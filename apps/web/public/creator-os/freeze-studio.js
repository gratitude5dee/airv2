...
}`,k2=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],X2=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],lM=new Oe,pc=new N,v0=new N;function W2(e,t,n){let i=new Xl,s=new Dt,a=new Dt,r=new Pe,o=new rf,l=new of,c={},h=n.maxTextureSize,p={[bs]:An,[An]:bs,[Xi]:Xi},u=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:H2,fragmentShader:G2}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let g=new ln;g.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new $e(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ic;let f=this.type;this.render=function(A,w,y){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;this.type===sb&&(Nt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ic);let T=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),I=e.state;I.setBlending(Wi),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let W=f!==this.type;W&&w.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(P=>P.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,P=A.length;V<P;V++){let k=A[V],X=k.shadow;if(X===void 0){Nt("WebGLShadowMap:",k,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);let J=X.getFrameExtents();s.multiply(J),a.copy(X.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/J.x),s.x=a.x*J.x,X.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/J.y),s.y=a.y*J.y,X.mapSize.y=a.y));let et=e.state.buffers.depth.getReversed();if(X.camera._reversedDepth=et,X.map===null||W===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===_o){if(k.isPointLight){Nt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new Jn(s.x,s.y,{format:xa,type:qi,minFilter:pn,magFilter:pn,generateMipmaps:!1}),X.map.texture.name=k.name+".shadowMap",X.map.depthTexture=new Ms(s.x,s.y,Ti),X.map.depthTexture.name=k.name+".shadowMapDepth",X.map.depthTexture.format=Hi,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=on,X.map.depthTexture.magFilter=on}else k.isPointLight?(X.map=new hd(s.x),X.map.depthTexture=new Jh(s.x,Ei)):(X.map=new Jn(s.x,s.y),X.map.depthTexture=new Ms(s.x,s.y,Ei)),X.map.depthTexture.name=k.name+".shadowMap",X.map.depthTexture.format=Hi,this.type===ic?(X.map.depthTexture.compareFunction=et?od:rd,X.map.depthTexture.minFilter=pn,X.map.depthTexture.magFilter=pn):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=on,X.map.depthTexture.magFilter=on);X.camera.updateProjectionMatrix()}let it=X.map.isWebGLCubeRenderTarget?6:1;for(let ot=0;ot<it;ot++){if(X.map.isWebGLCubeRenderTarget)e.setRenderTarget(X.map,ot),e.clear();else{ot===0&&(e.setRenderTarget(X.map),e.clear());let _t=X.getViewport(ot);r.set(a.x*_t.x,a.y*_t.y,a.x*_t.z,a.y*_t.w),I.viewport(r)}if(k.isPointLight){let _t=X.camera,Wt=X.matrix,re=k.distance||_t.far;re!==_t.far&&(_t.far=re,_t.updateProjectionMatrix()),pc.setFromMatrixPosition(k.matrixWorld),_t.position.copy(pc),v0.copy(_t.position),v0.add(k2[ot]),_t.up.copy(X2[ot]),_t.lookAt(v0),_t.updateMatrixWorld(),Wt.makeTranslation(-pc.x,-pc.y,-pc.z),lM.multiplyMatrices(_t.projectionMatrix,_t.matrixWorldInverse),X._frustum.setFromProjectionMatrix(lM,_t.coordinateSystem,_t.reversedDepth)}else X.updateMatrices(k);i=X.getFrustum(),v(w,y,X.camera,k,this.type)}X.isPointLightShadow!==!0&&this.type===_o&&_(X,y),X.needsUpdate=!1}f=this.type,m.needsUpdate=!1,e.setRenderTarget(T,R,D)};function _(A,w){let y=t.update(b);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Jn(s.x,s.y,{format:xa,type:qi})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,y,u,b,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,y,d,b,null)}function x(A,w,y,T){let R=null,D=y.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)R=D;else if(R=y.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let I=R.uuid,W=w.uuid,V=c[I];V===void 0&&(V={},c[I]=V);let P=V[W];P===void 0&&(P=R.clone(),V[W]=P,w.addEventListener("dispose",E)),R=P}if(R.visible=w.visible,R.wireframe=w.wireframe,T===_o?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:p[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,y.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let I=e.properties.get(R);I.light=y}return R}function v(A,w,y,T,R){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===_o)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,A.matrixWorld);let W=t.update(A),V=A.material;if(Array.isArray(V)){let P=W.groups;for(let k=0,X=P.length;k<X;k++){let J=P[k],et=V[J.materialIndex];if(et&&et.visible){let it=x(A,et,T,R);A.onBeforeShadow(e,A,w,y,W,it,J),e.renderBufferDirect(y,null,W,it,A,J),A.onAfterShadow(e,A,w,y,W,it,J)}}}else if(V.visible){let P=x(A,V,T,R);A.onBeforeShadow(e,A,w,y,W,P,null),e.renderBufferDirect(y,null,W,P,A,null),A.onAfterShadow(e,A,w,y,W,P,null)}}let I=A.children;for(let W=0,V=I.length;W<V;W++)v(I[W],w,y,T,R)}function E(A){A.target.removeEventListener("dispose",E);for(let y in c){let T=c[y],R=A.target.uuid;R in T&&(T[R].dispose(),delete T[R])}}}function q2(e,t){function n(){let U=!1,rt=new Pe,j=null,ht=new Pe(0,0,0,0);return{setMask:function(vt){j!==vt&&!U&&(e.colorMask(vt,vt,vt,vt),j=vt)},setLocked:function(vt){U=vt},setClear:function(vt,tt,Tt,Mt,Be){Be===!0&&(vt*=Mt,tt*=Mt,Tt*=Mt),rt.set(vt,tt,Tt,Mt),ht.equals(rt)===!1&&(e.clearColor(vt,tt,Tt,Mt),ht.copy(rt))},reset:function(){U=!1,j=null,ht.set(-1,0,0,0)}}}function i(){let U=!1,rt=!1,j=null,ht=null,vt=null;return{setReversed:function(tt){if(rt!==tt){let Tt=t.get("EXT_clip_control");tt?Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.ZERO_TO_ONE_EXT):Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.NEGATIVE_ONE_TO_ONE_EXT),rt=tt;let Mt=vt;vt=null,this.setClear(Mt)}},getReversed:function(){return rt},setTest:function(tt){tt?nt(e.DEPTH_TEST):Ot(e.DEPTH_TEST)},setMask:function(tt){j!==tt&&!U&&(e.depthMask(tt),j=tt)},setFunc:function(tt){if(rt&&(tt=zb[tt]),ht!==tt){switch(tt){case Uh:e.depthFunc(e.NEVER);break;case Lh:e.depthFunc(e.ALWAYS);break;case Ih:e.depthFunc(e.LESS);break;case Ka:e.depthFunc(e.LEQUAL);break;case Oh:e.depthFunc(e.EQUAL);break;case Ph:e.depthFunc(e.GEQUAL);break;case zh:e.depthFunc(e.GREATER);break;case Bh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}ht=tt}},setLocked:function(tt){U=tt},setClear:function(tt){vt!==tt&&(vt=tt,rt&&(tt=1-tt),e.clearDepth(tt))},reset:function(){U=!1,j=null,ht=null,vt=null,rt=!1}}}function s(){let U=!1,rt=null,j=null,ht=null,vt=null,tt=null,Tt=null,Mt=null,Be=null;return{setTest:function(be){U||(be?nt(e.STENCIL_TEST):Ot(e.STENCIL_TEST))},setMask:function(be){rt!==be&&!U&&(e.stencilMask(be),rt=be)},setFunc:function(be,Ai,wi){(j!==be||ht!==Ai||vt!==wi)&&(e.stencilFunc(be,Ai,wi),j=be,ht=Ai,vt=wi)},setOp:function(be,Ai,wi){(tt!==be||Tt!==Ai||Mt!==wi)&&(e.stencilOp(be,Ai,wi),tt=be,Tt=Ai,Mt=wi)},setLocked:function(be){U=be},setClear:function(be){Be!==be&&(e.clearStencil(be),Be=be)},reset:function(){U=!1,rt=null,j=null,ht=null,vt=null,tt=null,Tt=null,Mt=null,Be=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,h={},p={},u={},d=new WeakMap,g=[],b=null,m=!1,f=null,_=null,x=null,v=null,E=null,A=null,w=null,y=new ie(0,0,0),T=0,R=!1,D=null,I=null,W=null,V=null,P=null,k=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,J=0,et=e.getParameter(e.VERSION);et.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(et)[1]),X=J>=1):et.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(et)[1]),X=J>=2);let it=null,ot={},_t=e.getParameter(e.SCISSOR_BOX),Wt=e.getParameter(e.VIEWPORT),re=new Pe().fromArray(_t),te=new Pe().fromArray(Wt);function K(U,rt,j,ht){let vt=new Uint8Array(4),tt=e.createTexture();e.bindTexture(U,tt),e.texParameteri(U,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(U,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Tt=0;Tt<j;Tt++)U===e.TEXTURE_3D||U===e.TEXTURE_2D_ARRAY?e.texImage3D(rt,0,e.RGBA,1,1,ht,0,e.RGBA,e.UNSIGNED_BYTE,vt):e.texImage2D(rt+Tt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,vt);return tt}let at={};at[e.TEXTURE_2D]=K(e.TEXTURE_2D,e.TEXTURE_2D,1),at[e.TEXTURE_CUBE_MAP]=K(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[e.TEXTURE_2D_ARRAY]=K(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),at[e.TEXTURE_3D]=K(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),nt(e.DEPTH_TEST),r.setFunc(Ka),Ne(!1),q(Fg),nt(e.CULL_FACE),oe(Wi);function nt(U){h[U]!==!0&&(e.enable(U),h[U]=!0)}function Ot(U){h[U]!==!1&&(e.disable(U),h[U]=!1)}function Bt(U,rt){return u[U]!==rt?(e.bindFramebuffer(U,rt),u[U]=rt,U===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=rt),U===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=rt),!0):!1}function Ut(U,rt){let j=g,ht=!1;if(U){j=d.get(rt),j===void 0&&(j=[],d.set(rt,j));let vt=U.textures;if(j.length!==vt.length||j[0]!==e.COLOR_ATTACHMENT0){for(let tt=0,Tt=vt.length;tt<Tt;tt++)j[tt]=e.COLOR_ATTACHMENT0+tt;j.length=vt.length,ht=!0}}else j[0]!==e.BACK&&(j[0]=e.BACK,ht=!0);ht&&e.drawBuffers(j)}function Ie(U){return b!==U?(e.useProgram(U),b=U,!0):!1}let Jt={[la]:e.FUNC_ADD,[rb]:e.FUNC_SUBTRACT,[ob]:e.FUNC_REVERSE_SUBTRACT};Jt[lb]=e.MIN,Jt[cb]=e.MAX;let fe={[ub]:e.ZERO,[hb]:e.ONE,[fb]:e.SRC_COLOR,[Dh]:e.SRC_ALPHA,[vb]:e.SRC_ALPHA_SATURATE,[gb]:e.DST_COLOR,[pb]:e.DST_ALPHA,[db]:e.ONE_MINUS_SRC_COLOR,[Nh]:e.ONE_MINUS_SRC_ALPHA,[_b]:e.ONE_MINUS_DST_COLOR,[mb]:e.ONE_MINUS_DST_ALPHA,[yb]:e.CONSTANT_COLOR,[xb]:e.ONE_MINUS_CONSTANT_COLOR,[Sb]:e.CONSTANT_ALPHA,[bb]:e.ONE_MINUS_CONSTANT_ALPHA};function oe(U,rt,j,ht,vt,tt,Tt,Mt,Be,be){if(U===Wi){m===!0&&(Ot(e.BLEND),m=!1);return}if(m===!1&&(nt(e.BLEND),m=!0),U!==ab){if(U!==f||be!==R){if((_!==la||E!==la)&&(e.blendEquation(e.FUNC_ADD),_=la,E=la),be)switch(U){case Ja:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Vg:e.blendFunc(e.ONE,e.ONE);break;case Hg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Gg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:It("WebGLState: Invalid blending: ",U);break}else switch(U){case Ja:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Vg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Hg:It("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Gg:It("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:It("WebGLState: Invalid blending: ",U);break}x=null,v=null,A=null,w=null,y.set(0,0,0),T=0,f=U,R=be}return}vt=vt||rt,tt=tt||j,Tt=Tt||ht,(rt!==_||vt!==E)&&(e.blendEquationSeparate(Jt[rt],Jt[vt]),_=rt,E=vt),(j!==x||ht!==v||tt!==A||Tt!==w)&&(e.blendFuncSeparate(fe[j],fe[ht],fe[tt],fe[Tt]),x=j,v=ht,A=tt,w=Tt),(Mt.equals(y)===!1||Be!==T)&&(e.blendColor(Mt.r,Mt.g,Mt.b,Be),y.copy(Mt),T=Be),f=U,R=!1}function qt(U,rt){U.side===Xi?Ot(e.CULL_FACE):nt(e.CULL_FACE);let j=U.side===An;rt&&(j=!j),Ne(j),U.blending===Ja&&U.transparent===!1?oe(Wi):oe(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),r.setFunc(U.depthFunc),r.setTest(U.depthTest),r.setMask(U.depthWrite),a.setMask(U.colorWrite);let ht=U.stencilWrite;o.setTest(ht),ht&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Ft(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?nt(e.SAMPLE_ALPHA_TO_COVERAGE):Ot(e.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(U){D!==U&&(U?e.frontFace(e.CW):e.frontFace(e.CCW),D=U)}function q(U){U!==nb?(nt(e.CULL_FACE),U!==I&&(U===Fg?e.cullFace(e.BACK):U===ib?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Ot(e.CULL_FACE),I=U}function bt(U){U!==W&&(X&&e.lineWidth(U),W=U)}function Ft(U,rt,j){U?(nt(e.POLYGON_OFFSET_FILL),(V!==rt||P!==j)&&(V=rt,P=j,r.getReversed()&&(rt=-rt),e.polygonOffset(rt,j))):Ot(e.POLYGON_OFFSET_FILL)}function Xt(U){U?nt(e.SCISSOR_TEST):Ot(e.SCISSOR_TEST)}function Kt(U){U===void 0&&(U=e.TEXTURE0+k-1),it!==U&&(e.activeTexture(U),it=U)}function L(U,rt,j){j===void 0&&(it===null?j=e.TEXTURE0+k-1:j=it);let ht=ot[j];ht===void 0&&(ht={type:void 0,texture:void 0},ot[j]=ht),(ht.type!==U||ht.texture!==rt)&&(it!==j&&(e.activeTexture(j),it=j),e.bindTexture(U,rt||at[U]),ht.type=U,ht.texture=rt)}function ze(){let U=ot[it];U!==void 0&&U.type!==void 0&&(e.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function le(){try{e.compressedTexImage2D(...arguments)}catch(U){It("WebGLState:",U)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(U){It("WebGLState:",U)}}function S(){try{e.texSubImage2D(...arguments)}catch(U){It("WebGLState:",U)}}function z(){try{e.texSubImage3D(...arguments)}catch(U){It("WebGLState:",U)}}function H(){try{e.compressedTexSubImage2D(...arguments)}catch(U){It("WebGLState:",U)}}function Y(){try{e.compressedTexSubImage3D(...arguments)}catch(U){It("WebGLState:",U)}}function st(){try{e.texStorage2D(...arguments)}catch(U){It("WebGLState:",U)}}function lt(){try{e.texStorage3D(...arguments)}catch(U){It("WebGLState:",U)}}function Z(){try{e.texImage2D(...arguments)}catch(U){It("WebGLState:",U)}}function Q(){try{e.texImage3D(...arguments)}catch(U){It("WebGLState:",U)}}function ct(U){return p[U]!==void 0?p[U]:e.getParameter(U)}function At(U,rt){p[U]!==rt&&(e.pixelStorei(U,rt),p[U]=rt)}function dt(U){re.equals(U)===!1&&(e.scissor(U.x,U.y,U.z,U.w),re.copy(U))}function ut(U){te.equals(U)===!1&&(e.viewport(U.x,U.y,U.z,U.w),te.copy(U))}function Rt(U,rt){let j=c.get(rt);j===void 0&&(j=new WeakMap,c.set(rt,j));let ht=j.get(U);ht===void 0&&(ht=e.getUniformBlockIndex(rt,U.name),j.set(U,ht))}function Lt(U,rt){let ht=c.get(rt).get(U);l.get(rt)!==ht&&(e.uniformBlockBinding(rt,ht,U.__bindingPointIndex),l.set(rt,ht))}function Ht(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},it=null,ot={},u={},d=new WeakMap,g=[],b=null,m=!1,f=null,_=null,x=null,v=null,E=null,A=null,w=null,y=new ie(0,0,0),T=0,R=!1,D=null,I=null,W=null,V=null,P=null,re.set(0,0,e.canvas.width,e.canvas.height),te.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:nt,disable:Ot,bindFramebuffer:Bt,drawBuffers:Ut,useProgram:Ie,setBlending:oe,setMaterial:qt,setFlipSided:Ne,setCullFace:q,setLineWidth:bt,setPolygonOffset:Ft,setScissorTest:Xt,activeTexture:Kt,bindTexture:L,unbindTexture:ze,compressedTexImage2D:le,compressedTexImage3D:C,texImage2D:Z,texImage3D:Q,pixelStorei:At,getParameter:ct,updateUBOMapping:Rt,uniformBlockBinding:Lt,texStorage2D:st,texStorage3D:lt,texSubImage2D:S,texSubImage3D:z,compressedTexSubImage2D:H,compressedTexSubImage3D:Y,scissor:dt,viewport:ut,reset:Ht}}function Y2(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Dt,h=new WeakMap,p=new Set,u,d=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(C,S){return g?new OffscreenCanvas(C,S):zl("canvas")}function m(C,S,z){let H=1,Y=le(C);if((Y.width>z||Y.height>z)&&(H=z/Math.max(Y.width,Y.height)),H<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){let st=Math.floor(H*Y.width),lt=Math.floor(H*Y.height);u===void 0&&(u=b(st,lt));let Z=S?b(st,lt):u;return Z.width=st,Z.height=lt,Z.getContext("2d").drawImage(C,0,0,st,lt),Nt("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+st+"x"+lt+")."),Z}else return"data"in C&&Nt("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),C;return C}function f(C){return C.generateMipmaps}function _(C){e.generateMipmap(C)}function x(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function v(C,S,z,H,Y,st=!1){if(C!==null){if(e[C]!==void 0)return e[C];Nt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let lt;H&&(lt=t.get("EXT_texture_norm16"),lt||Nt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=S;if(S===e.RED&&(z===e.FLOAT&&(Z=e.R32F),z===e.HALF_FLOAT&&(Z=e.R16F),z===e.UNSIGNED_BYTE&&(Z=e.R8),z===e.UNSIGNED_SHORT&&lt&&(Z=lt.R16_EXT),z===e.SHORT&&lt&&(Z=lt.R16_SNORM_EXT)),S===e.RED_INTEGER&&(z===e.UNSIGNED_BYTE&&(Z=e.R8UI),z===e.UNSIGNED_SHORT&&(Z=e.R16UI),z===e.UNSIGNED_INT&&(Z=e.R32UI),z===e.BYTE&&(Z=e.R8I),z===e.SHORT&&(Z=e.R16I),z===e.INT&&(Z=e.R32I)),S===e.RG&&(z===e.FLOAT&&(Z=e.RG32F),z===e.HALF_FLOAT&&(Z=e.RG16F),z===e.UNSIGNED_BYTE&&(Z=e.RG8),z===e.UNSIGNED_SHORT&&lt&&(Z=lt.RG16_EXT),z===e.SHORT&&lt&&(Z=lt.RG16_SNORM_EXT)),S===e.RG_INTEGER&&(z===e.UNSIGNED_BYTE&&(Z=e.RG8UI),z===e.UNSIGNED_SHORT&&(Z=e.RG16UI),z===e.UNSIGNED_INT&&(Z=e.RG32UI),z===e.BYTE&&(Z=e.RG8I),z===e.SHORT&&(Z=e.RG16I),z===e.INT&&(Z=e.RG32I)),S===e.RGB_INTEGER&&(z===e.UNSIGNED_BYTE&&(Z=e.RGB8UI),z===e.UNSIGNED_SHORT&&(Z=e.RGB16UI),z===e.UNSIGNED_INT&&(Z=e.RGB32UI),z===e.BYTE&&(Z=e.RGB8I),z===e.SHORT&&(Z=e.RGB16I),z===e.INT&&(Z=e.RGB32I)),S===e.RGBA_INTEGER&&(z===e.UNSIGNED_BYTE&&(Z=e.RGBA8UI),z===e.UNSIGNED_SHORT&&(Z=e.RGBA16UI),z===e.UNSIGNED_INT&&(Z=e.RGBA32UI),z===e.BYTE&&(Z=e.RGBA8I),z===e.SHORT&&(Z=e.RGBA16I),z===e.INT&&(Z=e.RGBA32I)),S===e.RGB&&(z===e.UNSIGNED_SHORT&&lt&&(Z=lt.RGB16_EXT),z===e.SHORT&&lt&&(Z=lt.RGB16_SNORM_EXT),z===e.UNSIGNED_INT_5_9_9_9_REV&&(Z=e.RGB9_E5),z===e.UNSIGNED_INT_10F_11F_11F_REV&&(Z=e.R11F_G11F_B10F)),S===e.RGBA){let Q=st?Ol:ne.getTransfer(Y);z===e.FLOAT&&(Z=e.RGBA32F),z===e.HALF_FLOAT&&(Z=e.RGBA16F),z===e.UNSIGNED_BYTE&&(Z=Q===de?e.SRGB8_ALPHA8:e.RGBA8),z===e.UNSIGNED_SHORT&&lt&&(Z=lt.RGBA16_EXT),z===e.SHORT&&lt&&(Z=lt.RGBA16_SNORM_EXT),z===e.UNSIGNED_SHORT_4_4_4_4&&(Z=e.RGBA4),z===e.UNSIGNED_SHORT_5_5_5_1&&(Z=e.RGB5_A1)}return(Z===e.R16F||Z===e.R32F||Z===e.RG16F||Z===e.RG32F||Z===e.RGBA16F||Z===e.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function E(C,S){let z;return C?S===null||S===Ei||S===yo?z=e.DEPTH24_STENCIL8:S===Ti?z=e.DEPTH32F_STENCIL8:S===vo&&(z=e.DEPTH24_STENCIL8,Nt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Ei||S===yo?z=e.DEPTH_COMPONENT24:S===Ti?z=e.DEPTH_COMPONENT32F:S===vo&&(z=e.DEPTH_COMPONENT16),z}function A(C,S){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==on&&C.minFilter!==pn?Math.log2(Math.max(S.width,S.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?S.mipmaps.length:1}function w(C){let S=C.target;S.removeEventListener("dispose",w),T(S),S.isVideoTexture&&h.delete(S),S.isHTMLTexture&&p.delete(S)}function y(C){let S=C.target;S.removeEventListener("dispose",y),D(S)}function T(C){let S=i.get(C);if(S.__webglInit===void 0)return;let z=C.source,H=d.get(z);if(H){let Y=H[S.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&R(C),Object.keys(H).length===0&&d.delete(z)}i.remove(C)}function R(C){let S=i.get(C);e.deleteTexture(S.__webglTexture);let z=C.source,H=d.get(z);delete H[S.__cacheKey],r.memory.textures--}function D(C){let S=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let H=0;H<6;H++){if(Array.isArray(S.__webglFramebuffer[H]))for(let Y=0;Y<S.__webglFramebuffer[H].length;Y++)e.deleteFramebuffer(S.__webglFramebuffer[H][Y]);else e.deleteFramebuffer(S.__webglFramebuffer[H]);S.__webglDepthbuffer&&e.deleteRenderbuffer(S.__webglDepthbuffer[H])}else{if(Array.isArray(S.__webglFramebuffer))for(let H=0;H<S.__webglFramebuffer.length;H++)e.deleteFramebuffer(S.__webglFramebuffer[H]);else e.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&e.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&e.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let H=0;H<S.__webglColorRenderbuffer.length;H++)S.__webglColorRenderbuffer[H]&&e.deleteRenderbuffer(S.__webglColorRenderbuffer[H]);S.__webglDepthRenderbuffer&&e.deleteRenderbuffer(S.__webglDepthRenderbuffer)}let z=C.textures;for(let H=0,Y=z.length;H<Y;H++){let st=i.get(z[H]);st.__webglTexture&&(e.deleteTexture(st.__webglTexture),r.memory.textures--),i.remove(z[H])}i.remove(C)}let I=0;function W(){I=0}function V(){return I}function P(C){I=C}function k(){let C=I;return C>=s.maxTextures&&Nt("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),I+=1,C}function X(C){let S=[];return S.push(C.wrapS),S.push(C.wrapT),S.push(C.wrapR||0),S.push(C.magFilter),S.push(C.minFilter),S.push(C.anisotropy),S.push(C.internalFormat),S.push(C.format),S.push(C.type),S.push(C.generateMipmaps),S.push(C.premultiplyAlpha),S.push(C.flipY),S.push(C.unpackAlignment),S.push(C.colorSpace),S.join()}function J(C,S){let z=i.get(C);if(C.isVideoTexture&&L(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&z.__version!==C.version){let H=C.image;if(H===null)Nt("WebGLRenderer: Texture marked for update but no image data found.");else if(H.complete===!1)Nt("WebGLRenderer: Texture marked for update but image is incomplete");else{Ot(z,C,S);return}}else C.isExternalTexture&&(z.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,z.__webglTexture,e.TEXTURE0+S)}function et(C,S){let z=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&z.__version!==C.version){Ot(z,C,S);return}else C.isExternalTexture&&(z.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,z.__webglTexture,e.TEXTURE0+S)}function it(C,S){let z=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&z.__version!==C.version){Ot(z,C,S);return}n.bindTexture(e.TEXTURE_3D,z.__webglTexture,e.TEXTURE0+S)}function ot(C,S){let z=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&z.__version!==C.version){Bt(z,C,S);return}n.bindTexture(e.TEXTURE_CUBE_MAP,z.__webglTexture,e.TEXTURE0+S)}let _t={[Fh]:e.REPEAT,[Fi]:e.CLAMP_TO_EDGE,[Vh]:e.MIRRORED_REPEAT},Wt={[on]:e.NEAREST,[Tb]:e.NEAREST_MIPMAP_NEAREST,[ac]:e.NEAREST_MIPMAP_LINEAR,[pn]:e.LINEAR,[Mf]:e.LINEAR_MIPMAP_NEAREST,[va]:e.LINEAR_MIPMAP_LINEAR},re={[Cb]:e.NEVER,[Lb]:e.ALWAYS,[Rb]:e.LESS,[rd]:e.LEQUAL,[Db]:e.EQUAL,[od]:e.GEQUAL,[Nb]:e.GREATER,[Ub]:e.NOTEQUAL};function te(C,S){if(S.type===Ti&&t.has("OES_texture_float_linear")===!1&&(S.magFilter===pn||S.magFilter===Mf||S.magFilter===ac||S.magFilter===va||S.minFilter===pn||S.minFilter===Mf||S.minFilter===ac||S.minFilter===va)&&Nt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,_t[S.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,_t[S.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,_t[S.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,Wt[S.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,Wt[S.minFilter]),S.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,re[S.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===on||S.minFilter!==ac&&S.minFilter!==va||S.type===Ti&&t.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){let z=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,s.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function K(C,S){let z=!1;C.__webglInit===void 0&&(C.__webglInit=!0,S.addEventListener("dispose",w));let H=S.source,Y=d.get(H);Y===void 0&&(Y={},d.set(H,Y));let st=X(S);if(st!==C.__cacheKey){Y[st]===void 0&&(Y[st]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,z=!0),Y[st].usedTimes++;let lt=Y[C.__cacheKey];lt!==void 0&&(Y[C.__cacheKey].usedTimes--,lt.usedTimes===0&&R(S)),C.__cacheKey=st,C.__webglTexture=Y[st].texture}return z}function at(C,S,z){return Math.floor(Math.floor(C/z)/S)}function nt(C,S,z,H){let st=C.updateRanges;if(st.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,S.width,S.height,z,H,S.data);else{st.sort((At,dt)=>At.start-dt.start);let lt=0;for(let At=1;At<st.length;At++){let dt=st[lt],ut=st[At],Rt=dt.start+dt.count,Lt=at(ut.start,S.width,4),Ht=at(dt.start,S.width,4);ut.start<=Rt+1&&Lt===Ht&&at(ut.start+ut.count-1,S.width,4)===Lt?dt.count=Math.max(dt.count,ut.start+ut.count-dt.start):(++lt,st[lt]=ut)}st.length=lt+1;let Z=n.getParameter(e.UNPACK_ROW_LENGTH),Q=n.getParameter(e.UNPACK_SKIP_PIXELS),ct=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,S.width);for(let At=0,dt=st.length;At<dt;At++){let ut=st[At],Rt=Math.floor(ut.start/4),Lt=Math.ceil(ut.count/4),Ht=Rt%S.width,U=Math.floor(Rt/S.width),rt=Lt,j=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,Ht),n.pixelStorei(e.UNPACK_SKIP_ROWS,U),n.texSubImage2D(e.TEXTURE_2D,0,Ht,U,rt,j,z,H,S.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,Z),n.pixelStorei(e.UNPACK_SKIP_PIXELS,Q),n.pixelStorei(e.UNPACK_SKIP_ROWS,ct)}}function Ot(C,S,z){let H=e.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(H=e.TEXTURE_2D_ARRAY),S.isData3DTexture&&(H=e.TEXTURE_3D);let Y=K(C,S),st=S.source;n.bindTexture(H,C.__webglTexture,e.TEXTURE0+z);let lt=i.get(st);if(st.version!==lt.__version||Y===!0){if(n.activeTexture(e.TEXTURE0+z),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){let j=ne.getPrimaries(ne.workingColorSpace),ht=S.colorSpace===Es?null:ne.getPrimaries(S.colorSpace),vt=S.colorSpace===Es||j===ht?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt)}n.pixelStorei(e.UNPACK_ALIGNMENT,S.unpackAlignment);let Q=m(S.image,!1,s.maxTextureSize);Q=ze(S,Q);let ct=a.convert(S.format,S.colorSpace),At=a.convert(S.type),dt=v(S.internalFormat,ct,At,S.normalized,S.colorSpace,S.isVideoTexture);te(H,S);let ut,Rt=S.mipmaps,Lt=S.isVideoTexture!==!0,Ht=lt.__version===void 0||Y===!0,U=st.dataReady,rt=A(S,Q);if(S.isDepthTexture)dt=E(S.format===ya,S.type),Ht&&(Lt?n.texStorage2D(e.TEXTURE_2D,1,dt,Q.width,Q.height):n.texImage2D(e.TEXTURE_2D,0,dt,Q.width,Q.height,0,ct,At,null));else if(S.isDataTexture)if(Rt.length>0){Lt&&Ht&&n.texStorage2D(e.TEXTURE_2D,rt,dt,Rt[0].width,Rt[0].height);for(let j=0,ht=Rt.length;j<ht;j++)ut=Rt[j],Lt?U&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ut.width,ut.height,ct,At,ut.data):n.texImage2D(e.TEXTURE_2D,j,dt,ut.width,ut.height,0,ct,At,ut.data);S.generateMipmaps=!1}else Lt?(Ht&&n.texStorage2D(e.TEXTURE_2D,rt,dt,Q.width,Q.height),U&&nt(S,Q,ct,At)):n.texImage2D(e.TEXTURE_2D,0,dt,Q.width,Q.height,0,ct,At,Q.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Lt&&Ht&&n.texStorage3D(e.TEXTURE_2D_ARRAY,rt,dt,Rt[0].width,Rt[0].height,Q.depth);for(let j=0,ht=Rt.length;j<ht;j++)if(ut=Rt[j],S.format!==mi)if(ct!==null)if(Lt){if(U)if(S.layerUpdates.size>0){let vt=f0(ut.width,ut.height,S.format,S.type);for(let tt of S.layerUpdates){let Tt=ut.data.subarray(tt*vt/ut.data.BYTES_PER_ELEMENT,(tt+1)*vt/ut.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,tt,ut.width,ut.height,1,ct,Tt)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,0,ut.width,ut.height,Q.depth,ct,ut.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,j,dt,ut.width,ut.height,Q.depth,0,ut.data,0,0);else Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?U&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,0,ut.width,ut.height,Q.depth,ct,At,ut.data):n.texImage3D(e.TEXTURE_2D_ARRAY,j,dt,ut.width,ut.height,Q.depth,0,ct,At,ut.data)}else{Lt&&Ht&&n.texStorage2D(e.TEXTURE_2D,rt,dt,Rt[0].width,Rt[0].height);for(let j=0,ht=Rt.length;j<ht;j++)ut=Rt[j],S.format!==mi?ct!==null?Lt?U&&n.compressedTexSubImage2D(e.TEXTURE_2D,j,0,0,ut.width,ut.height,ct,ut.data):n.compressedTexImage2D(e.TEXTURE_2D,j,dt,ut.width,ut.height,0,ut.data):Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?U&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ut.width,ut.height,ct,At,ut.data):n.texImage2D(e.TEXTURE_2D,j,dt,ut.width,ut.height,0,ct,At,ut.data)}else if(S.isDataArrayTexture)if(Lt){if(Ht&&n.texStorage3D(e.TEXTURE_2D_ARRAY,rt,dt,Q.width,Q.height,Q.depth),U)if(S.layerUpdates.size>0){let j=f0(Q.width,Q.height,S.format,S.type);for(let ht of S.layerUpdates){let vt=Q.data.subarray(ht*j/Q.data.BYTES_PER_ELEMENT,(ht+1)*j/Q.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,ht,Q.width,Q.height,1,ct,At,vt)}S.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ct,At,Q.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,dt,Q.width,Q.height,Q.depth,0,ct,At,Q.data);else if(S.isData3DTexture)Lt?(Ht&&n.texStorage3D(e.TEXTURE_3D,rt,dt,Q.width,Q.height,Q.depth),U&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ct,At,Q.data)):n.texImage3D(e.TEXTURE_3D,0,dt,Q.width,Q.height,Q.depth,0,ct,At,Q.data);else if(S.isFramebufferTexture){if(Ht)if(Lt)n.texStorage2D(e.TEXTURE_2D,rt,dt,Q.width,Q.height);else{let j=Q.width,ht=Q.height;for(let vt=0;vt<rt;vt++)n.texImage2D(e.TEXTURE_2D,vt,dt,j,ht,0,ct,At,null),j>>=1,ht>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in e){let j=e.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),Q.parentNode!==j){j.appendChild(Q),p.add(S),j.onpaint=ht=>{let vt=ht.changedElements;for(let tt of p)vt.includes(tt.image)&&(tt.needsUpdate=!0)},j.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,Q);else{let vt=e.RGBA,tt=e.RGBA,Tt=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,vt,tt,Tt,Q)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(Rt.length>0){if(Lt&&Ht){let j=le(Rt[0]);n.texStorage2D(e.TEXTURE_2D,rt,dt,j.width,j.height)}for(let j=0,ht=Rt.length;j<ht;j++)ut=Rt[j],Lt?U&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ct,At,ut):n.texImage2D(e.TEXTURE_2D,j,dt,ct,At,ut);S.generateMipmaps=!1}else if(Lt){if(Ht){let j=le(Q);n.texStorage2D(e.TEXTURE_2D,rt,dt,j.width,j.height)}U&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,ct,At,Q)}else n.texImage2D(e.TEXTURE_2D,0,dt,ct,At,Q);f(S)&&_(H),lt.__version=st.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function Bt(C,S,z){if(S.image.length!==6)return;let H=K(C,S),Y=S.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+z);let st=i.get(Y);if(Y.version!==st.__version||H===!0){n.activeTexture(e.TEXTURE0+z);let lt=ne.getPrimaries(ne.workingColorSpace),Z=S.colorSpace===Es?null:ne.getPrimaries(S.colorSpace),Q=S.colorSpace===Es||lt===Z?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let ct=S.isCompressedTexture||S.image[0].isCompressedTexture,At=S.image[0]&&S.image[0].isDataTexture,dt=[];for(let tt=0;tt<6;tt++)!ct&&!At?dt[tt]=m(S.image[tt],!0,s.maxCubemapSize):dt[tt]=At?S.image[tt].image:S.image[tt],dt[tt]=ze(S,dt[tt]);let ut=dt[0],Rt=a.convert(S.format,S.colorSpace),Lt=a.convert(S.type),Ht=v(S.internalFormat,Rt,Lt,S.normalized,S.colorSpace),U=S.isVideoTexture!==!0,rt=st.__version===void 0||H===!0,j=Y.dataReady,ht=A(S,ut);te(e.TEXTURE_CUBE_MAP,S);let vt;if(ct){U&&rt&&n.texStorage2D(e.TEXTURE_CUBE_MAP,ht,Ht,ut.width,ut.height);for(let tt=0;tt<6;tt++){vt=dt[tt].mipmaps;for(let Tt=0;Tt<vt.length;Tt++){let Mt=vt[Tt];S.format!==mi?Rt!==null?U?j&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt,0,0,Mt.width,Mt.height,Rt,Mt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt,Ht,Mt.width,Mt.height,0,Mt.data):Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt,0,0,Mt.width,Mt.height,Rt,Lt,Mt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt,Ht,Mt.width,Mt.height,0,Rt,Lt,Mt.data)}}}else{if(vt=S.mipmaps,U&&rt){vt.length>0&&ht++;let tt=le(dt[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,ht,Ht,tt.width,tt.height)}for(let tt=0;tt<6;tt++)if(At){U?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,dt[tt].width,dt[tt].height,Rt,Lt,dt[tt].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Ht,dt[tt].width,dt[tt].height,0,Rt,Lt,dt[tt].data);for(let Tt=0;Tt<vt.length;Tt++){let Be=vt[Tt].image[tt].image;U?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt+1,0,0,Be.width,Be.height,Rt,Lt,Be.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt+1,Ht,Be.width,Be.height,0,Rt,Lt,Be.data)}}else{U?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,Rt,Lt,dt[tt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Ht,Rt,Lt,dt[tt]);for(let Tt=0;Tt<vt.length;Tt++){let Mt=vt[Tt];U?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt+1,0,0,Rt,Lt,Mt.image[tt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Tt+1,Ht,Rt,Lt,Mt.image[tt])}}}f(S)&&_(e.TEXTURE_CUBE_MAP),st.__version=Y.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function Ut(C,S,z,H,Y,st){let lt=a.convert(z.format,z.colorSpace),Z=a.convert(z.type),Q=v(z.internalFormat,lt,Z,z.normalized,z.colorSpace),ct=i.get(S),At=i.get(z);if(At.__renderTarget=S,!ct.__hasExternalTextures){let dt=Math.max(1,S.width>>st),ut=Math.max(1,S.height>>st);Y===e.TEXTURE_3D||Y===e.TEXTURE_2D_ARRAY?n.texImage3D(Y,st,Q,dt,ut,S.depth,0,lt,Z,null):n.texImage2D(Y,st,Q,dt,ut,0,lt,Z,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),Kt(S)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,H,Y,At.__webglTexture,0,Xt(S)):(Y===e.TEXTURE_2D||Y>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,H,Y,At.__webglTexture,st),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ie(C,S,z){if(e.bindRenderbuffer(e.RENDERBUFFER,C),S.depthBuffer){let H=S.depthTexture,Y=H&&H.isDepthTexture?H.type:null,st=E(S.stencilBuffer,Y),lt=S.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Kt(S)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Xt(S),st,S.width,S.height):z?e.renderbufferStorageMultisample(e.RENDERBUFFER,Xt(S),st,S.width,S.height):e.renderbufferStorage(e.RENDERBUFFER,st,S.width,S.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,lt,e.RENDERBUFFER,C)}else{let H=S.textures;for(let Y=0;Y<H.length;Y++){let st=H[Y],lt=a.convert(st.format,st.colorSpace),Z=a.convert(st.type),Q=v(st.internalFormat,lt,Z,st.normalized,st.colorSpace);Kt(S)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Xt(S),Q,S.width,S.height):z?e.renderbufferStorageMultisample(e.RENDERBUFFER,Xt(S),Q,S.width,S.height):e.renderbufferStorage(e.RENDERBUFFER,Q,S.width,S.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Jt(C,S,z){let H=S.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=i.get(S.depthTexture);if(Y.__renderTarget=S,(!Y.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),H){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,S.depthTexture.addEventListener("dispose",w)),Y.__webglTexture===void 0){Y.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,Y.__webglTexture),te(e.TEXTURE_CUBE_MAP,S.depthTexture);let ct=a.convert(S.depthTexture.format),At=a.convert(S.depthTexture.type),dt;S.depthTexture.format===Hi?dt=e.DEPTH_COMPONENT24:S.depthTexture.format===ya&&(dt=e.DEPTH24_STENCIL8);for(let ut=0;ut<6;ut++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ut,0,dt,S.width,S.height,0,ct,At,null)}}else J(S.depthTexture,0);let st=Y.__webglTexture,lt=Xt(S),Z=H?e.TEXTURE_CUBE_MAP_POSITIVE_X+z:e.TEXTURE_2D,Q=S.depthTexture.format===ya?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(S.depthTexture.format===Hi)Kt(S)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Q,Z,st,0,lt):e.framebufferTexture2D(e.FRAMEBUFFER,Q,Z,st,0);else if(S.depthTexture.format===ya)Kt(S)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Q,Z,st,0,lt):e.framebufferTexture2D(e.FRAMEBUFFER,Q,Z,st,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function fe(C){let S=i.get(C),z=C.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==C.depthTexture){let H=C.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),H){let Y=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,H.removeEventListener("dispose",Y)};H.addEventListener("dispose",Y),S.__depthDisposeCallback=Y}S.__boundDepthTexture=H}if(C.depthTexture&&!S.__autoAllocateDepthBuffer)if(z)for(let H=0;H<6;H++)Jt(S.__webglFramebuffer[H],C,H);else{let H=C.texture.mipmaps;H&&H.length>0?Jt(S.__webglFramebuffer[0],C,0):Jt(S.__webglFramebuffer,C,0)}else if(z){S.__webglDepthbuffer=[];for(let H=0;H<6;H++)if(n.bindFramebuffer(e.FRAMEBUFFER,S.__webglFramebuffer[H]),S.__webglDepthbuffer[H]===void 0)S.__webglDepthbuffer[H]=e.createRenderbuffer(),Ie(S.__webglDepthbuffer[H],C,!1);else{let Y=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,st=S.__webglDepthbuffer[H];e.bindRenderbuffer(e.RENDERBUFFER,st),e.framebufferRenderbuffer(e.FRAMEBUFFER,Y,e.RENDERBUFFER,st)}}else{let H=C.texture.mipmaps;if(H&&H.length>0?n.bindFramebuffer(e.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=e.createRenderbuffer(),Ie(S.__webglDepthbuffer,C,!1);else{let Y=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,st=S.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,st),e.framebufferRenderbuffer(e.FRAMEBUFFER,Y,e.RENDERBUFFER,st)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function oe(C,S,z){let H=i.get(C);S!==void 0&&Ut(H.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),z!==void 0&&fe(C)}function qt(C){let S=C.texture,z=i.get(C),H=i.get(S);C.addEventListener("dispose",y);let Y=C.textures,st=C.isWebGLCubeRenderTarget===!0,lt=Y.length>1;if(lt||(H.__webglTexture===void 0&&(H.__webglTexture=e.createTexture()),H.__version=S.version,r.memory.textures++),st){z.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[Z]=[];for(let Q=0;Q<S.mipmaps.length;Q++)z.__webglFramebuffer[Z][Q]=e.createFramebuffer()}else z.__webglFramebuffer[Z]=e.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let Z=0;Z<S.mipmaps.length;Z++)z.__webglFramebuffer[Z]=e.createFramebuffer()}else z.__webglFramebuffer=e.createFramebuffer();if(lt)for(let Z=0,Q=Y.length;Z<Q;Z++){let ct=i.get(Y[Z]);ct.__webglTexture===void 0&&(ct.__webglTexture=e.createTexture(),r.memory.textures++)}if(C.samples>0&&Kt(C)===!1){z.__webglMultisampledFramebuffer=e.createFramebuffer(),z.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let Z=0;Z<Y.length;Z++){let Q=Y[Z];z.__webglColorRenderbuffer[Z]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,z.__webglColorRenderbuffer[Z]);let ct=a.convert(Q.format,Q.colorSpace),At=a.convert(Q.type),dt=v(Q.internalFormat,ct,At,Q.normalized,Q.colorSpace,C.isXRRenderTarget===!0),ut=Xt(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,ut,dt,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Z,e.RENDERBUFFER,z.__webglColorRenderbuffer[Z])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(z.__webglDepthRenderbuffer=e.createRenderbuffer(),Ie(z.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(st){n.bindTexture(e.TEXTURE_CUBE_MAP,H.__webglTexture),te(e.TEXTURE_CUBE_MAP,S);for(let Z=0;Z<6;Z++)if(S.mipmaps&&S.mipmaps.length>0)for(let Q=0;Q<S.mipmaps.length;Q++)Ut(z.__webglFramebuffer[Z][Q],C,S,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Q);else Ut(z.__webglFramebuffer[Z],C,S,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);f(S)&&_(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(lt){for(let Z=0,Q=Y.length;Z<Q;Z++){let ct=Y[Z],At=i.get(ct),dt=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(dt=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(dt,At.__webglTexture),te(dt,ct),Ut(z.__webglFramebuffer,C,ct,e.COLOR_ATTACHMENT0+Z,dt,0),f(ct)&&_(dt)}n.unbindTexture()}else{let Z=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Z=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(Z,H.__webglTexture),te(Z,S),S.mipmaps&&S.mipmaps.length>0)for(let Q=0;Q<S.mipmaps.length;Q++)Ut(z.__webglFramebuffer[Q],C,S,e.COLOR_ATTACHMENT0,Z,Q);else Ut(z.__webglFramebuffer,C,S,e.COLOR_ATTACHMENT0,Z,0);f(S)&&_(Z),n.unbindTexture()}C.depthBuffer&&fe(C)}function Ne(C){let S=C.textures;for(let z=0,H=S.length;z<H;z++){let Y=S[z];if(f(Y)){let st=x(C),lt=i.get(Y).__webglTexture;n.bindTexture(st,lt),_(st),n.unbindTexture()}}}let q=[],bt=[];function Ft(C){if(C.samples>0){if(Kt(C)===!1){let S=C.textures,z=C.width,H=C.height,Y=e.COLOR_BUFFER_BIT,st=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,lt=i.get(C),Z=S.length>1;if(Z)for(let ct=0;ct<S.length;ct++)n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,lt.__webglMultisampledFramebuffer);let Q=C.texture.mipmaps;Q&&Q.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,lt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,lt.__webglFramebuffer);for(let ct=0;ct<S.length;ct++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(Y|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(Y|=e.STENCIL_BUFFER_BIT)),Z){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,lt.__webglColorRenderbuffer[ct]);let At=i.get(S[ct]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,At,0)}e.blitFramebuffer(0,0,z,H,0,0,z,H,Y,e.NEAREST),l===!0&&(q.length=0,bt.length=0,q.push(e.COLOR_ATTACHMENT0+ct),C.depthBuffer&&C.resolveDepthBuffer===!1&&(q.push(st),bt.push(st),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,bt)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,q))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),Z)for(let ct=0;ct<S.length;ct++){n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.RENDERBUFFER,lt.__webglColorRenderbuffer[ct]);let At=i.get(S[ct]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.TEXTURE_2D,At,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,lt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){let S=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[S])}}}function Xt(C){return Math.min(s.maxSamples,C.samples)}function Kt(C){let S=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function L(C){let S=r.render.frame;h.get(C)!==S&&(h.set(C,S),C.update())}function ze(C,S){let z=C.colorSpace,H=C.format,Y=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||z!==Il&&z!==Es&&(ne.getTransfer(z)===de?(H!==mi||Y!==$n)&&Nt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):It("WebGLTextures: Unsupported texture color space:",z)),S}function le(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=W,this.getTextureUnits=V,this.setTextureUnits=P,this.setTexture2D=J,this.setTexture2DArray=et,this.setTexture3D=it,this.setTextureCube=ot,this.rebindTextures=oe,this.setupRenderTarget=qt,this.updateRenderTargetMipmap=Ne,this.updateMultisampleRenderTarget=Ft,this.setupDepthRenderbuffer=fe,this.setupFrameBufferTexture=Ut,this.useMultisampledRTT=Kt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Z2(e,t){function n(i,s=Es){let a,r=ne.getTransfer(s);if(i===$n)return e.UNSIGNED_BYTE;if(i===Tf)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Af)return e.UNSIGNED_SHORT_5_5_5_1;if(i===t0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===e0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===Qg)return e.BYTE;if(i===$g)return e.SHORT;if(i===vo)return e.UNSIGNED_SHORT;if(i===Ef)return e.INT;if(i===Ei)return e.UNSIGNED_INT;if(i===Ti)return e.FLOAT;if(i===qi)return e.HALF_FLOAT;if(i===n0)return e.ALPHA;if(i===i0)return e.RGB;if(i===mi)return e.RGBA;if(i===Hi)return e.DEPTH_COMPONENT;if(i===ya)return e.DEPTH_STENCIL;if(i===s0)return e.RED;if(i===wf)return e.RED_INTEGER;if(i===xa)return e.RG;if(i===Cf)return e.RG_INTEGER;if(i===Rf)return e.RGBA_INTEGER;if(i===rc||i===oc||i===lc||i===cc)if(r===de)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===rc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===oc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===cc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===rc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===oc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===cc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Df||i===Nf||i===Uf||i===Lf)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Df)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Nf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===If||i===Of||i===Pf||i===zf||i===Bf||i===uc||i===Ff)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===If||i===Of)return r===de?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Pf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===zf)return a.COMPRESSED_R11_EAC;if(i===Bf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===uc)return a.COMPRESSED_RG11_EAC;if(i===Ff)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Vf||i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Vf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Hf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Gf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===kf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Xf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Wf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===qf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Yf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Zf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Jf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Kf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===jf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Qf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===$f)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===td||i===ed||i===nd)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===td)return r===de?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ed)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===nd)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===id||i===sd||i===hc||i===ad)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===id)return a.COMPRESSED_RED_RGTC1_EXT;if(i===sd)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===hc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ad)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var J2=`
void main() {
...
}`,A0=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new ql(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new jn({vertexShader:J2,fragmentShader:K2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new $e(new da(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},w0=class extends Gi{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",l=1,c=null,h=null,p=null,u=null,d=null,g=null,b=typeof XRWebGLBinding<"u",m=new A0,f={},_=n.getContextAttributes(),x=null,v=null,E=[],A=[],w=new Dt,y=null,T=new yn;T.viewport=new Pe;let R=new yn;R.viewport=new Pe;let D=[T,R],I=new yf,W=null,V=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let at=E[K];return at===void 0&&(at=new uo,E[K]=at),at.getTargetRaySpace()},this.getControllerGrip=function(K){let at=E[K];return at===void 0&&(at=new uo,E[K]=at),at.getGripSpace()},this.getHand=function(K){let at=E[K];return at===void 0&&(at=new uo,E[K]=at),at.getHandSpace()};function P(K){let at=A.indexOf(K.inputSource);if(at===-1)return;let nt=E[at];nt!==void 0&&(nt.update(K.inputSource,K.frame,c||r),nt.dispatchEvent({type:K.type,data:K.inputSource}))}function k(){s.removeEventListener("select",P),s.removeEventListener("selectstart",P),s.removeEventListener("selectend",P),s.removeEventListener("squeeze",P),s.removeEventListener("squeezestart",P),s.removeEventListener("squeezeend",P),s.removeEventListener("end",k),s.removeEventListener("inputsourceschange",X);for(let K=0;K<E.length;K++){let at=A[K];at!==null&&(A[K]=null,E[K].disconnect(at))}W=null,V=null,m.reset();for(let K in f)delete f[K];t.setRenderTarget(x),d=null,u=null,p=null,s=null,v=null,te.stop(),i.isPresenting=!1,t.setPixelRatio(y),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){a=K,i.isPresenting===!0&&Nt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,i.isPresenting===!0&&Nt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return p===null&&b&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(x=t.getRenderTarget(),s.addEventListener("select",P),s.addEventListener("selectstart",P),s.addEventListener("selectend",P),s.addEventListener("squeeze",P),s.addEventListener("squeezestart",P),s.addEventListener("squeezeend",P),s.addEventListener("end",k),s.addEventListener("inputsourceschange",X),_.xrCompatible!==!0&&await n.makeXRCompatible(),y=t.getPixelRatio(),t.getSize(w),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let nt=null,Ot=null,Bt=null;_.depth&&(Bt=_.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,nt=_.stencil?ya:Hi,Ot=_.stencil?yo:Ei);let Ut={colorFormat:n.RGBA8,depthFormat:Bt,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(Ut),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),v=new Jn(u.textureWidth,u.textureHeight,{format:mi,type:$n,depthTexture:new Ms(u.textureWidth,u.textureHeight,Ot,void 0,void 0,void 0,void 0,void 0,void 0,nt),stencilBuffer:_.stencil,colorSpace:t.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let nt={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(s,n,nt),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),v=new Jn(d.framebufferWidth,d.framebufferHeight,{format:mi,type:$n,colorSpace:t.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(o),te.setContext(s),te.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function X(K){for(let at=0;at<K.removed.length;at++){let nt=K.removed[at],Ot=A.indexOf(nt);Ot>=0&&(A[Ot]=null,E[Ot].disconnect(nt))}for(let at=0;at<K.added.length;at++){let nt=K.added[at],Ot=A.indexOf(nt);if(Ot===-1){for(let Ut=0;Ut<E.length;Ut++)if(Ut>=A.length){A.push(nt),Ot=Ut;break}else if(A[Ut]===null){A[Ut]=nt,Ot=Ut;break}if(Ot===-1)break}let Bt=E[Ot];Bt&&Bt.connect(nt)}}let J=new N,et=new N;function it(K,at,nt){J.setFromMatrixPosition(at.matrixWorld),et.setFromMatrixPosition(nt.matrixWorld);let Ot=J.distanceTo(et),Bt=at.projectionMatrix.elements,Ut=nt.projectionMatrix.elements,Ie=Bt[14]/(Bt[10]-1),Jt=Bt[14]/(Bt[10]+1),fe=(Bt[9]+1)/Bt[5],oe=(Bt[9]-1)/Bt[5],qt=(Bt[8]-1)/Bt[0],Ne=(Ut[8]+1)/Ut[0],q=Ie*qt,bt=Ie*Ne,Ft=Ot/(-qt+Ne),Xt=Ft*-qt;if(at.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(Xt),K.translateZ(Ft),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Bt[10]===-1)K.projectionMatrix.copy(at.projectionMatrix),K.projectionMatrixInverse.copy(at.projectionMatrixInverse);else{let Kt=Ie+Ft,L=Jt+Ft,ze=q-Xt,le=bt+(Ot-Xt),C=fe*Jt/L*Kt,S=oe*Jt/L*Kt;K.projectionMatrix.makePerspective(ze,le,C,S,Kt,L),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ot(K,at){at===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(at.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let at=K.near,nt=K.far;m.texture!==null&&(m.depthNear>0&&(at=m.depthNear),m.depthFar>0&&(nt=m.depthFar)),I.near=R.near=T.near=at,I.far=R.far=T.far=nt,(W!==I.near||V!==I.far)&&(s.updateRenderState({depthNear:I.near,depthFar:I.far}),W=I.near,V=I.far),I.layers.mask=K.layers.mask|6,T.layers.mask=I.layers.mask&-5,R.layers.mask=I.layers.mask&-3;let Ot=K.parent,Bt=I.cameras;ot(I,Ot);for(let Ut=0;Ut<Bt.length;Ut++)ot(Bt[Ut],Ot);Bt.length===2?it(I,T,R):I.projectionMatrix.copy(T.projectionMatrix),_t(K,I,Ot)};function _t(K,at,nt){nt===null?K.matrix.copy(at.matrixWorld):(K.matrix.copy(nt.matrixWorld),K.matrix.invert(),K.matrix.multiply(at.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(at.projectionMatrix),K.projectionMatrixInverse.copy(at.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Gh*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(u===null&&d===null))return l},this.setFoveation=function(K){l=K,u!==null&&(u.fixedFoveation=K),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(I)},this.getCameraTexture=function(K){return f[K]};let Wt=null;function re(K,at){if(h=at.getViewerPose(c||r),g=at,h!==null){let nt=h.views;d!==null&&(t.setRenderTargetFramebuffer(v,d.framebuffer),t.setRenderTarget(v));let Ot=!1;nt.length!==I.cameras.length&&(I.cameras.length=0,Ot=!0);for(let Jt=0;Jt<nt.length;Jt++){let fe=nt[Jt],oe=null;if(d!==null)oe=d.getViewport(fe);else{let Ne=p.getViewSubImage(u,fe);oe=Ne.viewport,Jt===0&&(t.setRenderTargetTextures(v,Ne.colorTexture,Ne.depthStencilTexture),t.setRenderTarget(v))}let qt=D[Jt];qt===void 0&&(qt=new yn,qt.layers.enable(Jt),qt.viewport=new Pe,D[Jt]=qt),qt.matrix.fromArray(fe.transform.matrix),qt.matrix.decompose(qt.position,qt.quaternion,qt.scale),qt.projectionMatrix.fromArray(fe.projectionMatrix),qt.projectionMatrixInverse.copy(qt.projectionMatrix).invert(),qt.viewport.set(oe.x,oe.y,oe.width,oe.height),Jt===0&&(I.matrix.copy(qt.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Ot===!0&&I.cameras.push(qt)}let Bt=s.enabledFeatures;if(Bt&&Bt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&b){p=i.getBinding();let Jt=p.getDepthInformation(nt[0]);Jt&&Jt.isValid&&Jt.texture&&m.init(Jt,s.renderState)}if(Bt&&Bt.includes("camera-access")&&b){t.state.unbindTexture(),p=i.getBinding();for(let Jt=0;Jt<nt.length;Jt++){let fe=nt[Jt].camera;if(fe){let oe=f[fe];oe||(oe=new ql,f[fe]=oe);let qt=p.getCameraImage(fe);oe.sourceTexture=qt}}}}for(let nt=0;nt<E.length;nt++){let Ot=A[nt],Bt=E[nt];Ot!==null&&Bt!==void 0&&Bt.update(Ot,at,c||r)}Wt&&Wt(K,at),at.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:at}),g=null}let te=new cM;te.setAnimationLoop(re),this.setAnimationLoop=function(K){Wt=K},this.dispose=function(){}}},j2=new Oe,mM=new zt;mM.set(-1,0,0,0,1,0,0,0,1);function Q2(e,t){function n(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,c0(e)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,_,x,v){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?a(m,f):f.isMeshLambertMaterial?(a(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(a(m,f),p(m,f)):f.isMeshPhongMaterial?(a(m,f),h(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(a(m,f),u(m,f),f.isMeshPhysicalMaterial&&d(m,f,v)):f.isMeshMatcapMaterial?(a(m,f),g(m,f)):f.isMeshDepthMaterial?a(m,f):f.isMeshDistanceMaterial?(a(m,f),b(m,f)):f.isMeshNormalMaterial?a(m,f):f.isLineBasicMaterial?(r(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,_,x):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,n(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===An&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,n(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===An&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,n(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,n(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let _=t.get(f),x=_.envMap,v=_.envMapRotation;x&&(m.envMap.value=x,m.envMapRotation.value.setFromMatrix4(j2.makeRotationFromEuler(v)).transpose(),x.isCubeTexture&&x.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(mM),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,m.aoMapTransform))}function r(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,_,x){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*_,m.scale.value=x*.5,f.map&&(m.map.value=f.map,n(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function p(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function u(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function d(m,f,_){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===An&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=_.texture,m.transmissionSamplerSize.value.set(_.width,_.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function b(m,f){let _=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(_.matrixWorld),m.nearDistance.value=_.shadow.camera.near,m.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function $2(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,E){let A=E.program;i.uniformBlockBinding(v,A)}function c(v,E){let A=s[v.id];A===void 0&&(m(v),A=h(v),s[v.id]=A,v.addEventListener("dispose",_));let w=E.program;i.updateUBOMapping(v,w);let y=t.render.frame;a[v.id]!==y&&(u(v),a[v.id]=y)}function h(v){let E=p();v.__bindingPointIndex=E;let A=e.createBuffer(),w=v.__size,y=v.usage;return e.bindBuffer(e.UNIFORM_BUFFER,A),e.bufferData(e.UNIFORM_BUFFER,w,y),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,E,A),A}function p(){for(let v=0;v<o;v++)if(r.indexOf(v)===-1)return r.push(v),v;return It("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){let E=s[v.id],A=v.uniforms,w=v.__cache;e.bindBuffer(e.UNIFORM_BUFFER,E);for(let y=0,T=A.length;y<T;y++){let R=A[y];if(Array.isArray(R))for(let D=0,I=R.length;D<I;D++)d(R[D],y,D,w);else d(R,y,0,w)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function d(v,E,A,w){if(b(v,E,A,w)===!0){let y=v.__offset,T=v.value;if(Array.isArray(T)){let R=0;for(let D=0;D<T.length;D++){let I=T[D],W=f(I);g(I,v.__data,R),typeof I!="number"&&typeof I!="boolean"&&!I.isMatrix3&&!ArrayBuffer.isView(I)&&(R+=W.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(T,v.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,y,v.__data)}}function g(v,E,A){typeof v=="number"||typeof v=="boolean"?E[0]=v:v.isMatrix3?(E[0]=v.elements[0],E[1]=v.elements[1],E[2]=v.elements[2],E[3]=0,E[4]=v.elements[3],E[5]=v.elements[4],E[6]=v.elements[5],E[7]=0,E[8]=v.elements[6],E[9]=v.elements[7],E[10]=v.elements[8],E[11]=0):ArrayBuffer.isView(v)?E.set(new v.constructor(v.buffer,v.byteOffset,E.length)):v.toArray(E,A)}function b(v,E,A,w){let y=v.value,T=E+"_"+A;if(w[T]===void 0)return typeof y=="number"||typeof y=="boolean"?w[T]=y:ArrayBuffer.isView(y)?w[T]=y.slice():w[T]=y.clone(),!0;{let R=w[T];if(typeof y=="number"||typeof y=="boolean"){if(R!==y)return w[T]=y,!0}else{if(ArrayBuffer.isView(y))return!0;if(R.equals(y)===!1)return R.copy(y),!0}}return!1}function m(v){let E=v.uniforms,A=0,w=16;for(let T=0,R=E.length;T<R;T++){let D=Array.isArray(E[T])?E[T]:[E[T]];for(let I=0,W=D.length;I<W;I++){let V=D[I],P=Array.isArray(V.value)?V.value:[V.value];for(let k=0,X=P.length;k<X;k++){let J=P[k],et=f(J),it=A%w,ot=it%et.boundary,_t=it+ot;A+=ot,_t!==0&&w-_t<et.storage&&(A+=w-_t),V.__data=new Float32Array(et.storage/Float32Array.BYTES_PER_ELEMENT),V.__offset=A,A+=et.storage}}}let y=A%w;return y>0&&(A+=w-y),v.__size=A,v.__cache={},this}function f(v){let E={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(E.boundary=4,E.storage=4):v.isVector2?(E.boundary=8,E.storage=8):v.isVector3||v.isColor?(E.boundary=16,E.storage=12):v.isVector4?(E.boundary=16,E.storage=16):v.isMatrix3?(E.boundary=48,E.storage=48):v.isMatrix4?(E.boundary=64,E.storage=64):v.isTexture?Nt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(E.boundary=16,E.storage=v.byteLength):Nt("WebGLRenderer: Unsupported uniform value type.",v),E}function _(v){let E=v.target;E.removeEventListener("dispose",_);let A=r.indexOf(E.__bindingPointIndex);r.splice(A,1),e.deleteBuffer(s[E.id]),delete s[E.id],delete a[E.id]}function x(){for(let v in s)e.deleteBuffer(s[v]);r=[],s={},a={}}return{bind:l,update:c,dispose:x}}var t3=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Yi=null;function e3(){return Yi===null&&(Yi=new qh(t3,16,16,xa,qi),Yi.name="DFG_LUT",Yi.minFilter=pn,Yi.magFilter=pn,Yi.wrapS=Fi,Yi.wrapT=Fi,Yi.generateMipmaps=!1,Yi.needsUpdate=!0),Yi}var fd=class{constructor(t={}){let{canvas:n=Ib(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:d=$n}=t;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=r;let b=d,m=new Set([Rf,Cf,wf]),f=new Set([$n,Ei,vo,yo,Tf,Af]),_=new Uint32Array(4),x=new Int32Array(4),v=new N,E=null,A=null,w=[],y=[],T=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Mi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,D=!1,I=null,W=null,V=null,P=null;this._outputColorSpace=Tn;let k=0,X=0,J=null,et=-1,it=null,ot=new Pe,_t=new Pe,Wt=null,re=new ie(0),te=0,K=n.width,at=n.height,nt=1,Ot=null,Bt=null,Ut=new Pe(0,0,K,at),Ie=new Pe(0,0,K,at),Jt=!1,fe=new Xl,oe=!1,qt=!1,Ne=new Oe,q=new N,bt=new Pe,Ft={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Xt=!1;function Kt(){return J===null?nt:1}let L=i;function ze(M,O){return n.getContext(M,O)}try{let M={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${xf}`),n.addEventListener("webglcontextlost",Be,!1),n.addEventListener("webglcontextrestored",be,!1),n.addEventListener("webglcontextcreationerror",Ai,!1),L===null){let O="webgl2";if(L=ze(O,M),L===null)throw ze(O)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(M){throw It("WebGLRenderer: "+M.message),M}let le,C,S,z,H,Y,st,lt,Z,Q,ct,At,dt,ut,Rt,Lt,Ht,U,rt,j,ht,vt,tt;function Tt(){le=new lR(L),le.init(),ht=new Z2(L,le),C=new tR(L,le,t,ht),S=new q2(L,le),C.reversedDepthBuffer&&u&&S.buffers.depth.setReversed(!0),W=L.createFramebuffer(),V=L.createFramebuffer(),P=L.createFramebuffer(),z=new hR(L),H=new U2,Y=new Y2(L,le,S,H,C,ht,z),st=new oR(R),lt=new mA(L),vt=new QC(L,lt),Z=new cR(L,lt,z,vt),Q=new dR(L,Z,lt,vt,z),U=new fR(L,C,Y),Rt=new eR(H),ct=new N2(R,st,le,C,vt,Rt),At=new Q2(R,H),dt=new I2,ut=new V2(le),Ht=new jC(R,st,S,Q,g,l),Lt=new W2(R,Q,C),tt=new $2(L,z,C,S),rt=new $C(L,le,z),j=new uR(L,le,z),z.programs=ct.programs,R.capabilities=C,R.extensions=le,R.properties=H,R.renderLists=dt,R.shadowMap=Lt,R.state=S,R.info=z}Tt(),b!==$n&&(T=new mR(b,n.width,n.height,o,s,a));let Mt=new w0(R,L);this.xr=Mt,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let M=le.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){let M=le.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return nt},this.setPixelRatio=function(M){M!==void 0&&(nt=M,this.setSize(K,at,!1))},this.getSize=function(M){return M.set(K,at)},this.setSize=function(M,O,G=!0){if(Mt.isPresenting){Nt("WebGLRenderer: Can't change size while VR device is presenting.");return}K=M,at=O,n.width=Math.floor(M*nt),n.height=Math.floor(O*nt),G===!0&&(n.style.width=M+"px",n.style.height=O+"px"),T!==null&&T.setSize(n.width,n.height),this.setViewport(0,0,M,O)},this.getDrawingBufferSize=function(M){return M.set(K*nt,at*nt).floor()},this.setDrawingBufferSize=function(M,O,G){K=M,at=O,nt=G,n.width=Math.floor(M*G),n.height=Math.floor(O*G),this.setViewport(0,0,M,O)},this.setEffects=function(M){if(b===$n){It("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let O=0;O<M.length;O++)if(M[O].isOutputPass===!0){Nt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(ot)},this.getViewport=function(M){return M.copy(Ut)},this.setViewport=function(M,O,G,B){M.isVector4?Ut.set(M.x,M.y,M.z,M.w):Ut.set(M,O,G,B),S.viewport(ot.copy(Ut).multiplyScalar(nt).round())},this.getScissor=function(M){return M.copy(Ie)},this.setScissor=function(M,O,G,B){M.isVector4?Ie.set(M.x,M.y,M.z,M.w):Ie.set(M,O,G,B),S.scissor(_t.copy(Ie).multiplyScalar(nt).round())},this.getScissorTest=function(){return Jt},this.setScissorTest=function(M){S.setScissorTest(Jt=M)},this.setOpaqueSort=function(M){Ot=M},this.setTransparentSort=function(M){Bt=M},this.getClearColor=function(M){return M.copy(Ht.getClearColor())},this.setClearColor=function(){Ht.setClearColor(...arguments)},this.getClearAlpha=function(){return Ht.getClearAlpha()},this.setClearAlpha=function(){Ht.setClearAlpha(...arguments)},this.clear=function(M=!0,O=!0,G=!0){let B=0;if(M){let F=!1;if(J!==null){let gt=J.texture.format;F=m.has(gt)}if(F){let gt=J.texture.type,St=f.has(gt),mt=Ht.getClearColor(),Et=Ht.getClearAlpha(),wt=mt.r,Gt=mt.g,Zt=mt.b;St?(_[0]=wt,_[1]=Gt,_[2]=Zt,_[3]=Et,L.clearBufferuiv(L.COLOR,0,_)):(x[0]=wt,x[1]=Gt,x[2]=Zt,x[3]=Et,L.clearBufferiv(L.COLOR,0,x))}else B|=L.COLOR_BUFFER_BIT}O&&(B|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),G&&(B|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&L.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(M){M.setRenderer(this),I=M},this.dispose=function(){n.removeEventListener("webglcontextlost",Be,!1),n.removeEventListener("webglcontextrestored",be,!1),n.removeEventListener("webglcontextcreationerror",Ai,!1),Ht.dispose(),dt.dispose(),ut.dispose(),H.dispose(),st.dispose(),Q.dispose(),vt.dispose(),tt.dispose(),ct.dispose(),Mt.dispose(),Mt.removeEventListener("sessionstart",U0),Mt.removeEventListener("sessionend",L0),ba.stop()};function Be(M){M.preventDefault(),o0("WebGLRenderer: Context Lost."),D=!0}function be(){o0("WebGLRenderer: Context Restored."),D=!1;let M=z.autoReset,O=Lt.enabled,G=Lt.autoUpdate,B=Lt.needsUpdate,F=Lt.type;Tt(),z.autoReset=M,Lt.enabled=O,Lt.autoUpdate=G,Lt.needsUpdate=B,Lt.type=F}function Ai(M){It("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function wi(M){let O=M.target;O.removeEventListener("dispose",wi),EM(O)}function EM(M){TM(M),H.remove(M)}function TM(M){let O=H.get(M).programs;O!==void 0&&(O.forEach(function(G){ct.releaseProgram(G)}),M.isShaderMaterial&&ct.releaseShaderCache(M))}this.renderBufferDirect=function(M,O,G,B,F,gt){O===null&&(O=Ft);let St=F.isMesh&&F.matrixWorld.determinantAffine()<0,mt=CM(M,O,G,B,F);S.setMaterial(B,St);let Et=G.index,wt=1;if(B.wireframe===!0){if(Et=Z.getWireframeAttribute(G),Et===void 0)return;wt=2}let Gt=G.drawRange,Zt=G.attributes.position,Ct=Gt.start*wt,ge=(Gt.start+Gt.count)*wt;gt!==null&&(Ct=Math.max(Ct,gt.start*wt),ge=Math.min(ge,(gt.start+gt.count)*wt)),Et!==null?(Ct=Math.max(Ct,0),ge=Math.min(ge,Et.count)):Zt!=null&&(Ct=Math.max(Ct,0),ge=Math.min(ge,Zt.count));let Ge=ge-Ct;if(Ge<0||Ge===1/0)return;vt.setup(F,B,mt,G,Et);let Fe,ye=rt;if(Et!==null&&(Fe=lt.get(Et),ye=j,ye.setIndex(Fe)),F.isMesh)B.wireframe===!0?(S.setLineWidth(B.wireframeLinewidth*Kt()),ye.setMode(L.LINES)):ye.setMode(L.TRIANGLES);else if(F.isLine){let mn=B.linewidth;mn===void 0&&(mn=1),S.setLineWidth(mn*Kt()),F.isLineSegments?ye.setMode(L.LINES):F.isLineLoop?ye.setMode(L.LINE_LOOP):ye.setMode(L.LINE_STRIP)}else F.isPoints?ye.setMode(L.POINTS):F.isSprite&&ye.setMode(L.TRIANGLES);if(F.isBatchedMesh)if(le.get("WEBGL_multi_draw"))ye.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{let mn=F._multiDrawStarts,xt=F._multiDrawCounts,On=F._multiDrawCount,ce=Et?lt.get(Et).bytesPerElement:1,ti=H.get(B).currentProgram.getUniforms();for(let Ci=0;Ci<On;Ci++)ti.setValue(L,"_gl_DrawID",Ci),ye.render(mn[Ci]/ce,xt[Ci])}else if(F.isInstancedMesh)ye.renderInstances(Ct,Ge,F.count);else if(G.isInstancedBufferGeometry){let mn=G._maxInstanceCount!==void 0?G._maxInstanceCount:1/0,xt=Math.min(G.instanceCount,mn);ye.renderInstances(Ct,Ge,xt)}else ye.render(Ct,Ge)};function N0(M,O,G){M.transparent===!0&&M.side===Xi&&M.forceSinglePass===!1?(M.side=An,M.needsUpdate=!0,Ec(M,O,G),M.side=bs,M.needsUpdate=!0,Ec(M,O,G),M.side=Xi):Ec(M,O,G)}this.compile=function(M,O,G=null){G===null&&(G=M),A=ut.get(G),A.init(O),y.push(A),G.traverseVisible(function(F){F.isLight&&F.layers.test(O.layers)&&(A.pushLight(F),F.castShadow&&A.pushShadow(F))}),M!==G&&M.traverseVisible(function(F){F.isLight&&F.layers.test(O.layers)&&(A.pushLight(F),F.castShadow&&A.pushShadow(F))}),A.setupLights();let B=new Set;return M.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;let gt=F.material;if(gt)if(Array.isArray(gt))for(let St=0;St<gt.length;St++){let mt=gt[St];N0(mt,G,F),B.add(mt)}else N0(gt,G,F),B.add(gt)}),A=y.pop(),B},this.compileAsync=function(M,O,G=null){let B=this.compile(M,O,G);return new Promise(F=>{function gt(){if(B.forEach(function(St){H.get(St).currentProgram.isReady()&&B.delete(St)}),B.size===0){F(M);return}setTimeout(gt,10)}le.get("KHR_parallel_shader_compile")!==null?gt():setTimeout(gt,10)})};let _d=null;function AM(M){_d&&_d(M)}function U0(){ba.stop()}function L0(){ba.start()}let ba=new cM;ba.setAnimationLoop(AM),typeof self<"u"&&ba.setContext(self),this.setAnimationLoop=function(M){_d=M,Mt.setAnimationLoop(M),M===null?ba.stop():ba.start()},Mt.addEventListener("sessionstart",U0),Mt.addEventListener("sessionend",L0),this.render=function(M,O){if(O!==void 0&&O.isCamera!==!0){It("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;I!==null&&I.renderStart(M,O);let G=Mt.enabled===!0&&Mt.isPresenting===!0,B=T!==null&&(J===null||G)&&T.begin(R,J);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),O.parent===null&&O.matrixWorldAutoUpdate===!0&&O.updateMatrixWorld(),Mt.enabled===!0&&Mt.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(Mt.cameraAutoUpdate===!0&&Mt.updateCamera(O),O=Mt.getCamera()),M.isScene===!0&&M.onBeforeRender(R,M,O,J),A=ut.get(M,y.length),A.init(O),A.state.textureUnits=Y.getTextureUnits(),y.push(A),Ne.multiplyMatrices(O.projectionMatrix,O.matrixWorldInverse),fe.setFromProjectionMatrix(Ne,bi,O.reversedDepth),qt=this.localClippingEnabled,oe=Rt.init(this.clippingPlanes,qt),E=dt.get(M,w.length),E.init(),w.push(E),Mt.enabled===!0&&Mt.isPresenting===!0){let St=R.xr.getDepthSensingMesh();St!==null&&vd(St,O,-1/0,R.sortObjects)}vd(M,O,0,R.sortObjects),E.finish(),R.sortObjects===!0&&E.sort(Ot,Bt,O.reversedDepth),Xt=Mt.enabled===!1||Mt.isPresenting===!1||Mt.hasDepthSensing()===!1,Xt&&Ht.addToRenderList(E,M),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),oe===!0&&Rt.beginShadows();let F=A.state.shadowsArray;if(Lt.render(F,M,O),oe===!0&&Rt.endShadows(),(B&&T.hasRenderPass())===!1){let St=E.opaque,mt=E.transmissive;if(A.setupLights(),O.isArrayCamera){let Et=O.cameras;if(mt.length>0)for(let wt=0,Gt=Et.length;wt<Gt;wt++){let Zt=Et[wt];O0(St,mt,M,Zt)}Xt&&Ht.render(M);for(let wt=0,Gt=Et.length;wt<Gt;wt++){let Zt=Et[wt];I0(E,M,Zt,Zt.viewport)}}else mt.length>0&&O0(St,mt,M,O),Xt&&Ht.render(M),I0(E,M,O)}J!==null&&X===0&&(Y.updateMultisampleRenderTarget(J),Y.updateRenderTargetMipmap(J)),B&&T.end(R),M.isScene===!0&&M.onAfterRender(R,M,O),vt.resetDefaultState(),et=-1,it=null,y.pop(),y.length>0?(A=y[y.length-1],Y.setTextureUnits(A.state.textureUnits),oe===!0&&Rt.setGlobalState(R.clippingPlanes,A.state.camera)):A=null,w.pop(),w.length>0?E=w[w.length-1]:E=null,I!==null&&I.renderEnd()};function vd(M,O,G,B){if(M.visible===!1)return;if(M.layers.test(O.layers)){if(M.isGroup)G=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(O);else if(M.isLightProbeGrid)A.pushLightProbeGrid(M);else if(M.isLight)A.pushLight(M),M.castShadow&&A.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||fe.intersectsSprite(M)){B&&bt.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Ne);let St=Q.update(M),mt=M.material;mt.visible&&E.push(M,St,mt,G,bt.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||fe.intersectsObject(M))){let St=Q.update(M),mt=M.material;if(B&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),bt.copy(M.boundingSphere.center)):(St.boundingSphere===null&&St.computeBoundingSphere(),bt.copy(St.boundingSphere.center)),bt.applyMatrix4(M.matrixWorld).applyMatrix4(Ne)),Array.isArray(mt)){let Et=St.groups;for(let wt=0,Gt=Et.length;wt<Gt;wt++){let Zt=Et[wt],Ct=mt[Zt.materialIndex];Ct&&Ct.visible&&E.push(M,St,Ct,G,bt.z,Zt)}}else mt.visible&&E.push(M,St,mt,G,bt.z,null)}}let gt=M.children;for(let St=0,mt=gt.length;St<mt;St++)vd(gt[St],O,G,B)}function I0(M,O,G,B){let{opaque:F,transmissive:gt,transparent:St}=M;A.setupLightsView(G),oe===!0&&Rt.setGlobalState(R.clippingPlanes,G),B&&S.viewport(ot.copy(B)),F.length>0&&Mc(F,O,G),gt.length>0&&Mc(gt,O,G),St.length>0&&Mc(St,O,G),S.buffers.depth.setTest(!0),S.buffers.depth.setMask(!0),S.buffers.color.setMask(!0),S.setPolygonOffset(!1)}function O0(M,O,G,B){if((G.isScene===!0?G.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[B.id]===void 0){let Ct=le.has("EXT_color_buffer_half_float")||le.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[B.id]=new Jn(1,1,{generateMipmaps:!0,type:Ct?qi:$n,minFilter:va,samples:Math.max(4,C.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ne.workingColorSpace})}let gt=A.state.transmissionRenderTarget[B.id],St=B.viewport||ot;gt.setSize(St.z*R.transmissionResolutionScale,St.w*R.transmissionResolutionScale);let mt=R.getRenderTarget(),Et=R.getActiveCubeFace(),wt=R.getActiveMipmapLevel();R.setRenderTarget(gt),R.getClearColor(re),te=R.getClearAlpha(),te<1&&R.setClearColor(16777215,.5),R.clear(),Xt&&Ht.render(G);let Gt=R.toneMapping;R.toneMapping=Mi;let Zt=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),A.setupLightsView(B),oe===!0&&Rt.setGlobalState(R.clippingPlanes,B),Mc(M,G,B),Y.updateMultisampleRenderTarget(gt),Y.updateRenderTargetMipmap(gt),le.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let ge=0,Ge=O.length;ge<Ge;ge++){let Fe=O[ge],{object:ye,geometry:mn,material:xt,group:On}=Fe;if(xt.side===Xi&&ye.layers.test(B.layers)){let ce=xt.side;xt.side=An,xt.needsUpdate=!0,P0(ye,G,B,mn,xt,On),xt.side=ce,xt.needsUpdate=!0,Ct=!0}}Ct===!0&&(Y.updateMultisampleRenderTarget(gt),Y.updateRenderTargetMipmap(gt))}R.setRenderTarget(mt,Et,wt),R.setClearColor(re,te),Zt!==void 0&&(B.viewport=Zt),R.toneMapping=Gt}function Mc(M,O,G){let B=O.isScene===!0?O.overrideMaterial:null;for(let F=0,gt=M.length;F<gt;F++){let St=M[F],{object:mt,geometry:Et,group:wt}=St,Gt=St.material;Gt.allowOverride===!0&&B!==null&&(Gt=B),mt.layers.test(G.layers)&&P0(mt,O,G,Et,Gt,wt)}}function P0(M,O,G,B,F,gt){M.onBeforeRender(R,O,G,B,F,gt),M.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),F.onBeforeRender(R,O,G,B,M,gt),F.transparent===!0&&F.side===Xi&&F.forceSinglePass===!1?(F.side=An,F.needsUpdate=!0,R.renderBufferDirect(G,O,B,F,M,gt),F.side=bs,F.needsUpdate=!0,R.renderBufferDirect(G,O,B,F,M,gt),F.side=Xi):R.renderBufferDirect(G,O,B,F,M,gt),M.onAfterRender(R,O,G,B,F,gt)}function Ec(M,O,G){O.isScene!==!0&&(O=Ft);let B=H.get(M),F=A.state.lights,gt=A.state.shadowsArray,St=F.state.version,mt=ct.getParameters(M,F.state,gt,O,G,A.state.lightProbeGridArray),Et=ct.getProgramCacheKey(mt),wt=B.programs;B.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?O.environment:null,B.fog=O.fog;let Gt=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;B.envMap=st.get(M.envMap||B.environment,Gt),B.envMapRotation=B.environment!==null&&M.envMap===null?O.environmentRotation:M.envMapRotation,wt===void 0&&(M.addEventListener("dispose",wi),wt=new Map,B.programs=wt);let Zt=wt.get(Et);if(Zt!==void 0){if(B.currentProgram===Zt&&B.lightsStateVersion===St)return B0(M,mt),Zt}else mt.uniforms=ct.getUniforms(M),I!==null&&M.isNodeMaterial&&I.build(M,G,mt),M.onBeforeCompile(mt,R),Zt=ct.acquireProgram(mt,Et),wt.set(Et,Zt),B.uniforms=mt.uniforms;let Ct=B.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ct.clippingPlanes=Rt.uniform),B0(M,mt),B.needsLights=DM(M),B.lightsStateVersion=St,B.needsLights&&(Ct.ambientLightColor.value=F.state.ambient,Ct.lightProbe.value=F.state.probe,Ct.directionalLights.value=F.state.directional,Ct.directionalLightShadows.value=F.state.directionalShadow,Ct.spotLights.value=F.state.spot,Ct.spotLightShadows.value=F.state.spotShadow,Ct.rectAreaLights.value=F.state.rectArea,Ct.ltc_1.value=F.state.rectAreaLTC1,Ct.ltc_2.value=F.state.rectAreaLTC2,Ct.pointLights.value=F.state.point,Ct.pointLightShadows.value=F.state.pointShadow,Ct.hemisphereLights.value=F.state.hemi,Ct.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Ct.spotLightMatrix.value=F.state.spotLightMatrix,Ct.spotLightMap.value=F.state.spotLightMap,Ct.pointShadowMatrix.value=F.state.pointShadowMatrix),B.lightProbeGrid=A.state.lightProbeGridArray.length>0,B.currentProgram=Zt,B.uniformsList=null,Zt}function z0(M){if(M.uniformsList===null){let O=M.currentProgram.getUniforms();M.uniformsList=So.seqWithValue(O.seq,M.uniforms)}return M.uniformsList}function B0(M,O){let G=H.get(M);G.outputColorSpace=O.outputColorSpace,G.batching=O.batching,G.batchingColor=O.batchingColor,G.instancing=O.instancing,G.instancingColor=O.instancingColor,G.instancingMorph=O.instancingMorph,G.skinning=O.skinning,G.morphTargets=O.morphTargets,G.morphNormals=O.morphNormals,G.morphColors=O.morphColors,G.morphTargetsCount=O.morphTargetsCount,G.numClippingPlanes=O.numClippingPlanes,G.numIntersection=O.numClipIntersection,G.vertexAlphas=O.vertexAlphas,G.vertexTangents=O.vertexTangents,G.toneMapping=O.toneMapping}function wM(M,O){if(M.length===0)return null;if(M.length===1)return M[0].texture!==null?M[0]:null;v.setFromMatrixPosition(O.matrixWorld);for(let G=0,B=M.length;G<B;G++){let F=M[G];if(F.texture!==null&&F.boundingBox.containsPoint(v))return F}return null}function CM(M,O,G,B,F){O.isScene!==!0&&(O=Ft),Y.resetTextureUnits();let gt=O.fog,St=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?O.environment:null,mt=J===null?R.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:ne.workingColorSpace,Et=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,wt=st.get(B.envMap||St,Et),Gt=B.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,Zt=!!G.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Ct=!!G.morphAttributes.position,ge=!!G.morphAttributes.normal,Ge=!!G.morphAttributes.color,Fe=Mi;B.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Fe=R.toneMapping);let ye=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,mn=ye!==void 0?ye.length:0,xt=H.get(B),On=A.state.lights;if(oe===!0&&(qt===!0||M!==it)){let Me=M===it&&B.id===et;Rt.setState(B,M,Me)}let ce=!1;B.version===xt.__version?(xt.needsLights&&xt.lightsStateVersion!==On.state.version||xt.outputColorSpace!==mt||F.isBatchedMesh&&xt.batching===!1||!F.isBatchedMesh&&xt.batching===!0||F.isBatchedMesh&&xt.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&xt.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&xt.instancing===!1||!F.isInstancedMesh&&xt.instancing===!0||F.isSkinnedMesh&&xt.skinning===!1||!F.isSkinnedMesh&&xt.skinning===!0||F.isInstancedMesh&&xt.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&xt.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&xt.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&xt.instancingMorph===!1&&F.morphTexture!==null||xt.envMap!==wt||B.fog===!0&&xt.fog!==gt||xt.numClippingPlanes!==void 0&&(xt.numClippingPlanes!==Rt.numPlanes||xt.numIntersection!==Rt.numIntersection)||xt.vertexAlphas!==Gt||xt.vertexTangents!==Zt||xt.morphTargets!==Ct||xt.morphNormals!==ge||xt.morphColors!==Ge||xt.toneMapping!==Fe||xt.morphTargetsCount!==mn||!!xt.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(ce=!0):(ce=!0,xt.__version=B.version);let ti=xt.currentProgram;ce===!0&&(ti=Ec(B,O,F),I&&B.isNodeMaterial&&I.onUpdateProgram(B,ti,xt));let Ci=!1,Ts=!1,er=!1,xe=ti.getUniforms(),ke=xt.uniforms;if(S.useProgram(ti.program)&&(Ci=!0,Ts=!0,er=!0),B.id!==et&&(et=B.id,Ts=!0),xt.needsLights){let Me=wM(A.state.lightProbeGridArray,F);xt.lightProbeGrid!==Me&&(xt.lightProbeGrid=Me,Ts=!0)}if(Ci||it!==M){S.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),xe.setValue(L,"projectionMatrix",M.projectionMatrix),xe.setValue(L,"viewMatrix",M.matrixWorldInverse);let ws=xe.map.cameraPosition;ws!==void 0&&ws.setValue(L,q.setFromMatrixPosition(M.matrixWorld)),C.logarithmicDepthBuffer&&xe.setValue(L,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&xe.setValue(L,"isOrthographic",M.isOrthographicCamera===!0),it!==M&&(it=M,Ts=!0,er=!0)}if(xt.needsLights&&(On.state.directionalShadowMap.length>0&&xe.setValue(L,"directionalShadowMap",On.state.directionalShadowMap,Y),On.state.spotShadowMap.length>0&&xe.setValue(L,"spotShadowMap",On.state.spotShadowMap,Y),On.state.pointShadowMap.length>0&&xe.setValue(L,"pointShadowMap",On.state.pointShadowMap,Y)),F.isSkinnedMesh){xe.setOptional(L,F,"bindMatrix"),xe.setOptional(L,F,"bindMatrixInverse");let Me=F.skeleton;Me&&(Me.boneTexture===null&&Me.computeBoneTexture(),xe.setValue(L,"boneTexture",Me.boneTexture,Y))}F.isBatchedMesh&&(xe.setOptional(L,F,"batchingTexture"),xe.setValue(L,"batchingTexture",F._matricesTexture,Y),xe.setOptional(L,F,"batchingIdTexture"),xe.setValue(L,"batchingIdTexture",F._indirectTexture,Y),xe.setOptional(L,F,"batchingColorTexture"),F._colorsTexture!==null&&xe.setValue(L,"batchingColorTexture",F._colorsTexture,Y));let As=G.morphAttributes;if((As.position!==void 0||As.normal!==void 0||As.color!==void 0)&&U.update(F,G,ti),(Ts||xt.receiveShadow!==F.receiveShadow)&&(xt.receiveShadow=F.receiveShadow,xe.setValue(L,"receiveShadow",F.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&O.environment!==null&&(ke.envMapIntensity.value=O.environmentIntensity),ke.dfgLUT!==void 0&&(ke.dfgLUT.value=e3()),Ts){if(xe.setValue(L,"toneMappingExposure",R.toneMappingExposure),xt.needsLights&&RM(ke,er),gt&&B.fog===!0&&At.refreshFogUniforms(ke,gt),At.refreshMaterialUniforms(ke,B,nt,at,A.state.transmissionRenderTarget[M.id]),xt.needsLights&&xt.lightProbeGrid){let Me=xt.lightProbeGrid;ke.probesSH.value=Me.texture,ke.probesMin.value.copy(Me.boundingBox.min),ke.probesMax.value.copy(Me.boundingBox.max),ke.probesResolution.value.copy(Me.resolution)}So.upload(L,z0(xt),ke,Y)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(So.upload(L,z0(xt),ke,Y),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&xe.setValue(L,"center",F.center),xe.setValue(L,"modelViewMatrix",F.modelViewMatrix),xe.setValue(L,"normalMatrix",F.normalMatrix),xe.setValue(L,"modelMatrix",F.matrixWorld),B.uniformsGroups!==void 0){let Me=B.uniformsGroups;for(let ws=0,nr=Me.length;ws<nr;ws++){let F0=Me[ws];tt.update(F0,ti),tt.bind(F0,ti)}}return ti}function RM(M,O){M.ambientLightColor.needsUpdate=O,M.lightProbe.needsUpdate=O,M.directionalLights.needsUpdate=O,M.directionalLightShadows.needsUpdate=O,M.pointLights.needsUpdate=O,M.pointLightShadows.needsUpdate=O,M.spotLights.needsUpdate=O,M.spotLightShadows.needsUpdate=O,M.rectAreaLights.needsUpdate=O,M.hemisphereLights.needsUpdate=O}function DM(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return k},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return J},this.setRenderTargetTextures=function(M,O,G){let B=H.get(M);B.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),H.get(M.texture).__webglTexture=O,H.get(M.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:G,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,O){let G=H.get(M);G.__webglFramebuffer=O,G.__useDefaultFramebuffer=O===void 0},this.setRenderTarget=function(M,O=0,G=0){J=M,k=O,X=G;let B=null,F=!1,gt=!1;if(M){let mt=H.get(M);if(mt.__useDefaultFramebuffer!==void 0){S.bindFramebuffer(L.FRAMEBUFFER,mt.__webglFramebuffer),ot.copy(M.viewport),_t.copy(M.scissor),Wt=M.scissorTest,S.viewport(ot),S.scissor(_t),S.setScissorTest(Wt),et=-1;return}else if(mt.__webglFramebuffer===void 0)Y.setupRenderTarget(M);else if(mt.__hasExternalTextures)Y.rebindTextures(M,H.get(M.texture).__webglTexture,H.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){let Gt=M.depthTexture;if(mt.__boundDepthTexture!==Gt){if(Gt!==null&&H.has(Gt)&&(M.width!==Gt.image.width||M.height!==Gt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(M)}}let Et=M.texture;(Et.isData3DTexture||Et.isDataArrayTexture||Et.isCompressedArrayTexture)&&(gt=!0);let wt=H.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(wt[O])?B=wt[O][G]:B=wt[O],F=!0):M.samples>0&&Y.useMultisampledRTT(M)===!1?B=H.get(M).__webglMultisampledFramebuffer:Array.isArray(wt)?B=wt[G]:B=wt,ot.copy(M.viewport),_t.copy(M.scissor),Wt=M.scissorTest}else ot.copy(Ut).multiplyScalar(nt).floor(),_t.copy(Ie).multiplyScalar(nt).floor(),Wt=Jt;if(G!==0&&(B=W),S.bindFramebuffer(L.FRAMEBUFFER,B)&&S.drawBuffers(M,B),S.viewport(ot),S.scissor(_t),S.setScissorTest(Wt),F){let mt=H.get(M.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+O,mt.__webglTexture,G)}else if(gt){let mt=O;for(let Et=0;Et<M.textures.length;Et++){let wt=H.get(M.textures[Et]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+Et,wt.__webglTexture,G,mt)}}else if(M!==null&&G!==0){let mt=H.get(M.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,mt.__webglTexture,G)}et=-1},this.readRenderTargetPixels=function(M,O,G,B,F,gt,St,mt=0){if(!(M&&M.isWebGLRenderTarget)){It("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=H.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&St!==void 0&&(Et=Et[St]),Et){S.bindFramebuffer(L.FRAMEBUFFER,Et);try{let wt=M.textures[mt],Gt=wt.format,Zt=wt.type;if(M.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+mt),!C.textureFormatReadable(Gt)){It("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!C.textureTypeReadable(Zt)){It("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}O>=0&&O<=M.width-B&&G>=0&&G<=M.height-F&&L.readPixels(O,G,B,F,ht.convert(Gt),ht.convert(Zt),gt)}finally{let wt=J!==null?H.get(J).__webglFramebuffer:null;S.bindFramebuffer(L.FRAMEBUFFER,wt)}}},this.readRenderTargetPixelsAsync=async function(M,O,G,B,F,gt,St,mt=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Et=H.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&St!==void 0&&(Et=Et[St]),Et)if(O>=0&&O<=M.width-B&&G>=0&&G<=M.height-F){S.bindFramebuffer(L.FRAMEBUFFER,Et);let wt=M.textures[mt],Gt=wt.format,Zt=wt.type;if(M.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+mt),!C.textureFormatReadable(Gt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!C.textureTypeReadable(Zt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ct=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Ct),L.bufferData(L.PIXEL_PACK_BUFFER,gt.byteLength,L.STREAM_READ),L.readPixels(O,G,B,F,ht.convert(Gt),ht.convert(Zt),0);let ge=J!==null?H.get(J).__webglFramebuffer:null;S.bindFramebuffer(L.FRAMEBUFFER,ge);let Ge=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Pb(L,Ge,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,Ct),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,gt),L.deleteBuffer(Ct),L.deleteSync(Ge),gt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,O=null,G=0){let B=Math.pow(2,-G),F=Math.floor(M.image.width*B),gt=Math.floor(M.image.height*B),St=O!==null?O.x:0,mt=O!==null?O.y:0;Y.setTexture2D(M,0),L.copyTexSubImage2D(L.TEXTURE_2D,G,0,0,St,mt,F,gt),S.unbindTexture()},this.copyTextureToTexture=function(M,O,G=null,B=null,F=0,gt=0){let St,mt,Et,wt,Gt,Zt,Ct,ge,Ge,Fe=M.isCompressedTexture?M.mipmaps[gt]:M.image;if(G!==null)St=G.max.x-G.min.x,mt=G.max.y-G.min.y,Et=G.isBox3?G.max.z-G.min.z:1,wt=G.min.x,Gt=G.min.y,Zt=G.isBox3?G.min.z:0;else{let ke=Math.pow(2,-F);St=Math.floor(Fe.width*ke),mt=Math.floor(Fe.height*ke),M.isDataArrayTexture?Et=Fe.depth:M.isData3DTexture?Et=Math.floor(Fe.depth*ke):Et=1,wt=0,Gt=0,Zt=0}B!==null?(Ct=B.x,ge=B.y,Ge=B.z):(Ct=0,ge=0,Ge=0);let ye=ht.convert(O.format),mn=ht.convert(O.type),xt;O.isData3DTexture?(Y.setTexture3D(O,0),xt=L.TEXTURE_3D):O.isDataArrayTexture||O.isCompressedArrayTexture?(Y.setTexture2DArray(O,0),xt=L.TEXTURE_2D_ARRAY):(Y.setTexture2D(O,0),xt=L.TEXTURE_2D),S.activeTexture(L.TEXTURE0),S.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,O.flipY),S.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),S.pixelStorei(L.UNPACK_ALIGNMENT,O.unpackAlignment);let On=S.getParameter(L.UNPACK_ROW_LENGTH),ce=S.getParameter(L.UNPACK_IMAGE_HEIGHT),ti=S.getParameter(L.UNPACK_SKIP_PIXELS),Ci=S.getParameter(L.UNPACK_SKIP_ROWS),Ts=S.getParameter(L.UNPACK_SKIP_IMAGES);S.pixelStorei(L.UNPACK_ROW_LENGTH,Fe.width),S.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Fe.height),S.pixelStorei(L.UNPACK_SKIP_PIXELS,wt),S.pixelStorei(L.UNPACK_SKIP_ROWS,Gt),S.pixelStorei(L.UNPACK_SKIP_IMAGES,Zt);let er=M.isDataArrayTexture||M.isData3DTexture,xe=O.isDataArrayTexture||O.isData3DTexture;if(M.isDepthTexture){let ke=H.get(M),As=H.get(O),Me=H.get(ke.__renderTarget),ws=H.get(As.__renderTarget);S.bindFramebuffer(L.READ_FRAMEBUFFER,Me.__webglFramebuffer),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,ws.__webglFramebuffer);for(let nr=0;nr<Et;nr++)er&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,H.get(M).__webglTexture,F,Zt+nr),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,H.get(O).__webglTexture,gt,Ge+nr)),L.blitFramebuffer(wt,Gt,St,mt,Ct,ge,St,mt,L.DEPTH_BUFFER_BIT,L.NEAREST);S.bindFramebuffer(L.READ_FRAMEBUFFER,null),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(F!==0||M.isRenderTargetTexture||H.has(M)){let ke=H.get(M),As=H.get(O);S.bindFramebuffer(L.READ_FRAMEBUFFER,V),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,P);for(let Me=0;Me<Et;Me++)er?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,ke.__webglTexture,F,Zt+Me):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,ke.__webglTexture,F),xe?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,As.__webglTexture,gt,Ge+Me):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,As.__webglTexture,gt),F!==0?L.blitFramebuffer(wt,Gt,St,mt,Ct,ge,St,mt,L.COLOR_BUFFER_BIT,L.NEAREST):xe?L.copyTexSubImage3D(xt,gt,Ct,ge,Ge+Me,wt,Gt,St,mt):L.copyTexSubImage2D(xt,gt,Ct,ge,wt,Gt,St,mt);S.bindFramebuffer(L.READ_FRAMEBUFFER,null),S.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else xe?M.isDataTexture||M.isData3DTexture?L.texSubImage3D(xt,gt,Ct,ge,Ge,St,mt,Et,ye,mn,Fe.data):O.isCompressedArrayTexture?L.compressedTexSubImage3D(xt,gt,Ct,ge,Ge,St,mt,Et,ye,Fe.data):L.texSubImage3D(xt,gt,Ct,ge,Ge,St,mt,Et,ye,mn,Fe):M.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,gt,Ct,ge,St,mt,ye,mn,Fe.data):M.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,gt,Ct,ge,Fe.width,Fe.height,ye,Fe.data):L.texSubImage2D(L.TEXTURE_2D,gt,Ct,ge,St,mt,ye,mn,Fe);S.pixelStorei(L.UNPACK_ROW_LENGTH,On),S.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ce),S.pixelStorei(L.UNPACK_SKIP_PIXELS,ti),S.pixelStorei(L.UNPACK_SKIP_ROWS,Ci),S.pixelStorei(L.UNPACK_SKIP_IMAGES,Ts),gt===0&&O.generateMipmaps&&L.generateMipmap(xt),S.unbindTexture()},this.initRenderTarget=function(M){H.get(M).__webglFramebuffer===void 0&&Y.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?Y.setTextureCube(M,0):M.isData3DTexture?Y.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Y.setTexture2DArray(M,0):Y.setTexture2D(M,0),S.unbindTexture()},this.resetState=function(){k=0,X=0,J=null,S.reset(),vt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return bi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=ne._getDrawingBufferColorSpace(t),n.unpackColorSpace=ne._getUnpackColorSpace()}};var C0=12;var se=(e,t,n=0)=>({time:e,azimuth:t||0,elevation:n,distance:1}),gM=e=>[...Array.from({length:9},(t,n)=>se(Number((n*5/48).toFixed(6)),e*n*45)),se(1,e*360)],gc=(e,t=0)=>[se(0,0),se(.2,e/2,t/2),se(.4,e,t),se(.6,e/2,t/2),se(.8,0),se(1,0)],_M=e=>[...Array.from({length:9},(t,n)=>se(Number((n*5/48).toFixed(6)),e*n*45,n===8?0:Number((25*Math.sin(Math.PI*n/8)).toFixed(3)))),se(1,e*360)],XU=[{id:"swing",name:"Side Arc",description:"A 65-degree arc around the frame.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,65,8)]},{id:"rise",name:"Hero Rise",description:"A new angle on the action.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,35,30)]},{id:"orbit",name:"Full Orbit",description:"A full right orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:gM(1)},{id:"arc-return",name:"Arc Return",description:"Sweep 45 degrees to the side, then retrace to the starting pose.",duration:5,returnsToStart:!0,trajectory:[se(0,0),se(.2,22.5),se(.45,45),se(.7,22.5),se(.9,0),se(1,0)]},{id:"rise-return",name:"Rise Return",description:"Rise 25 degrees, then descend to the starting pose.",duration:5,returnsToStart:!0,trajectory:[se(0,0),se(.2,0,12.5),se(.45,0,25),se(.7,0,12.5),se(.9,0),se(1,0)]},{id:"orbit-left",name:"Orbit Left",description:"A full left orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:gM(-1)},{id:"arc-left-return",name:"Left Return",description:"Sweep 45 degrees left, then retrace to the opening view.",duration:5,returnsToStart:!0,trajectory:gc(-45)},{id:"wide-return",name:"Wide Return",description:"Reach a 90-degree side view, then return to the opening pose.",duration:5,returnsToStart:!0,trajectory:gc(90)},{id:"dip-return",name:"Dip Return",description:"Dip 20 degrees below the subject, then rise back to the opening view.",duration:5,returnsToStart:!0,trajectory:gc(0,-20)},{id:"high-arc-return",name:"High Return",description:"Arc 45 degrees right and 25 degrees up, then retrace home.",duration:5,returnsToStart:!0,trajectory:gc(45,25)},{id:"low-arc-return",name:"Low Return",description:"Arc 45 degrees left and 20 degrees down, then retrace home.",duration:5,returnsToStart:!0,trajectory:gc(-45,-20)},{id:"sway-return",name:"Side to Side",description:"Sway left, cross through the opening view to the right, then return.",duration:5,returnsToStart:!0,trajectory:[se(0,0),se(.2,-30),se(.4,0),se(.6,30),se(.8,0),se(1,0)]},{id:"halo",name:"High Orbit",description:"Orbit right through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:_M(1)},{id:"halo-left",name:"High Orbit Left",description:"Orbit left through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:_M(-1)},{id:"arc-left",name:"Left Arc",description:"A 65-degree left arc that finishes at a new angle.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,-65,8)]},{id:"low-angle",name:"Low Reveal",description:"Sweep 40 degrees right and descend 20 degrees for a low-angle finish.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,40,-20)]}];var ft=Tc(R0());async function Mo(e){let t=e instanceof FormData?e:new FormData;if(!(e instanceof FormData))for(let[n,i]of Object.entries(e))t.set(n,i);t.set("format","json");try{return await(await fetch(window.location.pathname,{method:"POST",body:t,credentials:"same-origin"})).json()}catch{return null}}var Sc=Math.PI/180;function _c(e,t,n){return Math.max(t,Math.min(n,e))}function bc(e,t){if(t<=e[0].time)return e[0];let n=e[e.length-1];if(t>=n.time)return n;let i=1;for(;e[i].time<t;)i++;let s=e[i-1],a=e[i],r=Math.max(1e-6,a.time-s.time),o=(t-s.time)/r,l=o*o*(3-2*o),c=a.azimuth-s.azimuth;return c=((c%360+540)%360+360)%360-180,{time:t,azimuth:s.azimuth+c*l,elevation:s.elevation+(a.elevation-s.elevation)*l,distance:s.distance+(a.distance-s.distance)*l}}var MM={time:0,azimuth:0,elevation:0,distance:1},a3={...MM,time:1},vc=1024,SM=["#f8fbff","#ffd166","#ff5d8f","#4db0ff","#39d98a"],r3=[{id:"fast",label:"Flare Fast"},{id:"detailed",label:"Flare Detailed"},{id:"turbo",label:"Turbo"},{id:"hq",label:"Sunburst HQ"}];function o3(e){let t=(0,yt.useRef)(null),n=(0,yt.useRef)([]),i=(0,yt.useRef)(!1),[s,a]=(0,yt.useState)(SM[0]),[r,o]=(0,yt.useState)(14),[l,c]=(0,yt.useState)(!1),[h,p]=(0,yt.useState)(""),[u,d]=(0,yt.useState)("fast"),[,g]=(0,yt.useState)(0),b=(0,yt.useCallback)(()=>{let _=t.current,x=_?.getContext("2d");if(!(!_||!x)){x.fillStyle="#0a1120",x.fillRect(0,0,vc,vc);for(let v of n.current){x.save(),x.globalCompositeOperation=v.erase?"destination-out":"source-over",x.strokeStyle=v.color,x.fillStyle=v.color,x.lineWidth=v.width,x.lineCap="round",x.lineJoin="round";let[E,...A]=v.points;if(!E){x.restore();continue}x.beginPath(),x.arc(E.x,E.y,v.width/2,0,Math.PI*2),x.fill(),x.beginPath(),x.moveTo(E.x,E.y);for(let w of A)x.lineTo(w.x,w.y);x.stroke(),x.restore()}}},[]);(0,yt.useEffect)(()=>b(),[b]);let m=_=>{let x=_.currentTarget.getBoundingClientRect(),v=vc/Math.max(1,Math.min(x.width,x.height));return{x:(_.clientX-x.left)*v,y:(_.clientY-x.top)*v}},f=n.current.length===0;return(0,ft.jsxs)("div",{className:"fz-sketch",children:[(0,ft.jsx)("canvas",{ref:t,className:"fz-sketch-canvas",width:vc,height:vc,onPointerDown:_=>{_.currentTarget.setPointerCapture(_.pointerId),i.current=!0,n.current.push({points:[m(_)],color:s,width:r,erase:l}),b()},onPointerMove:_=>{i.current&&(n.current[n.current.length-1]?.points.push(m(_)),b())},onPointerUp:()=>{i.current=!1,g(_=>_+1)}}),(0,ft.jsxs)("div",{className:"fz-tools",children:[SM.map(_=>(0,ft.jsx)("button",{type:"button",className:`fz-swatch${!l&&s===_?" selected":""}`,style:{background:_},"aria-label":`paint ${_}`,onClick:()=>{a(_),c(!1)}},_)),(0,ft.jsx)("button",{type:"button",className:`fz-ghost${l?" selected":""}`,onClick:()=>c(_=>!_),children:"erase"}),(0,ft.jsx)("input",{className:"fz-size",type:"range",min:4,max:60,value:r,onChange:_=>o(Number(_.target.value)),"aria-label":"brush size"}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",disabled:f,onClick:()=>{n.current=[],b(),g(_=>_+1)},children:"clear"})]}),(0,ft.jsx)("textarea",{className:"fz-prompt",placeholder:"describe the scene \u2014 'two friends at a diner, neon light'",value:h,maxLength:2e3,onChange:_=>p(_.target.value)}),(0,ft.jsx)("div",{className:"fz-modes",children:r3.map(_=>(0,ft.jsx)("button",{type:"button",className:u===_.id?"active":"",onClick:()=>d(_.id),children:_.label},_.id))}),(0,ft.jsx)("button",{type:"button",className:"fz-primary",disabled:e.busy||!h.trim(),onClick:()=>{let _=t.current;n.current.length>0&&_?_.toBlob(v=>e.onGenerate(v,h.trim(),u),"image/png"):e.onGenerate(null,h.trim(),u)},children:e.busy?"generating\u2026":"generate the still"})]})}function yc(e,t,n){let i=t/2,s=n*.46,a=t*.36*e.distance,r=n*.11*e.distance,o=e.azimuth*Sc;return{x:i+Math.sin(o)*a,y:s+n*.16+Math.cos(o)*r-Math.sin(e.elevation*Sc)*n*.3,depth:Math.cos(o)}}var xc=.95,l3=2.3;function gd(e,t){let n=e.azimuth*Sc,i=e.elevation*Sc,s=l3*e.distance;return t.set(Math.sin(n)*Math.cos(i)*s,xc+Math.sin(i)*s,Math.cos(n)*Math.cos(i)*s),t}function c3(e){let t=new fd({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),e.appendChild(t.domElement),t.domElement.style.position="absolute",t.domElement.style.inset="0";let n=[],i=V=>(n.push(V),V),s=new Vl,a=new yn(42,1,.05,80);a.position.set(3.15,2.05,3.55),a.lookAt(0,.85,0);let r=i(new nc(14,28,2902638,1451582));s.add(r);let o=1.7,l=o*.72,c=new $e(i(new da(o*1.07,l*1.1)),i(new di({color:924208})));c.position.set(0,xc,0);let h=i(new di({color:4479370})),p=i(new da(o,l)),u=new $e(p,h);u.position.set(0,xc,.001);let d=new fo(i(new Zl(p)),i(new fa({color:8240895})));d.position.copy(u.position),s.add(c,u,d);let g=i(new di({color:6348031})),b=null,m=new Vi;s.add(m);let f=i(new go(.05,16,12)),_=i(new di({color:6348031})),x=i(new di({color:16777215})),v=i(new di({color:16765286,transparent:!0})),E=new Vi;E.add(new $e(i(new go(.075,18,14)),v));let A=new $e(i(new Yl(.048,.17,12)),v);A.rotation.x=Math.PI/2,A.position.z=.14,E.add(A),s.add(E);let w=i(new ln().setFromPoints([new N,new N(0,xc,0)])),y=new ho(w,i(new Ql({color:16765286,dashSize:.09,gapSize:.09,transparent:!0,opacity:.45})));y.computeLineDistances(),s.add(y);let T=new N,R=new N(0,xc,0),D=[],I=()=>{let V=e.clientWidth,P=e.clientHeight;if(V===0||P===0)return;let k=new Dt;t.getSize(k),(k.x!==V||k.y!==P)&&(t.setSize(V,P,!1),a.aspect=V/P,a.updateProjectionMatrix()),t.render(s,a)},W=new ResizeObserver(I);return W.observe(e),{setImage(V){if(V){let P=new xn(V);P.colorSpace=Tn,P.needsUpdate=!0,h.map=P,h.color.set(16777215)}else h.map=null,h.color.set(4479370);h.needsUpdate=!0,I()},update(V,P,k){if(D=V,V.length>=2){let J=[];for(let _t=0;_t<=96;_t++)J.push(gd(bc(V,_t/96),new N));let et=new mo(J),it=new jl(et,120,.018,8,!1),ot=new $e(it,g);b&&(s.remove(b),b.geometry.dispose()),b=ot,s.add(b)}else b&&(s.remove(b),b.geometry.dispose(),b=null);m.clear(),V.forEach((J,et)=>{let it=new $e(f,et===k?x:_);it.position.copy(gd(J,T)),et===k&&it.scale.setScalar(1.3),it.userData.index=et,m.add(it)});let X=bc(V,P);E.position.copy(gd(X,T)),E.lookAt(R),v.opacity=Math.cos(X.azimuth*Sc)<-.05?.45:1,w.setFromPoints([E.position.clone(),R.clone()]),y.computeLineDistances(),I()},pick(V,P){let k=e.clientWidth,X=e.clientHeight,J=null,et=30;return D.forEach((it,ot)=>{gd(it,T).project(a);let _t=(T.x*.5+.5)*k,Wt=(-T.y*.5+.5)*X,re=Math.hypot(_t-V,Wt-P);re<et&&(et=re,J=ot)}),J},dispose(){W.disconnect(),n.forEach(V=>V.dispose()),b?.geometry.dispose(),t.dispose(),t.domElement.remove()}}}function u3(e){let t=(0,yt.useRef)(null),n=(0,yt.useRef)(null),[i,s]=(0,yt.useState)(!1),a=(0,yt.useRef)(null),r=(0,yt.useRef)(e);return r.current=e,(0,yt.useEffect)(()=>{let o=t.current;if(!o)return;let l=null;try{l=c3(o)}catch{return}return n.current=l,s(!0),()=>{n.current=null,l.dispose()}},[]),(0,yt.useEffect)(()=>{n.current?.setImage(e.image)},[i,e.image]),(0,yt.useEffect)(()=>{n.current?.update(e.keyframes,e.scrubT,e.selected)}),(0,ft.jsx)("div",{ref:t,className:"fz-stage-canvas",onPointerDown:o=>{if(!i)return;o.currentTarget.setPointerCapture(o.pointerId);let l=o.currentTarget.getBoundingClientRect(),c=n.current?.pick(o.clientX-l.left,o.clientY-l.top)??null;c!==null&&r.current.onPick(c),a.current={moved:!1,picked:c}},onPointerMove:o=>{let l=a.current;if(!l||!i)return;let c=o.movementX,h=o.movementY;Math.abs(c)+Math.abs(h)<.5||(l.moved=!0,r.current.onDragPose(c*.6,-h*.4))},onPointerUp:()=>{let o=a.current;a.current=null,!(!o||o.moved||!i)&&r.current.onPick(o.picked)},children:!i&&(0,ft.jsx)(h3,{...e})})}function h3(e){let t=(0,yt.useRef)(null),n=(0,yt.useRef)(null),i=(0,yt.useCallback)(()=>{let s=t.current,a=s?.getContext("2d");if(!s||!a)return;let r=Math.min(2,window.devicePixelRatio||1),o=s.clientWidth,l=s.clientHeight;(s.width!==o*r||s.height!==l*r)&&(s.width=o*r,s.height=l*r),a.setTransform(r,0,0,r,0,0),a.clearRect(0,0,o,l),a.strokeStyle="rgba(120,170,255,0.10)",a.lineWidth=1;let c=l*.62;for(let v=0;v<=12;v++){let E=c+Math.pow(v/12,1.6)*(l-c);a.beginPath(),a.moveTo(0,E),a.lineTo(o,E),a.stroke()}for(let v=-8;v<=8;v++)a.beginPath(),a.moveTo(o/2+v*o*.07,c),a.lineTo(o/2+v*o*.22,l),a.stroke();let h=o/2,p=l*.46,u=o*.36,d=l*.11;a.strokeStyle="rgba(125,190,255,0.22)",a.setLineDash([4,6]),a.beginPath(),a.ellipse(h,p+l*.16,u,d,0,0,Math.PI*2),a.stroke(),a.setLineDash([]);let g=e.keyframes;if(g.length>=2){a.strokeStyle="rgba(96,220,255,0.9)",a.lineWidth=3,a.lineCap="round",a.beginPath();let v=96;for(let E=0;E<=v;E++){let A=yc(bc(g,E/v),o,l);E===0?a.moveTo(A.x,A.y):a.lineTo(A.x,A.y)}a.stroke()}let b=Math.min(o*.4,l*.4*(4/3)),m=b*.72;if(a.save(),a.shadowColor="rgba(0,0,0,0.6)",a.shadowBlur=24,a.fillStyle="#0e1a30",a.fillRect(h-b/2,p-m/2,b,m),a.restore(),e.image){let v=e.image,E=Math.min(b/v.width,m/v.height),A=v.width*E,w=v.height*E;a.drawImage(v,h-A/2,p-w/2,A,w)}else a.fillStyle="rgba(219,232,255,0.5)",a.font="13px ui-monospace, monospace",a.textAlign="center",a.fillText("no photo",h,p);a.strokeStyle="rgba(125,190,255,0.5)",a.strokeRect(h-b/2,p-m/2,b,m),g.forEach((v,E)=>{let A=yc(v,o,l);a.beginPath(),a.arc(A.x,A.y,E===e.selected?7:5,0,Math.PI*2),a.fillStyle=E===e.selected?"#ffffff":"#60dcff",a.fill(),E===e.selected&&(a.strokeStyle="rgba(96,220,255,0.6)",a.lineWidth=2,a.stroke())});let f=bc(g,e.scrubT),_=yc(f,o,l),x=_.depth<-.05;a.globalAlpha=x?.45:1,a.beginPath(),a.arc(_.x,_.y,13,0,Math.PI*2),a.fillStyle="#ffd166",a.fill(),a.beginPath(),a.arc(_.x,_.y,5,0,Math.PI*2),a.fillStyle="#0a1120",a.fill(),a.strokeStyle="rgba(255,209,102,0.35)",a.setLineDash([3,5]),a.beginPath(),a.moveTo(_.x,_.y),a.lineTo(h,p),a.stroke(),a.setLineDash([]),a.globalAlpha=1},[e.image,e.keyframes,e.scrubT,e.selected]);return(0,yt.useEffect)(()=>{i()},[i]),(0,yt.useEffect)(()=>{let s=()=>i();return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[i]),(0,ft.jsx)("canvas",{ref:t,className:"fz-stage-canvas",onPointerDown:s=>{s.currentTarget.setPointerCapture(s.pointerId);let a=s.currentTarget.getBoundingClientRect(),r=s.clientX-a.left,o=s.clientY-a.top,l=e.keyframes.findIndex(c=>{let h=yc(c,a.width,a.height);return Math.hypot(h.x-r,h.y-o)<20});l>=0&&e.onPick(l),n.current={x:r,y:o,moved:!1}},onPointerMove:s=>{let a=n.current;if(!a)return;let r=s.movementX??s.clientX-a.x,o=s.movementY??s.clientY-a.y;Math.abs(r)+Math.abs(o)<.5||(a.moved=!0,a.x=s.clientX,a.y=s.clientY,e.onDragPose(r*.6,-o*.4))},onPointerUp:s=>{let a=n.current;if(n.current=null,a&&!a.moved){let r=s.currentTarget.getBoundingClientRect(),o=e.keyframes.findIndex(l=>{let c=yc(l,r.width,r.height);return Math.hypot(c.x-(s.clientX-r.left),c.y-(s.clientY-r.top))<20});e.onPick(o>=0?o:null)}}})}function f3(e){let[t,n]=(0,yt.useState)(e.initial.sourceAssetId?"camera":"source"),[i,s]=(0,yt.useState)(e.initial.sourceUrl),[a,r]=(0,yt.useState)(e.initial.sourceAssetId),[o,l]=(0,yt.useState)(e.initial.renders),[c,h]=(0,yt.useState)(e.initial.activeJob),[p,u]=(0,yt.useState)(e.initial.latest),[d,g]=(0,yt.useState)(!1),[b,m]=(0,yt.useState)(null),[f,_]=(0,yt.useState)(!1),[x,v]=(0,yt.useState)(null),[E,A]=(0,yt.useState)([MM,{time:.5,azimuth:65,elevation:8,distance:1},a3]),[w,y]=(0,yt.useState)(0),[T,R]=(0,yt.useState)(null),[D,I]=(0,yt.useState)(null),[W,V]=(0,yt.useState)(5),[P,k]=(0,yt.useState)("768P"),[X]=(0,yt.useState)(()=>Math.floor(Math.random()*1e6)),J=(0,yt.useRef)(null),[,et]=(0,yt.useState)(0),it=(0,yt.useRef)(null),ot=(0,yt.useRef)(null),_t=(0,yt.useRef)(0),Wt=(0,yt.useCallback)(q=>{if(typeof q.latest=="number"&&u(q.latest),h(q.activeJob??null),q.sourceUrl&&s(q.sourceUrl),q.sourceAssetId&&r(q.sourceAssetId),q.renders&&l(q.renders),x&&!q.activeJob){let Ft=(x.kind==="render"?q.renders:q.sketches)?.find(Xt=>Xt.jobId===x.id);Ft&&(Ft.state==="delivered"||Ft.state==="failed")&&(v(null),Ft.state==="delivered"?x.kind==="render"?(m(null),n("result")):(m("still delivered \u2014 set the camera move"),n("camera")):m(Ft.error??"that didn't come out \u2014 try again?"))}},[x]),re=(0,yt.useCallback)(async()=>{let q=await Mo({action:"status",after:String(p)});if(q)return Wt(q),q},[p,Wt]),te=(0,yt.useCallback)(()=>{let q=Date.now();q-_t.current<3e4||(_t.current=q,re())},[re]);(0,yt.useEffect)(()=>{if(!i){J.current=null;return}let q=new Image;q.crossOrigin="anonymous",q.onload=()=>{J.current=q,et(bt=>bt+1)},q.onerror=()=>te(),q.src=i},[i,te]),(0,yt.useEffect)(()=>{if(!c)return;let q=window.setInterval(()=>{re()},2500);return()=>window.clearInterval(q)},[c,re]);let K=(q,bt)=>m(q?.line??bt),at=(0,yt.useCallback)(async q=>{if(!q||d)return;g(!0),m("reading the photo\u2026");let bt=new FormData;bt.set("action","source"),bt.set("file",q);let Ft=await Mo(bt);if(g(!1),!Ft||Ft.error||Ft.sourceAssetId===void 0){K(Ft,"that photo didn't come through \u2014 try another.");return}m(null),await re(),n("camera")},[d,re]),nt=(0,yt.useCallback)(async(q,bt,Ft)=>{if(d)return;g(!0),m("generating the still \u2014 about a minute");let Xt=new FormData;Xt.set("action","source"),Xt.set("kind","sketch"),Xt.set("prompt",bt),Xt.set("mode",Ft),q&&Xt.set("canvas",q,"sketch.png");let Kt=await Mo(Xt);if(g(!1),!Kt||Kt.error||!Kt.jobId){K(Kt,"that didn't work \u2014 try again?");return}v({id:Kt.jobId,kind:"sketch"}),Wt(Kt),m("generating the still \u2014 about a minute")},[d,Wt]),Ot=(0,yt.useCallback)(q=>{I(q.id),V(q.duration===6?6:5),A(q.trajectory.map(bt=>({...bt}))),R(null),y(0)},[]),Bt=(0,yt.useCallback)(()=>{A(q=>{if(q.length>=C0)return q;let bt=_c(w,.02,.98);if(q.some(Kt=>Math.abs(Kt.time-bt)<.01))return q;let Ft=bc(q,bt);return[...q,{...Ft,time:bt}].sort((Kt,L)=>Kt.time-L.time).map(Kt=>({...Kt}))}),I(null)},[w]),Ut=(0,yt.useCallback)(()=>{A(q=>{if(T===null||q.length<=2)return q;let bt=q[T];return!bt||bt.time===0||bt.time===1?q:q.filter((Ft,Xt)=>Xt!==T)}),R(null),I(null)},[T]),Ie=(0,yt.useCallback)((q,bt)=>{I(null),A(Ft=>{let Xt=T;if(Xt===null){let ze=1/0;Ft.forEach((le,C)=>{let S=Math.abs(le.time-w);S<ze&&(ze=S,Xt=C)})}if(Xt===null)return Ft;let Kt=Ft[Xt];if(!Kt||Kt.time===0||Kt.time===1)return Ft;let L=Ft.map((ze,le)=>le===Xt?{...ze,azimuth:_c(ze.azimuth+q,-360,360),elevation:_c(ze.elevation+bt,-90,90)}:ze);return R(Xt),L})},[T,w]),Jt=(0,yt.useCallback)(async()=>{if(d||!a)return;g(!0),m("rendering the freeze \u2014 a few minutes");let q={action:"render",duration:String(W),resolution:P,seed:String(X)};D?q.preset=D:q.trajectory=JSON.stringify(E);let bt=await Mo(q);if(g(!1),!bt||bt.error||!bt.jobId){K(bt,"that render didn't start \u2014 try again?");return}v({id:bt.jobId,kind:"render"}),Wt(bt),m("freezing \u2014 a few minutes")},[d,a,D,P,X,E,W,Wt]),fe=(0,yt.useCallback)(async q=>{if(d)return;g(!0),m("sending to iMessage\u2026");let bt=await Mo({action:"save",job:q});if(g(!1),!bt||bt.error){K(bt,"couldn't send it \u2014 try again");return}bt.downloadUrl?(window.open(bt.downloadUrl,"_blank","noopener"),m("sent the link \u2014 it's only good for a little while")):m("sent to iMessage")},[d]),oe=(0,yt.useCallback)(async()=>{await Mo({action:"cancel"}),v(null),m(null),await re()},[re]),qt=(0,yt.useMemo)(()=>o.filter(q=>q.state==="delivered"&&q.outputUrl),[o]),Ne=qt[qt.length-1];return(0,ft.jsxs)("div",{className:"fz",children:[(0,ft.jsx)("div",{className:"fz-tabs",children:["source","camera","result"].map(q=>(0,ft.jsx)("button",{type:"button",className:t===q?"active":"",disabled:q==="camera"&&!a||q==="result"&&qt.length===0,onClick:()=>n(q),children:q==="source"?"1 \xB7 photo":q==="camera"?"2 \xB7 camera":"3 \xB7 freeze"},q))}),c&&(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void oe(),children:"cancel the running job"}),t==="source"&&(0,ft.jsx)("div",{className:"fz-stage",children:f?(0,ft.jsxs)(ft.Fragment,{children:[(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>_(!1),children:"\u2190 back"}),(0,ft.jsx)(o3,{busy:d||x?.kind==="sketch",onGenerate:nt})]}):(0,ft.jsxs)(ft.Fragment,{children:[(0,ft.jsxs)("div",{className:"fz-hero",children:[(0,ft.jsx)("p",{className:"fz-title",children:"freeze the scene"}),(0,ft.jsx)("p",{className:"fz-sub",children:"pick the still \u2014 the camera moves, the moment doesn\u2019t"})]}),(0,ft.jsxs)("div",{className:"fz-source-grid",children:[(0,ft.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>ot.current?.click(),children:[(0,ft.jsx)("span",{className:"fz-card-icon",children:"\u25C9"}),"take a photo"]}),(0,ft.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>it.current?.click(),children:[(0,ft.jsx)("span",{className:"fz-card-icon",children:"\u25A4"}),"upload a photo"]}),(0,ft.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>_(!0),children:[(0,ft.jsx)("span",{className:"fz-card-icon",children:"\u270E"}),"sketch + generate"]})]}),(0,ft.jsx)("input",{ref:ot,type:"file",accept:"image/*,.heic,.heif",capture:"environment",hidden:!0,onChange:q=>void at(q.target.files?.[0]??null)}),(0,ft.jsx)("input",{ref:it,type:"file",accept:"image/*,.heic,.heif",hidden:!0,onChange:q=>void at(q.target.files?.[0]??null)}),qt.length>0&&(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("result"),children:"see your freezes \u2192"})]})}),t==="camera"&&(0,ft.jsxs)("div",{className:"fz-stage",children:[(0,ft.jsx)("div",{className:"fz-stage-wrap",children:(0,ft.jsx)(u3,{image:J.current,keyframes:E,scrubT:w,selected:T,onDragPose:Ie,onPick:R})}),(0,ft.jsx)("div",{className:"fz-presets",children:e.initial.presets.map(q=>(0,ft.jsx)("button",{type:"button",className:`fz-chip${D===q.id?" active":""}`,title:q.description,onClick:()=>Ot(q),children:q.name},q.id))}),(0,ft.jsxs)("div",{className:"fz-timeline",children:[(0,ft.jsxs)("div",{className:"fz-track",onPointerDown:q=>{let bt=q.currentTarget.getBoundingClientRect();y(_c((q.clientX-bt.left)/bt.width,0,1)),q.currentTarget.setPointerCapture(q.pointerId)},onPointerMove:q=>{if(q.buttons!==1)return;let bt=q.currentTarget.getBoundingClientRect();y(_c((q.clientX-bt.left)/bt.width,0,1))},children:[(0,ft.jsx)("div",{className:"fz-track-line"}),E.map((q,bt)=>(0,ft.jsx)("button",{type:"button",className:`fz-kf${T===bt?" selected":""}`,style:{left:`${q.time*100}%`},onPointerDown:Ft=>{Ft.stopPropagation(),R(bt),y(q.time)},onClick:Ft=>Ft.stopPropagation(),"aria-label":`keyframe ${bt+1} at ${Math.round(q.time*100)}%`},bt)),(0,ft.jsx)("div",{className:"fz-head",style:{left:`${w*100}%`}})]}),(0,ft.jsxs)("div",{className:"fz-timeline-row",children:[(0,ft.jsxs)("span",{className:"fz-meta",children:[E.length," keyframes \xB7 ",W,"s",T!==null?` \xB7 keyframe ${T+1}: ${E[T].time===0||E[T].time===1?"endpoints stay":"drag the stage to change it"}`:" \xB7 tap a dot, drag the stage"]}),(0,ft.jsxs)("div",{className:"fz-timeline-actions",children:[(0,ft.jsx)("button",{type:"button",className:"fz-ghost",disabled:E.length>=C0,onClick:Bt,children:"+ keyframe"}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",disabled:T===null||E[T]?.time===0||E[T]?.time===1,onClick:Ut,children:"\u2212 remove"})]})]})]}),(0,ft.jsxs)("div",{className:"fz-render-row",children:[(0,ft.jsx)("div",{className:"fz-seg",children:[5,6].map(q=>(0,ft.jsxs)("button",{type:"button",className:W===q?"active":"",onClick:()=>V(q),children:[q,"s"]},q))}),(0,ft.jsx)("div",{className:"fz-seg",children:["480P","768P","1080P"].map(q=>(0,ft.jsx)("button",{type:"button",className:P===q?"active":"",onClick:()=>k(q),children:q==="480P"?"480":q==="768P"?"720":"1080"},q))}),(0,ft.jsx)("button",{type:"button",className:"fz-primary",disabled:d||!a||x!==null,onClick:()=>void Jt(),children:x?.kind==="render"||d?"freezing\u2026":"freeze it"})]})]}),t==="result"&&(0,ft.jsxs)("div",{className:"fz-stage",children:[Ne?(0,ft.jsxs)("div",{className:"fz-result",children:[(0,ft.jsx)("video",{className:"fz-video",src:Ne.outputUrl??void 0,controls:!0,playsInline:!0,loop:!0,autoPlay:!0,muted:!0,onError:te}),(0,ft.jsxs)("div",{className:"fz-actions",children:[(0,ft.jsx)("button",{type:"button",className:"fz-primary",disabled:d,onClick:()=>void fe(Ne.jobId),children:"send to iMessage"}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("camera"),children:"new camera move"})]})]}):c?(0,ft.jsx)("p",{className:"fz-sub",children:"rendering \u2014 this takes a few minutes"}):(0,ft.jsx)("p",{className:"fz-sub",children:"nothing rendered yet"}),qt.length>1&&(0,ft.jsx)("div",{className:"fz-history",children:qt.slice(0,-1).reverse().map(q=>(0,ft.jsxs)("div",{className:"fz-history-row",children:[(0,ft.jsx)("video",{className:"fz-thumb",src:q.outputUrl??void 0,muted:!0,playsInline:!0,preload:"metadata",onError:te}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void fe(q.jobId),children:"send"})]},q.jobId))})]}),(0,ft.jsx)("p",{className:"fz-line",children:b??""})]})}var d3=`
