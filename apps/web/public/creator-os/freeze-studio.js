...
}`,J2=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],K2=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],fM=new Ie,vc=new U,b0=new U;function j2(e,t,n){let i=new Jl,s=new Lt,a=new Lt,r=new Oe,o=new of,c=new lf,l={},h=n.maxTextureSize,p={[Ts]:An,[An]:Ts,[ti]:ti},u=new Qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Lt},radius:{value:4}},vertexShader:Y2,fragmentShader:Z2}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let m=new Ve;m.setAttribute("position",new Jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new $e(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=oc;let f=this.type;this.render=function(A,w,y){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||A.length===0)return;this.type===lS&&(It("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=oc);let M=e.getRenderTarget(),C=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),L=e.state;L.setBlending(Zi),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let P=f!==this.type;P&&w.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(B=>B.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,B=A.length;q<B;q++){let W=A[q],Y=W.shadow;if(Y===void 0){It("WebGLShadowMap:",W,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);let tt=Y.getFrameExtents();s.multiply(tt),a.copy(Y.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/tt.x),s.x=a.x*tt.x,Y.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/tt.y),s.y=a.y*tt.y,Y.mapSize.y=a.y));let ot=e.state.buffers.depth.getReversed();if(Y.camera._reversedDepth=ot,Y.map===null||P===!0){if(Y.map!==null&&(Y.map.depthTexture!==null&&(Y.map.depthTexture.dispose(),Y.map.depthTexture=null),Y.map.dispose()),this.type===xo){if(W.isPointLight){It("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}Y.map=new Kn(s.x,s.y,{format:Sa,type:Ji,minFilter:dn,magFilter:dn,generateMipmaps:!1}),Y.map.texture.name=W.name+".shadowMap",Y.map.depthTexture=new As(s.x,s.y,wi),Y.map.depthTexture.name=W.name+".shadowMapDepth",Y.map.depthTexture.format=ki,Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=on,Y.map.depthTexture.magFilter=on}else W.isPointLight?(Y.map=new fd(s.x),Y.map.depthTexture=new Kh(s.x,Ai)):(Y.map=new Kn(s.x,s.y),Y.map.depthTexture=new As(s.x,s.y,Ai)),Y.map.depthTexture.name=W.name+".shadowMap",Y.map.depthTexture.format=ki,this.type===oc?(Y.map.depthTexture.compareFunction=ot?ld:od,Y.map.depthTexture.minFilter=dn,Y.map.depthTexture.magFilter=dn):(Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=on,Y.map.depthTexture.magFilter=on);Y.camera.updateProjectionMatrix()}let ct=Y.map.isWebGLCubeRenderTarget?6:1;for(let mt=0;mt<ct;mt++){if(Y.map.isWebGLCubeRenderTarget)e.setRenderTarget(Y.map,mt),e.clear();else{mt===0&&(e.setRenderTarget(Y.map),e.clear());let xt=Y.getViewport(mt);r.set(a.x*xt.x,a.y*xt.y,a.x*xt.z,a.y*xt.w),L.viewport(r)}if(W.isPointLight){let xt=Y.camera,kt=Y.matrix,ue=W.distance||xt.far;ue!==xt.far&&(xt.far=ue,xt.updateProjectionMatrix()),vc.setFromMatrixPosition(W.matrixWorld),xt.position.copy(vc),b0.copy(xt.position),b0.add(J2[mt]),xt.up.copy(K2[mt]),xt.lookAt(b0),xt.updateMatrixWorld(),kt.makeTranslation(-vc.x,-vc.y,-vc.z),fM.multiplyMatrices(xt.projectionMatrix,xt.matrixWorldInverse),Y._frustum.setFromProjectionMatrix(fM,xt.coordinateSystem,xt.reversedDepth)}else Y.updateMatrices(W);i=Y.getFrustum(),v(w,y,Y.camera,W,this.type)}Y.isPointLightShadow!==!0&&this.type===xo&&_(Y,y),Y.needsUpdate=!1}f=this.type,g.needsUpdate=!1,e.setRenderTarget(M,C,D)};function _(A,w){let y=t.update(S);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Kn(s.x,s.y,{format:Sa,type:Ji})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,y,u,S,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,y,d,S,null)}function x(A,w,y,M){let C=null,D=y.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)C=D;else if(C=y.isPointLight===!0?c:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let L=C.uuid,P=w.uuid,q=l[L];q===void 0&&(q={},l[L]=q);let B=q[P];B===void 0&&(B=C.clone(),q[P]=B,w.addEventListener("dispose",T)),C=B}if(C.visible=w.visible,C.wireframe=w.wireframe,M===xo?C.side=w.shadowSide!==null?w.shadowSide:w.side:C.side=w.shadowSide!==null?w.shadowSide:p[w.side],C.alphaMap=w.alphaMap,C.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,C.map=w.map,C.clipShadows=w.clipShadows,C.clippingPlanes=w.clippingPlanes,C.clipIntersection=w.clipIntersection,C.displacementMap=w.displacementMap,C.displacementScale=w.displacementScale,C.displacementBias=w.displacementBias,C.wireframeLinewidth=w.wireframeLinewidth,C.linewidth=w.linewidth,y.isPointLight===!0&&C.isMeshDistanceMaterial===!0){let L=e.properties.get(C);L.light=y}return C}function v(A,w,y,M,C){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&C===xo)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,A.matrixWorld);let P=t.update(A),q=A.material;if(Array.isArray(q)){let B=P.groups;for(let W=0,Y=B.length;W<Y;W++){let tt=B[W],ot=q[tt.materialIndex];if(ot&&ot.visible){let ct=x(A,ot,M,C);A.onBeforeShadow(e,A,w,y,P,ct,tt),e.renderBufferDirect(y,null,P,ct,A,tt),A.onAfterShadow(e,A,w,y,P,ct,tt)}}}else if(q.visible){let B=x(A,q,M,C);A.onBeforeShadow(e,A,w,y,P,B,null),e.renderBufferDirect(y,null,P,B,A,null),A.onAfterShadow(e,A,w,y,P,B,null)}}let L=A.children;for(let P=0,q=L.length;P<q;P++)v(L[P],w,y,M,C)}function T(A){A.target.removeEventListener("dispose",T);for(let y in l){let M=l[y],C=A.target.uuid;C in M&&(M[C].dispose(),delete M[C])}}}function Q2(e,t){function n(){let N=!1,Q=new Oe,V=null,lt=new Oe(0,0,0,0);return{setMask:function(pt){V!==pt&&!N&&(e.colorMask(pt,pt,pt,pt),V=pt)},setLocked:function(pt){N=pt},setClear:function(pt,nt,Tt,Et,Te){Te===!0&&(pt*=Et,nt*=Et,Tt*=Et),Q.set(pt,nt,Tt,Et),lt.equals(Q)===!1&&(e.clearColor(pt,nt,Tt,Et),lt.copy(Q))},reset:function(){N=!1,V=null,lt.set(-1,0,0,0)}}}function i(){let N=!1,Q=!1,V=null,lt=null,pt=null;return{setReversed:function(nt){if(Q!==nt){let Tt=t.get("EXT_clip_control");nt?Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.ZERO_TO_ONE_EXT):Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.NEGATIVE_ONE_TO_ONE_EXT),Q=nt;let Et=pt;pt=null,this.setClear(Et)}},getReversed:function(){return Q},setTest:function(nt){nt?rt(e.DEPTH_TEST):Rt(e.DEPTH_TEST)},setMask:function(nt){V!==nt&&!N&&(e.depthMask(nt),V=nt)},setFunc:function(nt){if(Q&&(nt=HS[nt]),lt!==nt){switch(nt){case Lh:e.depthFunc(e.NEVER);break;case Ih:e.depthFunc(e.ALWAYS);break;case Oh:e.depthFunc(e.LESS);break;case Qa:e.depthFunc(e.LEQUAL);break;case Ph:e.depthFunc(e.EQUAL);break;case zh:e.depthFunc(e.GEQUAL);break;case Bh:e.depthFunc(e.GREATER);break;case Fh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}lt=nt}},setLocked:function(nt){N=nt},setClear:function(nt){pt!==nt&&(pt=nt,Q&&(nt=1-nt),e.clearDepth(nt))},reset:function(){N=!1,V=null,lt=null,pt=null,Q=!1}}}function s(){let N=!1,Q=null,V=null,lt=null,pt=null,nt=null,Tt=null,Et=null,Te=null;return{setTest:function(xe){N||(xe?rt(e.STENCIL_TEST):Rt(e.STENCIL_TEST))},setMask:function(xe){Q!==xe&&!N&&(e.stencilMask(xe),Q=xe)},setFunc:function(xe,Ci,Ri){(V!==xe||lt!==Ci||pt!==Ri)&&(e.stencilFunc(xe,Ci,Ri),V=xe,lt=Ci,pt=Ri)},setOp:function(xe,Ci,Ri){(nt!==xe||Tt!==Ci||Et!==Ri)&&(e.stencilOp(xe,Ci,Ri),nt=xe,Tt=Ci,Et=Ri)},setLocked:function(xe){N=xe},setClear:function(xe){Te!==xe&&(e.clearStencil(xe),Te=xe)},reset:function(){N=!1,Q=null,V=null,lt=null,pt=null,nt=null,Tt=null,Et=null,Te=null}}}let a=new n,r=new i,o=new s,c=new WeakMap,l=new WeakMap,h={},p={},u={},d=new WeakMap,m=[],S=null,g=!1,f=null,_=null,x=null,v=null,T=null,A=null,w=null,y=new Qt(0,0,0),M=0,C=!1,D=null,L=null,P=null,q=null,B=null,W=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),Y=!1,tt=0,ot=e.getParameter(e.VERSION);ot.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(ot)[1]),Y=tt>=1):ot.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(ot)[1]),Y=tt>=2);let ct=null,mt={},xt=e.getParameter(e.SCISSOR_BOX),kt=e.getParameter(e.VIEWPORT),ue=new Oe().fromArray(xt),Yt=new Oe().fromArray(kt);function k(N,Q,V,lt){let pt=new Uint8Array(4),nt=e.createTexture();e.bindTexture(N,nt),e.texParameteri(N,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(N,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Tt=0;Tt<V;Tt++)N===e.TEXTURE_3D||N===e.TEXTURE_2D_ARRAY?e.texImage3D(Q,0,e.RGBA,1,1,lt,0,e.RGBA,e.UNSIGNED_BYTE,pt):e.texImage2D(Q+Tt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,pt);return nt}let at={};at[e.TEXTURE_2D]=k(e.TEXTURE_2D,e.TEXTURE_2D,1),at[e.TEXTURE_CUBE_MAP]=k(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),at[e.TEXTURE_2D_ARRAY]=k(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),at[e.TEXTURE_3D]=k(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),rt(e.DEPTH_TEST),r.setFunc(Qa),Le(!1),le(Gg),rt(e.CULL_FACE),$t(Zi);function rt(N){h[N]!==!0&&(e.enable(N),h[N]=!0)}function Rt(N){h[N]!==!1&&(e.disable(N),h[N]=!1)}function Ot(N,Q){return u[N]!==Q?(e.bindFramebuffer(N,Q),u[N]=Q,N===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=Q),N===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=Q),!0):!1}function Mt(N,Q){let V=m,lt=!1;if(N){V=d.get(Q),V===void 0&&(V=[],d.set(Q,V));let pt=N.textures;if(V.length!==pt.length||V[0]!==e.COLOR_ATTACHMENT0){for(let nt=0,Tt=pt.length;nt<Tt;nt++)V[nt]=e.COLOR_ATTACHMENT0+nt;V.length=pt.length,lt=!0}}else V[0]!==e.BACK&&(V[0]=e.BACK,lt=!0);lt&&e.drawBuffers(V)}function Wt(N){return S!==N?(e.useProgram(N),S=N,!0):!1}let Dt={[ha]:e.FUNC_ADD,[uS]:e.FUNC_SUBTRACT,[hS]:e.FUNC_REVERSE_SUBTRACT};Dt[fS]=e.MIN,Dt[dS]=e.MAX;let Zt={[pS]:e.ZERO,[mS]:e.ONE,[gS]:e.SRC_COLOR,[Nh]:e.SRC_ALPHA,[SS]:e.SRC_ALPHA_SATURATE,[xS]:e.DST_COLOR,[vS]:e.DST_ALPHA,[_S]:e.ONE_MINUS_SRC_COLOR,[Uh]:e.ONE_MINUS_SRC_ALPHA,[bS]:e.ONE_MINUS_DST_COLOR,[yS]:e.ONE_MINUS_DST_ALPHA,[MS]:e.CONSTANT_COLOR,[ES]:e.ONE_MINUS_CONSTANT_COLOR,[TS]:e.CONSTANT_ALPHA,[AS]:e.ONE_MINUS_CONSTANT_ALPHA};function $t(N,Q,V,lt,pt,nt,Tt,Et,Te,xe){if(N===Zi){g===!0&&(Rt(e.BLEND),g=!1);return}if(g===!1&&(rt(e.BLEND),g=!0),N!==cS){if(N!==f||xe!==C){if((_!==ha||T!==ha)&&(e.blendEquation(e.FUNC_ADD),_=ha,T=ha),xe)switch(N){case ja:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case kg:e.blendFunc(e.ONE,e.ONE);break;case Xg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Wg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Pt("WebGLState: Invalid blending: ",N);break}else switch(N){case ja:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case kg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Xg:Pt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Wg:Pt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Pt("WebGLState: Invalid blending: ",N);break}x=null,v=null,A=null,w=null,y.set(0,0,0),M=0,f=N,C=xe}return}pt=pt||Q,nt=nt||V,Tt=Tt||lt,(Q!==_||pt!==T)&&(e.blendEquationSeparate(Dt[Q],Dt[pt]),_=Q,T=pt),(V!==x||lt!==v||nt!==A||Tt!==w)&&(e.blendFuncSeparate(Zt[V],Zt[lt],Zt[nt],Zt[Tt]),x=V,v=lt,A=nt,w=Tt),(Et.equals(y)===!1||Te!==M)&&(e.blendColor(Et.r,Et.g,Et.b,Te),y.copy(Et),M=Te),f=N,C=!1}function Bt(N,Q){N.side===ti?Rt(e.CULL_FACE):rt(e.CULL_FACE);let V=N.side===An;Q&&(V=!V),Le(V),N.blending===ja&&N.transparent===!1?$t(Zi):$t(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),r.setFunc(N.depthFunc),r.setTest(N.depthTest),r.setMask(N.depthWrite),a.setMask(N.colorWrite);let lt=N.stencilWrite;o.setTest(lt),lt&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Pe(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?rt(e.SAMPLE_ALPHA_TO_COVERAGE):Rt(e.SAMPLE_ALPHA_TO_COVERAGE)}function Le(N){D!==N&&(N?e.frontFace(e.CW):e.frontFace(e.CCW),D=N)}function le(N){N!==rS?(rt(e.CULL_FACE),N!==L&&(N===Gg?e.cullFace(e.BACK):N===oS?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Rt(e.CULL_FACE),L=N}function He(N){N!==P&&(Y&&e.lineWidth(N),P=N)}function Pe(N,Q,V){N?(rt(e.POLYGON_OFFSET_FILL),(q!==Q||B!==V)&&(q=Q,B=V,r.getReversed()&&(Q=-Q),e.polygonOffset(Q,V))):Rt(e.POLYGON_OFFSET_FILL)}function ye(N){N?rt(e.SCISSOR_TEST):Rt(e.SCISSOR_TEST)}function Ee(N){N===void 0&&(N=e.TEXTURE0+W-1),ct!==N&&(e.activeTexture(N),ct=N)}function O(N,Q,V){V===void 0&&(ct===null?V=e.TEXTURE0+W-1:V=ct);let lt=mt[V];lt===void 0&&(lt={type:void 0,texture:void 0},mt[V]=lt),(lt.type!==N||lt.texture!==Q)&&(ct!==V&&(e.activeTexture(V),ct=V),e.bindTexture(N,Q||at[N]),lt.type=N,lt.texture=Q)}function pn(){let N=mt[ct];N!==void 0&&N.type!==void 0&&(e.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function ae(){try{e.compressedTexImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function R(){try{e.compressedTexImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function b(){try{e.texSubImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function F(){try{e.texSubImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function J(){try{e.compressedTexSubImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function ut(){try{e.texStorage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function gt(){try{e.texStorage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function j(){try{e.texImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function et(){try{e.texImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function dt(N){return p[N]!==void 0?p[N]:e.getParameter(N)}function At(N,Q){p[N]!==Q&&(e.pixelStorei(N,Q),p[N]=Q)}function ft(N){ue.equals(N)===!1&&(e.scissor(N.x,N.y,N.z,N.w),ue.copy(N))}function ht(N){Yt.equals(N)===!1&&(e.viewport(N.x,N.y,N.z,N.w),Yt.copy(N))}function wt(N,Q){let V=l.get(Q);V===void 0&&(V=new WeakMap,l.set(Q,V));let lt=V.get(N);lt===void 0&&(lt=e.getUniformBlockIndex(Q,N.name),V.set(N,lt))}function I(N,Q){let lt=l.get(Q).get(N);c.get(Q)!==lt&&(e.uniformBlockBinding(Q,lt,N.__bindingPointIndex),c.set(Q,lt))}function $(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},ct=null,mt={},u={},d=new WeakMap,m=[],S=null,g=!1,f=null,_=null,x=null,v=null,T=null,A=null,w=null,y=new Qt(0,0,0),M=0,C=!1,D=null,L=null,P=null,q=null,B=null,ue.set(0,0,e.canvas.width,e.canvas.height),Yt.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:rt,disable:Rt,bindFramebuffer:Ot,drawBuffers:Mt,useProgram:Wt,setBlending:$t,setMaterial:Bt,setFlipSided:Le,setCullFace:le,setLineWidth:He,setPolygonOffset:Pe,setScissorTest:ye,activeTexture:Ee,bindTexture:O,unbindTexture:pn,compressedTexImage2D:ae,compressedTexImage3D:R,texImage2D:j,texImage3D:et,pixelStorei:At,getParameter:dt,updateUBOMapping:wt,uniformBlockBinding:I,texStorage2D:ut,texStorage3D:gt,texSubImage2D:b,texSubImage3D:F,compressedTexSubImage2D:X,compressedTexSubImage3D:J,scissor:ft,viewport:ht,reset:$}}function $2(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Lt,h=new WeakMap,p=new Set,u,d=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(R,b){return m?new OffscreenCanvas(R,b):Hl("canvas")}function g(R,b,F){let X=1,J=ae(R);if((J.width>F||J.height>F)&&(X=F/Math.max(J.width,J.height)),X<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){let ut=Math.floor(X*J.width),gt=Math.floor(X*J.height);u===void 0&&(u=S(ut,gt));let j=b?S(ut,gt):u;return j.width=ut,j.height=gt,j.getContext("2d").drawImage(R,0,0,ut,gt),It("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ut+"x"+gt+")."),j}else return"data"in R&&It("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),R;return R}function f(R){return R.generateMipmaps}function _(R){e.generateMipmap(R)}function x(R){return R.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?e.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function v(R,b,F,X,J,ut=!1){if(R!==null){if(e[R]!==void 0)return e[R];It("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let gt;X&&(gt=t.get("EXT_texture_norm16"),gt||It("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=b;if(b===e.RED&&(F===e.FLOAT&&(j=e.R32F),F===e.HALF_FLOAT&&(j=e.R16F),F===e.UNSIGNED_BYTE&&(j=e.R8),F===e.UNSIGNED_SHORT&&gt&&(j=gt.R16_EXT),F===e.SHORT&&gt&&(j=gt.R16_SNORM_EXT)),b===e.RED_INTEGER&&(F===e.UNSIGNED_BYTE&&(j=e.R8UI),F===e.UNSIGNED_SHORT&&(j=e.R16UI),F===e.UNSIGNED_INT&&(j=e.R32UI),F===e.BYTE&&(j=e.R8I),F===e.SHORT&&(j=e.R16I),F===e.INT&&(j=e.R32I)),b===e.RG&&(F===e.FLOAT&&(j=e.RG32F),F===e.HALF_FLOAT&&(j=e.RG16F),F===e.UNSIGNED_BYTE&&(j=e.RG8),F===e.UNSIGNED_SHORT&&gt&&(j=gt.RG16_EXT),F===e.SHORT&&gt&&(j=gt.RG16_SNORM_EXT)),b===e.RG_INTEGER&&(F===e.UNSIGNED_BYTE&&(j=e.RG8UI),F===e.UNSIGNED_SHORT&&(j=e.RG16UI),F===e.UNSIGNED_INT&&(j=e.RG32UI),F===e.BYTE&&(j=e.RG8I),F===e.SHORT&&(j=e.RG16I),F===e.INT&&(j=e.RG32I)),b===e.RGB_INTEGER&&(F===e.UNSIGNED_BYTE&&(j=e.RGB8UI),F===e.UNSIGNED_SHORT&&(j=e.RGB16UI),F===e.UNSIGNED_INT&&(j=e.RGB32UI),F===e.BYTE&&(j=e.RGB8I),F===e.SHORT&&(j=e.RGB16I),F===e.INT&&(j=e.RGB32I)),b===e.RGBA_INTEGER&&(F===e.UNSIGNED_BYTE&&(j=e.RGBA8UI),F===e.UNSIGNED_SHORT&&(j=e.RGBA16UI),F===e.UNSIGNED_INT&&(j=e.RGBA32UI),F===e.BYTE&&(j=e.RGBA8I),F===e.SHORT&&(j=e.RGBA16I),F===e.INT&&(j=e.RGBA32I)),b===e.RGB&&(F===e.UNSIGNED_SHORT&&gt&&(j=gt.RGB16_EXT),F===e.SHORT&&gt&&(j=gt.RGB16_SNORM_EXT),F===e.UNSIGNED_INT_5_9_9_9_REV&&(j=e.RGB9_E5),F===e.UNSIGNED_INT_10F_11F_11F_REV&&(j=e.R11F_G11F_B10F)),b===e.RGBA){let et=ut?Fl:ee.getTransfer(J);F===e.FLOAT&&(j=e.RGBA32F),F===e.HALF_FLOAT&&(j=e.RGBA16F),F===e.UNSIGNED_BYTE&&(j=et===ce?e.SRGB8_ALPHA8:e.RGBA8),F===e.UNSIGNED_SHORT&&gt&&(j=gt.RGBA16_EXT),F===e.SHORT&&gt&&(j=gt.RGBA16_SNORM_EXT),F===e.UNSIGNED_SHORT_4_4_4_4&&(j=e.RGBA4),F===e.UNSIGNED_SHORT_5_5_5_1&&(j=e.RGB5_A1)}return(j===e.R16F||j===e.R32F||j===e.RG16F||j===e.RG32F||j===e.RGBA16F||j===e.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function T(R,b){let F;return R?b===null||b===Ai||b===So?F=e.DEPTH24_STENCIL8:b===wi?F=e.DEPTH32F_STENCIL8:b===bo&&(F=e.DEPTH24_STENCIL8,It("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Ai||b===So?F=e.DEPTH_COMPONENT24:b===wi?F=e.DEPTH_COMPONENT32F:b===bo&&(F=e.DEPTH_COMPONENT16),F}function A(R,b){return f(R)===!0||R.isFramebufferTexture&&R.minFilter!==on&&R.minFilter!==dn?Math.log2(Math.max(b.width,b.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?b.mipmaps.length:1}function w(R){let b=R.target;b.removeEventListener("dispose",w),M(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&p.delete(b)}function y(R){let b=R.target;b.removeEventListener("dispose",y),D(b)}function M(R){let b=i.get(R);if(b.__webglInit===void 0)return;let F=R.source,X=d.get(F);if(X){let J=X[b.__cacheKey];J.usedTimes--,J.usedTimes===0&&C(R),Object.keys(X).length===0&&d.delete(F)}i.remove(R)}function C(R){let b=i.get(R);e.deleteTexture(b.__webglTexture);let F=R.source,X=d.get(F);delete X[b.__cacheKey],r.memory.textures--}function D(R){let b=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(b.__webglFramebuffer[X]))for(let J=0;J<b.__webglFramebuffer[X].length;J++)e.deleteFramebuffer(b.__webglFramebuffer[X][J]);else e.deleteFramebuffer(b.__webglFramebuffer[X]);b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer[X])}else{if(Array.isArray(b.__webglFramebuffer))for(let X=0;X<b.__webglFramebuffer.length;X++)e.deleteFramebuffer(b.__webglFramebuffer[X]);else e.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&e.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let X=0;X<b.__webglColorRenderbuffer.length;X++)b.__webglColorRenderbuffer[X]&&e.deleteRenderbuffer(b.__webglColorRenderbuffer[X]);b.__webglDepthRenderbuffer&&e.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let F=R.textures;for(let X=0,J=F.length;X<J;X++){let ut=i.get(F[X]);ut.__webglTexture&&(e.deleteTexture(ut.__webglTexture),r.memory.textures--),i.remove(F[X])}i.remove(R)}let L=0;function P(){L=0}function q(){return L}function B(R){L=R}function W(){let R=L;return R>=s.maxTextures&&It("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),L+=1,R}function Y(R){let b=[];return b.push(R.wrapS),b.push(R.wrapT),b.push(R.wrapR||0),b.push(R.magFilter),b.push(R.minFilter),b.push(R.anisotropy),b.push(R.internalFormat),b.push(R.format),b.push(R.type),b.push(R.generateMipmaps),b.push(R.premultiplyAlpha),b.push(R.flipY),b.push(R.unpackAlignment),b.push(R.colorSpace),b.join()}function tt(R,b){let F=i.get(R);if(R.isVideoTexture&&O(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&F.__version!==R.version){let X=R.image;if(X===null)It("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)It("WebGLRenderer: Texture marked for update but image is incomplete");else{Rt(F,R,b);return}}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,F.__webglTexture,e.TEXTURE0+b)}function ot(R,b){let F=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){Rt(F,R,b);return}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,F.__webglTexture,e.TEXTURE0+b)}function ct(R,b){let F=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){Rt(F,R,b);return}n.bindTexture(e.TEXTURE_3D,F.__webglTexture,e.TEXTURE0+b)}function mt(R,b){let F=i.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&F.__version!==R.version){Ot(F,R,b);return}n.bindTexture(e.TEXTURE_CUBE_MAP,F.__webglTexture,e.TEXTURE0+b)}let xt={[Vh]:e.REPEAT,[Hi]:e.CLAMP_TO_EDGE,[Hh]:e.MIRRORED_REPEAT},kt={[on]:e.NEAREST,[RS]:e.NEAREST_MIPMAP_NEAREST,[cc]:e.NEAREST_MIPMAP_LINEAR,[dn]:e.LINEAR,[Ef]:e.LINEAR_MIPMAP_NEAREST,[xa]:e.LINEAR_MIPMAP_LINEAR},ue={[US]:e.NEVER,[zS]:e.ALWAYS,[LS]:e.LESS,[od]:e.LEQUAL,[IS]:e.EQUAL,[ld]:e.GEQUAL,[OS]:e.GREATER,[PS]:e.NOTEQUAL};function Yt(R,b){if(b.type===wi&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===dn||b.magFilter===Ef||b.magFilter===cc||b.magFilter===xa||b.minFilter===dn||b.minFilter===Ef||b.minFilter===cc||b.minFilter===xa)&&It("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(R,e.TEXTURE_WRAP_S,xt[b.wrapS]),e.texParameteri(R,e.TEXTURE_WRAP_T,xt[b.wrapT]),(R===e.TEXTURE_3D||R===e.TEXTURE_2D_ARRAY)&&e.texParameteri(R,e.TEXTURE_WRAP_R,xt[b.wrapR]),e.texParameteri(R,e.TEXTURE_MAG_FILTER,kt[b.magFilter]),e.texParameteri(R,e.TEXTURE_MIN_FILTER,kt[b.minFilter]),b.compareFunction&&(e.texParameteri(R,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(R,e.TEXTURE_COMPARE_FUNC,ue[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===on||b.minFilter!==cc&&b.minFilter!==xa||b.type===wi&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let F=t.get("EXT_texture_filter_anisotropic");e.texParameterf(R,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function k(R,b){let F=!1;R.__webglInit===void 0&&(R.__webglInit=!0,b.addEventListener("dispose",w));let X=b.source,J=d.get(X);J===void 0&&(J={},d.set(X,J));let ut=Y(b);if(ut!==R.__cacheKey){J[ut]===void 0&&(J[ut]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,F=!0),J[ut].usedTimes++;let gt=J[R.__cacheKey];gt!==void 0&&(J[R.__cacheKey].usedTimes--,gt.usedTimes===0&&C(b)),R.__cacheKey=ut,R.__webglTexture=J[ut].texture}return F}function at(R,b,F){return Math.floor(Math.floor(R/F)/b)}function rt(R,b,F,X){let ut=R.updateRanges;if(ut.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,b.width,b.height,F,X,b.data);else{ut.sort((At,ft)=>At.start-ft.start);let gt=0;for(let At=1;At<ut.length;At++){let ft=ut[gt],ht=ut[At],wt=ft.start+ft.count,I=at(ht.start,b.width,4),$=at(ft.start,b.width,4);ht.start<=wt+1&&I===$&&at(ht.start+ht.count-1,b.width,4)===I?ft.count=Math.max(ft.count,ht.start+ht.count-ft.start):(++gt,ut[gt]=ht)}ut.length=gt+1;let j=n.getParameter(e.UNPACK_ROW_LENGTH),et=n.getParameter(e.UNPACK_SKIP_PIXELS),dt=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,b.width);for(let At=0,ft=ut.length;At<ft;At++){let ht=ut[At],wt=Math.floor(ht.start/4),I=Math.ceil(ht.count/4),$=wt%b.width,N=Math.floor(wt/b.width),Q=I,V=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,$),n.pixelStorei(e.UNPACK_SKIP_ROWS,N),n.texSubImage2D(e.TEXTURE_2D,0,$,N,Q,V,F,X,b.data)}R.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,j),n.pixelStorei(e.UNPACK_SKIP_PIXELS,et),n.pixelStorei(e.UNPACK_SKIP_ROWS,dt)}}function Rt(R,b,F){let X=e.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(X=e.TEXTURE_2D_ARRAY),b.isData3DTexture&&(X=e.TEXTURE_3D);let J=k(R,b),ut=b.source;n.bindTexture(X,R.__webglTexture,e.TEXTURE0+F);let gt=i.get(ut);if(ut.version!==gt.__version||J===!0){if(n.activeTexture(e.TEXTURE0+F),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){let V=ee.getPrimaries(ee.workingColorSpace),lt=b.colorSpace===ws?null:ee.getPrimaries(b.colorSpace),pt=b.colorSpace===ws||V===lt?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,pt)}n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment);let et=g(b.image,!1,s.maxTextureSize);et=pn(b,et);let dt=a.convert(b.format,b.colorSpace),At=a.convert(b.type),ft=v(b.internalFormat,dt,At,b.normalized,b.colorSpace,b.isVideoTexture);Yt(X,b);let ht,wt=b.mipmaps,I=b.isVideoTexture!==!0,$=gt.__version===void 0||J===!0,N=ut.dataReady,Q=A(b,et);if(b.isDepthTexture)ft=T(b.format===ba,b.type),$&&(I?n.texStorage2D(e.TEXTURE_2D,1,ft,et.width,et.height):n.texImage2D(e.TEXTURE_2D,0,ft,et.width,et.height,0,dt,At,null));else if(b.isDataTexture)if(wt.length>0){I&&$&&n.texStorage2D(e.TEXTURE_2D,Q,ft,wt[0].width,wt[0].height);for(let V=0,lt=wt.length;V<lt;V++)ht=wt[V],I?N&&n.texSubImage2D(e.TEXTURE_2D,V,0,0,ht.width,ht.height,dt,At,ht.data):n.texImage2D(e.TEXTURE_2D,V,ft,ht.width,ht.height,0,dt,At,ht.data);b.generateMipmaps=!1}else I?($&&n.texStorage2D(e.TEXTURE_2D,Q,ft,et.width,et.height),N&&rt(b,et,dt,At)):n.texImage2D(e.TEXTURE_2D,0,ft,et.width,et.height,0,dt,At,et.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){I&&$&&n.texStorage3D(e.TEXTURE_2D_ARRAY,Q,ft,wt[0].width,wt[0].height,et.depth);for(let V=0,lt=wt.length;V<lt;V++)if(ht=wt[V],b.format!==_i)if(dt!==null)if(I){if(N)if(b.layerUpdates.size>0){let pt=m0(ht.width,ht.height,b.format,b.type);for(let nt of b.layerUpdates){let Tt=ht.data.subarray(nt*pt/ht.data.BYTES_PER_ELEMENT,(nt+1)*pt/ht.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,V,0,0,nt,ht.width,ht.height,1,dt,Tt)}b.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,V,0,0,0,ht.width,ht.height,et.depth,dt,ht.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,V,ft,ht.width,ht.height,et.depth,0,ht.data,0,0);else It("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?N&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,V,0,0,0,ht.width,ht.height,et.depth,dt,At,ht.data):n.texImage3D(e.TEXTURE_2D_ARRAY,V,ft,ht.width,ht.height,et.depth,0,dt,At,ht.data)}else{I&&$&&n.texStorage2D(e.TEXTURE_2D,Q,ft,wt[0].width,wt[0].height);for(let V=0,lt=wt.length;V<lt;V++)ht=wt[V],b.format!==_i?dt!==null?I?N&&n.compressedTexSubImage2D(e.TEXTURE_2D,V,0,0,ht.width,ht.height,dt,ht.data):n.compressedTexImage2D(e.TEXTURE_2D,V,ft,ht.width,ht.height,0,ht.data):It("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?N&&n.texSubImage2D(e.TEXTURE_2D,V,0,0,ht.width,ht.height,dt,At,ht.data):n.texImage2D(e.TEXTURE_2D,V,ft,ht.width,ht.height,0,dt,At,ht.data)}else if(b.isDataArrayTexture)if(I){if($&&n.texStorage3D(e.TEXTURE_2D_ARRAY,Q,ft,et.width,et.height,et.depth),N)if(b.layerUpdates.size>0){let V=m0(et.width,et.height,b.format,b.type);for(let lt of b.layerUpdates){let pt=et.data.subarray(lt*V/et.data.BYTES_PER_ELEMENT,(lt+1)*V/et.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,lt,et.width,et.height,1,dt,At,pt)}b.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,dt,At,et.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,ft,et.width,et.height,et.depth,0,dt,At,et.data);else if(b.isData3DTexture)I?($&&n.texStorage3D(e.TEXTURE_3D,Q,ft,et.width,et.height,et.depth),N&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,dt,At,et.data)):n.texImage3D(e.TEXTURE_3D,0,ft,et.width,et.height,et.depth,0,dt,At,et.data);else if(b.isFramebufferTexture){if($)if(I)n.texStorage2D(e.TEXTURE_2D,Q,ft,et.width,et.height);else{let V=et.width,lt=et.height;for(let pt=0;pt<Q;pt++)n.texImage2D(e.TEXTURE_2D,pt,ft,V,lt,0,dt,At,null),V>>=1,lt>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in e){let V=e.canvas;if(V.hasAttribute("layoutsubtree")||V.setAttribute("layoutsubtree","true"),et.parentNode!==V){V.appendChild(et),p.add(b),V.onpaint=lt=>{let pt=lt.changedElements;for(let nt of p)pt.includes(nt.image)&&(nt.needsUpdate=!0)},V.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,et);else{let pt=e.RGBA,nt=e.RGBA,Tt=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,pt,nt,Tt,et)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(wt.length>0){if(I&&$){let V=ae(wt[0]);n.texStorage2D(e.TEXTURE_2D,Q,ft,V.width,V.height)}for(let V=0,lt=wt.length;V<lt;V++)ht=wt[V],I?N&&n.texSubImage2D(e.TEXTURE_2D,V,0,0,dt,At,ht):n.texImage2D(e.TEXTURE_2D,V,ft,dt,At,ht);b.generateMipmaps=!1}else if(I){if($){let V=ae(et);n.texStorage2D(e.TEXTURE_2D,Q,ft,V.width,V.height)}N&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,dt,At,et)}else n.texImage2D(e.TEXTURE_2D,0,ft,dt,At,et);f(b)&&_(X),gt.__version=ut.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function Ot(R,b,F){if(b.image.length!==6)return;let X=k(R,b),J=b.source;n.bindTexture(e.TEXTURE_CUBE_MAP,R.__webglTexture,e.TEXTURE0+F);let ut=i.get(J);if(J.version!==ut.__version||X===!0){n.activeTexture(e.TEXTURE0+F);let gt=ee.getPrimaries(ee.workingColorSpace),j=b.colorSpace===ws?null:ee.getPrimaries(b.colorSpace),et=b.colorSpace===ws||gt===j?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);let dt=b.isCompressedTexture||b.image[0].isCompressedTexture,At=b.image[0]&&b.image[0].isDataTexture,ft=[];for(let nt=0;nt<6;nt++)!dt&&!At?ft[nt]=g(b.image[nt],!0,s.maxCubemapSize):ft[nt]=At?b.image[nt].image:b.image[nt],ft[nt]=pn(b,ft[nt]);let ht=ft[0],wt=a.convert(b.format,b.colorSpace),I=a.convert(b.type),$=v(b.internalFormat,wt,I,b.normalized,b.colorSpace),N=b.isVideoTexture!==!0,Q=ut.__version===void 0||X===!0,V=J.dataReady,lt=A(b,ht);Yt(e.TEXTURE_CUBE_MAP,b);let pt;if(dt){N&&Q&&n.texStorage2D(e.TEXTURE_CUBE_MAP,lt,$,ht.width,ht.height);for(let nt=0;nt<6;nt++){pt=ft[nt].mipmaps;for(let Tt=0;Tt<pt.length;Tt++){let Et=pt[Tt];b.format!==_i?wt!==null?N?V&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt,0,0,Et.width,Et.height,wt,Et.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt,$,Et.width,Et.height,0,Et.data):It("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt,0,0,Et.width,Et.height,wt,I,Et.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt,$,Et.width,Et.height,0,wt,I,Et.data)}}}else{if(pt=b.mipmaps,N&&Q){pt.length>0&&lt++;let nt=ae(ft[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,lt,$,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(At){N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,ft[nt].width,ft[nt].height,wt,I,ft[nt].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,$,ft[nt].width,ft[nt].height,0,wt,I,ft[nt].data);for(let Tt=0;Tt<pt.length;Tt++){let Te=pt[Tt].image[nt].image;N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt+1,0,0,Te.width,Te.height,wt,I,Te.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt+1,$,Te.width,Te.height,0,wt,I,Te.data)}}else{N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,wt,I,ft[nt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,$,wt,I,ft[nt]);for(let Tt=0;Tt<pt.length;Tt++){let Et=pt[Tt];N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt+1,0,0,wt,I,Et.image[nt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Tt+1,$,wt,I,Et.image[nt])}}}f(b)&&_(e.TEXTURE_CUBE_MAP),ut.__version=J.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function Mt(R,b,F,X,J,ut){let gt=a.convert(F.format,F.colorSpace),j=a.convert(F.type),et=v(F.internalFormat,gt,j,F.normalized,F.colorSpace),dt=i.get(b),At=i.get(F);if(At.__renderTarget=b,!dt.__hasExternalTextures){let ft=Math.max(1,b.width>>ut),ht=Math.max(1,b.height>>ut);J===e.TEXTURE_3D||J===e.TEXTURE_2D_ARRAY?n.texImage3D(J,ut,et,ft,ht,b.depth,0,gt,j,null):n.texImage2D(J,ut,et,ft,ht,0,gt,j,null)}n.bindFramebuffer(e.FRAMEBUFFER,R),Ee(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,X,J,At.__webglTexture,0,ye(b)):(J===e.TEXTURE_2D||J>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,X,J,At.__webglTexture,ut),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Wt(R,b,F){if(e.bindRenderbuffer(e.RENDERBUFFER,R),b.depthBuffer){let X=b.depthTexture,J=X&&X.isDepthTexture?X.type:null,ut=T(b.stencilBuffer,J),gt=b.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Ee(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,ye(b),ut,b.width,b.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,ye(b),ut,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,ut,b.width,b.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,gt,e.RENDERBUFFER,R)}else{let X=b.textures;for(let J=0;J<X.length;J++){let ut=X[J],gt=a.convert(ut.format,ut.colorSpace),j=a.convert(ut.type),et=v(ut.internalFormat,gt,j,ut.normalized,ut.colorSpace);Ee(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,ye(b),et,b.width,b.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,ye(b),et,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,et,b.width,b.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Dt(R,b,F){let X=b.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,R),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=i.get(b.depthTexture);if(J.__renderTarget=b,(!J.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),X){if(J.__webglInit===void 0&&(J.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),J.__webglTexture===void 0){J.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,J.__webglTexture),Yt(e.TEXTURE_CUBE_MAP,b.depthTexture);let dt=a.convert(b.depthTexture.format),At=a.convert(b.depthTexture.type),ft;b.depthTexture.format===ki?ft=e.DEPTH_COMPONENT24:b.depthTexture.format===ba&&(ft=e.DEPTH24_STENCIL8);for(let ht=0;ht<6;ht++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,ft,b.width,b.height,0,dt,At,null)}}else tt(b.depthTexture,0);let ut=J.__webglTexture,gt=ye(b),j=X?e.TEXTURE_CUBE_MAP_POSITIVE_X+F:e.TEXTURE_2D,et=b.depthTexture.format===ba?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(b.depthTexture.format===ki)Ee(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,j,ut,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,j,ut,0);else if(b.depthTexture.format===ba)Ee(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,j,ut,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,j,ut,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Zt(R){let b=i.get(R),F=R.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==R.depthTexture){let X=R.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),X){let J=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,X.removeEventListener("dispose",J)};X.addEventListener("dispose",J),b.__depthDisposeCallback=J}b.__boundDepthTexture=X}if(R.depthTexture&&!b.__autoAllocateDepthBuffer)if(F)for(let X=0;X<6;X++)Dt(b.__webglFramebuffer[X],R,X);else{let X=R.texture.mipmaps;X&&X.length>0?Dt(b.__webglFramebuffer[0],R,0):Dt(b.__webglFramebuffer,R,0)}else if(F){b.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[X]),b.__webglDepthbuffer[X]===void 0)b.__webglDepthbuffer[X]=e.createRenderbuffer(),Wt(b.__webglDepthbuffer[X],R,!1);else{let J=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ut=b.__webglDepthbuffer[X];e.bindRenderbuffer(e.RENDERBUFFER,ut),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,ut)}}else{let X=R.texture.mipmaps;if(X&&X.length>0?n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=e.createRenderbuffer(),Wt(b.__webglDepthbuffer,R,!1);else{let J=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ut=b.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,ut),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,ut)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function $t(R,b,F){let X=i.get(R);b!==void 0&&Mt(X.__webglFramebuffer,R,R.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),F!==void 0&&Zt(R)}function Bt(R){let b=R.texture,F=i.get(R),X=i.get(b);R.addEventListener("dispose",y);let J=R.textures,ut=R.isWebGLCubeRenderTarget===!0,gt=J.length>1;if(gt||(X.__webglTexture===void 0&&(X.__webglTexture=e.createTexture()),X.__version=b.version,r.memory.textures++),ut){F.__webglFramebuffer=[];for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0){F.__webglFramebuffer[j]=[];for(let et=0;et<b.mipmaps.length;et++)F.__webglFramebuffer[j][et]=e.createFramebuffer()}else F.__webglFramebuffer[j]=e.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){F.__webglFramebuffer=[];for(let j=0;j<b.mipmaps.length;j++)F.__webglFramebuffer[j]=e.createFramebuffer()}else F.__webglFramebuffer=e.createFramebuffer();if(gt)for(let j=0,et=J.length;j<et;j++){let dt=i.get(J[j]);dt.__webglTexture===void 0&&(dt.__webglTexture=e.createTexture(),r.memory.textures++)}if(R.samples>0&&Ee(R)===!1){F.__webglMultisampledFramebuffer=e.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let j=0;j<J.length;j++){let et=J[j];F.__webglColorRenderbuffer[j]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,F.__webglColorRenderbuffer[j]);let dt=a.convert(et.format,et.colorSpace),At=a.convert(et.type),ft=v(et.internalFormat,dt,At,et.normalized,et.colorSpace,R.isXRRenderTarget===!0),ht=ye(R);e.renderbufferStorageMultisample(e.RENDERBUFFER,ht,ft,R.width,R.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+j,e.RENDERBUFFER,F.__webglColorRenderbuffer[j])}e.bindRenderbuffer(e.RENDERBUFFER,null),R.depthBuffer&&(F.__webglDepthRenderbuffer=e.createRenderbuffer(),Wt(F.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(ut){n.bindTexture(e.TEXTURE_CUBE_MAP,X.__webglTexture),Yt(e.TEXTURE_CUBE_MAP,b);for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)Mt(F.__webglFramebuffer[j][et],R,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+j,et);else Mt(F.__webglFramebuffer[j],R,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(b)&&_(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(gt){for(let j=0,et=J.length;j<et;j++){let dt=J[j],At=i.get(dt),ft=e.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ft=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ft,At.__webglTexture),Yt(ft,dt),Mt(F.__webglFramebuffer,R,dt,e.COLOR_ATTACHMENT0+j,ft,0),f(dt)&&_(ft)}n.unbindTexture()}else{let j=e.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(j=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(j,X.__webglTexture),Yt(j,b),b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)Mt(F.__webglFramebuffer[et],R,b,e.COLOR_ATTACHMENT0,j,et);else Mt(F.__webglFramebuffer,R,b,e.COLOR_ATTACHMENT0,j,0);f(b)&&_(j),n.unbindTexture()}R.depthBuffer&&Zt(R)}function Le(R){let b=R.textures;for(let F=0,X=b.length;F<X;F++){let J=b[F];if(f(J)){let ut=x(R),gt=i.get(J).__webglTexture;n.bindTexture(ut,gt),_(ut),n.unbindTexture()}}}let le=[],He=[];function Pe(R){if(R.samples>0){if(Ee(R)===!1){let b=R.textures,F=R.width,X=R.height,J=e.COLOR_BUFFER_BIT,ut=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,gt=i.get(R),j=b.length>1;if(j)for(let dt=0;dt<b.length;dt++)n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);let et=R.texture.mipmaps;et&&et.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let dt=0;dt<b.length;dt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(J|=e.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(J|=e.STENCIL_BUFFER_BIT)),j){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,gt.__webglColorRenderbuffer[dt]);let At=i.get(b[dt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,At,0)}e.blitFramebuffer(0,0,F,X,0,0,F,X,J,e.NEAREST),c===!0&&(le.length=0,He.length=0,le.push(e.COLOR_ATTACHMENT0+dt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(le.push(ut),He.push(ut),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,He)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,le))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),j)for(let dt=0;dt<b.length;dt++){n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.RENDERBUFFER,gt.__webglColorRenderbuffer[dt]);let At=i.get(b[dt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.TEXTURE_2D,At,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&c){let b=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[b])}}}function ye(R){return Math.min(s.maxSamples,R.samples)}function Ee(R){let b=i.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function O(R){let b=r.render.frame;h.get(R)!==b&&(h.set(R,b),R.update())}function pn(R,b){let F=R.colorSpace,X=R.format,J=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||F!==Bl&&F!==ws&&(ee.getTransfer(F)===ce?(X!==_i||J!==ei)&&It("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Pt("WebGLTextures: Unsupported texture color space:",F)),b}function ae(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=W,this.resetTextureUnits=P,this.getTextureUnits=q,this.setTextureUnits=B,this.setTexture2D=tt,this.setTexture2DArray=ot,this.setTexture3D=ct,this.setTextureCube=mt,this.rebindTextures=$t,this.setupRenderTarget=Bt,this.updateRenderTargetMipmap=Le,this.updateMultisampleRenderTarget=Pe,this.setupDepthRenderbuffer=Zt,this.setupFrameBufferTexture=Mt,this.useMultisampledRTT=Ee,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function t3(e,t){function n(i,s=ws){let a,r=ee.getTransfer(s);if(i===ei)return e.UNSIGNED_BYTE;if(i===Af)return e.UNSIGNED_SHORT_4_4_4_4;if(i===wf)return e.UNSIGNED_SHORT_5_5_5_1;if(i===i0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===s0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===e0)return e.BYTE;if(i===n0)return e.SHORT;if(i===bo)return e.UNSIGNED_SHORT;if(i===Tf)return e.INT;if(i===Ai)return e.UNSIGNED_INT;if(i===wi)return e.FLOAT;if(i===Ji)return e.HALF_FLOAT;if(i===a0)return e.ALPHA;if(i===r0)return e.RGB;if(i===_i)return e.RGBA;if(i===ki)return e.DEPTH_COMPONENT;if(i===ba)return e.DEPTH_STENCIL;if(i===o0)return e.RED;if(i===Cf)return e.RED_INTEGER;if(i===Sa)return e.RG;if(i===Rf)return e.RG_INTEGER;if(i===Df)return e.RGBA_INTEGER;if(i===uc||i===hc||i===fc||i===dc)if(r===ce)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===uc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===hc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===dc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===uc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===hc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===dc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Nf||i===Uf||i===Lf||i===If)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Nf)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===If)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Of||i===Pf||i===zf||i===Bf||i===Ff||i===pc||i===Vf)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Of||i===Pf)return r===ce?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===zf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Bf)return a.COMPRESSED_R11_EAC;if(i===Ff)return a.COMPRESSED_SIGNED_R11_EAC;if(i===pc)return a.COMPRESSED_RG11_EAC;if(i===Vf)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f||i===td)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Hf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Gf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===kf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Xf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Wf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===qf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Yf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Zf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Jf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Kf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===jf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Qf)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===$f)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===td)return r===ce?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ed||i===nd||i===id)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===ed)return r===ce?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===nd)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===id)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===sd||i===ad||i===mc||i===rd)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===sd)return a.COMPRESSED_RED_RGTC1_EXT;if(i===ad)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===mc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===rd)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===So?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var e3=`
void main() {
...
}`,R0=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new jl(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new Qn({vertexShader:e3,fragmentShader:n3,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new $e(new ma(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},D0=class extends Xi{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",c=1,l=null,h=null,p=null,u=null,d=null,m=null,S=typeof XRWebGLBinding<"u",g=new R0,f={},_=n.getContextAttributes(),x=null,v=null,T=[],A=[],w=new Lt,y=null,M=new yn;M.viewport=new Oe;let C=new yn;C.viewport=new Oe;let D=[M,C],L=new xf,P=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(k){let at=T[k];return at===void 0&&(at=new mo,T[k]=at),at.getTargetRaySpace()},this.getControllerGrip=function(k){let at=T[k];return at===void 0&&(at=new mo,T[k]=at),at.getGripSpace()},this.getHand=function(k){let at=T[k];return at===void 0&&(at=new mo,T[k]=at),at.getHandSpace()};function B(k){let at=A.indexOf(k.inputSource);if(at===-1)return;let rt=T[at];rt!==void 0&&(rt.update(k.inputSource,k.frame,l||r),rt.dispatchEvent({type:k.type,data:k.inputSource}))}function W(){s.removeEventListener("select",B),s.removeEventListener("selectstart",B),s.removeEventListener("selectend",B),s.removeEventListener("squeeze",B),s.removeEventListener("squeezestart",B),s.removeEventListener("squeezeend",B),s.removeEventListener("end",W),s.removeEventListener("inputsourceschange",Y);for(let k=0;k<T.length;k++){let at=A[k];at!==null&&(A[k]=null,T[k].disconnect(at))}P=null,q=null,g.reset();for(let k in f)delete f[k];t.setRenderTarget(x),d=null,u=null,p=null,s=null,v=null,Yt.stop(),i.isPresenting=!1,t.setPixelRatio(y),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(k){a=k,i.isPresenting===!0&&It("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(k){o=k,i.isPresenting===!0&&It("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||r},this.setReferenceSpace=function(k){l=k},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return p===null&&S&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(k){if(s=k,s!==null){if(x=t.getRenderTarget(),s.addEventListener("select",B),s.addEventListener("selectstart",B),s.addEventListener("selectend",B),s.addEventListener("squeeze",B),s.addEventListener("squeezestart",B),s.addEventListener("squeezeend",B),s.addEventListener("end",W),s.addEventListener("inputsourceschange",Y),_.xrCompatible!==!0&&await n.makeXRCompatible(),y=t.getPixelRatio(),t.getSize(w),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let rt=null,Rt=null,Ot=null;_.depth&&(Ot=_.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,rt=_.stencil?ba:ki,Rt=_.stencil?So:Ai);let Mt={colorFormat:n.RGBA8,depthFormat:Ot,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(Mt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),v=new Kn(u.textureWidth,u.textureHeight,{format:_i,type:ei,depthTexture:new As(u.textureWidth,u.textureHeight,Rt,void 0,void 0,void 0,void 0,void 0,void 0,rt),stencilBuffer:_.stencil,colorSpace:t.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let rt={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(s,n,rt),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),v=new Kn(d.framebufferWidth,d.framebufferHeight,{format:_i,type:ei,colorSpace:t.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(c),l=null,r=await s.requestReferenceSpace(o),Yt.setContext(s),Yt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function Y(k){for(let at=0;at<k.removed.length;at++){let rt=k.removed[at],Rt=A.indexOf(rt);Rt>=0&&(A[Rt]=null,T[Rt].disconnect(rt))}for(let at=0;at<k.added.length;at++){let rt=k.added[at],Rt=A.indexOf(rt);if(Rt===-1){for(let Mt=0;Mt<T.length;Mt++)if(Mt>=A.length){A.push(rt),Rt=Mt;break}else if(A[Mt]===null){A[Mt]=rt,Rt=Mt;break}if(Rt===-1)break}let Ot=T[Rt];Ot&&Ot.connect(rt)}}let tt=new U,ot=new U;function ct(k,at,rt){tt.setFromMatrixPosition(at.matrixWorld),ot.setFromMatrixPosition(rt.matrixWorld);let Rt=tt.distanceTo(ot),Ot=at.projectionMatrix.elements,Mt=rt.projectionMatrix.elements,Wt=Ot[14]/(Ot[10]-1),Dt=Ot[14]/(Ot[10]+1),Zt=(Ot[9]+1)/Ot[5],$t=(Ot[9]-1)/Ot[5],Bt=(Ot[8]-1)/Ot[0],Le=(Mt[8]+1)/Mt[0],le=Wt*Bt,He=Wt*Le,Pe=Rt/(-Bt+Le),ye=Pe*-Bt;if(at.matrixWorld.decompose(k.position,k.quaternion,k.scale),k.translateX(ye),k.translateZ(Pe),k.matrixWorld.compose(k.position,k.quaternion,k.scale),k.matrixWorldInverse.copy(k.matrixWorld).invert(),Ot[10]===-1)k.projectionMatrix.copy(at.projectionMatrix),k.projectionMatrixInverse.copy(at.projectionMatrixInverse);else{let Ee=Wt+Pe,O=Dt+Pe,pn=le-ye,ae=He+(Rt-ye),R=Zt*Dt/O*Ee,b=$t*Dt/O*Ee;k.projectionMatrix.makePerspective(pn,ae,R,b,Ee,O),k.projectionMatrixInverse.copy(k.projectionMatrix).invert()}}function mt(k,at){at===null?k.matrixWorld.copy(k.matrix):k.matrixWorld.multiplyMatrices(at.matrixWorld,k.matrix),k.matrixWorldInverse.copy(k.matrixWorld).invert()}this.updateCamera=function(k){if(s===null)return;let at=k.near,rt=k.far;g.texture!==null&&(g.depthNear>0&&(at=g.depthNear),g.depthFar>0&&(rt=g.depthFar)),L.near=C.near=M.near=at,L.far=C.far=M.far=rt,(P!==L.near||q!==L.far)&&(s.updateRenderState({depthNear:L.near,depthFar:L.far}),P=L.near,q=L.far),L.layers.mask=k.layers.mask|6,M.layers.mask=L.layers.mask&-5,C.layers.mask=L.layers.mask&-3;let Rt=k.parent,Ot=L.cameras;mt(L,Rt);for(let Mt=0;Mt<Ot.length;Mt++)mt(Ot[Mt],Rt);Ot.length===2?ct(L,M,C):L.projectionMatrix.copy(M.projectionMatrix),xt(k,L,Rt)};function xt(k,at,rt){rt===null?k.matrix.copy(at.matrixWorld):(k.matrix.copy(rt.matrixWorld),k.matrix.invert(),k.matrix.multiply(at.matrixWorld)),k.matrix.decompose(k.position,k.quaternion,k.scale),k.updateMatrixWorld(!0),k.projectionMatrix.copy(at.projectionMatrix),k.projectionMatrixInverse.copy(at.projectionMatrixInverse),k.isPerspectiveCamera&&(k.fov=kh*2*Math.atan(1/k.projectionMatrix.elements[5]),k.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(u===null&&d===null))return c},this.setFoveation=function(k){c=k,u!==null&&(u.fixedFoveation=k),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=k)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(L)},this.getCameraTexture=function(k){return f[k]};let kt=null;function ue(k,at){if(h=at.getViewerPose(l||r),m=at,h!==null){let rt=h.views;d!==null&&(t.setRenderTargetFramebuffer(v,d.framebuffer),t.setRenderTarget(v));let Rt=!1;rt.length!==L.cameras.length&&(L.cameras.length=0,Rt=!0);for(let Dt=0;Dt<rt.length;Dt++){let Zt=rt[Dt],$t=null;if(d!==null)$t=d.getViewport(Zt);else{let Le=p.getViewSubImage(u,Zt);$t=Le.viewport,Dt===0&&(t.setRenderTargetTextures(v,Le.colorTexture,Le.depthStencilTexture),t.setRenderTarget(v))}let Bt=D[Dt];Bt===void 0&&(Bt=new yn,Bt.layers.enable(Dt),Bt.viewport=new Oe,D[Dt]=Bt),Bt.matrix.fromArray(Zt.transform.matrix),Bt.matrix.decompose(Bt.position,Bt.quaternion,Bt.scale),Bt.projectionMatrix.fromArray(Zt.projectionMatrix),Bt.projectionMatrixInverse.copy(Bt.projectionMatrix).invert(),Bt.viewport.set($t.x,$t.y,$t.width,$t.height),Dt===0&&(L.matrix.copy(Bt.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),Rt===!0&&L.cameras.push(Bt)}let Ot=s.enabledFeatures;if(Ot&&Ot.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&S){p=i.getBinding();let Dt=p.getDepthInformation(rt[0]);Dt&&Dt.isValid&&Dt.texture&&g.init(Dt,s.renderState)}if(Ot&&Ot.includes("camera-access")&&S){t.state.unbindTexture(),p=i.getBinding();for(let Dt=0;Dt<rt.length;Dt++){let Zt=rt[Dt].camera;if(Zt){let $t=f[Zt];$t||($t=new jl,f[Zt]=$t);let Bt=p.getCameraImage(Zt);$t.sourceTexture=Bt}}}}for(let rt=0;rt<T.length;rt++){let Rt=A[rt],Ot=T[rt];Rt!==null&&Ot!==void 0&&Ot.update(Rt,at,l||r)}kt&&kt(k,at),at.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:at}),m=null}let Yt=new dM;Yt.setAnimationLoop(ue),this.setAnimationLoop=function(k){kt=k},this.dispose=function(){}}},i3=new Ie,yM=new Ft;yM.set(-1,0,0,0,1,0,0,0,1);function s3(e,t){function n(g,f){g.matrixAutoUpdate===!0&&g.updateMatrix(),f.value.copy(g.matrix)}function i(g,f){f.color.getRGB(g.fogColor.value,f0(e)),f.isFog?(g.fogNear.value=f.near,g.fogFar.value=f.far):f.isFogExp2&&(g.fogDensity.value=f.density)}function s(g,f,_,x,v){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?a(g,f):f.isMeshLambertMaterial?(a(g,f),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(a(g,f),p(g,f)):f.isMeshPhongMaterial?(a(g,f),h(g,f),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(a(g,f),u(g,f),f.isMeshPhysicalMaterial&&d(g,f,v)):f.isMeshMatcapMaterial?(a(g,f),m(g,f)):f.isMeshDepthMaterial?a(g,f):f.isMeshDistanceMaterial?(a(g,f),S(g,f)):f.isMeshNormalMaterial?a(g,f):f.isLineBasicMaterial?(r(g,f),f.isLineDashedMaterial&&o(g,f)):f.isPointsMaterial?c(g,f,_,x):f.isSpriteMaterial?l(g,f):f.isShadowMaterial?(g.color.value.copy(f.color),g.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(g,f){g.opacity.value=f.opacity,f.color&&g.diffuse.value.copy(f.color),f.emissive&&g.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(g.map.value=f.map,n(f.map,g.mapTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.bumpMap&&(g.bumpMap.value=f.bumpMap,n(f.bumpMap,g.bumpMapTransform),g.bumpScale.value=f.bumpScale,f.side===An&&(g.bumpScale.value*=-1)),f.normalMap&&(g.normalMap.value=f.normalMap,n(f.normalMap,g.normalMapTransform),g.normalScale.value.copy(f.normalScale),f.side===An&&g.normalScale.value.negate()),f.displacementMap&&(g.displacementMap.value=f.displacementMap,n(f.displacementMap,g.displacementMapTransform),g.displacementScale.value=f.displacementScale,g.displacementBias.value=f.displacementBias),f.emissiveMap&&(g.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,g.emissiveMapTransform)),f.specularMap&&(g.specularMap.value=f.specularMap,n(f.specularMap,g.specularMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest);let _=t.get(f),x=_.envMap,v=_.envMapRotation;x&&(g.envMap.value=x,g.envMapRotation.value.setFromMatrix4(i3.makeRotationFromEuler(v)).transpose(),x.isCubeTexture&&x.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(yM),g.reflectivity.value=f.reflectivity,g.ior.value=f.ior,g.refractionRatio.value=f.refractionRatio),f.lightMap&&(g.lightMap.value=f.lightMap,g.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,g.lightMapTransform)),f.aoMap&&(g.aoMap.value=f.aoMap,g.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,g.aoMapTransform))}function r(g,f){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,f.map&&(g.map.value=f.map,n(f.map,g.mapTransform))}function o(g,f){g.dashSize.value=f.dashSize,g.totalSize.value=f.dashSize+f.gapSize,g.scale.value=f.scale}function c(g,f,_,x){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,g.size.value=f.size*_,g.scale.value=x*.5,f.map&&(g.map.value=f.map,n(f.map,g.uvTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest)}function l(g,f){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,g.rotation.value=f.rotation,f.map&&(g.map.value=f.map,n(f.map,g.mapTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest)}function h(g,f){g.specular.value.copy(f.specular),g.shininess.value=Math.max(f.shininess,1e-4)}function p(g,f){f.gradientMap&&(g.gradientMap.value=f.gradientMap)}function u(g,f){g.metalness.value=f.metalness,f.metalnessMap&&(g.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,g.metalnessMapTransform)),g.roughness.value=f.roughness,f.roughnessMap&&(g.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,g.roughnessMapTransform)),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)}function d(g,f,_){g.ior.value=f.ior,f.sheen>0&&(g.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),g.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(g.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,g.sheenColorMapTransform)),f.sheenRoughnessMap&&(g.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,g.sheenRoughnessMapTransform))),f.clearcoat>0&&(g.clearcoat.value=f.clearcoat,g.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(g.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,g.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(g.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===An&&g.clearcoatNormalScale.value.negate())),f.dispersion>0&&(g.dispersion.value=f.dispersion),f.iridescence>0&&(g.iridescence.value=f.iridescence,g.iridescenceIOR.value=f.iridescenceIOR,g.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(g.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,g.iridescenceMapTransform)),f.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),f.transmission>0&&(g.transmission.value=f.transmission,g.transmissionSamplerMap.value=_.texture,g.transmissionSamplerSize.value.set(_.width,_.height),f.transmissionMap&&(g.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,g.transmissionMapTransform)),g.thickness.value=f.thickness,f.thicknessMap&&(g.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=f.attenuationDistance,g.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(g.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(g.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=f.specularIntensity,g.specularColor.value.copy(f.specularColor),f.specularColorMap&&(g.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,g.specularColorMapTransform)),f.specularIntensityMap&&(g.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,g.specularIntensityMapTransform))}function m(g,f){f.matcap&&(g.matcap.value=f.matcap)}function S(g,f){let _=t.get(f).light;g.referencePosition.value.setFromMatrixPosition(_.matrixWorld),g.nearDistance.value=_.shadow.camera.near,g.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function a3(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(v,T){let A=T.program;i.uniformBlockBinding(v,A)}function l(v,T){let A=s[v.id];A===void 0&&(g(v),A=h(v),s[v.id]=A,v.addEventListener("dispose",_));let w=T.program;i.updateUBOMapping(v,w);let y=t.render.frame;a[v.id]!==y&&(u(v),a[v.id]=y)}function h(v){let T=p();v.__bindingPointIndex=T;let A=e.createBuffer(),w=v.__size,y=v.usage;return e.bindBuffer(e.UNIFORM_BUFFER,A),e.bufferData(e.UNIFORM_BUFFER,w,y),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,T,A),A}function p(){for(let v=0;v<o;v++)if(r.indexOf(v)===-1)return r.push(v),v;return Pt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){let T=s[v.id],A=v.uniforms,w=v.__cache;e.bindBuffer(e.UNIFORM_BUFFER,T);for(let y=0,M=A.length;y<M;y++){let C=A[y];if(Array.isArray(C))for(let D=0,L=C.length;D<L;D++)d(C[D],y,D,w);else d(C,y,0,w)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function d(v,T,A,w){if(S(v,T,A,w)===!0){let y=v.__offset,M=v.value;if(Array.isArray(M)){let C=0;for(let D=0;D<M.length;D++){let L=M[D],P=f(L);m(L,v.__data,C),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(C+=P.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(M,v.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,y,v.__data)}}function m(v,T,A){typeof v=="number"||typeof v=="boolean"?T[0]=v:v.isMatrix3?(T[0]=v.elements[0],T[1]=v.elements[1],T[2]=v.elements[2],T[3]=0,T[4]=v.elements[3],T[5]=v.elements[4],T[6]=v.elements[5],T[7]=0,T[8]=v.elements[6],T[9]=v.elements[7],T[10]=v.elements[8],T[11]=0):ArrayBuffer.isView(v)?T.set(new v.constructor(v.buffer,v.byteOffset,T.length)):v.toArray(T,A)}function S(v,T,A,w){let y=v.value,M=T+"_"+A;if(w[M]===void 0)return typeof y=="number"||typeof y=="boolean"?w[M]=y:ArrayBuffer.isView(y)?w[M]=y.slice():w[M]=y.clone(),!0;{let C=w[M];if(typeof y=="number"||typeof y=="boolean"){if(C!==y)return w[M]=y,!0}else{if(ArrayBuffer.isView(y))return!0;if(C.equals(y)===!1)return C.copy(y),!0}}return!1}function g(v){let T=v.uniforms,A=0,w=16;for(let M=0,C=T.length;M<C;M++){let D=Array.isArray(T[M])?T[M]:[T[M]];for(let L=0,P=D.length;L<P;L++){let q=D[L],B=Array.isArray(q.value)?q.value:[q.value];for(let W=0,Y=B.length;W<Y;W++){let tt=B[W],ot=f(tt),ct=A%w,mt=ct%ot.boundary,xt=ct+mt;A+=mt,xt!==0&&w-xt<ot.storage&&(A+=w-xt),q.__data=new Float32Array(ot.storage/Float32Array.BYTES_PER_ELEMENT),q.__offset=A,A+=ot.storage}}}let y=A%w;return y>0&&(A+=w-y),v.__size=A,v.__cache={},this}function f(v){let T={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(T.boundary=4,T.storage=4):v.isVector2?(T.boundary=8,T.storage=8):v.isVector3||v.isColor?(T.boundary=16,T.storage=12):v.isVector4?(T.boundary=16,T.storage=16):v.isMatrix3?(T.boundary=48,T.storage=48):v.isMatrix4?(T.boundary=64,T.storage=64):v.isTexture?It("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(T.boundary=16,T.storage=v.byteLength):It("WebGLRenderer: Unsupported uniform value type.",v),T}function _(v){let T=v.target;T.removeEventListener("dispose",_);let A=r.indexOf(T.__bindingPointIndex);r.splice(A,1),e.deleteBuffer(s[T.id]),delete s[T.id],delete a[T.id]}function x(){for(let v in s)e.deleteBuffer(s[v]);r=[],s={},a={}}return{bind:c,update:l,dispose:x}}var r3=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ki=null;function o3(){return Ki===null&&(Ki=new Yh(r3,16,16,Sa,Ji),Ki.name="DFG_LUT",Ki.minFilter=dn,Ki.magFilter=dn,Ki.wrapS=Hi,Ki.wrapT=Hi,Ki.generateMipmaps=!1,Ki.needsUpdate=!0),Ki}var dd=class{constructor(t={}){let{canvas:n=BS(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:d=ei}=t;this.isWebGLRenderer=!0;let m;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=i.getContextAttributes().alpha}else m=r;let S=d,g=new Set([Df,Rf,Cf]),f=new Set([ei,Ai,bo,So,Af,wf]),_=new Uint32Array(4),x=new Int32Array(4),v=new U,T=null,A=null,w=[],y=[],M=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ti,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let C=this,D=!1,L=null,P=null,q=null,B=null;this._outputColorSpace=Tn;let W=0,Y=0,tt=null,ot=-1,ct=null,mt=new Oe,xt=new Oe,kt=null,ue=new Qt(0),Yt=0,k=n.width,at=n.height,rt=1,Rt=null,Ot=null,Mt=new Oe(0,0,k,at),Wt=new Oe(0,0,k,at),Dt=!1,Zt=new Jl,$t=!1,Bt=!1,Le=new Ie,le=new U,He=new Oe,Pe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ye=!1;function Ee(){return tt===null?rt:1}let O=i;function pn(E,z){return n.getContext(E,z)}try{let E={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${bf}`),n.addEventListener("webglcontextlost",Te,!1),n.addEventListener("webglcontextrestored",xe,!1),n.addEventListener("webglcontextcreationerror",Ci,!1),O===null){let z="webgl2";if(O=pn(z,E),O===null)throw pn(z)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(E){throw Pt("WebGLRenderer: "+E.message),E}let ae,R,b,F,X,J,ut,gt,j,et,dt,At,ft,ht,wt,I,$,N,Q,V,lt,pt,nt;function Tt(){ae=new pR(O),ae.init(),lt=new t3(O,ae),R=new rR(O,ae,t,lt),b=new Q2(O,ae),R.reversedDepthBuffer&&u&&b.buffers.depth.setReversed(!0),P=O.createFramebuffer(),q=O.createFramebuffer(),B=O.createFramebuffer(),F=new _R(O),X=new B2,J=new $2(O,ae,b,X,R,lt,F),ut=new dR(C),gt=new bA(O),pt=new sR(O,gt),j=new mR(O,gt,F,pt),et=new yR(O,j,gt,pt,F),N=new vR(O,R,J),wt=new oR(X),dt=new z2(C,ut,ae,R,pt,wt),At=new s3(C,X),ft=new V2,ht=new q2(ae),$=new iR(C,ut,b,et,m,c),I=new j2(C,et,R),nt=new a3(O,F,R,b),Q=new aR(O,ae,F),V=new gR(O,ae,F),F.programs=dt.programs,C.capabilities=R,C.extensions=ae,C.properties=X,C.renderLists=ft,C.shadowMap=I,C.state=b,C.info=F}Tt(),S!==ei&&(M=new bR(S,n.width,n.height,o,s,a));let Et=new D0(C,O);this.xr=Et,this.getContext=function(){return O},this.getContextAttributes=function(){return O.getContextAttributes()},this.forceContextLoss=function(){let E=ae.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){let E=ae.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return rt},this.setPixelRatio=function(E){E!==void 0&&(rt=E,this.setSize(k,at,!1))},this.getSize=function(E){return E.set(k,at)},this.setSize=function(E,z,Z=!0){if(Et.isPresenting){It("WebGLRenderer: Can't change size while VR device is presenting.");return}k=E,at=z,n.width=Math.floor(E*rt),n.height=Math.floor(z*rt),Z===!0&&(n.style.width=E+"px",n.style.height=z+"px"),M!==null&&M.setSize(n.width,n.height),this.setViewport(0,0,E,z)},this.getDrawingBufferSize=function(E){return E.set(k*rt,at*rt).floor()},this.setDrawingBufferSize=function(E,z,Z){k=E,at=z,rt=Z,n.width=Math.floor(E*Z),n.height=Math.floor(z*Z),this.setViewport(0,0,E,z)},this.setEffects=function(E){if(S===ei){Pt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let z=0;z<E.length;z++)if(E[z].isOutputPass===!0){It("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(mt)},this.getViewport=function(E){return E.copy(Mt)},this.setViewport=function(E,z,Z,H){E.isVector4?Mt.set(E.x,E.y,E.z,E.w):Mt.set(E,z,Z,H),b.viewport(mt.copy(Mt).multiplyScalar(rt).round())},this.getScissor=function(E){return E.copy(Wt)},this.setScissor=function(E,z,Z,H){E.isVector4?Wt.set(E.x,E.y,E.z,E.w):Wt.set(E,z,Z,H),b.scissor(xt.copy(Wt).multiplyScalar(rt).round())},this.getScissorTest=function(){return Dt},this.setScissorTest=function(E){b.setScissorTest(Dt=E)},this.setOpaqueSort=function(E){Rt=E},this.setTransparentSort=function(E){Ot=E},this.getClearColor=function(E){return E.copy($.getClearColor())},this.setClearColor=function(){$.setClearColor(...arguments)},this.getClearAlpha=function(){return $.getClearAlpha()},this.setClearAlpha=function(){$.setClearAlpha(...arguments)},this.clear=function(E=!0,z=!0,Z=!0){let H=0;if(E){let G=!1;if(tt!==null){let yt=tt.texture.format;G=g.has(yt)}if(G){let yt=tt.texture.type,St=f.has(yt),vt=$.getClearColor(),Ct=$.getClearAlpha(),Nt=vt.r,Ht=vt.g,qt=vt.b;St?(_[0]=Nt,_[1]=Ht,_[2]=qt,_[3]=Ct,O.clearBufferuiv(O.COLOR,0,_)):(x[0]=Nt,x[1]=Ht,x[2]=qt,x[3]=Ct,O.clearBufferiv(O.COLOR,0,x))}else H|=O.COLOR_BUFFER_BIT}z&&(H|=O.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Z&&(H|=O.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&O.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),L=E},this.dispose=function(){n.removeEventListener("webglcontextlost",Te,!1),n.removeEventListener("webglcontextrestored",xe,!1),n.removeEventListener("webglcontextcreationerror",Ci,!1),$.dispose(),ft.dispose(),ht.dispose(),X.dispose(),ut.dispose(),et.dispose(),pt.dispose(),nt.dispose(),dt.dispose(),Et.dispose(),Et.removeEventListener("sessionstart",P0),Et.removeEventListener("sessionend",z0),Ea.stop()};function Te(E){E.preventDefault(),u0("WebGLRenderer: Context Lost."),D=!0}function xe(){u0("WebGLRenderer: Context Restored."),D=!1;let E=F.autoReset,z=I.enabled,Z=I.autoUpdate,H=I.needsUpdate,G=I.type;Tt(),F.autoReset=E,I.enabled=z,I.autoUpdate=Z,I.needsUpdate=H,I.type=G}function Ci(E){Pt("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function Ri(E){let z=E.target;z.removeEventListener("dispose",Ri),DM(z)}function DM(E){NM(E),X.remove(E)}function NM(E){let z=X.get(E).programs;z!==void 0&&(z.forEach(function(Z){dt.releaseProgram(Z)}),E.isShaderMaterial&&dt.releaseShaderCache(E))}this.renderBufferDirect=function(E,z,Z,H,G,yt){z===null&&(z=Pe);let St=G.isMesh&&G.matrixWorld.determinantAffine()<0,vt=IM(E,z,Z,H,G);b.setMaterial(H,St);let Ct=Z.index,Nt=1;if(H.wireframe===!0){if(Ct=j.getWireframeAttribute(Z),Ct===void 0)return;Nt=2}let Ht=Z.drawRange,qt=Z.attributes.position,Ut=Ht.start*Nt,de=(Ht.start+Ht.count)*Nt;yt!==null&&(Ut=Math.max(Ut,yt.start*Nt),de=Math.min(de,(yt.start+yt.count)*Nt)),Ct!==null?(Ut=Math.max(Ut,0),de=Math.min(de,Ct.count)):qt!=null&&(Ut=Math.max(Ut,0),de=Math.min(de,qt.count));let Ge=de-Ut;if(Ge<0||Ge===1/0)return;pt.setup(G,H,vt,Z,Ct);let ze,ge=Q;if(Ct!==null&&(ze=gt.get(Ct),ge=V,ge.setIndex(ze)),G.isMesh)H.wireframe===!0?(b.setLineWidth(H.wireframeLinewidth*Ee()),ge.setMode(O.LINES)):ge.setMode(O.TRIANGLES);else if(G.isLine){let mn=H.linewidth;mn===void 0&&(mn=1),b.setLineWidth(mn*Ee()),G.isLineSegments?ge.setMode(O.LINES):G.isLineLoop?ge.setMode(O.LINE_LOOP):ge.setMode(O.LINE_STRIP)}else G.isPoints?ge.setMode(O.POINTS):G.isSprite&&ge.setMode(O.TRIANGLES);if(G.isBatchedMesh)if(ae.get("WEBGL_multi_draw"))ge.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{let mn=G._multiDrawStarts,bt=G._multiDrawCounts,Pn=G._multiDrawCount,se=Ct?gt.get(Ct).bytesPerElement:1,ni=X.get(H).currentProgram.getUniforms();for(let Di=0;Di<Pn;Di++)ni.setValue(O,"_gl_DrawID",Di),ge.render(mn[Di]/se,bt[Di])}else if(G.isInstancedMesh)ge.renderInstances(Ut,Ge,G.count);else if(Z.isInstancedBufferGeometry){let mn=Z._maxInstanceCount!==void 0?Z._maxInstanceCount:1/0,bt=Math.min(Z.instanceCount,mn);ge.renderInstances(Ut,Ge,bt)}else ge.render(Ut,Ge)};function O0(E,z,Z){E.transparent===!0&&E.side===ti&&E.forceSinglePass===!1?(E.side=An,E.needsUpdate=!0,Tc(E,z,Z),E.side=Ts,E.needsUpdate=!0,Tc(E,z,Z),E.side=ti):Tc(E,z,Z)}this.compile=function(E,z,Z=null){Z===null&&(Z=E),A=ht.get(Z),A.init(z),y.push(A),Z.traverseVisible(function(G){G.isLight&&G.layers.test(z.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),E!==Z&&E.traverseVisible(function(G){G.isLight&&G.layers.test(z.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),A.setupLights();let H=new Set;return E.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;let yt=G.material;if(yt)if(Array.isArray(yt))for(let St=0;St<yt.length;St++){let vt=yt[St];O0(vt,Z,G),H.add(vt)}else O0(yt,Z,G),H.add(yt)}),A=y.pop(),H},this.compileAsync=function(E,z,Z=null){let H=this.compile(E,z,Z);return new Promise(G=>{function yt(){if(H.forEach(function(St){X.get(St).currentProgram.isReady()&&H.delete(St)}),H.size===0){G(E);return}setTimeout(yt,10)}ae.get("KHR_parallel_shader_compile")!==null?yt():setTimeout(yt,10)})};let xd=null;function UM(E){xd&&xd(E)}function P0(){Ea.stop()}function z0(){Ea.start()}let Ea=new dM;Ea.setAnimationLoop(UM),typeof self<"u"&&Ea.setContext(self),this.setAnimationLoop=function(E){xd=E,Et.setAnimationLoop(E),E===null?Ea.stop():Ea.start()},Et.addEventListener("sessionstart",P0),Et.addEventListener("sessionend",z0),this.render=function(E,z){if(z!==void 0&&z.isCamera!==!0){Pt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;L!==null&&L.renderStart(E,z);let Z=Et.enabled===!0&&Et.isPresenting===!0,H=M!==null&&(tt===null||Z)&&M.begin(C,tt);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),Et.enabled===!0&&Et.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(Et.cameraAutoUpdate===!0&&Et.updateCamera(z),z=Et.getCamera()),E.isScene===!0&&E.onBeforeRender(C,E,z,tt),A=ht.get(E,y.length),A.init(z),A.state.textureUnits=J.getTextureUnits(),y.push(A),Le.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),Zt.setFromProjectionMatrix(Le,Ei,z.reversedDepth),Bt=this.localClippingEnabled,$t=wt.init(this.clippingPlanes,Bt),T=ft.get(E,w.length),T.init(),w.push(T),Et.enabled===!0&&Et.isPresenting===!0){let St=C.xr.getDepthSensingMesh();St!==null&&bd(St,z,-1/0,C.sortObjects)}bd(E,z,0,C.sortObjects),T.finish(),C.sortObjects===!0&&T.sort(Rt,Ot,z.reversedDepth),ye=Et.enabled===!1||Et.isPresenting===!1||Et.hasDepthSensing()===!1,ye&&$.addToRenderList(T,E),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),$t===!0&&wt.beginShadows();let G=A.state.shadowsArray;if(I.render(G,E,z),$t===!0&&wt.endShadows(),(H&&M.hasRenderPass())===!1){let St=T.opaque,vt=T.transmissive;if(A.setupLights(),z.isArrayCamera){let Ct=z.cameras;if(vt.length>0)for(let Nt=0,Ht=Ct.length;Nt<Ht;Nt++){let qt=Ct[Nt];F0(St,vt,E,qt)}ye&&$.render(E);for(let Nt=0,Ht=Ct.length;Nt<Ht;Nt++){let qt=Ct[Nt];B0(T,E,qt,qt.viewport)}}else vt.length>0&&F0(St,vt,E,z),ye&&$.render(E),B0(T,E,z)}tt!==null&&Y===0&&(J.updateMultisampleRenderTarget(tt),J.updateRenderTargetMipmap(tt)),H&&M.end(C),E.isScene===!0&&E.onAfterRender(C,E,z),pt.resetDefaultState(),ot=-1,ct=null,y.pop(),y.length>0?(A=y[y.length-1],J.setTextureUnits(A.state.textureUnits),$t===!0&&wt.setGlobalState(C.clippingPlanes,A.state.camera)):A=null,w.pop(),w.length>0?T=w[w.length-1]:T=null,L!==null&&L.renderEnd()};function bd(E,z,Z,H){if(E.visible===!1)return;if(E.layers.test(z.layers)){if(E.isGroup)Z=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(z);else if(E.isLightProbeGrid)A.pushLightProbeGrid(E);else if(E.isLight)A.pushLight(E),E.castShadow&&A.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Zt.intersectsSprite(E)){H&&He.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Le);let St=et.update(E),vt=E.material;vt.visible&&T.push(E,St,vt,Z,He.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Zt.intersectsObject(E))){let St=et.update(E),vt=E.material;if(H&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),He.copy(E.boundingSphere.center)):(St.boundingSphere===null&&St.computeBoundingSphere(),He.copy(St.boundingSphere.center)),He.applyMatrix4(E.matrixWorld).applyMatrix4(Le)),Array.isArray(vt)){let Ct=St.groups;for(let Nt=0,Ht=Ct.length;Nt<Ht;Nt++){let qt=Ct[Nt],Ut=vt[qt.materialIndex];Ut&&Ut.visible&&T.push(E,St,Ut,Z,He.z,qt)}}else vt.visible&&T.push(E,St,vt,Z,He.z,null)}}let yt=E.children;for(let St=0,vt=yt.length;St<vt;St++)bd(yt[St],z,Z,H)}function B0(E,z,Z,H){let{opaque:G,transmissive:yt,transparent:St}=E;A.setupLightsView(Z),$t===!0&&wt.setGlobalState(C.clippingPlanes,Z),H&&b.viewport(mt.copy(H)),G.length>0&&Ec(G,z,Z),yt.length>0&&Ec(yt,z,Z),St.length>0&&Ec(St,z,Z),b.buffers.depth.setTest(!0),b.buffers.depth.setMask(!0),b.buffers.color.setMask(!0),b.setPolygonOffset(!1)}function F0(E,z,Z,H){if((Z.isScene===!0?Z.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[H.id]===void 0){let Ut=ae.has("EXT_color_buffer_half_float")||ae.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[H.id]=new Kn(1,1,{generateMipmaps:!0,type:Ut?Ji:ei,minFilter:xa,samples:Math.max(4,R.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ee.workingColorSpace})}let yt=A.state.transmissionRenderTarget[H.id],St=H.viewport||mt;yt.setSize(St.z*C.transmissionResolutionScale,St.w*C.transmissionResolutionScale);let vt=C.getRenderTarget(),Ct=C.getActiveCubeFace(),Nt=C.getActiveMipmapLevel();C.setRenderTarget(yt),C.getClearColor(ue),Yt=C.getClearAlpha(),Yt<1&&C.setClearColor(16777215,.5),C.clear(),ye&&$.render(Z);let Ht=C.toneMapping;C.toneMapping=Ti;let qt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),A.setupLightsView(H),$t===!0&&wt.setGlobalState(C.clippingPlanes,H),Ec(E,Z,H),J.updateMultisampleRenderTarget(yt),J.updateRenderTargetMipmap(yt),ae.has("WEBGL_multisampled_render_to_texture")===!1){let Ut=!1;for(let de=0,Ge=z.length;de<Ge;de++){let ze=z[de],{object:ge,geometry:mn,material:bt,group:Pn}=ze;if(bt.side===ti&&ge.layers.test(H.layers)){let se=bt.side;bt.side=An,bt.needsUpdate=!0,V0(ge,Z,H,mn,bt,Pn),bt.side=se,bt.needsUpdate=!0,Ut=!0}}Ut===!0&&(J.updateMultisampleRenderTarget(yt),J.updateRenderTargetMipmap(yt))}C.setRenderTarget(vt,Ct,Nt),C.setClearColor(ue,Yt),qt!==void 0&&(H.viewport=qt),C.toneMapping=Ht}function Ec(E,z,Z){let H=z.isScene===!0?z.overrideMaterial:null;for(let G=0,yt=E.length;G<yt;G++){let St=E[G],{object:vt,geometry:Ct,group:Nt}=St,Ht=St.material;Ht.allowOverride===!0&&H!==null&&(Ht=H),vt.layers.test(Z.layers)&&V0(vt,z,Z,Ct,Ht,Nt)}}function V0(E,z,Z,H,G,yt){E.onBeforeRender(C,z,Z,H,G,yt),E.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),G.onBeforeRender(C,z,Z,H,E,yt),G.transparent===!0&&G.side===ti&&G.forceSinglePass===!1?(G.side=An,G.needsUpdate=!0,C.renderBufferDirect(Z,z,H,G,E,yt),G.side=Ts,G.needsUpdate=!0,C.renderBufferDirect(Z,z,H,G,E,yt),G.side=ti):C.renderBufferDirect(Z,z,H,G,E,yt),E.onAfterRender(C,z,Z,H,G,yt)}function Tc(E,z,Z){z.isScene!==!0&&(z=Pe);let H=X.get(E),G=A.state.lights,yt=A.state.shadowsArray,St=G.state.version,vt=dt.getParameters(E,G.state,yt,z,Z,A.state.lightProbeGridArray),Ct=dt.getProgramCacheKey(vt),Nt=H.programs;H.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?z.environment:null,H.fog=z.fog;let Ht=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;H.envMap=ut.get(E.envMap||H.environment,Ht),H.envMapRotation=H.environment!==null&&E.envMap===null?z.environmentRotation:E.envMapRotation,Nt===void 0&&(E.addEventListener("dispose",Ri),Nt=new Map,H.programs=Nt);let qt=Nt.get(Ct);if(qt!==void 0){if(H.currentProgram===qt&&H.lightsStateVersion===St)return G0(E,vt),qt}else vt.uniforms=dt.getUniforms(E),L!==null&&E.isNodeMaterial&&L.build(E,Z,vt),E.onBeforeCompile(vt,C),qt=dt.acquireProgram(vt,Ct),Nt.set(Ct,qt),H.uniforms=vt.uniforms;let Ut=H.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ut.clippingPlanes=wt.uniform),G0(E,vt),H.needsLights=PM(E),H.lightsStateVersion=St,H.needsLights&&(Ut.ambientLightColor.value=G.state.ambient,Ut.lightProbe.value=G.state.probe,Ut.directionalLights.value=G.state.directional,Ut.directionalLightShadows.value=G.state.directionalShadow,Ut.spotLights.value=G.state.spot,Ut.spotLightShadows.value=G.state.spotShadow,Ut.rectAreaLights.value=G.state.rectArea,Ut.ltc_1.value=G.state.rectAreaLTC1,Ut.ltc_2.value=G.state.rectAreaLTC2,Ut.pointLights.value=G.state.point,Ut.pointLightShadows.value=G.state.pointShadow,Ut.hemisphereLights.value=G.state.hemi,Ut.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Ut.spotLightMatrix.value=G.state.spotLightMatrix,Ut.spotLightMap.value=G.state.spotLightMap,Ut.pointShadowMatrix.value=G.state.pointShadowMatrix),H.lightProbeGrid=A.state.lightProbeGridArray.length>0,H.currentProgram=qt,H.uniformsList=null,qt}function H0(E){if(E.uniformsList===null){let z=E.currentProgram.getUniforms();E.uniformsList=Eo.seqWithValue(z.seq,E.uniforms)}return E.uniformsList}function G0(E,z){let Z=X.get(E);Z.outputColorSpace=z.outputColorSpace,Z.batching=z.batching,Z.batchingColor=z.batchingColor,Z.instancing=z.instancing,Z.instancingColor=z.instancingColor,Z.instancingMorph=z.instancingMorph,Z.skinning=z.skinning,Z.morphTargets=z.morphTargets,Z.morphNormals=z.morphNormals,Z.morphColors=z.morphColors,Z.morphTargetsCount=z.morphTargetsCount,Z.numClippingPlanes=z.numClippingPlanes,Z.numIntersection=z.numClipIntersection,Z.vertexAlphas=z.vertexAlphas,Z.vertexTangents=z.vertexTangents,Z.toneMapping=z.toneMapping}function LM(E,z){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;v.setFromMatrixPosition(z.matrixWorld);for(let Z=0,H=E.length;Z<H;Z++){let G=E[Z];if(G.texture!==null&&G.boundingBox.containsPoint(v))return G}return null}function IM(E,z,Z,H,G){z.isScene!==!0&&(z=Pe),J.resetTextureUnits();let yt=z.fog,St=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?z.environment:null,vt=tt===null?C.outputColorSpace:tt.isXRRenderTarget===!0?tt.texture.colorSpace:ee.workingColorSpace,Ct=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,Nt=ut.get(H.envMap||St,Ct),Ht=H.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,qt=!!Z.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Ut=!!Z.morphAttributes.position,de=!!Z.morphAttributes.normal,Ge=!!Z.morphAttributes.color,ze=Ti;H.toneMapped&&(tt===null||tt.isXRRenderTarget===!0)&&(ze=C.toneMapping);let ge=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,mn=ge!==void 0?ge.length:0,bt=X.get(H),Pn=A.state.lights;if($t===!0&&(Bt===!0||E!==ct)){let be=E===ct&&H.id===ot;wt.setState(H,E,be)}let se=!1;H.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==Pn.state.version||bt.outputColorSpace!==vt||G.isBatchedMesh&&bt.batching===!1||!G.isBatchedMesh&&bt.batching===!0||G.isBatchedMesh&&bt.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&bt.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&bt.instancing===!1||!G.isInstancedMesh&&bt.instancing===!0||G.isSkinnedMesh&&bt.skinning===!1||!G.isSkinnedMesh&&bt.skinning===!0||G.isInstancedMesh&&bt.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&bt.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&bt.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&bt.instancingMorph===!1&&G.morphTexture!==null||bt.envMap!==Nt||H.fog===!0&&bt.fog!==yt||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==wt.numPlanes||bt.numIntersection!==wt.numIntersection)||bt.vertexAlphas!==Ht||bt.vertexTangents!==qt||bt.morphTargets!==Ut||bt.morphNormals!==de||bt.morphColors!==Ge||bt.toneMapping!==ze||bt.morphTargetsCount!==mn||!!bt.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(se=!0):(se=!0,bt.__version=H.version);let ni=bt.currentProgram;se===!0&&(ni=Tc(H,z,G),L&&H.isNodeMaterial&&L.onUpdateProgram(H,ni,bt));let Di=!1,Cs=!1,ar=!1,_e=ni.getUniforms(),ke=bt.uniforms;if(b.useProgram(ni.program)&&(Di=!0,Cs=!0,ar=!0),H.id!==ot&&(ot=H.id,Cs=!0),bt.needsLights){let be=LM(A.state.lightProbeGridArray,G);bt.lightProbeGrid!==be&&(bt.lightProbeGrid=be,Cs=!0)}if(Di||ct!==E){b.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),_e.setValue(O,"projectionMatrix",E.projectionMatrix),_e.setValue(O,"viewMatrix",E.matrixWorldInverse);let Ds=_e.map.cameraPosition;Ds!==void 0&&Ds.setValue(O,le.setFromMatrixPosition(E.matrixWorld)),R.logarithmicDepthBuffer&&_e.setValue(O,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&_e.setValue(O,"isOrthographic",E.isOrthographicCamera===!0),ct!==E&&(ct=E,Cs=!0,ar=!0)}if(bt.needsLights&&(Pn.state.directionalShadowMap.length>0&&_e.setValue(O,"directionalShadowMap",Pn.state.directionalShadowMap,J),Pn.state.spotShadowMap.length>0&&_e.setValue(O,"spotShadowMap",Pn.state.spotShadowMap,J),Pn.state.pointShadowMap.length>0&&_e.setValue(O,"pointShadowMap",Pn.state.pointShadowMap,J)),G.isSkinnedMesh){_e.setOptional(O,G,"bindMatrix"),_e.setOptional(O,G,"bindMatrixInverse");let be=G.skeleton;be&&(be.boneTexture===null&&be.computeBoneTexture(),_e.setValue(O,"boneTexture",be.boneTexture,J))}G.isBatchedMesh&&(_e.setOptional(O,G,"batchingTexture"),_e.setValue(O,"batchingTexture",G._matricesTexture,J),_e.setOptional(O,G,"batchingIdTexture"),_e.setValue(O,"batchingIdTexture",G._indirectTexture,J),_e.setOptional(O,G,"batchingColorTexture"),G._colorsTexture!==null&&_e.setValue(O,"batchingColorTexture",G._colorsTexture,J));let Rs=Z.morphAttributes;if((Rs.position!==void 0||Rs.normal!==void 0||Rs.color!==void 0)&&N.update(G,Z,ni),(Cs||bt.receiveShadow!==G.receiveShadow)&&(bt.receiveShadow=G.receiveShadow,_e.setValue(O,"receiveShadow",G.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&z.environment!==null&&(ke.envMapIntensity.value=z.environmentIntensity),ke.dfgLUT!==void 0&&(ke.dfgLUT.value=o3()),Cs){if(_e.setValue(O,"toneMappingExposure",C.toneMappingExposure),bt.needsLights&&OM(ke,ar),yt&&H.fog===!0&&At.refreshFogUniforms(ke,yt),At.refreshMaterialUniforms(ke,H,rt,at,A.state.transmissionRenderTarget[E.id]),bt.needsLights&&bt.lightProbeGrid){let be=bt.lightProbeGrid;ke.probesSH.value=be.texture,ke.probesMin.value.copy(be.boundingBox.min),ke.probesMax.value.copy(be.boundingBox.max),ke.probesResolution.value.copy(be.resolution)}Eo.upload(O,H0(bt),ke,J)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(Eo.upload(O,H0(bt),ke,J),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&_e.setValue(O,"center",G.center),_e.setValue(O,"modelViewMatrix",G.modelViewMatrix),_e.setValue(O,"normalMatrix",G.normalMatrix),_e.setValue(O,"modelMatrix",G.matrixWorld),H.uniformsGroups!==void 0){let be=H.uniformsGroups;for(let Ds=0,rr=be.length;Ds<rr;Ds++){let k0=be[Ds];nt.update(k0,ni),nt.bind(k0,ni)}}return ni}function OM(E,z){E.ambientLightColor.needsUpdate=z,E.lightProbe.needsUpdate=z,E.directionalLights.needsUpdate=z,E.directionalLightShadows.needsUpdate=z,E.pointLights.needsUpdate=z,E.pointLightShadows.needsUpdate=z,E.spotLights.needsUpdate=z,E.spotLightShadows.needsUpdate=z,E.rectAreaLights.needsUpdate=z,E.hemisphereLights.needsUpdate=z}function PM(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return Y},this.getRenderTarget=function(){return tt},this.setRenderTargetTextures=function(E,z,Z){let H=X.get(E);H.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),X.get(E.texture).__webglTexture=z,X.get(E.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:Z,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,z){let Z=X.get(E);Z.__webglFramebuffer=z,Z.__useDefaultFramebuffer=z===void 0},this.setRenderTarget=function(E,z=0,Z=0){tt=E,W=z,Y=Z;let H=null,G=!1,yt=!1;if(E){let vt=X.get(E);if(vt.__useDefaultFramebuffer!==void 0){b.bindFramebuffer(O.FRAMEBUFFER,vt.__webglFramebuffer),mt.copy(E.viewport),xt.copy(E.scissor),kt=E.scissorTest,b.viewport(mt),b.scissor(xt),b.setScissorTest(kt),ot=-1;return}else if(vt.__webglFramebuffer===void 0)J.setupRenderTarget(E);else if(vt.__hasExternalTextures)J.rebindTextures(E,X.get(E.texture).__webglTexture,X.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){let Ht=E.depthTexture;if(vt.__boundDepthTexture!==Ht){if(Ht!==null&&X.has(Ht)&&(E.width!==Ht.image.width||E.height!==Ht.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");J.setupDepthRenderbuffer(E)}}let Ct=E.texture;(Ct.isData3DTexture||Ct.isDataArrayTexture||Ct.isCompressedArrayTexture)&&(yt=!0);let Nt=X.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Nt[z])?H=Nt[z][Z]:H=Nt[z],G=!0):E.samples>0&&J.useMultisampledRTT(E)===!1?H=X.get(E).__webglMultisampledFramebuffer:Array.isArray(Nt)?H=Nt[Z]:H=Nt,mt.copy(E.viewport),xt.copy(E.scissor),kt=E.scissorTest}else mt.copy(Mt).multiplyScalar(rt).floor(),xt.copy(Wt).multiplyScalar(rt).floor(),kt=Dt;if(Z!==0&&(H=P),b.bindFramebuffer(O.FRAMEBUFFER,H)&&b.drawBuffers(E,H),b.viewport(mt),b.scissor(xt),b.setScissorTest(kt),G){let vt=X.get(E.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_CUBE_MAP_POSITIVE_X+z,vt.__webglTexture,Z)}else if(yt){let vt=z;for(let Ct=0;Ct<E.textures.length;Ct++){let Nt=X.get(E.textures[Ct]);O.framebufferTextureLayer(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0+Ct,Nt.__webglTexture,Z,vt)}}else if(E!==null&&Z!==0){let vt=X.get(E.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,vt.__webglTexture,Z)}ot=-1},this.readRenderTargetPixels=function(E,z,Z,H,G,yt,St,vt=0){if(!(E&&E.isWebGLRenderTarget)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ct=X.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&St!==void 0&&(Ct=Ct[St]),Ct){b.bindFramebuffer(O.FRAMEBUFFER,Ct);try{let Nt=E.textures[vt],Ht=Nt.format,qt=Nt.type;if(E.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+vt),!R.textureFormatReadable(Ht)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!R.textureTypeReadable(qt)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=E.width-H&&Z>=0&&Z<=E.height-G&&O.readPixels(z,Z,H,G,lt.convert(Ht),lt.convert(qt),yt)}finally{let Nt=tt!==null?X.get(tt).__webglFramebuffer:null;b.bindFramebuffer(O.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(E,z,Z,H,G,yt,St,vt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ct=X.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&St!==void 0&&(Ct=Ct[St]),Ct)if(z>=0&&z<=E.width-H&&Z>=0&&Z<=E.height-G){b.bindFramebuffer(O.FRAMEBUFFER,Ct);let Nt=E.textures[vt],Ht=Nt.format,qt=Nt.type;if(E.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+vt),!R.textureFormatReadable(Ht))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!R.textureTypeReadable(qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ut=O.createBuffer();O.bindBuffer(O.PIXEL_PACK_BUFFER,Ut),O.bufferData(O.PIXEL_PACK_BUFFER,yt.byteLength,O.STREAM_READ),O.readPixels(z,Z,H,G,lt.convert(Ht),lt.convert(qt),0);let de=tt!==null?X.get(tt).__webglFramebuffer:null;b.bindFramebuffer(O.FRAMEBUFFER,de);let Ge=O.fenceSync(O.SYNC_GPU_COMMANDS_COMPLETE,0);return O.flush(),await VS(O,Ge,4),O.bindBuffer(O.PIXEL_PACK_BUFFER,Ut),O.getBufferSubData(O.PIXEL_PACK_BUFFER,0,yt),O.deleteBuffer(Ut),O.deleteSync(Ge),yt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,z=null,Z=0){let H=Math.pow(2,-Z),G=Math.floor(E.image.width*H),yt=Math.floor(E.image.height*H),St=z!==null?z.x:0,vt=z!==null?z.y:0;J.setTexture2D(E,0),O.copyTexSubImage2D(O.TEXTURE_2D,Z,0,0,St,vt,G,yt),b.unbindTexture()},this.copyTextureToTexture=function(E,z,Z=null,H=null,G=0,yt=0){let St,vt,Ct,Nt,Ht,qt,Ut,de,Ge,ze=E.isCompressedTexture?E.mipmaps[yt]:E.image;if(Z!==null)St=Z.max.x-Z.min.x,vt=Z.max.y-Z.min.y,Ct=Z.isBox3?Z.max.z-Z.min.z:1,Nt=Z.min.x,Ht=Z.min.y,qt=Z.isBox3?Z.min.z:0;else{let ke=Math.pow(2,-G);St=Math.floor(ze.width*ke),vt=Math.floor(ze.height*ke),E.isDataArrayTexture?Ct=ze.depth:E.isData3DTexture?Ct=Math.floor(ze.depth*ke):Ct=1,Nt=0,Ht=0,qt=0}H!==null?(Ut=H.x,de=H.y,Ge=H.z):(Ut=0,de=0,Ge=0);let ge=lt.convert(z.format),mn=lt.convert(z.type),bt;z.isData3DTexture?(J.setTexture3D(z,0),bt=O.TEXTURE_3D):z.isDataArrayTexture||z.isCompressedArrayTexture?(J.setTexture2DArray(z,0),bt=O.TEXTURE_2D_ARRAY):(J.setTexture2D(z,0),bt=O.TEXTURE_2D),b.activeTexture(O.TEXTURE0),b.pixelStorei(O.UNPACK_FLIP_Y_WEBGL,z.flipY),b.pixelStorei(O.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),b.pixelStorei(O.UNPACK_ALIGNMENT,z.unpackAlignment);let Pn=b.getParameter(O.UNPACK_ROW_LENGTH),se=b.getParameter(O.UNPACK_IMAGE_HEIGHT),ni=b.getParameter(O.UNPACK_SKIP_PIXELS),Di=b.getParameter(O.UNPACK_SKIP_ROWS),Cs=b.getParameter(O.UNPACK_SKIP_IMAGES);b.pixelStorei(O.UNPACK_ROW_LENGTH,ze.width),b.pixelStorei(O.UNPACK_IMAGE_HEIGHT,ze.height),b.pixelStorei(O.UNPACK_SKIP_PIXELS,Nt),b.pixelStorei(O.UNPACK_SKIP_ROWS,Ht),b.pixelStorei(O.UNPACK_SKIP_IMAGES,qt);let ar=E.isDataArrayTexture||E.isData3DTexture,_e=z.isDataArrayTexture||z.isData3DTexture;if(E.isDepthTexture){let ke=X.get(E),Rs=X.get(z),be=X.get(ke.__renderTarget),Ds=X.get(Rs.__renderTarget);b.bindFramebuffer(O.READ_FRAMEBUFFER,be.__webglFramebuffer),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,Ds.__webglFramebuffer);for(let rr=0;rr<Ct;rr++)ar&&(O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,X.get(E).__webglTexture,G,qt+rr),O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,X.get(z).__webglTexture,yt,Ge+rr)),O.blitFramebuffer(Nt,Ht,St,vt,Ut,de,St,vt,O.DEPTH_BUFFER_BIT,O.NEAREST);b.bindFramebuffer(O.READ_FRAMEBUFFER,null),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else if(G!==0||E.isRenderTargetTexture||X.has(E)){let ke=X.get(E),Rs=X.get(z);b.bindFramebuffer(O.READ_FRAMEBUFFER,q),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,B);for(let be=0;be<Ct;be++)ar?O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,ke.__webglTexture,G,qt+be):O.framebufferTexture2D(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,ke.__webglTexture,G),_e?O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,Rs.__webglTexture,yt,Ge+be):O.framebufferTexture2D(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,Rs.__webglTexture,yt),G!==0?O.blitFramebuffer(Nt,Ht,St,vt,Ut,de,St,vt,O.COLOR_BUFFER_BIT,O.NEAREST):_e?O.copyTexSubImage3D(bt,yt,Ut,de,Ge+be,Nt,Ht,St,vt):O.copyTexSubImage2D(bt,yt,Ut,de,Nt,Ht,St,vt);b.bindFramebuffer(O.READ_FRAMEBUFFER,null),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else _e?E.isDataTexture||E.isData3DTexture?O.texSubImage3D(bt,yt,Ut,de,Ge,St,vt,Ct,ge,mn,ze.data):z.isCompressedArrayTexture?O.compressedTexSubImage3D(bt,yt,Ut,de,Ge,St,vt,Ct,ge,ze.data):O.texSubImage3D(bt,yt,Ut,de,Ge,St,vt,Ct,ge,mn,ze):E.isDataTexture?O.texSubImage2D(O.TEXTURE_2D,yt,Ut,de,St,vt,ge,mn,ze.data):E.isCompressedTexture?O.compressedTexSubImage2D(O.TEXTURE_2D,yt,Ut,de,ze.width,ze.height,ge,ze.data):O.texSubImage2D(O.TEXTURE_2D,yt,Ut,de,St,vt,ge,mn,ze);b.pixelStorei(O.UNPACK_ROW_LENGTH,Pn),b.pixelStorei(O.UNPACK_IMAGE_HEIGHT,se),b.pixelStorei(O.UNPACK_SKIP_PIXELS,ni),b.pixelStorei(O.UNPACK_SKIP_ROWS,Di),b.pixelStorei(O.UNPACK_SKIP_IMAGES,Cs),yt===0&&z.generateMipmaps&&O.generateMipmap(bt),b.unbindTexture()},this.initRenderTarget=function(E){X.get(E).__webglFramebuffer===void 0&&J.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?J.setTextureCube(E,0):E.isData3DTexture?J.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?J.setTexture2DArray(E,0):J.setTexture2D(E,0),b.unbindTexture()},this.resetState=function(){W=0,Y=0,tt=null,b.reset(),pt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ei}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=ee._getDrawingBufferColorSpace(t),n.unpackColorSpace=ee._getUnpackColorSpace()}};var gd=12;var ne=(e,t,n=0)=>({time:e,azimuth:t||0,elevation:n,distance:1}),xM=e=>[...Array.from({length:9},(t,n)=>ne(Number((n*5/48).toFixed(6)),e*n*45)),ne(1,e*360)],xc=(e,t=0)=>[ne(0,0),ne(.2,e/2,t/2),ne(.4,e,t),ne(.6,e/2,t/2),ne(.8,0),ne(1,0)],bM=e=>[...Array.from({length:9},(t,n)=>ne(Number((n*5/48).toFixed(6)),e*n*45,n===8?0:Number((25*Math.sin(Math.PI*n/8)).toFixed(3)))),ne(1,e*360)],QU=[{id:"swing",name:"Side Arc",description:"A 65-degree arc around the frame.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,65,8)]},{id:"rise",name:"Hero Rise",description:"A new angle on the action.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,35,30)]},{id:"orbit",name:"Full Orbit",description:"A full right orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:xM(1)},{id:"arc-return",name:"Arc Return",description:"Sweep 45 degrees to the side, then retrace to the starting pose.",duration:5,returnsToStart:!0,trajectory:[ne(0,0),ne(.2,22.5),ne(.45,45),ne(.7,22.5),ne(.9,0),ne(1,0)]},{id:"rise-return",name:"Rise Return",description:"Rise 25 degrees, then descend to the starting pose.",duration:5,returnsToStart:!0,trajectory:[ne(0,0),ne(.2,0,12.5),ne(.45,0,25),ne(.7,0,12.5),ne(.9,0),ne(1,0)]},{id:"orbit-left",name:"Orbit Left",description:"A full left orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:xM(-1)},{id:"arc-left-return",name:"Left Return",description:"Sweep 45 degrees left, then retrace to the opening view.",duration:5,returnsToStart:!0,trajectory:xc(-45)},{id:"wide-return",name:"Wide Return",description:"Reach a 90-degree side view, then return to the opening pose.",duration:5,returnsToStart:!0,trajectory:xc(90)},{id:"dip-return",name:"Dip Return",description:"Dip 20 degrees below the subject, then rise back to the opening view.",duration:5,returnsToStart:!0,trajectory:xc(0,-20)},{id:"high-arc-return",name:"High Return",description:"Arc 45 degrees right and 25 degrees up, then retrace home.",duration:5,returnsToStart:!0,trajectory:xc(45,25)},{id:"low-arc-return",name:"Low Return",description:"Arc 45 degrees left and 20 degrees down, then retrace home.",duration:5,returnsToStart:!0,trajectory:xc(-45,-20)},{id:"sway-return",name:"Side to Side",description:"Sway left, cross through the opening view to the right, then return.",duration:5,returnsToStart:!0,trajectory:[ne(0,0),ne(.2,-30),ne(.4,0),ne(.6,30),ne(.8,0),ne(1,0)]},{id:"halo",name:"High Orbit",description:"Orbit right through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:bM(1)},{id:"halo-left",name:"High Orbit Left",description:"Orbit left through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:bM(-1)},{id:"arc-left",name:"Left Arc",description:"A 65-degree left arc that finishes at a new angle.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,-65,8)]},{id:"low-angle",name:"Low Reveal",description:"Sweep 40 degrees right and descend 20 degrees for a low-angle finish.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,40,-20)]}];var K=Ac(N0());async function Ao(e){let t=e instanceof FormData?e:new FormData;if(!(e instanceof FormData))for(let[n,i]of Object.entries(e))t.set(n,i);t.set("format","json");try{return await(await fetch(window.location.pathname,{method:"POST",body:t,credentials:"same-origin"})).json()}catch{return null}}var Sc=Math.PI/180;function wn(e,t,n){return Math.max(t,Math.min(n,e))}function Mc(e,t){if(t<=e[0].time)return e[0];let n=e[e.length-1];if(t>=n.time)return n;let i=1;for(;e[i].time<t;)i++;let s=e[i-1],a=e[i],r=Math.max(1e-6,a.time-s.time),o=(t-s.time)/r,c=o*o*(3-2*o),l=a.azimuth-s.azimuth;return l=((l%360+540)%360+360)%360-180,{time:t,azimuth:s.azimuth+l*c,elevation:s.elevation+(a.elevation-s.elevation)*c,distance:s.distance+(a.distance-s.distance)*c}}var L0={time:0,azimuth:0,elevation:0,distance:1},h3={...L0,time:1},bc=1024,TM=["#f8fbff","#ffd166","#ff5d8f","#4db0ff","#39d98a"],f3=[{id:"fast",label:"Flare Fast"},{id:"detailed",label:"Flare Detailed"},{id:"turbo",label:"Turbo"},{id:"hq",label:"Sunburst HQ"}];function d3(e){let t=(0,st.useRef)(null),n=(0,st.useRef)([]),i=(0,st.useRef)(!1),[s,a]=(0,st.useState)(TM[0]),[r,o]=(0,st.useState)(14),[c,l]=(0,st.useState)(!1),[h,p]=(0,st.useState)(""),[u,d]=(0,st.useState)("fast"),[,m]=(0,st.useState)(0),S=(0,st.useCallback)(()=>{let _=t.current,x=_?.getContext("2d");if(!(!_||!x)){x.fillStyle="#0a1120",x.fillRect(0,0,bc,bc);for(let v of n.current){x.save(),x.globalCompositeOperation=v.erase?"destination-out":"source-over",x.strokeStyle=v.color,x.fillStyle=v.color,x.lineWidth=v.width,x.lineCap="round",x.lineJoin="round";let[T,...A]=v.points;if(!T){x.restore();continue}x.beginPath(),x.arc(T.x,T.y,v.width/2,0,Math.PI*2),x.fill(),x.beginPath(),x.moveTo(T.x,T.y);for(let w of A)x.lineTo(w.x,w.y);x.stroke(),x.restore()}}},[]);(0,st.useEffect)(()=>S(),[S]);let g=_=>{let x=_.currentTarget.getBoundingClientRect(),v=bc/Math.max(1,Math.min(x.width,x.height));return{x:(_.clientX-x.left)*v,y:(_.clientY-x.top)*v}},f=n.current.length===0;return(0,K.jsxs)("div",{className:"fz-sketch",children:[(0,K.jsx)("canvas",{ref:t,className:"fz-sketch-canvas",width:bc,height:bc,onPointerDown:_=>{_.currentTarget.setPointerCapture(_.pointerId),i.current=!0,n.current.push({points:[g(_)],color:s,width:r,erase:c}),S()},onPointerMove:_=>{i.current&&(n.current[n.current.length-1]?.points.push(g(_)),S())},onPointerUp:()=>{i.current=!1,m(_=>_+1)}}),(0,K.jsxs)("div",{className:"fz-tools",children:[TM.map(_=>(0,K.jsx)("button",{type:"button",className:`fz-swatch${!c&&s===_?" selected":""}`,style:{background:_},"aria-label":`paint ${_}`,onClick:()=>{a(_),l(!1)}},_)),(0,K.jsx)("button",{type:"button",className:`fz-ghost${c?" selected":""}`,onClick:()=>l(_=>!_),children:"erase"}),(0,K.jsx)("input",{className:"fz-size",type:"range",min:4,max:60,value:r,onChange:_=>o(Number(_.target.value)),"aria-label":"brush size"}),(0,K.jsx)("button",{type:"button",className:"fz-ghost",disabled:f,onClick:()=>{n.current=[],S(),m(_=>_+1)},children:"clear"})]}),(0,K.jsx)("textarea",{className:"fz-prompt",placeholder:"describe the scene \u2014 'two friends at a diner, neon light'",value:h,maxLength:2e3,onChange:_=>p(_.target.value)}),(0,K.jsx)("div",{className:"fz-modes",children:f3.map(_=>(0,K.jsx)("button",{type:"button",className:u===_.id?"active":"",onClick:()=>d(_.id),children:_.label},_.id))}),(0,K.jsx)("button",{type:"button",className:"fz-primary",disabled:e.busy||!h.trim(),onClick:()=>{let _=t.current;n.current.length>0&&_?_.toBlob(v=>e.onGenerate(v,h.trim(),u),"image/png"):e.onGenerate(null,h.trim(),u)},children:e.busy?"generating\u2026":"generate the still"})]})}var AM=1/30,wM=10*1024*1024;function p3(e,t,n=1e4){return new Promise((i,s)=>{if(Math.abs(e.currentTime-t)<.001&&e.readyState>=2){i();return}let a=window.setTimeout(()=>{e.removeEventListener("seeked",r),s(new Error("couldn't read that frame"))},n);function r(){window.clearTimeout(a),i()}e.addEventListener("seeked",r,{once:!0}),e.currentTime=t})}function RM(e,t){let n=document.createElement("canvas");n.width=Math.min(t,e.videoWidth),n.height=Math.round(n.width*e.videoHeight/Math.max(1,e.videoWidth));let i=n.getContext("2d");return!i||!n.width?null:(i.drawImage(e,0,0,n.width,n.height),n)}async function m3(e,t,n=1e4){try{await p3(e,t,n);let i=RM(e,160);return i?i.toDataURL("image/jpeg",.8):null}catch{return null}}function g3(e){let{busy:t,onFrame:n}=e,i=(0,st.useRef)(null),s=(0,st.useRef)(null),a=(0,st.useRef)(null),r=(0,st.useRef)(!1),o=(0,st.useRef)(0),[c,l]=(0,st.useState)(null),[h,p]=(0,st.useState)(0),[u,d]=(0,st.useState)(0),[m,S]=(0,st.useState)([]),[g,f]=(0,st.useState)(!1),[_,x]=(0,st.useState)(!1),[v,T]=(0,st.useState)(null);(0,st.useEffect)(()=>()=>{o.current++,a.current&&URL.revokeObjectURL(a.current)},[]);let A=(0,st.useCallback)(async M=>{if(!M)return;if(T(null),!M.type.startsWith("video/")){T("choose a video \u2014 mp4, mov, or webm");return}if(M.size>150*1024*1024){T("choose a clip under 150mb");return}f(!0);let C=++o.current,D=URL.createObjectURL(M),L=()=>o.current!==C;try{let P=document.createElement("video");if(P.preload="auto",P.muted=!0,P.playsInline=!0,await new Promise((W,Y)=>{let tt=window.setTimeout(()=>Y(new Error("that clip took too long to read")),2e4);P.onloadeddata=()=>{window.clearTimeout(tt),W()},P.onerror=()=>{window.clearTimeout(tt),Y(new Error("can't decode that video \u2014 try an h.264 mp4"))},P.src=D}),!Number.isFinite(P.duration)||P.duration<=0||P.duration>120)throw new Error("choose a clip under two minutes");if(L()){P.removeAttribute("src"),P.load(),URL.revokeObjectURL(D);return}let q=[],B=Date.now()+15e3;for(let W=0;W<10&&!L();W++){let Y=B-Date.now();if(Y<=0)break;let tt=Math.max(0,Math.min(P.duration-.05,P.duration*W/10)),ot=await m3(P,tt,Y);ot&&q.push({src:ot,time:tt})}if(L()){P.removeAttribute("src"),P.load(),URL.revokeObjectURL(D);return}a.current&&URL.revokeObjectURL(a.current),a.current=D,l(D),p(P.duration),d(P.duration/2),S(q),P.removeAttribute("src"),P.load()}catch(P){URL.revokeObjectURL(D),L()||T(P instanceof Error?P.message:"that video didn't load")}finally{L()||f(!1)}},[]),w=(0,st.useCallback)(M=>{d(M);let C=s.current;C&&(C.pause(),r.current=!0,C.currentTime=M)},[]),y=(0,st.useCallback)(async()=>{let M=s.current;if(!(!M||_||t)){x(!0);try{(r.current||M.readyState<2||Math.abs(M.currentTime-u)>.001)&&await new Promise((L,P)=>{let q=window.setTimeout(()=>{M.removeEventListener("seeked",B),P(new Error("couldn't read that frame"))},1e4),B=()=>{window.clearTimeout(q),L()};M.addEventListener("seeked",B,{once:!0}),r.current||(M.currentTime=u)});let C=Math.min(1920,M.videoWidth),D=null;for(;C>0;){let L=RM(M,C);if(!L)throw new Error("frame capture isn't available");if(D=await new Promise(P=>L.toBlob(q=>P(q),"image/jpeg",.94)),!D)throw new Error("frame capture isn't available");if(D.size<=wM||C<=320)break;C=Math.floor(C*.75)}if(!D||D.size>wM)throw new Error("that frame is too large \u2014 try a smaller clip");n(new File([D],"freeze-frame.jpg",{type:"image/jpeg"}))}catch(C){T(C instanceof Error?C.message:"couldn't capture the frame")}finally{x(!1)}}},[u,_,t,n]);return(0,K.jsxs)("div",{className:"fz-framepick",children:[(0,K.jsx)("input",{ref:i,type:"file",accept:"video/*",hidden:!0,onChange:M=>void A(M.target.files?.[0]??null)}),c?(0,K.jsxs)(K.Fragment,{children:[(0,K.jsx)("video",{ref:s,className:"fz-video",src:c,muted:!0,playsInline:!0,preload:"auto",onLoadedData:M=>{r.current=!0,M.currentTarget.currentTime=u},onSeeked:()=>{r.current=!1}}),m.length>0&&(0,K.jsx)("div",{className:"fz-strip",children:m.map((M,C)=>(0,K.jsx)("img",{src:M.src,alt:"",onClick:()=>w(M.time)},C))}),(0,K.jsx)("input",{type:"range",className:"fz-scrub",min:0,max:Math.max(AM,h),step:AM,value:u,onChange:M=>w(Number(M.target.value)),"aria-label":"pick the frame"}),(0,K.jsxs)("div",{className:"fz-row",children:[(0,K.jsx)("button",{type:"button",className:"fz-ghost",disabled:g,onClick:()=>i.current?.click(),children:"different clip"}),(0,K.jsx)("button",{type:"button",className:"fz-primary",disabled:_||t,onClick:()=>void y(),children:_?"capturing\u2026":`freeze at ${u.toFixed(2)}s`})]})]}):(0,K.jsxs)("div",{className:"fz-video-empty",children:[(0,K.jsx)("p",{className:"fz-sub",children:"pick the clip \u2014 then scrub to the moment to freeze"}),(0,K.jsx)("button",{type:"button",className:"fz-primary",disabled:g,onClick:()=>i.current?.click(),children:g?"reading the clip\u2026":"choose a video"})]}),v&&(0,K.jsx)("p",{className:"fz-err",children:v})]})}function vd(e,t,n,i){let s=t/2,a=n*.46+(i?.tilt??0)*n*.24,r=i?.zoom??1,o=t*.36*e.distance*r,c=n*.11*e.distance*r,l=(e.azimuth+(i?.yaw??0))*Sc;return{x:s+Math.sin(l)*o,y:a+n*.16+Math.cos(l)*c-Math.sin(e.elevation*Sc)*n*.3,depth:Math.cos(l)}}var sr=.95,I0=2.3;function yd(e,t){let n=e.azimuth*Sc,i=e.elevation*Sc,s=I0*e.distance;return t.set(Math.sin(n)*Math.cos(i)*s,sr+Math.sin(i)*s,Math.cos(n)*Math.cos(i)*s),t}function _3(e){let t=new dd({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),e.appendChild(t.domElement),t.domElement.style.position="absolute",t.domElement.style.inset="0";let n=[],i=k=>(n.push(k),k),s=new Wl;s.fog=new Xl(725009,6.5,16);let a=new yn(54,1,.05,80),r=new U(0,1.12,0),o={yaw:.52,pitch:.19,dist:5.2},c={...o},l=()=>{let k=Math.cos(c.pitch);a.position.set(r.x+Math.sin(c.yaw)*k*c.dist,r.y+Math.sin(c.pitch)*c.dist,r.z+Math.cos(c.yaw)*k*c.dist),a.lookAt(r)};l();let h=i(new rc(14,28,4612956,2372656));s.add(h);let p=i(new tr({color:4482140,dashSize:.16,gapSize:.12,transparent:!0,opacity:.55})),u=[];for(let k=0;k<=128;k++){let at=k/128*Math.PI*2;u.push(new U(Math.sin(at)*I0,sr,Math.cos(at)*I0))}let d=new Yi(i(new Ve().setFromPoints(u)),p);d.computeLineDistances(),s.add(d);let m=i(new Ve().setFromPoints([new U(0,.02,0),new U(0,sr,0)]));s.add(new Yi(m,i(new qi({color:4020818,transparent:!0,opacity:.6}))));let S=[];for(let k=0;k<=64;k++){let at=k/64*Math.PI*2;S.push(new U(Math.sin(at)*.55,.02,Math.cos(at)*.55))}s.add(new Yi(i(new Ve().setFromPoints(S)),i(new qi({color:4020818,transparent:!0,opacity:.7}))));let g=1.9,f=g*.72,_=new $e(i(new ma(g*1.07,f*1.1)),i(new mi({color:858139,side:ti})));_.position.set(0,sr,0);let x=i(new mi({color:4874585,side:ti})),v=i(new ma(g,f)),T=new $e(v,x);T.position.set(0,sr,.001);let A=new go(i(new $l(v)),i(new qi({color:8366235})));A.position.copy(T.position),s.add(_,T,A);let w=i(new mi({color:9426109})),y=null,M=i(new Ve),C=new Yi(M,i(new tr({color:9426109,dashSize:.12,gapSize:.1,transparent:!0,opacity:.28})));C.visible=!1,s.add(C);let D=new Gi;s.add(D);let L=i(new yo(.066,16,12)),P=i(new mi({color:9426109})),q=i(new mi({color:15791604})),B=i(new mi({color:16765286,transparent:!0})),W=new Gi;W.add(new $e(i(new yo(.1,18,14)),B));let Y=new $e(i(new Ql(.062,.22,12)),B);Y.rotation.x=Math.PI/2,Y.position.z=.18,W.add(Y),s.add(W);let tt=i(new Ve().setFromPoints([new U,new U(0,sr,0)])),ot=new Yi(tt,i(new tr({color:16765286,dashSize:.09,gapSize:.09,transparent:!0,opacity:.45})));ot.computeLineDistances(),s.add(ot);let ct=new U,mt=new U(0,sr,0),xt=[],kt=()=>{let k=e.clientWidth,at=e.clientHeight;if(k===0||at===0)return;let rt=new Lt;t.getSize(rt),(rt.x!==k||rt.y!==at)&&(t.setSize(k,at,!1),a.aspect=k/at,a.updateProjectionMatrix()),t.render(s,a)},ue=new ResizeObserver(kt);ue.observe(e);let Yt=null;return{setImage(k){if(Yt?.dispose(),k){let at=new xn(k);at.colorSpace=Tn,at.needsUpdate=!0,Yt=at,x.map=at,x.color.set(16777215)}else Yt=null,x.map=null,x.color.set(4874585);x.needsUpdate=!0,kt()},update(k,at,rt){xt=k;let Rt=[];for(let Mt=0;Mt<=96;Mt++){let Wt=yd(Mc(k,Mt/96),new U),Dt=Rt[Rt.length-1];Dt&&Wt.distanceToSquared(Dt)<1e-8||Rt.push(Wt)}if(Rt.length>=2){let Mt=new vo(Rt),Wt=new nc(Mt,120,.03,8,!1),Dt=new $e(Wt,w);y&&(s.remove(y),y.geometry.dispose()),y=Dt,s.add(y),M.setFromPoints(Rt.map(Zt=>new U(Zt.x,.02,Zt.z))),C.computeLineDistances(),C.visible=!0}else y&&(s.remove(y),y.geometry.dispose(),y=null,C.visible=!1);D.clear(),k.forEach((Mt,Wt)=>{let Dt=new $e(L,Wt===rt?q:P);Dt.position.copy(yd(Mt,ct)),Wt===rt&&Dt.scale.setScalar(1.3),Dt.userData.index=Wt,D.add(Dt)});let Ot=Mc(k,at);W.position.copy(yd(Ot,ct)),W.lookAt(mt),B.opacity=Math.cos(Ot.azimuth*Sc)<-.05?.45:1,tt.setFromPoints([W.position.clone(),mt.clone()]),ot.computeLineDistances(),kt()},orbit(k,at){c.yaw-=k*.0075,c.pitch=wn(c.pitch+at*.006,-.15,1.35),l(),kt()},zoom(k){c.dist=wn(c.dist/k,3.2,10),l(),kt()},viewDirty(){return Math.abs(c.yaw-o.yaw)>.01||Math.abs(c.pitch-o.pitch)>.01||Math.abs(c.dist-o.dist)>.05},resetView(){return Math.abs(c.yaw-o.yaw)<=.01&&Math.abs(c.pitch-o.pitch)<=.01&&Math.abs(c.dist-o.dist)<=.05?!1:(Object.assign(c,o),l(),kt(),!0)},pick(k,at){let rt=e.clientWidth,Rt=e.clientHeight,Ot=null,Mt=30;return xt.forEach((Wt,Dt)=>{yd(Wt,ct).project(a);let Zt=(ct.x*.5+.5)*rt,$t=(-ct.y*.5+.5)*Rt,Bt=Math.hypot(Zt-k,$t-at);Bt<Mt&&(Mt=Bt,Ot=Dt)}),Ot},dispose(){ue.disconnect(),Yt?.dispose(),n.forEach(k=>k.dispose()),y?.geometry.dispose(),t.dispose(),t.domElement.remove()}}}var wo=14;function v3(e){let t=(0,st.useRef)(null),n=(0,st.useRef)(null),[i,s]=(0,st.useState)(!1),a=(0,st.useRef)(null),r=(0,st.useRef)(new Map),o=(0,st.useRef)(e);o.current=e;let c=()=>{let l=a.current;l?.mode==="draw"&&l.snapshot&&l.travel>=wo&&l.samples.length>=2&&o.current.onDrawRevert(l.snapshot)};return(0,st.useEffect)(()=>{let l=t.current;if(!l||o.current.lite)return;let h=null;try{h=_3(l)}catch{return}n.current=h;let p={reset:()=>h.resetView()?(o.current.onViewChange(!1),!0):!1};return o.current.viewCtl.current=p,o.current.onViewChange(!1),s(!0),()=>{n.current=null,o.current.viewCtl.current===p&&(o.current.viewCtl.current=null),h.dispose()}},[]),(0,st.useEffect)(()=>{n.current?.setImage(e.image)},[i,e.image]),(0,st.useEffect)(()=>{n.current?.update(e.keyframes,e.scrubT,e.selected)},[i,e.keyframes,e.scrubT,e.selected]),(0,K.jsx)("div",{ref:t,className:"fz-stage-canvas",onPointerDown:l=>{if(!i)return;if(r.current.set(l.pointerId,{x:l.clientX,y:l.clientY}),l.currentTarget.setPointerCapture(l.pointerId),r.current.size>=2){c();let d=[...r.current.values()];a.current={mode:"view",picked:null,moved:!0,lastX:(d[0].x+d[1].x)/2,lastY:(d[0].y+d[1].y)/2,az:0,el:0,travel:0,samples:[],pinchD:Math.hypot(d[0].x-d[1].x,d[0].y-d[1].y),snapshot:null};return}let h=l.currentTarget.getBoundingClientRect(),p=n.current?.pick(l.clientX-h.left,l.clientY-h.top)??null;p!==null&&o.current.onPick(p);let u=p!==null&&(o.current.keyframes[p]?.time===0||o.current.keyframes[p]?.time===1);a.current={mode:o.current.mode==="draw"?"draw":o.current.mode==="look"?"view":p===null||u?"none":"edit",picked:p,moved:!1,lastX:l.clientX,lastY:l.clientY,az:0,el:0,travel:0,samples:[{azimuth:0,elevation:0}],pinchD:0,snapshot:o.current.keyframes}},onPointerMove:l=>{let h=a.current;if(!h||!i)return;if(r.current.has(l.pointerId)&&r.current.set(l.pointerId,{x:l.clientX,y:l.clientY}),h.mode==="view"){let d=n.current,m=[...r.current.values()];if(!d||m.length===0)return;let S=m.reduce((f,_)=>f+_.x,0)/m.length,g=m.reduce((f,_)=>f+_.y,0)/m.length;if(d.orbit(S-h.lastX,g-h.lastY),h.lastX=S,h.lastY=g,m.length===2){let f=Math.hypot(m[0].x-m[1].x,m[0].y-m[1].y);h.pinchD>0&&d.zoom(f/h.pinchD),h.pinchD=f}else h.pinchD=0;o.current.onViewChange(d.viewDirty());return}let p=l.clientX-h.lastX,u=l.clientY-h.lastY;if(!(Math.abs(p)+Math.abs(u)<.5)){if(h.lastX=l.clientX,h.lastY=l.clientY,h.moved=!0,h.mode==="edit"){o.current.onDragPose(p*.6,-u*.4,h.picked);return}h.mode!=="none"&&(h.travel+=Math.abs(p)+Math.abs(u),h.az=wn(h.az+p*.6,-360,360),h.el=wn(h.el-u*.4,-90,90),h.samples.length<600?h.samples.push({azimuth:h.az,elevation:h.el}):h.samples[h.samples.length-1]={azimuth:h.az,elevation:h.el},h.travel>=wo&&h.samples.length>=2&&(h.samples.length<4||h.samples.length%4===0)&&o.current.onDrawPath(h.samples))}},onPointerUp:l=>{r.current.delete(l.pointerId);let h=a.current;if(h?.mode==="view"){if(r.current.size===0)a.current=null;else{let p=[...r.current.values()][0];h.lastX=p.x,h.lastY=p.y,h.pinchD=0}return}if(a.current=null,!(!h||!i)){if(!h.moved){o.current.onPick(h.picked);return}h.mode==="draw"&&h.travel>=wo&&h.samples.length>=2&&o.current.onDrawPath(h.samples)}},onPointerCancel:l=>{r.current.delete(l.pointerId);let h=a.current;if(h?.mode==="view"&&r.current.size>0){let p=[...r.current.values()][0];h.lastX=p.x,h.lastY=p.y,h.pinchD=0;return}a.current=null},children:!i&&(0,K.jsx)(y3,{...e})})}function y3(e){let t=(0,st.useRef)(null),n=(0,st.useRef)(null),i=(0,st.useRef)(new Map),s=(0,st.useRef)({yaw:0,tilt:0,zoom:1}),a=(0,st.useRef)(e);a.current=e;let r=()=>{let c=n.current;c?.mode==="draw"&&c.snapshot&&c.travel>=wo&&c.samples.length>=2&&a.current.onDrawRevert(c.snapshot)},o=(0,st.useCallback)(()=>{let c=t.current,l=c?.getContext("2d");if(!c||!l)return;let h=Math.min(2,window.devicePixelRatio||1),p=c.clientWidth,u=c.clientHeight;(c.width!==p*h||c.height!==u*h)&&(c.width=p*h,c.height=u*h),l.setTransform(h,0,0,h,0,0),l.clearRect(0,0,p,u),l.strokeStyle="rgba(160,196,182,0.10)",l.lineWidth=1;let d=u*.62;for(let M=0;M<=12;M++){let C=d+Math.pow(M/12,1.6)*(u-d);l.beginPath(),l.moveTo(0,C),l.lineTo(p,C),l.stroke()}for(let M=-8;M<=8;M++)l.beginPath(),l.moveTo(p/2+M*p*.07,d),l.lineTo(p/2+M*p*.22,u),l.stroke();let m=s.current,S=p/2,g=u*.46+m.tilt*u*.24,f=p*.36*m.zoom,_=u*.11*m.zoom;l.strokeStyle="rgba(159,216,197,0.22)",l.setLineDash([4,6]),l.beginPath(),l.ellipse(S,g+u*.16,f,_,0,0,Math.PI*2),l.stroke(),l.setLineDash([]);let x=e.keyframes;if(x.length>=2){l.strokeStyle="rgba(143,212,189,0.9)",l.lineWidth=3,l.lineCap="round",l.beginPath();let M=96;for(let C=0;C<=M;C++){let D=vd(Mc(x,C/M),p,u,m);C===0?l.moveTo(D.x,D.y):l.lineTo(D.x,D.y)}l.stroke()}let v=Math.min(p*.4,u*.4*(4/3)),T=v*.72;if(l.save(),l.shadowColor="rgba(0,0,0,0.6)",l.shadowBlur=24,l.fillStyle="#0d181b",l.fillRect(S-v/2,g-T/2,v,T),l.restore(),e.image){let M=e.image,C=Math.min(v/M.width,T/M.height),D=M.width*C,L=M.height*C;l.drawImage(M,S-D/2,g-L/2,D,L)}else l.fillStyle="rgba(214,233,226,0.5)",l.font="13px ui-monospace, monospace",l.textAlign="center",l.fillText("no photo",S,g);l.strokeStyle="rgba(159,216,197,0.45)",l.strokeRect(S-v/2,g-T/2,v,T),x.forEach((M,C)=>{let D=vd(M,p,u,m);l.beginPath(),l.arc(D.x,D.y,C===e.selected?7:5,0,Math.PI*2),l.fillStyle=C===e.selected?"#f0f5f4":"#8fd4bd",l.fill(),C===e.selected&&(l.strokeStyle="rgba(143,212,189,0.6)",l.lineWidth=2,l.stroke())});let A=Mc(x,e.scrubT),w=vd(A,p,u,m),y=w.depth<-.05;l.globalAlpha=y?.45:1,l.beginPath(),l.arc(w.x,w.y,13,0,Math.PI*2),l.fillStyle="#ffd166",l.fill(),l.beginPath(),l.arc(w.x,w.y,5,0,Math.PI*2),l.fillStyle="#0a1120",l.fill(),l.strokeStyle="rgba(255,209,102,0.35)",l.setLineDash([3,5]),l.beginPath(),l.moveTo(w.x,w.y),l.lineTo(S,g),l.stroke(),l.setLineDash([]),l.globalAlpha=1},[e.image,e.keyframes,e.scrubT,e.selected]);return(0,st.useEffect)(()=>{let c=()=>{let h=s.current;return Math.abs(h.yaw)>.5||Math.abs(h.tilt)>.02||Math.abs(h.zoom-1)>.02},l={reset:()=>c()?(s.current={yaw:0,tilt:0,zoom:1},o(),a.current.onViewChange(!1),!0):!1};return a.current.viewCtl.current=l,a.current.onViewChange(!1),()=>{a.current.viewCtl.current===l&&(a.current.viewCtl.current=null)}},[o]),(0,st.useEffect)(()=>{o()},[o]),(0,st.useEffect)(()=>{let c=()=>o();return window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)},[o]),(0,K.jsx)("canvas",{ref:t,className:"fz-stage-canvas",onPointerDown:c=>{if(i.current.set(c.pointerId,{x:c.clientX,y:c.clientY}),c.currentTarget.setPointerCapture(c.pointerId),i.current.size>=2){r();let m=[...i.current.values()];n.current={mode:"view",picked:null,moved:!0,lastX:(m[0].x+m[1].x)/2,lastY:(m[0].y+m[1].y)/2,az:0,el:0,travel:0,samples:[],pinchD:Math.hypot(m[0].x-m[1].x,m[0].y-m[1].y),snapshot:null};return}let l=c.currentTarget.getBoundingClientRect(),h=c.clientX-l.left,p=c.clientY-l.top,u=e.keyframes.findIndex(m=>{let S=vd(m,l.width,l.height,s.current);return Math.hypot(S.x-h,S.y-p)<20});u>=0&&e.onPick(u);let d=u>=0&&(e.keyframes[u]?.time===0||e.keyframes[u]?.time===1);n.current={mode:e.mode==="draw"?"draw":e.mode==="look"?"view":u<0||d?"none":"edit",picked:u>=0?u:null,moved:!1,lastX:c.clientX,lastY:c.clientY,az:0,el:0,travel:0,samples:[{azimuth:0,elevation:0}],pinchD:0,snapshot:e.keyframes}},onPointerMove:c=>{let l=n.current;if(!l)return;if(i.current.has(c.pointerId)&&i.current.set(c.pointerId,{x:c.clientX,y:c.clientY}),l.mode==="view"){let u=[...i.current.values()];if(u.length===0)return;let d=u.reduce((_,x)=>_+x.x,0)/u.length,m=u.reduce((_,x)=>_+x.y,0)/u.length,S=d-l.lastX,g=m-l.lastY,f=s.current;if(f.yaw-=S*.3,f.tilt=wn(f.tilt+g*.0035,-.5,.7),l.lastX=d,l.lastY=m,u.length===2){let _=Math.hypot(u[0].x-u[1].x,u[0].y-u[1].y);l.pinchD>0&&(f.zoom=wn(f.zoom*(_/l.pinchD),.7,2.2)),l.pinchD=_}else l.pinchD=0;o(),a.current.onViewChange(Math.abs(f.yaw)>.5||Math.abs(f.tilt)>.02||Math.abs(f.zoom-1)>.02);return}let h=c.clientX-l.lastX,p=c.clientY-l.lastY;if(!(Math.abs(h)+Math.abs(p)<.5)){if(l.lastX=c.clientX,l.lastY=c.clientY,l.moved=!0,l.mode==="edit"){e.onDragPose(h*.6,-p*.4,l.picked);return}l.mode!=="none"&&(l.travel+=Math.abs(h)+Math.abs(p),l.az=wn(l.az+h*.6,-360,360),l.el=wn(l.el-p*.4,-90,90),l.samples.length<600?l.samples.push({azimuth:l.az,elevation:l.el}):l.samples[l.samples.length-1]={azimuth:l.az,elevation:l.el},l.travel>=wo&&l.samples.length>=2&&(l.samples.length<4||l.samples.length%4===0)&&e.onDrawPath(l.samples))}},onPointerUp:c=>{i.current.delete(c.pointerId);let l=n.current;if(l?.mode==="view"){if(i.current.size===0)n.current=null;else{let h=[...i.current.values()][0];l.lastX=h.x,l.lastY=h.y,l.pinchD=0}return}if(n.current=null,!!l){if(!l.moved){e.onPick(l.picked);return}l.mode==="draw"&&l.travel>=wo&&l.samples.length>=2&&e.onDrawPath(l.samples)}},onPointerCancel:c=>{i.current.delete(c.pointerId);let l=n.current;if(l?.mode==="view"&&i.current.size>0){let h=[...i.current.values()][0];l.lastX=h.x,l.lastY=h.y,l.pinchD=0;return}n.current=null}})}function x3({kind:e}){let t={orbit:"M50 43a34 13 0 1 1 1 0l-5-4m5 4-5 3","orbit-left":"M50 43a34 13 0 1 0-1 0l5-4m-5 4 5 3",swing:"M50 43Q84 44 84 30Q82 20 67 19",rise:"M50 43Q88 43 77 18Q68 4 50 7","arc-return":"M50 43Q84 44 84 30Q82 20 67 19M67 23Q78 24 79 30Q79 39 50 39l5-4m-5 4 5 3","rise-return":"M46 43V10l-4 5m4-5 4 5M56 10v33l-4-5m4 5 4-5","arc-left-return":"M50 43Q16 44 16 30Q18 20 33 19M33 23Q22 24 21 30Q21 39 50 39l-5-4m5 4-5 3","wide-return":"M50 43C5 43 5 17 50 17C90 17 90 39 50 39l5-4m-5 4 5 3","dip-return":"M46 16v32l-4-5m4 5 4-5M56 48V16l-4 5m4-5 4 5","high-arc-return":"M50 43Q84 30 72 8M72 8Q76 30 50 39l5-5","low-arc-return":"M50 24Q16 30 28 49M28 49Q24 30 50 28l-5-4","sway-return":"M50 43Q16 43 16 30Q50 8 84 30Q84 43 50 43l5-4m-5 4 5 3",halo:"M50 43C96 43 91 5 50 5C9 5 4 43 50 43l-5-4m5 4-5 3","halo-left":"M50 43C4 43 9 5 50 5C91 5 96 43 50 43l5-4m-5 4 5 3","arc-left":"M50 43Q16 44 16 30Q18 20 33 19","low-angle":"M50 20Q85 20 78 48l-5-4m5 4 3-5"};return(0,K.jsxs)("svg",{className:"fz-path",viewBox:"0 0 100 56","aria-hidden":"true",children:[(0,K.jsx)("ellipse",{cx:"50",cy:"30",rx:"34",ry:"13",className:"fz-path-guide"}),(0,K.jsx)("path",{d:"M50 13v25M43 33l7 5 7-5",className:"fz-path-axis"}),(0,K.jsx)("circle",{cx:"50",cy:"29",r:"4",className:"fz-path-subject"}),(0,K.jsx)("path",{className:"fz-path-motion",d:t[e]??t.orbit}),(0,K.jsx)("circle",{cx:"50",cy:"43",r:"3",className:"fz-path-camera"})]})}function b3(e){let[t,n]=(0,st.useState)(e.initial.sourceAssetId?"camera":"source"),[i,s]=(0,st.useState)(e.initial.sourceUrl),[a,r]=(0,st.useState)(e.initial.sourceAssetId),[o,c]=(0,st.useState)(e.initial.renders),[l,h]=(0,st.useState)(e.initial.activeJob),[p,u]=(0,st.useState)(e.initial.latest),[d,m]=(0,st.useState)(!1),[S,g]=(0,st.useState)(null),[f,_]=(0,st.useState)(!1),[x,v]=(0,st.useState)(!1),[T,A]=(0,st.useState)(!1),[w,y]=(0,st.useState)(null),[M,C]=(0,st.useState)([L0,{time:.5,azimuth:65,elevation:8,distance:1},h3]),[D,L]=(0,st.useState)(0),[P,q]=(0,st.useState)(null),[B,W]=(0,st.useState)("draw"),[Y,tt]=(0,st.useState)(!1),ot=(0,st.useRef)(null),[ct,mt]=(0,st.useState)(null),[xt,kt]=(0,st.useState)(5),[ue,Yt]=(0,st.useState)("768P"),[k]=(0,st.useState)(()=>Math.floor(Math.random()*1e6)),at=(0,st.useRef)(null),[,rt]=(0,st.useState)(0),Rt=(0,st.useRef)(null),Ot=(0,st.useRef)(null),Mt=(0,st.useRef)(0),Wt=(0,st.useRef)(e.initial.sourceAssetId),Dt=(0,st.useRef)(null),Zt=(0,st.useCallback)(I=>{let $=Dt.current;$&&$!==I&&(URL.revokeObjectURL($),Dt.current=null),I.startsWith("blob:")&&(Dt.current=I),s(I)},[]),$t=(0,st.useCallback)(()=>{Dt.current&&(URL.revokeObjectURL(Dt.current),Dt.current=null),s(null)},[]);(0,st.useEffect)(()=>()=>{Dt.current&&URL.revokeObjectURL(Dt.current)},[]);let Bt=(0,st.useCallback)((I,$=!1)=>{if(typeof I.latest=="number"&&u(I.latest),h(I.activeJob??null),I.line&&g(I.line),I.sourceUrl&&($||I.sourceAssetId!==Wt.current)&&Zt(I.sourceUrl),I.sourceAssetId&&(Wt.current=I.sourceAssetId,r(I.sourceAssetId)),I.renders&&c(I.renders),w&&!I.activeJob){let Q=(w.kind==="render"?I.renders:I.sketches)?.find(V=>V.jobId===w.id);Q&&(Q.state==="delivered"||Q.state==="failed")&&(y(null),Q.state==="delivered"?w.kind==="render"?(g(null),n("result")):(_(!1),g("still delivered \u2014 set the camera move"),n("camera")):g(Q.error??"that didn't come out \u2014 try again?"))}},[w,Zt]),Le=(0,st.useRef)(0),le=(0,st.useCallback)(async()=>{let I=++Le.current,$=await Ao({action:"status",after:String(p)});if(!(!$||I!==Le.current))return Bt($),$},[p,Bt]),He=(0,st.useCallback)(async I=>{for(let $=0;$<10;$++){if(Wt.current!==I)return;let N=await le();if(Wt.current!==I)return;if(N&&N.sourceAssetId===I&&(Bt(N,!0),N.sourceUrl)){g(null);return}await new Promise(Q=>setTimeout(Q,1200))}Wt.current===I&&g("still converting \u2014 back out and re-upload if it stalls")},[le,Bt]),Pe=(0,st.useCallback)(()=>{let I=Date.now();I-Mt.current<3e4||(Mt.current=I,le().then($=>{$&&Bt($,!0)}))},[le,Bt]),ye=(0,st.useRef)(0);(0,st.useEffect)(()=>{let I=++ye.current;if(!i){at.current=null,rt(N=>N+1);return}let $=new Image;$.crossOrigin="anonymous",$.onload=()=>{I===ye.current&&(at.current=$,rt(N=>N+1))},$.onerror=()=>{I===ye.current&&Pe()},$.src=i},[i,Pe]),(0,st.useEffect)(()=>{if(!l)return;let I=!1,$=window.setInterval(()=>{I||(I=!0,le().finally(()=>{I=!1}))},2500);return()=>window.clearInterval($)},[l,le]);let Ee=(I,$)=>g(I?.line??$),O=(0,st.useCallback)(async I=>{if(!I||d)return;m(!0),g("reading the photo\u2026");let N=I.type.startsWith("image/")&&!/hei[cf]/i.test(I.type)?URL.createObjectURL(I):null,Q=new FormData;Q.set("action","source"),Q.set("file",I);let V=await Ao(Q);if(m(!1),!V||V.error||V.sourceAssetId===void 0){N&&URL.revokeObjectURL(N),Ee(V,"that photo didn't come through \u2014 try another.");return}g(null),r(V.sourceAssetId),_(!1),v(!1),Wt.current=V.sourceAssetId,V.sourceUrl?(N&&URL.revokeObjectURL(N),Zt(V.sourceUrl)):N?Zt(N):($t(),g("converting the photo\u2026")),n("camera"),le(),!V.sourceUrl&&!N&&V.sourceAssetId&&He(V.sourceAssetId)},[d,le,Zt,$t,He]),pn=(0,st.useCallback)(async(I,$,N)=>{if(d)return;m(!0),g("generating the still \u2014 about a minute");let Q=new FormData;Q.set("action","source"),Q.set("kind","sketch"),Q.set("prompt",$),Q.set("mode",N),I&&Q.set("canvas",I,"sketch.png");let V=await Ao(Q);if(m(!1),!V||V.error||!V.jobId){Ee(V,"that didn't work \u2014 try again?");return}y({id:V.jobId,kind:"sketch"}),Bt(V),g("generating the still \u2014 about a minute")},[d,Bt]),ae=(0,st.useCallback)(I=>{mt(I.id),kt(I.duration===6?6:5),C(I.trajectory.map($=>({...$}))),q(null),L(0)},[]),R=(0,st.useCallback)(()=>{let I=wn(D,.02,.98);if(M.length>=gd||M.some(Q=>Math.abs(Q.time-I)<.01))return;let $=Mc(M,I),N=[...M,{...$,time:I}].sort((Q,V)=>Q.time-V.time).map(Q=>({...Q}));C(N),q(null),mt(null)},[M,D]),b=(0,st.useCallback)(()=>{C(I=>{if(P===null||I.length<=2)return I;let $=I[P];return!$||$.time===0||$.time===1?I:I.filter((N,Q)=>Q!==P)}),q(null),mt(null)},[P]),F=(0,st.useCallback)((I,$,N)=>{A(!0),mt(null),C(Q=>{let V=N??P;if(V===null){let nt=1/0;Q.forEach((Tt,Et)=>{let Te=Math.abs(Tt.time-D);Te<nt&&(nt=Te,V=Et)})}if(V===null)return Q;let lt=Q[V];if(!lt||lt.time===0||lt.time===1)return Q;let pt=Q.map((nt,Tt)=>Tt===V?{...nt,azimuth:wn(nt.azimuth+I,-360,360),elevation:wn(nt.elevation+$,-90,90)}:nt);return q(V),pt})},[P,D]),X=(0,st.useCallback)(I=>{if(I.length===0)return;let $=Math.min(I.length,gd-1),N=[{...L0}];for(let lt=0;lt<$-1;lt++){let pt=Math.floor(lt*(I.length-1)/Math.max(1,$-1)),nt=I[Math.min(pt,I.length-1)];N.push({time:Number(((lt+1)/$).toFixed(4)),azimuth:Math.round(nt.azimuth*10)/10,elevation:Math.round(nt.elevation*10)/10,distance:1})}let Q=I[I.length-1];N.push({time:1,azimuth:Math.round(Q.azimuth*10)/10,elevation:Math.round(Q.elevation*10)/10,distance:1});let V=[];for(let lt of N){let pt=V[V.length-1];pt&&Math.abs(lt.azimuth-pt.azimuth)<.05&&Math.abs(lt.elevation-pt.elevation)<.05?V[V.length-1]={...pt,time:V.length===1?pt.time:lt.time}:V.push(lt)}V.length<2||(A(!0),mt(null),q(null),C(V),L(1))},[]),J=(0,st.useCallback)(I=>{C(I.map($=>({...$}))),q(null)},[]),ut=(0,st.useCallback)((I,$)=>{mt(null),A(!0),C(N=>N.map((Q,V)=>V!==I||Q.time===0||Q.time===1?Q:{...Q,...$.azimuth!==void 0?{azimuth:wn($.azimuth,-360,360)}:{},...$.elevation!==void 0?{elevation:wn($.elevation,-90,90)}:{}}))},[]),gt=(0,st.useCallback)(async()=>{if(d||!a||!i)return;m(!0),g("rendering the freeze \u2014 a few minutes");let I={action:"render",duration:String(xt),resolution:ue,seed:String(k)};ct?I.preset=ct:I.trajectory=JSON.stringify(M);let $=await Ao(I);if(m(!1),!$||$.error||!$.jobId){Ee($,"that render didn't start \u2014 try again?");return}y({id:$.jobId,kind:"render"}),Bt($),g("freezing \u2014 a few minutes")},[d,a,i,ct,ue,k,M,xt,Bt]),j=(0,st.useCallback)(async I=>{if(d)return;m(!0),g("sending to iMessage\u2026");let $=await Ao({action:"save",job:I});if(m(!1),!$||$.error){Ee($,"couldn't send it \u2014 try again");return}$.downloadUrl?(window.open($.downloadUrl,"_blank","noopener"),g("sent the link \u2014 it's only good for a little while")):g("sent to iMessage")},[d]),et=(0,st.useCallback)(async()=>{await Ao({action:"cancel"}),y(null),g(null),await le()},[le]),dt=(0,st.useMemo)(()=>o.filter(I=>I.state==="delivered"&&I.outputUrl),[o]),At=dt[dt.length-1],ft=P!==null&&P<M.length?P:null;if(ft===null){let I=1/0;M.forEach(($,N)=>{if($.time===0||$.time===1)return;let Q=Math.abs($.time-D);Q<I&&(I=Q,ft=N)})}let ht=ft!==null?M[ft]:void 0,wt=!!ht&&ht.time!==0&&ht.time!==1;return(0,K.jsxs)("div",{className:"fz",children:[(0,K.jsx)("div",{className:"fz-tabs",children:["source","camera","result"].map(I=>(0,K.jsx)("button",{type:"button",className:t===I?"active":"",disabled:I==="camera"&&!a||I==="result"&&dt.length===0,onClick:()=>n(I),children:I==="source"?"1 \xB7 photo":I==="camera"?"2 \xB7 camera":"3 \xB7 freeze"},I))}),l&&(0,K.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void et(),children:"cancel the running job"}),t==="source"&&(0,K.jsx)("div",{className:"fz-stage",children:!f&&!x?(0,K.jsxs)(K.Fragment,{children:[(0,K.jsxs)("div",{className:"fz-hero",children:[(0,K.jsx)("p",{className:"fz-title",children:"freeze the scene"}),(0,K.jsx)("p",{className:"fz-sub",children:"pick the still \u2014 the camera moves, the moment doesn\u2019t"})]}),(0,K.jsxs)("div",{className:"fz-source-grid",children:[(0,K.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>Ot.current?.click(),children:[(0,K.jsx)("span",{className:"fz-card-icon",children:"\u25C9"}),"take a photo"]}),(0,K.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>Rt.current?.click(),children:[(0,K.jsx)("span",{className:"fz-card-icon",children:"\u25A4"}),"upload a photo"]}),(0,K.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>_(!0),children:[(0,K.jsx)("span",{className:"fz-card-icon",children:"\u270E"}),"sketch + generate"]}),(0,K.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>v(!0),children:[(0,K.jsx)("span",{className:"fz-card-icon",children:"\u25B6"}),"video \u2192 freeze a frame"]})]}),(0,K.jsx)("input",{ref:Ot,type:"file",accept:"image/*,.heic,.heif",capture:"environment",hidden:!0,onChange:I=>void O(I.target.files?.[0]??null)}),(0,K.jsx)("input",{ref:Rt,type:"file",accept:"image/*,.heic,.heif",hidden:!0,onChange:I=>void O(I.target.files?.[0]??null)}),dt.length>0&&(0,K.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("result"),children:"see your freezes \u2192"})]}):f?(0,K.jsxs)(K.Fragment,{children:[(0,K.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>_(!1),children:"\u2190 back"}),(0,K.jsx)(d3,{busy:d||w?.kind==="sketch",onGenerate:pn})]}):(0,K.jsxs)(K.Fragment,{children:[(0,K.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>v(!1),children:"\u2190 back"}),(0,K.jsx)(g3,{busy:d,onFrame:I=>void O(I)})]})}),t==="camera"&&(0,K.jsxs)("div",{className:"fz-stage fz-cam",children:[(0,K.jsxs)("div",{className:"fz-stage-wrap",children:[(0,K.jsx)(v3,{image:at.current,keyframes:M,scrubT:D,selected:P,lite:e.initial.lite,mode:B,onViewChange:tt,viewCtl:ot,onDragPose:F,onDrawPath:X,onDrawRevert:J,onPick:q}),Y&&(0,K.jsx)("button",{type:"button",className:"fz-viewreset",onClick:()=>ot.current?.reset(),children:"reset view"}),!T&&(0,K.jsxs)("div",{className:"fz-stage-hint",children:[(0,K.jsx)("span",{className:"fz-stage-dot"}),B==="draw"?"drag to draw the camera path":B==="look"?"drag to look \u2014 pinch to zoom":"drag a dot to move it"]})]}),(0,K.jsxs)("div",{className:"fz-modebar",role:"group","aria-label":"stage gesture",children:[(0,K.jsx)("span",{className:"fz-ctl-label",children:"stage"}),(0,K.jsxs)("div",{className:"fz-seg",children:[(0,K.jsx)("button",{type:"button",className:B==="draw"?"active":"","aria-pressed":B==="draw",onClick:()=>W("draw"),children:"draw path"}),(0,K.jsx)("button",{type:"button",className:B==="edit"?"active":"","aria-pressed":B==="edit",onClick:()=>W("edit"),children:"move dot"}),(0,K.jsx)("button",{type:"button",className:B==="look"?"active":"","aria-pressed":B==="look",onClick:()=>W("look"),children:"look"})]})]}),(0,K.jsx)("div",{className:"fz-ctl-label",children:"camera move"}),(0,K.jsx)("div",{className:"fz-prail",children:e.initial.presets.map(I=>(0,K.jsxs)("button",{type:"button",className:`fz-preset${ct===I.id?" active":""}`,title:I.description,"aria-pressed":ct===I.id,onClick:()=>ae(I),children:[(0,K.jsx)(x3,{kind:I.id}),(0,K.jsx)("span",{className:"fz-preset-name",children:I.name}),(0,K.jsx)("span",{className:"fz-preset-return",children:I.returnsToStart?"returns to start":"new angle"})]},I.id))}),(0,K.jsxs)("div",{className:"fz-timeline",children:[(0,K.jsxs)("div",{className:"fz-timeline-meta",children:[(0,K.jsxs)("span",{children:[(D*xt).toFixed(2),"s / ",xt,"s"]}),(0,K.jsxs)("span",{children:[M.length," keyframes",ct?` \xB7 ${e.initial.presets.find(I=>I.id===ct)?.name??ct}`:" \xB7 drawn",P!==null&&(M[P].time===0||M[P].time===1?" \xB7 endpoint":` \xB7 kf ${P+1}`)]})]}),(0,K.jsxs)("div",{className:"fz-track",onPointerDown:I=>{let $=I.currentTarget.getBoundingClientRect(),N=I.clientX-$.left,Q=null,V=23;M.forEach((lt,pt)=>{let nt=Math.abs(lt.time*$.width-N);nt<V&&(V=nt,Q=pt)}),Q!==null?(q(Q),L(M[Q].time)):L(wn(N/$.width,0,1)),I.currentTarget.setPointerCapture(I.pointerId)},onPointerMove:I=>{if(I.buttons!==1)return;let $=I.currentTarget.getBoundingClientRect();L(wn((I.clientX-$.left)/$.width,0,1))},children:[(0,K.jsx)("div",{className:"fz-track-ticks"}),M.map((I,$)=>(0,K.jsx)("button",{type:"button",className:`fz-kf${P===$?" selected":""}`,style:{left:`${I.time*100}%`},onClick:()=>{q($),L(I.time)},"aria-label":`keyframe ${$+1} at ${Math.round(I.time*100)}%`},$)),(0,K.jsx)("div",{className:"fz-head",style:{left:`${D*100}%`},children:(0,K.jsx)("i",{})})]}),(0,K.jsxs)("div",{className:"fz-timeline-row",children:[(0,K.jsx)("span",{className:"fz-meta",children:P!==null?M[P].time===0||M[P].time===1?"endpoints hold the framing":"move this dot with the sliders or the scene":B==="draw"?"drag the scene to sketch the path":B==="look"?"drag to look around \u2014 pinch to zoom":"drag a dot to move it"}),(0,K.jsxs)("div",{className:"fz-timeline-actions",children:[(0,K.jsx)("button",{type:"button",className:"fz-ghost",disabled:M.length>=gd,onClick:R,children:"+ keyframe"}),(0,K.jsx)("button",{type:"button",className:"fz-ghost",disabled:P===null||M[P]?.time===0||M[P]?.time===1,onClick:b,children:"\u2212 remove"})]})]})]}),(0,K.jsxs)("div",{className:"fz-aim",children:[(0,K.jsx)("div",{className:"fz-ctl-label",children:wt?`aim \u2014 keyframe ${(ft??0)+1}`:"aim \u2014 tap a middle dot on the timeline"}),(0,K.jsxs)("div",{className:"fz-aim-row",children:[(0,K.jsx)("span",{className:"fz-aim-label",children:"orbit"}),(0,K.jsx)("input",{type:"range",min:-360,max:360,step:1,value:ht?.azimuth??0,disabled:!wt,"aria-label":"orbit angle in degrees",onChange:I=>{ft!==null&&ut(ft,{azimuth:Number(I.target.value)})}}),(0,K.jsx)("span",{className:"fz-aim-val",children:wt&&ht?`${Math.round(ht.azimuth)}\xB0`:"\u2014"})]}),(0,K.jsxs)("div",{className:"fz-aim-row",children:[(0,K.jsx)("span",{className:"fz-aim-label",children:"height"}),(0,K.jsx)("input",{type:"range",min:-90,max:90,step:1,value:ht?.elevation??0,disabled:!wt,"aria-label":"camera height in degrees",onChange:I=>{ft!==null&&ut(ft,{elevation:Number(I.target.value)})}}),(0,K.jsx)("span",{className:"fz-aim-val",children:wt&&ht?`${Math.round(ht.elevation)}\xB0`:"\u2014"})]})]}),(0,K.jsxs)("div",{className:"fz-render-row",children:[(0,K.jsx)("div",{className:"fz-seg",children:[5,6].map(I=>(0,K.jsxs)("button",{type:"button",className:xt===I?"active":"",onClick:()=>kt(I),children:[I,"s"]},I))}),(0,K.jsx)("div",{className:"fz-seg",children:["480P","768P","1080P"].map(I=>(0,K.jsx)("button",{type:"button",className:ue===I?"active":"",onClick:()=>Yt(I),children:I==="480P"?"480":I==="768P"?"720":"1080"},I))}),(0,K.jsx)("button",{type:"button",className:"fz-primary",disabled:d||!a||!i||w!==null,onClick:()=>void gt(),children:w?.kind==="render"||d?"freezing\u2026":"freeze it"})]})]}),t==="result"&&(0,K.jsxs)("div",{className:"fz-stage",children:[At?(0,K.jsxs)("div",{className:"fz-result",children:[(0,K.jsx)("video",{className:"fz-video",src:At.outputUrl??void 0,controls:!0,playsInline:!0,loop:!0,autoPlay:!0,muted:!0,onError:Pe}),(0,K.jsxs)("div",{className:"fz-actions",children:[(0,K.jsx)("button",{type:"button",className:"fz-primary",disabled:d,onClick:()=>void j(At.jobId),children:"send to iMessage"}),(0,K.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("camera"),children:"new camera move"})]})]}):l?(0,K.jsx)("p",{className:"fz-sub",children:"rendering \u2014 this takes a few minutes"}):(0,K.jsx)("p",{className:"fz-sub",children:"nothing rendered yet"}),dt.length>1&&(0,K.jsx)("div",{className:"fz-history",children:dt.slice(0,-1).reverse().map(I=>(0,K.jsxs)("div",{className:"fz-history-row",children:[(0,K.jsx)("video",{className:"fz-thumb",src:I.outputUrl??void 0,muted:!0,playsInline:!0,preload:"metadata",onError:Pe}),(0,K.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void j(I.jobId),children:"send"})]},I.jobId))})]}),(0,K.jsx)("p",{className:"fz-line",children:S??""})]})}var S3=`
...
`,U0=document.getElementById("freeze-studio");if(U0){let e=null;try{e=JSON.parse(U0.dataset.payload??"")}catch{e=null}if(e){let t=document.createElement("style");t.textContent=S3,document.head.appendChild(t),(0,CM.createRoot)(U0).render((0,K.jsx)(st.StrictMode,{children:(0,K.jsx)(b3,{initial:e})}))}}})();
