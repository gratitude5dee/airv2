...
`)}var v2={[Jg]:"Linear",[Kg]:"Reinhard",[jg]:"Cineon",[Qg]:"ACESFilmic",[t0]:"AgX",[e0]:"Neutral",[$g]:"Custom"};function _2(e,t){let n=v2[t];return n===void 0?(Ot("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+e+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+e+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}var hd=new L;function y2(){ie.getLuminanceCoefficients(hd);let e=hd.x.toFixed(4),t=hd.y.toFixed(4),n=hd.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${t}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,Q2=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],$2=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],gM=new Pe,yc=new L,M0=new L;function t3(e,t,n){let i=new Kl,s=new It,a=new It,r=new ze,o=new lf,c=new cf,l={},h=n.maxTextureSize,d={[Ts]:Cn,[Cn]:Ts,[ni]:ni},u=new ti({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new It},radius:{value:4}},vertexShader:K2,fragmentShader:j2}),p=u.clone();p.defines.HORIZONTAL_PASS=1;let m=new He;m.setAttribute("position",new jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new je(m,u),v=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=lc;let f=this.type;this.render=function(A,w,x){if(v.enabled===!1||v.autoUpdate===!1&&v.needsUpdate===!1||A.length===0)return;this.type===fS&&(Ot("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=lc);let M=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),I=e.state;I.setBlending(Zi),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let q=f!==this.type;q&&w.traverse(function(J){J.material&&(Array.isArray(J.material)?J.material.forEach(z=>z.needsUpdate=!0):J.material.needsUpdate=!0)});for(let J=0,z=A.length;J<z;J++){let B=A[J],V=B.shadow;if(V===void 0){Ot("WebGLShadowMap:",B,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let j=V.getFrameExtents();s.multiply(j),a.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/j.x),s.x=a.x*j.x,V.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/j.y),s.y=a.y*j.y,V.mapSize.y=a.y));let rt=e.state.buffers.depth.getReversed();if(V.camera._reversedDepth=rt,V.map===null||q===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===So){if(B.isPointLight){Ot("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Qn(s.x,s.y,{format:Sa,type:Ji,minFilter:mn,magFilter:mn,generateMipmaps:!1}),V.map.texture.name=B.name+".shadowMap",V.map.depthTexture=new As(s.x,s.y,Ri),V.map.depthTexture.name=B.name+".shadowMapDepth",V.map.depthTexture.format=ki,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=cn,V.map.depthTexture.magFilter=cn}else B.isPointLight?(V.map=new dd(s.x),V.map.depthTexture=new jh(s.x,Ci)):(V.map=new Qn(s.x,s.y),V.map.depthTexture=new As(s.x,s.y,Ci)),V.map.depthTexture.name=B.name+".shadowMap",V.map.depthTexture.format=ki,this.type===lc?(V.map.depthTexture.compareFunction=rt?cd:ld,V.map.depthTexture.minFilter=mn,V.map.depthTexture.magFilter=mn):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=cn,V.map.depthTexture.magFilter=cn);V.camera.updateProjectionMatrix()}let ct=V.map.isWebGLCubeRenderTarget?6:1;for(let lt=0;lt<ct;lt++){if(V.map.isWebGLCubeRenderTarget)e.setRenderTarget(V.map,lt),e.clear();else{lt===0&&(e.setRenderTarget(V.map),e.clear());let at=V.getViewport(lt);r.set(a.x*at.x,a.y*at.y,a.x*at.z,a.y*at.w),I.viewport(r)}if(B.isPointLight){let at=V.camera,Nt=V.matrix,Kt=B.distance||at.far;Kt!==at.far&&(at.far=Kt,at.updateProjectionMatrix()),yc.setFromMatrixPosition(B.matrixWorld),at.position.copy(yc),M0.copy(at.position),M0.add(Q2[lt]),at.up.copy($2[lt]),at.lookAt(M0),at.updateMatrixWorld(),Nt.makeTranslation(-yc.x,-yc.y,-yc.z),gM.multiplyMatrices(at.projectionMatrix,at.matrixWorldInverse),V._frustum.setFromProjectionMatrix(gM,at.coordinateSystem,at.reversedDepth)}else V.updateMatrices(B);i=V.getFrustum(),_(w,x,V.camera,B,this.type)}V.isPointLightShadow!==!0&&this.type===So&&g(V,x),V.needsUpdate=!1}f=this.type,v.needsUpdate=!1,e.setRenderTarget(M,R,D)};function g(A,w){let x=t.update(S);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Qn(s.x,s.y,{format:Sa,type:Ji})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,x,u,S,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,x,p,S,null)}function y(A,w,x,M){let R=null,D=x.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)R=D;else if(R=x.isPointLight===!0?c:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let I=R.uuid,q=w.uuid,J=l[I];J===void 0&&(J={},l[I]=J);let z=J[q];z===void 0&&(z=R.clone(),J[q]=z,w.addEventListener("dispose",T)),R=z}if(R.visible=w.visible,R.wireframe=w.wireframe,M===So?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:d[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let I=e.properties.get(R);I.light=x}return R}function _(A,w,x,M,R){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===So)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,A.matrixWorld);let q=t.update(A),J=A.material;if(Array.isArray(J)){let z=q.groups;for(let B=0,V=z.length;B<V;B++){let j=z[B],rt=J[j.materialIndex];if(rt&&rt.visible){let ct=y(A,rt,M,R);A.onBeforeShadow(e,A,w,x,q,ct,j),e.renderBufferDirect(x,null,q,ct,A,j),A.onAfterShadow(e,A,w,x,q,ct,j)}}}else if(J.visible){let z=y(A,J,M,R);A.onBeforeShadow(e,A,w,x,q,z,null),e.renderBufferDirect(x,null,q,z,A,null),A.onAfterShadow(e,A,w,x,q,z,null)}}let I=A.children;for(let q=0,J=I.length;q<J;q++)_(I[q],w,x,M,R)}function T(A){A.target.removeEventListener("dispose",T);for(let x in l){let M=l[x],R=A.target.uuid;R in M&&(M[R].dispose(),delete M[R])}}}function e3(e,t){function n(){let O=!1,N=new ze,U=null,st=new ze(0,0,0,0);return{setMask:function(K){U!==K&&!O&&(e.colorMask(K,K,K,K),U=K)},setLocked:function(K){O=K},setClear:function(K,Z,ht,pt,kt){kt===!0&&(K*=pt,Z*=pt,ht*=pt),N.set(K,Z,ht,pt),st.equals(N)===!1&&(e.clearColor(K,Z,ht,pt),st.copy(N))},reset:function(){O=!1,U=null,st.set(-1,0,0,0)}}}function i(){let O=!1,N=!1,U=null,st=null,K=null;return{setReversed:function(Z){if(N!==Z){let ht=t.get("EXT_clip_control");Z?ht.clipControlEXT(ht.LOWER_LEFT_EXT,ht.ZERO_TO_ONE_EXT):ht.clipControlEXT(ht.LOWER_LEFT_EXT,ht.NEGATIVE_ONE_TO_ONE_EXT),N=Z;let pt=K;K=null,this.setClear(pt)}},getReversed:function(){return N},setTest:function(Z){Z?ot(e.DEPTH_TEST):Ct(e.DEPTH_TEST)},setMask:function(Z){U!==Z&&!O&&(e.depthMask(Z),U=Z)},setFunc:function(Z){if(N&&(Z=WS[Z]),st!==Z){switch(Z){case Ih:e.depthFunc(e.NEVER);break;case Oh:e.depthFunc(e.ALWAYS);break;case Ph:e.depthFunc(e.LESS);break;case $a:e.depthFunc(e.LEQUAL);break;case zh:e.depthFunc(e.EQUAL);break;case Bh:e.depthFunc(e.GEQUAL);break;case Fh:e.depthFunc(e.GREATER);break;case Vh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}st=Z}},setLocked:function(Z){O=Z},setClear:function(Z){K!==Z&&(K=Z,N&&(Z=1-Z),e.clearDepth(Z))},reset:function(){O=!1,U=null,st=null,K=null,N=!1}}}function s(){let O=!1,N=null,U=null,st=null,K=null,Z=null,ht=null,pt=null,kt=null;return{setTest:function(re){O||(re?ot(e.STENCIL_TEST):Ct(e.STENCIL_TEST))},setMask:function(re){N!==re&&!O&&(e.stencilMask(re),N=re)},setFunc:function(re,Mn,zn){(U!==re||st!==Mn||K!==zn)&&(e.stencilFunc(re,Mn,zn),U=re,st=Mn,K=zn)},setOp:function(re,Mn,zn){(Z!==re||ht!==Mn||pt!==zn)&&(e.stencilOp(re,Mn,zn),Z=re,ht=Mn,pt=zn)},setLocked:function(re){O=re},setClear:function(re){kt!==re&&(e.clearStencil(re),kt=re)},reset:function(){O=!1,N=null,U=null,st=null,K=null,Z=null,ht=null,pt=null,kt=null}}}let a=new n,r=new i,o=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},p=new WeakMap,m=[],S=null,v=!1,f=null,g=null,y=null,_=null,T=null,A=null,w=null,x=new ee(0,0,0),M=0,R=!1,D=null,I=null,q=null,J=null,z=null,B=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,j=0,rt=e.getParameter(e.VERSION);rt.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(rt)[1]),V=j>=1):rt.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(rt)[1]),V=j>=2);let ct=null,lt={},at=e.getParameter(e.SCISSOR_BOX),Nt=e.getParameter(e.VIEWPORT),Kt=new ze().fromArray(at),Ht=new ze().fromArray(Nt);function Q(O,N,U,st){let K=new Uint8Array(4),Z=e.createTexture();e.bindTexture(O,Z),e.texParameteri(O,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(O,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let ht=0;ht<U;ht++)O===e.TEXTURE_3D||O===e.TEXTURE_2D_ARRAY?e.texImage3D(N,0,e.RGBA,1,1,st,0,e.RGBA,e.UNSIGNED_BYTE,K):e.texImage2D(N+ht,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,K);return Z}let ut={};ut[e.TEXTURE_2D]=Q(e.TEXTURE_2D,e.TEXTURE_2D,1),ut[e.TEXTURE_CUBE_MAP]=Q(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),ut[e.TEXTURE_2D_ARRAY]=Q(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),ut[e.TEXTURE_3D]=Q(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ot(e.DEPTH_TEST),r.setFunc($a),jt(!1),me(Xg),ot(e.CULL_FACE),Ft(Zi);function ot(O){h[O]!==!0&&(e.enable(O),h[O]=!0)}function Ct(O){h[O]!==!1&&(e.disable(O),h[O]=!1)}function mt(O,N){return u[O]!==N?(e.bindFramebuffer(O,N),u[O]=N,O===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=N),O===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=N),!0):!1}function yt(O,N){let U=m,st=!1;if(O){U=p.get(N),U===void 0&&(U=[],p.set(N,U));let K=O.textures;if(U.length!==K.length||U[0]!==e.COLOR_ATTACHMENT0){for(let Z=0,ht=K.length;Z<ht;Z++)U[Z]=e.COLOR_ATTACHMENT0+Z;U.length=K.length,st=!0}}else U[0]!==e.BACK&&(U[0]=e.BACK,st=!0);st&&e.drawBuffers(U)}function ae(O){return S!==O?(e.useProgram(O),S=O,!0):!1}let Gt={[ha]:e.FUNC_ADD,[pS]:e.FUNC_SUBTRACT,[mS]:e.FUNC_REVERSE_SUBTRACT};Gt[gS]=e.MIN,Gt[vS]=e.MAX;let Zt={[_S]:e.ZERO,[yS]:e.ONE,[xS]:e.SRC_COLOR,[Uh]:e.SRC_ALPHA,[AS]:e.SRC_ALPHA_SATURATE,[ES]:e.DST_COLOR,[SS]:e.DST_ALPHA,[bS]:e.ONE_MINUS_SRC_COLOR,[Lh]:e.ONE_MINUS_SRC_ALPHA,[TS]:e.ONE_MINUS_DST_COLOR,[MS]:e.ONE_MINUS_DST_ALPHA,[wS]:e.CONSTANT_COLOR,[CS]:e.ONE_MINUS_CONSTANT_COLOR,[RS]:e.CONSTANT_ALPHA,[DS]:e.ONE_MINUS_CONSTANT_ALPHA};function Ft(O,N,U,st,K,Z,ht,pt,kt,re){if(O===Zi){v===!0&&(Ct(e.BLEND),v=!1);return}if(v===!1&&(ot(e.BLEND),v=!0),O!==dS){if(O!==f||re!==R){if((g!==ha||T!==ha)&&(e.blendEquation(e.FUNC_ADD),g=ha,T=ha),re)switch(O){case Qa:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Wg:e.blendFunc(e.ONE,e.ONE);break;case qg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Yg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:zt("WebGLState: Invalid blending: ",O);break}else switch(O){case Qa:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Wg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case qg:zt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Yg:zt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:zt("WebGLState: Invalid blending: ",O);break}y=null,_=null,A=null,w=null,x.set(0,0,0),M=0,f=O,R=re}return}K=K||N,Z=Z||U,ht=ht||st,(N!==g||K!==T)&&(e.blendEquationSeparate(Gt[N],Gt[K]),g=N,T=K),(U!==y||st!==_||Z!==A||ht!==w)&&(e.blendFuncSeparate(Zt[U],Zt[st],Zt[Z],Zt[ht]),y=U,_=st,A=Z,w=ht),(pt.equals(x)===!1||kt!==M)&&(e.blendColor(pt.r,pt.g,pt.b,kt),x.copy(pt),M=kt),f=O,R=!1}function Lt(O,N){O.side===ni?Ct(e.CULL_FACE):ot(e.CULL_FACE);let U=O.side===Cn;N&&(U=!U),jt(U),O.blending===Qa&&O.transparent===!1?Ft(Zi):Ft(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),r.setFunc(O.depthFunc),r.setTest(O.depthTest),r.setMask(O.depthWrite),a.setMask(O.colorWrite);let st=O.stencilWrite;o.setTest(st),st&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),Ie(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?ot(e.SAMPLE_ALPHA_TO_COVERAGE):Ct(e.SAMPLE_ALPHA_TO_COVERAGE)}function jt(O){D!==O&&(O?e.frontFace(e.CW):e.frontFace(e.CCW),D=O)}function me(O){O!==uS?(ot(e.CULL_FACE),O!==I&&(O===Xg?e.cullFace(e.BACK):O===hS?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Ct(e.CULL_FACE),I=O}function le(O){O!==q&&(V&&e.lineWidth(O),q=O)}function Ie(O,N,U){O?(ot(e.POLYGON_OFFSET_FILL),(J!==N||z!==U)&&(J=N,z=U,r.getReversed()&&(N=-N),e.polygonOffset(N,U))):Ct(e.POLYGON_OFFSET_FILL)}function ue(O){O?ot(e.SCISSOR_TEST):Ct(e.SCISSOR_TEST)}function Oe(O){O===void 0&&(O=e.TEXTURE0+B-1),ct!==O&&(e.activeTexture(O),ct=O)}function P(O,N,U){U===void 0&&(ct===null?U=e.TEXTURE0+B-1:U=ct);let st=lt[U];st===void 0&&(st={type:void 0,texture:void 0},lt[U]=st),(st.type!==O||st.texture!==N)&&(ct!==U&&(e.activeTexture(U),ct=U),e.bindTexture(O,N||ut[O]),st.type=O,st.texture=N)}function sn(){let O=lt[ct];O!==void 0&&O.type!==void 0&&(e.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function ce(){try{e.compressedTexImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function b(){try{e.texSubImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function H(){try{e.texSubImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function $(){try{e.compressedTexSubImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function ft(){try{e.texStorage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function gt(){try{e.texStorage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function tt(){try{e.texImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function et(){try{e.texImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function vt(O){return d[O]!==void 0?d[O]:e.getParameter(O)}function Tt(O,N){d[O]!==N&&(e.pixelStorei(O,N),d[O]=N)}function _t(O){Kt.equals(O)===!1&&(e.scissor(O.x,O.y,O.z,O.w),Kt.copy(O))}function dt(O){Ht.equals(O)===!1&&(e.viewport(O.x,O.y,O.z,O.w),Ht.copy(O))}function Rt(O,N){let U=l.get(N);U===void 0&&(U=new WeakMap,l.set(N,U));let st=U.get(O);st===void 0&&(st=e.getUniformBlockIndex(N,O.name),U.set(O,st))}function At(O,N){let st=l.get(N).get(O);c.get(N)!==st&&(e.uniformBlockBinding(N,st,O.__bindingPointIndex),c.set(N,st))}function Pt(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},d={},ct=null,lt={},u={},p=new WeakMap,m=[],S=null,v=!1,f=null,g=null,y=null,_=null,T=null,A=null,w=null,x=new ee(0,0,0),M=0,R=!1,D=null,I=null,q=null,J=null,z=null,Kt.set(0,0,e.canvas.width,e.canvas.height),Ht.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:ot,disable:Ct,bindFramebuffer:mt,drawBuffers:yt,useProgram:ae,setBlending:Ft,setMaterial:Lt,setFlipSided:jt,setCullFace:me,setLineWidth:le,setPolygonOffset:Ie,setScissorTest:ue,activeTexture:Oe,bindTexture:P,unbindTexture:sn,compressedTexImage2D:ce,compressedTexImage3D:C,texImage2D:tt,texImage3D:et,pixelStorei:Tt,getParameter:vt,updateUBOMapping:Rt,uniformBlockBinding:At,texStorage2D:ft,texStorage3D:gt,texSubImage2D:b,texSubImage3D:H,compressedTexSubImage2D:X,compressedTexSubImage3D:$,scissor:_t,viewport:dt,reset:Pt}}function n3(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new It,h=new WeakMap,d=new Set,u,p=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(C,b){return m?new OffscreenCanvas(C,b):Gl("canvas")}function v(C,b,H){let X=1,$=ce(C);if(($.width>H||$.height>H)&&(X=H/Math.max($.width,$.height)),X<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){let ft=Math.floor(X*$.width),gt=Math.floor(X*$.height);u===void 0&&(u=S(ft,gt));let tt=b?S(ft,gt):u;return tt.width=ft,tt.height=gt,tt.getContext("2d").drawImage(C,0,0,ft,gt),Ot("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ft+"x"+gt+")."),tt}else return"data"in C&&Ot("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),C;return C}function f(C){return C.generateMipmaps}function g(C){e.generateMipmap(C)}function y(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function _(C,b,H,X,$,ft=!1){if(C!==null){if(e[C]!==void 0)return e[C];Ot("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let gt;X&&(gt=t.get("EXT_texture_norm16"),gt||Ot("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let tt=b;if(b===e.RED&&(H===e.FLOAT&&(tt=e.R32F),H===e.HALF_FLOAT&&(tt=e.R16F),H===e.UNSIGNED_BYTE&&(tt=e.R8),H===e.UNSIGNED_SHORT&&gt&&(tt=gt.R16_EXT),H===e.SHORT&&gt&&(tt=gt.R16_SNORM_EXT)),b===e.RED_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.R8UI),H===e.UNSIGNED_SHORT&&(tt=e.R16UI),H===e.UNSIGNED_INT&&(tt=e.R32UI),H===e.BYTE&&(tt=e.R8I),H===e.SHORT&&(tt=e.R16I),H===e.INT&&(tt=e.R32I)),b===e.RG&&(H===e.FLOAT&&(tt=e.RG32F),H===e.HALF_FLOAT&&(tt=e.RG16F),H===e.UNSIGNED_BYTE&&(tt=e.RG8),H===e.UNSIGNED_SHORT&&gt&&(tt=gt.RG16_EXT),H===e.SHORT&&gt&&(tt=gt.RG16_SNORM_EXT)),b===e.RG_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.RG8UI),H===e.UNSIGNED_SHORT&&(tt=e.RG16UI),H===e.UNSIGNED_INT&&(tt=e.RG32UI),H===e.BYTE&&(tt=e.RG8I),H===e.SHORT&&(tt=e.RG16I),H===e.INT&&(tt=e.RG32I)),b===e.RGB_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.RGB8UI),H===e.UNSIGNED_SHORT&&(tt=e.RGB16UI),H===e.UNSIGNED_INT&&(tt=e.RGB32UI),H===e.BYTE&&(tt=e.RGB8I),H===e.SHORT&&(tt=e.RGB16I),H===e.INT&&(tt=e.RGB32I)),b===e.RGBA_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.RGBA8UI),H===e.UNSIGNED_SHORT&&(tt=e.RGBA16UI),H===e.UNSIGNED_INT&&(tt=e.RGBA32UI),H===e.BYTE&&(tt=e.RGBA8I),H===e.SHORT&&(tt=e.RGBA16I),H===e.INT&&(tt=e.RGBA32I)),b===e.RGB&&(H===e.UNSIGNED_SHORT&&gt&&(tt=gt.RGB16_EXT),H===e.SHORT&&gt&&(tt=gt.RGB16_SNORM_EXT),H===e.UNSIGNED_INT_5_9_9_9_REV&&(tt=e.RGB9_E5),H===e.UNSIGNED_INT_10F_11F_11F_REV&&(tt=e.R11F_G11F_B10F)),b===e.RGBA){let et=ft?Vl:ie.getTransfer($);H===e.FLOAT&&(tt=e.RGBA32F),H===e.HALF_FLOAT&&(tt=e.RGBA16F),H===e.UNSIGNED_BYTE&&(tt=et===pe?e.SRGB8_ALPHA8:e.RGBA8),H===e.UNSIGNED_SHORT&&gt&&(tt=gt.RGBA16_EXT),H===e.SHORT&&gt&&(tt=gt.RGBA16_SNORM_EXT),H===e.UNSIGNED_SHORT_4_4_4_4&&(tt=e.RGBA4),H===e.UNSIGNED_SHORT_5_5_5_1&&(tt=e.RGB5_A1)}return(tt===e.R16F||tt===e.R32F||tt===e.RG16F||tt===e.RG32F||tt===e.RGBA16F||tt===e.RGBA32F)&&t.get("EXT_color_buffer_float"),tt}function T(C,b){let H;return C?b===null||b===Ci||b===Eo?H=e.DEPTH24_STENCIL8:b===Ri?H=e.DEPTH32F_STENCIL8:b===Mo&&(H=e.DEPTH24_STENCIL8,Ot("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Ci||b===Eo?H=e.DEPTH_COMPONENT24:b===Ri?H=e.DEPTH_COMPONENT32F:b===Mo&&(H=e.DEPTH_COMPONENT16),H}function A(C,b){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==cn&&C.minFilter!==mn?Math.log2(Math.max(b.width,b.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?b.mipmaps.length:1}function w(C){let b=C.target;b.removeEventListener("dispose",w),M(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&d.delete(b)}function x(C){let b=C.target;b.removeEventListener("dispose",x),D(b)}function M(C){let b=i.get(C);if(b.__webglInit===void 0)return;let H=C.source,X=p.get(H);if(X){let $=X[b.__cacheKey];$.usedTimes--,$.usedTimes===0&&R(C),Object.keys(X).length===0&&p.delete(H)}i.remove(C)}function R(C){let b=i.get(C);e.deleteTexture(b.__webglTexture);let H=C.source,X=p.get(H);delete X[b.__cacheKey],r.memory.textures--}function D(C){let b=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(b.__webglFramebuffer[X]))for(let $=0;$<b.__webglFramebuffer[X].length;$++)e.deleteFramebuffer(b.__webglFramebuffer[X][$]);else e.deleteFramebuffer(b.__webglFramebuffer[X]);b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer[X])}else{if(Array.isArray(b.__webglFramebuffer))for(let X=0;X<b.__webglFramebuffer.length;X++)e.deleteFramebuffer(b.__webglFramebuffer[X]);else e.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&e.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let X=0;X<b.__webglColorRenderbuffer.length;X++)b.__webglColorRenderbuffer[X]&&e.deleteRenderbuffer(b.__webglColorRenderbuffer[X]);b.__webglDepthRenderbuffer&&e.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let H=C.textures;for(let X=0,$=H.length;X<$;X++){let ft=i.get(H[X]);ft.__webglTexture&&(e.deleteTexture(ft.__webglTexture),r.memory.textures--),i.remove(H[X])}i.remove(C)}let I=0;function q(){I=0}function J(){return I}function z(C){I=C}function B(){let C=I;return C>=s.maxTextures&&Ot("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),I+=1,C}function V(C){let b=[];return b.push(C.wrapS),b.push(C.wrapT),b.push(C.wrapR||0),b.push(C.magFilter),b.push(C.minFilter),b.push(C.anisotropy),b.push(C.internalFormat),b.push(C.format),b.push(C.type),b.push(C.generateMipmaps),b.push(C.premultiplyAlpha),b.push(C.flipY),b.push(C.unpackAlignment),b.push(C.colorSpace),b.join()}function j(C,b){let H=i.get(C);if(C.isVideoTexture&&P(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&H.__version!==C.version){let X=C.image;if(X===null)Ot("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ot("WebGLRenderer: Texture marked for update but image is incomplete");else{Ct(H,C,b);return}}else C.isExternalTexture&&(H.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,H.__webglTexture,e.TEXTURE0+b)}function rt(C,b){let H=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&H.__version!==C.version){Ct(H,C,b);return}else C.isExternalTexture&&(H.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,H.__webglTexture,e.TEXTURE0+b)}function ct(C,b){let H=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&H.__version!==C.version){Ct(H,C,b);return}n.bindTexture(e.TEXTURE_3D,H.__webglTexture,e.TEXTURE0+b)}function lt(C,b){let H=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&H.__version!==C.version){mt(H,C,b);return}n.bindTexture(e.TEXTURE_CUBE_MAP,H.__webglTexture,e.TEXTURE0+b)}let at={[Hh]:e.REPEAT,[Hi]:e.CLAMP_TO_EDGE,[Gh]:e.MIRRORED_REPEAT},Nt={[cn]:e.NEAREST,[LS]:e.NEAREST_MIPMAP_NEAREST,[uc]:e.NEAREST_MIPMAP_LINEAR,[mn]:e.LINEAR,[Tf]:e.LINEAR_MIPMAP_NEAREST,[xa]:e.LINEAR_MIPMAP_LINEAR},Kt={[PS]:e.NEVER,[HS]:e.ALWAYS,[zS]:e.LESS,[ld]:e.LEQUAL,[BS]:e.EQUAL,[cd]:e.GEQUAL,[FS]:e.GREATER,[VS]:e.NOTEQUAL};function Ht(C,b){if(b.type===Ri&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===mn||b.magFilter===Tf||b.magFilter===uc||b.magFilter===xa||b.minFilter===mn||b.minFilter===Tf||b.minFilter===uc||b.minFilter===xa)&&Ot("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,at[b.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,at[b.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,at[b.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,Nt[b.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,Nt[b.minFilter]),b.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,Kt[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===cn||b.minFilter!==uc&&b.minFilter!==xa||b.type===Ri&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let H=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function Q(C,b){let H=!1;C.__webglInit===void 0&&(C.__webglInit=!0,b.addEventListener("dispose",w));let X=b.source,$=p.get(X);$===void 0&&($={},p.set(X,$));let ft=V(b);if(ft!==C.__cacheKey){$[ft]===void 0&&($[ft]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,H=!0),$[ft].usedTimes++;let gt=$[C.__cacheKey];gt!==void 0&&($[C.__cacheKey].usedTimes--,gt.usedTimes===0&&R(b)),C.__cacheKey=ft,C.__webglTexture=$[ft].texture}return H}function ut(C,b,H){return Math.floor(Math.floor(C/H)/b)}function ot(C,b,H,X){let ft=C.updateRanges;if(ft.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,b.width,b.height,H,X,b.data);else{ft.sort((Tt,_t)=>Tt.start-_t.start);let gt=0;for(let Tt=1;Tt<ft.length;Tt++){let _t=ft[gt],dt=ft[Tt],Rt=_t.start+_t.count,At=ut(dt.start,b.width,4),Pt=ut(_t.start,b.width,4);dt.start<=Rt+1&&At===Pt&&ut(dt.start+dt.count-1,b.width,4)===At?_t.count=Math.max(_t.count,dt.start+dt.count-_t.start):(++gt,ft[gt]=dt)}ft.length=gt+1;let tt=n.getParameter(e.UNPACK_ROW_LENGTH),et=n.getParameter(e.UNPACK_SKIP_PIXELS),vt=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,b.width);for(let Tt=0,_t=ft.length;Tt<_t;Tt++){let dt=ft[Tt],Rt=Math.floor(dt.start/4),At=Math.ceil(dt.count/4),Pt=Rt%b.width,O=Math.floor(Rt/b.width),N=At,U=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,Pt),n.pixelStorei(e.UNPACK_SKIP_ROWS,O),n.texSubImage2D(e.TEXTURE_2D,0,Pt,O,N,U,H,X,b.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,tt),n.pixelStorei(e.UNPACK_SKIP_PIXELS,et),n.pixelStorei(e.UNPACK_SKIP_ROWS,vt)}}function Ct(C,b,H){let X=e.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(X=e.TEXTURE_2D_ARRAY),b.isData3DTexture&&(X=e.TEXTURE_3D);let $=Q(C,b),ft=b.source;n.bindTexture(X,C.__webglTexture,e.TEXTURE0+H);let gt=i.get(ft);if(ft.version!==gt.__version||$===!0){if(n.activeTexture(e.TEXTURE0+H),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){let U=ie.getPrimaries(ie.workingColorSpace),st=b.colorSpace===ws?null:ie.getPrimaries(b.colorSpace),K=b.colorSpace===ws||U===st?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,K)}n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment);let et=v(b.image,!1,s.maxTextureSize);et=sn(b,et);let vt=a.convert(b.format,b.colorSpace),Tt=a.convert(b.type),_t=_(b.internalFormat,vt,Tt,b.normalized,b.colorSpace,b.isVideoTexture);Ht(X,b);let dt,Rt=b.mipmaps,At=b.isVideoTexture!==!0,Pt=gt.__version===void 0||$===!0,O=ft.dataReady,N=A(b,et);if(b.isDepthTexture)_t=T(b.format===ba,b.type),Pt&&(At?n.texStorage2D(e.TEXTURE_2D,1,_t,et.width,et.height):n.texImage2D(e.TEXTURE_2D,0,_t,et.width,et.height,0,vt,Tt,null));else if(b.isDataTexture)if(Rt.length>0){At&&Pt&&n.texStorage2D(e.TEXTURE_2D,N,_t,Rt[0].width,Rt[0].height);for(let U=0,st=Rt.length;U<st;U++)dt=Rt[U],At?O&&n.texSubImage2D(e.TEXTURE_2D,U,0,0,dt.width,dt.height,vt,Tt,dt.data):n.texImage2D(e.TEXTURE_2D,U,_t,dt.width,dt.height,0,vt,Tt,dt.data);b.generateMipmaps=!1}else At?(Pt&&n.texStorage2D(e.TEXTURE_2D,N,_t,et.width,et.height),O&&ot(b,et,vt,Tt)):n.texImage2D(e.TEXTURE_2D,0,_t,et.width,et.height,0,vt,Tt,et.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){At&&Pt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,N,_t,Rt[0].width,Rt[0].height,et.depth);for(let U=0,st=Rt.length;U<st;U++)if(dt=Rt[U],b.format!==yi)if(vt!==null)if(At){if(O)if(b.layerUpdates.size>0){let K=v0(dt.width,dt.height,b.format,b.type);for(let Z of b.layerUpdates){let ht=dt.data.subarray(Z*K/dt.data.BYTES_PER_ELEMENT,(Z+1)*K/dt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,U,0,0,Z,dt.width,dt.height,1,vt,ht)}b.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,U,0,0,0,dt.width,dt.height,et.depth,vt,dt.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,U,_t,dt.width,dt.height,et.depth,0,dt.data,0,0);else Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else At?O&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,U,0,0,0,dt.width,dt.height,et.depth,vt,Tt,dt.data):n.texImage3D(e.TEXTURE_2D_ARRAY,U,_t,dt.width,dt.height,et.depth,0,vt,Tt,dt.data)}else{At&&Pt&&n.texStorage2D(e.TEXTURE_2D,N,_t,Rt[0].width,Rt[0].height);for(let U=0,st=Rt.length;U<st;U++)dt=Rt[U],b.format!==yi?vt!==null?At?O&&n.compressedTexSubImage2D(e.TEXTURE_2D,U,0,0,dt.width,dt.height,vt,dt.data):n.compressedTexImage2D(e.TEXTURE_2D,U,_t,dt.width,dt.height,0,dt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):At?O&&n.texSubImage2D(e.TEXTURE_2D,U,0,0,dt.width,dt.height,vt,Tt,dt.data):n.texImage2D(e.TEXTURE_2D,U,_t,dt.width,dt.height,0,vt,Tt,dt.data)}else if(b.isDataArrayTexture)if(At){if(Pt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,N,_t,et.width,et.height,et.depth),O)if(b.layerUpdates.size>0){let U=v0(et.width,et.height,b.format,b.type);for(let st of b.layerUpdates){let K=et.data.subarray(st*U/et.data.BYTES_PER_ELEMENT,(st+1)*U/et.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,st,et.width,et.height,1,vt,Tt,K)}b.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,vt,Tt,et.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,_t,et.width,et.height,et.depth,0,vt,Tt,et.data);else if(b.isData3DTexture)At?(Pt&&n.texStorage3D(e.TEXTURE_3D,N,_t,et.width,et.height,et.depth),O&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,vt,Tt,et.data)):n.texImage3D(e.TEXTURE_3D,0,_t,et.width,et.height,et.depth,0,vt,Tt,et.data);else if(b.isFramebufferTexture){if(Pt)if(At)n.texStorage2D(e.TEXTURE_2D,N,_t,et.width,et.height);else{let U=et.width,st=et.height;for(let K=0;K<N;K++)n.texImage2D(e.TEXTURE_2D,K,_t,U,st,0,vt,Tt,null),U>>=1,st>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in e){let U=e.canvas;if(U.hasAttribute("layoutsubtree")||U.setAttribute("layoutsubtree","true"),et.parentNode!==U){U.appendChild(et),d.add(b),U.onpaint=st=>{let K=st.changedElements;for(let Z of d)K.includes(Z.image)&&(Z.needsUpdate=!0)},U.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,et);else{let K=e.RGBA,Z=e.RGBA,ht=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,K,Z,ht,et)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(Rt.length>0){if(At&&Pt){let U=ce(Rt[0]);n.texStorage2D(e.TEXTURE_2D,N,_t,U.width,U.height)}for(let U=0,st=Rt.length;U<st;U++)dt=Rt[U],At?O&&n.texSubImage2D(e.TEXTURE_2D,U,0,0,vt,Tt,dt):n.texImage2D(e.TEXTURE_2D,U,_t,vt,Tt,dt);b.generateMipmaps=!1}else if(At){if(Pt){let U=ce(et);n.texStorage2D(e.TEXTURE_2D,N,_t,U.width,U.height)}O&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,vt,Tt,et)}else n.texImage2D(e.TEXTURE_2D,0,_t,vt,Tt,et);f(b)&&g(X),gt.__version=ft.version,b.onUpdate&&b.onUpdate(b)}C.__version=b.version}function mt(C,b,H){if(b.image.length!==6)return;let X=Q(C,b),$=b.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+H);let ft=i.get($);if($.version!==ft.__version||X===!0){n.activeTexture(e.TEXTURE0+H);let gt=ie.getPrimaries(ie.workingColorSpace),tt=b.colorSpace===ws?null:ie.getPrimaries(b.colorSpace),et=b.colorSpace===ws||gt===tt?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);let vt=b.isCompressedTexture||b.image[0].isCompressedTexture,Tt=b.image[0]&&b.image[0].isDataTexture,_t=[];for(let Z=0;Z<6;Z++)!vt&&!Tt?_t[Z]=v(b.image[Z],!0,s.maxCubemapSize):_t[Z]=Tt?b.image[Z].image:b.image[Z],_t[Z]=sn(b,_t[Z]);let dt=_t[0],Rt=a.convert(b.format,b.colorSpace),At=a.convert(b.type),Pt=_(b.internalFormat,Rt,At,b.normalized,b.colorSpace),O=b.isVideoTexture!==!0,N=ft.__version===void 0||X===!0,U=$.dataReady,st=A(b,dt);Ht(e.TEXTURE_CUBE_MAP,b);let K;if(vt){O&&N&&n.texStorage2D(e.TEXTURE_CUBE_MAP,st,Pt,dt.width,dt.height);for(let Z=0;Z<6;Z++){K=_t[Z].mipmaps;for(let ht=0;ht<K.length;ht++){let pt=K[ht];b.format!==yi?Rt!==null?O?U&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,0,0,pt.width,pt.height,Rt,pt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,Pt,pt.width,pt.height,0,pt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,0,0,pt.width,pt.height,Rt,At,pt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht,Pt,pt.width,pt.height,0,Rt,At,pt.data)}}}else{if(K=b.mipmaps,O&&N){K.length>0&&st++;let Z=ce(_t[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,st,Pt,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(Tt){O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,_t[Z].width,_t[Z].height,Rt,At,_t[Z].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Pt,_t[Z].width,_t[Z].height,0,Rt,At,_t[Z].data);for(let ht=0;ht<K.length;ht++){let kt=K[ht].image[Z].image;O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,0,0,kt.width,kt.height,Rt,At,kt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,Pt,kt.width,kt.height,0,Rt,At,kt.data)}}else{O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Rt,At,_t[Z]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Pt,Rt,At,_t[Z]);for(let ht=0;ht<K.length;ht++){let pt=K[ht];O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,0,0,Rt,At,pt.image[Z]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ht+1,Pt,Rt,At,pt.image[Z])}}}f(b)&&g(e.TEXTURE_CUBE_MAP),ft.__version=$.version,b.onUpdate&&b.onUpdate(b)}C.__version=b.version}function yt(C,b,H,X,$,ft){let gt=a.convert(H.format,H.colorSpace),tt=a.convert(H.type),et=_(H.internalFormat,gt,tt,H.normalized,H.colorSpace),vt=i.get(b),Tt=i.get(H);if(Tt.__renderTarget=b,!vt.__hasExternalTextures){let _t=Math.max(1,b.width>>ft),dt=Math.max(1,b.height>>ft);$===e.TEXTURE_3D||$===e.TEXTURE_2D_ARRAY?n.texImage3D($,ft,et,_t,dt,b.depth,0,gt,tt,null):n.texImage2D($,ft,et,_t,dt,0,gt,tt,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),Oe(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,X,$,Tt.__webglTexture,0,ue(b)):($===e.TEXTURE_2D||$>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,X,$,Tt.__webglTexture,ft),n.bindFramebuffer(e.FRAMEBUFFER,null)}function ae(C,b,H){if(e.bindRenderbuffer(e.RENDERBUFFER,C),b.depthBuffer){let X=b.depthTexture,$=X&&X.isDepthTexture?X.type:null,ft=T(b.stencilBuffer,$),gt=b.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Oe(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,ue(b),ft,b.width,b.height):H?e.renderbufferStorageMultisample(e.RENDERBUFFER,ue(b),ft,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,ft,b.width,b.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,gt,e.RENDERBUFFER,C)}else{let X=b.textures;for(let $=0;$<X.length;$++){let ft=X[$],gt=a.convert(ft.format,ft.colorSpace),tt=a.convert(ft.type),et=_(ft.internalFormat,gt,tt,ft.normalized,ft.colorSpace);Oe(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,ue(b),et,b.width,b.height):H?e.renderbufferStorageMultisample(e.RENDERBUFFER,ue(b),et,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,et,b.width,b.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Gt(C,b,H){let X=b.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let $=i.get(b.depthTexture);if($.__renderTarget=b,(!$.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),X){if($.__webglInit===void 0&&($.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),$.__webglTexture===void 0){$.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,$.__webglTexture),Ht(e.TEXTURE_CUBE_MAP,b.depthTexture);let vt=a.convert(b.depthTexture.format),Tt=a.convert(b.depthTexture.type),_t;b.depthTexture.format===ki?_t=e.DEPTH_COMPONENT24:b.depthTexture.format===ba&&(_t=e.DEPTH24_STENCIL8);for(let dt=0;dt<6;dt++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0,_t,b.width,b.height,0,vt,Tt,null)}}else j(b.depthTexture,0);let ft=$.__webglTexture,gt=ue(b),tt=X?e.TEXTURE_CUBE_MAP_POSITIVE_X+H:e.TEXTURE_2D,et=b.depthTexture.format===ba?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(b.depthTexture.format===ki)Oe(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,tt,ft,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,tt,ft,0);else if(b.depthTexture.format===ba)Oe(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,tt,ft,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,tt,ft,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Zt(C){let b=i.get(C),H=C.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==C.depthTexture){let X=C.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),X){let $=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,X.removeEventListener("dispose",$)};X.addEventListener("dispose",$),b.__depthDisposeCallback=$}b.__boundDepthTexture=X}if(C.depthTexture&&!b.__autoAllocateDepthBuffer)if(H)for(let X=0;X<6;X++)Gt(b.__webglFramebuffer[X],C,X);else{let X=C.texture.mipmaps;X&&X.length>0?Gt(b.__webglFramebuffer[0],C,0):Gt(b.__webglFramebuffer,C,0)}else if(H){b.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[X]),b.__webglDepthbuffer[X]===void 0)b.__webglDepthbuffer[X]=e.createRenderbuffer(),ae(b.__webglDepthbuffer[X],C,!1);else{let $=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ft=b.__webglDepthbuffer[X];e.bindRenderbuffer(e.RENDERBUFFER,ft),e.framebufferRenderbuffer(e.FRAMEBUFFER,$,e.RENDERBUFFER,ft)}}else{let X=C.texture.mipmaps;if(X&&X.length>0?n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=e.createRenderbuffer(),ae(b.__webglDepthbuffer,C,!1);else{let $=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ft=b.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,ft),e.framebufferRenderbuffer(e.FRAMEBUFFER,$,e.RENDERBUFFER,ft)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ft(C,b,H){let X=i.get(C);b!==void 0&&yt(X.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),H!==void 0&&Zt(C)}function Lt(C){let b=C.texture,H=i.get(C),X=i.get(b);C.addEventListener("dispose",x);let $=C.textures,ft=C.isWebGLCubeRenderTarget===!0,gt=$.length>1;if(gt||(X.__webglTexture===void 0&&(X.__webglTexture=e.createTexture()),X.__version=b.version,r.memory.textures++),ft){H.__webglFramebuffer=[];for(let tt=0;tt<6;tt++)if(b.mipmaps&&b.mipmaps.length>0){H.__webglFramebuffer[tt]=[];for(let et=0;et<b.mipmaps.length;et++)H.__webglFramebuffer[tt][et]=e.createFramebuffer()}else H.__webglFramebuffer[tt]=e.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){H.__webglFramebuffer=[];for(let tt=0;tt<b.mipmaps.length;tt++)H.__webglFramebuffer[tt]=e.createFramebuffer()}else H.__webglFramebuffer=e.createFramebuffer();if(gt)for(let tt=0,et=$.length;tt<et;tt++){let vt=i.get($[tt]);vt.__webglTexture===void 0&&(vt.__webglTexture=e.createTexture(),r.memory.textures++)}if(C.samples>0&&Oe(C)===!1){H.__webglMultisampledFramebuffer=e.createFramebuffer(),H.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let tt=0;tt<$.length;tt++){let et=$[tt];H.__webglColorRenderbuffer[tt]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,H.__webglColorRenderbuffer[tt]);let vt=a.convert(et.format,et.colorSpace),Tt=a.convert(et.type),_t=_(et.internalFormat,vt,Tt,et.normalized,et.colorSpace,C.isXRRenderTarget===!0),dt=ue(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,dt,_t,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+tt,e.RENDERBUFFER,H.__webglColorRenderbuffer[tt])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(H.__webglDepthRenderbuffer=e.createRenderbuffer(),ae(H.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(ft){n.bindTexture(e.TEXTURE_CUBE_MAP,X.__webglTexture),Ht(e.TEXTURE_CUBE_MAP,b);for(let tt=0;tt<6;tt++)if(b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)yt(H.__webglFramebuffer[tt][et],C,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,et);else yt(H.__webglFramebuffer[tt],C,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0);f(b)&&g(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(gt){for(let tt=0,et=$.length;tt<et;tt++){let vt=$[tt],Tt=i.get(vt),_t=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(_t=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(_t,Tt.__webglTexture),Ht(_t,vt),yt(H.__webglFramebuffer,C,vt,e.COLOR_ATTACHMENT0+tt,_t,0),f(vt)&&g(_t)}n.unbindTexture()}else{let tt=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(tt=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(tt,X.__webglTexture),Ht(tt,b),b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)yt(H.__webglFramebuffer[et],C,b,e.COLOR_ATTACHMENT0,tt,et);else yt(H.__webglFramebuffer,C,b,e.COLOR_ATTACHMENT0,tt,0);f(b)&&g(tt),n.unbindTexture()}C.depthBuffer&&Zt(C)}function jt(C){let b=C.textures;for(let H=0,X=b.length;H<X;H++){let $=b[H];if(f($)){let ft=y(C),gt=i.get($).__webglTexture;n.bindTexture(ft,gt),g(ft),n.unbindTexture()}}}let me=[],le=[];function Ie(C){if(C.samples>0){if(Oe(C)===!1){let b=C.textures,H=C.width,X=C.height,$=e.COLOR_BUFFER_BIT,ft=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,gt=i.get(C),tt=b.length>1;if(tt)for(let vt=0;vt<b.length;vt++)n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);let et=C.texture.mipmaps;et&&et.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let vt=0;vt<b.length;vt++){if(C.resolveDepthBuffer&&(C.depthBuffer&&($|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&($|=e.STENCIL_BUFFER_BIT)),tt){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,gt.__webglColorRenderbuffer[vt]);let Tt=i.get(b[vt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Tt,0)}e.blitFramebuffer(0,0,H,X,0,0,H,X,$,e.NEAREST),c===!0&&(me.length=0,le.length=0,me.push(e.COLOR_ATTACHMENT0+vt),C.depthBuffer&&C.resolveDepthBuffer===!1&&(me.push(ft),le.push(ft),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,le)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,me))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),tt)for(let vt=0;vt<b.length;vt++){n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.RENDERBUFFER,gt.__webglColorRenderbuffer[vt]);let Tt=i.get(b[vt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.TEXTURE_2D,Tt,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&c){let b=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[b])}}}function ue(C){return Math.min(s.maxSamples,C.samples)}function Oe(C){let b=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function P(C){let b=r.render.frame;h.get(C)!==b&&(h.set(C,b),C.update())}function sn(C,b){let H=C.colorSpace,X=C.format,$=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||H!==Fl&&H!==ws&&(ie.getTransfer(H)===pe?(X!==yi||$!==ii)&&Ot("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):zt("WebGLTextures: Unsupported texture color space:",H)),b}function ce(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(l.width=C.naturalWidth||C.width,l.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(l.width=C.displayWidth,l.height=C.displayHeight):(l.width=C.width,l.height=C.height),l}this.allocateTextureUnit=B,this.resetTextureUnits=q,this.getTextureUnits=J,this.setTextureUnits=z,this.setTexture2D=j,this.setTexture2DArray=rt,this.setTexture3D=ct,this.setTextureCube=lt,this.rebindTextures=Ft,this.setupRenderTarget=Lt,this.updateRenderTargetMipmap=jt,this.updateMultisampleRenderTarget=Ie,this.setupDepthRenderbuffer=Zt,this.setupFrameBufferTexture=yt,this.useMultisampledRTT=Oe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function i3(e,t){function n(i,s=ws){let a,r=ie.getTransfer(s);if(i===ii)return e.UNSIGNED_BYTE;if(i===wf)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Cf)return e.UNSIGNED_SHORT_5_5_5_1;if(i===a0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===r0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===i0)return e.BYTE;if(i===s0)return e.SHORT;if(i===Mo)return e.UNSIGNED_SHORT;if(i===Af)return e.INT;if(i===Ci)return e.UNSIGNED_INT;if(i===Ri)return e.FLOAT;if(i===Ji)return e.HALF_FLOAT;if(i===o0)return e.ALPHA;if(i===l0)return e.RGB;if(i===yi)return e.RGBA;if(i===ki)return e.DEPTH_COMPONENT;if(i===ba)return e.DEPTH_STENCIL;if(i===c0)return e.RED;if(i===Rf)return e.RED_INTEGER;if(i===Sa)return e.RG;if(i===Df)return e.RG_INTEGER;if(i===Nf)return e.RGBA_INTEGER;if(i===hc||i===fc||i===dc||i===pc)if(r===pe)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===hc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===dc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===pc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===hc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===dc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===pc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Uf||i===Lf||i===If||i===Of)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Uf)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===If)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Of)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Pf||i===zf||i===Bf||i===Ff||i===Vf||i===mc||i===Hf)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Pf||i===zf)return r===pe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Bf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ff)return a.COMPRESSED_R11_EAC;if(i===Vf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===mc)return a.COMPRESSED_RG11_EAC;if(i===Hf)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f||i===td||i===ed)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Gf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===kf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Xf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Wf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Yf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Jf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Kf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===jf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Qf)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===$f)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===td)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ed)return r===pe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===nd||i===id||i===sd)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===nd)return r===pe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===id)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===sd)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ad||i===rd||i===gc||i===od)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===ad)return a.COMPRESSED_RED_RGTC1_EXT;if(i===rd)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===gc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===od)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Eo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var s3=`
void main() {
...
}`,N0=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new Ql(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new ti({vertexShader:s3,fragmentShader:a3,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new je(new ma(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},U0=class extends Xi{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",c=1,l=null,h=null,d=null,u=null,p=null,m=null,S=typeof XRWebGLBinding<"u",v=new N0,f={},g=n.getContextAttributes(),y=null,_=null,T=[],A=[],w=new It,x=null,M=new xn;M.viewport=new ze;let R=new xn;R.viewport=new ze;let D=[M,R],I=new bf,q=null,J=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let ut=T[Q];return ut===void 0&&(ut=new vo,T[Q]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(Q){let ut=T[Q];return ut===void 0&&(ut=new vo,T[Q]=ut),ut.getGripSpace()},this.getHand=function(Q){let ut=T[Q];return ut===void 0&&(ut=new vo,T[Q]=ut),ut.getHandSpace()};function z(Q){let ut=A.indexOf(Q.inputSource);if(ut===-1)return;let ot=T[ut];ot!==void 0&&(ot.update(Q.inputSource,Q.frame,l||r),ot.dispatchEvent({type:Q.type,data:Q.inputSource}))}function B(){s.removeEventListener("select",z),s.removeEventListener("selectstart",z),s.removeEventListener("selectend",z),s.removeEventListener("squeeze",z),s.removeEventListener("squeezestart",z),s.removeEventListener("squeezeend",z),s.removeEventListener("end",B),s.removeEventListener("inputsourceschange",V);for(let Q=0;Q<T.length;Q++){let ut=A[Q];ut!==null&&(A[Q]=null,T[Q].disconnect(ut))}q=null,J=null,v.reset();for(let Q in f)delete f[Q];t.setRenderTarget(y),p=null,u=null,d=null,s=null,_=null,Ht.stop(),i.isPresenting=!1,t.setPixelRatio(x),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){a=Q,i.isPresenting===!0&&Ot("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){o=Q,i.isPresenting===!0&&Ot("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||r},this.setReferenceSpace=function(Q){l=Q},this.getBaseLayer=function(){return u!==null?u:p},this.getBinding=function(){return d===null&&S&&(d=new XRWebGLBinding(s,n)),d},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(Q){if(s=Q,s!==null){if(y=t.getRenderTarget(),s.addEventListener("select",z),s.addEventListener("selectstart",z),s.addEventListener("selectend",z),s.addEventListener("squeeze",z),s.addEventListener("squeezestart",z),s.addEventListener("squeezeend",z),s.addEventListener("end",B),s.addEventListener("inputsourceschange",V),g.xrCompatible!==!0&&await n.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(w),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let ot=null,Ct=null,mt=null;g.depth&&(mt=g.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ot=g.stencil?ba:ki,Ct=g.stencil?Eo:Ci);let yt={colorFormat:n.RGBA8,depthFormat:mt,scaleFactor:a};d=this.getBinding(),u=d.createProjectionLayer(yt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),_=new Qn(u.textureWidth,u.textureHeight,{format:yi,type:ii,depthTexture:new As(u.textureWidth,u.textureHeight,Ct,void 0,void 0,void 0,void 0,void 0,void 0,ot),stencilBuffer:g.stencil,colorSpace:t.outputColorSpace,samples:g.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let ot={antialias:g.antialias,alpha:!0,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:a};p=new XRWebGLLayer(s,n,ot),s.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),_=new Qn(p.framebufferWidth,p.framebufferHeight,{format:yi,type:ii,colorSpace:t.outputColorSpace,stencilBuffer:g.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}_.isXRRenderTarget=!0,this.setFoveation(c),l=null,r=await s.requestReferenceSpace(o),Ht.setContext(s),Ht.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function V(Q){for(let ut=0;ut<Q.removed.length;ut++){let ot=Q.removed[ut],Ct=A.indexOf(ot);Ct>=0&&(A[Ct]=null,T[Ct].disconnect(ot))}for(let ut=0;ut<Q.added.length;ut++){let ot=Q.added[ut],Ct=A.indexOf(ot);if(Ct===-1){for(let yt=0;yt<T.length;yt++)if(yt>=A.length){A.push(ot),Ct=yt;break}else if(A[yt]===null){A[yt]=ot,Ct=yt;break}if(Ct===-1)break}let mt=T[Ct];mt&&mt.connect(ot)}}let j=new L,rt=new L;function ct(Q,ut,ot){j.setFromMatrixPosition(ut.matrixWorld),rt.setFromMatrixPosition(ot.matrixWorld);let Ct=j.distanceTo(rt),mt=ut.projectionMatrix.elements,yt=ot.projectionMatrix.elements,ae=mt[14]/(mt[10]-1),Gt=mt[14]/(mt[10]+1),Zt=(mt[9]+1)/mt[5],Ft=(mt[9]-1)/mt[5],Lt=(mt[8]-1)/mt[0],jt=(yt[8]+1)/yt[0],me=ae*Lt,le=ae*jt,Ie=Ct/(-Lt+jt),ue=Ie*-Lt;if(ut.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(ue),Q.translateZ(Ie),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),mt[10]===-1)Q.projectionMatrix.copy(ut.projectionMatrix),Q.projectionMatrixInverse.copy(ut.projectionMatrixInverse);else{let Oe=ae+Ie,P=Gt+Ie,sn=me-ue,ce=le+(Ct-ue),C=Zt*Gt/P*Oe,b=Ft*Gt/P*Oe;Q.projectionMatrix.makePerspective(sn,ce,C,b,Oe,P),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function lt(Q,ut){ut===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(ut.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(s===null)return;let ut=Q.near,ot=Q.far;v.texture!==null&&(v.depthNear>0&&(ut=v.depthNear),v.depthFar>0&&(ot=v.depthFar)),I.near=R.near=M.near=ut,I.far=R.far=M.far=ot,(q!==I.near||J!==I.far)&&(s.updateRenderState({depthNear:I.near,depthFar:I.far}),q=I.near,J=I.far),I.layers.mask=Q.layers.mask|6,M.layers.mask=I.layers.mask&-5,R.layers.mask=I.layers.mask&-3;let Ct=Q.parent,mt=I.cameras;lt(I,Ct);for(let yt=0;yt<mt.length;yt++)lt(mt[yt],Ct);mt.length===2?ct(I,M,R):I.projectionMatrix.copy(M.projectionMatrix),at(Q,I,Ct)};function at(Q,ut,ot){ot===null?Q.matrix.copy(ut.matrixWorld):(Q.matrix.copy(ot.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(ut.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(ut.projectionMatrix),Q.projectionMatrixInverse.copy(ut.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=Xh*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(u===null&&p===null))return c},this.setFoveation=function(Q){c=Q,u!==null&&(u.fixedFoveation=Q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Q)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(I)},this.getCameraTexture=function(Q){return f[Q]};let Nt=null;function Kt(Q,ut){if(h=ut.getViewerPose(l||r),m=ut,h!==null){let ot=h.views;p!==null&&(t.setRenderTargetFramebuffer(_,p.framebuffer),t.setRenderTarget(_));let Ct=!1;ot.length!==I.cameras.length&&(I.cameras.length=0,Ct=!0);for(let Gt=0;Gt<ot.length;Gt++){let Zt=ot[Gt],Ft=null;if(p!==null)Ft=p.getViewport(Zt);else{let jt=d.getViewSubImage(u,Zt);Ft=jt.viewport,Gt===0&&(t.setRenderTargetTextures(_,jt.colorTexture,jt.depthStencilTexture),t.setRenderTarget(_))}let Lt=D[Gt];Lt===void 0&&(Lt=new xn,Lt.layers.enable(Gt),Lt.viewport=new ze,D[Gt]=Lt),Lt.matrix.fromArray(Zt.transform.matrix),Lt.matrix.decompose(Lt.position,Lt.quaternion,Lt.scale),Lt.projectionMatrix.fromArray(Zt.projectionMatrix),Lt.projectionMatrixInverse.copy(Lt.projectionMatrix).invert(),Lt.viewport.set(Ft.x,Ft.y,Ft.width,Ft.height),Gt===0&&(I.matrix.copy(Lt.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Ct===!0&&I.cameras.push(Lt)}let mt=s.enabledFeatures;if(mt&&mt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&S){d=i.getBinding();let Gt=d.getDepthInformation(ot[0]);Gt&&Gt.isValid&&Gt.texture&&v.init(Gt,s.renderState)}if(mt&&mt.includes("camera-access")&&S){t.state.unbindTexture(),d=i.getBinding();for(let Gt=0;Gt<ot.length;Gt++){let Zt=ot[Gt].camera;if(Zt){let Ft=f[Zt];Ft||(Ft=new Ql,f[Zt]=Ft);let Lt=d.getCameraImage(Zt);Ft.sourceTexture=Lt}}}}for(let ot=0;ot<T.length;ot++){let Ct=A[ot],mt=T[ot];Ct!==null&&mt!==void 0&&mt.update(Ct,ut,l||r)}Nt&&Nt(Q,ut),ut.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ut}),m=null}let Ht=new vM;Ht.setAnimationLoop(Kt),this.setAnimationLoop=function(Q){Nt=Q},this.dispose=function(){}}},r3=new Pe,MM=new Vt;MM.set(-1,0,0,0,1,0,0,0,1);function o3(e,t){function n(v,f){v.matrixAutoUpdate===!0&&v.updateMatrix(),f.value.copy(v.matrix)}function i(v,f){f.color.getRGB(v.fogColor.value,p0(e)),f.isFog?(v.fogNear.value=f.near,v.fogFar.value=f.far):f.isFogExp2&&(v.fogDensity.value=f.density)}function s(v,f,g,y,_){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?a(v,f):f.isMeshLambertMaterial?(a(v,f),f.envMap&&(v.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(a(v,f),d(v,f)):f.isMeshPhongMaterial?(a(v,f),h(v,f),f.envMap&&(v.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(a(v,f),u(v,f),f.isMeshPhysicalMaterial&&p(v,f,_)):f.isMeshMatcapMaterial?(a(v,f),m(v,f)):f.isMeshDepthMaterial?a(v,f):f.isMeshDistanceMaterial?(a(v,f),S(v,f)):f.isMeshNormalMaterial?a(v,f):f.isLineBasicMaterial?(r(v,f),f.isLineDashedMaterial&&o(v,f)):f.isPointsMaterial?c(v,f,g,y):f.isSpriteMaterial?l(v,f):f.isShadowMaterial?(v.color.value.copy(f.color),v.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(v,f){v.opacity.value=f.opacity,f.color&&v.diffuse.value.copy(f.color),f.emissive&&v.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(v.map.value=f.map,n(f.map,v.mapTransform)),f.alphaMap&&(v.alphaMap.value=f.alphaMap,n(f.alphaMap,v.alphaMapTransform)),f.bumpMap&&(v.bumpMap.value=f.bumpMap,n(f.bumpMap,v.bumpMapTransform),v.bumpScale.value=f.bumpScale,f.side===Cn&&(v.bumpScale.value*=-1)),f.normalMap&&(v.normalMap.value=f.normalMap,n(f.normalMap,v.normalMapTransform),v.normalScale.value.copy(f.normalScale),f.side===Cn&&v.normalScale.value.negate()),f.displacementMap&&(v.displacementMap.value=f.displacementMap,n(f.displacementMap,v.displacementMapTransform),v.displacementScale.value=f.displacementScale,v.displacementBias.value=f.displacementBias),f.emissiveMap&&(v.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,v.emissiveMapTransform)),f.specularMap&&(v.specularMap.value=f.specularMap,n(f.specularMap,v.specularMapTransform)),f.alphaTest>0&&(v.alphaTest.value=f.alphaTest);let g=t.get(f),y=g.envMap,_=g.envMapRotation;y&&(v.envMap.value=y,v.envMapRotation.value.setFromMatrix4(r3.makeRotationFromEuler(_)).transpose(),y.isCubeTexture&&y.isRenderTargetTexture===!1&&v.envMapRotation.value.premultiply(MM),v.reflectivity.value=f.reflectivity,v.ior.value=f.ior,v.refractionRatio.value=f.refractionRatio),f.lightMap&&(v.lightMap.value=f.lightMap,v.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,v.lightMapTransform)),f.aoMap&&(v.aoMap.value=f.aoMap,v.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,v.aoMapTransform))}function r(v,f){v.diffuse.value.copy(f.color),v.opacity.value=f.opacity,f.map&&(v.map.value=f.map,n(f.map,v.mapTransform))}function o(v,f){v.dashSize.value=f.dashSize,v.totalSize.value=f.dashSize+f.gapSize,v.scale.value=f.scale}function c(v,f,g,y){v.diffuse.value.copy(f.color),v.opacity.value=f.opacity,v.size.value=f.size*g,v.scale.value=y*.5,f.map&&(v.map.value=f.map,n(f.map,v.uvTransform)),f.alphaMap&&(v.alphaMap.value=f.alphaMap,n(f.alphaMap,v.alphaMapTransform)),f.alphaTest>0&&(v.alphaTest.value=f.alphaTest)}function l(v,f){v.diffuse.value.copy(f.color),v.opacity.value=f.opacity,v.rotation.value=f.rotation,f.map&&(v.map.value=f.map,n(f.map,v.mapTransform)),f.alphaMap&&(v.alphaMap.value=f.alphaMap,n(f.alphaMap,v.alphaMapTransform)),f.alphaTest>0&&(v.alphaTest.value=f.alphaTest)}function h(v,f){v.specular.value.copy(f.specular),v.shininess.value=Math.max(f.shininess,1e-4)}function d(v,f){f.gradientMap&&(v.gradientMap.value=f.gradientMap)}function u(v,f){v.metalness.value=f.metalness,f.metalnessMap&&(v.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,v.metalnessMapTransform)),v.roughness.value=f.roughness,f.roughnessMap&&(v.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,v.roughnessMapTransform)),f.envMap&&(v.envMapIntensity.value=f.envMapIntensity)}function p(v,f,g){v.ior.value=f.ior,f.sheen>0&&(v.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),v.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(v.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,v.sheenColorMapTransform)),f.sheenRoughnessMap&&(v.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,v.sheenRoughnessMapTransform))),f.clearcoat>0&&(v.clearcoat.value=f.clearcoat,v.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(v.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,v.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(v.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,v.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(v.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,v.clearcoatNormalMapTransform),v.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Cn&&v.clearcoatNormalScale.value.negate())),f.dispersion>0&&(v.dispersion.value=f.dispersion),f.iridescence>0&&(v.iridescence.value=f.iridescence,v.iridescenceIOR.value=f.iridescenceIOR,v.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],v.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(v.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,v.iridescenceMapTransform)),f.iridescenceThicknessMap&&(v.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,v.iridescenceThicknessMapTransform))),f.transmission>0&&(v.transmission.value=f.transmission,v.transmissionSamplerMap.value=g.texture,v.transmissionSamplerSize.value.set(g.width,g.height),f.transmissionMap&&(v.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,v.transmissionMapTransform)),v.thickness.value=f.thickness,f.thicknessMap&&(v.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,v.thicknessMapTransform)),v.attenuationDistance.value=f.attenuationDistance,v.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(v.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(v.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,v.anisotropyMapTransform))),v.specularIntensity.value=f.specularIntensity,v.specularColor.value.copy(f.specularColor),f.specularColorMap&&(v.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,v.specularColorMapTransform)),f.specularIntensityMap&&(v.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,v.specularIntensityMapTransform))}function m(v,f){f.matcap&&(v.matcap.value=f.matcap)}function S(v,f){let g=t.get(f).light;v.referencePosition.value.setFromMatrixPosition(g.matrixWorld),v.nearDistance.value=g.shadow.camera.near,v.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function l3(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(_,T){let A=T.program;i.uniformBlockBinding(_,A)}function l(_,T){let A=s[_.id];A===void 0&&(v(_),A=h(_),s[_.id]=A,_.addEventListener("dispose",g));let w=T.program;i.updateUBOMapping(_,w);let x=t.render.frame;a[_.id]!==x&&(u(_),a[_.id]=x)}function h(_){let T=d();_.__bindingPointIndex=T;let A=e.createBuffer(),w=_.__size,x=_.usage;return e.bindBuffer(e.UNIFORM_BUFFER,A),e.bufferData(e.UNIFORM_BUFFER,w,x),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,T,A),A}function d(){for(let _=0;_<o;_++)if(r.indexOf(_)===-1)return r.push(_),_;return zt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(_){let T=s[_.id],A=_.uniforms,w=_.__cache;e.bindBuffer(e.UNIFORM_BUFFER,T);for(let x=0,M=A.length;x<M;x++){let R=A[x];if(Array.isArray(R))for(let D=0,I=R.length;D<I;D++)p(R[D],x,D,w);else p(R,x,0,w)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(_,T,A,w){if(S(_,T,A,w)===!0){let x=_.__offset,M=_.value;if(Array.isArray(M)){let R=0;for(let D=0;D<M.length;D++){let I=M[D],q=f(I);m(I,_.__data,R),typeof I!="number"&&typeof I!="boolean"&&!I.isMatrix3&&!ArrayBuffer.isView(I)&&(R+=q.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(M,_.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,x,_.__data)}}function m(_,T,A){typeof _=="number"||typeof _=="boolean"?T[0]=_:_.isMatrix3?(T[0]=_.elements[0],T[1]=_.elements[1],T[2]=_.elements[2],T[3]=0,T[4]=_.elements[3],T[5]=_.elements[4],T[6]=_.elements[5],T[7]=0,T[8]=_.elements[6],T[9]=_.elements[7],T[10]=_.elements[8],T[11]=0):ArrayBuffer.isView(_)?T.set(new _.constructor(_.buffer,_.byteOffset,T.length)):_.toArray(T,A)}function S(_,T,A,w){let x=_.value,M=T+"_"+A;if(w[M]===void 0)return typeof x=="number"||typeof x=="boolean"?w[M]=x:ArrayBuffer.isView(x)?w[M]=x.slice():w[M]=x.clone(),!0;{let R=w[M];if(typeof x=="number"||typeof x=="boolean"){if(R!==x)return w[M]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(R.equals(x)===!1)return R.copy(x),!0}}return!1}function v(_){let T=_.uniforms,A=0,w=16;for(let M=0,R=T.length;M<R;M++){let D=Array.isArray(T[M])?T[M]:[T[M]];for(let I=0,q=D.length;I<q;I++){let J=D[I],z=Array.isArray(J.value)?J.value:[J.value];for(let B=0,V=z.length;B<V;B++){let j=z[B],rt=f(j),ct=A%w,lt=ct%rt.boundary,at=ct+lt;A+=lt,at!==0&&w-at<rt.storage&&(A+=w-at),J.__data=new Float32Array(rt.storage/Float32Array.BYTES_PER_ELEMENT),J.__offset=A,A+=rt.storage}}}let x=A%w;return x>0&&(A+=w-x),_.__size=A,_.__cache={},this}function f(_){let T={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(T.boundary=4,T.storage=4):_.isVector2?(T.boundary=8,T.storage=8):_.isVector3||_.isColor?(T.boundary=16,T.storage=12):_.isVector4?(T.boundary=16,T.storage=16):_.isMatrix3?(T.boundary=48,T.storage=48):_.isMatrix4?(T.boundary=64,T.storage=64):_.isTexture?Ot("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(_)?(T.boundary=16,T.storage=_.byteLength):Ot("WebGLRenderer: Unsupported uniform value type.",_),T}function g(_){let T=_.target;T.removeEventListener("dispose",g);let A=r.indexOf(T.__bindingPointIndex);r.splice(A,1),e.deleteBuffer(s[T.id]),delete s[T.id],delete a[T.id]}function y(){for(let _ in s)e.deleteBuffer(s[_]);r=[],s={},a={}}return{bind:c,update:l,dispose:y}}var c3=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ki=null;function u3(){return Ki===null&&(Ki=new Zh(c3,16,16,Sa,Ji),Ki.name="DFG_LUT",Ki.minFilter=mn,Ki.magFilter=mn,Ki.wrapS=Hi,Ki.wrapT=Hi,Ki.generateMipmaps=!1,Ki.needsUpdate=!0),Ki}var pd=class{constructor(t={}){let{canvas:n=GS(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:u=!1,outputBufferType:p=ii}=t;this.isWebGLRenderer=!0;let m;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=i.getContextAttributes().alpha}else m=r;let S=p,v=new Set([Nf,Df,Rf]),f=new Set([ii,Ci,Mo,Eo,wf,Cf]),g=new Uint32Array(4),y=new Int32Array(4),_=new L,T=null,A=null,w=[],x=[],M=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=wi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,D=!1,I=null,q=null,J=null,z=null;this._outputColorSpace=wn;let B=0,V=0,j=null,rt=-1,ct=null,lt=new ze,at=new ze,Nt=null,Kt=new ee(0),Ht=0,Q=n.width,ut=n.height,ot=1,Ct=null,mt=null,yt=new ze(0,0,Q,ut),ae=new ze(0,0,Q,ut),Gt=!1,Zt=new Kl,Ft=!1,Lt=!1,jt=new Pe,me=new L,le=new ze,Ie={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ue=!1;function Oe(){return j===null?ot:1}let P=i;function sn(E,F){return n.getContext(E,F)}try{let E={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Sf}`),n.addEventListener("webglcontextlost",kt,!1),n.addEventListener("webglcontextrestored",re,!1),n.addEventListener("webglcontextcreationerror",Mn,!1),P===null){let F="webgl2";if(P=sn(F,E),P===null)throw sn(F)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(E){throw zt("WebGLRenderer: "+E.message),E}let ce,C,b,H,X,$,ft,gt,tt,et,vt,Tt,_t,dt,Rt,At,Pt,O,N,U,st,K,Z;function ht(){ce=new vR(P),ce.init(),st=new i3(P,ce),C=new cR(P,ce,t,st),b=new e3(P,ce),C.reversedDepthBuffer&&u&&b.buffers.depth.setReversed(!0),q=P.createFramebuffer(),J=P.createFramebuffer(),z=P.createFramebuffer(),H=new xR(P),X=new H2,$=new n3(P,ce,b,X,C,st,H),ft=new gR(R),gt=new EA(P),K=new oR(P,gt),tt=new _R(P,gt,H,K),et=new SR(P,tt,gt,K,H),O=new bR(P,C,$),Rt=new uR(X),vt=new V2(R,ft,ce,C,K,Rt),Tt=new o3(R,X),_t=new k2,dt=new J2(ce),Pt=new rR(R,ft,b,et,m,c),At=new t3(R,et,C),Z=new l3(P,H,C,b),N=new lR(P,ce,H),U=new yR(P,ce,H),H.programs=vt.programs,R.capabilities=C,R.extensions=ce,R.properties=X,R.renderLists=_t,R.shadowMap=At,R.state=b,R.info=H}ht(),S!==ii&&(M=new ER(S,n.width,n.height,o,s,a));let pt=new U0(R,P);this.xr=pt,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let E=ce.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){let E=ce.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return ot},this.setPixelRatio=function(E){E!==void 0&&(ot=E,this.setSize(Q,ut,!1))},this.getSize=function(E){return E.set(Q,ut)},this.setSize=function(E,F,W=!0){if(pt.isPresenting){Ot("WebGLRenderer: Can't change size while VR device is presenting.");return}Q=E,ut=F,n.width=Math.floor(E*ot),n.height=Math.floor(F*ot),W===!0&&(n.style.width=E+"px",n.style.height=F+"px"),M!==null&&M.setSize(n.width,n.height),this.setViewport(0,0,E,F)},this.getDrawingBufferSize=function(E){return E.set(Q*ot,ut*ot).floor()},this.setDrawingBufferSize=function(E,F,W){Q=E,ut=F,ot=W,n.width=Math.floor(E*W),n.height=Math.floor(F*W),this.setViewport(0,0,E,F)},this.setEffects=function(E){if(S===ii){zt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let F=0;F<E.length;F++)if(E[F].isOutputPass===!0){Ot("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(lt)},this.getViewport=function(E){return E.copy(yt)},this.setViewport=function(E,F,W,G){E.isVector4?yt.set(E.x,E.y,E.z,E.w):yt.set(E,F,W,G),b.viewport(lt.copy(yt).multiplyScalar(ot).round())},this.getScissor=function(E){return E.copy(ae)},this.setScissor=function(E,F,W,G){E.isVector4?ae.set(E.x,E.y,E.z,E.w):ae.set(E,F,W,G),b.scissor(at.copy(ae).multiplyScalar(ot).round())},this.getScissorTest=function(){return Gt},this.setScissorTest=function(E){b.setScissorTest(Gt=E)},this.setOpaqueSort=function(E){Ct=E},this.setTransparentSort=function(E){mt=E},this.getClearColor=function(E){return E.copy(Pt.getClearColor())},this.setClearColor=function(){Pt.setClearColor(...arguments)},this.getClearAlpha=function(){return Pt.getClearAlpha()},this.setClearAlpha=function(){Pt.setClearAlpha(...arguments)},this.clear=function(E=!0,F=!0,W=!0){let G=0;if(E){let k=!1;if(j!==null){let St=j.texture.format;k=v.has(St)}if(k){let St=j.texture.type,Et=f.has(St),bt=Pt.getClearColor(),wt=Pt.getClearAlpha(),Dt=bt.r,Wt=bt.g,Jt=bt.b;Et?(g[0]=Dt,g[1]=Wt,g[2]=Jt,g[3]=wt,P.clearBufferuiv(P.COLOR,0,g)):(y[0]=Dt,y[1]=Wt,y[2]=Jt,y[3]=wt,P.clearBufferiv(P.COLOR,0,y))}else G|=P.COLOR_BUFFER_BIT}F&&(G|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(G|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&P.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),I=E},this.dispose=function(){n.removeEventListener("webglcontextlost",kt,!1),n.removeEventListener("webglcontextrestored",re,!1),n.removeEventListener("webglcontextcreationerror",Mn,!1),Pt.dispose(),_t.dispose(),dt.dispose(),X.dispose(),ft.dispose(),et.dispose(),K.dispose(),Z.dispose(),vt.dispose(),pt.dispose(),pt.removeEventListener("sessionstart",V0),pt.removeEventListener("sessionend",H0),Ta.stop()};function kt(E){E.preventDefault(),f0("WebGLRenderer: Context Lost."),D=!0}function re(){f0("WebGLRenderer: Context Restored."),D=!1;let E=H.autoReset,F=At.enabled,W=At.autoUpdate,G=At.needsUpdate,k=At.type;ht(),H.autoReset=E,At.enabled=F,At.autoUpdate=W,At.needsUpdate=G,At.type=k}function Mn(E){zt("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function zn(E){let F=E.target;F.removeEventListener("dispose",zn),LM(F)}function LM(E){IM(E),X.remove(E)}function IM(E){let F=X.get(E).programs;F!==void 0&&(F.forEach(function(W){vt.releaseProgram(W)}),E.isShaderMaterial&&vt.releaseShaderCache(E))}this.renderBufferDirect=function(E,F,W,G,k,St){F===null&&(F=Ie);let Et=k.isMesh&&k.matrixWorld.determinantAffine()<0,bt=zM(E,F,W,G,k);b.setMaterial(G,Et);let wt=W.index,Dt=1;if(G.wireframe===!0){if(wt=tt.getWireframeAttribute(W),wt===void 0)return;Dt=2}let Wt=W.drawRange,Jt=W.attributes.position,Ut=Wt.start*Dt,_e=(Wt.start+Wt.count)*Dt;St!==null&&(Ut=Math.max(Ut,St.start*Dt),_e=Math.min(_e,(St.start+St.count)*Dt)),wt!==null?(Ut=Math.max(Ut,0),_e=Math.min(_e,wt.count)):Jt!=null&&(Ut=Math.max(Ut,0),_e=Math.min(_e,Jt.count));let Ge=_e-Ut;if(Ge<0||Ge===1/0)return;K.setup(k,G,bt,W,wt);let Be,be=N;if(wt!==null&&(Be=gt.get(wt),be=U,be.setIndex(Be)),k.isMesh)G.wireframe===!0?(b.setLineWidth(G.wireframeLinewidth*Oe()),be.setMode(P.LINES)):be.setMode(P.TRIANGLES);else if(k.isLine){let gn=G.linewidth;gn===void 0&&(gn=1),b.setLineWidth(gn*Oe()),k.isLineSegments?be.setMode(P.LINES):k.isLineLoop?be.setMode(P.LINE_LOOP):be.setMode(P.LINE_STRIP)}else k.isPoints?be.setMode(P.POINTS):k.isSprite&&be.setMode(P.TRIANGLES);if(k.isBatchedMesh)if(ce.get("WEBGL_multi_draw"))be.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{let gn=k._multiDrawStarts,Mt=k._multiDrawCounts,Bn=k._multiDrawCount,he=wt?gt.get(wt).bytesPerElement:1,si=X.get(G).currentProgram.getUniforms();for(let Di=0;Di<Bn;Di++)si.setValue(P,"_gl_DrawID",Di),be.render(gn[Di]/he,Mt[Di])}else if(k.isInstancedMesh)be.renderInstances(Ut,Ge,k.count);else if(W.isInstancedBufferGeometry){let gn=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,Mt=Math.min(W.instanceCount,gn);be.renderInstances(Ut,Ge,Mt)}else be.render(Ut,Ge)};function F0(E,F,W){E.transparent===!0&&E.side===ni&&E.forceSinglePass===!1?(E.side=Cn,E.needsUpdate=!0,Ac(E,F,W),E.side=Ts,E.needsUpdate=!0,Ac(E,F,W),E.side=ni):Ac(E,F,W)}this.compile=function(E,F,W=null){W===null&&(W=E),A=dt.get(W),A.init(F),x.push(A),W.traverseVisible(function(k){k.isLight&&k.layers.test(F.layers)&&(A.pushLight(k),k.castShadow&&A.pushShadow(k))}),E!==W&&E.traverseVisible(function(k){k.isLight&&k.layers.test(F.layers)&&(A.pushLight(k),k.castShadow&&A.pushShadow(k))}),A.setupLights();let G=new Set;return E.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;let St=k.material;if(St)if(Array.isArray(St))for(let Et=0;Et<St.length;Et++){let bt=St[Et];F0(bt,W,k),G.add(bt)}else F0(St,W,k),G.add(St)}),A=x.pop(),G},this.compileAsync=function(E,F,W=null){let G=this.compile(E,F,W);return new Promise(k=>{function St(){if(G.forEach(function(Et){X.get(Et).currentProgram.isReady()&&G.delete(Et)}),G.size===0){k(E);return}setTimeout(St,10)}ce.get("KHR_parallel_shader_compile")!==null?St():setTimeout(St,10)})};let Sd=null;function OM(E){Sd&&Sd(E)}function V0(){Ta.stop()}function H0(){Ta.start()}let Ta=new vM;Ta.setAnimationLoop(OM),typeof self<"u"&&Ta.setContext(self),this.setAnimationLoop=function(E){Sd=E,pt.setAnimationLoop(E),E===null?Ta.stop():Ta.start()},pt.addEventListener("sessionstart",V0),pt.addEventListener("sessionend",H0),this.render=function(E,F){if(F!==void 0&&F.isCamera!==!0){zt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;I!==null&&I.renderStart(E,F);let W=pt.enabled===!0&&pt.isPresenting===!0,G=M!==null&&(j===null||W)&&M.begin(R,j);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),pt.enabled===!0&&pt.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(pt.cameraAutoUpdate===!0&&pt.updateCamera(F),F=pt.getCamera()),E.isScene===!0&&E.onBeforeRender(R,E,F,j),A=dt.get(E,x.length),A.init(F),A.state.textureUnits=$.getTextureUnits(),x.push(A),jt.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Zt.setFromProjectionMatrix(jt,Ai,F.reversedDepth),Lt=this.localClippingEnabled,Ft=Rt.init(this.clippingPlanes,Lt),T=_t.get(E,w.length),T.init(),w.push(T),pt.enabled===!0&&pt.isPresenting===!0){let Et=R.xr.getDepthSensingMesh();Et!==null&&Md(Et,F,-1/0,R.sortObjects)}Md(E,F,0,R.sortObjects),T.finish(),R.sortObjects===!0&&T.sort(Ct,mt,F.reversedDepth),ue=pt.enabled===!1||pt.isPresenting===!1||pt.hasDepthSensing()===!1,ue&&Pt.addToRenderList(T,E),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ft===!0&&Rt.beginShadows();let k=A.state.shadowsArray;if(At.render(k,E,F),Ft===!0&&Rt.endShadows(),(G&&M.hasRenderPass())===!1){let Et=T.opaque,bt=T.transmissive;if(A.setupLights(),F.isArrayCamera){let wt=F.cameras;if(bt.length>0)for(let Dt=0,Wt=wt.length;Dt<Wt;Dt++){let Jt=wt[Dt];k0(Et,bt,E,Jt)}ue&&Pt.render(E);for(let Dt=0,Wt=wt.length;Dt<Wt;Dt++){let Jt=wt[Dt];G0(T,E,Jt,Jt.viewport)}}else bt.length>0&&k0(Et,bt,E,F),ue&&Pt.render(E),G0(T,E,F)}j!==null&&V===0&&($.updateMultisampleRenderTarget(j),$.updateRenderTargetMipmap(j)),G&&M.end(R),E.isScene===!0&&E.onAfterRender(R,E,F),K.resetDefaultState(),rt=-1,ct=null,x.pop(),x.length>0?(A=x[x.length-1],$.setTextureUnits(A.state.textureUnits),Ft===!0&&Rt.setGlobalState(R.clippingPlanes,A.state.camera)):A=null,w.pop(),w.length>0?T=w[w.length-1]:T=null,I!==null&&I.renderEnd()};function Md(E,F,W,G){if(E.visible===!1)return;if(E.layers.test(F.layers)){if(E.isGroup)W=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(F);else if(E.isLightProbeGrid)A.pushLightProbeGrid(E);else if(E.isLight)A.pushLight(E),E.castShadow&&A.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Zt.intersectsSprite(E)){G&&le.setFromMatrixPosition(E.matrixWorld).applyMatrix4(jt);let Et=et.update(E),bt=E.material;bt.visible&&T.push(E,Et,bt,W,le.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Zt.intersectsObject(E))){let Et=et.update(E),bt=E.material;if(G&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),le.copy(E.boundingSphere.center)):(Et.boundingSphere===null&&Et.computeBoundingSphere(),le.copy(Et.boundingSphere.center)),le.applyMatrix4(E.matrixWorld).applyMatrix4(jt)),Array.isArray(bt)){let wt=Et.groups;for(let Dt=0,Wt=wt.length;Dt<Wt;Dt++){let Jt=wt[Dt],Ut=bt[Jt.materialIndex];Ut&&Ut.visible&&T.push(E,Et,Ut,W,le.z,Jt)}}else bt.visible&&T.push(E,Et,bt,W,le.z,null)}}let St=E.children;for(let Et=0,bt=St.length;Et<bt;Et++)Md(St[Et],F,W,G)}function G0(E,F,W,G){let{opaque:k,transmissive:St,transparent:Et}=E;A.setupLightsView(W),Ft===!0&&Rt.setGlobalState(R.clippingPlanes,W),G&&b.viewport(lt.copy(G)),k.length>0&&Tc(k,F,W),St.length>0&&Tc(St,F,W),Et.length>0&&Tc(Et,F,W),b.buffers.depth.setTest(!0),b.buffers.depth.setMask(!0),b.buffers.color.setMask(!0),b.setPolygonOffset(!1)}function k0(E,F,W,G){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[G.id]===void 0){let Ut=ce.has("EXT_color_buffer_half_float")||ce.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[G.id]=new Qn(1,1,{generateMipmaps:!0,type:Ut?Ji:ii,minFilter:xa,samples:Math.max(4,C.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ie.workingColorSpace})}let St=A.state.transmissionRenderTarget[G.id],Et=G.viewport||lt;St.setSize(Et.z*R.transmissionResolutionScale,Et.w*R.transmissionResolutionScale);let bt=R.getRenderTarget(),wt=R.getActiveCubeFace(),Dt=R.getActiveMipmapLevel();R.setRenderTarget(St),R.getClearColor(Kt),Ht=R.getClearAlpha(),Ht<1&&R.setClearColor(16777215,.5),R.clear(),ue&&Pt.render(W);let Wt=R.toneMapping;R.toneMapping=wi;let Jt=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),A.setupLightsView(G),Ft===!0&&Rt.setGlobalState(R.clippingPlanes,G),Tc(E,W,G),$.updateMultisampleRenderTarget(St),$.updateRenderTargetMipmap(St),ce.has("WEBGL_multisampled_render_to_texture")===!1){let Ut=!1;for(let _e=0,Ge=F.length;_e<Ge;_e++){let Be=F[_e],{object:be,geometry:gn,material:Mt,group:Bn}=Be;if(Mt.side===ni&&be.layers.test(G.layers)){let he=Mt.side;Mt.side=Cn,Mt.needsUpdate=!0,X0(be,W,G,gn,Mt,Bn),Mt.side=he,Mt.needsUpdate=!0,Ut=!0}}Ut===!0&&($.updateMultisampleRenderTarget(St),$.updateRenderTargetMipmap(St))}R.setRenderTarget(bt,wt,Dt),R.setClearColor(Kt,Ht),Jt!==void 0&&(G.viewport=Jt),R.toneMapping=Wt}function Tc(E,F,W){let G=F.isScene===!0?F.overrideMaterial:null;for(let k=0,St=E.length;k<St;k++){let Et=E[k],{object:bt,geometry:wt,group:Dt}=Et,Wt=Et.material;Wt.allowOverride===!0&&G!==null&&(Wt=G),bt.layers.test(W.layers)&&X0(bt,F,W,wt,Wt,Dt)}}function X0(E,F,W,G,k,St){E.onBeforeRender(R,F,W,G,k,St),E.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),k.onBeforeRender(R,F,W,G,E,St),k.transparent===!0&&k.side===ni&&k.forceSinglePass===!1?(k.side=Cn,k.needsUpdate=!0,R.renderBufferDirect(W,F,G,k,E,St),k.side=Ts,k.needsUpdate=!0,R.renderBufferDirect(W,F,G,k,E,St),k.side=ni):R.renderBufferDirect(W,F,G,k,E,St),E.onAfterRender(R,F,W,G,k,St)}function Ac(E,F,W){F.isScene!==!0&&(F=Ie);let G=X.get(E),k=A.state.lights,St=A.state.shadowsArray,Et=k.state.version,bt=vt.getParameters(E,k.state,St,F,W,A.state.lightProbeGridArray),wt=vt.getProgramCacheKey(bt),Dt=G.programs;G.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?F.environment:null,G.fog=F.fog;let Wt=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;G.envMap=ft.get(E.envMap||G.environment,Wt),G.envMapRotation=G.environment!==null&&E.envMap===null?F.environmentRotation:E.envMapRotation,Dt===void 0&&(E.addEventListener("dispose",zn),Dt=new Map,G.programs=Dt);let Jt=Dt.get(wt);if(Jt!==void 0){if(G.currentProgram===Jt&&G.lightsStateVersion===Et)return q0(E,bt),Jt}else bt.uniforms=vt.getUniforms(E),I!==null&&E.isNodeMaterial&&I.build(E,W,bt),E.onBeforeCompile(bt,R),Jt=vt.acquireProgram(bt,wt),Dt.set(wt,Jt),G.uniforms=bt.uniforms;let Ut=G.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ut.clippingPlanes=Rt.uniform),q0(E,bt),G.needsLights=FM(E),G.lightsStateVersion=Et,G.needsLights&&(Ut.ambientLightColor.value=k.state.ambient,Ut.lightProbe.value=k.state.probe,Ut.directionalLights.value=k.state.directional,Ut.directionalLightShadows.value=k.state.directionalShadow,Ut.spotLights.value=k.state.spot,Ut.spotLightShadows.value=k.state.spotShadow,Ut.rectAreaLights.value=k.state.rectArea,Ut.ltc_1.value=k.state.rectAreaLTC1,Ut.ltc_2.value=k.state.rectAreaLTC2,Ut.pointLights.value=k.state.point,Ut.pointLightShadows.value=k.state.pointShadow,Ut.hemisphereLights.value=k.state.hemi,Ut.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Ut.spotLightMatrix.value=k.state.spotLightMatrix,Ut.spotLightMap.value=k.state.spotLightMap,Ut.pointShadowMatrix.value=k.state.pointShadowMatrix),G.lightProbeGrid=A.state.lightProbeGridArray.length>0,G.currentProgram=Jt,G.uniformsList=null,Jt}function W0(E){if(E.uniformsList===null){let F=E.currentProgram.getUniforms();E.uniformsList=Ao.seqWithValue(F.seq,E.uniforms)}return E.uniformsList}function q0(E,F){let W=X.get(E);W.outputColorSpace=F.outputColorSpace,W.batching=F.batching,W.batchingColor=F.batchingColor,W.instancing=F.instancing,W.instancingColor=F.instancingColor,W.instancingMorph=F.instancingMorph,W.skinning=F.skinning,W.morphTargets=F.morphTargets,W.morphNormals=F.morphNormals,W.morphColors=F.morphColors,W.morphTargetsCount=F.morphTargetsCount,W.numClippingPlanes=F.numClippingPlanes,W.numIntersection=F.numClipIntersection,W.vertexAlphas=F.vertexAlphas,W.vertexTangents=F.vertexTangents,W.toneMapping=F.toneMapping}function PM(E,F){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;_.setFromMatrixPosition(F.matrixWorld);for(let W=0,G=E.length;W<G;W++){let k=E[W];if(k.texture!==null&&k.boundingBox.containsPoint(_))return k}return null}function zM(E,F,W,G,k){F.isScene!==!0&&(F=Ie),$.resetTextureUnits();let St=F.fog,Et=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?F.environment:null,bt=j===null?R.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:ie.workingColorSpace,wt=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,Dt=ft.get(G.envMap||Et,wt),Wt=G.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Jt=!!W.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Ut=!!W.morphAttributes.position,_e=!!W.morphAttributes.normal,Ge=!!W.morphAttributes.color,Be=wi;G.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(Be=R.toneMapping);let be=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,gn=be!==void 0?be.length:0,Mt=X.get(G),Bn=A.state.lights;if(Ft===!0&&(Lt===!0||E!==ct)){let Ee=E===ct&&G.id===rt;Rt.setState(G,E,Ee)}let he=!1;G.version===Mt.__version?(Mt.needsLights&&Mt.lightsStateVersion!==Bn.state.version||Mt.outputColorSpace!==bt||k.isBatchedMesh&&Mt.batching===!1||!k.isBatchedMesh&&Mt.batching===!0||k.isBatchedMesh&&Mt.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&Mt.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&Mt.instancing===!1||!k.isInstancedMesh&&Mt.instancing===!0||k.isSkinnedMesh&&Mt.skinning===!1||!k.isSkinnedMesh&&Mt.skinning===!0||k.isInstancedMesh&&Mt.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&Mt.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&Mt.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&Mt.instancingMorph===!1&&k.morphTexture!==null||Mt.envMap!==Dt||G.fog===!0&&Mt.fog!==St||Mt.numClippingPlanes!==void 0&&(Mt.numClippingPlanes!==Rt.numPlanes||Mt.numIntersection!==Rt.numIntersection)||Mt.vertexAlphas!==Wt||Mt.vertexTangents!==Jt||Mt.morphTargets!==Ut||Mt.morphNormals!==_e||Mt.morphColors!==Ge||Mt.toneMapping!==Be||Mt.morphTargetsCount!==gn||!!Mt.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(he=!0):(he=!0,Mt.__version=G.version);let si=Mt.currentProgram;he===!0&&(si=Ac(G,F,k),I&&G.isNodeMaterial&&I.onUpdateProgram(G,si,Mt));let Di=!1,Cs=!1,or=!1,Se=si.getUniforms(),ke=Mt.uniforms;if(b.useProgram(si.program)&&(Di=!0,Cs=!0,or=!0),G.id!==rt&&(rt=G.id,Cs=!0),Mt.needsLights){let Ee=PM(A.state.lightProbeGridArray,k);Mt.lightProbeGrid!==Ee&&(Mt.lightProbeGrid=Ee,Cs=!0)}if(Di||ct!==E){b.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),Se.setValue(P,"projectionMatrix",E.projectionMatrix),Se.setValue(P,"viewMatrix",E.matrixWorldInverse);let Ds=Se.map.cameraPosition;Ds!==void 0&&Ds.setValue(P,me.setFromMatrixPosition(E.matrixWorld)),C.logarithmicDepthBuffer&&Se.setValue(P,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&Se.setValue(P,"isOrthographic",E.isOrthographicCamera===!0),ct!==E&&(ct=E,Cs=!0,or=!0)}if(Mt.needsLights&&(Bn.state.directionalShadowMap.length>0&&Se.setValue(P,"directionalShadowMap",Bn.state.directionalShadowMap,$),Bn.state.spotShadowMap.length>0&&Se.setValue(P,"spotShadowMap",Bn.state.spotShadowMap,$),Bn.state.pointShadowMap.length>0&&Se.setValue(P,"pointShadowMap",Bn.state.pointShadowMap,$)),k.isSkinnedMesh){Se.setOptional(P,k,"bindMatrix"),Se.setOptional(P,k,"bindMatrixInverse");let Ee=k.skeleton;Ee&&(Ee.boneTexture===null&&Ee.computeBoneTexture(),Se.setValue(P,"boneTexture",Ee.boneTexture,$))}k.isBatchedMesh&&(Se.setOptional(P,k,"batchingTexture"),Se.setValue(P,"batchingTexture",k._matricesTexture,$),Se.setOptional(P,k,"batchingIdTexture"),Se.setValue(P,"batchingIdTexture",k._indirectTexture,$),Se.setOptional(P,k,"batchingColorTexture"),k._colorsTexture!==null&&Se.setValue(P,"batchingColorTexture",k._colorsTexture,$));let Rs=W.morphAttributes;if((Rs.position!==void 0||Rs.normal!==void 0||Rs.color!==void 0)&&O.update(k,W,si),(Cs||Mt.receiveShadow!==k.receiveShadow)&&(Mt.receiveShadow=k.receiveShadow,Se.setValue(P,"receiveShadow",k.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&F.environment!==null&&(ke.envMapIntensity.value=F.environmentIntensity),ke.dfgLUT!==void 0&&(ke.dfgLUT.value=u3()),Cs){if(Se.setValue(P,"toneMappingExposure",R.toneMappingExposure),Mt.needsLights&&BM(ke,or),St&&G.fog===!0&&Tt.refreshFogUniforms(ke,St),Tt.refreshMaterialUniforms(ke,G,ot,ut,A.state.transmissionRenderTarget[E.id]),Mt.needsLights&&Mt.lightProbeGrid){let Ee=Mt.lightProbeGrid;ke.probesSH.value=Ee.texture,ke.probesMin.value.copy(Ee.boundingBox.min),ke.probesMax.value.copy(Ee.boundingBox.max),ke.probesResolution.value.copy(Ee.resolution)}Ao.upload(P,W0(Mt),ke,$)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(Ao.upload(P,W0(Mt),ke,$),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&Se.setValue(P,"center",k.center),Se.setValue(P,"modelViewMatrix",k.modelViewMatrix),Se.setValue(P,"normalMatrix",k.normalMatrix),Se.setValue(P,"modelMatrix",k.matrixWorld),G.uniformsGroups!==void 0){let Ee=G.uniformsGroups;for(let Ds=0,lr=Ee.length;Ds<lr;Ds++){let Y0=Ee[Ds];Z.update(Y0,si),Z.bind(Y0,si)}}return si}function BM(E,F){E.ambientLightColor.needsUpdate=F,E.lightProbe.needsUpdate=F,E.directionalLights.needsUpdate=F,E.directionalLightShadows.needsUpdate=F,E.pointLights.needsUpdate=F,E.pointLightShadows.needsUpdate=F,E.spotLights.needsUpdate=F,E.spotLightShadows.needsUpdate=F,E.rectAreaLights.needsUpdate=F,E.hemisphereLights.needsUpdate=F}function FM(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return V},this.getRenderTarget=function(){return j},this.setRenderTargetTextures=function(E,F,W){let G=X.get(E);G.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),X.get(E.texture).__webglTexture=F,X.get(E.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:W,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,F){let W=X.get(E);W.__webglFramebuffer=F,W.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(E,F=0,W=0){j=E,B=F,V=W;let G=null,k=!1,St=!1;if(E){let bt=X.get(E);if(bt.__useDefaultFramebuffer!==void 0){b.bindFramebuffer(P.FRAMEBUFFER,bt.__webglFramebuffer),lt.copy(E.viewport),at.copy(E.scissor),Nt=E.scissorTest,b.viewport(lt),b.scissor(at),b.setScissorTest(Nt),rt=-1;return}else if(bt.__webglFramebuffer===void 0)$.setupRenderTarget(E);else if(bt.__hasExternalTextures)$.rebindTextures(E,X.get(E.texture).__webglTexture,X.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){let Wt=E.depthTexture;if(bt.__boundDepthTexture!==Wt){if(Wt!==null&&X.has(Wt)&&(E.width!==Wt.image.width||E.height!==Wt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");$.setupDepthRenderbuffer(E)}}let wt=E.texture;(wt.isData3DTexture||wt.isDataArrayTexture||wt.isCompressedArrayTexture)&&(St=!0);let Dt=X.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Dt[F])?G=Dt[F][W]:G=Dt[F],k=!0):E.samples>0&&$.useMultisampledRTT(E)===!1?G=X.get(E).__webglMultisampledFramebuffer:Array.isArray(Dt)?G=Dt[W]:G=Dt,lt.copy(E.viewport),at.copy(E.scissor),Nt=E.scissorTest}else lt.copy(yt).multiplyScalar(ot).floor(),at.copy(ae).multiplyScalar(ot).floor(),Nt=Gt;if(W!==0&&(G=q),b.bindFramebuffer(P.FRAMEBUFFER,G)&&b.drawBuffers(E,G),b.viewport(lt),b.scissor(at),b.setScissorTest(Nt),k){let bt=X.get(E.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+F,bt.__webglTexture,W)}else if(St){let bt=F;for(let wt=0;wt<E.textures.length;wt++){let Dt=X.get(E.textures[wt]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+wt,Dt.__webglTexture,W,bt)}}else if(E!==null&&W!==0){let bt=X.get(E.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,bt.__webglTexture,W)}rt=-1},this.readRenderTargetPixels=function(E,F,W,G,k,St,Et,bt=0){if(!(E&&E.isWebGLRenderTarget)){zt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let wt=X.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Et!==void 0&&(wt=wt[Et]),wt){b.bindFramebuffer(P.FRAMEBUFFER,wt);try{let Dt=E.textures[bt],Wt=Dt.format,Jt=Dt.type;if(E.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+bt),!C.textureFormatReadable(Wt)){zt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!C.textureTypeReadable(Jt)){zt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=E.width-G&&W>=0&&W<=E.height-k&&P.readPixels(F,W,G,k,st.convert(Wt),st.convert(Jt),St)}finally{let Dt=j!==null?X.get(j).__webglFramebuffer:null;b.bindFramebuffer(P.FRAMEBUFFER,Dt)}}},this.readRenderTargetPixelsAsync=async function(E,F,W,G,k,St,Et,bt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let wt=X.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&Et!==void 0&&(wt=wt[Et]),wt)if(F>=0&&F<=E.width-G&&W>=0&&W<=E.height-k){b.bindFramebuffer(P.FRAMEBUFFER,wt);let Dt=E.textures[bt],Wt=Dt.format,Jt=Dt.type;if(E.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+bt),!C.textureFormatReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!C.textureTypeReadable(Jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ut=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,Ut),P.bufferData(P.PIXEL_PACK_BUFFER,St.byteLength,P.STREAM_READ),P.readPixels(F,W,G,k,st.convert(Wt),st.convert(Jt),0);let _e=j!==null?X.get(j).__webglFramebuffer:null;b.bindFramebuffer(P.FRAMEBUFFER,_e);let Ge=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await XS(P,Ge,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,Ut),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,St),P.deleteBuffer(Ut),P.deleteSync(Ge),St}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,F=null,W=0){let G=Math.pow(2,-W),k=Math.floor(E.image.width*G),St=Math.floor(E.image.height*G),Et=F!==null?F.x:0,bt=F!==null?F.y:0;$.setTexture2D(E,0),P.copyTexSubImage2D(P.TEXTURE_2D,W,0,0,Et,bt,k,St),b.unbindTexture()},this.copyTextureToTexture=function(E,F,W=null,G=null,k=0,St=0){let Et,bt,wt,Dt,Wt,Jt,Ut,_e,Ge,Be=E.isCompressedTexture?E.mipmaps[St]:E.image;if(W!==null)Et=W.max.x-W.min.x,bt=W.max.y-W.min.y,wt=W.isBox3?W.max.z-W.min.z:1,Dt=W.min.x,Wt=W.min.y,Jt=W.isBox3?W.min.z:0;else{let ke=Math.pow(2,-k);Et=Math.floor(Be.width*ke),bt=Math.floor(Be.height*ke),E.isDataArrayTexture?wt=Be.depth:E.isData3DTexture?wt=Math.floor(Be.depth*ke):wt=1,Dt=0,Wt=0,Jt=0}G!==null?(Ut=G.x,_e=G.y,Ge=G.z):(Ut=0,_e=0,Ge=0);let be=st.convert(F.format),gn=st.convert(F.type),Mt;F.isData3DTexture?($.setTexture3D(F,0),Mt=P.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?($.setTexture2DArray(F,0),Mt=P.TEXTURE_2D_ARRAY):($.setTexture2D(F,0),Mt=P.TEXTURE_2D),b.activeTexture(P.TEXTURE0),b.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,F.flipY),b.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),b.pixelStorei(P.UNPACK_ALIGNMENT,F.unpackAlignment);let Bn=b.getParameter(P.UNPACK_ROW_LENGTH),he=b.getParameter(P.UNPACK_IMAGE_HEIGHT),si=b.getParameter(P.UNPACK_SKIP_PIXELS),Di=b.getParameter(P.UNPACK_SKIP_ROWS),Cs=b.getParameter(P.UNPACK_SKIP_IMAGES);b.pixelStorei(P.UNPACK_ROW_LENGTH,Be.width),b.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Be.height),b.pixelStorei(P.UNPACK_SKIP_PIXELS,Dt),b.pixelStorei(P.UNPACK_SKIP_ROWS,Wt),b.pixelStorei(P.UNPACK_SKIP_IMAGES,Jt);let or=E.isDataArrayTexture||E.isData3DTexture,Se=F.isDataArrayTexture||F.isData3DTexture;if(E.isDepthTexture){let ke=X.get(E),Rs=X.get(F),Ee=X.get(ke.__renderTarget),Ds=X.get(Rs.__renderTarget);b.bindFramebuffer(P.READ_FRAMEBUFFER,Ee.__webglFramebuffer),b.bindFramebuffer(P.DRAW_FRAMEBUFFER,Ds.__webglFramebuffer);for(let lr=0;lr<wt;lr++)or&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,X.get(E).__webglTexture,k,Jt+lr),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,X.get(F).__webglTexture,St,Ge+lr)),P.blitFramebuffer(Dt,Wt,Et,bt,Ut,_e,Et,bt,P.DEPTH_BUFFER_BIT,P.NEAREST);b.bindFramebuffer(P.READ_FRAMEBUFFER,null),b.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(k!==0||E.isRenderTargetTexture||X.has(E)){let ke=X.get(E),Rs=X.get(F);b.bindFramebuffer(P.READ_FRAMEBUFFER,J),b.bindFramebuffer(P.DRAW_FRAMEBUFFER,z);for(let Ee=0;Ee<wt;Ee++)or?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,ke.__webglTexture,k,Jt+Ee):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,ke.__webglTexture,k),Se?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Rs.__webglTexture,St,Ge+Ee):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Rs.__webglTexture,St),k!==0?P.blitFramebuffer(Dt,Wt,Et,bt,Ut,_e,Et,bt,P.COLOR_BUFFER_BIT,P.NEAREST):Se?P.copyTexSubImage3D(Mt,St,Ut,_e,Ge+Ee,Dt,Wt,Et,bt):P.copyTexSubImage2D(Mt,St,Ut,_e,Dt,Wt,Et,bt);b.bindFramebuffer(P.READ_FRAMEBUFFER,null),b.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else Se?E.isDataTexture||E.isData3DTexture?P.texSubImage3D(Mt,St,Ut,_e,Ge,Et,bt,wt,be,gn,Be.data):F.isCompressedArrayTexture?P.compressedTexSubImage3D(Mt,St,Ut,_e,Ge,Et,bt,wt,be,Be.data):P.texSubImage3D(Mt,St,Ut,_e,Ge,Et,bt,wt,be,gn,Be):E.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,St,Ut,_e,Et,bt,be,gn,Be.data):E.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,St,Ut,_e,Be.width,Be.height,be,Be.data):P.texSubImage2D(P.TEXTURE_2D,St,Ut,_e,Et,bt,be,gn,Be);b.pixelStorei(P.UNPACK_ROW_LENGTH,Bn),b.pixelStorei(P.UNPACK_IMAGE_HEIGHT,he),b.pixelStorei(P.UNPACK_SKIP_PIXELS,si),b.pixelStorei(P.UNPACK_SKIP_ROWS,Di),b.pixelStorei(P.UNPACK_SKIP_IMAGES,Cs),St===0&&F.generateMipmaps&&P.generateMipmap(Mt),b.unbindTexture()},this.initRenderTarget=function(E){X.get(E).__webglFramebuffer===void 0&&$.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?$.setTextureCube(E,0):E.isData3DTexture?$.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?$.setTexture2DArray(E,0):$.setTexture2D(E,0),b.unbindTexture()},this.resetState=function(){B=0,V=0,j=null,b.reset(),K.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ai}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=ie._getDrawingBufferColorSpace(t),n.unpackColorSpace=ie._getUnpackColorSpace()}};var vd=12;var se=(e,t,n=0)=>({time:e,azimuth:t||0,elevation:n,distance:1}),EM=e=>[...Array.from({length:9},(t,n)=>se(Number((n*5/48).toFixed(6)),e*n*45)),se(1,e*360)],bc=(e,t=0)=>[se(0,0),se(.2,e/2,t/2),se(.4,e,t),se(.6,e/2,t/2),se(.8,0),se(1,0)],TM=e=>[...Array.from({length:9},(t,n)=>se(Number((n*5/48).toFixed(6)),e*n*45,n===8?0:Number((25*Math.sin(Math.PI*n/8)).toFixed(3)))),se(1,e*360)],iL=[{id:"swing",name:"Side Arc",description:"A 65-degree arc around the frame.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,65,8)]},{id:"rise",name:"Hero Rise",description:"A new angle on the action.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,35,30)]},{id:"orbit",name:"Full Orbit",description:"A full right orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:EM(1)},{id:"arc-return",name:"Arc Return",description:"Sweep 45 degrees to the side, then retrace to the starting pose.",duration:5,returnsToStart:!0,trajectory:[se(0,0),se(.2,22.5),se(.45,45),se(.7,22.5),se(.9,0),se(1,0)]},{id:"rise-return",name:"Rise Return",description:"Rise 25 degrees, then descend to the starting pose.",duration:5,returnsToStart:!0,trajectory:[se(0,0),se(.2,0,12.5),se(.45,0,25),se(.7,0,12.5),se(.9,0),se(1,0)]},{id:"orbit-left",name:"Orbit Left",description:"A full left orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:EM(-1)},{id:"arc-left-return",name:"Left Return",description:"Sweep 45 degrees left, then retrace to the opening view.",duration:5,returnsToStart:!0,trajectory:bc(-45)},{id:"wide-return",name:"Wide Return",description:"Reach a 90-degree side view, then return to the opening pose.",duration:5,returnsToStart:!0,trajectory:bc(90)},{id:"dip-return",name:"Dip Return",description:"Dip 20 degrees below the subject, then rise back to the opening view.",duration:5,returnsToStart:!0,trajectory:bc(0,-20)},{id:"high-arc-return",name:"High Return",description:"Arc 45 degrees right and 25 degrees up, then retrace home.",duration:5,returnsToStart:!0,trajectory:bc(45,25)},{id:"low-arc-return",name:"Low Return",description:"Arc 45 degrees left and 20 degrees down, then retrace home.",duration:5,returnsToStart:!0,trajectory:bc(-45,-20)},{id:"sway-return",name:"Side to Side",description:"Sway left, cross through the opening view to the right, then return.",duration:5,returnsToStart:!0,trajectory:[se(0,0),se(.2,-30),se(.4,0),se(.6,30),se(.8,0),se(1,0)]},{id:"halo",name:"High Orbit",description:"Orbit right through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:TM(1)},{id:"halo-left",name:"High Orbit Left",description:"Orbit left through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:TM(-1)},{id:"arc-left",name:"Left Arc",description:"A 65-degree left arc that finishes at a new angle.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,-65,8)]},{id:"low-angle",name:"Low Reveal",description:"Sweep 40 degrees right and descend 20 degrees for a low-angle finish.",duration:5,returnsToStart:!1,trajectory:[se(0,0),se(1,40,-20)]}];var Y=wc(L0());async function rr(e){let t=e instanceof FormData?e:new FormData;if(!(e instanceof FormData))for(let[n,i]of Object.entries(e))t.set(n,i);t.set("format","json");try{return await(await fetch(window.location.pathname,{method:"POST",body:t,credentials:"same-origin"})).json()}catch{return null}}var Mc=Math.PI/180;function nn(e,t,n){return Math.max(t,Math.min(n,e))}function Ec(e,t){if(t<=e[0].time)return e[0];let n=e[e.length-1];if(t>=n.time)return n;let i=1;for(;e[i].time<t;)i++;let s=e[i-1],a=e[i],r=Math.max(1e-6,a.time-s.time),o=(t-s.time)/r,c=o*o*(3-2*o),l=a.azimuth-s.azimuth;return l=((l%360+540)%360+360)%360-180,{time:t,azimuth:s.azimuth+l*c,elevation:s.elevation+(a.elevation-s.elevation)*c,distance:s.distance+(a.distance-s.distance)*c}}var z0={time:0,azimuth:0,elevation:0,distance:1},p3={...z0,time:1},Sc=1024,RM=["#f8fbff","#ffd166","#ff5d8f","#4db0ff","#39d98a"],m3=[{id:"fast",label:"Flare Fast"},{id:"detailed",label:"Flare Detailed"},{id:"turbo",label:"Turbo"},{id:"hq",label:"Sunburst HQ"}];function g3(e){let t=(0,it.useRef)(null),n=(0,it.useRef)([]),i=(0,it.useRef)(!1),[s,a]=(0,it.useState)(RM[0]),[r,o]=(0,it.useState)(14),[c,l]=(0,it.useState)(!1),[h,d]=(0,it.useState)(""),[u,p]=(0,it.useState)("fast"),[,m]=(0,it.useState)(0),S=(0,it.useCallback)(()=>{let g=t.current,y=g?.getContext("2d");if(!(!g||!y)){y.fillStyle="#0a1120",y.fillRect(0,0,Sc,Sc);for(let _ of n.current){y.save(),y.globalCompositeOperation=_.erase?"destination-out":"source-over",y.strokeStyle=_.color,y.fillStyle=_.color,y.lineWidth=_.width,y.lineCap="round",y.lineJoin="round";let[T,...A]=_.points;if(!T){y.restore();continue}y.beginPath(),y.arc(T.x,T.y,_.width/2,0,Math.PI*2),y.fill(),y.beginPath(),y.moveTo(T.x,T.y);for(let w of A)y.lineTo(w.x,w.y);y.stroke(),y.restore()}}},[]);(0,it.useEffect)(()=>S(),[S]);let v=g=>{let y=g.currentTarget.getBoundingClientRect(),_=Sc/Math.max(1,Math.min(y.width,y.height));return{x:(g.clientX-y.left)*_,y:(g.clientY-y.top)*_}},f=n.current.length===0;return(0,Y.jsxs)("div",{className:"fz-sketch",children:[(0,Y.jsx)("canvas",{ref:t,className:"fz-sketch-canvas",width:Sc,height:Sc,onPointerDown:g=>{g.currentTarget.setPointerCapture(g.pointerId),i.current=!0,n.current.push({points:[v(g)],color:s,width:r,erase:c}),S()},onPointerMove:g=>{i.current&&(n.current[n.current.length-1]?.points.push(v(g)),S())},onPointerUp:()=>{i.current=!1,m(g=>g+1)}}),(0,Y.jsxs)("div",{className:"fz-tools",children:[RM.map(g=>(0,Y.jsx)("button",{type:"button",className:`fz-swatch${!c&&s===g?" selected":""}`,style:{background:g},"aria-label":`paint ${g}`,onClick:()=>{a(g),l(!1)}},g)),(0,Y.jsx)("button",{type:"button",className:`fz-ghost${c?" selected":""}`,onClick:()=>l(g=>!g),children:"erase"}),(0,Y.jsx)("input",{className:"fz-size",type:"range",min:4,max:60,value:r,onChange:g=>o(Number(g.target.value)),"aria-label":"brush size"}),(0,Y.jsx)("button",{type:"button",className:"fz-ghost",disabled:f,onClick:()=>{n.current=[],S(),m(g=>g+1)},children:"clear"})]}),(0,Y.jsx)("textarea",{className:"fz-prompt",placeholder:"describe the scene \u2014 'two friends at a diner, neon light'",value:h,maxLength:2e3,onChange:g=>d(g.target.value)}),(0,Y.jsx)("div",{className:"fz-modes",children:m3.map(g=>(0,Y.jsx)("button",{type:"button",className:u===g.id?"active":"",onClick:()=>p(g.id),children:g.label},g.id))}),(0,Y.jsx)("button",{type:"button",className:"fz-primary",disabled:e.busy||!h.trim(),onClick:()=>{let g=t.current;n.current.length>0&&g?g.toBlob(_=>e.onGenerate(_,h.trim(),u),"image/png"):e.onGenerate(null,h.trim(),u)},children:e.busy?"generating\u2026":"generate the still"})]})}var yd=1/30,DM=10*1024*1024,ar=30,v3=250*1024*1024,I0={mp4:"video/mp4",mov:"video/quicktime",webm:"video/webm"};async function _3(e){let t=e.slice(0,8388608),n=await crypto.subtle.digest("SHA-256",await new Blob([t,`:${e.size}`]).arrayBuffer());return Array.from(new Uint8Array(n)).map(i=>i.toString(16).padStart(2,"0")).join("")}function y3(e,t,n=1e4){return new Promise((i,s)=>{if(Math.abs(e.currentTime-t)<.001&&e.readyState>=2){i();return}let a=window.setTimeout(()=>{e.removeEventListener("seeked",r),s(new Error("couldn't read that frame"))},n);function r(){window.clearTimeout(a),i()}e.addEventListener("seeked",r,{once:!0}),e.currentTime=t})}function UM(e,t){let n=document.createElement("canvas");n.width=Math.min(t,e.videoWidth),n.height=Math.round(n.width*e.videoHeight/Math.max(1,e.videoWidth));let i=n.getContext("2d");return!i||!n.width?null:(i.drawImage(e,0,0,n.width,n.height),n)}async function x3(e,t,n=1e4){try{await y3(e,t,n);let i=UM(e,160);return i?i.toDataURL("image/jpeg",.8):null}catch{return null}}function b3(e){let{busy:t,onFrame:n}=e,i=(0,it.useRef)(null),s=(0,it.useRef)(null),a=(0,it.useRef)(null),r=(0,it.useRef)(null),o=(0,it.useRef)(!1),c=(0,it.useRef)(0),[l,h]=(0,it.useState)(null),[d,u]=(0,it.useState)(0),[p,m]=(0,it.useState)(0),[S,v]=(0,it.useState)(0),[f,g]=(0,it.useState)(!1),[y,_]=(0,it.useState)([]),[T,A]=(0,it.useState)(!1),[w,x]=(0,it.useState)(!1),[M,R]=(0,it.useState)(null);(0,it.useEffect)(()=>()=>{c.current++,a.current&&URL.revokeObjectURL(a.current)},[]);let D=(0,it.useCallback)(async B=>{if(!B)return;R(null);let V=B.name.split(".").pop()?.toLowerCase()??"",j=I0[V]??B.type;if(!Object.values(I0).includes(j)){R("choose a video \u2014 mp4, mov, or webm");return}if(B.size>v3){R("choose a clip under 250mb");return}A(!0);let rt=++c.current,ct=URL.createObjectURL(B),lt=()=>c.current!==rt;try{let at=document.createElement("video");if(at.preload="auto",at.muted=!0,at.playsInline=!0,await new Promise((Q,ut)=>{let ot=window.setTimeout(()=>ut(new Error("that clip took too long to read")),2e4);at.onloadeddata=()=>{window.clearTimeout(ot),Q()},at.onerror=()=>{window.clearTimeout(ot),ut(new Error("can't decode that video \u2014 try an h.264 mp4"))},at.src=ct}),!Number.isFinite(at.duration)||at.duration<=0||at.duration>15*60)throw new Error("choose a clip under fifteen minutes");if(lt()){at.removeAttribute("src"),at.load(),URL.revokeObjectURL(ct);return}let Nt=[],Kt=Date.now()+15e3;for(let Q=0;Q<10&&!lt();Q++){let ut=Kt-Date.now();if(ut<=0)break;let ot=Math.max(0,Math.min(at.duration-.05,at.duration*Q/10)),Ct=await x3(at,ot,ut);Ct&&Nt.push({src:Ct,time:ot})}if(lt()){at.removeAttribute("src"),at.load(),URL.revokeObjectURL(ct);return}a.current&&URL.revokeObjectURL(a.current),a.current=ct,r.current=B,h(ct),u(at.duration);let Ht=Math.min(ar,at.duration)/2;v(Math.max(0,at.duration/2-Ht)),m(at.duration/2),_(Nt),at.removeAttribute("src"),at.load()}catch(at){URL.revokeObjectURL(ct),lt()||R(at instanceof Error?at.message:"that video didn't load")}finally{lt()||A(!1)}},[]),I=Math.min(d,S+ar),q=(0,it.useCallback)(B=>{let V=nn(B,S,I);m(V);let j=s.current;j&&(j.pause(),o.current=!0,j.currentTime=V)},[S,I]),J=(0,it.useCallback)(B=>{(B<S||B>I)&&v(nn(B-ar/2,0,Math.max(0,d-ar))),m(B);let V=s.current;V&&(V.pause(),o.current=!0,V.currentTime=B)},[d,S,I]),z=(0,it.useCallback)(async()=>{let B=s.current;if(!(!B||w||t)){x(!0);try{(o.current||B.readyState<2||Math.abs(B.currentTime-p)>.001)&&await new Promise((lt,at)=>{let Nt=window.setTimeout(()=>{B.removeEventListener("seeked",Kt),at(new Error("couldn't read that frame"))},1e4),Kt=()=>{window.clearTimeout(Nt),lt()};B.addEventListener("seeked",Kt,{once:!0}),o.current||(B.currentTime=p)});let V=Math.min(1920,B.videoWidth),j=null;for(;V>0;){let lt=UM(B,V);if(!lt)throw new Error("frame capture isn't available");if(j=await new Promise(at=>lt.toBlob(Nt=>at(Nt),"image/jpeg",.94)),!j)throw new Error("frame capture isn't available");if(j.size<=DM||V<=320)break;V=Math.floor(V*.75)}if(!j||j.size>DM)throw new Error("that frame is too large \u2014 try a smaller clip");let rt=new File([j],"freeze-frame.jpg",{type:"image/jpeg"}),ct=r.current;if(ct){g(!0);try{let lt=ct.name.split(".").pop()?.toLowerCase()??"",at=I0[lt]??ct.type,Nt=await rr({action:"clip",mime:at});if(Nt?.clipPath&&Nt.uploadUrl){let Kt=await _3(ct),Ht=new FormData;Ht.append("cacheControl","3600"),Ht.append("",ct);let Q=await fetch(Nt.uploadUrl,{method:"PUT",body:Ht});if(!Q.ok)throw new Error(`clip upload ${Q.status}`);n(rt,{path:Nt.clipPath,sha:Kt,bytes:ct.size,clipIn:S,clipOut:I,freezeAt:p});return}throw new Error(Nt?.line??"the clip upload didn't start")}catch(lt){R(`${lt instanceof Error?lt.message:"the clip didn't upload"} \u2014 the freeze still works, it just won't splice into the footage`)}finally{g(!1)}}n(rt,null)}catch(V){R(V instanceof Error?V.message:"couldn't capture the frame")}finally{x(!1)}}},[p,w,t,n,S,I]);return(0,Y.jsxs)("div",{className:"fz-framepick",children:[(0,Y.jsx)("input",{ref:i,type:"file",accept:"video/*",hidden:!0,onChange:B=>void D(B.target.files?.[0]??null)}),l?(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)("video",{ref:s,className:"fz-video",src:l,muted:!0,playsInline:!0,preload:"auto",onLoadedData:B=>{o.current=!0,B.currentTarget.currentTime=p},onSeeked:()=>{o.current=!1}}),y.length>0&&(0,Y.jsx)("div",{className:"fz-strip",children:y.map((B,V)=>(0,Y.jsx)("img",{src:B.src,alt:"",onClick:()=>J(B.time)},V))}),d>ar&&(0,Y.jsxs)("div",{className:"fz-win",children:[(0,Y.jsx)("input",{type:"range",className:"fz-scrub",min:0,max:Math.max(yd,d-ar),step:yd,value:S,onChange:B=>{let V=Number(B.target.value);v(V);let j=nn(p,V,V+ar);m(j);let rt=s.current;rt&&(rt.pause(),o.current=!0,rt.currentTime=j)},"aria-label":"which 30 seconds to keep"}),(0,Y.jsxs)("span",{className:"fz-meta",children:["keeping ",S.toFixed(1),"s \u2013 ",I.toFixed(1),"s of"," ",d.toFixed(1),"s"]})]}),(0,Y.jsx)("input",{type:"range",className:"fz-scrub",min:S,max:Math.max(S+yd,I),step:yd,value:p,onChange:B=>q(Number(B.target.value)),"aria-label":"pick the frame"}),(0,Y.jsxs)("div",{className:"fz-row",children:[(0,Y.jsx)("button",{type:"button",className:"fz-ghost",disabled:T,onClick:()=>i.current?.click(),children:"different clip"}),(0,Y.jsx)("button",{type:"button",className:"fz-primary",disabled:w||t||f,onClick:()=>void z(),children:w?"capturing\u2026":f?"saving the clip\u2026":`freeze at ${p.toFixed(2)}s`})]})]}):(0,Y.jsxs)("div",{className:"fz-video-empty",children:[(0,Y.jsx)("p",{className:"fz-sub",children:"pick the clip \u2014 then scrub to the moment to freeze"}),(0,Y.jsx)("button",{type:"button",className:"fz-primary",disabled:T,onClick:()=>i.current?.click(),children:T?"reading the clip\u2026":"choose a video"})]}),M&&(0,Y.jsx)("p",{className:"fz-err",children:M})]})}function O0(e){let t=(0,it.useRef)(null),n=(0,it.useRef)(null);return(0,it.useEffect)(()=>{let i=t.current,s=n.current,a=s?.getContext("2d");if(!i||!s||!a)return;let r=window.matchMedia("(prefers-reduced-motion: reduce)").matches,o=6,c=["#dff5ec","#8fd4bd","#3d7a5f","#1b2f28"],l=[],h=()=>{let S=i.getBoundingClientRect();s.width=Math.max(1,Math.floor(S.width)),s.height=Math.max(1,Math.floor(S.height)),l=[];for(let v=0;v<s.width;v+=o)for(let f=0;f<s.height;f+=o){let g=Math.hypot(v-s.width/2,f-s.height/2);l.push({x:v,y:f,color:c[Math.floor(Math.random()*c.length)],max:.6+Math.random()*1.6,delay:r?0:g,counter:0,step:Math.random()*4+(s.width+s.height)*.01,phase:Math.random()*Math.PI*2,speed:.0016+Math.random()*.0028})}};h();let d=0,u=performance.now(),p=S=>{d=requestAnimationFrame(p);let v=S-u;if(!(v<1e3/60)){u=S-v%(1e3/60),a.clearRect(0,0,s.width,s.height);for(let f of l){let g;if(f.counter<=f.delay){f.counter+=f.step;continue}else r?g=f.max:g=f.max*(.55+.45*Math.sin(S*f.speed+f.phase));let y=f.max-g/2;a.fillStyle=f.color,a.fillRect(f.x+y,f.y+y,Math.max(.4,g),Math.max(.4,g))}}};d=requestAnimationFrame(p);let m=new ResizeObserver(h);return m.observe(i),()=>{m.disconnect(),cancelAnimationFrame(d)}},[]),(0,Y.jsxs)("div",{ref:t,className:"fz-dither",role:"status","aria-live":"polite",children:[(0,Y.jsx)("canvas",{ref:n,className:"fz-dither-canvas"}),(0,Y.jsxs)("div",{className:"fz-dither-label",children:[(0,Y.jsx)("b",{children:e.label}),e.sub&&(0,Y.jsx)("span",{children:e.sub})]})]})}function xd(e,t,n,i){let s=t/2,a=n*.46+(i?.tilt??0)*n*.24,r=i?.zoom??1,o=t*.36*e.distance,c=n*.11*e.distance,l=(e.azimuth+(i?.yaw??0))*Mc;return{x:s+Math.sin(l)*o*r,y:a+n*.16+(Math.cos(l)*c-Math.sin(e.elevation*Mc)*n*.3)*r,depth:Math.cos(l)}}var Ea=.95,B0=2.3;function bd(e,t){let n=e.azimuth*Mc,i=e.elevation*Mc,s=B0*e.distance;return t.set(Math.sin(n)*Math.cos(i)*s,Ea+Math.sin(i)*s,Math.cos(n)*Math.cos(i)*s),t}function S3(e){let t=new pd({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),e.appendChild(t.domElement),t.domElement.style.position="absolute",t.domElement.style.inset="0";let n=[],i=mt=>(n.push(mt),mt),s=new ql;s.fog=new Wl(725009,6.5,16);let a=new xn(54,1,.05,80),r=new L(0,1.12,0),o={yaw:.52,pitch:.19,dist:5.2},c={...o},l=()=>{let mt=Math.cos(c.pitch);a.position.set(r.x+Math.sin(c.yaw)*mt*c.dist,r.y+Math.sin(c.pitch)*c.dist,r.z+Math.cos(c.yaw)*mt*c.dist),a.lookAt(r)};l();let h=i(new oc(14,28,4612956,2372656));s.add(h);let d=i(new er({color:4482140,dashSize:.16,gapSize:.12,transparent:!0,opacity:.55})),u=[];for(let mt=0;mt<=128;mt++){let yt=mt/128*Math.PI*2;u.push(new L(Math.sin(yt)*B0,Ea,Math.cos(yt)*B0))}let p=new Yi(i(new He().setFromPoints(u)),d);p.computeLineDistances(),s.add(p);let m=i(new He().setFromPoints([new L(0,.02,0),new L(0,Ea,0)]));s.add(new Yi(m,i(new qi({color:4020818,transparent:!0,opacity:.6}))));let S=[];for(let mt=0;mt<=64;mt++){let yt=mt/64*Math.PI*2;S.push(new L(Math.sin(yt)*.55,.02,Math.cos(yt)*.55))}s.add(new Yi(i(new He().setFromPoints(S)),i(new qi({color:4020818,transparent:!0,opacity:.7}))));let v=1.9,f=v*.72,g=new je(i(new ma(v*1.07,f*1.1)),i(new vi({color:858139,side:ni})));g.position.set(0,Ea,0);let y=i(new vi({color:4874585,side:ni})),_=i(new ma(v,f)),T=new je(_,y);T.position.set(0,Ea,.001);let A=new je(_,y);A.position.set(0,Ea,-.001),A.rotation.y=Math.PI;let w=new _o(i(new tc(_)),i(new qi({color:8366235})));w.position.copy(T.position),s.add(g,T,A,w);let x=i(new vi({color:9426109})),M=null,R=i(new He),D=new Yi(R,i(new er({color:9426109,dashSize:.12,gapSize:.1,transparent:!0,opacity:.28})));D.visible=!1,s.add(D);let I=new Gi;s.add(I);let q=i(new bo(.066,16,12)),J=i(new vi({color:9426109})),z=i(new vi({color:15791604})),B=i(new vi({color:16765286,transparent:!0})),V=new Gi;V.add(new je(i(new bo(.1,18,14)),B));let j=new je(i(new $l(.062,.22,12)),B);j.rotation.x=Math.PI/2,j.position.z=.18,V.add(j),s.add(V);let rt=i(new He().setFromPoints([new L,new L(0,Ea,0)])),ct=new Yi(rt,i(new er({color:16765286,dashSize:.09,gapSize:.09,transparent:!0,opacity:.45})));ct.computeLineDistances(),s.add(ct);let lt=new L,at=new L(0,Ea,0),Nt=[],Kt=null,Ht={time:0,azimuth:0,elevation:0,distance:1},Q=()=>{B.opacity=Math.cos(Ht.azimuth*Mc-c.yaw)<-.05?.45:1},ut=()=>{let mt=e.clientWidth,yt=e.clientHeight;if(mt===0||yt===0)return;let ae=new It;t.getSize(ae),(ae.x!==mt||ae.y!==yt)&&(t.setSize(mt,yt,!1),a.aspect=mt/yt,a.updateProjectionMatrix()),t.render(s,a)},ot=new ResizeObserver(ut);ot.observe(e);let Ct=null;return{setImage(mt){if(Ct?.dispose(),mt){let yt=new bn(mt);yt.colorSpace=wn,yt.needsUpdate=!0,Ct=yt,y.map=yt,y.color.set(16777215)}else Ct=null,y.map=null,y.color.set(4874585);y.needsUpdate=!0,ut()},update(mt,yt,ae){let Gt=mt!==Nt,Zt=ae!==Kt;if(Nt=mt,Kt=ae,Gt){let Ft=[];for(let Lt=0;Lt<=96;Lt++){let jt=bd(Ec(mt,Lt/96),new L),me=Ft[Ft.length-1];me&&jt.distanceToSquared(me)<1e-8||Ft.push(jt)}if(Ft.length>=2){let Lt=new xo(Ft),jt=new ic(Lt,120,.03,8,!1),me=new je(jt,x);M&&(s.remove(M),M.geometry.dispose()),M=me,s.add(M),R.setFromPoints(Ft.map(le=>new L(le.x,.02,le.z))),R.setDrawRange(0,Ft.length),D.computeLineDistances(),D.visible=!0}else M&&(s.remove(M),M.geometry.dispose(),M=null,D.visible=!1)}(Gt||Zt)&&(I.clear(),mt.forEach((Ft,Lt)=>{let jt=new je(q,Lt===ae?z:J);jt.position.copy(bd(Ft,lt)),Lt===ae&&jt.scale.setScalar(1.3),jt.userData.index=Lt,I.add(jt)})),Ht=Ec(mt,yt),V.position.copy(bd(Ht,lt)),V.lookAt(at),Q(),rt.setFromPoints([V.position.clone(),at.clone()]),ct.computeLineDistances(),ut()},orbit(mt,yt){c.yaw-=mt*.0075,c.pitch=nn(c.pitch+yt*.006,-.15,1.35),l(),Q(),ut()},zoom(mt){c.dist=nn(c.dist/mt,3.2,10),l(),ut()},viewDirty(){return Math.abs(c.yaw-o.yaw)>.01||Math.abs(c.pitch-o.pitch)>.01||Math.abs(c.dist-o.dist)>.05},resetView(){return Math.abs(c.yaw-o.yaw)<=.01&&Math.abs(c.pitch-o.pitch)<=.01&&Math.abs(c.dist-o.dist)<=.05?!1:(Object.assign(c,o),l(),Q(),ut(),!0)},pick(mt,yt){let ae=e.clientWidth,Gt=e.clientHeight,Zt=null,Ft=30;return Nt.forEach((Lt,jt)=>{bd(Lt,lt).project(a);let me=(lt.x*.5+.5)*ae,le=(-lt.y*.5+.5)*Gt,Ie=Math.hypot(me-mt,le-yt);Ie<Ft&&(Ft=Ie,Zt=jt)}),Zt},dispose(){ot.disconnect(),Ct?.dispose(),n.forEach(mt=>mt.dispose()),M?.geometry.dispose(),t.dispose(),t.domElement.remove()}}}var Co=14;function M3(e){let t=(0,it.useRef)(null),n=(0,it.useRef)(null),[i,s]=(0,it.useState)(!1),a=(0,it.useRef)(null),r=(0,it.useRef)(new Map),o=(0,it.useRef)(e);o.current=e;let c=()=>{let l=a.current;if(!l?.snapshot)return;(l.mode==="draw"?l.travel>=Co&&l.samples.length>=2:l.mode==="edit"&&l.moved)&&o.current.onDrawRevert(l.snapshot,l.snapshotSel,{preset:l.snapshotPreset,hintSeen:l.snapshotHint})};return(0,it.useEffect)(()=>{let l=t.current;if(!l||o.current.lite)return;let h=null;try{h=S3(l)}catch{return}n.current=h;let d={reset:()=>h.resetView()?(o.current.onViewChange(!1),!0):!1};return o.current.viewCtl.current=d,o.current.onViewChange(!1),s(!0),()=>{n.current=null,o.current.viewCtl.current===d&&(o.current.viewCtl.current=null),h.dispose()}},[]),(0,it.useEffect)(()=>{n.current?.setImage(e.image)},[i,e.image]),(0,it.useEffect)(()=>{n.current?.update(e.keyframes,e.scrubT,e.selected)},[i,e.keyframes,e.scrubT,e.selected]),(0,Y.jsx)("div",{ref:t,className:"fz-stage-canvas",onPointerDown:l=>{if(!i)return;if(r.current.set(l.pointerId,{x:l.clientX,y:l.clientY}),l.currentTarget.setPointerCapture(l.pointerId),r.current.size>=2){c();let p=[...r.current.values()];a.current={mode:"view",picked:null,moved:!0,lastX:p.reduce((m,S)=>m+S.x,0)/p.length,lastY:p.reduce((m,S)=>m+S.y,0)/p.length,az:0,el:0,travel:0,samples:[],pinchD:p.length===2?Math.hypot(p[0].x-p[1].x,p[0].y-p[1].y):0,snapshot:null,snapshotSel:null,snapshotPreset:null,snapshotHint:!1};return}if(o.current.mode==="look"){a.current={mode:"view",picked:null,moved:!1,lastX:l.clientX,lastY:l.clientY,az:0,el:0,travel:0,samples:[],pinchD:0,snapshot:null,snapshotSel:null,snapshotPreset:null,snapshotHint:!1};return}let h=l.currentTarget.getBoundingClientRect(),d=n.current?.pick(l.clientX-h.left,l.clientY-h.top)??null;d!==null&&o.current.onPick(d);let u=d!==null&&(o.current.keyframes[d]?.time===0||o.current.keyframes[d]?.time===1);a.current={mode:o.current.mode==="draw"?"draw":d===null||u?"none":"edit",picked:d,moved:!1,lastX:l.clientX,lastY:l.clientY,az:0,el:0,travel:0,samples:[{azimuth:0,elevation:0}],pinchD:0,snapshot:o.current.keyframes,snapshotSel:o.current.selected,snapshotPreset:o.current.preset,snapshotHint:o.current.hintSeen}},onPointerMove:l=>{let h=a.current;if(!h||!i)return;if(r.current.has(l.pointerId)&&r.current.set(l.pointerId,{x:l.clientX,y:l.clientY}),h.mode==="view"){let p=n.current,m=[...r.current.values()];if(!p||m.length===0)return;let S=m.reduce((f,g)=>f+g.x,0)/m.length,v=m.reduce((f,g)=>f+g.y,0)/m.length;if(p.orbit(S-h.lastX,v-h.lastY),h.lastX=S,h.lastY=v,m.length===2){let f=Math.hypot(m[0].x-m[1].x,m[0].y-m[1].y);h.pinchD>0&&p.zoom(f/h.pinchD),h.pinchD=f}else h.pinchD=0;o.current.onViewChange(p.viewDirty());return}let d=l.clientX-h.lastX,u=l.clientY-h.lastY;if(!(Math.abs(d)+Math.abs(u)<.5)){if(h.lastX=l.clientX,h.lastY=l.clientY,h.moved=!0,h.mode==="edit"){o.current.onDragPose(d*.6,-u*.4,h.picked);return}h.mode!=="none"&&(h.travel+=Math.abs(d)+Math.abs(u),h.az=nn(h.az+d*.6,-360,360),h.el=nn(h.el-u*.4,-90,90),h.samples.length<600?h.samples.push({azimuth:h.az,elevation:h.el}):h.samples[h.samples.length-1]={azimuth:h.az,elevation:h.el},h.travel>=Co&&h.samples.length>=2&&(h.samples.length<4||h.samples.length%4===0)&&o.current.onDrawPath(h.samples))}},onPointerUp:l=>{r.current.delete(l.pointerId);let h=a.current;if(h?.mode==="view"){if(r.current.size===0)a.current=null;else{let d=[...r.current.values()];h.lastX=d.reduce((u,p)=>u+p.x,0)/d.length,h.lastY=d.reduce((u,p)=>u+p.y,0)/d.length,h.pinchD=d.length===2?Math.hypot(d[0].x-d[1].x,d[0].y-d[1].y):0}return}if(a.current=null,!(!h||!i)){if(!h.moved){o.current.onPick(h.picked);return}h.mode==="draw"&&h.travel>=Co&&h.samples.length>=2&&o.current.onDrawPath(h.samples,!0)}},onPointerCancel:l=>{r.current.delete(l.pointerId);let h=a.current;if(h?.mode==="view"&&r.current.size>0){let d=[...r.current.values()];h.lastX=d.reduce((u,p)=>u+p.x,0)/d.length,h.lastY=d.reduce((u,p)=>u+p.y,0)/d.length,h.pinchD=d.length===2?Math.hypot(d[0].x-d[1].x,d[0].y-d[1].y):0;return}c(),a.current=null},children:!i&&(0,Y.jsx)(E3,{...e})})}function E3(e){let t=(0,it.useRef)(null),n=(0,it.useRef)(null),i=(0,it.useRef)(new Map),s=(0,it.useRef)({yaw:0,tilt:0,zoom:1}),a=(0,it.useRef)(e);a.current=e;let r=()=>{let c=n.current;if(!c?.snapshot)return;(c.mode==="draw"?c.travel>=Co&&c.samples.length>=2:c.mode==="edit"&&c.moved)&&a.current.onDrawRevert(c.snapshot,c.snapshotSel,{preset:c.snapshotPreset,hintSeen:c.snapshotHint})},o=(0,it.useCallback)(()=>{let c=t.current,l=c?.getContext("2d");if(!c||!l)return;let h=Math.min(2,window.devicePixelRatio||1),d=c.clientWidth,u=c.clientHeight;(c.width!==d*h||c.height!==u*h)&&(c.width=d*h,c.height=u*h),l.setTransform(h,0,0,h,0,0),l.clearRect(0,0,d,u),l.strokeStyle="rgba(160,196,182,0.10)",l.lineWidth=1;let p=u*.62;for(let M=0;M<=12;M++){let R=p+Math.pow(M/12,1.6)*(u-p);l.beginPath(),l.moveTo(0,R),l.lineTo(d,R),l.stroke()}for(let M=-8;M<=8;M++)l.beginPath(),l.moveTo(d/2+M*d*.07,p),l.lineTo(d/2+M*d*.22,u),l.stroke();let m=s.current,S=d/2,v=u*.46+m.tilt*u*.24,f=d*.36*m.zoom,g=u*.11*m.zoom;l.strokeStyle="rgba(159,216,197,0.22)",l.setLineDash([4,6]),l.beginPath(),l.ellipse(S,v+u*.16,f,g,0,0,Math.PI*2),l.stroke(),l.setLineDash([]);let y=e.keyframes;if(y.length>=2){l.strokeStyle="rgba(143,212,189,0.9)",l.lineWidth=3,l.lineCap="round",l.beginPath();let M=96;for(let R=0;R<=M;R++){let D=xd(Ec(y,R/M),d,u,m);R===0?l.moveTo(D.x,D.y):l.lineTo(D.x,D.y)}l.stroke()}let _=Math.min(d*.4,u*.4*(4/3))*m.zoom,T=_*.72;if(l.save(),l.shadowColor="rgba(0,0,0,0.6)",l.shadowBlur=24,l.fillStyle="#0d181b",l.fillRect(S-_/2,v-T/2,_,T),l.restore(),e.image){let M=e.image,R=Math.min(_/M.width,T/M.height),D=M.width*R,I=M.height*R;l.drawImage(M,S-D/2,v-I/2,D,I)}else l.fillStyle="rgba(214,233,226,0.5)",l.font="13px ui-monospace, monospace",l.textAlign="center",l.fillText("no photo",S,v);l.strokeStyle="rgba(159,216,197,0.45)",l.strokeRect(S-_/2,v-T/2,_,T),y.forEach((M,R)=>{let D=xd(M,d,u,m);l.beginPath(),l.arc(D.x,D.y,R===e.selected?7:5,0,Math.PI*2),l.fillStyle=R===e.selected?"#f0f5f4":"#8fd4bd",l.fill(),R===e.selected&&(l.strokeStyle="rgba(143,212,189,0.6)",l.lineWidth=2,l.stroke())});let A=Ec(y,e.scrubT),w=xd(A,d,u,m),x=w.depth<-.05;l.globalAlpha=x?.45:1,l.beginPath(),l.arc(w.x,w.y,13,0,Math.PI*2),l.fillStyle="#ffd166",l.fill(),l.beginPath(),l.arc(w.x,w.y,5,0,Math.PI*2),l.fillStyle="#0a1120",l.fill(),l.strokeStyle="rgba(255,209,102,0.35)",l.setLineDash([3,5]),l.beginPath(),l.moveTo(w.x,w.y),l.lineTo(S,v),l.stroke(),l.setLineDash([]),l.globalAlpha=1},[e.image,e.keyframes,e.scrubT,e.selected]);return(0,it.useEffect)(()=>{let c=()=>{let h=s.current;return Math.abs(h.yaw)>.5||Math.abs(h.tilt)>.02||Math.abs(h.zoom-1)>.02},l={reset:()=>c()?(s.current={yaw:0,tilt:0,zoom:1},o(),a.current.onViewChange(!1),!0):!1};return a.current.viewCtl.current=l,a.current.onViewChange(c()),()=>{a.current.viewCtl.current===l&&(a.current.viewCtl.current=null)}},[o]),(0,it.useEffect)(()=>{o()},[o]),(0,it.useEffect)(()=>{let c=()=>o();return window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)},[o]),(0,Y.jsx)("canvas",{ref:t,className:"fz-stage-canvas",onPointerDown:c=>{if(i.current.set(c.pointerId,{x:c.clientX,y:c.clientY}),c.currentTarget.setPointerCapture(c.pointerId),i.current.size>=2){r();let m=[...i.current.values()];n.current={mode:"view",picked:null,moved:!0,lastX:m.reduce((S,v)=>S+v.x,0)/m.length,lastY:m.reduce((S,v)=>S+v.y,0)/m.length,az:0,el:0,travel:0,samples:[],pinchD:m.length===2?Math.hypot(m[0].x-m[1].x,m[0].y-m[1].y):0,snapshot:null,snapshotSel:null,snapshotPreset:null,snapshotHint:!1};return}if(e.mode==="look"){n.current={mode:"view",picked:null,moved:!1,lastX:c.clientX,lastY:c.clientY,az:0,el:0,travel:0,samples:[],pinchD:0,snapshot:null,snapshotSel:null,snapshotPreset:null,snapshotHint:!1};return}let l=c.currentTarget.getBoundingClientRect(),h=c.clientX-l.left,d=c.clientY-l.top,u=e.keyframes.findIndex(m=>{let S=xd(m,l.width,l.height,s.current);return Math.hypot(S.x-h,S.y-d)<20});u>=0&&e.onPick(u);let p=u>=0&&(e.keyframes[u]?.time===0||e.keyframes[u]?.time===1);n.current={mode:e.mode==="draw"?"draw":u<0||p?"none":"edit",picked:u>=0?u:null,moved:!1,lastX:c.clientX,lastY:c.clientY,az:0,el:0,travel:0,samples:[{azimuth:0,elevation:0}],pinchD:0,snapshot:e.keyframes,snapshotSel:e.selected,snapshotPreset:e.preset,snapshotHint:e.hintSeen}},onPointerMove:c=>{let l=n.current;if(!l)return;if(i.current.has(c.pointerId)&&i.current.set(c.pointerId,{x:c.clientX,y:c.clientY}),l.mode==="view"){let u=[...i.current.values()];if(u.length===0)return;let p=u.reduce((g,y)=>g+y.x,0)/u.length,m=u.reduce((g,y)=>g+y.y,0)/u.length,S=p-l.lastX,v=m-l.lastY,f=s.current;if(f.yaw-=S*.3,f.tilt=nn(f.tilt+v*.0035,-.5,.7),l.lastX=p,l.lastY=m,u.length===2){let g=Math.hypot(u[0].x-u[1].x,u[0].y-u[1].y);l.pinchD>0&&(f.zoom=nn(f.zoom*(g/l.pinchD),.7,2.2)),l.pinchD=g}else l.pinchD=0;o(),a.current.onViewChange(Math.abs(f.yaw)>.5||Math.abs(f.tilt)>.02||Math.abs(f.zoom-1)>.02);return}let h=c.clientX-l.lastX,d=c.clientY-l.lastY;if(!(Math.abs(h)+Math.abs(d)<.5)){if(l.lastX=c.clientX,l.lastY=c.clientY,l.moved=!0,l.mode==="edit"){e.onDragPose(h*.6,-d*.4,l.picked);return}l.mode!=="none"&&(l.travel+=Math.abs(h)+Math.abs(d),l.az=nn(l.az+h*.6,-360,360),l.el=nn(l.el-d*.4,-90,90),l.samples.length<600?l.samples.push({azimuth:l.az,elevation:l.el}):l.samples[l.samples.length-1]={azimuth:l.az,elevation:l.el},l.travel>=Co&&l.samples.length>=2&&(l.samples.length<4||l.samples.length%4===0)&&e.onDrawPath(l.samples))}},onPointerUp:c=>{i.current.delete(c.pointerId);let l=n.current;if(l?.mode==="view"){if(i.current.size===0)n.current=null;else{let h=[...i.current.values()];l.lastX=h.reduce((d,u)=>d+u.x,0)/h.length,l.lastY=h.reduce((d,u)=>d+u.y,0)/h.length,l.pinchD=h.length===2?Math.hypot(h[0].x-h[1].x,h[0].y-h[1].y):0}return}if(n.current=null,!!l){if(!l.moved){e.onPick(l.picked);return}l.mode==="draw"&&l.travel>=Co&&l.samples.length>=2&&e.onDrawPath(l.samples,!0)}},onPointerCancel:c=>{i.current.delete(c.pointerId);let l=n.current;if(l?.mode==="view"&&i.current.size>0){let h=[...i.current.values()];l.lastX=h.reduce((d,u)=>d+u.x,0)/h.length,l.lastY=h.reduce((d,u)=>d+u.y,0)/h.length,l.pinchD=h.length===2?Math.hypot(h[0].x-h[1].x,h[0].y-h[1].y):0;return}r(),n.current=null}})}function T3({kind:e}){let t={orbit:"M50 43a34 13 0 1 1 1 0l-5-4m5 4-5 3","orbit-left":"M50 43a34 13 0 1 0-1 0l5-4m-5 4 5 3",swing:"M50 43Q84 44 84 30Q82 20 67 19",rise:"M50 43Q88 43 77 18Q68 4 50 7","arc-return":"M50 43Q84 44 84 30Q82 20 67 19M67 23Q78 24 79 30Q79 39 50 39l5-4m-5 4 5 3","rise-return":"M46 43V10l-4 5m4-5 4 5M56 10v33l-4-5m4 5 4-5","arc-left-return":"M50 43Q16 44 16 30Q18 20 33 19M33 23Q22 24 21 30Q21 39 50 39l-5-4m5 4-5 3","wide-return":"M50 43C5 43 5 17 50 17C90 17 90 39 50 39l5-4m-5 4 5 3","dip-return":"M46 16v32l-4-5m4 5 4-5M56 48V16l-4 5m4-5 4 5","high-arc-return":"M50 43Q84 30 72 8M72 8Q76 30 50 39l5-5","low-arc-return":"M50 24Q16 30 28 49M28 49Q24 30 50 28l-5-4","sway-return":"M50 43Q16 43 16 30Q50 8 84 30Q84 43 50 43l5-4m-5 4 5 3",halo:"M50 43C96 43 91 5 50 5C9 5 4 43 50 43l-5-4m5 4-5 3","halo-left":"M50 43C4 43 9 5 50 5C91 5 96 43 50 43l5-4m-5 4 5 3","arc-left":"M50 43Q16 44 16 30Q18 20 33 19","low-angle":"M50 20Q85 20 78 48l-5-4m5 4 3-5"};return(0,Y.jsxs)("svg",{className:"fz-path",viewBox:"0 0 100 56","aria-hidden":"true",children:[(0,Y.jsx)("ellipse",{cx:"50",cy:"30",rx:"34",ry:"13",className:"fz-path-guide"}),(0,Y.jsx)("path",{d:"M50 13v25M43 33l7 5 7-5",className:"fz-path-axis"}),(0,Y.jsx)("circle",{cx:"50",cy:"29",r:"4",className:"fz-path-subject"}),(0,Y.jsx)("path",{className:"fz-path-motion",d:t[e]??t.orbit}),(0,Y.jsx)("circle",{cx:"50",cy:"43",r:"3",className:"fz-path-camera"})]})}function A3(e){let[t,n]=(0,it.useState)(e.initial.sourceAssetId?"camera":"source"),[i,s]=(0,it.useState)(e.initial.sourceUrl),[a,r]=(0,it.useState)(e.initial.sourceAssetId),[o,c]=(0,it.useState)(e.initial.hasClip===!0),[l,h]=(0,it.useState)(e.initial.renders),[d,u]=(0,it.useState)(e.initial.activeJob),[p,m]=(0,it.useState)(e.initial.latest),[S,v]=(0,it.useState)(!1),[f,g]=(0,it.useState)(null),[y,_]=(0,it.useState)(!1),[T,A]=(0,it.useState)(!1),[w,x]=(0,it.useState)(!1),[M,R]=(0,it.useState)(null),[D,I]=(0,it.useState)([z0,{time:.5,azimuth:65,elevation:8,distance:1},p3]),[q,J]=(0,it.useState)(0),[z,B]=(0,it.useState)(null),[V,j]=(0,it.useState)("draw"),[rt,ct]=(0,it.useState)(!1),lt=(0,it.useRef)(null),[at,Nt]=(0,it.useState)(null),[Kt,Ht]=(0,it.useState)(5),[Q,ut]=(0,it.useState)("768P"),[ot]=(0,it.useState)(()=>Math.floor(Math.random()*1e6)),Ct=(0,it.useRef)(null),[,mt]=(0,it.useState)(0),yt=(0,it.useRef)(null),ae=(0,it.useRef)(null),Gt=(0,it.useRef)(0),Zt=(0,it.useRef)(e.initial.sourceAssetId),Ft=(0,it.useRef)(null),Lt=(0,it.useRef)(null),jt=(0,it.useCallback)(N=>{let U=Lt.current;U&&U!==N&&(URL.revokeObjectURL(U),Lt.current=null),N.startsWith("blob:")&&(Lt.current=N),s(N)},[]),me=(0,it.useCallback)(()=>{Lt.current&&(URL.revokeObjectURL(Lt.current),Lt.current=null),s(null)},[]);(0,it.useEffect)(()=>()=>{Lt.current&&URL.revokeObjectURL(Lt.current)},[]);let le=(0,it.useCallback)((N,U=!1)=>{if(typeof N.latest=="number"&&m(N.latest),u(N.activeJob??null),N.line&&g(N.line),N.sourceUrl&&(U||N.sourceAssetId!==Zt.current)&&jt(N.sourceUrl),N.sourceAssetId&&(Zt.current=N.sourceAssetId,r(N.sourceAssetId)),typeof N.hasClip=="boolean"&&c(N.hasClip),N.renders&&h(N.renders),M&&!N.activeJob){let K=(M.kind==="render"?N.renders:N.sketches)?.find(Z=>Z.jobId===M.id);K&&(K.state==="delivered"||K.state==="failed")&&(R(null),K.state==="delivered"?M.kind==="render"?(g(null),n("result")):(_(!1),g("still delivered \u2014 set the camera move"),n("camera")):g(K.error??"that didn't come out \u2014 try again?"))}},[M,jt]);(0,it.useEffect)(()=>{let N=Ft.current;if(!N)return;let U=0,st=()=>{U=0;let ht=N.getBoundingClientRect().left+N.clientWidth/2;for(let pt of Array.from(N.children)){let kt=pt.getBoundingClientRect(),re=(kt.left+kt.width/2-ht)/N.clientWidth*2.4,Mn=nn(re,-1,1);pt.style.setProperty("--tilt",`${(-Mn*10).toFixed(2)}deg`),pt.style.setProperty("--pop",(1-Math.abs(Mn)*.12).toFixed(3))}},K=()=>{U||(U=requestAnimationFrame(st))};return st(),N.addEventListener("scroll",K,{passive:!0}),window.addEventListener("resize",K),()=>{N.removeEventListener("scroll",K),window.removeEventListener("resize",K),U&&cancelAnimationFrame(U)}},[t]);let Ie=(0,it.useRef)(0),ue=(0,it.useCallback)(async()=>{let N=++Ie.current,U=await rr({action:"status",after:String(p)});if(!(!U||N!==Ie.current))return le(U),U},[p,le]),Oe=(0,it.useCallback)(async N=>{for(let U=0;U<10;U++){if(Zt.current!==N)return;let st=await ue();if(Zt.current!==N)return;if(st&&st.sourceAssetId===N&&(le(st,!0),st.sourceUrl)){g(null);return}await new Promise(K=>setTimeout(K,1200))}Zt.current===N&&g("still converting \u2014 back out and re-upload if it stalls")},[ue,le]),P=(0,it.useCallback)(()=>{let N=Date.now();N-Gt.current<3e4||(Gt.current=N,ue().then(U=>{U&&le(U,!0)}))},[ue,le]),sn=(0,it.useRef)(0);(0,it.useEffect)(()=>{let N=++sn.current;if(!i){Ct.current=null,mt(st=>st+1);return}let U=new Image;U.crossOrigin="anonymous",U.onload=()=>{N===sn.current&&(Ct.current=U,mt(st=>st+1))},U.onerror=()=>{N===sn.current&&P()},U.src=i},[i,P]),(0,it.useEffect)(()=>{if(!d)return;let N=!1,U=window.setInterval(()=>{N||(N=!0,ue().finally(()=>{N=!1}))},2500);return()=>window.clearInterval(U)},[d,ue]);let ce=(N,U)=>g(N?.line??U),C=(0,it.useCallback)(async(N,U)=>{if(!N||S)return;v(!0),g("reading the photo\u2026");let K=N.type.startsWith("image/")&&!/hei[cf]/i.test(N.type)?URL.createObjectURL(N):null,Z=new FormData;Z.set("action","source"),Z.set("file",N),U&&(Z.set("clipPath",U.path),Z.set("clipSha",U.sha),Z.set("clipBytes",String(U.bytes)),Z.set("clipIn",String(U.clipIn)),Z.set("clipOut",String(U.clipOut)),Z.set("freezeAt",String(U.freezeAt)));let ht=await rr(Z);if(v(!1),!ht||ht.error||ht.sourceAssetId===void 0){K&&URL.revokeObjectURL(K),ce(ht,"that photo didn't come through \u2014 try another.");return}g(null),r(ht.sourceAssetId),typeof ht.hasClip=="boolean"&&c(ht.hasClip),_(!1),A(!1),Zt.current=ht.sourceAssetId,ht.sourceUrl?(K&&URL.revokeObjectURL(K),jt(ht.sourceUrl)):K?jt(K):(me(),g("converting the photo\u2026")),n("camera"),ue(),!ht.sourceUrl&&!K&&ht.sourceAssetId&&Oe(ht.sourceAssetId)},[S,ue,jt,me,Oe]),b=(0,it.useCallback)(async(N,U,st)=>{if(S)return;v(!0),g("generating the still \u2014 about a minute");let K=new FormData;K.set("action","source"),K.set("kind","sketch"),K.set("prompt",U),K.set("mode",st),N&&K.set("canvas",N,"sketch.png");let Z=await rr(K);if(v(!1),!Z||Z.error||!Z.jobId){ce(Z,"that didn't work \u2014 try again?");return}R({id:Z.jobId,kind:"sketch"}),le(Z),g("generating the still \u2014 about a minute")},[S,le]),H=(0,it.useCallback)(N=>{Nt(N.id),Ht(N.duration===6?6:5),I(N.trajectory.map(U=>({...U}))),B(null),J(0)},[]),X=(0,it.useCallback)(()=>{let N=nn(q,.02,.98);if(D.length>=vd||D.some(K=>Math.abs(K.time-N)<.01))return;let U=Ec(D,N),st=[...D,{...U,time:N}].sort((K,Z)=>K.time-Z.time).map(K=>({...K}));I(st),B(null),Nt(null)},[D,q]),$=(0,it.useCallback)(()=>{I(N=>{if(z===null||N.length<=2)return N;let U=N[z];return!U||U.time===0||U.time===1?N:N.filter((st,K)=>K!==z)}),B(null),Nt(null)},[z]),ft=(0,it.useCallback)((N,U,st)=>{x(!0),Nt(null),I(K=>{let Z=st??z;if(Z===null){let kt=1/0;K.forEach((re,Mn)=>{let zn=Math.abs(re.time-q);zn<kt&&(kt=zn,Z=Mn)})}if(Z===null)return K;let ht=K[Z];if(!ht||ht.time===0||ht.time===1)return K;let pt=K.map((kt,re)=>re===Z?{...kt,azimuth:nn(kt.azimuth+N,-360,360),elevation:nn(kt.elevation+U,-90,90)}:kt);return B(Z),pt})},[z,q]),gt=(0,it.useCallback)((N,U=!1)=>{if(N.length===0)return;let st=Math.min(N.length,vd-1),K=[{...z0}];for(let pt=0;pt<st-1;pt++){let kt=Math.floor(pt*(N.length-1)/Math.max(1,st-1)),re=N[Math.min(kt,N.length-1)];K.push({time:Number(((pt+1)/st).toFixed(4)),azimuth:Math.round(re.azimuth*10)/10,elevation:Math.round(re.elevation*10)/10,distance:1})}let Z=N[N.length-1];K.push({time:1,azimuth:Math.round(Z.azimuth*10)/10,elevation:Math.round(Z.elevation*10)/10,distance:1});let ht=[];for(let pt of K){let kt=ht[ht.length-1];kt&&Math.abs(pt.azimuth-kt.azimuth)<.05&&Math.abs(pt.elevation-kt.elevation)<.05?ht[ht.length-1]={...kt,time:ht.length===1?kt.time:pt.time}:ht.push(pt)}ht.length<2||(I(ht),U?(x(!0),Nt(null),B(null),J(1)):B(pt=>pt!==null&&pt>=ht.length?null:pt))},[]),tt=(0,it.useCallback)((N,U,st)=>{I(N.map(K=>({...K}))),B(typeof U=="number"&&U>=0&&U<N.length?U:null),st&&(Nt(st.preset),x(st.hintSeen))},[]),et=(0,it.useCallback)((N,U)=>{Nt(null),x(!0),I(st=>st.map((K,Z)=>Z!==N||K.time===0||K.time===1?K:{...K,...U.azimuth!==void 0?{azimuth:nn(U.azimuth,-360,360)}:{},...U.elevation!==void 0?{elevation:nn(U.elevation,-90,90)}:{}}))},[]),vt=(0,it.useCallback)(async()=>{if(S||!a||!i)return;v(!0),g("rendering the freeze \u2014 a few minutes");let N={action:"render",duration:String(Kt),resolution:Q,seed:String(ot)};at?N.preset=at:N.trajectory=JSON.stringify(D);let U=await rr(N);if(v(!1),!U||U.error||!U.jobId){ce(U,"that render didn't start \u2014 try again?");return}R({id:U.jobId,kind:"render"}),le(U),g("freezing \u2014 a few minutes")},[S,a,i,at,Q,ot,D,Kt,le]),Tt=(0,it.useCallback)(async N=>{if(S)return;v(!0),g("sending to iMessage\u2026");let U=await rr({action:"save",job:N});if(v(!1),!U||U.error){ce(U,"couldn't send it \u2014 try again");return}U.downloadUrl?(window.open(U.downloadUrl,"_blank","noopener"),g("sent the link \u2014 it's only good for a little while")):g("sent to iMessage")},[S]),_t=(0,it.useCallback)(async()=>{await rr({action:"cancel"}),R(null),g(null),await ue()},[ue]),dt=(0,it.useMemo)(()=>l.filter(N=>N.state==="delivered"&&N.outputUrl),[l]),Rt=dt[dt.length-1],At=z!==null&&z<D.length?z:null;if(At===null){let N=1/0;D.forEach((U,st)=>{if(U.time===0||U.time===1)return;let K=Math.abs(U.time-q);K<N&&(N=K,At=st)})}let Pt=At!==null?D[At]:void 0,O=!!Pt&&Pt.time!==0&&Pt.time!==1;return(0,Y.jsxs)("div",{className:"fz",children:[(0,Y.jsx)("div",{className:"fz-tabs",children:["source","camera","result"].map(N=>(0,Y.jsx)("button",{type:"button",className:t===N?"active":"",disabled:N==="camera"&&!a||N==="result"&&dt.length===0,onClick:()=>n(N),children:N==="source"?"1 \xB7 photo":N==="camera"?"2 \xB7 camera":"3 \xB7 freeze"},N))}),d&&(0,Y.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void _t(),children:"cancel the running job"}),t==="source"&&(0,Y.jsx)("div",{className:"fz-stage",children:!y&&!T?(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsxs)("div",{className:"fz-hero",children:[(0,Y.jsx)("p",{className:"fz-title",children:"freeze the scene"}),(0,Y.jsx)("p",{className:"fz-sub",children:"pick the still \u2014 the camera moves, the moment doesn\u2019t"})]}),(0,Y.jsxs)("div",{className:"fz-source-grid",children:[(0,Y.jsxs)("button",{type:"button",className:"fz-card",disabled:S,onClick:()=>ae.current?.click(),children:[(0,Y.jsx)("span",{className:"fz-card-icon",children:"\u25C9"}),"take a photo"]}),(0,Y.jsxs)("button",{type:"button",className:"fz-card",disabled:S,onClick:()=>yt.current?.click(),children:[(0,Y.jsx)("span",{className:"fz-card-icon",children:"\u25A4"}),"upload a photo"]}),(0,Y.jsxs)("button",{type:"button",className:"fz-card",disabled:S,onClick:()=>_(!0),children:[(0,Y.jsx)("span",{className:"fz-card-icon",children:"\u270E"}),"sketch + generate"]}),(0,Y.jsxs)("button",{type:"button",className:"fz-card",disabled:S,onClick:()=>A(!0),children:[(0,Y.jsx)("span",{className:"fz-card-icon",children:"\u25B6"}),"video \u2192 freeze a frame",(0,Y.jsx)("span",{className:"fz-card-sub",children:"the clip splices back around it"})]})]}),(0,Y.jsx)("input",{ref:ae,type:"file",accept:"image/*,.heic,.heif",capture:"environment",hidden:!0,onChange:N=>void C(N.target.files?.[0]??null)}),(0,Y.jsx)("input",{ref:yt,type:"file",accept:"image/*,.heic,.heif",hidden:!0,onChange:N=>void C(N.target.files?.[0]??null)}),dt.length>0&&(0,Y.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("result"),children:"see your freezes \u2192"})]}):y?(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>_(!1),children:"\u2190 back"}),M?.kind==="sketch"&&(0,Y.jsx)(O0,{label:"generating the still",sub:"the camera stage opens when it lands"}),(0,Y.jsx)(g3,{busy:S||M?.kind==="sketch",onGenerate:b})]}):(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>A(!1),children:"\u2190 back"}),(0,Y.jsx)(b3,{busy:S,onFrame:(N,U)=>void C(N,U)})]})}),t==="camera"&&(0,Y.jsxs)("div",{className:"fz-stage fz-cam",children:[(0,Y.jsxs)("div",{className:"fz-stage-wrap",children:[(0,Y.jsx)(M3,{image:Ct.current,keyframes:D,scrubT:q,selected:z,lite:e.initial.lite,mode:V,onViewChange:ct,viewCtl:lt,onDragPose:ft,onDrawPath:gt,onDrawRevert:tt,onPick:B,preset:at,hintSeen:w}),rt&&(0,Y.jsx)("button",{type:"button",className:"fz-viewreset",onClick:()=>lt.current?.reset(),children:"reset view"}),!w&&(0,Y.jsxs)("div",{className:"fz-stage-hint",children:[(0,Y.jsx)("span",{className:"fz-stage-dot"}),V==="draw"?"drag to draw the camera path":V==="look"?"drag to look \u2014 pinch to zoom":"drag a dot to move it"]})]}),(0,Y.jsxs)("div",{className:"fz-modebar",role:"group","aria-label":"stage gesture",children:[(0,Y.jsx)("span",{className:"fz-ctl-label",children:"stage"}),(0,Y.jsxs)("div",{className:"fz-seg",children:[(0,Y.jsx)("button",{type:"button",className:V==="draw"?"active":"","aria-pressed":V==="draw",onClick:()=>j("draw"),children:"draw path"}),(0,Y.jsx)("button",{type:"button",className:V==="edit"?"active":"","aria-pressed":V==="edit",onClick:()=>j("edit"),children:"move dot"}),(0,Y.jsx)("button",{type:"button",className:V==="look"?"active":"","aria-pressed":V==="look",onClick:()=>j("look"),children:"look"})]})]}),(0,Y.jsx)("div",{className:"fz-ctl-label",children:"camera move"}),(0,Y.jsx)("div",{className:"fz-prail",ref:Ft,children:e.initial.presets.map(N=>(0,Y.jsxs)("button",{type:"button",className:`fz-preset${at===N.id?" active":""}`,title:N.description,"aria-pressed":at===N.id,onClick:()=>H(N),children:[(0,Y.jsx)(T3,{kind:N.id}),(0,Y.jsx)("span",{className:"fz-preset-name",children:N.name}),(0,Y.jsx)("span",{className:"fz-preset-return",children:N.returnsToStart?"returns to start":"new angle"})]},N.id))}),(0,Y.jsxs)("div",{className:"fz-timeline",children:[(0,Y.jsxs)("div",{className:"fz-timeline-meta",children:[(0,Y.jsxs)("span",{children:[(q*Kt).toFixed(2),"s / ",Kt,"s"]}),(0,Y.jsxs)("span",{children:[D.length," keyframes",at?` \xB7 ${e.initial.presets.find(N=>N.id===at)?.name??at}`:" \xB7 drawn",z!==null&&(D[z].time===0||D[z].time===1?" \xB7 endpoint":` \xB7 kf ${z+1}`)]})]}),(0,Y.jsxs)("div",{className:"fz-track",onPointerDown:N=>{let U=N.currentTarget.getBoundingClientRect(),st=N.clientX-U.left,K=null,Z=23;D.forEach((ht,pt)=>{let kt=Math.abs(ht.time*U.width-st);kt<Z&&(Z=kt,K=pt)}),K!==null?(B(K),J(D[K].time)):J(nn(st/U.width,0,1)),N.currentTarget.setPointerCapture(N.pointerId)},onPointerMove:N=>{if(N.buttons!==1)return;let U=N.currentTarget.getBoundingClientRect();J(nn((N.clientX-U.left)/U.width,0,1))},children:[(0,Y.jsx)("div",{className:"fz-track-ticks"}),D.map((N,U)=>(0,Y.jsx)("button",{type:"button",className:`fz-kf${z===U?" selected":""}`,style:{left:`${N.time*100}%`},onClick:()=>{B(U),J(N.time)},"aria-label":`keyframe ${U+1} at ${Math.round(N.time*100)}%`},U)),(0,Y.jsx)("div",{className:"fz-head",style:{left:`${q*100}%`},children:(0,Y.jsx)("i",{})})]}),(0,Y.jsxs)("div",{className:"fz-timeline-row",children:[(0,Y.jsx)("span",{className:"fz-meta",children:z!==null?D[z].time===0||D[z].time===1?"endpoints hold the framing":"move this dot with the sliders or the scene":V==="draw"?"drag the scene to sketch the path":V==="look"?"drag to look around \u2014 pinch to zoom":"drag a dot to move it"}),(0,Y.jsxs)("div",{className:"fz-timeline-actions",children:[(0,Y.jsx)("button",{type:"button",className:"fz-ghost",disabled:D.length>=vd,onClick:X,children:"+ keyframe"}),(0,Y.jsx)("button",{type:"button",className:"fz-ghost",disabled:z===null||D[z]?.time===0||D[z]?.time===1,onClick:$,children:"\u2212 remove"})]})]})]}),(0,Y.jsxs)("div",{className:"fz-aim",children:[(0,Y.jsx)("div",{className:"fz-ctl-label",children:O?`aim \u2014 keyframe ${(At??0)+1}`:"aim \u2014 tap a middle dot on the timeline"}),(0,Y.jsxs)("div",{className:"fz-aim-row",children:[(0,Y.jsx)("span",{className:"fz-aim-label",children:"orbit"}),(0,Y.jsx)("input",{type:"range",min:-360,max:360,step:1,value:Pt?.azimuth??0,disabled:!O,"aria-label":"orbit angle in degrees",onChange:N=>{At!==null&&et(At,{azimuth:Number(N.target.value)})}}),(0,Y.jsx)("span",{className:"fz-aim-val",children:O&&Pt?`${Math.round(Pt.azimuth)}\xB0`:"\u2014"})]}),(0,Y.jsxs)("div",{className:"fz-aim-row",children:[(0,Y.jsx)("span",{className:"fz-aim-label",children:"height"}),(0,Y.jsx)("input",{type:"range",min:-90,max:90,step:1,value:Pt?.elevation??0,disabled:!O,"aria-label":"camera height in degrees",onChange:N=>{At!==null&&et(At,{elevation:Number(N.target.value)})}}),(0,Y.jsx)("span",{className:"fz-aim-val",children:O&&Pt?`${Math.round(Pt.elevation)}\xB0`:"\u2014"})]})]}),M?.kind==="render"&&(0,Y.jsx)(O0,{label:o?"freezing into your clip":"freezing",sub:"a few minutes \u2014 the result tab lights up"}),o&&!M&&(0,Y.jsx)("p",{className:"fz-meta",children:"this freeze splices back into your clip"}),(0,Y.jsxs)("div",{className:"fz-render-row",children:[(0,Y.jsx)("div",{className:"fz-seg",children:[5,6].map(N=>(0,Y.jsxs)("button",{type:"button",className:Kt===N?"active":"",onClick:()=>Ht(N),children:[N,"s"]},N))}),(0,Y.jsx)("div",{className:"fz-seg",children:["480P","768P","1080P"].map(N=>(0,Y.jsx)("button",{type:"button",className:Q===N?"active":"",onClick:()=>ut(N),children:N==="480P"?"480":N==="768P"?"720":"1080"},N))}),(0,Y.jsx)("button",{type:"button",className:"fz-primary",disabled:S||!a||!i||M!==null,onClick:()=>void vt(),children:M?.kind==="render"||S?"freezing\u2026":"freeze it"})]})]}),t==="result"&&(0,Y.jsxs)("div",{className:"fz-stage",children:[Rt?(0,Y.jsxs)("div",{className:"fz-result",children:[(0,Y.jsx)("video",{className:"fz-video",src:Rt.outputUrl??void 0,controls:!0,playsInline:!0,loop:!0,autoPlay:!0,muted:!0,onError:P}),(0,Y.jsxs)("div",{className:"fz-actions",children:[(0,Y.jsx)("button",{type:"button",className:"fz-primary",disabled:S,onClick:()=>void Tt(Rt.jobId),children:"send to iMessage"}),(0,Y.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("camera"),children:"new camera move"})]})]}):d?(0,Y.jsx)(O0,{label:o?"freezing into your clip":"freezing",sub:"the camera move renders, then splices in \u2014 a few minutes"}):(0,Y.jsx)("p",{className:"fz-sub",children:"nothing rendered yet"}),dt.length>1&&(0,Y.jsx)("div",{className:"fz-history",children:dt.slice(0,-1).reverse().map(N=>(0,Y.jsxs)("div",{className:"fz-history-row",children:[(0,Y.jsx)("video",{className:"fz-thumb",src:N.outputUrl??void 0,muted:!0,playsInline:!0,preload:"metadata",onError:P}),(0,Y.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void Tt(N.jobId),children:"send"})]},N.jobId))})]}),(0,Y.jsx)("p",{className:"fz-line",children:f??""})]})}var w3=`
...
`,P0=document.getElementById("freeze-studio");if(P0){let e=null;try{e=JSON.parse(P0.dataset.payload??"")}catch{e=null}if(e){let t=document.createElement("style");t.textContent=w3,document.head.appendChild(t),(0,NM.createRoot)(P0).render((0,Y.jsx)(it.StrictMode,{children:(0,Y.jsx)(A3,{initial:e})}))}}})();
