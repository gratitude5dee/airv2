...
`)+`
`+f);let S=v+g+r,y=v+f+o,M=Qb(s,s.VERTEX_SHADER,S),A=Qb(s,s.FRAGMENT_SHADER,y);s.attachShader(b,M),s.attachShader(b,A),n.index0AttributeName!==void 0?s.bindAttribLocation(b,0,n.index0AttributeName):n.hasPositionAttribute===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function w(D){if(e.debug.checkShaderErrors){let L=s.getProgramInfoLog(b)||"",F=s.getShaderInfoLog(M)||"",q=s.getShaderInfoLog(A)||"",P=L.trim(),G=F.trim(),X=q.trim(),J=!0,tt=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(J=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(s,b,M,A);else{let at=tM(s,M,"vertex"),ot=tM(s,A,"fragment");Lt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
}`,q2=[new N(1,0,0),new N(-1,0,0),new N(0,1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1)],Y2=[new N(0,-1,0),new N(0,-1,0),new N(0,0,1),new N(0,0,-1),new N(0,-1,0),new N(0,-1,0)],lM=new De,pc=new N,v0=new N;function Z2(e,t,n){let i=new Xl,s=new Dt,a=new Dt,r=new Ue,o=new rf,l=new of,c={},h=n.maxTextureSize,p={[bs]:An,[An]:bs,[Xi]:Xi},u=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:X2,fragmentShader:W2}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let _=new on;_.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new Qe(_,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ic;let f=this.type;this.render=function(A,w,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||A.length===0)return;this.type===sb&&(Ut("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ic);let T=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),L=e.state;L.setBlending(Wi),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let F=f!==this.type;F&&w.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(P=>P.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,P=A.length;q<P;q++){let G=A[q],X=G.shadow;if(X===void 0){Ut("WebGLShadowMap:",G,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);let J=X.getFrameExtents();s.multiply(J),a.copy(X.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/J.x),s.x=a.x*J.x,X.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/J.y),s.y=a.y*J.y,X.mapSize.y=a.y));let tt=e.state.buffers.depth.getReversed();if(X.camera._reversedDepth=tt,X.map===null||F===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===_o){if(G.isPointLight){Ut("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new Jn(s.x,s.y,{format:xa,type:qi,minFilter:dn,magFilter:dn,generateMipmaps:!1}),X.map.texture.name=G.name+".shadowMap",X.map.depthTexture=new Ms(s.x,s.y,Ti),X.map.depthTexture.name=G.name+".shadowMapDepth",X.map.depthTexture.format=Hi,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=rn,X.map.depthTexture.magFilter=rn}else G.isPointLight?(X.map=new hd(s.x),X.map.depthTexture=new Jh(s.x,Ei)):(X.map=new Jn(s.x,s.y),X.map.depthTexture=new Ms(s.x,s.y,Ei)),X.map.depthTexture.name=G.name+".shadowMap",X.map.depthTexture.format=Hi,this.type===ic?(X.map.depthTexture.compareFunction=tt?od:rd,X.map.depthTexture.minFilter=dn,X.map.depthTexture.magFilter=dn):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=rn,X.map.depthTexture.magFilter=rn);X.camera.updateProjectionMatrix()}let at=X.map.isWebGLCubeRenderTarget?6:1;for(let ot=0;ot<at;ot++){if(X.map.isWebGLCubeRenderTarget)e.setRenderTarget(X.map,ot),e.clear();else{ot===0&&(e.setRenderTarget(X.map),e.clear());let vt=X.getViewport(ot);r.set(a.x*vt.x,a.y*vt.y,a.x*vt.z,a.y*vt.w),L.viewport(r)}if(G.isPointLight){let vt=X.camera,kt=X.matrix,de=G.distance||vt.far;de!==vt.far&&(vt.far=de,vt.updateProjectionMatrix()),pc.setFromMatrixPosition(G.matrixWorld),vt.position.copy(pc),v0.copy(vt.position),v0.add(q2[ot]),vt.up.copy(Y2[ot]),vt.lookAt(v0),vt.updateMatrixWorld(),kt.makeTranslation(-pc.x,-pc.y,-pc.z),lM.multiplyMatrices(vt.projectionMatrix,vt.matrixWorldInverse),X._frustum.setFromProjectionMatrix(lM,vt.coordinateSystem,vt.reversedDepth)}else X.updateMatrices(G);i=X.getFrustum(),y(w,x,X.camera,G,this.type)}X.isPointLightShadow!==!0&&this.type===_o&&v(X,x),X.needsUpdate=!1}f=this.type,g.needsUpdate=!1,e.setRenderTarget(T,R,D)};function v(A,w){let x=t.update(b);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Jn(s.x,s.y,{format:xa,type:qi})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,x,u,b,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,x,d,b,null)}function S(A,w,x,T){let R=null,D=x.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)R=D;else if(R=x.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let L=R.uuid,F=w.uuid,q=c[L];q===void 0&&(q={},c[L]=q);let P=q[F];P===void 0&&(P=R.clone(),q[F]=P,w.addEventListener("dispose",M)),R=P}if(R.visible=w.visible,R.wireframe=w.wireframe,T===_o?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:p[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let L=e.properties.get(R);L.light=x}return R}function y(A,w,x,T,R){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===_o)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,A.matrixWorld);let F=t.update(A),q=A.material;if(Array.isArray(q)){let P=F.groups;for(let G=0,X=P.length;G<X;G++){let J=P[G],tt=q[J.materialIndex];if(tt&&tt.visible){let at=S(A,tt,T,R);A.onBeforeShadow(e,A,w,x,F,at,J),e.renderBufferDirect(x,null,F,at,A,J),A.onAfterShadow(e,A,w,x,F,at,J)}}}else if(q.visible){let P=S(A,q,T,R);A.onBeforeShadow(e,A,w,x,F,P,null),e.renderBufferDirect(x,null,F,P,A,null),A.onAfterShadow(e,A,w,x,F,P,null)}}let L=A.children;for(let F=0,q=L.length;F<q;F++)y(L[F],w,x,T,R)}function M(A){A.target.removeEventListener("dispose",M);for(let x in c){let T=c[x],R=A.target.uuid;R in T&&(T[R].dispose(),delete T[R])}}}function J2(e,t){function n(){let I=!1,ut=new Ue,j=null,ft=new Ue(0,0,0,0);return{setMask:function(_t){j!==_t&&!I&&(e.colorMask(_t,_t,_t,_t),j=_t)},setLocked:function(_t){I=_t},setClear:function(_t,et,Tt,bt,Ie){Ie===!0&&(_t*=bt,et*=bt,Tt*=bt),ut.set(_t,et,Tt,bt),ft.equals(ut)===!1&&(e.clearColor(_t,et,Tt,bt),ft.copy(ut))},reset:function(){I=!1,j=null,ft.set(-1,0,0,0)}}}function i(){let I=!1,ut=!1,j=null,ft=null,_t=null;return{setReversed:function(et){if(ut!==et){let Tt=t.get("EXT_clip_control");et?Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.ZERO_TO_ONE_EXT):Tt.clipControlEXT(Tt.LOWER_LEFT_EXT,Tt.NEGATIVE_ONE_TO_ONE_EXT),ut=et;let bt=_t;_t=null,this.setClear(bt)}},getReversed:function(){return ut},setTest:function(et){et?it(e.DEPTH_TEST):At(e.DEPTH_TEST)},setMask:function(et){j!==et&&!I&&(e.depthMask(et),j=et)},setFunc:function(et){if(ut&&(et=zb[et]),ft!==et){switch(et){case Nh:e.depthFunc(e.NEVER);break;case Lh:e.depthFunc(e.ALWAYS);break;case Ih:e.depthFunc(e.LESS);break;case Ka:e.depthFunc(e.LEQUAL);break;case Oh:e.depthFunc(e.EQUAL);break;case Ph:e.depthFunc(e.GEQUAL);break;case zh:e.depthFunc(e.GREATER);break;case Bh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}ft=et}},setLocked:function(et){I=et},setClear:function(et){_t!==et&&(_t=et,ut&&(et=1-et),e.clearDepth(et))},reset:function(){I=!1,j=null,ft=null,_t=null,ut=!1}}}function s(){let I=!1,ut=null,j=null,ft=null,_t=null,et=null,Tt=null,bt=null,Ie=null;return{setTest:function(_e){I||(_e?it(e.STENCIL_TEST):At(e.STENCIL_TEST))},setMask:function(_e){ut!==_e&&!I&&(e.stencilMask(_e),ut=_e)},setFunc:function(_e,Ai,wi){(j!==_e||ft!==Ai||_t!==wi)&&(e.stencilFunc(_e,Ai,wi),j=_e,ft=Ai,_t=wi)},setOp:function(_e,Ai,wi){(et!==_e||Tt!==Ai||bt!==wi)&&(e.stencilOp(_e,Ai,wi),et=_e,Tt=Ai,bt=wi)},setLocked:function(_e){I=_e},setClear:function(_e){Ie!==_e&&(e.clearStencil(_e),Ie=_e)},reset:function(){I=!1,ut=null,j=null,ft=null,_t=null,et=null,Tt=null,bt=null,Ie=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,h={},p={},u={},d=new WeakMap,_=[],b=null,g=!1,f=null,v=null,S=null,y=null,M=null,A=null,w=null,x=new te(0,0,0),T=0,R=!1,D=null,L=null,F=null,q=null,P=null,G=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,J=0,tt=e.getParameter(e.VERSION);tt.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(tt)[1]),X=J>=1):tt.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(tt)[1]),X=J>=2);let at=null,ot={},vt=e.getParameter(e.SCISSOR_BOX),kt=e.getParameter(e.VIEWPORT),de=new Ue().fromArray(vt),Ht=new Ue().fromArray(kt);function Z(I,ut,j,ft){let _t=new Uint8Array(4),et=e.createTexture();e.bindTexture(I,et),e.texParameteri(I,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(I,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Tt=0;Tt<j;Tt++)I===e.TEXTURE_3D||I===e.TEXTURE_2D_ARRAY?e.texImage3D(ut,0,e.RGBA,1,1,ft,0,e.RGBA,e.UNSIGNED_BYTE,_t):e.texImage2D(ut+Tt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,_t);return et}let rt={};rt[e.TEXTURE_2D]=Z(e.TEXTURE_2D,e.TEXTURE_2D,1),rt[e.TEXTURE_CUBE_MAP]=Z(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),rt[e.TEXTURE_2D_ARRAY]=Z(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),rt[e.TEXTURE_3D]=Z(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),it(e.DEPTH_TEST),r.setFunc(Ka),Ne(!1),Be(Fg),it(e.CULL_FACE),Kt(Wi);function it(I){h[I]!==!0&&(e.enable(I),h[I]=!0)}function At(I){h[I]!==!1&&(e.disable(I),h[I]=!1)}function Ot(I,ut){return u[I]!==ut?(e.bindFramebuffer(I,ut),u[I]=ut,I===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=ut),I===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=ut),!0):!1}function St(I,ut){let j=_,ft=!1;if(I){j=d.get(ut),j===void 0&&(j=[],d.set(ut,j));let _t=I.textures;if(j.length!==_t.length||j[0]!==e.COLOR_ATTACHMENT0){for(let et=0,Tt=_t.length;et<Tt;et++)j[et]=e.COLOR_ATTACHMENT0+et;j.length=_t.length,ft=!0}}else j[0]!==e.BACK&&(j[0]=e.BACK,ft=!0);ft&&e.drawBuffers(j)}function Ae(I){return b!==I?(e.useProgram(I),b=I,!0):!1}let Gt={[la]:e.FUNC_ADD,[rb]:e.FUNC_SUBTRACT,[ob]:e.FUNC_REVERSE_SUBTRACT};Gt[lb]=e.MIN,Gt[cb]=e.MAX;let se={[ub]:e.ZERO,[hb]:e.ONE,[fb]:e.SRC_COLOR,[Dh]:e.SRC_ALPHA,[vb]:e.SRC_ALPHA_SATURATE,[gb]:e.DST_COLOR,[pb]:e.DST_ALPHA,[db]:e.ONE_MINUS_SRC_COLOR,[Uh]:e.ONE_MINUS_SRC_ALPHA,[_b]:e.ONE_MINUS_DST_COLOR,[mb]:e.ONE_MINUS_DST_ALPHA,[yb]:e.CONSTANT_COLOR,[xb]:e.ONE_MINUS_CONSTANT_COLOR,[Sb]:e.CONSTANT_ALPHA,[bb]:e.ONE_MINUS_CONSTANT_ALPHA};function Kt(I,ut,j,ft,_t,et,Tt,bt,Ie,_e){if(I===Wi){g===!0&&(At(e.BLEND),g=!1);return}if(g===!1&&(it(e.BLEND),g=!0),I!==ab){if(I!==f||_e!==R){if((v!==la||M!==la)&&(e.blendEquation(e.FUNC_ADD),v=la,M=la),_e)switch(I){case Ja:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Vg:e.blendFunc(e.ONE,e.ONE);break;case Hg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Gg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Lt("WebGLState: Invalid blending: ",I);break}else switch(I){case Ja:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Vg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Hg:Lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Gg:Lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Lt("WebGLState: Invalid blending: ",I);break}S=null,y=null,A=null,w=null,x.set(0,0,0),T=0,f=I,R=_e}return}_t=_t||ut,et=et||j,Tt=Tt||ft,(ut!==v||_t!==M)&&(e.blendEquationSeparate(Gt[ut],Gt[_t]),v=ut,M=_t),(j!==S||ft!==y||et!==A||Tt!==w)&&(e.blendFuncSeparate(se[j],se[ft],se[et],se[Tt]),S=j,y=ft,A=et,w=Tt),(bt.equals(x)===!1||Ie!==T)&&(e.blendColor(bt.r,bt.g,bt.b,Ie),x.copy(bt),T=Ie),f=I,R=!1}function qt(I,ut){I.side===Xi?At(e.CULL_FACE):it(e.CULL_FACE);let j=I.side===An;ut&&(j=!j),Ne(j),I.blending===Ja&&I.transparent===!1?Kt(Wi):Kt(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),r.setFunc(I.depthFunc),r.setTest(I.depthTest),r.setMask(I.depthWrite),a.setMask(I.colorWrite);let ft=I.stencilWrite;o.setTest(ft),ft&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Je(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?it(e.SAMPLE_ALPHA_TO_COVERAGE):At(e.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(I){D!==I&&(I?e.frontFace(e.CW):e.frontFace(e.CCW),D=I)}function Be(I){I!==nb?(it(e.CULL_FACE),I!==L&&(I===Fg?e.cullFace(e.BACK):I===ib?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):At(e.CULL_FACE),L=I}function ke(I){I!==F&&(X&&e.lineWidth(I),F=I)}function Je(I,ut,j){I?(it(e.POLYGON_OFFSET_FILL),(q!==ut||P!==j)&&(q=ut,P=j,r.getReversed()&&(ut=-ut),e.polygonOffset(ut,j))):At(e.POLYGON_OFFSET_FILL)}function we(I){I?it(e.SCISSOR_TEST):At(e.SCISSOR_TEST)}function Le(I){I===void 0&&(I=e.TEXTURE0+G-1),at!==I&&(e.activeTexture(I),at=I)}function O(I,ut,j){j===void 0&&(at===null?j=e.TEXTURE0+G-1:j=at);let ft=ot[j];ft===void 0&&(ft={type:void 0,texture:void 0},ot[j]=ft),(ft.type!==I||ft.texture!==ut)&&(at!==j&&(e.activeTexture(j),at=j),e.bindTexture(I,ut||rt[I]),ft.type=I,ft.texture=ut)}function pn(){let I=ot[at];I!==void 0&&I.type!==void 0&&(e.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function jt(){try{e.compressedTexImage2D(...arguments)}catch(I){Lt("WebGLState:",I)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(I){Lt("WebGLState:",I)}}function m(){try{e.texSubImage2D(...arguments)}catch(I){Lt("WebGLState:",I)}}function U(){try{e.texSubImage3D(...arguments)}catch(I){Lt("WebGLState:",I)}}function z(){try{e.compressedTexSubImage2D(...arguments)}catch(I){Lt("WebGLState:",I)}}function V(){try{e.compressedTexSubImage3D(...arguments)}catch(I){Lt("WebGLState:",I)}}function Q(){try{e.texStorage2D(...arguments)}catch(I){Lt("WebGLState:",I)}}function lt(){try{e.texStorage3D(...arguments)}catch(I){Lt("WebGLState:",I)}}function Y(){try{e.texImage2D(...arguments)}catch(I){Lt("WebGLState:",I)}}function K(){try{e.texImage3D(...arguments)}catch(I){Lt("WebGLState:",I)}}function ct(I){return p[I]!==void 0?p[I]:e.getParameter(I)}function Mt(I,ut){p[I]!==ut&&(e.pixelStorei(I,ut),p[I]=ut)}function dt(I){de.equals(I)===!1&&(e.scissor(I.x,I.y,I.z,I.w),de.copy(I))}function ht(I){Ht.equals(I)===!1&&(e.viewport(I.x,I.y,I.z,I.w),Ht.copy(I))}function Rt(I,ut){let j=c.get(ut);j===void 0&&(j=new WeakMap,c.set(ut,j));let ft=j.get(I);ft===void 0&&(ft=e.getUniformBlockIndex(ut,I.name),j.set(I,ft))}function Nt(I,ut){let ft=c.get(ut).get(I);l.get(ut)!==ft&&(e.uniformBlockBinding(ut,ft,I.__bindingPointIndex),l.set(ut,ft))}function Bt(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},at=null,ot={},u={},d=new WeakMap,_=[],b=null,g=!1,f=null,v=null,S=null,y=null,M=null,A=null,w=null,x=new te(0,0,0),T=0,R=!1,D=null,L=null,F=null,q=null,P=null,de.set(0,0,e.canvas.width,e.canvas.height),Ht.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:it,disable:At,bindFramebuffer:Ot,drawBuffers:St,useProgram:Ae,setBlending:Kt,setMaterial:qt,setFlipSided:Ne,setCullFace:Be,setLineWidth:ke,setPolygonOffset:Je,setScissorTest:we,activeTexture:Le,bindTexture:O,unbindTexture:pn,compressedTexImage2D:jt,compressedTexImage3D:C,texImage2D:Y,texImage3D:K,pixelStorei:Mt,getParameter:ct,updateUBOMapping:Rt,uniformBlockBinding:Nt,texStorage2D:Q,texStorage3D:lt,texSubImage2D:m,texSubImage3D:U,compressedTexSubImage2D:z,compressedTexSubImage3D:V,scissor:dt,viewport:ht,reset:Bt}}function K2(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Dt,h=new WeakMap,p=new Set,u,d=new WeakMap,_=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(C,m){return _?new OffscreenCanvas(C,m):zl("canvas")}function g(C,m,U){let z=1,V=jt(C);if((V.width>U||V.height>U)&&(z=U/Math.max(V.width,V.height)),z<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){let Q=Math.floor(z*V.width),lt=Math.floor(z*V.height);u===void 0&&(u=b(Q,lt));let Y=m?b(Q,lt):u;return Y.width=Q,Y.height=lt,Y.getContext("2d").drawImage(C,0,0,Q,lt),Ut("WebGLRenderer: Texture has been resized from ("+V.width+"x"+V.height+") to ("+Q+"x"+lt+")."),Y}else return"data"in C&&Ut("WebGLRenderer: Image in DataTexture is too big ("+V.width+"x"+V.height+")."),C;return C}function f(C){return C.generateMipmaps}function v(C){e.generateMipmap(C)}function S(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function y(C,m,U,z,V,Q=!1){if(C!==null){if(e[C]!==void 0)return e[C];Ut("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let lt;z&&(lt=t.get("EXT_texture_norm16"),lt||Ut("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=m;if(m===e.RED&&(U===e.FLOAT&&(Y=e.R32F),U===e.HALF_FLOAT&&(Y=e.R16F),U===e.UNSIGNED_BYTE&&(Y=e.R8),U===e.UNSIGNED_SHORT&&lt&&(Y=lt.R16_EXT),U===e.SHORT&&lt&&(Y=lt.R16_SNORM_EXT)),m===e.RED_INTEGER&&(U===e.UNSIGNED_BYTE&&(Y=e.R8UI),U===e.UNSIGNED_SHORT&&(Y=e.R16UI),U===e.UNSIGNED_INT&&(Y=e.R32UI),U===e.BYTE&&(Y=e.R8I),U===e.SHORT&&(Y=e.R16I),U===e.INT&&(Y=e.R32I)),m===e.RG&&(U===e.FLOAT&&(Y=e.RG32F),U===e.HALF_FLOAT&&(Y=e.RG16F),U===e.UNSIGNED_BYTE&&(Y=e.RG8),U===e.UNSIGNED_SHORT&&lt&&(Y=lt.RG16_EXT),U===e.SHORT&&lt&&(Y=lt.RG16_SNORM_EXT)),m===e.RG_INTEGER&&(U===e.UNSIGNED_BYTE&&(Y=e.RG8UI),U===e.UNSIGNED_SHORT&&(Y=e.RG16UI),U===e.UNSIGNED_INT&&(Y=e.RG32UI),U===e.BYTE&&(Y=e.RG8I),U===e.SHORT&&(Y=e.RG16I),U===e.INT&&(Y=e.RG32I)),m===e.RGB_INTEGER&&(U===e.UNSIGNED_BYTE&&(Y=e.RGB8UI),U===e.UNSIGNED_SHORT&&(Y=e.RGB16UI),U===e.UNSIGNED_INT&&(Y=e.RGB32UI),U===e.BYTE&&(Y=e.RGB8I),U===e.SHORT&&(Y=e.RGB16I),U===e.INT&&(Y=e.RGB32I)),m===e.RGBA_INTEGER&&(U===e.UNSIGNED_BYTE&&(Y=e.RGBA8UI),U===e.UNSIGNED_SHORT&&(Y=e.RGBA16UI),U===e.UNSIGNED_INT&&(Y=e.RGBA32UI),U===e.BYTE&&(Y=e.RGBA8I),U===e.SHORT&&(Y=e.RGBA16I),U===e.INT&&(Y=e.RGBA32I)),m===e.RGB&&(U===e.UNSIGNED_SHORT&&lt&&(Y=lt.RGB16_EXT),U===e.SHORT&&lt&&(Y=lt.RGB16_SNORM_EXT),U===e.UNSIGNED_INT_5_9_9_9_REV&&(Y=e.RGB9_E5),U===e.UNSIGNED_INT_10F_11F_11F_REV&&(Y=e.R11F_G11F_B10F)),m===e.RGBA){let K=Q?Ol:$t.getTransfer(V);U===e.FLOAT&&(Y=e.RGBA32F),U===e.HALF_FLOAT&&(Y=e.RGBA16F),U===e.UNSIGNED_BYTE&&(Y=K===oe?e.SRGB8_ALPHA8:e.RGBA8),U===e.UNSIGNED_SHORT&&lt&&(Y=lt.RGBA16_EXT),U===e.SHORT&&lt&&(Y=lt.RGBA16_SNORM_EXT),U===e.UNSIGNED_SHORT_4_4_4_4&&(Y=e.RGBA4),U===e.UNSIGNED_SHORT_5_5_5_1&&(Y=e.RGB5_A1)}return(Y===e.R16F||Y===e.R32F||Y===e.RG16F||Y===e.RG32F||Y===e.RGBA16F||Y===e.RGBA32F)&&t.get("EXT_color_buffer_float"),Y}function M(C,m){let U;return C?m===null||m===Ei||m===yo?U=e.DEPTH24_STENCIL8:m===Ti?U=e.DEPTH32F_STENCIL8:m===vo&&(U=e.DEPTH24_STENCIL8,Ut("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):m===null||m===Ei||m===yo?U=e.DEPTH_COMPONENT24:m===Ti?U=e.DEPTH_COMPONENT32F:m===vo&&(U=e.DEPTH_COMPONENT16),U}function A(C,m){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==rn&&C.minFilter!==dn?Math.log2(Math.max(m.width,m.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?m.mipmaps.length:1}function w(C){let m=C.target;m.removeEventListener("dispose",w),T(m),m.isVideoTexture&&h.delete(m),m.isHTMLTexture&&p.delete(m)}function x(C){let m=C.target;m.removeEventListener("dispose",x),D(m)}function T(C){let m=i.get(C);if(m.__webglInit===void 0)return;let U=C.source,z=d.get(U);if(z){let V=z[m.__cacheKey];V.usedTimes--,V.usedTimes===0&&R(C),Object.keys(z).length===0&&d.delete(U)}i.remove(C)}function R(C){let m=i.get(C);e.deleteTexture(m.__webglTexture);let U=C.source,z=d.get(U);delete z[m.__cacheKey],r.memory.textures--}function D(C){let m=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(m.__webglFramebuffer[z]))for(let V=0;V<m.__webglFramebuffer[z].length;V++)e.deleteFramebuffer(m.__webglFramebuffer[z][V]);else e.deleteFramebuffer(m.__webglFramebuffer[z]);m.__webglDepthbuffer&&e.deleteRenderbuffer(m.__webglDepthbuffer[z])}else{if(Array.isArray(m.__webglFramebuffer))for(let z=0;z<m.__webglFramebuffer.length;z++)e.deleteFramebuffer(m.__webglFramebuffer[z]);else e.deleteFramebuffer(m.__webglFramebuffer);if(m.__webglDepthbuffer&&e.deleteRenderbuffer(m.__webglDepthbuffer),m.__webglMultisampledFramebuffer&&e.deleteFramebuffer(m.__webglMultisampledFramebuffer),m.__webglColorRenderbuffer)for(let z=0;z<m.__webglColorRenderbuffer.length;z++)m.__webglColorRenderbuffer[z]&&e.deleteRenderbuffer(m.__webglColorRenderbuffer[z]);m.__webglDepthRenderbuffer&&e.deleteRenderbuffer(m.__webglDepthRenderbuffer)}let U=C.textures;for(let z=0,V=U.length;z<V;z++){let Q=i.get(U[z]);Q.__webglTexture&&(e.deleteTexture(Q.__webglTexture),r.memory.textures--),i.remove(U[z])}i.remove(C)}let L=0;function F(){L=0}function q(){return L}function P(C){L=C}function G(){let C=L;return C>=s.maxTextures&&Ut("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),L+=1,C}function X(C){let m=[];return m.push(C.wrapS),m.push(C.wrapT),m.push(C.wrapR||0),m.push(C.magFilter),m.push(C.minFilter),m.push(C.anisotropy),m.push(C.internalFormat),m.push(C.format),m.push(C.type),m.push(C.generateMipmaps),m.push(C.premultiplyAlpha),m.push(C.flipY),m.push(C.unpackAlignment),m.push(C.colorSpace),m.join()}function J(C,m){let U=i.get(C);if(C.isVideoTexture&&O(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&U.__version!==C.version){let z=C.image;if(z===null)Ut("WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)Ut("WebGLRenderer: Texture marked for update but image is incomplete");else{At(U,C,m);return}}else C.isExternalTexture&&(U.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,U.__webglTexture,e.TEXTURE0+m)}function tt(C,m){let U=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&U.__version!==C.version){At(U,C,m);return}else C.isExternalTexture&&(U.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,U.__webglTexture,e.TEXTURE0+m)}function at(C,m){let U=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&U.__version!==C.version){At(U,C,m);return}n.bindTexture(e.TEXTURE_3D,U.__webglTexture,e.TEXTURE0+m)}function ot(C,m){let U=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&U.__version!==C.version){Ot(U,C,m);return}n.bindTexture(e.TEXTURE_CUBE_MAP,U.__webglTexture,e.TEXTURE0+m)}let vt={[Fh]:e.REPEAT,[Fi]:e.CLAMP_TO_EDGE,[Vh]:e.MIRRORED_REPEAT},kt={[rn]:e.NEAREST,[Tb]:e.NEAREST_MIPMAP_NEAREST,[ac]:e.NEAREST_MIPMAP_LINEAR,[dn]:e.LINEAR,[Mf]:e.LINEAR_MIPMAP_NEAREST,[va]:e.LINEAR_MIPMAP_LINEAR},de={[Cb]:e.NEVER,[Lb]:e.ALWAYS,[Rb]:e.LESS,[rd]:e.LEQUAL,[Db]:e.EQUAL,[od]:e.GEQUAL,[Ub]:e.GREATER,[Nb]:e.NOTEQUAL};function Ht(C,m){if(m.type===Ti&&t.has("OES_texture_float_linear")===!1&&(m.magFilter===dn||m.magFilter===Mf||m.magFilter===ac||m.magFilter===va||m.minFilter===dn||m.minFilter===Mf||m.minFilter===ac||m.minFilter===va)&&Ut("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,vt[m.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,vt[m.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,vt[m.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,kt[m.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,kt[m.minFilter]),m.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,de[m.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(m.magFilter===rn||m.minFilter!==ac&&m.minFilter!==va||m.type===Ti&&t.has("OES_texture_float_linear")===!1)return;if(m.anisotropy>1||i.get(m).__currentAnisotropy){let U=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(m.anisotropy,s.getMaxAnisotropy())),i.get(m).__currentAnisotropy=m.anisotropy}}}function Z(C,m){let U=!1;C.__webglInit===void 0&&(C.__webglInit=!0,m.addEventListener("dispose",w));let z=m.source,V=d.get(z);V===void 0&&(V={},d.set(z,V));let Q=X(m);if(Q!==C.__cacheKey){V[Q]===void 0&&(V[Q]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,U=!0),V[Q].usedTimes++;let lt=V[C.__cacheKey];lt!==void 0&&(V[C.__cacheKey].usedTimes--,lt.usedTimes===0&&R(m)),C.__cacheKey=Q,C.__webglTexture=V[Q].texture}return U}function rt(C,m,U){return Math.floor(Math.floor(C/U)/m)}function it(C,m,U,z){let Q=C.updateRanges;if(Q.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,m.width,m.height,U,z,m.data);else{Q.sort((Mt,dt)=>Mt.start-dt.start);let lt=0;for(let Mt=1;Mt<Q.length;Mt++){let dt=Q[lt],ht=Q[Mt],Rt=dt.start+dt.count,Nt=rt(ht.start,m.width,4),Bt=rt(dt.start,m.width,4);ht.start<=Rt+1&&Nt===Bt&&rt(ht.start+ht.count-1,m.width,4)===Nt?dt.count=Math.max(dt.count,ht.start+ht.count-dt.start):(++lt,Q[lt]=ht)}Q.length=lt+1;let Y=n.getParameter(e.UNPACK_ROW_LENGTH),K=n.getParameter(e.UNPACK_SKIP_PIXELS),ct=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,m.width);for(let Mt=0,dt=Q.length;Mt<dt;Mt++){let ht=Q[Mt],Rt=Math.floor(ht.start/4),Nt=Math.ceil(ht.count/4),Bt=Rt%m.width,I=Math.floor(Rt/m.width),ut=Nt,j=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,Bt),n.pixelStorei(e.UNPACK_SKIP_ROWS,I),n.texSubImage2D(e.TEXTURE_2D,0,Bt,I,ut,j,U,z,m.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,Y),n.pixelStorei(e.UNPACK_SKIP_PIXELS,K),n.pixelStorei(e.UNPACK_SKIP_ROWS,ct)}}function At(C,m,U){let z=e.TEXTURE_2D;(m.isDataArrayTexture||m.isCompressedArrayTexture)&&(z=e.TEXTURE_2D_ARRAY),m.isData3DTexture&&(z=e.TEXTURE_3D);let V=Z(C,m),Q=m.source;n.bindTexture(z,C.__webglTexture,e.TEXTURE0+U);let lt=i.get(Q);if(Q.version!==lt.__version||V===!0){if(n.activeTexture(e.TEXTURE0+U),(typeof ImageBitmap<"u"&&m.image instanceof ImageBitmap)===!1){let j=$t.getPrimaries($t.workingColorSpace),ft=m.colorSpace===Es?null:$t.getPrimaries(m.colorSpace),_t=m.colorSpace===Es||j===ft?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t)}n.pixelStorei(e.UNPACK_ALIGNMENT,m.unpackAlignment);let K=g(m.image,!1,s.maxTextureSize);K=pn(m,K);let ct=a.convert(m.format,m.colorSpace),Mt=a.convert(m.type),dt=y(m.internalFormat,ct,Mt,m.normalized,m.colorSpace,m.isVideoTexture);Ht(z,m);let ht,Rt=m.mipmaps,Nt=m.isVideoTexture!==!0,Bt=lt.__version===void 0||V===!0,I=Q.dataReady,ut=A(m,K);if(m.isDepthTexture)dt=M(m.format===ya,m.type),Bt&&(Nt?n.texStorage2D(e.TEXTURE_2D,1,dt,K.width,K.height):n.texImage2D(e.TEXTURE_2D,0,dt,K.width,K.height,0,ct,Mt,null));else if(m.isDataTexture)if(Rt.length>0){Nt&&Bt&&n.texStorage2D(e.TEXTURE_2D,ut,dt,Rt[0].width,Rt[0].height);for(let j=0,ft=Rt.length;j<ft;j++)ht=Rt[j],Nt?I&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ht.width,ht.height,ct,Mt,ht.data):n.texImage2D(e.TEXTURE_2D,j,dt,ht.width,ht.height,0,ct,Mt,ht.data);m.generateMipmaps=!1}else Nt?(Bt&&n.texStorage2D(e.TEXTURE_2D,ut,dt,K.width,K.height),I&&it(m,K,ct,Mt)):n.texImage2D(e.TEXTURE_2D,0,dt,K.width,K.height,0,ct,Mt,K.data);else if(m.isCompressedTexture)if(m.isCompressedArrayTexture){Nt&&Bt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ut,dt,Rt[0].width,Rt[0].height,K.depth);for(let j=0,ft=Rt.length;j<ft;j++)if(ht=Rt[j],m.format!==mi)if(ct!==null)if(Nt){if(I)if(m.layerUpdates.size>0){let _t=f0(ht.width,ht.height,m.format,m.type);for(let et of m.layerUpdates){let Tt=ht.data.subarray(et*_t/ht.data.BYTES_PER_ELEMENT,(et+1)*_t/ht.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,et,ht.width,ht.height,1,ct,Tt)}m.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,0,ht.width,ht.height,K.depth,ct,ht.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,j,dt,ht.width,ht.height,K.depth,0,ht.data,0,0);else Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Nt?I&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,0,ht.width,ht.height,K.depth,ct,Mt,ht.data):n.texImage3D(e.TEXTURE_2D_ARRAY,j,dt,ht.width,ht.height,K.depth,0,ct,Mt,ht.data)}else{Nt&&Bt&&n.texStorage2D(e.TEXTURE_2D,ut,dt,Rt[0].width,Rt[0].height);for(let j=0,ft=Rt.length;j<ft;j++)ht=Rt[j],m.format!==mi?ct!==null?Nt?I&&n.compressedTexSubImage2D(e.TEXTURE_2D,j,0,0,ht.width,ht.height,ct,ht.data):n.compressedTexImage2D(e.TEXTURE_2D,j,dt,ht.width,ht.height,0,ht.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Nt?I&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ht.width,ht.height,ct,Mt,ht.data):n.texImage2D(e.TEXTURE_2D,j,dt,ht.width,ht.height,0,ct,Mt,ht.data)}else if(m.isDataArrayTexture)if(Nt){if(Bt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ut,dt,K.width,K.height,K.depth),I)if(m.layerUpdates.size>0){let j=f0(K.width,K.height,m.format,m.type);for(let ft of m.layerUpdates){let _t=K.data.subarray(ft*j/K.data.BYTES_PER_ELEMENT,(ft+1)*j/K.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,ft,K.width,K.height,1,ct,Mt,_t)}m.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,ct,Mt,K.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,dt,K.width,K.height,K.depth,0,ct,Mt,K.data);else if(m.isData3DTexture)Nt?(Bt&&n.texStorage3D(e.TEXTURE_3D,ut,dt,K.width,K.height,K.depth),I&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,ct,Mt,K.data)):n.texImage3D(e.TEXTURE_3D,0,dt,K.width,K.height,K.depth,0,ct,Mt,K.data);else if(m.isFramebufferTexture){if(Bt)if(Nt)n.texStorage2D(e.TEXTURE_2D,ut,dt,K.width,K.height);else{let j=K.width,ft=K.height;for(let _t=0;_t<ut;_t++)n.texImage2D(e.TEXTURE_2D,_t,dt,j,ft,0,ct,Mt,null),j>>=1,ft>>=1}}else if(m.isHTMLTexture){if("texElementImage2D"in e){let j=e.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),K.parentNode!==j){j.appendChild(K),p.add(m),j.onpaint=ft=>{let _t=ft.changedElements;for(let et of p)_t.includes(et.image)&&(et.needsUpdate=!0)},j.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,K);else{let _t=e.RGBA,et=e.RGBA,Tt=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,_t,et,Tt,K)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(Rt.length>0){if(Nt&&Bt){let j=jt(Rt[0]);n.texStorage2D(e.TEXTURE_2D,ut,dt,j.width,j.height)}for(let j=0,ft=Rt.length;j<ft;j++)ht=Rt[j],Nt?I&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ct,Mt,ht):n.texImage2D(e.TEXTURE_2D,j,dt,ct,Mt,ht);m.generateMipmaps=!1}else if(Nt){if(Bt){let j=jt(K);n.texStorage2D(e.TEXTURE_2D,ut,dt,j.width,j.height)}I&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,ct,Mt,K)}else n.texImage2D(e.TEXTURE_2D,0,dt,ct,Mt,K);f(m)&&v(z),lt.__version=Q.version,m.onUpdate&&m.onUpdate(m)}C.__version=m.version}function Ot(C,m,U){if(m.image.length!==6)return;let z=Z(C,m),V=m.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+U);let Q=i.get(V);if(V.version!==Q.__version||z===!0){n.activeTexture(e.TEXTURE0+U);let lt=$t.getPrimaries($t.workingColorSpace),Y=m.colorSpace===Es?null:$t.getPrimaries(m.colorSpace),K=m.colorSpace===Es||lt===Y?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,m.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,m.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,m.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let ct=m.isCompressedTexture||m.image[0].isCompressedTexture,Mt=m.image[0]&&m.image[0].isDataTexture,dt=[];for(let et=0;et<6;et++)!ct&&!Mt?dt[et]=g(m.image[et],!0,s.maxCubemapSize):dt[et]=Mt?m.image[et].image:m.image[et],dt[et]=pn(m,dt[et]);let ht=dt[0],Rt=a.convert(m.format,m.colorSpace),Nt=a.convert(m.type),Bt=y(m.internalFormat,Rt,Nt,m.normalized,m.colorSpace),I=m.isVideoTexture!==!0,ut=Q.__version===void 0||z===!0,j=V.dataReady,ft=A(m,ht);Ht(e.TEXTURE_CUBE_MAP,m);let _t;if(ct){I&&ut&&n.texStorage2D(e.TEXTURE_CUBE_MAP,ft,Bt,ht.width,ht.height);for(let et=0;et<6;et++){_t=dt[et].mipmaps;for(let Tt=0;Tt<_t.length;Tt++){let bt=_t[Tt];m.format!==mi?Rt!==null?I?j&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,0,0,bt.width,bt.height,Rt,bt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,Bt,bt.width,bt.height,0,bt.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,0,0,bt.width,bt.height,Rt,Nt,bt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt,Bt,bt.width,bt.height,0,Rt,Nt,bt.data)}}}else{if(_t=m.mipmaps,I&&ut){_t.length>0&&ft++;let et=jt(dt[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,ft,Bt,et.width,et.height)}for(let et=0;et<6;et++)if(Mt){I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,dt[et].width,dt[et].height,Rt,Nt,dt[et].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Bt,dt[et].width,dt[et].height,0,Rt,Nt,dt[et].data);for(let Tt=0;Tt<_t.length;Tt++){let Ie=_t[Tt].image[et].image;I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,0,0,Ie.width,Ie.height,Rt,Nt,Ie.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,Bt,Ie.width,Ie.height,0,Rt,Nt,Ie.data)}}else{I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,Rt,Nt,dt[et]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Bt,Rt,Nt,dt[et]);for(let Tt=0;Tt<_t.length;Tt++){let bt=_t[Tt];I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,0,0,Rt,Nt,bt.image[et]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+et,Tt+1,Bt,Rt,Nt,bt.image[et])}}}f(m)&&v(e.TEXTURE_CUBE_MAP),Q.__version=V.version,m.onUpdate&&m.onUpdate(m)}C.__version=m.version}function St(C,m,U,z,V,Q){let lt=a.convert(U.format,U.colorSpace),Y=a.convert(U.type),K=y(U.internalFormat,lt,Y,U.normalized,U.colorSpace),ct=i.get(m),Mt=i.get(U);if(Mt.__renderTarget=m,!ct.__hasExternalTextures){let dt=Math.max(1,m.width>>Q),ht=Math.max(1,m.height>>Q);V===e.TEXTURE_3D||V===e.TEXTURE_2D_ARRAY?n.texImage3D(V,Q,K,dt,ht,m.depth,0,lt,Y,null):n.texImage2D(V,Q,K,dt,ht,0,lt,Y,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),Le(m)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,z,V,Mt.__webglTexture,0,we(m)):(V===e.TEXTURE_2D||V>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&V<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,z,V,Mt.__webglTexture,Q),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ae(C,m,U){if(e.bindRenderbuffer(e.RENDERBUFFER,C),m.depthBuffer){let z=m.depthTexture,V=z&&z.isDepthTexture?z.type:null,Q=M(m.stencilBuffer,V),lt=m.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Le(m)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,we(m),Q,m.width,m.height):U?e.renderbufferStorageMultisample(e.RENDERBUFFER,we(m),Q,m.width,m.height):e.renderbufferStorage(e.RENDERBUFFER,Q,m.width,m.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,lt,e.RENDERBUFFER,C)}else{let z=m.textures;for(let V=0;V<z.length;V++){let Q=z[V],lt=a.convert(Q.format,Q.colorSpace),Y=a.convert(Q.type),K=y(Q.internalFormat,lt,Y,Q.normalized,Q.colorSpace);Le(m)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,we(m),K,m.width,m.height):U?e.renderbufferStorageMultisample(e.RENDERBUFFER,we(m),K,m.width,m.height):e.renderbufferStorage(e.RENDERBUFFER,K,m.width,m.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Gt(C,m,U){let z=m.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(m.depthTexture&&m.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let V=i.get(m.depthTexture);if(V.__renderTarget=m,(!V.__webglTexture||m.depthTexture.image.width!==m.width||m.depthTexture.image.height!==m.height)&&(m.depthTexture.image.width=m.width,m.depthTexture.image.height=m.height,m.depthTexture.needsUpdate=!0),z){if(V.__webglInit===void 0&&(V.__webglInit=!0,m.depthTexture.addEventListener("dispose",w)),V.__webglTexture===void 0){V.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,V.__webglTexture),Ht(e.TEXTURE_CUBE_MAP,m.depthTexture);let ct=a.convert(m.depthTexture.format),Mt=a.convert(m.depthTexture.type),dt;m.depthTexture.format===Hi?dt=e.DEPTH_COMPONENT24:m.depthTexture.format===ya&&(dt=e.DEPTH24_STENCIL8);for(let ht=0;ht<6;ht++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,dt,m.width,m.height,0,ct,Mt,null)}}else J(m.depthTexture,0);let Q=V.__webglTexture,lt=we(m),Y=z?e.TEXTURE_CUBE_MAP_POSITIVE_X+U:e.TEXTURE_2D,K=m.depthTexture.format===ya?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(m.depthTexture.format===Hi)Le(m)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,K,Y,Q,0,lt):e.framebufferTexture2D(e.FRAMEBUFFER,K,Y,Q,0);else if(m.depthTexture.format===ya)Le(m)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,K,Y,Q,0,lt):e.framebufferTexture2D(e.FRAMEBUFFER,K,Y,Q,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function se(C){let m=i.get(C),U=C.isWebGLCubeRenderTarget===!0;if(m.__boundDepthTexture!==C.depthTexture){let z=C.depthTexture;if(m.__depthDisposeCallback&&m.__depthDisposeCallback(),z){let V=()=>{delete m.__boundDepthTexture,delete m.__depthDisposeCallback,z.removeEventListener("dispose",V)};z.addEventListener("dispose",V),m.__depthDisposeCallback=V}m.__boundDepthTexture=z}if(C.depthTexture&&!m.__autoAllocateDepthBuffer)if(U)for(let z=0;z<6;z++)Gt(m.__webglFramebuffer[z],C,z);else{let z=C.texture.mipmaps;z&&z.length>0?Gt(m.__webglFramebuffer[0],C,0):Gt(m.__webglFramebuffer,C,0)}else if(U){m.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(n.bindFramebuffer(e.FRAMEBUFFER,m.__webglFramebuffer[z]),m.__webglDepthbuffer[z]===void 0)m.__webglDepthbuffer[z]=e.createRenderbuffer(),Ae(m.__webglDepthbuffer[z],C,!1);else{let V=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,Q=m.__webglDepthbuffer[z];e.bindRenderbuffer(e.RENDERBUFFER,Q),e.framebufferRenderbuffer(e.FRAMEBUFFER,V,e.RENDERBUFFER,Q)}}else{let z=C.texture.mipmaps;if(z&&z.length>0?n.bindFramebuffer(e.FRAMEBUFFER,m.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,m.__webglFramebuffer),m.__webglDepthbuffer===void 0)m.__webglDepthbuffer=e.createRenderbuffer(),Ae(m.__webglDepthbuffer,C,!1);else{let V=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,Q=m.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,Q),e.framebufferRenderbuffer(e.FRAMEBUFFER,V,e.RENDERBUFFER,Q)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Kt(C,m,U){let z=i.get(C);m!==void 0&&St(z.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),U!==void 0&&se(C)}function qt(C){let m=C.texture,U=i.get(C),z=i.get(m);C.addEventListener("dispose",x);let V=C.textures,Q=C.isWebGLCubeRenderTarget===!0,lt=V.length>1;if(lt||(z.__webglTexture===void 0&&(z.__webglTexture=e.createTexture()),z.__version=m.version,r.memory.textures++),Q){U.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(m.mipmaps&&m.mipmaps.length>0){U.__webglFramebuffer[Y]=[];for(let K=0;K<m.mipmaps.length;K++)U.__webglFramebuffer[Y][K]=e.createFramebuffer()}else U.__webglFramebuffer[Y]=e.createFramebuffer()}else{if(m.mipmaps&&m.mipmaps.length>0){U.__webglFramebuffer=[];for(let Y=0;Y<m.mipmaps.length;Y++)U.__webglFramebuffer[Y]=e.createFramebuffer()}else U.__webglFramebuffer=e.createFramebuffer();if(lt)for(let Y=0,K=V.length;Y<K;Y++){let ct=i.get(V[Y]);ct.__webglTexture===void 0&&(ct.__webglTexture=e.createTexture(),r.memory.textures++)}if(C.samples>0&&Le(C)===!1){U.__webglMultisampledFramebuffer=e.createFramebuffer(),U.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let Y=0;Y<V.length;Y++){let K=V[Y];U.__webglColorRenderbuffer[Y]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,U.__webglColorRenderbuffer[Y]);let ct=a.convert(K.format,K.colorSpace),Mt=a.convert(K.type),dt=y(K.internalFormat,ct,Mt,K.normalized,K.colorSpace,C.isXRRenderTarget===!0),ht=we(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,ht,dt,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Y,e.RENDERBUFFER,U.__webglColorRenderbuffer[Y])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(U.__webglDepthRenderbuffer=e.createRenderbuffer(),Ae(U.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(Q){n.bindTexture(e.TEXTURE_CUBE_MAP,z.__webglTexture),Ht(e.TEXTURE_CUBE_MAP,m);for(let Y=0;Y<6;Y++)if(m.mipmaps&&m.mipmaps.length>0)for(let K=0;K<m.mipmaps.length;K++)St(U.__webglFramebuffer[Y][K],C,m,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Y,K);else St(U.__webglFramebuffer[Y],C,m,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);f(m)&&v(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(lt){for(let Y=0,K=V.length;Y<K;Y++){let ct=V[Y],Mt=i.get(ct),dt=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(dt=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(dt,Mt.__webglTexture),Ht(dt,ct),St(U.__webglFramebuffer,C,ct,e.COLOR_ATTACHMENT0+Y,dt,0),f(ct)&&v(dt)}n.unbindTexture()}else{let Y=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Y=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(Y,z.__webglTexture),Ht(Y,m),m.mipmaps&&m.mipmaps.length>0)for(let K=0;K<m.mipmaps.length;K++)St(U.__webglFramebuffer[K],C,m,e.COLOR_ATTACHMENT0,Y,K);else St(U.__webglFramebuffer,C,m,e.COLOR_ATTACHMENT0,Y,0);f(m)&&v(Y),n.unbindTexture()}C.depthBuffer&&se(C)}function Ne(C){let m=C.textures;for(let U=0,z=m.length;U<z;U++){let V=m[U];if(f(V)){let Q=S(C),lt=i.get(V).__webglTexture;n.bindTexture(Q,lt),v(Q),n.unbindTexture()}}}let Be=[],ke=[];function Je(C){if(C.samples>0){if(Le(C)===!1){let m=C.textures,U=C.width,z=C.height,V=e.COLOR_BUFFER_BIT,Q=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,lt=i.get(C),Y=m.length>1;if(Y)for(let ct=0;ct<m.length;ct++)n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,lt.__webglMultisampledFramebuffer);let K=C.texture.mipmaps;K&&K.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,lt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,lt.__webglFramebuffer);for(let ct=0;ct<m.length;ct++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(V|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(V|=e.STENCIL_BUFFER_BIT)),Y){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,lt.__webglColorRenderbuffer[ct]);let Mt=i.get(m[ct]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Mt,0)}e.blitFramebuffer(0,0,U,z,0,0,U,z,V,e.NEAREST),l===!0&&(Be.length=0,ke.length=0,Be.push(e.COLOR_ATTACHMENT0+ct),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Be.push(Q),ke.push(Q),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,ke)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Be))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),Y)for(let ct=0;ct<m.length;ct++){n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.RENDERBUFFER,lt.__webglColorRenderbuffer[ct]);let Mt=i.get(m[ct]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,lt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.TEXTURE_2D,Mt,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,lt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){let m=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[m])}}}function we(C){return Math.min(s.maxSamples,C.samples)}function Le(C){let m=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&m.__useRenderToTexture!==!1}function O(C){let m=r.render.frame;h.get(C)!==m&&(h.set(C,m),C.update())}function pn(C,m){let U=C.colorSpace,z=C.format,V=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||U!==Il&&U!==Es&&($t.getTransfer(U)===oe?(z!==mi||V!==$n)&&Ut("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Lt("WebGLTextures: Unsupported texture color space:",U)),m}function jt(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=F,this.getTextureUnits=q,this.setTextureUnits=P,this.setTexture2D=J,this.setTexture2DArray=tt,this.setTexture3D=at,this.setTextureCube=ot,this.rebindTextures=Kt,this.setupRenderTarget=qt,this.updateRenderTargetMipmap=Ne,this.updateMultisampleRenderTarget=Je,this.setupDepthRenderbuffer=se,this.setupFrameBufferTexture=St,this.useMultisampledRTT=Le,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function j2(e,t){function n(i,s=Es){let a,r=$t.getTransfer(s);if(i===$n)return e.UNSIGNED_BYTE;if(i===Tf)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Af)return e.UNSIGNED_SHORT_5_5_5_1;if(i===t0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===e0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===Qg)return e.BYTE;if(i===$g)return e.SHORT;if(i===vo)return e.UNSIGNED_SHORT;if(i===Ef)return e.INT;if(i===Ei)return e.UNSIGNED_INT;if(i===Ti)return e.FLOAT;if(i===qi)return e.HALF_FLOAT;if(i===n0)return e.ALPHA;if(i===i0)return e.RGB;if(i===mi)return e.RGBA;if(i===Hi)return e.DEPTH_COMPONENT;if(i===ya)return e.DEPTH_STENCIL;if(i===s0)return e.RED;if(i===wf)return e.RED_INTEGER;if(i===xa)return e.RG;if(i===Cf)return e.RG_INTEGER;if(i===Rf)return e.RGBA_INTEGER;if(i===rc||i===oc||i===lc||i===cc)if(r===oe)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===rc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===oc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===cc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===rc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===oc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===cc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Df||i===Uf||i===Nf||i===Lf)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Df)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Nf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===If||i===Of||i===Pf||i===zf||i===Bf||i===uc||i===Ff)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===If||i===Of)return r===oe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Pf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===zf)return a.COMPRESSED_R11_EAC;if(i===Bf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===uc)return a.COMPRESSED_RG11_EAC;if(i===Ff)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Vf||i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Vf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Hf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Gf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===kf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Xf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Wf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===qf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Yf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Zf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Jf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Kf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===jf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Qf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===$f)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===td||i===ed||i===nd)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===td)return r===oe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ed)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===nd)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===id||i===sd||i===hc||i===ad)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===id)return a.COMPRESSED_RED_RGTC1_EXT;if(i===sd)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===hc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ad)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var Q2=`
void main() {
...
}`,A0=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new ql(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new jn({vertexShader:Q2,fragmentShader:$2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new Qe(new da(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},w0=class extends Gi{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",l=1,c=null,h=null,p=null,u=null,d=null,_=null,b=typeof XRWebGLBinding<"u",g=new A0,f={},v=n.getContextAttributes(),S=null,y=null,M=[],A=[],w=new Dt,x=null,T=new yn;T.viewport=new Ue;let R=new yn;R.viewport=new Ue;let D=[T,R],L=new yf,F=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let rt=M[Z];return rt===void 0&&(rt=new uo,M[Z]=rt),rt.getTargetRaySpace()},this.getControllerGrip=function(Z){let rt=M[Z];return rt===void 0&&(rt=new uo,M[Z]=rt),rt.getGripSpace()},this.getHand=function(Z){let rt=M[Z];return rt===void 0&&(rt=new uo,M[Z]=rt),rt.getHandSpace()};function P(Z){let rt=A.indexOf(Z.inputSource);if(rt===-1)return;let it=M[rt];it!==void 0&&(it.update(Z.inputSource,Z.frame,c||r),it.dispatchEvent({type:Z.type,data:Z.inputSource}))}function G(){s.removeEventListener("select",P),s.removeEventListener("selectstart",P),s.removeEventListener("selectend",P),s.removeEventListener("squeeze",P),s.removeEventListener("squeezestart",P),s.removeEventListener("squeezeend",P),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",X);for(let Z=0;Z<M.length;Z++){let rt=A[Z];rt!==null&&(A[Z]=null,M[Z].disconnect(rt))}F=null,q=null,g.reset();for(let Z in f)delete f[Z];t.setRenderTarget(S),d=null,u=null,p=null,s=null,y=null,Ht.stop(),i.isPresenting=!1,t.setPixelRatio(x),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){a=Z,i.isPresenting===!0&&Ut("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,i.isPresenting===!0&&Ut("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(Z){c=Z},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return p===null&&b&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(Z){if(s=Z,s!==null){if(S=t.getRenderTarget(),s.addEventListener("select",P),s.addEventListener("selectstart",P),s.addEventListener("selectend",P),s.addEventListener("squeeze",P),s.addEventListener("squeezestart",P),s.addEventListener("squeezeend",P),s.addEventListener("end",G),s.addEventListener("inputsourceschange",X),v.xrCompatible!==!0&&await n.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(w),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let it=null,At=null,Ot=null;v.depth&&(Ot=v.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,it=v.stencil?ya:Hi,At=v.stencil?yo:Ei);let St={colorFormat:n.RGBA8,depthFormat:Ot,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(St),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),y=new Jn(u.textureWidth,u.textureHeight,{format:mi,type:$n,depthTexture:new Ms(u.textureWidth,u.textureHeight,At,void 0,void 0,void 0,void 0,void 0,void 0,it),stencilBuffer:v.stencil,colorSpace:t.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let it={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(s,n,it),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),y=new Jn(d.framebufferWidth,d.framebufferHeight,{format:mi,type:$n,colorSpace:t.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(o),Ht.setContext(s),Ht.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function X(Z){for(let rt=0;rt<Z.removed.length;rt++){let it=Z.removed[rt],At=A.indexOf(it);At>=0&&(A[At]=null,M[At].disconnect(it))}for(let rt=0;rt<Z.added.length;rt++){let it=Z.added[rt],At=A.indexOf(it);if(At===-1){for(let St=0;St<M.length;St++)if(St>=A.length){A.push(it),At=St;break}else if(A[St]===null){A[St]=it,At=St;break}if(At===-1)break}let Ot=M[At];Ot&&Ot.connect(it)}}let J=new N,tt=new N;function at(Z,rt,it){J.setFromMatrixPosition(rt.matrixWorld),tt.setFromMatrixPosition(it.matrixWorld);let At=J.distanceTo(tt),Ot=rt.projectionMatrix.elements,St=it.projectionMatrix.elements,Ae=Ot[14]/(Ot[10]-1),Gt=Ot[14]/(Ot[10]+1),se=(Ot[9]+1)/Ot[5],Kt=(Ot[9]-1)/Ot[5],qt=(Ot[8]-1)/Ot[0],Ne=(St[8]+1)/St[0],Be=Ae*qt,ke=Ae*Ne,Je=At/(-qt+Ne),we=Je*-qt;if(rt.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(we),Z.translateZ(Je),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Ot[10]===-1)Z.projectionMatrix.copy(rt.projectionMatrix),Z.projectionMatrixInverse.copy(rt.projectionMatrixInverse);else{let Le=Ae+Je,O=Gt+Je,pn=Be-we,jt=ke+(At-we),C=se*Gt/O*Le,m=Kt*Gt/O*Le;Z.projectionMatrix.makePerspective(pn,jt,C,m,Le,O),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function ot(Z,rt){rt===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(rt.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(s===null)return;let rt=Z.near,it=Z.far;g.texture!==null&&(g.depthNear>0&&(rt=g.depthNear),g.depthFar>0&&(it=g.depthFar)),L.near=R.near=T.near=rt,L.far=R.far=T.far=it,(F!==L.near||q!==L.far)&&(s.updateRenderState({depthNear:L.near,depthFar:L.far}),F=L.near,q=L.far),L.layers.mask=Z.layers.mask|6,T.layers.mask=L.layers.mask&-5,R.layers.mask=L.layers.mask&-3;let At=Z.parent,Ot=L.cameras;ot(L,At);for(let St=0;St<Ot.length;St++)ot(Ot[St],At);Ot.length===2?at(L,T,R):L.projectionMatrix.copy(T.projectionMatrix),vt(Z,L,At)};function vt(Z,rt,it){it===null?Z.matrix.copy(rt.matrixWorld):(Z.matrix.copy(it.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(rt.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(rt.projectionMatrix),Z.projectionMatrixInverse.copy(rt.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Gh*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(u===null&&d===null))return l},this.setFoveation=function(Z){l=Z,u!==null&&(u.fixedFoveation=Z),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=Z)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(L)},this.getCameraTexture=function(Z){return f[Z]};let kt=null;function de(Z,rt){if(h=rt.getViewerPose(c||r),_=rt,h!==null){let it=h.views;d!==null&&(t.setRenderTargetFramebuffer(y,d.framebuffer),t.setRenderTarget(y));let At=!1;it.length!==L.cameras.length&&(L.cameras.length=0,At=!0);for(let Gt=0;Gt<it.length;Gt++){let se=it[Gt],Kt=null;if(d!==null)Kt=d.getViewport(se);else{let Ne=p.getViewSubImage(u,se);Kt=Ne.viewport,Gt===0&&(t.setRenderTargetTextures(y,Ne.colorTexture,Ne.depthStencilTexture),t.setRenderTarget(y))}let qt=D[Gt];qt===void 0&&(qt=new yn,qt.layers.enable(Gt),qt.viewport=new Ue,D[Gt]=qt),qt.matrix.fromArray(se.transform.matrix),qt.matrix.decompose(qt.position,qt.quaternion,qt.scale),qt.projectionMatrix.fromArray(se.projectionMatrix),qt.projectionMatrixInverse.copy(qt.projectionMatrix).invert(),qt.viewport.set(Kt.x,Kt.y,Kt.width,Kt.height),Gt===0&&(L.matrix.copy(qt.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),At===!0&&L.cameras.push(qt)}let Ot=s.enabledFeatures;if(Ot&&Ot.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&b){p=i.getBinding();let Gt=p.getDepthInformation(it[0]);Gt&&Gt.isValid&&Gt.texture&&g.init(Gt,s.renderState)}if(Ot&&Ot.includes("camera-access")&&b){t.state.unbindTexture(),p=i.getBinding();for(let Gt=0;Gt<it.length;Gt++){let se=it[Gt].camera;if(se){let Kt=f[se];Kt||(Kt=new ql,f[se]=Kt);let qt=p.getCameraImage(se);Kt.sourceTexture=qt}}}}for(let it=0;it<M.length;it++){let At=A[it],Ot=M[it];At!==null&&Ot!==void 0&&Ot.update(At,rt,c||r)}kt&&kt(Z,rt),rt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:rt}),_=null}let Ht=new cM;Ht.setAnimationLoop(de),this.setAnimationLoop=function(Z){kt=Z},this.dispose=function(){}}},t3=new De,mM=new Pt;mM.set(-1,0,0,0,1,0,0,0,1);function e3(e,t){function n(g,f){g.matrixAutoUpdate===!0&&g.updateMatrix(),f.value.copy(g.matrix)}function i(g,f){f.color.getRGB(g.fogColor.value,c0(e)),f.isFog?(g.fogNear.value=f.near,g.fogFar.value=f.far):f.isFogExp2&&(g.fogDensity.value=f.density)}function s(g,f,v,S,y){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?a(g,f):f.isMeshLambertMaterial?(a(g,f),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(a(g,f),p(g,f)):f.isMeshPhongMaterial?(a(g,f),h(g,f),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(a(g,f),u(g,f),f.isMeshPhysicalMaterial&&d(g,f,y)):f.isMeshMatcapMaterial?(a(g,f),_(g,f)):f.isMeshDepthMaterial?a(g,f):f.isMeshDistanceMaterial?(a(g,f),b(g,f)):f.isMeshNormalMaterial?a(g,f):f.isLineBasicMaterial?(r(g,f),f.isLineDashedMaterial&&o(g,f)):f.isPointsMaterial?l(g,f,v,S):f.isSpriteMaterial?c(g,f):f.isShadowMaterial?(g.color.value.copy(f.color),g.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(g,f){g.opacity.value=f.opacity,f.color&&g.diffuse.value.copy(f.color),f.emissive&&g.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(g.map.value=f.map,n(f.map,g.mapTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.bumpMap&&(g.bumpMap.value=f.bumpMap,n(f.bumpMap,g.bumpMapTransform),g.bumpScale.value=f.bumpScale,f.side===An&&(g.bumpScale.value*=-1)),f.normalMap&&(g.normalMap.value=f.normalMap,n(f.normalMap,g.normalMapTransform),g.normalScale.value.copy(f.normalScale),f.side===An&&g.normalScale.value.negate()),f.displacementMap&&(g.displacementMap.value=f.displacementMap,n(f.displacementMap,g.displacementMapTransform),g.displacementScale.value=f.displacementScale,g.displacementBias.value=f.displacementBias),f.emissiveMap&&(g.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,g.emissiveMapTransform)),f.specularMap&&(g.specularMap.value=f.specularMap,n(f.specularMap,g.specularMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest);let v=t.get(f),S=v.envMap,y=v.envMapRotation;S&&(g.envMap.value=S,g.envMapRotation.value.setFromMatrix4(t3.makeRotationFromEuler(y)).transpose(),S.isCubeTexture&&S.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(mM),g.reflectivity.value=f.reflectivity,g.ior.value=f.ior,g.refractionRatio.value=f.refractionRatio),f.lightMap&&(g.lightMap.value=f.lightMap,g.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,g.lightMapTransform)),f.aoMap&&(g.aoMap.value=f.aoMap,g.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,g.aoMapTransform))}function r(g,f){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,f.map&&(g.map.value=f.map,n(f.map,g.mapTransform))}function o(g,f){g.dashSize.value=f.dashSize,g.totalSize.value=f.dashSize+f.gapSize,g.scale.value=f.scale}function l(g,f,v,S){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,g.size.value=f.size*v,g.scale.value=S*.5,f.map&&(g.map.value=f.map,n(f.map,g.uvTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest)}function c(g,f){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,g.rotation.value=f.rotation,f.map&&(g.map.value=f.map,n(f.map,g.mapTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest)}function h(g,f){g.specular.value.copy(f.specular),g.shininess.value=Math.max(f.shininess,1e-4)}function p(g,f){f.gradientMap&&(g.gradientMap.value=f.gradientMap)}function u(g,f){g.metalness.value=f.metalness,f.metalnessMap&&(g.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,g.metalnessMapTransform)),g.roughness.value=f.roughness,f.roughnessMap&&(g.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,g.roughnessMapTransform)),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)}function d(g,f,v){g.ior.value=f.ior,f.sheen>0&&(g.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),g.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(g.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,g.sheenColorMapTransform)),f.sheenRoughnessMap&&(g.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,g.sheenRoughnessMapTransform))),f.clearcoat>0&&(g.clearcoat.value=f.clearcoat,g.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(g.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,g.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(g.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===An&&g.clearcoatNormalScale.value.negate())),f.dispersion>0&&(g.dispersion.value=f.dispersion),f.iridescence>0&&(g.iridescence.value=f.iridescence,g.iridescenceIOR.value=f.iridescenceIOR,g.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(g.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,g.iridescenceMapTransform)),f.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),f.transmission>0&&(g.transmission.value=f.transmission,g.transmissionSamplerMap.value=v.texture,g.transmissionSamplerSize.value.set(v.width,v.height),f.transmissionMap&&(g.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,g.transmissionMapTransform)),g.thickness.value=f.thickness,f.thicknessMap&&(g.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=f.attenuationDistance,g.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(g.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(g.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=f.specularIntensity,g.specularColor.value.copy(f.specularColor),f.specularColorMap&&(g.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,g.specularColorMapTransform)),f.specularIntensityMap&&(g.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,f){f.matcap&&(g.matcap.value=f.matcap)}function b(g,f){let v=t.get(f).light;g.referencePosition.value.setFromMatrixPosition(v.matrixWorld),g.nearDistance.value=v.shadow.camera.near,g.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function n3(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,M){let A=M.program;i.uniformBlockBinding(y,A)}function c(y,M){let A=s[y.id];A===void 0&&(g(y),A=h(y),s[y.id]=A,y.addEventListener("dispose",v));let w=M.program;i.updateUBOMapping(y,w);let x=t.render.frame;a[y.id]!==x&&(u(y),a[y.id]=x)}function h(y){let M=p();y.__bindingPointIndex=M;let A=e.createBuffer(),w=y.__size,x=y.usage;return e.bindBuffer(e.UNIFORM_BUFFER,A),e.bufferData(e.UNIFORM_BUFFER,w,x),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,M,A),A}function p(){for(let y=0;y<o;y++)if(r.indexOf(y)===-1)return r.push(y),y;return Lt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(y){let M=s[y.id],A=y.uniforms,w=y.__cache;e.bindBuffer(e.UNIFORM_BUFFER,M);for(let x=0,T=A.length;x<T;x++){let R=A[x];if(Array.isArray(R))for(let D=0,L=R.length;D<L;D++)d(R[D],x,D,w);else d(R,x,0,w)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function d(y,M,A,w){if(b(y,M,A,w)===!0){let x=y.__offset,T=y.value;if(Array.isArray(T)){let R=0;for(let D=0;D<T.length;D++){let L=T[D],F=f(L);_(L,y.__data,R),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(R+=F.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(T,y.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,x,y.__data)}}function _(y,M,A){typeof y=="number"||typeof y=="boolean"?M[0]=y:y.isMatrix3?(M[0]=y.elements[0],M[1]=y.elements[1],M[2]=y.elements[2],M[3]=0,M[4]=y.elements[3],M[5]=y.elements[4],M[6]=y.elements[5],M[7]=0,M[8]=y.elements[6],M[9]=y.elements[7],M[10]=y.elements[8],M[11]=0):ArrayBuffer.isView(y)?M.set(new y.constructor(y.buffer,y.byteOffset,M.length)):y.toArray(M,A)}function b(y,M,A,w){let x=y.value,T=M+"_"+A;if(w[T]===void 0)return typeof x=="number"||typeof x=="boolean"?w[T]=x:ArrayBuffer.isView(x)?w[T]=x.slice():w[T]=x.clone(),!0;{let R=w[T];if(typeof x=="number"||typeof x=="boolean"){if(R!==x)return w[T]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(R.equals(x)===!1)return R.copy(x),!0}}return!1}function g(y){let M=y.uniforms,A=0,w=16;for(let T=0,R=M.length;T<R;T++){let D=Array.isArray(M[T])?M[T]:[M[T]];for(let L=0,F=D.length;L<F;L++){let q=D[L],P=Array.isArray(q.value)?q.value:[q.value];for(let G=0,X=P.length;G<X;G++){let J=P[G],tt=f(J),at=A%w,ot=at%tt.boundary,vt=at+ot;A+=ot,vt!==0&&w-vt<tt.storage&&(A+=w-vt),q.__data=new Float32Array(tt.storage/Float32Array.BYTES_PER_ELEMENT),q.__offset=A,A+=tt.storage}}}let x=A%w;return x>0&&(A+=w-x),y.__size=A,y.__cache={},this}function f(y){let M={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(M.boundary=4,M.storage=4):y.isVector2?(M.boundary=8,M.storage=8):y.isVector3||y.isColor?(M.boundary=16,M.storage=12):y.isVector4?(M.boundary=16,M.storage=16):y.isMatrix3?(M.boundary=48,M.storage=48):y.isMatrix4?(M.boundary=64,M.storage=64):y.isTexture?Ut("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(M.boundary=16,M.storage=y.byteLength):Ut("WebGLRenderer: Unsupported uniform value type.",y),M}function v(y){let M=y.target;M.removeEventListener("dispose",v);let A=r.indexOf(M.__bindingPointIndex);r.splice(A,1),e.deleteBuffer(s[M.id]),delete s[M.id],delete a[M.id]}function S(){for(let y in s)e.deleteBuffer(s[y]);r=[],s={},a={}}return{bind:l,update:c,dispose:S}}var i3=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Yi=null;function s3(){return Yi===null&&(Yi=new qh(i3,16,16,xa,qi),Yi.name="DFG_LUT",Yi.minFilter=dn,Yi.magFilter=dn,Yi.wrapS=Fi,Yi.wrapT=Fi,Yi.generateMipmaps=!1,Yi.needsUpdate=!0),Yi}var fd=class{constructor(t={}){let{canvas:n=Ib(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:d=$n}=t;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=r;let b=d,g=new Set([Rf,Cf,wf]),f=new Set([$n,Ei,vo,yo,Tf,Af]),v=new Uint32Array(4),S=new Int32Array(4),y=new N,M=null,A=null,w=[],x=[],T=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Mi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,D=!1,L=null,F=null,q=null,P=null;this._outputColorSpace=Tn;let G=0,X=0,J=null,tt=-1,at=null,ot=new Ue,vt=new Ue,kt=null,de=new te(0),Ht=0,Z=n.width,rt=n.height,it=1,At=null,Ot=null,St=new Ue(0,0,Z,rt),Ae=new Ue(0,0,Z,rt),Gt=!1,se=new Xl,Kt=!1,qt=!1,Ne=new De,Be=new N,ke=new Ue,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},we=!1;function Le(){return J===null?it:1}let O=i;function pn(E,B){return n.getContext(E,B)}try{let E={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${xf}`),n.addEventListener("webglcontextlost",Ie,!1),n.addEventListener("webglcontextrestored",_e,!1),n.addEventListener("webglcontextcreationerror",Ai,!1),O===null){let B="webgl2";if(O=pn(B,E),O===null)throw pn(B)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(E){throw Lt("WebGLRenderer: "+E.message),E}let jt,C,m,U,z,V,Q,lt,Y,K,ct,Mt,dt,ht,Rt,Nt,Bt,I,ut,j,ft,_t,et;function Tt(){jt=new hR(O),jt.init(),ft=new j2(O,jt),C=new iR(O,jt,t,ft),m=new J2(O,jt),C.reversedDepthBuffer&&u&&m.buffers.depth.setReversed(!0),F=O.createFramebuffer(),q=O.createFramebuffer(),P=O.createFramebuffer(),U=new pR(O),z=new O2,V=new K2(O,jt,m,z,C,ft,U),Q=new uR(R),lt=new vA(O),_t=new eR(O,lt),Y=new fR(O,lt,U,_t),K=new gR(O,Y,lt,_t,U),I=new mR(O,C,V),Rt=new sR(z),ct=new I2(R,Q,jt,C,_t,Rt),Mt=new e3(R,z),dt=new z2,ht=new k2(jt),Bt=new tR(R,Q,m,K,_,l),Nt=new Z2(R,K,C),et=new n3(O,U,C,m),ut=new nR(O,jt,U),j=new dR(O,jt,U),U.programs=ct.programs,R.capabilities=C,R.extensions=jt,R.properties=z,R.renderLists=dt,R.shadowMap=Nt,R.state=m,R.info=U}Tt(),b!==$n&&(T=new vR(b,n.width,n.height,o,s,a));let bt=new w0(R,O);this.xr=bt,this.getContext=function(){return O},this.getContextAttributes=function(){return O.getContextAttributes()},this.forceContextLoss=function(){let E=jt.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){let E=jt.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return it},this.setPixelRatio=function(E){E!==void 0&&(it=E,this.setSize(Z,rt,!1))},this.getSize=function(E){return E.set(Z,rt)},this.setSize=function(E,B,W=!0){if(bt.isPresenting){Ut("WebGLRenderer: Can't change size while VR device is presenting.");return}Z=E,rt=B,n.width=Math.floor(E*it),n.height=Math.floor(B*it),W===!0&&(n.style.width=E+"px",n.style.height=B+"px"),T!==null&&T.setSize(n.width,n.height),this.setViewport(0,0,E,B)},this.getDrawingBufferSize=function(E){return E.set(Z*it,rt*it).floor()},this.setDrawingBufferSize=function(E,B,W){Z=E,rt=B,it=W,n.width=Math.floor(E*W),n.height=Math.floor(B*W),this.setViewport(0,0,E,B)},this.setEffects=function(E){if(b===$n){Lt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let B=0;B<E.length;B++)if(E[B].isOutputPass===!0){Ut("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(ot)},this.getViewport=function(E){return E.copy(St)},this.setViewport=function(E,B,W,H){E.isVector4?St.set(E.x,E.y,E.z,E.w):St.set(E,B,W,H),m.viewport(ot.copy(St).multiplyScalar(it).round())},this.getScissor=function(E){return E.copy(Ae)},this.setScissor=function(E,B,W,H){E.isVector4?Ae.set(E.x,E.y,E.z,E.w):Ae.set(E,B,W,H),m.scissor(vt.copy(Ae).multiplyScalar(it).round())},this.getScissorTest=function(){return Gt},this.setScissorTest=function(E){m.setScissorTest(Gt=E)},this.setOpaqueSort=function(E){At=E},this.setTransparentSort=function(E){Ot=E},this.getClearColor=function(E){return E.copy(Bt.getClearColor())},this.setClearColor=function(){Bt.setClearColor(...arguments)},this.getClearAlpha=function(){return Bt.getClearAlpha()},this.setClearAlpha=function(){Bt.setClearAlpha(...arguments)},this.clear=function(E=!0,B=!0,W=!0){let H=0;if(E){let k=!1;if(J!==null){let gt=J.texture.format;k=g.has(gt)}if(k){let gt=J.texture.type,xt=f.has(gt),mt=Bt.getClearColor(),Et=Bt.getClearAlpha(),wt=mt.r,Ft=mt.g,Wt=mt.b;xt?(v[0]=wt,v[1]=Ft,v[2]=Wt,v[3]=Et,O.clearBufferuiv(O.COLOR,0,v)):(S[0]=wt,S[1]=Ft,S[2]=Wt,S[3]=Et,O.clearBufferiv(O.COLOR,0,S))}else H|=O.COLOR_BUFFER_BIT}B&&(H|=O.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),W&&(H|=O.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&O.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),L=E},this.dispose=function(){n.removeEventListener("webglcontextlost",Ie,!1),n.removeEventListener("webglcontextrestored",_e,!1),n.removeEventListener("webglcontextcreationerror",Ai,!1),Bt.dispose(),dt.dispose(),ht.dispose(),z.dispose(),Q.dispose(),K.dispose(),_t.dispose(),et.dispose(),ct.dispose(),bt.dispose(),bt.removeEventListener("sessionstart",N0),bt.removeEventListener("sessionend",L0),ba.stop()};function Ie(E){E.preventDefault(),o0("WebGLRenderer: Context Lost."),D=!0}function _e(){o0("WebGLRenderer: Context Restored."),D=!1;let E=U.autoReset,B=Nt.enabled,W=Nt.autoUpdate,H=Nt.needsUpdate,k=Nt.type;Tt(),U.autoReset=E,Nt.enabled=B,Nt.autoUpdate=W,Nt.needsUpdate=H,Nt.type=k}function Ai(E){Lt("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function wi(E){let B=E.target;B.removeEventListener("dispose",wi),wM(B)}function wM(E){CM(E),z.remove(E)}function CM(E){let B=z.get(E).programs;B!==void 0&&(B.forEach(function(W){ct.releaseProgram(W)}),E.isShaderMaterial&&ct.releaseShaderCache(E))}this.renderBufferDirect=function(E,B,W,H,k,gt){B===null&&(B=Je);let xt=k.isMesh&&k.matrixWorld.determinantAffine()<0,mt=UM(E,B,W,H,k);m.setMaterial(H,xt);let Et=W.index,wt=1;if(H.wireframe===!0){if(Et=Y.getWireframeAttribute(W),Et===void 0)return;wt=2}let Ft=W.drawRange,Wt=W.attributes.position,Ct=Ft.start*wt,ue=(Ft.start+Ft.count)*wt;gt!==null&&(Ct=Math.max(Ct,gt.start*wt),ue=Math.min(ue,(gt.start+gt.count)*wt)),Et!==null?(Ct=Math.max(Ct,0),ue=Math.min(ue,Et.count)):Wt!=null&&(Ct=Math.max(Ct,0),ue=Math.min(ue,Wt.count));let Fe=ue-Ct;if(Fe<0||Fe===1/0)return;_t.setup(k,H,mt,W,Et);let Oe,pe=ut;if(Et!==null&&(Oe=lt.get(Et),pe=j,pe.setIndex(Oe)),k.isMesh)H.wireframe===!0?(m.setLineWidth(H.wireframeLinewidth*Le()),pe.setMode(O.LINES)):pe.setMode(O.TRIANGLES);else if(k.isLine){let mn=H.linewidth;mn===void 0&&(mn=1),m.setLineWidth(mn*Le()),k.isLineSegments?pe.setMode(O.LINES):k.isLineLoop?pe.setMode(O.LINE_LOOP):pe.setMode(O.LINE_STRIP)}else k.isPoints?pe.setMode(O.POINTS):k.isSprite&&pe.setMode(O.TRIANGLES);if(k.isBatchedMesh)if(jt.get("WEBGL_multi_draw"))pe.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{let mn=k._multiDrawStarts,yt=k._multiDrawCounts,On=k._multiDrawCount,ie=Et?lt.get(Et).bytesPerElement:1,ti=z.get(H).currentProgram.getUniforms();for(let Ci=0;Ci<On;Ci++)ti.setValue(O,"_gl_DrawID",Ci),pe.render(mn[Ci]/ie,yt[Ci])}else if(k.isInstancedMesh)pe.renderInstances(Ct,Fe,k.count);else if(W.isInstancedBufferGeometry){let mn=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,yt=Math.min(W.instanceCount,mn);pe.renderInstances(Ct,Fe,yt)}else pe.render(Ct,Fe)};function U0(E,B,W){E.transparent===!0&&E.side===Xi&&E.forceSinglePass===!1?(E.side=An,E.needsUpdate=!0,Ec(E,B,W),E.side=bs,E.needsUpdate=!0,Ec(E,B,W),E.side=Xi):Ec(E,B,W)}this.compile=function(E,B,W=null){W===null&&(W=E),A=ht.get(W),A.init(B),x.push(A),W.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(A.pushLight(k),k.castShadow&&A.pushShadow(k))}),E!==W&&E.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(A.pushLight(k),k.castShadow&&A.pushShadow(k))}),A.setupLights();let H=new Set;return E.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;let gt=k.material;if(gt)if(Array.isArray(gt))for(let xt=0;xt<gt.length;xt++){let mt=gt[xt];U0(mt,W,k),H.add(mt)}else U0(gt,W,k),H.add(gt)}),A=x.pop(),H},this.compileAsync=function(E,B,W=null){let H=this.compile(E,B,W);return new Promise(k=>{function gt(){if(H.forEach(function(xt){z.get(xt).currentProgram.isReady()&&H.delete(xt)}),H.size===0){k(E);return}setTimeout(gt,10)}jt.get("KHR_parallel_shader_compile")!==null?gt():setTimeout(gt,10)})};let _d=null;function RM(E){_d&&_d(E)}function N0(){ba.stop()}function L0(){ba.start()}let ba=new cM;ba.setAnimationLoop(RM),typeof self<"u"&&ba.setContext(self),this.setAnimationLoop=function(E){_d=E,bt.setAnimationLoop(E),E===null?ba.stop():ba.start()},bt.addEventListener("sessionstart",N0),bt.addEventListener("sessionend",L0),this.render=function(E,B){if(B!==void 0&&B.isCamera!==!0){Lt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;L!==null&&L.renderStart(E,B);let W=bt.enabled===!0&&bt.isPresenting===!0,H=T!==null&&(J===null||W)&&T.begin(R,J);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),bt.enabled===!0&&bt.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(bt.cameraAutoUpdate===!0&&bt.updateCamera(B),B=bt.getCamera()),E.isScene===!0&&E.onBeforeRender(R,E,B,J),A=ht.get(E,x.length),A.init(B),A.state.textureUnits=V.getTextureUnits(),x.push(A),Ne.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),se.setFromProjectionMatrix(Ne,bi,B.reversedDepth),qt=this.localClippingEnabled,Kt=Rt.init(this.clippingPlanes,qt),M=dt.get(E,w.length),M.init(),w.push(M),bt.enabled===!0&&bt.isPresenting===!0){let xt=R.xr.getDepthSensingMesh();xt!==null&&vd(xt,B,-1/0,R.sortObjects)}vd(E,B,0,R.sortObjects),M.finish(),R.sortObjects===!0&&M.sort(At,Ot,B.reversedDepth),we=bt.enabled===!1||bt.isPresenting===!1||bt.hasDepthSensing()===!1,we&&Bt.addToRenderList(M,E),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Kt===!0&&Rt.beginShadows();let k=A.state.shadowsArray;if(Nt.render(k,E,B),Kt===!0&&Rt.endShadows(),(H&&T.hasRenderPass())===!1){let xt=M.opaque,mt=M.transmissive;if(A.setupLights(),B.isArrayCamera){let Et=B.cameras;if(mt.length>0)for(let wt=0,Ft=Et.length;wt<Ft;wt++){let Wt=Et[wt];O0(xt,mt,E,Wt)}we&&Bt.render(E);for(let wt=0,Ft=Et.length;wt<Ft;wt++){let Wt=Et[wt];I0(M,E,Wt,Wt.viewport)}}else mt.length>0&&O0(xt,mt,E,B),we&&Bt.render(E),I0(M,E,B)}J!==null&&X===0&&(V.updateMultisampleRenderTarget(J),V.updateRenderTargetMipmap(J)),H&&T.end(R),E.isScene===!0&&E.onAfterRender(R,E,B),_t.resetDefaultState(),tt=-1,at=null,x.pop(),x.length>0?(A=x[x.length-1],V.setTextureUnits(A.state.textureUnits),Kt===!0&&Rt.setGlobalState(R.clippingPlanes,A.state.camera)):A=null,w.pop(),w.length>0?M=w[w.length-1]:M=null,L!==null&&L.renderEnd()};function vd(E,B,W,H){if(E.visible===!1)return;if(E.layers.test(B.layers)){if(E.isGroup)W=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(B);else if(E.isLightProbeGrid)A.pushLightProbeGrid(E);else if(E.isLight)A.pushLight(E),E.castShadow&&A.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||se.intersectsSprite(E)){H&&ke.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Ne);let xt=K.update(E),mt=E.material;mt.visible&&M.push(E,xt,mt,W,ke.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||se.intersectsObject(E))){let xt=K.update(E),mt=E.material;if(H&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),ke.copy(E.boundingSphere.center)):(xt.boundingSphere===null&&xt.computeBoundingSphere(),ke.copy(xt.boundingSphere.center)),ke.applyMatrix4(E.matrixWorld).applyMatrix4(Ne)),Array.isArray(mt)){let Et=xt.groups;for(let wt=0,Ft=Et.length;wt<Ft;wt++){let Wt=Et[wt],Ct=mt[Wt.materialIndex];Ct&&Ct.visible&&M.push(E,xt,Ct,W,ke.z,Wt)}}else mt.visible&&M.push(E,xt,mt,W,ke.z,null)}}let gt=E.children;for(let xt=0,mt=gt.length;xt<mt;xt++)vd(gt[xt],B,W,H)}function I0(E,B,W,H){let{opaque:k,transmissive:gt,transparent:xt}=E;A.setupLightsView(W),Kt===!0&&Rt.setGlobalState(R.clippingPlanes,W),H&&m.viewport(ot.copy(H)),k.length>0&&Mc(k,B,W),gt.length>0&&Mc(gt,B,W),xt.length>0&&Mc(xt,B,W),m.buffers.depth.setTest(!0),m.buffers.depth.setMask(!0),m.buffers.color.setMask(!0),m.setPolygonOffset(!1)}function O0(E,B,W,H){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[H.id]===void 0){let Ct=jt.has("EXT_color_buffer_half_float")||jt.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[H.id]=new Jn(1,1,{generateMipmaps:!0,type:Ct?qi:$n,minFilter:va,samples:Math.max(4,C.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$t.workingColorSpace})}let gt=A.state.transmissionRenderTarget[H.id],xt=H.viewport||ot;gt.setSize(xt.z*R.transmissionResolutionScale,xt.w*R.transmissionResolutionScale);let mt=R.getRenderTarget(),Et=R.getActiveCubeFace(),wt=R.getActiveMipmapLevel();R.setRenderTarget(gt),R.getClearColor(de),Ht=R.getClearAlpha(),Ht<1&&R.setClearColor(16777215,.5),R.clear(),we&&Bt.render(W);let Ft=R.toneMapping;R.toneMapping=Mi;let Wt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),A.setupLightsView(H),Kt===!0&&Rt.setGlobalState(R.clippingPlanes,H),Mc(E,W,H),V.updateMultisampleRenderTarget(gt),V.updateRenderTargetMipmap(gt),jt.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let ue=0,Fe=B.length;ue<Fe;ue++){let Oe=B[ue],{object:pe,geometry:mn,material:yt,group:On}=Oe;if(yt.side===Xi&&pe.layers.test(H.layers)){let ie=yt.side;yt.side=An,yt.needsUpdate=!0,P0(pe,W,H,mn,yt,On),yt.side=ie,yt.needsUpdate=!0,Ct=!0}}Ct===!0&&(V.updateMultisampleRenderTarget(gt),V.updateRenderTargetMipmap(gt))}R.setRenderTarget(mt,Et,wt),R.setClearColor(de,Ht),Wt!==void 0&&(H.viewport=Wt),R.toneMapping=Ft}function Mc(E,B,W){let H=B.isScene===!0?B.overrideMaterial:null;for(let k=0,gt=E.length;k<gt;k++){let xt=E[k],{object:mt,geometry:Et,group:wt}=xt,Ft=xt.material;Ft.allowOverride===!0&&H!==null&&(Ft=H),mt.layers.test(W.layers)&&P0(mt,B,W,Et,Ft,wt)}}function P0(E,B,W,H,k,gt){E.onBeforeRender(R,B,W,H,k,gt),E.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),k.onBeforeRender(R,B,W,H,E,gt),k.transparent===!0&&k.side===Xi&&k.forceSinglePass===!1?(k.side=An,k.needsUpdate=!0,R.renderBufferDirect(W,B,H,k,E,gt),k.side=bs,k.needsUpdate=!0,R.renderBufferDirect(W,B,H,k,E,gt),k.side=Xi):R.renderBufferDirect(W,B,H,k,E,gt),E.onAfterRender(R,B,W,H,k,gt)}function Ec(E,B,W){B.isScene!==!0&&(B=Je);let H=z.get(E),k=A.state.lights,gt=A.state.shadowsArray,xt=k.state.version,mt=ct.getParameters(E,k.state,gt,B,W,A.state.lightProbeGridArray),Et=ct.getProgramCacheKey(mt),wt=H.programs;H.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?B.environment:null,H.fog=B.fog;let Ft=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;H.envMap=Q.get(E.envMap||H.environment,Ft),H.envMapRotation=H.environment!==null&&E.envMap===null?B.environmentRotation:E.envMapRotation,wt===void 0&&(E.addEventListener("dispose",wi),wt=new Map,H.programs=wt);let Wt=wt.get(Et);if(Wt!==void 0){if(H.currentProgram===Wt&&H.lightsStateVersion===xt)return B0(E,mt),Wt}else mt.uniforms=ct.getUniforms(E),L!==null&&E.isNodeMaterial&&L.build(E,W,mt),E.onBeforeCompile(mt,R),Wt=ct.acquireProgram(mt,Et),wt.set(Et,Wt),H.uniforms=mt.uniforms;let Ct=H.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ct.clippingPlanes=Rt.uniform),B0(E,mt),H.needsLights=LM(E),H.lightsStateVersion=xt,H.needsLights&&(Ct.ambientLightColor.value=k.state.ambient,Ct.lightProbe.value=k.state.probe,Ct.directionalLights.value=k.state.directional,Ct.directionalLightShadows.value=k.state.directionalShadow,Ct.spotLights.value=k.state.spot,Ct.spotLightShadows.value=k.state.spotShadow,Ct.rectAreaLights.value=k.state.rectArea,Ct.ltc_1.value=k.state.rectAreaLTC1,Ct.ltc_2.value=k.state.rectAreaLTC2,Ct.pointLights.value=k.state.point,Ct.pointLightShadows.value=k.state.pointShadow,Ct.hemisphereLights.value=k.state.hemi,Ct.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Ct.spotLightMatrix.value=k.state.spotLightMatrix,Ct.spotLightMap.value=k.state.spotLightMap,Ct.pointShadowMatrix.value=k.state.pointShadowMatrix),H.lightProbeGrid=A.state.lightProbeGridArray.length>0,H.currentProgram=Wt,H.uniformsList=null,Wt}function z0(E){if(E.uniformsList===null){let B=E.currentProgram.getUniforms();E.uniformsList=So.seqWithValue(B.seq,E.uniforms)}return E.uniformsList}function B0(E,B){let W=z.get(E);W.outputColorSpace=B.outputColorSpace,W.batching=B.batching,W.batchingColor=B.batchingColor,W.instancing=B.instancing,W.instancingColor=B.instancingColor,W.instancingMorph=B.instancingMorph,W.skinning=B.skinning,W.morphTargets=B.morphTargets,W.morphNormals=B.morphNormals,W.morphColors=B.morphColors,W.morphTargetsCount=B.morphTargetsCount,W.numClippingPlanes=B.numClippingPlanes,W.numIntersection=B.numClipIntersection,W.vertexAlphas=B.vertexAlphas,W.vertexTangents=B.vertexTangents,W.toneMapping=B.toneMapping}function DM(E,B){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;y.setFromMatrixPosition(B.matrixWorld);for(let W=0,H=E.length;W<H;W++){let k=E[W];if(k.texture!==null&&k.boundingBox.containsPoint(y))return k}return null}function UM(E,B,W,H,k){B.isScene!==!0&&(B=Je),V.resetTextureUnits();let gt=B.fog,xt=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?B.environment:null,mt=J===null?R.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:$t.workingColorSpace,Et=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,wt=Q.get(H.envMap||xt,Et),Ft=H.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Wt=!!W.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Ct=!!W.morphAttributes.position,ue=!!W.morphAttributes.normal,Fe=!!W.morphAttributes.color,Oe=Mi;H.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Oe=R.toneMapping);let pe=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,mn=pe!==void 0?pe.length:0,yt=z.get(H),On=A.state.lights;if(Kt===!0&&(qt===!0||E!==at)){let ve=E===at&&H.id===tt;Rt.setState(H,E,ve)}let ie=!1;H.version===yt.__version?(yt.needsLights&&yt.lightsStateVersion!==On.state.version||yt.outputColorSpace!==mt||k.isBatchedMesh&&yt.batching===!1||!k.isBatchedMesh&&yt.batching===!0||k.isBatchedMesh&&yt.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&yt.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&yt.instancing===!1||!k.isInstancedMesh&&yt.instancing===!0||k.isSkinnedMesh&&yt.skinning===!1||!k.isSkinnedMesh&&yt.skinning===!0||k.isInstancedMesh&&yt.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&yt.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&yt.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&yt.instancingMorph===!1&&k.morphTexture!==null||yt.envMap!==wt||H.fog===!0&&yt.fog!==gt||yt.numClippingPlanes!==void 0&&(yt.numClippingPlanes!==Rt.numPlanes||yt.numIntersection!==Rt.numIntersection)||yt.vertexAlphas!==Ft||yt.vertexTangents!==Wt||yt.morphTargets!==Ct||yt.morphNormals!==ue||yt.morphColors!==Fe||yt.toneMapping!==Oe||yt.morphTargetsCount!==mn||!!yt.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(ie=!0):(ie=!0,yt.__version=H.version);let ti=yt.currentProgram;ie===!0&&(ti=Ec(H,B,k),L&&H.isNodeMaterial&&L.onUpdateProgram(H,ti,yt));let Ci=!1,Ts=!1,er=!1,me=ti.getUniforms(),Ve=yt.uniforms;if(m.useProgram(ti.program)&&(Ci=!0,Ts=!0,er=!0),H.id!==tt&&(tt=H.id,Ts=!0),yt.needsLights){let ve=DM(A.state.lightProbeGridArray,k);yt.lightProbeGrid!==ve&&(yt.lightProbeGrid=ve,Ts=!0)}if(Ci||at!==E){m.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),me.setValue(O,"projectionMatrix",E.projectionMatrix),me.setValue(O,"viewMatrix",E.matrixWorldInverse);let ws=me.map.cameraPosition;ws!==void 0&&ws.setValue(O,Be.setFromMatrixPosition(E.matrixWorld)),C.logarithmicDepthBuffer&&me.setValue(O,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&me.setValue(O,"isOrthographic",E.isOrthographicCamera===!0),at!==E&&(at=E,Ts=!0,er=!0)}if(yt.needsLights&&(On.state.directionalShadowMap.length>0&&me.setValue(O,"directionalShadowMap",On.state.directionalShadowMap,V),On.state.spotShadowMap.length>0&&me.setValue(O,"spotShadowMap",On.state.spotShadowMap,V),On.state.pointShadowMap.length>0&&me.setValue(O,"pointShadowMap",On.state.pointShadowMap,V)),k.isSkinnedMesh){me.setOptional(O,k,"bindMatrix"),me.setOptional(O,k,"bindMatrixInverse");let ve=k.skeleton;ve&&(ve.boneTexture===null&&ve.computeBoneTexture(),me.setValue(O,"boneTexture",ve.boneTexture,V))}k.isBatchedMesh&&(me.setOptional(O,k,"batchingTexture"),me.setValue(O,"batchingTexture",k._matricesTexture,V),me.setOptional(O,k,"batchingIdTexture"),me.setValue(O,"batchingIdTexture",k._indirectTexture,V),me.setOptional(O,k,"batchingColorTexture"),k._colorsTexture!==null&&me.setValue(O,"batchingColorTexture",k._colorsTexture,V));let As=W.morphAttributes;if((As.position!==void 0||As.normal!==void 0||As.color!==void 0)&&I.update(k,W,ti),(Ts||yt.receiveShadow!==k.receiveShadow)&&(yt.receiveShadow=k.receiveShadow,me.setValue(O,"receiveShadow",k.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&B.environment!==null&&(Ve.envMapIntensity.value=B.environmentIntensity),Ve.dfgLUT!==void 0&&(Ve.dfgLUT.value=s3()),Ts){if(me.setValue(O,"toneMappingExposure",R.toneMappingExposure),yt.needsLights&&NM(Ve,er),gt&&H.fog===!0&&Mt.refreshFogUniforms(Ve,gt),Mt.refreshMaterialUniforms(Ve,H,it,rt,A.state.transmissionRenderTarget[E.id]),yt.needsLights&&yt.lightProbeGrid){let ve=yt.lightProbeGrid;Ve.probesSH.value=ve.texture,Ve.probesMin.value.copy(ve.boundingBox.min),Ve.probesMax.value.copy(ve.boundingBox.max),Ve.probesResolution.value.copy(ve.resolution)}So.upload(O,z0(yt),Ve,V)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(So.upload(O,z0(yt),Ve,V),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&me.setValue(O,"center",k.center),me.setValue(O,"modelViewMatrix",k.modelViewMatrix),me.setValue(O,"normalMatrix",k.normalMatrix),me.setValue(O,"modelMatrix",k.matrixWorld),H.uniformsGroups!==void 0){let ve=H.uniformsGroups;for(let ws=0,nr=ve.length;ws<nr;ws++){let F0=ve[ws];et.update(F0,ti),et.bind(F0,ti)}}return ti}function NM(E,B){E.ambientLightColor.needsUpdate=B,E.lightProbe.needsUpdate=B,E.directionalLights.needsUpdate=B,E.directionalLightShadows.needsUpdate=B,E.pointLights.needsUpdate=B,E.pointLightShadows.needsUpdate=B,E.spotLights.needsUpdate=B,E.spotLightShadows.needsUpdate=B,E.rectAreaLights.needsUpdate=B,E.hemisphereLights.needsUpdate=B}function LM(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return J},this.setRenderTargetTextures=function(E,B,W){let H=z.get(E);H.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),z.get(E.texture).__webglTexture=B,z.get(E.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:W,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,B){let W=z.get(E);W.__webglFramebuffer=B,W.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(E,B=0,W=0){J=E,G=B,X=W;let H=null,k=!1,gt=!1;if(E){let mt=z.get(E);if(mt.__useDefaultFramebuffer!==void 0){m.bindFramebuffer(O.FRAMEBUFFER,mt.__webglFramebuffer),ot.copy(E.viewport),vt.copy(E.scissor),kt=E.scissorTest,m.viewport(ot),m.scissor(vt),m.setScissorTest(kt),tt=-1;return}else if(mt.__webglFramebuffer===void 0)V.setupRenderTarget(E);else if(mt.__hasExternalTextures)V.rebindTextures(E,z.get(E.texture).__webglTexture,z.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){let Ft=E.depthTexture;if(mt.__boundDepthTexture!==Ft){if(Ft!==null&&z.has(Ft)&&(E.width!==Ft.image.width||E.height!==Ft.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");V.setupDepthRenderbuffer(E)}}let Et=E.texture;(Et.isData3DTexture||Et.isDataArrayTexture||Et.isCompressedArrayTexture)&&(gt=!0);let wt=z.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(wt[B])?H=wt[B][W]:H=wt[B],k=!0):E.samples>0&&V.useMultisampledRTT(E)===!1?H=z.get(E).__webglMultisampledFramebuffer:Array.isArray(wt)?H=wt[W]:H=wt,ot.copy(E.viewport),vt.copy(E.scissor),kt=E.scissorTest}else ot.copy(St).multiplyScalar(it).floor(),vt.copy(Ae).multiplyScalar(it).floor(),kt=Gt;if(W!==0&&(H=F),m.bindFramebuffer(O.FRAMEBUFFER,H)&&m.drawBuffers(E,H),m.viewport(ot),m.scissor(vt),m.setScissorTest(kt),k){let mt=z.get(E.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_CUBE_MAP_POSITIVE_X+B,mt.__webglTexture,W)}else if(gt){let mt=B;for(let Et=0;Et<E.textures.length;Et++){let wt=z.get(E.textures[Et]);O.framebufferTextureLayer(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0+Et,wt.__webglTexture,W,mt)}}else if(E!==null&&W!==0){let mt=z.get(E.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,mt.__webglTexture,W)}tt=-1},this.readRenderTargetPixels=function(E,B,W,H,k,gt,xt,mt=0){if(!(E&&E.isWebGLRenderTarget)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=z.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&xt!==void 0&&(Et=Et[xt]),Et){m.bindFramebuffer(O.FRAMEBUFFER,Et);try{let wt=E.textures[mt],Ft=wt.format,Wt=wt.type;if(E.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+mt),!C.textureFormatReadable(Ft)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!C.textureTypeReadable(Wt)){Lt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=E.width-H&&W>=0&&W<=E.height-k&&O.readPixels(B,W,H,k,ft.convert(Ft),ft.convert(Wt),gt)}finally{let wt=J!==null?z.get(J).__webglFramebuffer:null;m.bindFramebuffer(O.FRAMEBUFFER,wt)}}},this.readRenderTargetPixelsAsync=async function(E,B,W,H,k,gt,xt,mt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Et=z.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&xt!==void 0&&(Et=Et[xt]),Et)if(B>=0&&B<=E.width-H&&W>=0&&W<=E.height-k){m.bindFramebuffer(O.FRAMEBUFFER,Et);let wt=E.textures[mt],Ft=wt.format,Wt=wt.type;if(E.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+mt),!C.textureFormatReadable(Ft))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!C.textureTypeReadable(Wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ct=O.createBuffer();O.bindBuffer(O.PIXEL_PACK_BUFFER,Ct),O.bufferData(O.PIXEL_PACK_BUFFER,gt.byteLength,O.STREAM_READ),O.readPixels(B,W,H,k,ft.convert(Ft),ft.convert(Wt),0);let ue=J!==null?z.get(J).__webglFramebuffer:null;m.bindFramebuffer(O.FRAMEBUFFER,ue);let Fe=O.fenceSync(O.SYNC_GPU_COMMANDS_COMPLETE,0);return O.flush(),await Pb(O,Fe,4),O.bindBuffer(O.PIXEL_PACK_BUFFER,Ct),O.getBufferSubData(O.PIXEL_PACK_BUFFER,0,gt),O.deleteBuffer(Ct),O.deleteSync(Fe),gt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,B=null,W=0){let H=Math.pow(2,-W),k=Math.floor(E.image.width*H),gt=Math.floor(E.image.height*H),xt=B!==null?B.x:0,mt=B!==null?B.y:0;V.setTexture2D(E,0),O.copyTexSubImage2D(O.TEXTURE_2D,W,0,0,xt,mt,k,gt),m.unbindTexture()},this.copyTextureToTexture=function(E,B,W=null,H=null,k=0,gt=0){let xt,mt,Et,wt,Ft,Wt,Ct,ue,Fe,Oe=E.isCompressedTexture?E.mipmaps[gt]:E.image;if(W!==null)xt=W.max.x-W.min.x,mt=W.max.y-W.min.y,Et=W.isBox3?W.max.z-W.min.z:1,wt=W.min.x,Ft=W.min.y,Wt=W.isBox3?W.min.z:0;else{let Ve=Math.pow(2,-k);xt=Math.floor(Oe.width*Ve),mt=Math.floor(Oe.height*Ve),E.isDataArrayTexture?Et=Oe.depth:E.isData3DTexture?Et=Math.floor(Oe.depth*Ve):Et=1,wt=0,Ft=0,Wt=0}H!==null?(Ct=H.x,ue=H.y,Fe=H.z):(Ct=0,ue=0,Fe=0);let pe=ft.convert(B.format),mn=ft.convert(B.type),yt;B.isData3DTexture?(V.setTexture3D(B,0),yt=O.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(V.setTexture2DArray(B,0),yt=O.TEXTURE_2D_ARRAY):(V.setTexture2D(B,0),yt=O.TEXTURE_2D),m.activeTexture(O.TEXTURE0),m.pixelStorei(O.UNPACK_FLIP_Y_WEBGL,B.flipY),m.pixelStorei(O.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),m.pixelStorei(O.UNPACK_ALIGNMENT,B.unpackAlignment);let On=m.getParameter(O.UNPACK_ROW_LENGTH),ie=m.getParameter(O.UNPACK_IMAGE_HEIGHT),ti=m.getParameter(O.UNPACK_SKIP_PIXELS),Ci=m.getParameter(O.UNPACK_SKIP_ROWS),Ts=m.getParameter(O.UNPACK_SKIP_IMAGES);m.pixelStorei(O.UNPACK_ROW_LENGTH,Oe.width),m.pixelStorei(O.UNPACK_IMAGE_HEIGHT,Oe.height),m.pixelStorei(O.UNPACK_SKIP_PIXELS,wt),m.pixelStorei(O.UNPACK_SKIP_ROWS,Ft),m.pixelStorei(O.UNPACK_SKIP_IMAGES,Wt);let er=E.isDataArrayTexture||E.isData3DTexture,me=B.isDataArrayTexture||B.isData3DTexture;if(E.isDepthTexture){let Ve=z.get(E),As=z.get(B),ve=z.get(Ve.__renderTarget),ws=z.get(As.__renderTarget);m.bindFramebuffer(O.READ_FRAMEBUFFER,ve.__webglFramebuffer),m.bindFramebuffer(O.DRAW_FRAMEBUFFER,ws.__webglFramebuffer);for(let nr=0;nr<Et;nr++)er&&(O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,z.get(E).__webglTexture,k,Wt+nr),O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,z.get(B).__webglTexture,gt,Fe+nr)),O.blitFramebuffer(wt,Ft,xt,mt,Ct,ue,xt,mt,O.DEPTH_BUFFER_BIT,O.NEAREST);m.bindFramebuffer(O.READ_FRAMEBUFFER,null),m.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else if(k!==0||E.isRenderTargetTexture||z.has(E)){let Ve=z.get(E),As=z.get(B);m.bindFramebuffer(O.READ_FRAMEBUFFER,q),m.bindFramebuffer(O.DRAW_FRAMEBUFFER,P);for(let ve=0;ve<Et;ve++)er?O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,Ve.__webglTexture,k,Wt+ve):O.framebufferTexture2D(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,Ve.__webglTexture,k),me?O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,As.__webglTexture,gt,Fe+ve):O.framebufferTexture2D(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,As.__webglTexture,gt),k!==0?O.blitFramebuffer(wt,Ft,xt,mt,Ct,ue,xt,mt,O.COLOR_BUFFER_BIT,O.NEAREST):me?O.copyTexSubImage3D(yt,gt,Ct,ue,Fe+ve,wt,Ft,xt,mt):O.copyTexSubImage2D(yt,gt,Ct,ue,wt,Ft,xt,mt);m.bindFramebuffer(O.READ_FRAMEBUFFER,null),m.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else me?E.isDataTexture||E.isData3DTexture?O.texSubImage3D(yt,gt,Ct,ue,Fe,xt,mt,Et,pe,mn,Oe.data):B.isCompressedArrayTexture?O.compressedTexSubImage3D(yt,gt,Ct,ue,Fe,xt,mt,Et,pe,Oe.data):O.texSubImage3D(yt,gt,Ct,ue,Fe,xt,mt,Et,pe,mn,Oe):E.isDataTexture?O.texSubImage2D(O.TEXTURE_2D,gt,Ct,ue,xt,mt,pe,mn,Oe.data):E.isCompressedTexture?O.compressedTexSubImage2D(O.TEXTURE_2D,gt,Ct,ue,Oe.width,Oe.height,pe,Oe.data):O.texSubImage2D(O.TEXTURE_2D,gt,Ct,ue,xt,mt,pe,mn,Oe);m.pixelStorei(O.UNPACK_ROW_LENGTH,On),m.pixelStorei(O.UNPACK_IMAGE_HEIGHT,ie),m.pixelStorei(O.UNPACK_SKIP_PIXELS,ti),m.pixelStorei(O.UNPACK_SKIP_ROWS,Ci),m.pixelStorei(O.UNPACK_SKIP_IMAGES,Ts),gt===0&&B.generateMipmaps&&O.generateMipmap(yt),m.unbindTexture()},this.initRenderTarget=function(E){z.get(E).__webglFramebuffer===void 0&&V.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?V.setTextureCube(E,0):E.isData3DTexture?V.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?V.setTexture2DArray(E,0):V.setTexture2D(E,0),m.unbindTexture()},this.resetState=function(){G=0,X=0,J=null,m.reset(),_t.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return bi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=$t._getDrawingBufferColorSpace(t),n.unpackColorSpace=$t._getUnpackColorSpace()}};var C0=12;var ee=(e,t,n=0)=>({time:e,azimuth:t||0,elevation:n,distance:1}),gM=e=>[...Array.from({length:9},(t,n)=>ee(Number((n*5/48).toFixed(6)),e*n*45)),ee(1,e*360)],gc=(e,t=0)=>[ee(0,0),ee(.2,e/2,t/2),ee(.4,e,t),ee(.6,e/2,t/2),ee(.8,0),ee(1,0)],_M=e=>[...Array.from({length:9},(t,n)=>ee(Number((n*5/48).toFixed(6)),e*n*45,n===8?0:Number((25*Math.sin(Math.PI*n/8)).toFixed(3)))),ee(1,e*360)],KN=[{id:"swing",name:"Side Arc",description:"A 65-degree arc around the frame.",duration:5,returnsToStart:!1,trajectory:[ee(0,0),ee(1,65,8)]},{id:"rise",name:"Hero Rise",description:"A new angle on the action.",duration:5,returnsToStart:!1,trajectory:[ee(0,0),ee(1,35,30)]},{id:"orbit",name:"Full Orbit",description:"A full right orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:gM(1)},{id:"arc-return",name:"Arc Return",description:"Sweep 45 degrees to the side, then retrace to the starting pose.",duration:5,returnsToStart:!0,trajectory:[ee(0,0),ee(.2,22.5),ee(.45,45),ee(.7,22.5),ee(.9,0),ee(1,0)]},{id:"rise-return",name:"Rise Return",description:"Rise 25 degrees, then descend to the starting pose.",duration:5,returnsToStart:!0,trajectory:[ee(0,0),ee(.2,0,12.5),ee(.45,0,25),ee(.7,0,12.5),ee(.9,0),ee(1,0)]},{id:"orbit-left",name:"Orbit Left",description:"A full left orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:gM(-1)},{id:"arc-left-return",name:"Left Return",description:"Sweep 45 degrees left, then retrace to the opening view.",duration:5,returnsToStart:!0,trajectory:gc(-45)},{id:"wide-return",name:"Wide Return",description:"Reach a 90-degree side view, then return to the opening pose.",duration:5,returnsToStart:!0,trajectory:gc(90)},{id:"dip-return",name:"Dip Return",description:"Dip 20 degrees below the subject, then rise back to the opening view.",duration:5,returnsToStart:!0,trajectory:gc(0,-20)},{id:"high-arc-return",name:"High Return",description:"Arc 45 degrees right and 25 degrees up, then retrace home.",duration:5,returnsToStart:!0,trajectory:gc(45,25)},{id:"low-arc-return",name:"Low Return",description:"Arc 45 degrees left and 20 degrees down, then retrace home.",duration:5,returnsToStart:!0,trajectory:gc(-45,-20)},{id:"sway-return",name:"Side to Side",description:"Sway left, cross through the opening view to the right, then return.",duration:5,returnsToStart:!0,trajectory:[ee(0,0),ee(.2,-30),ee(.4,0),ee(.6,30),ee(.8,0),ee(1,0)]},{id:"halo",name:"High Orbit",description:"Orbit right through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:_M(1)},{id:"halo-left",name:"High Orbit Left",description:"Orbit left through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:_M(-1)},{id:"arc-left",name:"Left Arc",description:"A 65-degree left arc that finishes at a new angle.",duration:5,returnsToStart:!1,trajectory:[ee(0,0),ee(1,-65,8)]},{id:"low-angle",name:"Low Reveal",description:"Sweep 40 degrees right and descend 20 degrees for a low-angle finish.",duration:5,returnsToStart:!1,trajectory:[ee(0,0),ee(1,40,-20)]}];var nt=Tc(R0());async function Mo(e){let t=e instanceof FormData?e:new FormData;if(!(e instanceof FormData))for(let[n,i]of Object.entries(e))t.set(n,i);t.set("format","json");try{return await(await fetch(window.location.pathname,{method:"POST",body:t,credentials:"same-origin"})).json()}catch{return null}}var Sc=Math.PI/180;function _c(e,t,n){return Math.max(t,Math.min(n,e))}function bc(e,t){if(t<=e[0].time)return e[0];let n=e[e.length-1];if(t>=n.time)return n;let i=1;for(;e[i].time<t;)i++;let s=e[i-1],a=e[i],r=Math.max(1e-6,a.time-s.time),o=(t-s.time)/r,l=o*o*(3-2*o),c=a.azimuth-s.azimuth;return c=((c%360+540)%360+360)%360-180,{time:t,azimuth:s.azimuth+c*l,elevation:s.elevation+(a.elevation-s.elevation)*l,distance:s.distance+(a.distance-s.distance)*l}}var TM={time:0,azimuth:0,elevation:0,distance:1},l3={...TM,time:1},vc=1024,SM=["#f8fbff","#ffd166","#ff5d8f","#4db0ff","#39d98a"],c3=[{id:"fast",label:"Flare Fast"},{id:"detailed",label:"Flare Detailed"},{id:"turbo",label:"Turbo"},{id:"hq",label:"Sunburst HQ"}];function u3(e){let t=(0,st.useRef)(null),n=(0,st.useRef)([]),i=(0,st.useRef)(!1),[s,a]=(0,st.useState)(SM[0]),[r,o]=(0,st.useState)(14),[l,c]=(0,st.useState)(!1),[h,p]=(0,st.useState)(""),[u,d]=(0,st.useState)("fast"),[,_]=(0,st.useState)(0),b=(0,st.useCallback)(()=>{let v=t.current,S=v?.getContext("2d");if(!(!v||!S)){S.fillStyle="#0a1120",S.fillRect(0,0,vc,vc);for(let y of n.current){S.save(),S.globalCompositeOperation=y.erase?"destination-out":"source-over",S.strokeStyle=y.color,S.fillStyle=y.color,S.lineWidth=y.width,S.lineCap="round",S.lineJoin="round";let[M,...A]=y.points;if(!M){S.restore();continue}S.beginPath(),S.arc(M.x,M.y,y.width/2,0,Math.PI*2),S.fill(),S.beginPath(),S.moveTo(M.x,M.y);for(let w of A)S.lineTo(w.x,w.y);S.stroke(),S.restore()}}},[]);(0,st.useEffect)(()=>b(),[b]);let g=v=>{let S=v.currentTarget.getBoundingClientRect(),y=vc/Math.max(1,Math.min(S.width,S.height));return{x:(v.clientX-S.left)*y,y:(v.clientY-S.top)*y}},f=n.current.length===0;return(0,nt.jsxs)("div",{className:"fz-sketch",children:[(0,nt.jsx)("canvas",{ref:t,className:"fz-sketch-canvas",width:vc,height:vc,onPointerDown:v=>{v.currentTarget.setPointerCapture(v.pointerId),i.current=!0,n.current.push({points:[g(v)],color:s,width:r,erase:l}),b()},onPointerMove:v=>{i.current&&(n.current[n.current.length-1]?.points.push(g(v)),b())},onPointerUp:()=>{i.current=!1,_(v=>v+1)}}),(0,nt.jsxs)("div",{className:"fz-tools",children:[SM.map(v=>(0,nt.jsx)("button",{type:"button",className:`fz-swatch${!l&&s===v?" selected":""}`,style:{background:v},"aria-label":`paint ${v}`,onClick:()=>{a(v),c(!1)}},v)),(0,nt.jsx)("button",{type:"button",className:`fz-ghost${l?" selected":""}`,onClick:()=>c(v=>!v),children:"erase"}),(0,nt.jsx)("input",{className:"fz-size",type:"range",min:4,max:60,value:r,onChange:v=>o(Number(v.target.value)),"aria-label":"brush size"}),(0,nt.jsx)("button",{type:"button",className:"fz-ghost",disabled:f,onClick:()=>{n.current=[],b(),_(v=>v+1)},children:"clear"})]}),(0,nt.jsx)("textarea",{className:"fz-prompt",placeholder:"describe the scene \u2014 'two friends at a diner, neon light'",value:h,maxLength:2e3,onChange:v=>p(v.target.value)}),(0,nt.jsx)("div",{className:"fz-modes",children:c3.map(v=>(0,nt.jsx)("button",{type:"button",className:u===v.id?"active":"",onClick:()=>d(v.id),children:v.label},v.id))}),(0,nt.jsx)("button",{type:"button",className:"fz-primary",disabled:e.busy||!h.trim(),onClick:()=>{let v=t.current;n.current.length>0&&v?v.toBlob(y=>e.onGenerate(y,h.trim(),u),"image/png"):e.onGenerate(null,h.trim(),u)},children:e.busy?"generating\u2026":"generate the still"})]})}var bM=1/30,MM=10*1024*1024;function h3(e,t,n=1e4){return new Promise((i,s)=>{if(Math.abs(e.currentTime-t)<.001&&e.readyState>=2){i();return}let a=window.setTimeout(()=>{e.removeEventListener("seeked",r),s(new Error("couldn't read that frame"))},n);function r(){window.clearTimeout(a),i()}e.addEventListener("seeked",r,{once:!0}),e.currentTime=t})}function AM(e,t){let n=document.createElement("canvas");n.width=Math.min(t,e.videoWidth),n.height=Math.round(n.width*e.videoHeight/Math.max(1,e.videoWidth));let i=n.getContext("2d");return!i||!n.width?null:(i.drawImage(e,0,0,n.width,n.height),n)}async function f3(e,t,n=1e4){try{await h3(e,t,n);let i=AM(e,160);return i?i.toDataURL("image/jpeg",.8):null}catch{return null}}function d3(e){let{busy:t,onFrame:n}=e,i=(0,st.useRef)(null),s=(0,st.useRef)(null),a=(0,st.useRef)(null),r=(0,st.useRef)(!1),o=(0,st.useRef)(0),[l,c]=(0,st.useState)(null),[h,p]=(0,st.useState)(0),[u,d]=(0,st.useState)(0),[_,b]=(0,st.useState)([]),[g,f]=(0,st.useState)(!1),[v,S]=(0,st.useState)(!1),[y,M]=(0,st.useState)(null);(0,st.useEffect)(()=>()=>{o.current++,a.current&&URL.revokeObjectURL(a.current)},[]);let A=(0,st.useCallback)(async T=>{if(!T)return;if(M(null),!T.type.startsWith("video/")){M("choose a video \u2014 mp4, mov, or webm");return}if(T.size>150*1024*1024){M("choose a clip under 150mb");return}f(!0);let R=++o.current,D=URL.createObjectURL(T),L=()=>o.current!==R;try{let F=document.createElement("video");if(F.preload="auto",F.muted=!0,F.playsInline=!0,await new Promise((G,X)=>{let J=window.setTimeout(()=>X(new Error("that clip took too long to read")),2e4);F.onloadeddata=()=>{window.clearTimeout(J),G()},F.onerror=()=>{window.clearTimeout(J),X(new Error("can't decode that video \u2014 try an h.264 mp4"))},F.src=D}),!Number.isFinite(F.duration)||F.duration<=0||F.duration>120)throw new Error("choose a clip under two minutes");if(L()){F.removeAttribute("src"),F.load(),URL.revokeObjectURL(D);return}let q=[],P=Date.now()+15e3;for(let G=0;G<10&&!L();G++){let X=P-Date.now();if(X<=0)break;let J=Math.max(0,Math.min(F.duration-.05,F.duration*G/10)),tt=await f3(F,J,X);tt&&q.push({src:tt,time:J})}if(L()){F.removeAttribute("src"),F.load(),URL.revokeObjectURL(D);return}a.current&&URL.revokeObjectURL(a.current),a.current=D,c(D),p(F.duration),d(F.duration/2),b(q),F.removeAttribute("src"),F.load()}catch(F){URL.revokeObjectURL(D),L()||M(F instanceof Error?F.message:"that video didn't load")}finally{L()||f(!1)}},[]),w=(0,st.useCallback)(T=>{d(T);let R=s.current;R&&(R.pause(),r.current=!0,R.currentTime=T)},[]),x=(0,st.useCallback)(async()=>{let T=s.current;if(!(!T||v||t)){S(!0);try{(r.current||T.readyState<2||Math.abs(T.currentTime-u)>.001)&&await new Promise((L,F)=>{let q=window.setTimeout(()=>{T.removeEventListener("seeked",P),F(new Error("couldn't read that frame"))},1e4),P=()=>{window.clearTimeout(q),L()};T.addEventListener("seeked",P,{once:!0}),r.current||(T.currentTime=u)});let R=Math.min(1920,T.videoWidth),D=null;for(;R>0;){let L=AM(T,R);if(!L)throw new Error("frame capture isn't available");if(D=await new Promise(F=>L.toBlob(q=>F(q),"image/jpeg",.94)),!D)throw new Error("frame capture isn't available");if(D.size<=MM||R<=320)break;R=Math.floor(R*.75)}if(!D||D.size>MM)throw new Error("that frame is too large \u2014 try a smaller clip");n(new File([D],"freeze-frame.jpg",{type:"image/jpeg"}))}catch(R){M(R instanceof Error?R.message:"couldn't capture the frame")}finally{S(!1)}}},[u,v,t,n]);return(0,nt.jsxs)("div",{className:"fz-framepick",children:[(0,nt.jsx)("input",{ref:i,type:"file",accept:"video/*",hidden:!0,onChange:T=>void A(T.target.files?.[0]??null)}),l?(0,nt.jsxs)(nt.Fragment,{children:[(0,nt.jsx)("video",{ref:s,className:"fz-video",src:l,muted:!0,playsInline:!0,preload:"auto",onLoadedData:T=>{r.current=!0,T.currentTarget.currentTime=u},onSeeked:()=>{r.current=!1}}),_.length>0&&(0,nt.jsx)("div",{className:"fz-strip",children:_.map((T,R)=>(0,nt.jsx)("img",{src:T.src,alt:"",onClick:()=>w(T.time)},R))}),(0,nt.jsx)("input",{type:"range",className:"fz-scrub",min:0,max:Math.max(bM,h),step:bM,value:u,onChange:T=>w(Number(T.target.value)),"aria-label":"pick the frame"}),(0,nt.jsxs)("div",{className:"fz-row",children:[(0,nt.jsx)("button",{type:"button",className:"fz-ghost",disabled:g,onClick:()=>i.current?.click(),children:"different clip"}),(0,nt.jsx)("button",{type:"button",className:"fz-primary",disabled:v||t,onClick:()=>void x(),children:v?"capturing\u2026":`freeze at ${u.toFixed(2)}s`})]})]}):(0,nt.jsxs)("div",{className:"fz-video-empty",children:[(0,nt.jsx)("p",{className:"fz-sub",children:"pick the clip \u2014 then scrub to the moment to freeze"}),(0,nt.jsx)("button",{type:"button",className:"fz-primary",disabled:g,onClick:()=>i.current?.click(),children:g?"reading the clip\u2026":"choose a video"})]}),y&&(0,nt.jsx)("p",{className:"fz-err",children:y})]})}function yc(e,t,n){let i=t/2,s=n*.46,a=t*.36*e.distance,r=n*.11*e.distance,o=e.azimuth*Sc;return{x:i+Math.sin(o)*a,y:s+n*.16+Math.cos(o)*r-Math.sin(e.elevation*Sc)*n*.3,depth:Math.cos(o)}}var xc=.95,p3=2.3;function gd(e,t){let n=e.azimuth*Sc,i=e.elevation*Sc,s=p3*e.distance;return t.set(Math.sin(n)*Math.cos(i)*s,xc+Math.sin(i)*s,Math.cos(n)*Math.cos(i)*s),t}function m3(e){let t=new fd({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),e.appendChild(t.domElement),t.domElement.style.position="absolute",t.domElement.style.inset="0";let n=[],i=P=>(n.push(P),P),s=new Vl,a=new yn(42,1,.05,80);a.position.set(3.15,2.05,3.55),a.lookAt(0,.85,0);let r=i(new nc(14,28,2902638,1451582));s.add(r);let o=1.7,l=o*.72,c=new Qe(i(new da(o*1.07,l*1.1)),i(new di({color:924208})));c.position.set(0,xc,0);let h=i(new di({color:4479370})),p=i(new da(o,l)),u=new Qe(p,h);u.position.set(0,xc,.001);let d=new fo(i(new Zl(p)),i(new fa({color:8240895})));d.position.copy(u.position),s.add(c,u,d);let _=i(new di({color:6348031})),b=null,g=new Vi;s.add(g);let f=i(new go(.05,16,12)),v=i(new di({color:6348031})),S=i(new di({color:16777215})),y=i(new di({color:16765286,transparent:!0})),M=new Vi;M.add(new Qe(i(new go(.075,18,14)),y));let A=new Qe(i(new Yl(.048,.17,12)),y);A.rotation.x=Math.PI/2,A.position.z=.14,M.add(A),s.add(M);let w=i(new on().setFromPoints([new N,new N(0,xc,0)])),x=new ho(w,i(new Ql({color:16765286,dashSize:.09,gapSize:.09,transparent:!0,opacity:.45})));x.computeLineDistances(),s.add(x);let T=new N,R=new N(0,xc,0),D=[],L=()=>{let P=e.clientWidth,G=e.clientHeight;if(P===0||G===0)return;let X=new Dt;t.getSize(X),(X.x!==P||X.y!==G)&&(t.setSize(P,G,!1),a.aspect=P/G,a.updateProjectionMatrix()),t.render(s,a)},F=new ResizeObserver(L);F.observe(e);let q=null;return{setImage(P){if(q?.dispose(),P){let G=new xn(P);G.colorSpace=Tn,G.needsUpdate=!0,q=G,h.map=G,h.color.set(16777215)}else q=null,h.map=null,h.color.set(4479370);h.needsUpdate=!0,L()},update(P,G,X){if(D=P,P.length>=2){let tt=[];for(let kt=0;kt<=96;kt++)tt.push(gd(bc(P,kt/96),new N));let at=new mo(tt),ot=new jl(at,120,.018,8,!1),vt=new Qe(ot,_);b&&(s.remove(b),b.geometry.dispose()),b=vt,s.add(b)}else b&&(s.remove(b),b.geometry.dispose(),b=null);g.clear(),P.forEach((tt,at)=>{let ot=new Qe(f,at===X?S:v);ot.position.copy(gd(tt,T)),at===X&&ot.scale.setScalar(1.3),ot.userData.index=at,g.add(ot)});let J=bc(P,G);M.position.copy(gd(J,T)),M.lookAt(R),y.opacity=Math.cos(J.azimuth*Sc)<-.05?.45:1,w.setFromPoints([M.position.clone(),R.clone()]),x.computeLineDistances(),L()},pick(P,G){let X=e.clientWidth,J=e.clientHeight,tt=null,at=30;return D.forEach((ot,vt)=>{gd(ot,T).project(a);let kt=(T.x*.5+.5)*X,de=(-T.y*.5+.5)*J,Ht=Math.hypot(kt-P,de-G);Ht<at&&(at=Ht,tt=vt)}),tt},dispose(){F.disconnect(),q?.dispose(),n.forEach(P=>P.dispose()),b?.geometry.dispose(),t.dispose(),t.domElement.remove()}}}function g3(e){let t=(0,st.useRef)(null),n=(0,st.useRef)(null),[i,s]=(0,st.useState)(!1),a=(0,st.useRef)(null),r=(0,st.useRef)(e);return r.current=e,(0,st.useEffect)(()=>{let o=t.current;if(!o||r.current.lite)return;let l=null;try{l=m3(o)}catch{return}return n.current=l,s(!0),()=>{n.current=null,l.dispose()}},[]),(0,st.useEffect)(()=>{n.current?.setImage(e.image)},[i,e.image]),(0,st.useEffect)(()=>{n.current?.update(e.keyframes,e.scrubT,e.selected)}),(0,nt.jsx)("div",{ref:t,className:"fz-stage-canvas",onPointerDown:o=>{if(!i)return;o.currentTarget.setPointerCapture(o.pointerId);let l=o.currentTarget.getBoundingClientRect(),c=n.current?.pick(o.clientX-l.left,o.clientY-l.top)??null;c!==null&&r.current.onPick(c),a.current={moved:!1,picked:c}},onPointerMove:o=>{let l=a.current;if(!l||!i)return;let c=o.movementX,h=o.movementY;Math.abs(c)+Math.abs(h)<.5||(l.moved=!0,r.current.onDragPose(c*.6,-h*.4))},onPointerUp:()=>{let o=a.current;a.current=null,!(!o||o.moved||!i)&&r.current.onPick(o.picked)},children:!i&&(0,nt.jsx)(_3,{...e})})}function _3(e){let t=(0,st.useRef)(null),n=(0,st.useRef)(null),i=(0,st.useCallback)(()=>{let s=t.current,a=s?.getContext("2d");if(!s||!a)return;let r=Math.min(2,window.devicePixelRatio||1),o=s.clientWidth,l=s.clientHeight;(s.width!==o*r||s.height!==l*r)&&(s.width=o*r,s.height=l*r),a.setTransform(r,0,0,r,0,0),a.clearRect(0,0,o,l),a.strokeStyle="rgba(120,170,255,0.10)",a.lineWidth=1;let c=l*.62;for(let y=0;y<=12;y++){let M=c+Math.pow(y/12,1.6)*(l-c);a.beginPath(),a.moveTo(0,M),a.lineTo(o,M),a.stroke()}for(let y=-8;y<=8;y++)a.beginPath(),a.moveTo(o/2+y*o*.07,c),a.lineTo(o/2+y*o*.22,l),a.stroke();let h=o/2,p=l*.46,u=o*.36,d=l*.11;a.strokeStyle="rgba(125,190,255,0.22)",a.setLineDash([4,6]),a.beginPath(),a.ellipse(h,p+l*.16,u,d,0,0,Math.PI*2),a.stroke(),a.setLineDash([]);let _=e.keyframes;if(_.length>=2){a.strokeStyle="rgba(96,220,255,0.9)",a.lineWidth=3,a.lineCap="round",a.beginPath();let y=96;for(let M=0;M<=y;M++){let A=yc(bc(_,M/y),o,l);M===0?a.moveTo(A.x,A.y):a.lineTo(A.x,A.y)}a.stroke()}let b=Math.min(o*.4,l*.4*(4/3)),g=b*.72;if(a.save(),a.shadowColor="rgba(0,0,0,0.6)",a.shadowBlur=24,a.fillStyle="#0e1a30",a.fillRect(h-b/2,p-g/2,b,g),a.restore(),e.image){let y=e.image,M=Math.min(b/y.width,g/y.height),A=y.width*M,w=y.height*M;a.drawImage(y,h-A/2,p-w/2,A,w)}else a.fillStyle="rgba(219,232,255,0.5)",a.font="13px ui-monospace, monospace",a.textAlign="center",a.fillText("no photo",h,p);a.strokeStyle="rgba(125,190,255,0.5)",a.strokeRect(h-b/2,p-g/2,b,g),_.forEach((y,M)=>{let A=yc(y,o,l);a.beginPath(),a.arc(A.x,A.y,M===e.selected?7:5,0,Math.PI*2),a.fillStyle=M===e.selected?"#ffffff":"#60dcff",a.fill(),M===e.selected&&(a.strokeStyle="rgba(96,220,255,0.6)",a.lineWidth=2,a.stroke())});let f=bc(_,e.scrubT),v=yc(f,o,l),S=v.depth<-.05;a.globalAlpha=S?.45:1,a.beginPath(),a.arc(v.x,v.y,13,0,Math.PI*2),a.fillStyle="#ffd166",a.fill(),a.beginPath(),a.arc(v.x,v.y,5,0,Math.PI*2),a.fillStyle="#0a1120",a.fill(),a.strokeStyle="rgba(255,209,102,0.35)",a.setLineDash([3,5]),a.beginPath(),a.moveTo(v.x,v.y),a.lineTo(h,p),a.stroke(),a.setLineDash([]),a.globalAlpha=1},[e.image,e.keyframes,e.scrubT,e.selected]);return(0,st.useEffect)(()=>{i()},[i]),(0,st.useEffect)(()=>{let s=()=>i();return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[i]),(0,nt.jsx)("canvas",{ref:t,className:"fz-stage-canvas",onPointerDown:s=>{s.currentTarget.setPointerCapture(s.pointerId);let a=s.currentTarget.getBoundingClientRect(),r=s.clientX-a.left,o=s.clientY-a.top,l=e.keyframes.findIndex(c=>{let h=yc(c,a.width,a.height);return Math.hypot(h.x-r,h.y-o)<20});l>=0&&e.onPick(l),n.current={x:r,y:o,moved:!1}},onPointerMove:s=>{let a=n.current;if(!a)return;let r=s.movementX??s.clientX-a.x,o=s.movementY??s.clientY-a.y;Math.abs(r)+Math.abs(o)<.5||(a.moved=!0,a.x=s.clientX,a.y=s.clientY,e.onDragPose(r*.6,-o*.4))},onPointerUp:s=>{let a=n.current;if(n.current=null,a&&!a.moved){let r=s.currentTarget.getBoundingClientRect(),o=e.keyframes.findIndex(l=>{let c=yc(l,r.width,r.height);return Math.hypot(c.x-(s.clientX-r.left),c.y-(s.clientY-r.top))<20});e.onPick(o>=0?o:null)}}})}function v3(e){let[t,n]=(0,st.useState)(e.initial.sourceAssetId?"camera":"source"),[i,s]=(0,st.useState)(e.initial.sourceUrl),[a,r]=(0,st.useState)(e.initial.sourceAssetId),[o,l]=(0,st.useState)(e.initial.renders),[c,h]=(0,st.useState)(e.initial.activeJob),[p,u]=(0,st.useState)(e.initial.latest),[d,_]=(0,st.useState)(!1),[b,g]=(0,st.useState)(null),[f,v]=(0,st.useState)(!1),[S,y]=(0,st.useState)(!1),[M,A]=(0,st.useState)(null),[w,x]=(0,st.useState)([TM,{time:.5,azimuth:65,elevation:8,distance:1},l3]),[T,R]=(0,st.useState)(0),[D,L]=(0,st.useState)(null),[F,q]=(0,st.useState)(null),[P,G]=(0,st.useState)(5),[X,J]=(0,st.useState)("768P"),[tt]=(0,st.useState)(()=>Math.floor(Math.random()*1e6)),at=(0,st.useRef)(null),[,ot]=(0,st.useState)(0),vt=(0,st.useRef)(null),kt=(0,st.useRef)(null),de=(0,st.useRef)(0),Ht=(0,st.useRef)(e.initial.sourceAssetId),Z=(0,st.useRef)(null),rt=(0,st.useCallback)(m=>{let U=Z.current;U&&U!==m&&(URL.revokeObjectURL(U),Z.current=null),m.startsWith("blob:")&&(Z.current=m),s(m)},[]),it=(0,st.useCallback)(()=>{Z.current&&(URL.revokeObjectURL(Z.current),Z.current=null),s(null)},[]);(0,st.useEffect)(()=>()=>{Z.current&&URL.revokeObjectURL(Z.current)},[]);let At=(0,st.useCallback)((m,U=!1)=>{if(typeof m.latest=="number"&&u(m.latest),h(m.activeJob??null),m.line&&g(m.line),m.sourceUrl&&(U||m.sourceAssetId!==Ht.current)&&rt(m.sourceUrl),m.sourceAssetId&&(Ht.current=m.sourceAssetId,r(m.sourceAssetId)),m.renders&&l(m.renders),M&&!m.activeJob){let V=(M.kind==="render"?m.renders:m.sketches)?.find(Q=>Q.jobId===M.id);V&&(V.state==="delivered"||V.state==="failed")&&(A(null),V.state==="delivered"?M.kind==="render"?(g(null),n("result")):(v(!1),g("still delivered \u2014 set the camera move"),n("camera")):g(V.error??"that didn't come out \u2014 try again?"))}},[M,rt]),Ot=(0,st.useRef)(0),St=(0,st.useCallback)(async()=>{let m=++Ot.current,U=await Mo({action:"status",after:String(p)});if(!(!U||m!==Ot.current))return At(U),U},[p,At]),Ae=(0,st.useCallback)(async m=>{for(let U=0;U<10;U++){if(Ht.current!==m)return;let z=await St();if(Ht.current!==m)return;if(z&&z.sourceAssetId===m&&(At(z,!0),z.sourceUrl)){g(null);return}await new Promise(V=>setTimeout(V,1200))}Ht.current===m&&g("still converting \u2014 back out and re-upload if it stalls")},[St,At]),Gt=(0,st.useCallback)(()=>{let m=Date.now();m-de.current<3e4||(de.current=m,St().then(U=>{U&&At(U,!0)}))},[St,At]),se=(0,st.useRef)(0);(0,st.useEffect)(()=>{let m=++se.current;if(!i){at.current=null,ot(z=>z+1);return}let U=new Image;U.crossOrigin="anonymous",U.onload=()=>{m===se.current&&(at.current=U,ot(z=>z+1))},U.onerror=()=>{m===se.current&&Gt()},U.src=i},[i,Gt]),(0,st.useEffect)(()=>{if(!c)return;let m=!1,U=window.setInterval(()=>{m||(m=!0,St().finally(()=>{m=!1}))},2500);return()=>window.clearInterval(U)},[c,St]);let Kt=(m,U)=>g(m?.line??U),qt=(0,st.useCallback)(async m=>{if(!m||d)return;_(!0),g("reading the photo\u2026");let z=m.type.startsWith("image/")&&!/hei[cf]/i.test(m.type)?URL.createObjectURL(m):null,V=new FormData;V.set("action","source"),V.set("file",m);let Q=await Mo(V);if(_(!1),!Q||Q.error||Q.sourceAssetId===void 0){z&&URL.revokeObjectURL(z),Kt(Q,"that photo didn't come through \u2014 try another.");return}g(null),r(Q.sourceAssetId),v(!1),y(!1),Ht.current=Q.sourceAssetId,Q.sourceUrl?(z&&URL.revokeObjectURL(z),rt(Q.sourceUrl)):z?rt(z):(it(),g("converting the photo\u2026")),n("camera"),St(),!Q.sourceUrl&&!z&&Q.sourceAssetId&&Ae(Q.sourceAssetId)},[d,St,rt,it,Ae]),Ne=(0,st.useCallback)(async(m,U,z)=>{if(d)return;_(!0),g("generating the still \u2014 about a minute");let V=new FormData;V.set("action","source"),V.set("kind","sketch"),V.set("prompt",U),V.set("mode",z),m&&V.set("canvas",m,"sketch.png");let Q=await Mo(V);if(_(!1),!Q||Q.error||!Q.jobId){Kt(Q,"that didn't work \u2014 try again?");return}A({id:Q.jobId,kind:"sketch"}),At(Q),g("generating the still \u2014 about a minute")},[d,At]),Be=(0,st.useCallback)(m=>{q(m.id),G(m.duration===6?6:5),x(m.trajectory.map(U=>({...U}))),L(null),R(0)},[]),ke=(0,st.useCallback)(()=>{x(m=>{if(m.length>=C0)return m;let U=_c(T,.02,.98);if(m.some(Q=>Math.abs(Q.time-U)<.01))return m;let z=bc(m,U);return[...m,{...z,time:U}].sort((Q,lt)=>Q.time-lt.time).map(Q=>({...Q}))}),q(null)},[T]),Je=(0,st.useCallback)(()=>{x(m=>{if(D===null||m.length<=2)return m;let U=m[D];return!U||U.time===0||U.time===1?m:m.filter((z,V)=>V!==D)}),L(null),q(null)},[D]),we=(0,st.useCallback)((m,U)=>{q(null),x(z=>{let V=D;if(V===null){let Y=1/0;z.forEach((K,ct)=>{let Mt=Math.abs(K.time-T);Mt<Y&&(Y=Mt,V=ct)})}if(V===null)return z;let Q=z[V];if(!Q||Q.time===0||Q.time===1)return z;let lt=z.map((Y,K)=>K===V?{...Y,azimuth:_c(Y.azimuth+m,-360,360),elevation:_c(Y.elevation+U,-90,90)}:Y);return L(V),lt})},[D,T]),Le=(0,st.useCallback)(async()=>{if(d||!a||!i)return;_(!0),g("rendering the freeze \u2014 a few minutes");let m={action:"render",duration:String(P),resolution:X,seed:String(tt)};F?m.preset=F:m.trajectory=JSON.stringify(w);let U=await Mo(m);if(_(!1),!U||U.error||!U.jobId){Kt(U,"that render didn't start \u2014 try again?");return}A({id:U.jobId,kind:"render"}),At(U),g("freezing \u2014 a few minutes")},[d,a,i,F,X,tt,w,P,At]),O=(0,st.useCallback)(async m=>{if(d)return;_(!0),g("sending to iMessage\u2026");let U=await Mo({action:"save",job:m});if(_(!1),!U||U.error){Kt(U,"couldn't send it \u2014 try again");return}U.downloadUrl?(window.open(U.downloadUrl,"_blank","noopener"),g("sent the link \u2014 it's only good for a little while")):g("sent to iMessage")},[d]),pn=(0,st.useCallback)(async()=>{await Mo({action:"cancel"}),A(null),g(null),await St()},[St]),jt=(0,st.useMemo)(()=>o.filter(m=>m.state==="delivered"&&m.outputUrl),[o]),C=jt[jt.length-1];return(0,nt.jsxs)("div",{className:"fz",children:[(0,nt.jsx)("div",{className:"fz-tabs",children:["source","camera","result"].map(m=>(0,nt.jsx)("button",{type:"button",className:t===m?"active":"",disabled:m==="camera"&&!a||m==="result"&&jt.length===0,onClick:()=>n(m),children:m==="source"?"1 \xB7 photo":m==="camera"?"2 \xB7 camera":"3 \xB7 freeze"},m))}),c&&(0,nt.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void pn(),children:"cancel the running job"}),t==="source"&&(0,nt.jsx)("div",{className:"fz-stage",children:!f&&!S?(0,nt.jsxs)(nt.Fragment,{children:[(0,nt.jsxs)("div",{className:"fz-hero",children:[(0,nt.jsx)("p",{className:"fz-title",children:"freeze the scene"}),(0,nt.jsx)("p",{className:"fz-sub",children:"pick the still \u2014 the camera moves, the moment doesn\u2019t"})]}),(0,nt.jsxs)("div",{className:"fz-source-grid",children:[(0,nt.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>kt.current?.click(),children:[(0,nt.jsx)("span",{className:"fz-card-icon",children:"\u25C9"}),"take a photo"]}),(0,nt.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>vt.current?.click(),children:[(0,nt.jsx)("span",{className:"fz-card-icon",children:"\u25A4"}),"upload a photo"]}),(0,nt.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>v(!0),children:[(0,nt.jsx)("span",{className:"fz-card-icon",children:"\u270E"}),"sketch + generate"]}),(0,nt.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>y(!0),children:[(0,nt.jsx)("span",{className:"fz-card-icon",children:"\u25B6"}),"video \u2192 freeze a frame"]})]}),(0,nt.jsx)("input",{ref:kt,type:"file",accept:"image/*,.heic,.heif",capture:"environment",hidden:!0,onChange:m=>void qt(m.target.files?.[0]??null)}),(0,nt.jsx)("input",{ref:vt,type:"file",accept:"image/*,.heic,.heif",hidden:!0,onChange:m=>void qt(m.target.files?.[0]??null)}),jt.length>0&&(0,nt.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("result"),children:"see your freezes \u2192"})]}):f?(0,nt.jsxs)(nt.Fragment,{children:[(0,nt.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>v(!1),children:"\u2190 back"}),(0,nt.jsx)(u3,{busy:d||M?.kind==="sketch",onGenerate:Ne})]}):(0,nt.jsxs)(nt.Fragment,{children:[(0,nt.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>y(!1),children:"\u2190 back"}),(0,nt.jsx)(d3,{busy:d,onFrame:m=>void qt(m)})]})}),t==="camera"&&(0,nt.jsxs)("div",{className:"fz-stage",children:[(0,nt.jsx)("div",{className:"fz-stage-wrap",children:(0,nt.jsx)(g3,{image:at.current,keyframes:w,scrubT:T,selected:D,lite:e.initial.lite,onDragPose:we,onPick:L})}),(0,nt.jsx)("div",{className:"fz-presets",children:e.initial.presets.map(m=>(0,nt.jsx)("button",{type:"button",className:`fz-chip${F===m.id?" active":""}`,title:m.description,onClick:()=>Be(m),children:m.name},m.id))}),(0,nt.jsxs)("div",{className:"fz-timeline",children:[(0,nt.jsxs)("div",{className:"fz-track",onPointerDown:m=>{let U=m.currentTarget.getBoundingClientRect();R(_c((m.clientX-U.left)/U.width,0,1)),m.currentTarget.setPointerCapture(m.pointerId)},onPointerMove:m=>{if(m.buttons!==1)return;let U=m.currentTarget.getBoundingClientRect();R(_c((m.clientX-U.left)/U.width,0,1))},children:[(0,nt.jsx)("div",{className:"fz-track-line"}),w.map((m,U)=>(0,nt.jsx)("button",{type:"button",className:`fz-kf${D===U?" selected":""}`,style:{left:`${m.time*100}%`},onPointerDown:z=>{z.stopPropagation(),L(U),R(m.time)},onClick:z=>z.stopPropagation(),"aria-label":`keyframe ${U+1} at ${Math.round(m.time*100)}%`},U)),(0,nt.jsx)("div",{className:"fz-head",style:{left:`${T*100}%`}})]}),(0,nt.jsxs)("div",{className:"fz-timeline-row",children:[(0,nt.jsxs)("span",{className:"fz-meta",children:[w.length," keyframes \xB7 ",P,"s",D!==null?` \xB7 keyframe ${D+1}: ${w[D].time===0||w[D].time===1?"endpoints stay":"drag the stage to change it"}`:" \xB7 tap a dot, drag the stage"]}),(0,nt.jsxs)("div",{className:"fz-timeline-actions",children:[(0,nt.jsx)("button",{type:"button",className:"fz-ghost",disabled:w.length>=C0,onClick:ke,children:"+ keyframe"}),(0,nt.jsx)("button",{type:"button",className:"fz-ghost",disabled:D===null||w[D]?.time===0||w[D]?.time===1,onClick:Je,children:"\u2212 remove"})]})]})]}),(0,nt.jsxs)("div",{className:"fz-render-row",children:[(0,nt.jsx)("div",{className:"fz-seg",children:[5,6].map(m=>(0,nt.jsxs)("button",{type:"button",className:P===m?"active":"",onClick:()=>G(m),children:[m,"s"]},m))}),(0,nt.jsx)("div",{className:"fz-seg",children:["480P","768P","1080P"].map(m=>(0,nt.jsx)("button",{type:"button",className:X===m?"active":"",onClick:()=>J(m),children:m==="480P"?"480":m==="768P"?"720":"1080"},m))}),(0,nt.jsx)("button",{type:"button",className:"fz-primary",disabled:d||!a||!i||M!==null,onClick:()=>void Le(),children:M?.kind==="render"||d?"freezing\u2026":"freeze it"})]})]}),t==="result"&&(0,nt.jsxs)("div",{className:"fz-stage",children:[C?(0,nt.jsxs)("div",{className:"fz-result",children:[(0,nt.jsx)("video",{className:"fz-video",src:C.outputUrl??void 0,controls:!0,playsInline:!0,loop:!0,autoPlay:!0,muted:!0,onError:Gt}),(0,nt.jsxs)("div",{className:"fz-actions",children:[(0,nt.jsx)("button",{type:"button",className:"fz-primary",disabled:d,onClick:()=>void O(C.jobId),children:"send to iMessage"}),(0,nt.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("camera"),children:"new camera move"})]})]}):c?(0,nt.jsx)("p",{className:"fz-sub",children:"rendering \u2014 this takes a few minutes"}):(0,nt.jsx)("p",{className:"fz-sub",children:"nothing rendered yet"}),jt.length>1&&(0,nt.jsx)("div",{className:"fz-history",children:jt.slice(0,-1).reverse().map(m=>(0,nt.jsxs)("div",{className:"fz-history-row",children:[(0,nt.jsx)("video",{className:"fz-thumb",src:m.outputUrl??void 0,muted:!0,playsInline:!0,preload:"metadata",onError:Gt}),(0,nt.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void O(m.jobId),children:"send"})]},m.jobId))})]}),(0,nt.jsx)("p",{className:"fz-line",children:b??""})]})}var y3=`
