...
}`,J2=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],K2=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],fM=new Ie,vc=new U,b0=new U;function j2(e,t,n){let i=new Jl,s=new It,a=new It,r=new Oe,o=new of,c=new lf,l={},h=n.maxTextureSize,p={[Ts]:An,[An]:Ts,[ti]:ti},u=new Qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new It},radius:{value:4}},vertexShader:Y2,fragmentShader:Z2}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let m=new Ve;m.setAttribute("position",new Jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new je(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=oc;let f=this.type;this.render=function(A,w,y){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||A.length===0)return;this.type===lS&&(Ot("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=oc);let M=e.getRenderTarget(),C=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),L=e.state;L.setBlending(Zi),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let P=f!==this.type;P&&w.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(B=>B.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,B=A.length;W<B;W++){let q=A[W],X=q.shadow;if(X===void 0){Ot("WebGLShadowMap:",q,"has no shadow.");continue}if(X.autoUpdate===!1&&X.needsUpdate===!1)continue;s.copy(X.mapSize);let tt=X.getFrameExtents();s.multiply(tt),a.copy(X.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/tt.x),s.x=a.x*tt.x,X.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/tt.y),s.y=a.y*tt.y,X.mapSize.y=a.y));let ot=e.state.buffers.depth.getReversed();if(X.camera._reversedDepth=ot,X.map===null||P===!0){if(X.map!==null&&(X.map.depthTexture!==null&&(X.map.depthTexture.dispose(),X.map.depthTexture=null),X.map.dispose()),this.type===xo){if(q.isPointLight){Ot("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}X.map=new Kn(s.x,s.y,{format:Sa,type:Ji,minFilter:dn,magFilter:dn,generateMipmaps:!1}),X.map.texture.name=q.name+".shadowMap",X.map.depthTexture=new As(s.x,s.y,wi),X.map.depthTexture.name=q.name+".shadowMapDepth",X.map.depthTexture.format=ki,X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=on,X.map.depthTexture.magFilter=on}else q.isPointLight?(X.map=new fd(s.x),X.map.depthTexture=new Kh(s.x,Ai)):(X.map=new Kn(s.x,s.y),X.map.depthTexture=new As(s.x,s.y,Ai)),X.map.depthTexture.name=q.name+".shadowMap",X.map.depthTexture.format=ki,this.type===oc?(X.map.depthTexture.compareFunction=ot?ld:od,X.map.depthTexture.minFilter=dn,X.map.depthTexture.magFilter=dn):(X.map.depthTexture.compareFunction=null,X.map.depthTexture.minFilter=on,X.map.depthTexture.magFilter=on);X.camera.updateProjectionMatrix()}let ut=X.map.isWebGLCubeRenderTarget?6:1;for(let dt=0;dt<ut;dt++){if(X.map.isWebGLCubeRenderTarget)e.setRenderTarget(X.map,dt),e.clear();else{dt===0&&(e.setRenderTarget(X.map),e.clear());let xt=X.getViewport(dt);r.set(a.x*xt.x,a.y*xt.y,a.x*xt.z,a.y*xt.w),L.viewport(r)}if(q.isPointLight){let xt=X.camera,Zt=X.matrix,se=q.distance||xt.far;se!==xt.far&&(xt.far=se,xt.updateProjectionMatrix()),vc.setFromMatrixPosition(q.matrixWorld),xt.position.copy(vc),b0.copy(xt.position),b0.add(J2[dt]),xt.up.copy(K2[dt]),xt.lookAt(b0),xt.updateMatrixWorld(),Zt.makeTranslation(-vc.x,-vc.y,-vc.z),fM.multiplyMatrices(xt.projectionMatrix,xt.matrixWorldInverse),X._frustum.setFromProjectionMatrix(fM,xt.coordinateSystem,xt.reversedDepth)}else X.updateMatrices(q);i=X.getFrustum(),v(w,y,X.camera,q,this.type)}X.isPointLightShadow!==!0&&this.type===xo&&_(X,y),X.needsUpdate=!1}f=this.type,g.needsUpdate=!1,e.setRenderTarget(M,C,D)};function _(A,w){let y=t.update(S);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Kn(s.x,s.y,{format:Sa,type:Ji})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,y,u,S,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,y,d,S,null)}function x(A,w,y,M){let C=null,D=y.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)C=D;else if(C=y.isPointLight===!0?c:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let L=C.uuid,P=w.uuid,W=l[L];W===void 0&&(W={},l[L]=W);let B=W[P];B===void 0&&(B=C.clone(),W[P]=B,w.addEventListener("dispose",T)),C=B}if(C.visible=w.visible,C.wireframe=w.wireframe,M===xo?C.side=w.shadowSide!==null?w.shadowSide:w.side:C.side=w.shadowSide!==null?w.shadowSide:p[w.side],C.alphaMap=w.alphaMap,C.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,C.map=w.map,C.clipShadows=w.clipShadows,C.clippingPlanes=w.clippingPlanes,C.clipIntersection=w.clipIntersection,C.displacementMap=w.displacementMap,C.displacementScale=w.displacementScale,C.displacementBias=w.displacementBias,C.wireframeLinewidth=w.wireframeLinewidth,C.linewidth=w.linewidth,y.isPointLight===!0&&C.isMeshDistanceMaterial===!0){let L=e.properties.get(C);L.light=y}return C}function v(A,w,y,M,C){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&C===xo)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,A.matrixWorld);let P=t.update(A),W=A.material;if(Array.isArray(W)){let B=P.groups;for(let q=0,X=B.length;q<X;q++){let tt=B[q],ot=W[tt.materialIndex];if(ot&&ot.visible){let ut=x(A,ot,M,C);A.onBeforeShadow(e,A,w,y,P,ut,tt),e.renderBufferDirect(y,null,P,ut,A,tt),A.onAfterShadow(e,A,w,y,P,ut,tt)}}}else if(W.visible){let B=x(A,W,M,C);A.onBeforeShadow(e,A,w,y,P,B,null),e.renderBufferDirect(y,null,P,B,A,null),A.onAfterShadow(e,A,w,y,P,B,null)}}let L=A.children;for(let P=0,W=L.length;P<W;P++)v(L[P],w,y,M,C)}function T(A){A.target.removeEventListener("dispose",T);for(let y in l){let M=l[y],C=A.target.uuid;C in M&&(M[C].dispose(),delete M[C])}}}function Q2(e,t){function n(){let N=!1,j=new Oe,V=null,lt=new Oe(0,0,0,0);return{setMask:function(mt){V!==mt&&!N&&(e.colorMask(mt,mt,mt,mt),V=mt)},setLocked:function(mt){N=mt},setClear:function(mt,nt,Et,Mt,Ae){Ae===!0&&(mt*=Mt,nt*=Mt,Et*=Mt),j.set(mt,nt,Et,Mt),lt.equals(j)===!1&&(e.clearColor(mt,nt,Et,Mt),lt.copy(j))},reset:function(){N=!1,V=null,lt.set(-1,0,0,0)}}}function i(){let N=!1,j=!1,V=null,lt=null,mt=null;return{setReversed:function(nt){if(j!==nt){let Et=t.get("EXT_clip_control");nt?Et.clipControlEXT(Et.LOWER_LEFT_EXT,Et.ZERO_TO_ONE_EXT):Et.clipControlEXT(Et.LOWER_LEFT_EXT,Et.NEGATIVE_ONE_TO_ONE_EXT),j=nt;let Mt=mt;mt=null,this.setClear(Mt)}},getReversed:function(){return j},setTest:function(nt){nt?st(e.DEPTH_TEST):Rt(e.DEPTH_TEST)},setMask:function(nt){V!==nt&&!N&&(e.depthMask(nt),V=nt)},setFunc:function(nt){if(j&&(nt=HS[nt]),lt!==nt){switch(nt){case Lh:e.depthFunc(e.NEVER);break;case Ih:e.depthFunc(e.ALWAYS);break;case Oh:e.depthFunc(e.LESS);break;case $a:e.depthFunc(e.LEQUAL);break;case Ph:e.depthFunc(e.EQUAL);break;case zh:e.depthFunc(e.GEQUAL);break;case Bh:e.depthFunc(e.GREATER);break;case Fh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}lt=nt}},setLocked:function(nt){N=nt},setClear:function(nt){mt!==nt&&(mt=nt,j&&(nt=1-nt),e.clearDepth(nt))},reset:function(){N=!1,V=null,lt=null,mt=null,j=!1}}}function s(){let N=!1,j=null,V=null,lt=null,mt=null,nt=null,Et=null,Mt=null,Ae=null;return{setTest:function(be){N||(be?st(e.STENCIL_TEST):Rt(e.STENCIL_TEST))},setMask:function(be){j!==be&&!N&&(e.stencilMask(be),j=be)},setFunc:function(be,Ci,Ri){(V!==be||lt!==Ci||mt!==Ri)&&(e.stencilFunc(be,Ci,Ri),V=be,lt=Ci,mt=Ri)},setOp:function(be,Ci,Ri){(nt!==be||Et!==Ci||Mt!==Ri)&&(e.stencilOp(be,Ci,Ri),nt=be,Et=Ci,Mt=Ri)},setLocked:function(be){N=be},setClear:function(be){Ae!==be&&(e.clearStencil(be),Ae=be)},reset:function(){N=!1,j=null,V=null,lt=null,mt=null,nt=null,Et=null,Mt=null,Ae=null}}}let a=new n,r=new i,o=new s,c=new WeakMap,l=new WeakMap,h={},p={},u={},d=new WeakMap,m=[],S=null,g=!1,f=null,_=null,x=null,v=null,T=null,A=null,w=null,y=new Qt(0,0,0),M=0,C=!1,D=null,L=null,P=null,W=null,B=null,q=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),X=!1,tt=0,ot=e.getParameter(e.VERSION);ot.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(ot)[1]),X=tt>=1):ot.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(ot)[1]),X=tt>=2);let ut=null,dt={},xt=e.getParameter(e.SCISSOR_BOX),Zt=e.getParameter(e.VIEWPORT),se=new Oe().fromArray(xt),$t=new Oe().fromArray(Zt);function Q(N,j,V,lt){let mt=new Uint8Array(4),nt=e.createTexture();e.bindTexture(N,nt),e.texParameteri(N,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(N,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Et=0;Et<V;Et++)N===e.TEXTURE_3D||N===e.TEXTURE_2D_ARRAY?e.texImage3D(j,0,e.RGBA,1,1,lt,0,e.RGBA,e.UNSIGNED_BYTE,mt):e.texImage2D(j+Et,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,mt);return nt}let it={};it[e.TEXTURE_2D]=Q(e.TEXTURE_2D,e.TEXTURE_2D,1),it[e.TEXTURE_CUBE_MAP]=Q(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),it[e.TEXTURE_2D_ARRAY]=Q(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),it[e.TEXTURE_3D]=Q(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),st(e.DEPTH_TEST),r.setFunc($a),ye(!1),ce(Gg),st(e.CULL_FACE),qt(Zi);function st(N){h[N]!==!0&&(e.enable(N),h[N]=!0)}function Rt(N){h[N]!==!1&&(e.disable(N),h[N]=!1)}function Lt(N,j){return u[N]!==j?(e.bindFramebuffer(N,j),u[N]=j,N===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=j),N===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=j),!0):!1}function Ct(N,j){let V=m,lt=!1;if(N){V=d.get(j),V===void 0&&(V=[],d.set(j,V));let mt=N.textures;if(V.length!==mt.length||V[0]!==e.COLOR_ATTACHMENT0){for(let nt=0,Et=mt.length;nt<Et;nt++)V[nt]=e.COLOR_ATTACHMENT0+nt;V.length=mt.length,lt=!0}}else V[0]!==e.BACK&&(V[0]=e.BACK,lt=!0);lt&&e.drawBuffers(V)}function Wt(N){return S!==N?(e.useProgram(N),S=N,!0):!1}let Nt={[ha]:e.FUNC_ADD,[uS]:e.FUNC_SUBTRACT,[hS]:e.FUNC_REVERSE_SUBTRACT};Nt[fS]=e.MIN,Nt[dS]=e.MAX;let Ft={[pS]:e.ZERO,[mS]:e.ONE,[gS]:e.SRC_COLOR,[Nh]:e.SRC_ALPHA,[SS]:e.SRC_ALPHA_SATURATE,[xS]:e.DST_COLOR,[vS]:e.DST_ALPHA,[_S]:e.ONE_MINUS_SRC_COLOR,[Uh]:e.ONE_MINUS_SRC_ALPHA,[bS]:e.ONE_MINUS_DST_COLOR,[yS]:e.ONE_MINUS_DST_ALPHA,[MS]:e.CONSTANT_COLOR,[ES]:e.ONE_MINUS_CONSTANT_COLOR,[TS]:e.CONSTANT_ALPHA,[AS]:e.ONE_MINUS_CONSTANT_ALPHA};function qt(N,j,V,lt,mt,nt,Et,Mt,Ae,be){if(N===Zi){g===!0&&(Rt(e.BLEND),g=!1);return}if(g===!1&&(st(e.BLEND),g=!0),N!==cS){if(N!==f||be!==C){if((_!==ha||T!==ha)&&(e.blendEquation(e.FUNC_ADD),_=ha,T=ha),be)switch(N){case Qa:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case kg:e.blendFunc(e.ONE,e.ONE);break;case Xg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Wg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Pt("WebGLState: Invalid blending: ",N);break}else switch(N){case Qa:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case kg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Xg:Pt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Wg:Pt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Pt("WebGLState: Invalid blending: ",N);break}x=null,v=null,A=null,w=null,y.set(0,0,0),M=0,f=N,C=be}return}mt=mt||j,nt=nt||V,Et=Et||lt,(j!==_||mt!==T)&&(e.blendEquationSeparate(Nt[j],Nt[mt]),_=j,T=mt),(V!==x||lt!==v||nt!==A||Et!==w)&&(e.blendFuncSeparate(Ft[V],Ft[lt],Ft[nt],Ft[Et]),x=V,v=lt,A=nt,w=Et),(Mt.equals(y)===!1||Ae!==M)&&(e.blendColor(Mt.r,Mt.g,Mt.b,Ae),y.copy(Mt),M=Ae),f=N,C=!1}function Bt(N,j){N.side===ti?Rt(e.CULL_FACE):st(e.CULL_FACE);let V=N.side===An;j&&(V=!V),ye(V),N.blending===Qa&&N.transparent===!1?qt(Zi):qt(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),r.setFunc(N.depthFunc),r.setTest(N.depthTest),r.setMask(N.depthWrite),a.setMask(N.colorWrite);let lt=N.stencilWrite;o.setTest(lt),lt&&(o.setMask(N.stencilWriteMask),o.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),o.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),Pe(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?st(e.SAMPLE_ALPHA_TO_COVERAGE):Rt(e.SAMPLE_ALPHA_TO_COVERAGE)}function ye(N){D!==N&&(N?e.frontFace(e.CW):e.frontFace(e.CCW),D=N)}function ce(N){N!==rS?(st(e.CULL_FACE),N!==L&&(N===Gg?e.cullFace(e.BACK):N===oS?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Rt(e.CULL_FACE),L=N}function He(N){N!==P&&(X&&e.lineWidth(N),P=N)}function Pe(N,j,V){N?(st(e.POLYGON_OFFSET_FILL),(W!==j||B!==V)&&(W=j,B=V,r.getReversed()&&(j=-j),e.polygonOffset(j,V))):Rt(e.POLYGON_OFFSET_FILL)}function xe(N){N?st(e.SCISSOR_TEST):Rt(e.SCISSOR_TEST)}function Te(N){N===void 0&&(N=e.TEXTURE0+q-1),ut!==N&&(e.activeTexture(N),ut=N)}function O(N,j,V){V===void 0&&(ut===null?V=e.TEXTURE0+q-1:V=ut);let lt=dt[V];lt===void 0&&(lt={type:void 0,texture:void 0},dt[V]=lt),(lt.type!==N||lt.texture!==j)&&(ut!==V&&(e.activeTexture(V),ut=V),e.bindTexture(N,j||it[N]),lt.type=N,lt.texture=j)}function pn(){let N=dt[ut];N!==void 0&&N.type!==void 0&&(e.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function re(){try{e.compressedTexImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function R(){try{e.compressedTexImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function b(){try{e.texSubImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function F(){try{e.texSubImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function k(){try{e.compressedTexSubImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function Z(){try{e.compressedTexSubImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function ct(){try{e.texStorage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function gt(){try{e.texStorage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function K(){try{e.texImage2D(...arguments)}catch(N){Pt("WebGLState:",N)}}function et(){try{e.texImage3D(...arguments)}catch(N){Pt("WebGLState:",N)}}function pt(N){return p[N]!==void 0?p[N]:e.getParameter(N)}function Tt(N,j){p[N]!==j&&(e.pixelStorei(N,j),p[N]=j)}function ft(N){se.equals(N)===!1&&(e.scissor(N.x,N.y,N.z,N.w),se.copy(N))}function ht(N){$t.equals(N)===!1&&(e.viewport(N.x,N.y,N.z,N.w),$t.copy(N))}function At(N,j){let V=l.get(j);V===void 0&&(V=new WeakMap,l.set(j,V));let lt=V.get(N);lt===void 0&&(lt=e.getUniformBlockIndex(j,N.name),V.set(N,lt))}function I(N,j){let lt=l.get(j).get(N);c.get(j)!==lt&&(e.uniformBlockBinding(j,lt,N.__bindingPointIndex),c.set(j,lt))}function $(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},ut=null,dt={},u={},d=new WeakMap,m=[],S=null,g=!1,f=null,_=null,x=null,v=null,T=null,A=null,w=null,y=new Qt(0,0,0),M=0,C=!1,D=null,L=null,P=null,W=null,B=null,se.set(0,0,e.canvas.width,e.canvas.height),$t.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:st,disable:Rt,bindFramebuffer:Lt,drawBuffers:Ct,useProgram:Wt,setBlending:qt,setMaterial:Bt,setFlipSided:ye,setCullFace:ce,setLineWidth:He,setPolygonOffset:Pe,setScissorTest:xe,activeTexture:Te,bindTexture:O,unbindTexture:pn,compressedTexImage2D:re,compressedTexImage3D:R,texImage2D:K,texImage3D:et,pixelStorei:Tt,getParameter:pt,updateUBOMapping:At,uniformBlockBinding:I,texStorage2D:ct,texStorage3D:gt,texSubImage2D:b,texSubImage3D:F,compressedTexSubImage2D:k,compressedTexSubImage3D:Z,scissor:ft,viewport:ht,reset:$}}function $2(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new It,h=new WeakMap,p=new Set,u,d=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(R,b){return m?new OffscreenCanvas(R,b):Hl("canvas")}function g(R,b,F){let k=1,Z=re(R);if((Z.width>F||Z.height>F)&&(k=F/Math.max(Z.width,Z.height)),k<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){let ct=Math.floor(k*Z.width),gt=Math.floor(k*Z.height);u===void 0&&(u=S(ct,gt));let K=b?S(ct,gt):u;return K.width=ct,K.height=gt,K.getContext("2d").drawImage(R,0,0,ct,gt),Ot("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+ct+"x"+gt+")."),K}else return"data"in R&&Ot("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),R;return R}function f(R){return R.generateMipmaps}function _(R){e.generateMipmap(R)}function x(R){return R.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?e.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function v(R,b,F,k,Z,ct=!1){if(R!==null){if(e[R]!==void 0)return e[R];Ot("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let gt;k&&(gt=t.get("EXT_texture_norm16"),gt||Ot("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let K=b;if(b===e.RED&&(F===e.FLOAT&&(K=e.R32F),F===e.HALF_FLOAT&&(K=e.R16F),F===e.UNSIGNED_BYTE&&(K=e.R8),F===e.UNSIGNED_SHORT&&gt&&(K=gt.R16_EXT),F===e.SHORT&&gt&&(K=gt.R16_SNORM_EXT)),b===e.RED_INTEGER&&(F===e.UNSIGNED_BYTE&&(K=e.R8UI),F===e.UNSIGNED_SHORT&&(K=e.R16UI),F===e.UNSIGNED_INT&&(K=e.R32UI),F===e.BYTE&&(K=e.R8I),F===e.SHORT&&(K=e.R16I),F===e.INT&&(K=e.R32I)),b===e.RG&&(F===e.FLOAT&&(K=e.RG32F),F===e.HALF_FLOAT&&(K=e.RG16F),F===e.UNSIGNED_BYTE&&(K=e.RG8),F===e.UNSIGNED_SHORT&&gt&&(K=gt.RG16_EXT),F===e.SHORT&&gt&&(K=gt.RG16_SNORM_EXT)),b===e.RG_INTEGER&&(F===e.UNSIGNED_BYTE&&(K=e.RG8UI),F===e.UNSIGNED_SHORT&&(K=e.RG16UI),F===e.UNSIGNED_INT&&(K=e.RG32UI),F===e.BYTE&&(K=e.RG8I),F===e.SHORT&&(K=e.RG16I),F===e.INT&&(K=e.RG32I)),b===e.RGB_INTEGER&&(F===e.UNSIGNED_BYTE&&(K=e.RGB8UI),F===e.UNSIGNED_SHORT&&(K=e.RGB16UI),F===e.UNSIGNED_INT&&(K=e.RGB32UI),F===e.BYTE&&(K=e.RGB8I),F===e.SHORT&&(K=e.RGB16I),F===e.INT&&(K=e.RGB32I)),b===e.RGBA_INTEGER&&(F===e.UNSIGNED_BYTE&&(K=e.RGBA8UI),F===e.UNSIGNED_SHORT&&(K=e.RGBA16UI),F===e.UNSIGNED_INT&&(K=e.RGBA32UI),F===e.BYTE&&(K=e.RGBA8I),F===e.SHORT&&(K=e.RGBA16I),F===e.INT&&(K=e.RGBA32I)),b===e.RGB&&(F===e.UNSIGNED_SHORT&&gt&&(K=gt.RGB16_EXT),F===e.SHORT&&gt&&(K=gt.RGB16_SNORM_EXT),F===e.UNSIGNED_INT_5_9_9_9_REV&&(K=e.RGB9_E5),F===e.UNSIGNED_INT_10F_11F_11F_REV&&(K=e.R11F_G11F_B10F)),b===e.RGBA){let et=ct?Fl:ee.getTransfer(Z);F===e.FLOAT&&(K=e.RGBA32F),F===e.HALF_FLOAT&&(K=e.RGBA16F),F===e.UNSIGNED_BYTE&&(K=et===ue?e.SRGB8_ALPHA8:e.RGBA8),F===e.UNSIGNED_SHORT&&gt&&(K=gt.RGBA16_EXT),F===e.SHORT&&gt&&(K=gt.RGBA16_SNORM_EXT),F===e.UNSIGNED_SHORT_4_4_4_4&&(K=e.RGBA4),F===e.UNSIGNED_SHORT_5_5_5_1&&(K=e.RGB5_A1)}return(K===e.R16F||K===e.R32F||K===e.RG16F||K===e.RG32F||K===e.RGBA16F||K===e.RGBA32F)&&t.get("EXT_color_buffer_float"),K}function T(R,b){let F;return R?b===null||b===Ai||b===So?F=e.DEPTH24_STENCIL8:b===wi?F=e.DEPTH32F_STENCIL8:b===bo&&(F=e.DEPTH24_STENCIL8,Ot("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Ai||b===So?F=e.DEPTH_COMPONENT24:b===wi?F=e.DEPTH_COMPONENT32F:b===bo&&(F=e.DEPTH_COMPONENT16),F}function A(R,b){return f(R)===!0||R.isFramebufferTexture&&R.minFilter!==on&&R.minFilter!==dn?Math.log2(Math.max(b.width,b.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?b.mipmaps.length:1}function w(R){let b=R.target;b.removeEventListener("dispose",w),M(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&p.delete(b)}function y(R){let b=R.target;b.removeEventListener("dispose",y),D(b)}function M(R){let b=i.get(R);if(b.__webglInit===void 0)return;let F=R.source,k=d.get(F);if(k){let Z=k[b.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&C(R),Object.keys(k).length===0&&d.delete(F)}i.remove(R)}function C(R){let b=i.get(R);e.deleteTexture(b.__webglTexture);let F=R.source,k=d.get(F);delete k[b.__cacheKey],r.memory.textures--}function D(R){let b=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(b.__webglFramebuffer[k]))for(let Z=0;Z<b.__webglFramebuffer[k].length;Z++)e.deleteFramebuffer(b.__webglFramebuffer[k][Z]);else e.deleteFramebuffer(b.__webglFramebuffer[k]);b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer[k])}else{if(Array.isArray(b.__webglFramebuffer))for(let k=0;k<b.__webglFramebuffer.length;k++)e.deleteFramebuffer(b.__webglFramebuffer[k]);else e.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&e.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let k=0;k<b.__webglColorRenderbuffer.length;k++)b.__webglColorRenderbuffer[k]&&e.deleteRenderbuffer(b.__webglColorRenderbuffer[k]);b.__webglDepthRenderbuffer&&e.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let F=R.textures;for(let k=0,Z=F.length;k<Z;k++){let ct=i.get(F[k]);ct.__webglTexture&&(e.deleteTexture(ct.__webglTexture),r.memory.textures--),i.remove(F[k])}i.remove(R)}let L=0;function P(){L=0}function W(){return L}function B(R){L=R}function q(){let R=L;return R>=s.maxTextures&&Ot("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),L+=1,R}function X(R){let b=[];return b.push(R.wrapS),b.push(R.wrapT),b.push(R.wrapR||0),b.push(R.magFilter),b.push(R.minFilter),b.push(R.anisotropy),b.push(R.internalFormat),b.push(R.format),b.push(R.type),b.push(R.generateMipmaps),b.push(R.premultiplyAlpha),b.push(R.flipY),b.push(R.unpackAlignment),b.push(R.colorSpace),b.join()}function tt(R,b){let F=i.get(R);if(R.isVideoTexture&&O(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&F.__version!==R.version){let k=R.image;if(k===null)Ot("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Ot("WebGLRenderer: Texture marked for update but image is incomplete");else{Rt(F,R,b);return}}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,F.__webglTexture,e.TEXTURE0+b)}function ot(R,b){let F=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){Rt(F,R,b);return}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,F.__webglTexture,e.TEXTURE0+b)}function ut(R,b){let F=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){Rt(F,R,b);return}n.bindTexture(e.TEXTURE_3D,F.__webglTexture,e.TEXTURE0+b)}function dt(R,b){let F=i.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&F.__version!==R.version){Lt(F,R,b);return}n.bindTexture(e.TEXTURE_CUBE_MAP,F.__webglTexture,e.TEXTURE0+b)}let xt={[Vh]:e.REPEAT,[Hi]:e.CLAMP_TO_EDGE,[Hh]:e.MIRRORED_REPEAT},Zt={[on]:e.NEAREST,[RS]:e.NEAREST_MIPMAP_NEAREST,[cc]:e.NEAREST_MIPMAP_LINEAR,[dn]:e.LINEAR,[Ef]:e.LINEAR_MIPMAP_NEAREST,[xa]:e.LINEAR_MIPMAP_LINEAR},se={[US]:e.NEVER,[zS]:e.ALWAYS,[LS]:e.LESS,[od]:e.LEQUAL,[IS]:e.EQUAL,[ld]:e.GEQUAL,[OS]:e.GREATER,[PS]:e.NOTEQUAL};function $t(R,b){if(b.type===wi&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===dn||b.magFilter===Ef||b.magFilter===cc||b.magFilter===xa||b.minFilter===dn||b.minFilter===Ef||b.minFilter===cc||b.minFilter===xa)&&Ot("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(R,e.TEXTURE_WRAP_S,xt[b.wrapS]),e.texParameteri(R,e.TEXTURE_WRAP_T,xt[b.wrapT]),(R===e.TEXTURE_3D||R===e.TEXTURE_2D_ARRAY)&&e.texParameteri(R,e.TEXTURE_WRAP_R,xt[b.wrapR]),e.texParameteri(R,e.TEXTURE_MAG_FILTER,Zt[b.magFilter]),e.texParameteri(R,e.TEXTURE_MIN_FILTER,Zt[b.minFilter]),b.compareFunction&&(e.texParameteri(R,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(R,e.TEXTURE_COMPARE_FUNC,se[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===on||b.minFilter!==cc&&b.minFilter!==xa||b.type===wi&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let F=t.get("EXT_texture_filter_anisotropic");e.texParameterf(R,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function Q(R,b){let F=!1;R.__webglInit===void 0&&(R.__webglInit=!0,b.addEventListener("dispose",w));let k=b.source,Z=d.get(k);Z===void 0&&(Z={},d.set(k,Z));let ct=X(b);if(ct!==R.__cacheKey){Z[ct]===void 0&&(Z[ct]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,F=!0),Z[ct].usedTimes++;let gt=Z[R.__cacheKey];gt!==void 0&&(Z[R.__cacheKey].usedTimes--,gt.usedTimes===0&&C(b)),R.__cacheKey=ct,R.__webglTexture=Z[ct].texture}return F}function it(R,b,F){return Math.floor(Math.floor(R/F)/b)}function st(R,b,F,k){let ct=R.updateRanges;if(ct.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,b.width,b.height,F,k,b.data);else{ct.sort((Tt,ft)=>Tt.start-ft.start);let gt=0;for(let Tt=1;Tt<ct.length;Tt++){let ft=ct[gt],ht=ct[Tt],At=ft.start+ft.count,I=it(ht.start,b.width,4),$=it(ft.start,b.width,4);ht.start<=At+1&&I===$&&it(ht.start+ht.count-1,b.width,4)===I?ft.count=Math.max(ft.count,ht.start+ht.count-ft.start):(++gt,ct[gt]=ht)}ct.length=gt+1;let K=n.getParameter(e.UNPACK_ROW_LENGTH),et=n.getParameter(e.UNPACK_SKIP_PIXELS),pt=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,b.width);for(let Tt=0,ft=ct.length;Tt<ft;Tt++){let ht=ct[Tt],At=Math.floor(ht.start/4),I=Math.ceil(ht.count/4),$=At%b.width,N=Math.floor(At/b.width),j=I,V=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,$),n.pixelStorei(e.UNPACK_SKIP_ROWS,N),n.texSubImage2D(e.TEXTURE_2D,0,$,N,j,V,F,k,b.data)}R.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,K),n.pixelStorei(e.UNPACK_SKIP_PIXELS,et),n.pixelStorei(e.UNPACK_SKIP_ROWS,pt)}}function Rt(R,b,F){let k=e.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(k=e.TEXTURE_2D_ARRAY),b.isData3DTexture&&(k=e.TEXTURE_3D);let Z=Q(R,b),ct=b.source;n.bindTexture(k,R.__webglTexture,e.TEXTURE0+F);let gt=i.get(ct);if(ct.version!==gt.__version||Z===!0){if(n.activeTexture(e.TEXTURE0+F),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){let V=ee.getPrimaries(ee.workingColorSpace),lt=b.colorSpace===ws?null:ee.getPrimaries(b.colorSpace),mt=b.colorSpace===ws||V===lt?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,mt)}n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment);let et=g(b.image,!1,s.maxTextureSize);et=pn(b,et);let pt=a.convert(b.format,b.colorSpace),Tt=a.convert(b.type),ft=v(b.internalFormat,pt,Tt,b.normalized,b.colorSpace,b.isVideoTexture);$t(k,b);let ht,At=b.mipmaps,I=b.isVideoTexture!==!0,$=gt.__version===void 0||Z===!0,N=ct.dataReady,j=A(b,et);if(b.isDepthTexture)ft=T(b.format===ba,b.type),$&&(I?n.texStorage2D(e.TEXTURE_2D,1,ft,et.width,et.height):n.texImage2D(e.TEXTURE_2D,0,ft,et.width,et.height,0,pt,Tt,null));else if(b.isDataTexture)if(At.length>0){I&&$&&n.texStorage2D(e.TEXTURE_2D,j,ft,At[0].width,At[0].height);for(let V=0,lt=At.length;V<lt;V++)ht=At[V],I?N&&n.texSubImage2D(e.TEXTURE_2D,V,0,0,ht.width,ht.height,pt,Tt,ht.data):n.texImage2D(e.TEXTURE_2D,V,ft,ht.width,ht.height,0,pt,Tt,ht.data);b.generateMipmaps=!1}else I?($&&n.texStorage2D(e.TEXTURE_2D,j,ft,et.width,et.height),N&&st(b,et,pt,Tt)):n.texImage2D(e.TEXTURE_2D,0,ft,et.width,et.height,0,pt,Tt,et.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){I&&$&&n.texStorage3D(e.TEXTURE_2D_ARRAY,j,ft,At[0].width,At[0].height,et.depth);for(let V=0,lt=At.length;V<lt;V++)if(ht=At[V],b.format!==_i)if(pt!==null)if(I){if(N)if(b.layerUpdates.size>0){let mt=m0(ht.width,ht.height,b.format,b.type);for(let nt of b.layerUpdates){let Et=ht.data.subarray(nt*mt/ht.data.BYTES_PER_ELEMENT,(nt+1)*mt/ht.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,V,0,0,nt,ht.width,ht.height,1,pt,Et)}b.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,V,0,0,0,ht.width,ht.height,et.depth,pt,ht.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,V,ft,ht.width,ht.height,et.depth,0,ht.data,0,0);else Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?N&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,V,0,0,0,ht.width,ht.height,et.depth,pt,Tt,ht.data):n.texImage3D(e.TEXTURE_2D_ARRAY,V,ft,ht.width,ht.height,et.depth,0,pt,Tt,ht.data)}else{I&&$&&n.texStorage2D(e.TEXTURE_2D,j,ft,At[0].width,At[0].height);for(let V=0,lt=At.length;V<lt;V++)ht=At[V],b.format!==_i?pt!==null?I?N&&n.compressedTexSubImage2D(e.TEXTURE_2D,V,0,0,ht.width,ht.height,pt,ht.data):n.compressedTexImage2D(e.TEXTURE_2D,V,ft,ht.width,ht.height,0,ht.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?N&&n.texSubImage2D(e.TEXTURE_2D,V,0,0,ht.width,ht.height,pt,Tt,ht.data):n.texImage2D(e.TEXTURE_2D,V,ft,ht.width,ht.height,0,pt,Tt,ht.data)}else if(b.isDataArrayTexture)if(I){if($&&n.texStorage3D(e.TEXTURE_2D_ARRAY,j,ft,et.width,et.height,et.depth),N)if(b.layerUpdates.size>0){let V=m0(et.width,et.height,b.format,b.type);for(let lt of b.layerUpdates){let mt=et.data.subarray(lt*V/et.data.BYTES_PER_ELEMENT,(lt+1)*V/et.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,lt,et.width,et.height,1,pt,Tt,mt)}b.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,pt,Tt,et.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,ft,et.width,et.height,et.depth,0,pt,Tt,et.data);else if(b.isData3DTexture)I?($&&n.texStorage3D(e.TEXTURE_3D,j,ft,et.width,et.height,et.depth),N&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,pt,Tt,et.data)):n.texImage3D(e.TEXTURE_3D,0,ft,et.width,et.height,et.depth,0,pt,Tt,et.data);else if(b.isFramebufferTexture){if($)if(I)n.texStorage2D(e.TEXTURE_2D,j,ft,et.width,et.height);else{let V=et.width,lt=et.height;for(let mt=0;mt<j;mt++)n.texImage2D(e.TEXTURE_2D,mt,ft,V,lt,0,pt,Tt,null),V>>=1,lt>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in e){let V=e.canvas;if(V.hasAttribute("layoutsubtree")||V.setAttribute("layoutsubtree","true"),et.parentNode!==V){V.appendChild(et),p.add(b),V.onpaint=lt=>{let mt=lt.changedElements;for(let nt of p)mt.includes(nt.image)&&(nt.needsUpdate=!0)},V.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,et);else{let mt=e.RGBA,nt=e.RGBA,Et=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,mt,nt,Et,et)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(At.length>0){if(I&&$){let V=re(At[0]);n.texStorage2D(e.TEXTURE_2D,j,ft,V.width,V.height)}for(let V=0,lt=At.length;V<lt;V++)ht=At[V],I?N&&n.texSubImage2D(e.TEXTURE_2D,V,0,0,pt,Tt,ht):n.texImage2D(e.TEXTURE_2D,V,ft,pt,Tt,ht);b.generateMipmaps=!1}else if(I){if($){let V=re(et);n.texStorage2D(e.TEXTURE_2D,j,ft,V.width,V.height)}N&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,pt,Tt,et)}else n.texImage2D(e.TEXTURE_2D,0,ft,pt,Tt,et);f(b)&&_(k),gt.__version=ct.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function Lt(R,b,F){if(b.image.length!==6)return;let k=Q(R,b),Z=b.source;n.bindTexture(e.TEXTURE_CUBE_MAP,R.__webglTexture,e.TEXTURE0+F);let ct=i.get(Z);if(Z.version!==ct.__version||k===!0){n.activeTexture(e.TEXTURE0+F);let gt=ee.getPrimaries(ee.workingColorSpace),K=b.colorSpace===ws?null:ee.getPrimaries(b.colorSpace),et=b.colorSpace===ws||gt===K?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);let pt=b.isCompressedTexture||b.image[0].isCompressedTexture,Tt=b.image[0]&&b.image[0].isDataTexture,ft=[];for(let nt=0;nt<6;nt++)!pt&&!Tt?ft[nt]=g(b.image[nt],!0,s.maxCubemapSize):ft[nt]=Tt?b.image[nt].image:b.image[nt],ft[nt]=pn(b,ft[nt]);let ht=ft[0],At=a.convert(b.format,b.colorSpace),I=a.convert(b.type),$=v(b.internalFormat,At,I,b.normalized,b.colorSpace),N=b.isVideoTexture!==!0,j=ct.__version===void 0||k===!0,V=Z.dataReady,lt=A(b,ht);$t(e.TEXTURE_CUBE_MAP,b);let mt;if(pt){N&&j&&n.texStorage2D(e.TEXTURE_CUBE_MAP,lt,$,ht.width,ht.height);for(let nt=0;nt<6;nt++){mt=ft[nt].mipmaps;for(let Et=0;Et<mt.length;Et++){let Mt=mt[Et];b.format!==_i?At!==null?N?V&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et,0,0,Mt.width,Mt.height,At,Mt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et,$,Mt.width,Mt.height,0,Mt.data):Ot("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et,0,0,Mt.width,Mt.height,At,I,Mt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et,$,Mt.width,Mt.height,0,At,I,Mt.data)}}}else{if(mt=b.mipmaps,N&&j){mt.length>0&&lt++;let nt=re(ft[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,lt,$,nt.width,nt.height)}for(let nt=0;nt<6;nt++)if(Tt){N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,ft[nt].width,ft[nt].height,At,I,ft[nt].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,$,ft[nt].width,ft[nt].height,0,At,I,ft[nt].data);for(let Et=0;Et<mt.length;Et++){let Ae=mt[Et].image[nt].image;N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et+1,0,0,Ae.width,Ae.height,At,I,Ae.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et+1,$,Ae.width,Ae.height,0,At,I,Ae.data)}}else{N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,0,0,At,I,ft[nt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,$,At,I,ft[nt]);for(let Et=0;Et<mt.length;Et++){let Mt=mt[Et];N?V&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et+1,0,0,At,I,Mt.image[nt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,Et+1,$,At,I,Mt.image[nt])}}}f(b)&&_(e.TEXTURE_CUBE_MAP),ct.__version=Z.version,b.onUpdate&&b.onUpdate(b)}R.__version=b.version}function Ct(R,b,F,k,Z,ct){let gt=a.convert(F.format,F.colorSpace),K=a.convert(F.type),et=v(F.internalFormat,gt,K,F.normalized,F.colorSpace),pt=i.get(b),Tt=i.get(F);if(Tt.__renderTarget=b,!pt.__hasExternalTextures){let ft=Math.max(1,b.width>>ct),ht=Math.max(1,b.height>>ct);Z===e.TEXTURE_3D||Z===e.TEXTURE_2D_ARRAY?n.texImage3D(Z,ct,et,ft,ht,b.depth,0,gt,K,null):n.texImage2D(Z,ct,et,ft,ht,0,gt,K,null)}n.bindFramebuffer(e.FRAMEBUFFER,R),Te(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,k,Z,Tt.__webglTexture,0,xe(b)):(Z===e.TEXTURE_2D||Z>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,k,Z,Tt.__webglTexture,ct),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Wt(R,b,F){if(e.bindRenderbuffer(e.RENDERBUFFER,R),b.depthBuffer){let k=b.depthTexture,Z=k&&k.isDepthTexture?k.type:null,ct=T(b.stencilBuffer,Z),gt=b.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Te(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,xe(b),ct,b.width,b.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,xe(b),ct,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,ct,b.width,b.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,gt,e.RENDERBUFFER,R)}else{let k=b.textures;for(let Z=0;Z<k.length;Z++){let ct=k[Z],gt=a.convert(ct.format,ct.colorSpace),K=a.convert(ct.type),et=v(ct.internalFormat,gt,K,ct.normalized,ct.colorSpace);Te(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,xe(b),et,b.width,b.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,xe(b),et,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,et,b.width,b.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Nt(R,b,F){let k=b.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,R),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Z=i.get(b.depthTexture);if(Z.__renderTarget=b,(!Z.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),k){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),Z.__webglTexture===void 0){Z.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,Z.__webglTexture),$t(e.TEXTURE_CUBE_MAP,b.depthTexture);let pt=a.convert(b.depthTexture.format),Tt=a.convert(b.depthTexture.type),ft;b.depthTexture.format===ki?ft=e.DEPTH_COMPONENT24:b.depthTexture.format===ba&&(ft=e.DEPTH24_STENCIL8);for(let ht=0;ht<6;ht++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0,ft,b.width,b.height,0,pt,Tt,null)}}else tt(b.depthTexture,0);let ct=Z.__webglTexture,gt=xe(b),K=k?e.TEXTURE_CUBE_MAP_POSITIVE_X+F:e.TEXTURE_2D,et=b.depthTexture.format===ba?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(b.depthTexture.format===ki)Te(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,K,ct,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,K,ct,0);else if(b.depthTexture.format===ba)Te(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,K,ct,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,K,ct,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ft(R){let b=i.get(R),F=R.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==R.depthTexture){let k=R.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),k){let Z=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,k.removeEventListener("dispose",Z)};k.addEventListener("dispose",Z),b.__depthDisposeCallback=Z}b.__boundDepthTexture=k}if(R.depthTexture&&!b.__autoAllocateDepthBuffer)if(F)for(let k=0;k<6;k++)Nt(b.__webglFramebuffer[k],R,k);else{let k=R.texture.mipmaps;k&&k.length>0?Nt(b.__webglFramebuffer[0],R,0):Nt(b.__webglFramebuffer,R,0)}else if(F){b.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[k]),b.__webglDepthbuffer[k]===void 0)b.__webglDepthbuffer[k]=e.createRenderbuffer(),Wt(b.__webglDepthbuffer[k],R,!1);else{let Z=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ct=b.__webglDepthbuffer[k];e.bindRenderbuffer(e.RENDERBUFFER,ct),e.framebufferRenderbuffer(e.FRAMEBUFFER,Z,e.RENDERBUFFER,ct)}}else{let k=R.texture.mipmaps;if(k&&k.length>0?n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=e.createRenderbuffer(),Wt(b.__webglDepthbuffer,R,!1);else{let Z=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ct=b.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,ct),e.framebufferRenderbuffer(e.FRAMEBUFFER,Z,e.RENDERBUFFER,ct)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function qt(R,b,F){let k=i.get(R);b!==void 0&&Ct(k.__webglFramebuffer,R,R.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),F!==void 0&&Ft(R)}function Bt(R){let b=R.texture,F=i.get(R),k=i.get(b);R.addEventListener("dispose",y);let Z=R.textures,ct=R.isWebGLCubeRenderTarget===!0,gt=Z.length>1;if(gt||(k.__webglTexture===void 0&&(k.__webglTexture=e.createTexture()),k.__version=b.version,r.memory.textures++),ct){F.__webglFramebuffer=[];for(let K=0;K<6;K++)if(b.mipmaps&&b.mipmaps.length>0){F.__webglFramebuffer[K]=[];for(let et=0;et<b.mipmaps.length;et++)F.__webglFramebuffer[K][et]=e.createFramebuffer()}else F.__webglFramebuffer[K]=e.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){F.__webglFramebuffer=[];for(let K=0;K<b.mipmaps.length;K++)F.__webglFramebuffer[K]=e.createFramebuffer()}else F.__webglFramebuffer=e.createFramebuffer();if(gt)for(let K=0,et=Z.length;K<et;K++){let pt=i.get(Z[K]);pt.__webglTexture===void 0&&(pt.__webglTexture=e.createTexture(),r.memory.textures++)}if(R.samples>0&&Te(R)===!1){F.__webglMultisampledFramebuffer=e.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let K=0;K<Z.length;K++){let et=Z[K];F.__webglColorRenderbuffer[K]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,F.__webglColorRenderbuffer[K]);let pt=a.convert(et.format,et.colorSpace),Tt=a.convert(et.type),ft=v(et.internalFormat,pt,Tt,et.normalized,et.colorSpace,R.isXRRenderTarget===!0),ht=xe(R);e.renderbufferStorageMultisample(e.RENDERBUFFER,ht,ft,R.width,R.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+K,e.RENDERBUFFER,F.__webglColorRenderbuffer[K])}e.bindRenderbuffer(e.RENDERBUFFER,null),R.depthBuffer&&(F.__webglDepthRenderbuffer=e.createRenderbuffer(),Wt(F.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(ct){n.bindTexture(e.TEXTURE_CUBE_MAP,k.__webglTexture),$t(e.TEXTURE_CUBE_MAP,b);for(let K=0;K<6;K++)if(b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)Ct(F.__webglFramebuffer[K][et],R,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+K,et);else Ct(F.__webglFramebuffer[K],R,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+K,0);f(b)&&_(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(gt){for(let K=0,et=Z.length;K<et;K++){let pt=Z[K],Tt=i.get(pt),ft=e.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ft=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ft,Tt.__webglTexture),$t(ft,pt),Ct(F.__webglFramebuffer,R,pt,e.COLOR_ATTACHMENT0+K,ft,0),f(pt)&&_(ft)}n.unbindTexture()}else{let K=e.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(K=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(K,k.__webglTexture),$t(K,b),b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)Ct(F.__webglFramebuffer[et],R,b,e.COLOR_ATTACHMENT0,K,et);else Ct(F.__webglFramebuffer,R,b,e.COLOR_ATTACHMENT0,K,0);f(b)&&_(K),n.unbindTexture()}R.depthBuffer&&Ft(R)}function ye(R){let b=R.textures;for(let F=0,k=b.length;F<k;F++){let Z=b[F];if(f(Z)){let ct=x(R),gt=i.get(Z).__webglTexture;n.bindTexture(ct,gt),_(ct),n.unbindTexture()}}}let ce=[],He=[];function Pe(R){if(R.samples>0){if(Te(R)===!1){let b=R.textures,F=R.width,k=R.height,Z=e.COLOR_BUFFER_BIT,ct=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,gt=i.get(R),K=b.length>1;if(K)for(let pt=0;pt<b.length;pt++)n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+pt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+pt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);let et=R.texture.mipmaps;et&&et.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let pt=0;pt<b.length;pt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(Z|=e.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(Z|=e.STENCIL_BUFFER_BIT)),K){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,gt.__webglColorRenderbuffer[pt]);let Tt=i.get(b[pt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,Tt,0)}e.blitFramebuffer(0,0,F,k,0,0,F,k,Z,e.NEAREST),c===!0&&(ce.length=0,He.length=0,ce.push(e.COLOR_ATTACHMENT0+pt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(ce.push(ct),He.push(ct),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,He)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,ce))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),K)for(let pt=0;pt<b.length;pt++){n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+pt,e.RENDERBUFFER,gt.__webglColorRenderbuffer[pt]);let Tt=i.get(b[pt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+pt,e.TEXTURE_2D,Tt,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&c){let b=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[b])}}}function xe(R){return Math.min(s.maxSamples,R.samples)}function Te(R){let b=i.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function O(R){let b=r.render.frame;h.get(R)!==b&&(h.set(R,b),R.update())}function pn(R,b){let F=R.colorSpace,k=R.format,Z=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||F!==Bl&&F!==ws&&(ee.getTransfer(F)===ue?(k!==_i||Z!==ei)&&Ot("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Pt("WebGLTextures: Unsupported texture color space:",F)),b}function re(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=q,this.resetTextureUnits=P,this.getTextureUnits=W,this.setTextureUnits=B,this.setTexture2D=tt,this.setTexture2DArray=ot,this.setTexture3D=ut,this.setTextureCube=dt,this.rebindTextures=qt,this.setupRenderTarget=Bt,this.updateRenderTargetMipmap=ye,this.updateMultisampleRenderTarget=Pe,this.setupDepthRenderbuffer=Ft,this.setupFrameBufferTexture=Ct,this.useMultisampledRTT=Te,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function t3(e,t){function n(i,s=ws){let a,r=ee.getTransfer(s);if(i===ei)return e.UNSIGNED_BYTE;if(i===Af)return e.UNSIGNED_SHORT_4_4_4_4;if(i===wf)return e.UNSIGNED_SHORT_5_5_5_1;if(i===i0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===s0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===e0)return e.BYTE;if(i===n0)return e.SHORT;if(i===bo)return e.UNSIGNED_SHORT;if(i===Tf)return e.INT;if(i===Ai)return e.UNSIGNED_INT;if(i===wi)return e.FLOAT;if(i===Ji)return e.HALF_FLOAT;if(i===a0)return e.ALPHA;if(i===r0)return e.RGB;if(i===_i)return e.RGBA;if(i===ki)return e.DEPTH_COMPONENT;if(i===ba)return e.DEPTH_STENCIL;if(i===o0)return e.RED;if(i===Cf)return e.RED_INTEGER;if(i===Sa)return e.RG;if(i===Rf)return e.RG_INTEGER;if(i===Df)return e.RGBA_INTEGER;if(i===uc||i===hc||i===fc||i===dc)if(r===ue)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===uc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===hc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===dc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===uc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===hc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===dc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Nf||i===Uf||i===Lf||i===If)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Nf)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===If)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Of||i===Pf||i===zf||i===Bf||i===Ff||i===pc||i===Vf)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Of||i===Pf)return r===ue?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===zf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Bf)return a.COMPRESSED_R11_EAC;if(i===Ff)return a.COMPRESSED_SIGNED_R11_EAC;if(i===pc)return a.COMPRESSED_RG11_EAC;if(i===Vf)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f||i===td)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Hf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Gf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===kf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Xf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Wf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===qf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Yf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Zf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Jf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Kf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===jf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Qf)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===$f)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===td)return r===ue?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===ed||i===nd||i===id)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===ed)return r===ue?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===nd)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===id)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===sd||i===ad||i===mc||i===rd)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===sd)return a.COMPRESSED_RED_RGTC1_EXT;if(i===ad)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===mc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===rd)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===So?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var e3=`
void main() {
...
}`,R0=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new jl(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new Qn({vertexShader:e3,fragmentShader:n3,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new je(new ma(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},D0=class extends Xi{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",c=1,l=null,h=null,p=null,u=null,d=null,m=null,S=typeof XRWebGLBinding<"u",g=new R0,f={},_=n.getContextAttributes(),x=null,v=null,T=[],A=[],w=new It,y=null,M=new yn;M.viewport=new Oe;let C=new yn;C.viewport=new Oe;let D=[M,C],L=new xf,P=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let it=T[Q];return it===void 0&&(it=new mo,T[Q]=it),it.getTargetRaySpace()},this.getControllerGrip=function(Q){let it=T[Q];return it===void 0&&(it=new mo,T[Q]=it),it.getGripSpace()},this.getHand=function(Q){let it=T[Q];return it===void 0&&(it=new mo,T[Q]=it),it.getHandSpace()};function B(Q){let it=A.indexOf(Q.inputSource);if(it===-1)return;let st=T[it];st!==void 0&&(st.update(Q.inputSource,Q.frame,l||r),st.dispatchEvent({type:Q.type,data:Q.inputSource}))}function q(){s.removeEventListener("select",B),s.removeEventListener("selectstart",B),s.removeEventListener("selectend",B),s.removeEventListener("squeeze",B),s.removeEventListener("squeezestart",B),s.removeEventListener("squeezeend",B),s.removeEventListener("end",q),s.removeEventListener("inputsourceschange",X);for(let Q=0;Q<T.length;Q++){let it=A[Q];it!==null&&(A[Q]=null,T[Q].disconnect(it))}P=null,W=null,g.reset();for(let Q in f)delete f[Q];t.setRenderTarget(x),d=null,u=null,p=null,s=null,v=null,$t.stop(),i.isPresenting=!1,t.setPixelRatio(y),t.setSize(w.width,w.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){a=Q,i.isPresenting===!0&&Ot("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){o=Q,i.isPresenting===!0&&Ot("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||r},this.setReferenceSpace=function(Q){l=Q},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return p===null&&S&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return m},this.getSession=function(){return s},this.setSession=async function(Q){if(s=Q,s!==null){if(x=t.getRenderTarget(),s.addEventListener("select",B),s.addEventListener("selectstart",B),s.addEventListener("selectend",B),s.addEventListener("squeeze",B),s.addEventListener("squeezestart",B),s.addEventListener("squeezeend",B),s.addEventListener("end",q),s.addEventListener("inputsourceschange",X),_.xrCompatible!==!0&&await n.makeXRCompatible(),y=t.getPixelRatio(),t.getSize(w),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let st=null,Rt=null,Lt=null;_.depth&&(Lt=_.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,st=_.stencil?ba:ki,Rt=_.stencil?So:Ai);let Ct={colorFormat:n.RGBA8,depthFormat:Lt,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(Ct),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),v=new Kn(u.textureWidth,u.textureHeight,{format:_i,type:ei,depthTexture:new As(u.textureWidth,u.textureHeight,Rt,void 0,void 0,void 0,void 0,void 0,void 0,st),stencilBuffer:_.stencil,colorSpace:t.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let st={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(s,n,st),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),v=new Kn(d.framebufferWidth,d.framebufferHeight,{format:_i,type:ei,colorSpace:t.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(c),l=null,r=await s.requestReferenceSpace(o),$t.setContext(s),$t.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function X(Q){for(let it=0;it<Q.removed.length;it++){let st=Q.removed[it],Rt=A.indexOf(st);Rt>=0&&(A[Rt]=null,T[Rt].disconnect(st))}for(let it=0;it<Q.added.length;it++){let st=Q.added[it],Rt=A.indexOf(st);if(Rt===-1){for(let Ct=0;Ct<T.length;Ct++)if(Ct>=A.length){A.push(st),Rt=Ct;break}else if(A[Ct]===null){A[Ct]=st,Rt=Ct;break}if(Rt===-1)break}let Lt=T[Rt];Lt&&Lt.connect(st)}}let tt=new U,ot=new U;function ut(Q,it,st){tt.setFromMatrixPosition(it.matrixWorld),ot.setFromMatrixPosition(st.matrixWorld);let Rt=tt.distanceTo(ot),Lt=it.projectionMatrix.elements,Ct=st.projectionMatrix.elements,Wt=Lt[14]/(Lt[10]-1),Nt=Lt[14]/(Lt[10]+1),Ft=(Lt[9]+1)/Lt[5],qt=(Lt[9]-1)/Lt[5],Bt=(Lt[8]-1)/Lt[0],ye=(Ct[8]+1)/Ct[0],ce=Wt*Bt,He=Wt*ye,Pe=Rt/(-Bt+ye),xe=Pe*-Bt;if(it.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(xe),Q.translateZ(Pe),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),Lt[10]===-1)Q.projectionMatrix.copy(it.projectionMatrix),Q.projectionMatrixInverse.copy(it.projectionMatrixInverse);else{let Te=Wt+Pe,O=Nt+Pe,pn=ce-xe,re=He+(Rt-xe),R=Ft*Nt/O*Te,b=qt*Nt/O*Te;Q.projectionMatrix.makePerspective(pn,re,R,b,Te,O),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function dt(Q,it){it===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(it.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(s===null)return;let it=Q.near,st=Q.far;g.texture!==null&&(g.depthNear>0&&(it=g.depthNear),g.depthFar>0&&(st=g.depthFar)),L.near=C.near=M.near=it,L.far=C.far=M.far=st,(P!==L.near||W!==L.far)&&(s.updateRenderState({depthNear:L.near,depthFar:L.far}),P=L.near,W=L.far),L.layers.mask=Q.layers.mask|6,M.layers.mask=L.layers.mask&-5,C.layers.mask=L.layers.mask&-3;let Rt=Q.parent,Lt=L.cameras;dt(L,Rt);for(let Ct=0;Ct<Lt.length;Ct++)dt(Lt[Ct],Rt);Lt.length===2?ut(L,M,C):L.projectionMatrix.copy(M.projectionMatrix),xt(Q,L,Rt)};function xt(Q,it,st){st===null?Q.matrix.copy(it.matrixWorld):(Q.matrix.copy(st.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(it.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(it.projectionMatrix),Q.projectionMatrixInverse.copy(it.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=kh*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return L},this.getFoveation=function(){if(!(u===null&&d===null))return c},this.setFoveation=function(Q){c=Q,u!==null&&(u.fixedFoveation=Q),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=Q)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(L)},this.getCameraTexture=function(Q){return f[Q]};let Zt=null;function se(Q,it){if(h=it.getViewerPose(l||r),m=it,h!==null){let st=h.views;d!==null&&(t.setRenderTargetFramebuffer(v,d.framebuffer),t.setRenderTarget(v));let Rt=!1;st.length!==L.cameras.length&&(L.cameras.length=0,Rt=!0);for(let Nt=0;Nt<st.length;Nt++){let Ft=st[Nt],qt=null;if(d!==null)qt=d.getViewport(Ft);else{let ye=p.getViewSubImage(u,Ft);qt=ye.viewport,Nt===0&&(t.setRenderTargetTextures(v,ye.colorTexture,ye.depthStencilTexture),t.setRenderTarget(v))}let Bt=D[Nt];Bt===void 0&&(Bt=new yn,Bt.layers.enable(Nt),Bt.viewport=new Oe,D[Nt]=Bt),Bt.matrix.fromArray(Ft.transform.matrix),Bt.matrix.decompose(Bt.position,Bt.quaternion,Bt.scale),Bt.projectionMatrix.fromArray(Ft.projectionMatrix),Bt.projectionMatrixInverse.copy(Bt.projectionMatrix).invert(),Bt.viewport.set(qt.x,qt.y,qt.width,qt.height),Nt===0&&(L.matrix.copy(Bt.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale)),Rt===!0&&L.cameras.push(Bt)}let Lt=s.enabledFeatures;if(Lt&&Lt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&S){p=i.getBinding();let Nt=p.getDepthInformation(st[0]);Nt&&Nt.isValid&&Nt.texture&&g.init(Nt,s.renderState)}if(Lt&&Lt.includes("camera-access")&&S){t.state.unbindTexture(),p=i.getBinding();for(let Nt=0;Nt<st.length;Nt++){let Ft=st[Nt].camera;if(Ft){let qt=f[Ft];qt||(qt=new jl,f[Ft]=qt);let Bt=p.getCameraImage(Ft);qt.sourceTexture=Bt}}}}for(let st=0;st<T.length;st++){let Rt=A[st],Lt=T[st];Rt!==null&&Lt!==void 0&&Lt.update(Rt,it,l||r)}Zt&&Zt(Q,it),it.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:it}),m=null}let $t=new dM;$t.setAnimationLoop(se),this.setAnimationLoop=function(Q){Zt=Q},this.dispose=function(){}}},i3=new Ie,yM=new Vt;yM.set(-1,0,0,0,1,0,0,0,1);function s3(e,t){function n(g,f){g.matrixAutoUpdate===!0&&g.updateMatrix(),f.value.copy(g.matrix)}function i(g,f){f.color.getRGB(g.fogColor.value,f0(e)),f.isFog?(g.fogNear.value=f.near,g.fogFar.value=f.far):f.isFogExp2&&(g.fogDensity.value=f.density)}function s(g,f,_,x,v){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?a(g,f):f.isMeshLambertMaterial?(a(g,f),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(a(g,f),p(g,f)):f.isMeshPhongMaterial?(a(g,f),h(g,f),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(a(g,f),u(g,f),f.isMeshPhysicalMaterial&&d(g,f,v)):f.isMeshMatcapMaterial?(a(g,f),m(g,f)):f.isMeshDepthMaterial?a(g,f):f.isMeshDistanceMaterial?(a(g,f),S(g,f)):f.isMeshNormalMaterial?a(g,f):f.isLineBasicMaterial?(r(g,f),f.isLineDashedMaterial&&o(g,f)):f.isPointsMaterial?c(g,f,_,x):f.isSpriteMaterial?l(g,f):f.isShadowMaterial?(g.color.value.copy(f.color),g.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(g,f){g.opacity.value=f.opacity,f.color&&g.diffuse.value.copy(f.color),f.emissive&&g.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(g.map.value=f.map,n(f.map,g.mapTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.bumpMap&&(g.bumpMap.value=f.bumpMap,n(f.bumpMap,g.bumpMapTransform),g.bumpScale.value=f.bumpScale,f.side===An&&(g.bumpScale.value*=-1)),f.normalMap&&(g.normalMap.value=f.normalMap,n(f.normalMap,g.normalMapTransform),g.normalScale.value.copy(f.normalScale),f.side===An&&g.normalScale.value.negate()),f.displacementMap&&(g.displacementMap.value=f.displacementMap,n(f.displacementMap,g.displacementMapTransform),g.displacementScale.value=f.displacementScale,g.displacementBias.value=f.displacementBias),f.emissiveMap&&(g.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,g.emissiveMapTransform)),f.specularMap&&(g.specularMap.value=f.specularMap,n(f.specularMap,g.specularMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest);let _=t.get(f),x=_.envMap,v=_.envMapRotation;x&&(g.envMap.value=x,g.envMapRotation.value.setFromMatrix4(i3.makeRotationFromEuler(v)).transpose(),x.isCubeTexture&&x.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(yM),g.reflectivity.value=f.reflectivity,g.ior.value=f.ior,g.refractionRatio.value=f.refractionRatio),f.lightMap&&(g.lightMap.value=f.lightMap,g.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,g.lightMapTransform)),f.aoMap&&(g.aoMap.value=f.aoMap,g.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,g.aoMapTransform))}function r(g,f){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,f.map&&(g.map.value=f.map,n(f.map,g.mapTransform))}function o(g,f){g.dashSize.value=f.dashSize,g.totalSize.value=f.dashSize+f.gapSize,g.scale.value=f.scale}function c(g,f,_,x){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,g.size.value=f.size*_,g.scale.value=x*.5,f.map&&(g.map.value=f.map,n(f.map,g.uvTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest)}function l(g,f){g.diffuse.value.copy(f.color),g.opacity.value=f.opacity,g.rotation.value=f.rotation,f.map&&(g.map.value=f.map,n(f.map,g.mapTransform)),f.alphaMap&&(g.alphaMap.value=f.alphaMap,n(f.alphaMap,g.alphaMapTransform)),f.alphaTest>0&&(g.alphaTest.value=f.alphaTest)}function h(g,f){g.specular.value.copy(f.specular),g.shininess.value=Math.max(f.shininess,1e-4)}function p(g,f){f.gradientMap&&(g.gradientMap.value=f.gradientMap)}function u(g,f){g.metalness.value=f.metalness,f.metalnessMap&&(g.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,g.metalnessMapTransform)),g.roughness.value=f.roughness,f.roughnessMap&&(g.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,g.roughnessMapTransform)),f.envMap&&(g.envMapIntensity.value=f.envMapIntensity)}function d(g,f,_){g.ior.value=f.ior,f.sheen>0&&(g.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),g.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(g.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,g.sheenColorMapTransform)),f.sheenRoughnessMap&&(g.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,g.sheenRoughnessMapTransform))),f.clearcoat>0&&(g.clearcoat.value=f.clearcoat,g.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(g.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,g.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(g.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===An&&g.clearcoatNormalScale.value.negate())),f.dispersion>0&&(g.dispersion.value=f.dispersion),f.iridescence>0&&(g.iridescence.value=f.iridescence,g.iridescenceIOR.value=f.iridescenceIOR,g.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(g.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,g.iridescenceMapTransform)),f.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),f.transmission>0&&(g.transmission.value=f.transmission,g.transmissionSamplerMap.value=_.texture,g.transmissionSamplerSize.value.set(_.width,_.height),f.transmissionMap&&(g.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,g.transmissionMapTransform)),g.thickness.value=f.thickness,f.thicknessMap&&(g.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=f.attenuationDistance,g.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(g.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(g.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=f.specularIntensity,g.specularColor.value.copy(f.specularColor),f.specularColorMap&&(g.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,g.specularColorMapTransform)),f.specularIntensityMap&&(g.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,g.specularIntensityMapTransform))}function m(g,f){f.matcap&&(g.matcap.value=f.matcap)}function S(g,f){let _=t.get(f).light;g.referencePosition.value.setFromMatrixPosition(_.matrixWorld),g.nearDistance.value=_.shadow.camera.near,g.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function a3(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(v,T){let A=T.program;i.uniformBlockBinding(v,A)}function l(v,T){let A=s[v.id];A===void 0&&(g(v),A=h(v),s[v.id]=A,v.addEventListener("dispose",_));let w=T.program;i.updateUBOMapping(v,w);let y=t.render.frame;a[v.id]!==y&&(u(v),a[v.id]=y)}function h(v){let T=p();v.__bindingPointIndex=T;let A=e.createBuffer(),w=v.__size,y=v.usage;return e.bindBuffer(e.UNIFORM_BUFFER,A),e.bufferData(e.UNIFORM_BUFFER,w,y),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,T,A),A}function p(){for(let v=0;v<o;v++)if(r.indexOf(v)===-1)return r.push(v),v;return Pt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){let T=s[v.id],A=v.uniforms,w=v.__cache;e.bindBuffer(e.UNIFORM_BUFFER,T);for(let y=0,M=A.length;y<M;y++){let C=A[y];if(Array.isArray(C))for(let D=0,L=C.length;D<L;D++)d(C[D],y,D,w);else d(C,y,0,w)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function d(v,T,A,w){if(S(v,T,A,w)===!0){let y=v.__offset,M=v.value;if(Array.isArray(M)){let C=0;for(let D=0;D<M.length;D++){let L=M[D],P=f(L);m(L,v.__data,C),typeof L!="number"&&typeof L!="boolean"&&!L.isMatrix3&&!ArrayBuffer.isView(L)&&(C+=P.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(M,v.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,y,v.__data)}}function m(v,T,A){typeof v=="number"||typeof v=="boolean"?T[0]=v:v.isMatrix3?(T[0]=v.elements[0],T[1]=v.elements[1],T[2]=v.elements[2],T[3]=0,T[4]=v.elements[3],T[5]=v.elements[4],T[6]=v.elements[5],T[7]=0,T[8]=v.elements[6],T[9]=v.elements[7],T[10]=v.elements[8],T[11]=0):ArrayBuffer.isView(v)?T.set(new v.constructor(v.buffer,v.byteOffset,T.length)):v.toArray(T,A)}function S(v,T,A,w){let y=v.value,M=T+"_"+A;if(w[M]===void 0)return typeof y=="number"||typeof y=="boolean"?w[M]=y:ArrayBuffer.isView(y)?w[M]=y.slice():w[M]=y.clone(),!0;{let C=w[M];if(typeof y=="number"||typeof y=="boolean"){if(C!==y)return w[M]=y,!0}else{if(ArrayBuffer.isView(y))return!0;if(C.equals(y)===!1)return C.copy(y),!0}}return!1}function g(v){let T=v.uniforms,A=0,w=16;for(let M=0,C=T.length;M<C;M++){let D=Array.isArray(T[M])?T[M]:[T[M]];for(let L=0,P=D.length;L<P;L++){let W=D[L],B=Array.isArray(W.value)?W.value:[W.value];for(let q=0,X=B.length;q<X;q++){let tt=B[q],ot=f(tt),ut=A%w,dt=ut%ot.boundary,xt=ut+dt;A+=dt,xt!==0&&w-xt<ot.storage&&(A+=w-xt),W.__data=new Float32Array(ot.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=A,A+=ot.storage}}}let y=A%w;return y>0&&(A+=w-y),v.__size=A,v.__cache={},this}function f(v){let T={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(T.boundary=4,T.storage=4):v.isVector2?(T.boundary=8,T.storage=8):v.isVector3||v.isColor?(T.boundary=16,T.storage=12):v.isVector4?(T.boundary=16,T.storage=16):v.isMatrix3?(T.boundary=48,T.storage=48):v.isMatrix4?(T.boundary=64,T.storage=64):v.isTexture?Ot("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(T.boundary=16,T.storage=v.byteLength):Ot("WebGLRenderer: Unsupported uniform value type.",v),T}function _(v){let T=v.target;T.removeEventListener("dispose",_);let A=r.indexOf(T.__bindingPointIndex);r.splice(A,1),e.deleteBuffer(s[T.id]),delete s[T.id],delete a[T.id]}function x(){for(let v in s)e.deleteBuffer(s[v]);r=[],s={},a={}}return{bind:c,update:l,dispose:x}}var r3=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Ki=null;function o3(){return Ki===null&&(Ki=new Yh(r3,16,16,Sa,Ji),Ki.name="DFG_LUT",Ki.minFilter=dn,Ki.magFilter=dn,Ki.wrapS=Hi,Ki.wrapT=Hi,Ki.generateMipmaps=!1,Ki.needsUpdate=!0),Ki}var dd=class{constructor(t={}){let{canvas:n=BS(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:d=ei}=t;this.isWebGLRenderer=!0;let m;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=i.getContextAttributes().alpha}else m=r;let S=d,g=new Set([Df,Rf,Cf]),f=new Set([ei,Ai,bo,So,Af,wf]),_=new Uint32Array(4),x=new Int32Array(4),v=new U,T=null,A=null,w=[],y=[],M=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ti,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let C=this,D=!1,L=null,P=null,W=null,B=null;this._outputColorSpace=Tn;let q=0,X=0,tt=null,ot=-1,ut=null,dt=new Oe,xt=new Oe,Zt=null,se=new Qt(0),$t=0,Q=n.width,it=n.height,st=1,Rt=null,Lt=null,Ct=new Oe(0,0,Q,it),Wt=new Oe(0,0,Q,it),Nt=!1,Ft=new Jl,qt=!1,Bt=!1,ye=new Ie,ce=new U,He=new Oe,Pe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},xe=!1;function Te(){return tt===null?st:1}let O=i;function pn(E,z){return n.getContext(E,z)}try{let E={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${bf}`),n.addEventListener("webglcontextlost",Ae,!1),n.addEventListener("webglcontextrestored",be,!1),n.addEventListener("webglcontextcreationerror",Ci,!1),O===null){let z="webgl2";if(O=pn(z,E),O===null)throw pn(z)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(E){throw Pt("WebGLRenderer: "+E.message),E}let re,R,b,F,k,Z,ct,gt,K,et,pt,Tt,ft,ht,At,I,$,N,j,V,lt,mt,nt;function Et(){re=new pR(O),re.init(),lt=new t3(O,re),R=new rR(O,re,t,lt),b=new Q2(O,re),R.reversedDepthBuffer&&u&&b.buffers.depth.setReversed(!0),P=O.createFramebuffer(),W=O.createFramebuffer(),B=O.createFramebuffer(),F=new _R(O),k=new B2,Z=new $2(O,re,b,k,R,lt,F),ct=new dR(C),gt=new bA(O),mt=new sR(O,gt),K=new mR(O,gt,F,mt),et=new yR(O,K,gt,mt,F),N=new vR(O,R,Z),At=new oR(k),pt=new z2(C,ct,re,R,mt,At),Tt=new s3(C,k),ft=new V2,ht=new q2(re),$=new iR(C,ct,b,et,m,c),I=new j2(C,et,R),nt=new a3(O,F,R,b),j=new aR(O,re,F),V=new gR(O,re,F),F.programs=pt.programs,C.capabilities=R,C.extensions=re,C.properties=k,C.renderLists=ft,C.shadowMap=I,C.state=b,C.info=F}Et(),S!==ei&&(M=new bR(S,n.width,n.height,o,s,a));let Mt=new D0(C,O);this.xr=Mt,this.getContext=function(){return O},this.getContextAttributes=function(){return O.getContextAttributes()},this.forceContextLoss=function(){let E=re.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){let E=re.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return st},this.setPixelRatio=function(E){E!==void 0&&(st=E,this.setSize(Q,it,!1))},this.getSize=function(E){return E.set(Q,it)},this.setSize=function(E,z,Y=!0){if(Mt.isPresenting){Ot("WebGLRenderer: Can't change size while VR device is presenting.");return}Q=E,it=z,n.width=Math.floor(E*st),n.height=Math.floor(z*st),Y===!0&&(n.style.width=E+"px",n.style.height=z+"px"),M!==null&&M.setSize(n.width,n.height),this.setViewport(0,0,E,z)},this.getDrawingBufferSize=function(E){return E.set(Q*st,it*st).floor()},this.setDrawingBufferSize=function(E,z,Y){Q=E,it=z,st=Y,n.width=Math.floor(E*Y),n.height=Math.floor(z*Y),this.setViewport(0,0,E,z)},this.setEffects=function(E){if(S===ei){Pt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(E){for(let z=0;z<E.length;z++)if(E[z].isOutputPass===!0){Ot("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(E||[])},this.getCurrentViewport=function(E){return E.copy(dt)},this.getViewport=function(E){return E.copy(Ct)},this.setViewport=function(E,z,Y,H){E.isVector4?Ct.set(E.x,E.y,E.z,E.w):Ct.set(E,z,Y,H),b.viewport(dt.copy(Ct).multiplyScalar(st).round())},this.getScissor=function(E){return E.copy(Wt)},this.setScissor=function(E,z,Y,H){E.isVector4?Wt.set(E.x,E.y,E.z,E.w):Wt.set(E,z,Y,H),b.scissor(xt.copy(Wt).multiplyScalar(st).round())},this.getScissorTest=function(){return Nt},this.setScissorTest=function(E){b.setScissorTest(Nt=E)},this.setOpaqueSort=function(E){Rt=E},this.setTransparentSort=function(E){Lt=E},this.getClearColor=function(E){return E.copy($.getClearColor())},this.setClearColor=function(){$.setClearColor(...arguments)},this.getClearAlpha=function(){return $.getClearAlpha()},this.setClearAlpha=function(){$.setClearAlpha(...arguments)},this.clear=function(E=!0,z=!0,Y=!0){let H=0;if(E){let G=!1;if(tt!==null){let yt=tt.texture.format;G=g.has(yt)}if(G){let yt=tt.texture.type,St=f.has(yt),vt=$.getClearColor(),wt=$.getClearAlpha(),Dt=vt.r,Gt=vt.g,Yt=vt.b;St?(_[0]=Dt,_[1]=Gt,_[2]=Yt,_[3]=wt,O.clearBufferuiv(O.COLOR,0,_)):(x[0]=Dt,x[1]=Gt,x[2]=Yt,x[3]=wt,O.clearBufferiv(O.COLOR,0,x))}else H|=O.COLOR_BUFFER_BIT}z&&(H|=O.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Y&&(H|=O.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H!==0&&O.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(E){E.setRenderer(this),L=E},this.dispose=function(){n.removeEventListener("webglcontextlost",Ae,!1),n.removeEventListener("webglcontextrestored",be,!1),n.removeEventListener("webglcontextcreationerror",Ci,!1),$.dispose(),ft.dispose(),ht.dispose(),k.dispose(),ct.dispose(),et.dispose(),mt.dispose(),nt.dispose(),pt.dispose(),Mt.dispose(),Mt.removeEventListener("sessionstart",P0),Mt.removeEventListener("sessionend",z0),Ta.stop()};function Ae(E){E.preventDefault(),u0("WebGLRenderer: Context Lost."),D=!0}function be(){u0("WebGLRenderer: Context Restored."),D=!1;let E=F.autoReset,z=I.enabled,Y=I.autoUpdate,H=I.needsUpdate,G=I.type;Et(),F.autoReset=E,I.enabled=z,I.autoUpdate=Y,I.needsUpdate=H,I.type=G}function Ci(E){Pt("WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function Ri(E){let z=E.target;z.removeEventListener("dispose",Ri),DM(z)}function DM(E){NM(E),k.remove(E)}function NM(E){let z=k.get(E).programs;z!==void 0&&(z.forEach(function(Y){pt.releaseProgram(Y)}),E.isShaderMaterial&&pt.releaseShaderCache(E))}this.renderBufferDirect=function(E,z,Y,H,G,yt){z===null&&(z=Pe);let St=G.isMesh&&G.matrixWorld.determinantAffine()<0,vt=IM(E,z,Y,H,G);b.setMaterial(H,St);let wt=Y.index,Dt=1;if(H.wireframe===!0){if(wt=K.getWireframeAttribute(Y),wt===void 0)return;Dt=2}let Gt=Y.drawRange,Yt=Y.attributes.position,Ut=Gt.start*Dt,de=(Gt.start+Gt.count)*Dt;yt!==null&&(Ut=Math.max(Ut,yt.start*Dt),de=Math.min(de,(yt.start+yt.count)*Dt)),wt!==null?(Ut=Math.max(Ut,0),de=Math.min(de,wt.count)):Yt!=null&&(Ut=Math.max(Ut,0),de=Math.min(de,Yt.count));let Ge=de-Ut;if(Ge<0||Ge===1/0)return;mt.setup(G,H,vt,Y,wt);let ze,ge=j;if(wt!==null&&(ze=gt.get(wt),ge=V,ge.setIndex(ze)),G.isMesh)H.wireframe===!0?(b.setLineWidth(H.wireframeLinewidth*Te()),ge.setMode(O.LINES)):ge.setMode(O.TRIANGLES);else if(G.isLine){let mn=H.linewidth;mn===void 0&&(mn=1),b.setLineWidth(mn*Te()),G.isLineSegments?ge.setMode(O.LINES):G.isLineLoop?ge.setMode(O.LINE_LOOP):ge.setMode(O.LINE_STRIP)}else G.isPoints?ge.setMode(O.POINTS):G.isSprite&&ge.setMode(O.TRIANGLES);if(G.isBatchedMesh)if(re.get("WEBGL_multi_draw"))ge.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{let mn=G._multiDrawStarts,bt=G._multiDrawCounts,Pn=G._multiDrawCount,ae=wt?gt.get(wt).bytesPerElement:1,ni=k.get(H).currentProgram.getUniforms();for(let Di=0;Di<Pn;Di++)ni.setValue(O,"_gl_DrawID",Di),ge.render(mn[Di]/ae,bt[Di])}else if(G.isInstancedMesh)ge.renderInstances(Ut,Ge,G.count);else if(Y.isInstancedBufferGeometry){let mn=Y._maxInstanceCount!==void 0?Y._maxInstanceCount:1/0,bt=Math.min(Y.instanceCount,mn);ge.renderInstances(Ut,Ge,bt)}else ge.render(Ut,Ge)};function O0(E,z,Y){E.transparent===!0&&E.side===ti&&E.forceSinglePass===!1?(E.side=An,E.needsUpdate=!0,Tc(E,z,Y),E.side=Ts,E.needsUpdate=!0,Tc(E,z,Y),E.side=ti):Tc(E,z,Y)}this.compile=function(E,z,Y=null){Y===null&&(Y=E),A=ht.get(Y),A.init(z),y.push(A),Y.traverseVisible(function(G){G.isLight&&G.layers.test(z.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),E!==Y&&E.traverseVisible(function(G){G.isLight&&G.layers.test(z.layers)&&(A.pushLight(G),G.castShadow&&A.pushShadow(G))}),A.setupLights();let H=new Set;return E.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;let yt=G.material;if(yt)if(Array.isArray(yt))for(let St=0;St<yt.length;St++){let vt=yt[St];O0(vt,Y,G),H.add(vt)}else O0(yt,Y,G),H.add(yt)}),A=y.pop(),H},this.compileAsync=function(E,z,Y=null){let H=this.compile(E,z,Y);return new Promise(G=>{function yt(){if(H.forEach(function(St){k.get(St).currentProgram.isReady()&&H.delete(St)}),H.size===0){G(E);return}setTimeout(yt,10)}re.get("KHR_parallel_shader_compile")!==null?yt():setTimeout(yt,10)})};let xd=null;function UM(E){xd&&xd(E)}function P0(){Ta.stop()}function z0(){Ta.start()}let Ta=new dM;Ta.setAnimationLoop(UM),typeof self<"u"&&Ta.setContext(self),this.setAnimationLoop=function(E){xd=E,Mt.setAnimationLoop(E),E===null?Ta.stop():Ta.start()},Mt.addEventListener("sessionstart",P0),Mt.addEventListener("sessionend",z0),this.render=function(E,z){if(z!==void 0&&z.isCamera!==!0){Pt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;L!==null&&L.renderStart(E,z);let Y=Mt.enabled===!0&&Mt.isPresenting===!0,H=M!==null&&(tt===null||Y)&&M.begin(C,tt);if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),Mt.enabled===!0&&Mt.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(Mt.cameraAutoUpdate===!0&&Mt.updateCamera(z),z=Mt.getCamera()),E.isScene===!0&&E.onBeforeRender(C,E,z,tt),A=ht.get(E,y.length),A.init(z),A.state.textureUnits=Z.getTextureUnits(),y.push(A),ye.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),Ft.setFromProjectionMatrix(ye,Ei,z.reversedDepth),Bt=this.localClippingEnabled,qt=At.init(this.clippingPlanes,Bt),T=ft.get(E,w.length),T.init(),w.push(T),Mt.enabled===!0&&Mt.isPresenting===!0){let St=C.xr.getDepthSensingMesh();St!==null&&bd(St,z,-1/0,C.sortObjects)}bd(E,z,0,C.sortObjects),T.finish(),C.sortObjects===!0&&T.sort(Rt,Lt,z.reversedDepth),xe=Mt.enabled===!1||Mt.isPresenting===!1||Mt.hasDepthSensing()===!1,xe&&$.addToRenderList(T,E),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),qt===!0&&At.beginShadows();let G=A.state.shadowsArray;if(I.render(G,E,z),qt===!0&&At.endShadows(),(H&&M.hasRenderPass())===!1){let St=T.opaque,vt=T.transmissive;if(A.setupLights(),z.isArrayCamera){let wt=z.cameras;if(vt.length>0)for(let Dt=0,Gt=wt.length;Dt<Gt;Dt++){let Yt=wt[Dt];F0(St,vt,E,Yt)}xe&&$.render(E);for(let Dt=0,Gt=wt.length;Dt<Gt;Dt++){let Yt=wt[Dt];B0(T,E,Yt,Yt.viewport)}}else vt.length>0&&F0(St,vt,E,z),xe&&$.render(E),B0(T,E,z)}tt!==null&&X===0&&(Z.updateMultisampleRenderTarget(tt),Z.updateRenderTargetMipmap(tt)),H&&M.end(C),E.isScene===!0&&E.onAfterRender(C,E,z),mt.resetDefaultState(),ot=-1,ut=null,y.pop(),y.length>0?(A=y[y.length-1],Z.setTextureUnits(A.state.textureUnits),qt===!0&&At.setGlobalState(C.clippingPlanes,A.state.camera)):A=null,w.pop(),w.length>0?T=w[w.length-1]:T=null,L!==null&&L.renderEnd()};function bd(E,z,Y,H){if(E.visible===!1)return;if(E.layers.test(z.layers)){if(E.isGroup)Y=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(z);else if(E.isLightProbeGrid)A.pushLightProbeGrid(E);else if(E.isLight)A.pushLight(E),E.castShadow&&A.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Ft.intersectsSprite(E)){H&&He.setFromMatrixPosition(E.matrixWorld).applyMatrix4(ye);let St=et.update(E),vt=E.material;vt.visible&&T.push(E,St,vt,Y,He.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Ft.intersectsObject(E))){let St=et.update(E),vt=E.material;if(H&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),He.copy(E.boundingSphere.center)):(St.boundingSphere===null&&St.computeBoundingSphere(),He.copy(St.boundingSphere.center)),He.applyMatrix4(E.matrixWorld).applyMatrix4(ye)),Array.isArray(vt)){let wt=St.groups;for(let Dt=0,Gt=wt.length;Dt<Gt;Dt++){let Yt=wt[Dt],Ut=vt[Yt.materialIndex];Ut&&Ut.visible&&T.push(E,St,Ut,Y,He.z,Yt)}}else vt.visible&&T.push(E,St,vt,Y,He.z,null)}}let yt=E.children;for(let St=0,vt=yt.length;St<vt;St++)bd(yt[St],z,Y,H)}function B0(E,z,Y,H){let{opaque:G,transmissive:yt,transparent:St}=E;A.setupLightsView(Y),qt===!0&&At.setGlobalState(C.clippingPlanes,Y),H&&b.viewport(dt.copy(H)),G.length>0&&Ec(G,z,Y),yt.length>0&&Ec(yt,z,Y),St.length>0&&Ec(St,z,Y),b.buffers.depth.setTest(!0),b.buffers.depth.setMask(!0),b.buffers.color.setMask(!0),b.setPolygonOffset(!1)}function F0(E,z,Y,H){if((Y.isScene===!0?Y.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[H.id]===void 0){let Ut=re.has("EXT_color_buffer_half_float")||re.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[H.id]=new Kn(1,1,{generateMipmaps:!0,type:Ut?Ji:ei,minFilter:xa,samples:Math.max(4,R.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ee.workingColorSpace})}let yt=A.state.transmissionRenderTarget[H.id],St=H.viewport||dt;yt.setSize(St.z*C.transmissionResolutionScale,St.w*C.transmissionResolutionScale);let vt=C.getRenderTarget(),wt=C.getActiveCubeFace(),Dt=C.getActiveMipmapLevel();C.setRenderTarget(yt),C.getClearColor(se),$t=C.getClearAlpha(),$t<1&&C.setClearColor(16777215,.5),C.clear(),xe&&$.render(Y);let Gt=C.toneMapping;C.toneMapping=Ti;let Yt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),A.setupLightsView(H),qt===!0&&At.setGlobalState(C.clippingPlanes,H),Ec(E,Y,H),Z.updateMultisampleRenderTarget(yt),Z.updateRenderTargetMipmap(yt),re.has("WEBGL_multisampled_render_to_texture")===!1){let Ut=!1;for(let de=0,Ge=z.length;de<Ge;de++){let ze=z[de],{object:ge,geometry:mn,material:bt,group:Pn}=ze;if(bt.side===ti&&ge.layers.test(H.layers)){let ae=bt.side;bt.side=An,bt.needsUpdate=!0,V0(ge,Y,H,mn,bt,Pn),bt.side=ae,bt.needsUpdate=!0,Ut=!0}}Ut===!0&&(Z.updateMultisampleRenderTarget(yt),Z.updateRenderTargetMipmap(yt))}C.setRenderTarget(vt,wt,Dt),C.setClearColor(se,$t),Yt!==void 0&&(H.viewport=Yt),C.toneMapping=Gt}function Ec(E,z,Y){let H=z.isScene===!0?z.overrideMaterial:null;for(let G=0,yt=E.length;G<yt;G++){let St=E[G],{object:vt,geometry:wt,group:Dt}=St,Gt=St.material;Gt.allowOverride===!0&&H!==null&&(Gt=H),vt.layers.test(Y.layers)&&V0(vt,z,Y,wt,Gt,Dt)}}function V0(E,z,Y,H,G,yt){E.onBeforeRender(C,z,Y,H,G,yt),E.modelViewMatrix.multiplyMatrices(Y.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),G.onBeforeRender(C,z,Y,H,E,yt),G.transparent===!0&&G.side===ti&&G.forceSinglePass===!1?(G.side=An,G.needsUpdate=!0,C.renderBufferDirect(Y,z,H,G,E,yt),G.side=Ts,G.needsUpdate=!0,C.renderBufferDirect(Y,z,H,G,E,yt),G.side=ti):C.renderBufferDirect(Y,z,H,G,E,yt),E.onAfterRender(C,z,Y,H,G,yt)}function Tc(E,z,Y){z.isScene!==!0&&(z=Pe);let H=k.get(E),G=A.state.lights,yt=A.state.shadowsArray,St=G.state.version,vt=pt.getParameters(E,G.state,yt,z,Y,A.state.lightProbeGridArray),wt=pt.getProgramCacheKey(vt),Dt=H.programs;H.environment=E.isMeshStandardMaterial||E.isMeshLambertMaterial||E.isMeshPhongMaterial?z.environment:null,H.fog=z.fog;let Gt=E.isMeshStandardMaterial||E.isMeshLambertMaterial&&!E.envMap||E.isMeshPhongMaterial&&!E.envMap;H.envMap=ct.get(E.envMap||H.environment,Gt),H.envMapRotation=H.environment!==null&&E.envMap===null?z.environmentRotation:E.envMapRotation,Dt===void 0&&(E.addEventListener("dispose",Ri),Dt=new Map,H.programs=Dt);let Yt=Dt.get(wt);if(Yt!==void 0){if(H.currentProgram===Yt&&H.lightsStateVersion===St)return G0(E,vt),Yt}else vt.uniforms=pt.getUniforms(E),L!==null&&E.isNodeMaterial&&L.build(E,Y,vt),E.onBeforeCompile(vt,C),Yt=pt.acquireProgram(vt,wt),Dt.set(wt,Yt),H.uniforms=vt.uniforms;let Ut=H.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ut.clippingPlanes=At.uniform),G0(E,vt),H.needsLights=PM(E),H.lightsStateVersion=St,H.needsLights&&(Ut.ambientLightColor.value=G.state.ambient,Ut.lightProbe.value=G.state.probe,Ut.directionalLights.value=G.state.directional,Ut.directionalLightShadows.value=G.state.directionalShadow,Ut.spotLights.value=G.state.spot,Ut.spotLightShadows.value=G.state.spotShadow,Ut.rectAreaLights.value=G.state.rectArea,Ut.ltc_1.value=G.state.rectAreaLTC1,Ut.ltc_2.value=G.state.rectAreaLTC2,Ut.pointLights.value=G.state.point,Ut.pointLightShadows.value=G.state.pointShadow,Ut.hemisphereLights.value=G.state.hemi,Ut.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Ut.spotLightMatrix.value=G.state.spotLightMatrix,Ut.spotLightMap.value=G.state.spotLightMap,Ut.pointShadowMatrix.value=G.state.pointShadowMatrix),H.lightProbeGrid=A.state.lightProbeGridArray.length>0,H.currentProgram=Yt,H.uniformsList=null,Yt}function H0(E){if(E.uniformsList===null){let z=E.currentProgram.getUniforms();E.uniformsList=Eo.seqWithValue(z.seq,E.uniforms)}return E.uniformsList}function G0(E,z){let Y=k.get(E);Y.outputColorSpace=z.outputColorSpace,Y.batching=z.batching,Y.batchingColor=z.batchingColor,Y.instancing=z.instancing,Y.instancingColor=z.instancingColor,Y.instancingMorph=z.instancingMorph,Y.skinning=z.skinning,Y.morphTargets=z.morphTargets,Y.morphNormals=z.morphNormals,Y.morphColors=z.morphColors,Y.morphTargetsCount=z.morphTargetsCount,Y.numClippingPlanes=z.numClippingPlanes,Y.numIntersection=z.numClipIntersection,Y.vertexAlphas=z.vertexAlphas,Y.vertexTangents=z.vertexTangents,Y.toneMapping=z.toneMapping}function LM(E,z){if(E.length===0)return null;if(E.length===1)return E[0].texture!==null?E[0]:null;v.setFromMatrixPosition(z.matrixWorld);for(let Y=0,H=E.length;Y<H;Y++){let G=E[Y];if(G.texture!==null&&G.boundingBox.containsPoint(v))return G}return null}function IM(E,z,Y,H,G){z.isScene!==!0&&(z=Pe),Z.resetTextureUnits();let yt=z.fog,St=H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial?z.environment:null,vt=tt===null?C.outputColorSpace:tt.isXRRenderTarget===!0?tt.texture.colorSpace:ee.workingColorSpace,wt=H.isMeshStandardMaterial||H.isMeshLambertMaterial&&!H.envMap||H.isMeshPhongMaterial&&!H.envMap,Dt=ct.get(H.envMap||St,wt),Gt=H.vertexColors===!0&&!!Y.attributes.color&&Y.attributes.color.itemSize===4,Yt=!!Y.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Ut=!!Y.morphAttributes.position,de=!!Y.morphAttributes.normal,Ge=!!Y.morphAttributes.color,ze=Ti;H.toneMapped&&(tt===null||tt.isXRRenderTarget===!0)&&(ze=C.toneMapping);let ge=Y.morphAttributes.position||Y.morphAttributes.normal||Y.morphAttributes.color,mn=ge!==void 0?ge.length:0,bt=k.get(H),Pn=A.state.lights;if(qt===!0&&(Bt===!0||E!==ut)){let Se=E===ut&&H.id===ot;At.setState(H,E,Se)}let ae=!1;H.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==Pn.state.version||bt.outputColorSpace!==vt||G.isBatchedMesh&&bt.batching===!1||!G.isBatchedMesh&&bt.batching===!0||G.isBatchedMesh&&bt.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&bt.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&bt.instancing===!1||!G.isInstancedMesh&&bt.instancing===!0||G.isSkinnedMesh&&bt.skinning===!1||!G.isSkinnedMesh&&bt.skinning===!0||G.isInstancedMesh&&bt.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&bt.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&bt.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&bt.instancingMorph===!1&&G.morphTexture!==null||bt.envMap!==Dt||H.fog===!0&&bt.fog!==yt||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==At.numPlanes||bt.numIntersection!==At.numIntersection)||bt.vertexAlphas!==Gt||bt.vertexTangents!==Yt||bt.morphTargets!==Ut||bt.morphNormals!==de||bt.morphColors!==Ge||bt.toneMapping!==ze||bt.morphTargetsCount!==mn||!!bt.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(ae=!0):(ae=!0,bt.__version=H.version);let ni=bt.currentProgram;ae===!0&&(ni=Tc(H,z,G),L&&H.isNodeMaterial&&L.onUpdateProgram(H,ni,bt));let Di=!1,Cs=!1,ar=!1,_e=ni.getUniforms(),ke=bt.uniforms;if(b.useProgram(ni.program)&&(Di=!0,Cs=!0,ar=!0),H.id!==ot&&(ot=H.id,Cs=!0),bt.needsLights){let Se=LM(A.state.lightProbeGridArray,G);bt.lightProbeGrid!==Se&&(bt.lightProbeGrid=Se,Cs=!0)}if(Di||ut!==E){b.buffers.depth.getReversed()&&E.reversedDepth!==!0&&(E._reversedDepth=!0,E.updateProjectionMatrix()),_e.setValue(O,"projectionMatrix",E.projectionMatrix),_e.setValue(O,"viewMatrix",E.matrixWorldInverse);let Ds=_e.map.cameraPosition;Ds!==void 0&&Ds.setValue(O,ce.setFromMatrixPosition(E.matrixWorld)),R.logarithmicDepthBuffer&&_e.setValue(O,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&_e.setValue(O,"isOrthographic",E.isOrthographicCamera===!0),ut!==E&&(ut=E,Cs=!0,ar=!0)}if(bt.needsLights&&(Pn.state.directionalShadowMap.length>0&&_e.setValue(O,"directionalShadowMap",Pn.state.directionalShadowMap,Z),Pn.state.spotShadowMap.length>0&&_e.setValue(O,"spotShadowMap",Pn.state.spotShadowMap,Z),Pn.state.pointShadowMap.length>0&&_e.setValue(O,"pointShadowMap",Pn.state.pointShadowMap,Z)),G.isSkinnedMesh){_e.setOptional(O,G,"bindMatrix"),_e.setOptional(O,G,"bindMatrixInverse");let Se=G.skeleton;Se&&(Se.boneTexture===null&&Se.computeBoneTexture(),_e.setValue(O,"boneTexture",Se.boneTexture,Z))}G.isBatchedMesh&&(_e.setOptional(O,G,"batchingTexture"),_e.setValue(O,"batchingTexture",G._matricesTexture,Z),_e.setOptional(O,G,"batchingIdTexture"),_e.setValue(O,"batchingIdTexture",G._indirectTexture,Z),_e.setOptional(O,G,"batchingColorTexture"),G._colorsTexture!==null&&_e.setValue(O,"batchingColorTexture",G._colorsTexture,Z));let Rs=Y.morphAttributes;if((Rs.position!==void 0||Rs.normal!==void 0||Rs.color!==void 0)&&N.update(G,Y,ni),(Cs||bt.receiveShadow!==G.receiveShadow)&&(bt.receiveShadow=G.receiveShadow,_e.setValue(O,"receiveShadow",G.receiveShadow)),(H.isMeshStandardMaterial||H.isMeshLambertMaterial||H.isMeshPhongMaterial)&&H.envMap===null&&z.environment!==null&&(ke.envMapIntensity.value=z.environmentIntensity),ke.dfgLUT!==void 0&&(ke.dfgLUT.value=o3()),Cs){if(_e.setValue(O,"toneMappingExposure",C.toneMappingExposure),bt.needsLights&&OM(ke,ar),yt&&H.fog===!0&&Tt.refreshFogUniforms(ke,yt),Tt.refreshMaterialUniforms(ke,H,st,it,A.state.transmissionRenderTarget[E.id]),bt.needsLights&&bt.lightProbeGrid){let Se=bt.lightProbeGrid;ke.probesSH.value=Se.texture,ke.probesMin.value.copy(Se.boundingBox.min),ke.probesMax.value.copy(Se.boundingBox.max),ke.probesResolution.value.copy(Se.resolution)}Eo.upload(O,H0(bt),ke,Z)}if(H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(Eo.upload(O,H0(bt),ke,Z),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&_e.setValue(O,"center",G.center),_e.setValue(O,"modelViewMatrix",G.modelViewMatrix),_e.setValue(O,"normalMatrix",G.normalMatrix),_e.setValue(O,"modelMatrix",G.matrixWorld),H.uniformsGroups!==void 0){let Se=H.uniformsGroups;for(let Ds=0,rr=Se.length;Ds<rr;Ds++){let k0=Se[Ds];nt.update(k0,ni),nt.bind(k0,ni)}}return ni}function OM(E,z){E.ambientLightColor.needsUpdate=z,E.lightProbe.needsUpdate=z,E.directionalLights.needsUpdate=z,E.directionalLightShadows.needsUpdate=z,E.pointLights.needsUpdate=z,E.pointLightShadows.needsUpdate=z,E.spotLights.needsUpdate=z,E.spotLightShadows.needsUpdate=z,E.rectAreaLights.needsUpdate=z,E.hemisphereLights.needsUpdate=z}function PM(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return X},this.getRenderTarget=function(){return tt},this.setRenderTargetTextures=function(E,z,Y){let H=k.get(E);H.__autoAllocateDepthBuffer=E.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),k.get(E.texture).__webglTexture=z,k.get(E.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:Y,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(E,z){let Y=k.get(E);Y.__webglFramebuffer=z,Y.__useDefaultFramebuffer=z===void 0},this.setRenderTarget=function(E,z=0,Y=0){tt=E,q=z,X=Y;let H=null,G=!1,yt=!1;if(E){let vt=k.get(E);if(vt.__useDefaultFramebuffer!==void 0){b.bindFramebuffer(O.FRAMEBUFFER,vt.__webglFramebuffer),dt.copy(E.viewport),xt.copy(E.scissor),Zt=E.scissorTest,b.viewport(dt),b.scissor(xt),b.setScissorTest(Zt),ot=-1;return}else if(vt.__webglFramebuffer===void 0)Z.setupRenderTarget(E);else if(vt.__hasExternalTextures)Z.rebindTextures(E,k.get(E.texture).__webglTexture,k.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){let Gt=E.depthTexture;if(vt.__boundDepthTexture!==Gt){if(Gt!==null&&k.has(Gt)&&(E.width!==Gt.image.width||E.height!==Gt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Z.setupDepthRenderbuffer(E)}}let wt=E.texture;(wt.isData3DTexture||wt.isDataArrayTexture||wt.isCompressedArrayTexture)&&(yt=!0);let Dt=k.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Dt[z])?H=Dt[z][Y]:H=Dt[z],G=!0):E.samples>0&&Z.useMultisampledRTT(E)===!1?H=k.get(E).__webglMultisampledFramebuffer:Array.isArray(Dt)?H=Dt[Y]:H=Dt,dt.copy(E.viewport),xt.copy(E.scissor),Zt=E.scissorTest}else dt.copy(Ct).multiplyScalar(st).floor(),xt.copy(Wt).multiplyScalar(st).floor(),Zt=Nt;if(Y!==0&&(H=P),b.bindFramebuffer(O.FRAMEBUFFER,H)&&b.drawBuffers(E,H),b.viewport(dt),b.scissor(xt),b.setScissorTest(Zt),G){let vt=k.get(E.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_CUBE_MAP_POSITIVE_X+z,vt.__webglTexture,Y)}else if(yt){let vt=z;for(let wt=0;wt<E.textures.length;wt++){let Dt=k.get(E.textures[wt]);O.framebufferTextureLayer(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0+wt,Dt.__webglTexture,Y,vt)}}else if(E!==null&&Y!==0){let vt=k.get(E.texture);O.framebufferTexture2D(O.FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,vt.__webglTexture,Y)}ot=-1},this.readRenderTargetPixels=function(E,z,Y,H,G,yt,St,vt=0){if(!(E&&E.isWebGLRenderTarget)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let wt=k.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&St!==void 0&&(wt=wt[St]),wt){b.bindFramebuffer(O.FRAMEBUFFER,wt);try{let Dt=E.textures[vt],Gt=Dt.format,Yt=Dt.type;if(E.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+vt),!R.textureFormatReadable(Gt)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!R.textureTypeReadable(Yt)){Pt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=E.width-H&&Y>=0&&Y<=E.height-G&&O.readPixels(z,Y,H,G,lt.convert(Gt),lt.convert(Yt),yt)}finally{let Dt=tt!==null?k.get(tt).__webglFramebuffer:null;b.bindFramebuffer(O.FRAMEBUFFER,Dt)}}},this.readRenderTargetPixelsAsync=async function(E,z,Y,H,G,yt,St,vt=0){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let wt=k.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&St!==void 0&&(wt=wt[St]),wt)if(z>=0&&z<=E.width-H&&Y>=0&&Y<=E.height-G){b.bindFramebuffer(O.FRAMEBUFFER,wt);let Dt=E.textures[vt],Gt=Dt.format,Yt=Dt.type;if(E.textures.length>1&&O.readBuffer(O.COLOR_ATTACHMENT0+vt),!R.textureFormatReadable(Gt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!R.textureTypeReadable(Yt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ut=O.createBuffer();O.bindBuffer(O.PIXEL_PACK_BUFFER,Ut),O.bufferData(O.PIXEL_PACK_BUFFER,yt.byteLength,O.STREAM_READ),O.readPixels(z,Y,H,G,lt.convert(Gt),lt.convert(Yt),0);let de=tt!==null?k.get(tt).__webglFramebuffer:null;b.bindFramebuffer(O.FRAMEBUFFER,de);let Ge=O.fenceSync(O.SYNC_GPU_COMMANDS_COMPLETE,0);return O.flush(),await VS(O,Ge,4),O.bindBuffer(O.PIXEL_PACK_BUFFER,Ut),O.getBufferSubData(O.PIXEL_PACK_BUFFER,0,yt),O.deleteBuffer(Ut),O.deleteSync(Ge),yt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(E,z=null,Y=0){let H=Math.pow(2,-Y),G=Math.floor(E.image.width*H),yt=Math.floor(E.image.height*H),St=z!==null?z.x:0,vt=z!==null?z.y:0;Z.setTexture2D(E,0),O.copyTexSubImage2D(O.TEXTURE_2D,Y,0,0,St,vt,G,yt),b.unbindTexture()},this.copyTextureToTexture=function(E,z,Y=null,H=null,G=0,yt=0){let St,vt,wt,Dt,Gt,Yt,Ut,de,Ge,ze=E.isCompressedTexture?E.mipmaps[yt]:E.image;if(Y!==null)St=Y.max.x-Y.min.x,vt=Y.max.y-Y.min.y,wt=Y.isBox3?Y.max.z-Y.min.z:1,Dt=Y.min.x,Gt=Y.min.y,Yt=Y.isBox3?Y.min.z:0;else{let ke=Math.pow(2,-G);St=Math.floor(ze.width*ke),vt=Math.floor(ze.height*ke),E.isDataArrayTexture?wt=ze.depth:E.isData3DTexture?wt=Math.floor(ze.depth*ke):wt=1,Dt=0,Gt=0,Yt=0}H!==null?(Ut=H.x,de=H.y,Ge=H.z):(Ut=0,de=0,Ge=0);let ge=lt.convert(z.format),mn=lt.convert(z.type),bt;z.isData3DTexture?(Z.setTexture3D(z,0),bt=O.TEXTURE_3D):z.isDataArrayTexture||z.isCompressedArrayTexture?(Z.setTexture2DArray(z,0),bt=O.TEXTURE_2D_ARRAY):(Z.setTexture2D(z,0),bt=O.TEXTURE_2D),b.activeTexture(O.TEXTURE0),b.pixelStorei(O.UNPACK_FLIP_Y_WEBGL,z.flipY),b.pixelStorei(O.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),b.pixelStorei(O.UNPACK_ALIGNMENT,z.unpackAlignment);let Pn=b.getParameter(O.UNPACK_ROW_LENGTH),ae=b.getParameter(O.UNPACK_IMAGE_HEIGHT),ni=b.getParameter(O.UNPACK_SKIP_PIXELS),Di=b.getParameter(O.UNPACK_SKIP_ROWS),Cs=b.getParameter(O.UNPACK_SKIP_IMAGES);b.pixelStorei(O.UNPACK_ROW_LENGTH,ze.width),b.pixelStorei(O.UNPACK_IMAGE_HEIGHT,ze.height),b.pixelStorei(O.UNPACK_SKIP_PIXELS,Dt),b.pixelStorei(O.UNPACK_SKIP_ROWS,Gt),b.pixelStorei(O.UNPACK_SKIP_IMAGES,Yt);let ar=E.isDataArrayTexture||E.isData3DTexture,_e=z.isDataArrayTexture||z.isData3DTexture;if(E.isDepthTexture){let ke=k.get(E),Rs=k.get(z),Se=k.get(ke.__renderTarget),Ds=k.get(Rs.__renderTarget);b.bindFramebuffer(O.READ_FRAMEBUFFER,Se.__webglFramebuffer),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,Ds.__webglFramebuffer);for(let rr=0;rr<wt;rr++)ar&&(O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,k.get(E).__webglTexture,G,Yt+rr),O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,k.get(z).__webglTexture,yt,Ge+rr)),O.blitFramebuffer(Dt,Gt,St,vt,Ut,de,St,vt,O.DEPTH_BUFFER_BIT,O.NEAREST);b.bindFramebuffer(O.READ_FRAMEBUFFER,null),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else if(G!==0||E.isRenderTargetTexture||k.has(E)){let ke=k.get(E),Rs=k.get(z);b.bindFramebuffer(O.READ_FRAMEBUFFER,W),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,B);for(let Se=0;Se<wt;Se++)ar?O.framebufferTextureLayer(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,ke.__webglTexture,G,Yt+Se):O.framebufferTexture2D(O.READ_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,ke.__webglTexture,G),_e?O.framebufferTextureLayer(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,Rs.__webglTexture,yt,Ge+Se):O.framebufferTexture2D(O.DRAW_FRAMEBUFFER,O.COLOR_ATTACHMENT0,O.TEXTURE_2D,Rs.__webglTexture,yt),G!==0?O.blitFramebuffer(Dt,Gt,St,vt,Ut,de,St,vt,O.COLOR_BUFFER_BIT,O.NEAREST):_e?O.copyTexSubImage3D(bt,yt,Ut,de,Ge+Se,Dt,Gt,St,vt):O.copyTexSubImage2D(bt,yt,Ut,de,Dt,Gt,St,vt);b.bindFramebuffer(O.READ_FRAMEBUFFER,null),b.bindFramebuffer(O.DRAW_FRAMEBUFFER,null)}else _e?E.isDataTexture||E.isData3DTexture?O.texSubImage3D(bt,yt,Ut,de,Ge,St,vt,wt,ge,mn,ze.data):z.isCompressedArrayTexture?O.compressedTexSubImage3D(bt,yt,Ut,de,Ge,St,vt,wt,ge,ze.data):O.texSubImage3D(bt,yt,Ut,de,Ge,St,vt,wt,ge,mn,ze):E.isDataTexture?O.texSubImage2D(O.TEXTURE_2D,yt,Ut,de,St,vt,ge,mn,ze.data):E.isCompressedTexture?O.compressedTexSubImage2D(O.TEXTURE_2D,yt,Ut,de,ze.width,ze.height,ge,ze.data):O.texSubImage2D(O.TEXTURE_2D,yt,Ut,de,St,vt,ge,mn,ze);b.pixelStorei(O.UNPACK_ROW_LENGTH,Pn),b.pixelStorei(O.UNPACK_IMAGE_HEIGHT,ae),b.pixelStorei(O.UNPACK_SKIP_PIXELS,ni),b.pixelStorei(O.UNPACK_SKIP_ROWS,Di),b.pixelStorei(O.UNPACK_SKIP_IMAGES,Cs),yt===0&&z.generateMipmaps&&O.generateMipmap(bt),b.unbindTexture()},this.initRenderTarget=function(E){k.get(E).__webglFramebuffer===void 0&&Z.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?Z.setTextureCube(E,0):E.isData3DTexture?Z.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?Z.setTexture2DArray(E,0):Z.setTexture2D(E,0),b.unbindTexture()},this.resetState=function(){q=0,X=0,tt=null,b.reset(),mt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ei}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=ee._getDrawingBufferColorSpace(t),n.unpackColorSpace=ee._getUnpackColorSpace()}};var gd=12;var ne=(e,t,n=0)=>({time:e,azimuth:t||0,elevation:n,distance:1}),xM=e=>[...Array.from({length:9},(t,n)=>ne(Number((n*5/48).toFixed(6)),e*n*45)),ne(1,e*360)],xc=(e,t=0)=>[ne(0,0),ne(.2,e/2,t/2),ne(.4,e,t),ne(.6,e/2,t/2),ne(.8,0),ne(1,0)],bM=e=>[...Array.from({length:9},(t,n)=>ne(Number((n*5/48).toFixed(6)),e*n*45,n===8?0:Number((25*Math.sin(Math.PI*n/8)).toFixed(3)))),ne(1,e*360)],QU=[{id:"swing",name:"Side Arc",description:"A 65-degree arc around the frame.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,65,8)]},{id:"rise",name:"Hero Rise",description:"A new angle on the action.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,35,30)]},{id:"orbit",name:"Full Orbit",description:"A full right orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:xM(1)},{id:"arc-return",name:"Arc Return",description:"Sweep 45 degrees to the side, then retrace to the starting pose.",duration:5,returnsToStart:!0,trajectory:[ne(0,0),ne(.2,22.5),ne(.45,45),ne(.7,22.5),ne(.9,0),ne(1,0)]},{id:"rise-return",name:"Rise Return",description:"Rise 25 degrees, then descend to the starting pose.",duration:5,returnsToStart:!0,trajectory:[ne(0,0),ne(.2,0,12.5),ne(.45,0,25),ne(.7,0,12.5),ne(.9,0),ne(1,0)]},{id:"orbit-left",name:"Orbit Left",description:"A full left orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:xM(-1)},{id:"arc-left-return",name:"Left Return",description:"Sweep 45 degrees left, then retrace to the opening view.",duration:5,returnsToStart:!0,trajectory:xc(-45)},{id:"wide-return",name:"Wide Return",description:"Reach a 90-degree side view, then return to the opening pose.",duration:5,returnsToStart:!0,trajectory:xc(90)},{id:"dip-return",name:"Dip Return",description:"Dip 20 degrees below the subject, then rise back to the opening view.",duration:5,returnsToStart:!0,trajectory:xc(0,-20)},{id:"high-arc-return",name:"High Return",description:"Arc 45 degrees right and 25 degrees up, then retrace home.",duration:5,returnsToStart:!0,trajectory:xc(45,25)},{id:"low-arc-return",name:"Low Return",description:"Arc 45 degrees left and 20 degrees down, then retrace home.",duration:5,returnsToStart:!0,trajectory:xc(-45,-20)},{id:"sway-return",name:"Side to Side",description:"Sway left, cross through the opening view to the right, then return.",duration:5,returnsToStart:!0,trajectory:[ne(0,0),ne(.2,-30),ne(.4,0),ne(.6,30),ne(.8,0),ne(1,0)]},{id:"halo",name:"High Orbit",description:"Orbit right through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:bM(1)},{id:"halo-left",name:"High Orbit Left",description:"Orbit left through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:bM(-1)},{id:"arc-left",name:"Left Arc",description:"A 65-degree left arc that finishes at a new angle.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,-65,8)]},{id:"low-angle",name:"Low Reveal",description:"Sweep 40 degrees right and descend 20 degrees for a low-angle finish.",duration:5,returnsToStart:!1,trajectory:[ne(0,0),ne(1,40,-20)]}];var J=Ac(N0());async function Ao(e){let t=e instanceof FormData?e:new FormData;if(!(e instanceof FormData))for(let[n,i]of Object.entries(e))t.set(n,i);t.set("format","json");try{return await(await fetch(window.location.pathname,{method:"POST",body:t,credentials:"same-origin"})).json()}catch{return null}}var Sc=Math.PI/180;function wn(e,t,n){return Math.max(t,Math.min(n,e))}function Mc(e,t){if(t<=e[0].time)return e[0];let n=e[e.length-1];if(t>=n.time)return n;let i=1;for(;e[i].time<t;)i++;let s=e[i-1],a=e[i],r=Math.max(1e-6,a.time-s.time),o=(t-s.time)/r,c=o*o*(3-2*o),l=a.azimuth-s.azimuth;return l=((l%360+540)%360+360)%360-180,{time:t,azimuth:s.azimuth+l*c,elevation:s.elevation+(a.elevation-s.elevation)*c,distance:s.distance+(a.distance-s.distance)*c}}var L0={time:0,azimuth:0,elevation:0,distance:1},h3={...L0,time:1},bc=1024,TM=["#f8fbff","#ffd166","#ff5d8f","#4db0ff","#39d98a"],f3=[{id:"fast",label:"Flare Fast"},{id:"detailed",label:"Flare Detailed"},{id:"turbo",label:"Turbo"},{id:"hq",label:"Sunburst HQ"}];function d3(e){let t=(0,rt.useRef)(null),n=(0,rt.useRef)([]),i=(0,rt.useRef)(!1),[s,a]=(0,rt.useState)(TM[0]),[r,o]=(0,rt.useState)(14),[c,l]=(0,rt.useState)(!1),[h,p]=(0,rt.useState)(""),[u,d]=(0,rt.useState)("fast"),[,m]=(0,rt.useState)(0),S=(0,rt.useCallback)(()=>{let _=t.current,x=_?.getContext("2d");if(!(!_||!x)){x.fillStyle="#0a1120",x.fillRect(0,0,bc,bc);for(let v of n.current){x.save(),x.globalCompositeOperation=v.erase?"destination-out":"source-over",x.strokeStyle=v.color,x.fillStyle=v.color,x.lineWidth=v.width,x.lineCap="round",x.lineJoin="round";let[T,...A]=v.points;if(!T){x.restore();continue}x.beginPath(),x.arc(T.x,T.y,v.width/2,0,Math.PI*2),x.fill(),x.beginPath(),x.moveTo(T.x,T.y);for(let w of A)x.lineTo(w.x,w.y);x.stroke(),x.restore()}}},[]);(0,rt.useEffect)(()=>S(),[S]);let g=_=>{let x=_.currentTarget.getBoundingClientRect(),v=bc/Math.max(1,Math.min(x.width,x.height));return{x:(_.clientX-x.left)*v,y:(_.clientY-x.top)*v}},f=n.current.length===0;return(0,J.jsxs)("div",{className:"fz-sketch",children:[(0,J.jsx)("canvas",{ref:t,className:"fz-sketch-canvas",width:bc,height:bc,onPointerDown:_=>{_.currentTarget.setPointerCapture(_.pointerId),i.current=!0,n.current.push({points:[g(_)],color:s,width:r,erase:c}),S()},onPointerMove:_=>{i.current&&(n.current[n.current.length-1]?.points.push(g(_)),S())},onPointerUp:()=>{i.current=!1,m(_=>_+1)}}),(0,J.jsxs)("div",{className:"fz-tools",children:[TM.map(_=>(0,J.jsx)("button",{type:"button",className:`fz-swatch${!c&&s===_?" selected":""}`,style:{background:_},"aria-label":`paint ${_}`,onClick:()=>{a(_),l(!1)}},_)),(0,J.jsx)("button",{type:"button",className:`fz-ghost${c?" selected":""}`,onClick:()=>l(_=>!_),children:"erase"}),(0,J.jsx)("input",{className:"fz-size",type:"range",min:4,max:60,value:r,onChange:_=>o(Number(_.target.value)),"aria-label":"brush size"}),(0,J.jsx)("button",{type:"button",className:"fz-ghost",disabled:f,onClick:()=>{n.current=[],S(),m(_=>_+1)},children:"clear"})]}),(0,J.jsx)("textarea",{className:"fz-prompt",placeholder:"describe the scene \u2014 'two friends at a diner, neon light'",value:h,maxLength:2e3,onChange:_=>p(_.target.value)}),(0,J.jsx)("div",{className:"fz-modes",children:f3.map(_=>(0,J.jsx)("button",{type:"button",className:u===_.id?"active":"",onClick:()=>d(_.id),children:_.label},_.id))}),(0,J.jsx)("button",{type:"button",className:"fz-primary",disabled:e.busy||!h.trim(),onClick:()=>{let _=t.current;n.current.length>0&&_?_.toBlob(v=>e.onGenerate(v,h.trim(),u),"image/png"):e.onGenerate(null,h.trim(),u)},children:e.busy?"generating\u2026":"generate the still"})]})}var AM=1/30,wM=10*1024*1024;function p3(e,t,n=1e4){return new Promise((i,s)=>{if(Math.abs(e.currentTime-t)<.001&&e.readyState>=2){i();return}let a=window.setTimeout(()=>{e.removeEventListener("seeked",r),s(new Error("couldn't read that frame"))},n);function r(){window.clearTimeout(a),i()}e.addEventListener("seeked",r,{once:!0}),e.currentTime=t})}function RM(e,t){let n=document.createElement("canvas");n.width=Math.min(t,e.videoWidth),n.height=Math.round(n.width*e.videoHeight/Math.max(1,e.videoWidth));let i=n.getContext("2d");return!i||!n.width?null:(i.drawImage(e,0,0,n.width,n.height),n)}async function m3(e,t,n=1e4){try{await p3(e,t,n);let i=RM(e,160);return i?i.toDataURL("image/jpeg",.8):null}catch{return null}}function g3(e){let{busy:t,onFrame:n}=e,i=(0,rt.useRef)(null),s=(0,rt.useRef)(null),a=(0,rt.useRef)(null),r=(0,rt.useRef)(!1),o=(0,rt.useRef)(0),[c,l]=(0,rt.useState)(null),[h,p]=(0,rt.useState)(0),[u,d]=(0,rt.useState)(0),[m,S]=(0,rt.useState)([]),[g,f]=(0,rt.useState)(!1),[_,x]=(0,rt.useState)(!1),[v,T]=(0,rt.useState)(null);(0,rt.useEffect)(()=>()=>{o.current++,a.current&&URL.revokeObjectURL(a.current)},[]);let A=(0,rt.useCallback)(async M=>{if(!M)return;if(T(null),!M.type.startsWith("video/")){T("choose a video \u2014 mp4, mov, or webm");return}if(M.size>150*1024*1024){T("choose a clip under 150mb");return}f(!0);let C=++o.current,D=URL.createObjectURL(M),L=()=>o.current!==C;try{let P=document.createElement("video");if(P.preload="auto",P.muted=!0,P.playsInline=!0,await new Promise((q,X)=>{let tt=window.setTimeout(()=>X(new Error("that clip took too long to read")),2e4);P.onloadeddata=()=>{window.clearTimeout(tt),q()},P.onerror=()=>{window.clearTimeout(tt),X(new Error("can't decode that video \u2014 try an h.264 mp4"))},P.src=D}),!Number.isFinite(P.duration)||P.duration<=0||P.duration>120)throw new Error("choose a clip under two minutes");if(L()){P.removeAttribute("src"),P.load(),URL.revokeObjectURL(D);return}let W=[],B=Date.now()+15e3;for(let q=0;q<10&&!L();q++){let X=B-Date.now();if(X<=0)break;let tt=Math.max(0,Math.min(P.duration-.05,P.duration*q/10)),ot=await m3(P,tt,X);ot&&W.push({src:ot,time:tt})}if(L()){P.removeAttribute("src"),P.load(),URL.revokeObjectURL(D);return}a.current&&URL.revokeObjectURL(a.current),a.current=D,l(D),p(P.duration),d(P.duration/2),S(W),P.removeAttribute("src"),P.load()}catch(P){URL.revokeObjectURL(D),L()||T(P instanceof Error?P.message:"that video didn't load")}finally{L()||f(!1)}},[]),w=(0,rt.useCallback)(M=>{d(M);let C=s.current;C&&(C.pause(),r.current=!0,C.currentTime=M)},[]),y=(0,rt.useCallback)(async()=>{let M=s.current;if(!(!M||_||t)){x(!0);try{(r.current||M.readyState<2||Math.abs(M.currentTime-u)>.001)&&await new Promise((L,P)=>{let W=window.setTimeout(()=>{M.removeEventListener("seeked",B),P(new Error("couldn't read that frame"))},1e4),B=()=>{window.clearTimeout(W),L()};M.addEventListener("seeked",B,{once:!0}),r.current||(M.currentTime=u)});let C=Math.min(1920,M.videoWidth),D=null;for(;C>0;){let L=RM(M,C);if(!L)throw new Error("frame capture isn't available");if(D=await new Promise(P=>L.toBlob(W=>P(W),"image/jpeg",.94)),!D)throw new Error("frame capture isn't available");if(D.size<=wM||C<=320)break;C=Math.floor(C*.75)}if(!D||D.size>wM)throw new Error("that frame is too large \u2014 try a smaller clip");n(new File([D],"freeze-frame.jpg",{type:"image/jpeg"}))}catch(C){T(C instanceof Error?C.message:"couldn't capture the frame")}finally{x(!1)}}},[u,_,t,n]);return(0,J.jsxs)("div",{className:"fz-framepick",children:[(0,J.jsx)("input",{ref:i,type:"file",accept:"video/*",hidden:!0,onChange:M=>void A(M.target.files?.[0]??null)}),c?(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)("video",{ref:s,className:"fz-video",src:c,muted:!0,playsInline:!0,preload:"auto",onLoadedData:M=>{r.current=!0,M.currentTarget.currentTime=u},onSeeked:()=>{r.current=!1}}),m.length>0&&(0,J.jsx)("div",{className:"fz-strip",children:m.map((M,C)=>(0,J.jsx)("img",{src:M.src,alt:"",onClick:()=>w(M.time)},C))}),(0,J.jsx)("input",{type:"range",className:"fz-scrub",min:0,max:Math.max(AM,h),step:AM,value:u,onChange:M=>w(Number(M.target.value)),"aria-label":"pick the frame"}),(0,J.jsxs)("div",{className:"fz-row",children:[(0,J.jsx)("button",{type:"button",className:"fz-ghost",disabled:g,onClick:()=>i.current?.click(),children:"different clip"}),(0,J.jsx)("button",{type:"button",className:"fz-primary",disabled:_||t,onClick:()=>void y(),children:_?"capturing\u2026":`freeze at ${u.toFixed(2)}s`})]})]}):(0,J.jsxs)("div",{className:"fz-video-empty",children:[(0,J.jsx)("p",{className:"fz-sub",children:"pick the clip \u2014 then scrub to the moment to freeze"}),(0,J.jsx)("button",{type:"button",className:"fz-primary",disabled:g,onClick:()=>i.current?.click(),children:g?"reading the clip\u2026":"choose a video"})]}),v&&(0,J.jsx)("p",{className:"fz-err",children:v})]})}function vd(e,t,n,i){let s=t/2,a=n*.46+(i?.tilt??0)*n*.24,r=i?.zoom??1,o=t*.36*e.distance*r,c=n*.11*e.distance*r,l=(e.azimuth+(i?.yaw??0))*Sc;return{x:s+Math.sin(l)*o,y:a+n*.16+Math.cos(l)*c-Math.sin(e.elevation*Sc)*n*.3,depth:Math.cos(l)}}var Ea=.95,I0=2.3;function yd(e,t){let n=e.azimuth*Sc,i=e.elevation*Sc,s=I0*e.distance;return t.set(Math.sin(n)*Math.cos(i)*s,Ea+Math.sin(i)*s,Math.cos(n)*Math.cos(i)*s),t}function _3(e){let t=new dd({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),e.appendChild(t.domElement),t.domElement.style.position="absolute",t.domElement.style.inset="0";let n=[],i=it=>(n.push(it),it),s=new Wl;s.fog=new Xl(725009,6.5,16);let a=new yn(54,1,.05,80),r=new U(0,1.12,0),o={yaw:.52,pitch:.19,dist:5.2},c={...o},l=()=>{let it=Math.cos(c.pitch);a.position.set(r.x+Math.sin(c.yaw)*it*c.dist,r.y+Math.sin(c.pitch)*c.dist,r.z+Math.cos(c.yaw)*it*c.dist),a.lookAt(r)};l();let h=i(new rc(14,28,4612956,2372656));s.add(h);let p=i(new er({color:4482140,dashSize:.16,gapSize:.12,transparent:!0,opacity:.55})),u=[];for(let it=0;it<=128;it++){let st=it/128*Math.PI*2;u.push(new U(Math.sin(st)*I0,Ea,Math.cos(st)*I0))}let d=new Yi(i(new Ve().setFromPoints(u)),p);d.computeLineDistances(),s.add(d);let m=i(new Ve().setFromPoints([new U(0,.02,0),new U(0,Ea,0)]));s.add(new Yi(m,i(new qi({color:4020818,transparent:!0,opacity:.6}))));let S=[];for(let it=0;it<=64;it++){let st=it/64*Math.PI*2;S.push(new U(Math.sin(st)*.55,.02,Math.cos(st)*.55))}s.add(new Yi(i(new Ve().setFromPoints(S)),i(new qi({color:4020818,transparent:!0,opacity:.7}))));let g=1.9,f=g*.72,_=new je(i(new ma(g*1.07,f*1.1)),i(new mi({color:858139,side:ti})));_.position.set(0,Ea,0);let x=i(new mi({color:4874585,side:ti})),v=i(new ma(g,f)),T=new je(v,x);T.position.set(0,Ea,.001);let A=new je(v,x);A.position.set(0,Ea,-.001),A.rotation.y=Math.PI;let w=new go(i(new $l(v)),i(new qi({color:8366235})));w.position.copy(T.position),s.add(_,T,A,w);let y=i(new mi({color:9426109})),M=null,C=i(new Ve),D=new Yi(C,i(new er({color:9426109,dashSize:.12,gapSize:.1,transparent:!0,opacity:.28})));D.visible=!1,s.add(D);let L=new Gi;s.add(L);let P=i(new yo(.066,16,12)),W=i(new mi({color:9426109})),B=i(new mi({color:15791604})),q=i(new mi({color:16765286,transparent:!0})),X=new Gi;X.add(new je(i(new yo(.1,18,14)),q));let tt=new je(i(new Ql(.062,.22,12)),q);tt.rotation.x=Math.PI/2,tt.position.z=.18,X.add(tt),s.add(X);let ot=i(new Ve().setFromPoints([new U,new U(0,Ea,0)])),ut=new Yi(ot,i(new er({color:16765286,dashSize:.09,gapSize:.09,transparent:!0,opacity:.45})));ut.computeLineDistances(),s.add(ut);let dt=new U,xt=new U(0,Ea,0),Zt=[],se=()=>{let it=e.clientWidth,st=e.clientHeight;if(it===0||st===0)return;let Rt=new It;t.getSize(Rt),(Rt.x!==it||Rt.y!==st)&&(t.setSize(it,st,!1),a.aspect=it/st,a.updateProjectionMatrix()),t.render(s,a)},$t=new ResizeObserver(se);$t.observe(e);let Q=null;return{setImage(it){if(Q?.dispose(),it){let st=new xn(it);st.colorSpace=Tn,st.needsUpdate=!0,Q=st,x.map=st,x.color.set(16777215)}else Q=null,x.map=null,x.color.set(4874585);x.needsUpdate=!0,se()},update(it,st,Rt){Zt=it;let Lt=[];for(let Wt=0;Wt<=96;Wt++){let Nt=yd(Mc(it,Wt/96),new U),Ft=Lt[Lt.length-1];Ft&&Nt.distanceToSquared(Ft)<1e-8||Lt.push(Nt)}if(Lt.length>=2){let Wt=new vo(Lt),Nt=new nc(Wt,120,.03,8,!1),Ft=new je(Nt,y);M&&(s.remove(M),M.geometry.dispose()),M=Ft,s.add(M),C.setFromPoints(Lt.map(qt=>new U(qt.x,.02,qt.z))),D.computeLineDistances(),D.visible=!0}else M&&(s.remove(M),M.geometry.dispose(),M=null,D.visible=!1);L.clear(),it.forEach((Wt,Nt)=>{let Ft=new je(P,Nt===Rt?B:W);Ft.position.copy(yd(Wt,dt)),Nt===Rt&&Ft.scale.setScalar(1.3),Ft.userData.index=Nt,L.add(Ft)});let Ct=Mc(it,st);X.position.copy(yd(Ct,dt)),X.lookAt(xt),q.opacity=Math.cos(Ct.azimuth*Sc)<-.05?.45:1,ot.setFromPoints([X.position.clone(),xt.clone()]),ut.computeLineDistances(),se()},orbit(it,st){c.yaw-=it*.0075,c.pitch=wn(c.pitch+st*.006,-.15,1.35),l(),se()},zoom(it){c.dist=wn(c.dist/it,3.2,10),l(),se()},viewDirty(){return Math.abs(c.yaw-o.yaw)>.01||Math.abs(c.pitch-o.pitch)>.01||Math.abs(c.dist-o.dist)>.05},resetView(){return Math.abs(c.yaw-o.yaw)<=.01&&Math.abs(c.pitch-o.pitch)<=.01&&Math.abs(c.dist-o.dist)<=.05?!1:(Object.assign(c,o),l(),se(),!0)},pick(it,st){let Rt=e.clientWidth,Lt=e.clientHeight,Ct=null,Wt=30;return Zt.forEach((Nt,Ft)=>{yd(Nt,dt).project(a);let qt=(dt.x*.5+.5)*Rt,Bt=(-dt.y*.5+.5)*Lt,ye=Math.hypot(qt-it,Bt-st);ye<Wt&&(Wt=ye,Ct=Ft)}),Ct},dispose(){$t.disconnect(),Q?.dispose(),n.forEach(it=>it.dispose()),M?.geometry.dispose(),t.dispose(),t.domElement.remove()}}}var wo=14;function v3(e){let t=(0,rt.useRef)(null),n=(0,rt.useRef)(null),[i,s]=(0,rt.useState)(!1),a=(0,rt.useRef)(null),r=(0,rt.useRef)(new Map),o=(0,rt.useRef)(e);o.current=e;let c=()=>{let l=a.current;l?.mode==="draw"&&l.snapshot&&l.travel>=wo&&l.samples.length>=2&&o.current.onDrawRevert(l.snapshot)};return(0,rt.useEffect)(()=>{let l=t.current;if(!l||o.current.lite)return;let h=null;try{h=_3(l)}catch{return}n.current=h;let p={reset:()=>h.resetView()?(o.current.onViewChange(!1),!0):!1};return o.current.viewCtl.current=p,o.current.onViewChange(!1),s(!0),()=>{n.current=null,o.current.viewCtl.current===p&&(o.current.viewCtl.current=null),h.dispose()}},[]),(0,rt.useEffect)(()=>{n.current?.setImage(e.image)},[i,e.image]),(0,rt.useEffect)(()=>{n.current?.update(e.keyframes,e.scrubT,e.selected)},[i,e.keyframes,e.scrubT,e.selected]),(0,J.jsx)("div",{ref:t,className:"fz-stage-canvas",onPointerDown:l=>{if(!i)return;if(r.current.set(l.pointerId,{x:l.clientX,y:l.clientY}),l.currentTarget.setPointerCapture(l.pointerId),r.current.size>=2){c();let d=[...r.current.values()];a.current={mode:"view",picked:null,moved:!0,lastX:(d[0].x+d[1].x)/2,lastY:(d[0].y+d[1].y)/2,az:0,el:0,travel:0,samples:[],pinchD:Math.hypot(d[0].x-d[1].x,d[0].y-d[1].y),snapshot:null};return}let h=l.currentTarget.getBoundingClientRect(),p=n.current?.pick(l.clientX-h.left,l.clientY-h.top)??null;p!==null&&o.current.onPick(p);let u=p!==null&&(o.current.keyframes[p]?.time===0||o.current.keyframes[p]?.time===1);a.current={mode:o.current.mode==="draw"?"draw":o.current.mode==="look"?"view":p===null||u?"none":"edit",picked:p,moved:!1,lastX:l.clientX,lastY:l.clientY,az:0,el:0,travel:0,samples:[{azimuth:0,elevation:0}],pinchD:0,snapshot:o.current.keyframes}},onPointerMove:l=>{let h=a.current;if(!h||!i)return;if(r.current.has(l.pointerId)&&r.current.set(l.pointerId,{x:l.clientX,y:l.clientY}),h.mode==="view"){let d=n.current,m=[...r.current.values()];if(!d||m.length===0)return;let S=m.reduce((f,_)=>f+_.x,0)/m.length,g=m.reduce((f,_)=>f+_.y,0)/m.length;if(d.orbit(S-h.lastX,g-h.lastY),h.lastX=S,h.lastY=g,m.length===2){let f=Math.hypot(m[0].x-m[1].x,m[0].y-m[1].y);h.pinchD>0&&d.zoom(f/h.pinchD),h.pinchD=f}else h.pinchD=0;o.current.onViewChange(d.viewDirty());return}let p=l.clientX-h.lastX,u=l.clientY-h.lastY;if(!(Math.abs(p)+Math.abs(u)<.5)){if(h.lastX=l.clientX,h.lastY=l.clientY,h.moved=!0,h.mode==="edit"){o.current.onDragPose(p*.6,-u*.4,h.picked);return}h.mode!=="none"&&(h.travel+=Math.abs(p)+Math.abs(u),h.az=wn(h.az+p*.6,-360,360),h.el=wn(h.el-u*.4,-90,90),h.samples.length<600?h.samples.push({azimuth:h.az,elevation:h.el}):h.samples[h.samples.length-1]={azimuth:h.az,elevation:h.el},h.travel>=wo&&h.samples.length>=2&&(h.samples.length<4||h.samples.length%4===0)&&o.current.onDrawPath(h.samples))}},onPointerUp:l=>{r.current.delete(l.pointerId);let h=a.current;if(h?.mode==="view"){if(r.current.size===0)a.current=null;else{let p=[...r.current.values()][0];h.lastX=p.x,h.lastY=p.y,h.pinchD=0}return}if(a.current=null,!(!h||!i)){if(!h.moved){o.current.onPick(h.picked);return}h.mode==="draw"&&h.travel>=wo&&h.samples.length>=2&&o.current.onDrawPath(h.samples)}},onPointerCancel:l=>{r.current.delete(l.pointerId);let h=a.current;if(h?.mode==="view"&&r.current.size>0){let p=[...r.current.values()][0];h.lastX=p.x,h.lastY=p.y,h.pinchD=0;return}a.current=null},children:!i&&(0,J.jsx)(y3,{...e})})}function y3(e){let t=(0,rt.useRef)(null),n=(0,rt.useRef)(null),i=(0,rt.useRef)(new Map),s=(0,rt.useRef)({yaw:0,tilt:0,zoom:1}),a=(0,rt.useRef)(e);a.current=e;let r=()=>{let c=n.current;c?.mode==="draw"&&c.snapshot&&c.travel>=wo&&c.samples.length>=2&&a.current.onDrawRevert(c.snapshot)},o=(0,rt.useCallback)(()=>{let c=t.current,l=c?.getContext("2d");if(!c||!l)return;let h=Math.min(2,window.devicePixelRatio||1),p=c.clientWidth,u=c.clientHeight;(c.width!==p*h||c.height!==u*h)&&(c.width=p*h,c.height=u*h),l.setTransform(h,0,0,h,0,0),l.clearRect(0,0,p,u),l.strokeStyle="rgba(160,196,182,0.10)",l.lineWidth=1;let d=u*.62;for(let M=0;M<=12;M++){let C=d+Math.pow(M/12,1.6)*(u-d);l.beginPath(),l.moveTo(0,C),l.lineTo(p,C),l.stroke()}for(let M=-8;M<=8;M++)l.beginPath(),l.moveTo(p/2+M*p*.07,d),l.lineTo(p/2+M*p*.22,u),l.stroke();let m=s.current,S=p/2,g=u*.46+m.tilt*u*.24,f=p*.36*m.zoom,_=u*.11*m.zoom;l.strokeStyle="rgba(159,216,197,0.22)",l.setLineDash([4,6]),l.beginPath(),l.ellipse(S,g+u*.16,f,_,0,0,Math.PI*2),l.stroke(),l.setLineDash([]);let x=e.keyframes;if(x.length>=2){l.strokeStyle="rgba(143,212,189,0.9)",l.lineWidth=3,l.lineCap="round",l.beginPath();let M=96;for(let C=0;C<=M;C++){let D=vd(Mc(x,C/M),p,u,m);C===0?l.moveTo(D.x,D.y):l.lineTo(D.x,D.y)}l.stroke()}let v=Math.min(p*.4,u*.4*(4/3)),T=v*.72;if(l.save(),l.shadowColor="rgba(0,0,0,0.6)",l.shadowBlur=24,l.fillStyle="#0d181b",l.fillRect(S-v/2,g-T/2,v,T),l.restore(),e.image){let M=e.image,C=Math.min(v/M.width,T/M.height),D=M.width*C,L=M.height*C;l.drawImage(M,S-D/2,g-L/2,D,L)}else l.fillStyle="rgba(214,233,226,0.5)",l.font="13px ui-monospace, monospace",l.textAlign="center",l.fillText("no photo",S,g);l.strokeStyle="rgba(159,216,197,0.45)",l.strokeRect(S-v/2,g-T/2,v,T),x.forEach((M,C)=>{let D=vd(M,p,u,m);l.beginPath(),l.arc(D.x,D.y,C===e.selected?7:5,0,Math.PI*2),l.fillStyle=C===e.selected?"#f0f5f4":"#8fd4bd",l.fill(),C===e.selected&&(l.strokeStyle="rgba(143,212,189,0.6)",l.lineWidth=2,l.stroke())});let A=Mc(x,e.scrubT),w=vd(A,p,u,m),y=w.depth<-.05;l.globalAlpha=y?.45:1,l.beginPath(),l.arc(w.x,w.y,13,0,Math.PI*2),l.fillStyle="#ffd166",l.fill(),l.beginPath(),l.arc(w.x,w.y,5,0,Math.PI*2),l.fillStyle="#0a1120",l.fill(),l.strokeStyle="rgba(255,209,102,0.35)",l.setLineDash([3,5]),l.beginPath(),l.moveTo(w.x,w.y),l.lineTo(S,g),l.stroke(),l.setLineDash([]),l.globalAlpha=1},[e.image,e.keyframes,e.scrubT,e.selected]);return(0,rt.useEffect)(()=>{let c=()=>{let h=s.current;return Math.abs(h.yaw)>.5||Math.abs(h.tilt)>.02||Math.abs(h.zoom-1)>.02},l={reset:()=>c()?(s.current={yaw:0,tilt:0,zoom:1},o(),a.current.onViewChange(!1),!0):!1};return a.current.viewCtl.current=l,a.current.onViewChange(!1),()=>{a.current.viewCtl.current===l&&(a.current.viewCtl.current=null)}},[o]),(0,rt.useEffect)(()=>{o()},[o]),(0,rt.useEffect)(()=>{let c=()=>o();return window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)},[o]),(0,J.jsx)("canvas",{ref:t,className:"fz-stage-canvas",onPointerDown:c=>{if(i.current.set(c.pointerId,{x:c.clientX,y:c.clientY}),c.currentTarget.setPointerCapture(c.pointerId),i.current.size>=2){r();let m=[...i.current.values()];n.current={mode:"view",picked:null,moved:!0,lastX:(m[0].x+m[1].x)/2,lastY:(m[0].y+m[1].y)/2,az:0,el:0,travel:0,samples:[],pinchD:Math.hypot(m[0].x-m[1].x,m[0].y-m[1].y),snapshot:null};return}let l=c.currentTarget.getBoundingClientRect(),h=c.clientX-l.left,p=c.clientY-l.top,u=e.keyframes.findIndex(m=>{let S=vd(m,l.width,l.height,s.current);return Math.hypot(S.x-h,S.y-p)<20});u>=0&&e.onPick(u);let d=u>=0&&(e.keyframes[u]?.time===0||e.keyframes[u]?.time===1);n.current={mode:e.mode==="draw"?"draw":e.mode==="look"?"view":u<0||d?"none":"edit",picked:u>=0?u:null,moved:!1,lastX:c.clientX,lastY:c.clientY,az:0,el:0,travel:0,samples:[{azimuth:0,elevation:0}],pinchD:0,snapshot:e.keyframes}},onPointerMove:c=>{let l=n.current;if(!l)return;if(i.current.has(c.pointerId)&&i.current.set(c.pointerId,{x:c.clientX,y:c.clientY}),l.mode==="view"){let u=[...i.current.values()];if(u.length===0)return;let d=u.reduce((_,x)=>_+x.x,0)/u.length,m=u.reduce((_,x)=>_+x.y,0)/u.length,S=d-l.lastX,g=m-l.lastY,f=s.current;if(f.yaw-=S*.3,f.tilt=wn(f.tilt+g*.0035,-.5,.7),l.lastX=d,l.lastY=m,u.length===2){let _=Math.hypot(u[0].x-u[1].x,u[0].y-u[1].y);l.pinchD>0&&(f.zoom=wn(f.zoom*(_/l.pinchD),.7,2.2)),l.pinchD=_}else l.pinchD=0;o(),a.current.onViewChange(Math.abs(f.yaw)>.5||Math.abs(f.tilt)>.02||Math.abs(f.zoom-1)>.02);return}let h=c.clientX-l.lastX,p=c.clientY-l.lastY;if(!(Math.abs(h)+Math.abs(p)<.5)){if(l.lastX=c.clientX,l.lastY=c.clientY,l.moved=!0,l.mode==="edit"){e.onDragPose(h*.6,-p*.4,l.picked);return}l.mode!=="none"&&(l.travel+=Math.abs(h)+Math.abs(p),l.az=wn(l.az+h*.6,-360,360),l.el=wn(l.el-p*.4,-90,90),l.samples.length<600?l.samples.push({azimuth:l.az,elevation:l.el}):l.samples[l.samples.length-1]={azimuth:l.az,elevation:l.el},l.travel>=wo&&l.samples.length>=2&&(l.samples.length<4||l.samples.length%4===0)&&e.onDrawPath(l.samples))}},onPointerUp:c=>{i.current.delete(c.pointerId);let l=n.current;if(l?.mode==="view"){if(i.current.size===0)n.current=null;else{let h=[...i.current.values()][0];l.lastX=h.x,l.lastY=h.y,l.pinchD=0}return}if(n.current=null,!!l){if(!l.moved){e.onPick(l.picked);return}l.mode==="draw"&&l.travel>=wo&&l.samples.length>=2&&e.onDrawPath(l.samples)}},onPointerCancel:c=>{i.current.delete(c.pointerId);let l=n.current;if(l?.mode==="view"&&i.current.size>0){let h=[...i.current.values()][0];l.lastX=h.x,l.lastY=h.y,l.pinchD=0;return}n.current=null}})}function x3({kind:e}){let t={orbit:"M50 43a34 13 0 1 1 1 0l-5-4m5 4-5 3","orbit-left":"M50 43a34 13 0 1 0-1 0l5-4m-5 4 5 3",swing:"M50 43Q84 44 84 30Q82 20 67 19",rise:"M50 43Q88 43 77 18Q68 4 50 7","arc-return":"M50 43Q84 44 84 30Q82 20 67 19M67 23Q78 24 79 30Q79 39 50 39l5-4m-5 4 5 3","rise-return":"M46 43V10l-4 5m4-5 4 5M56 10v33l-4-5m4 5 4-5","arc-left-return":"M50 43Q16 44 16 30Q18 20 33 19M33 23Q22 24 21 30Q21 39 50 39l-5-4m5 4-5 3","wide-return":"M50 43C5 43 5 17 50 17C90 17 90 39 50 39l5-4m-5 4 5 3","dip-return":"M46 16v32l-4-5m4 5 4-5M56 48V16l-4 5m4-5 4 5","high-arc-return":"M50 43Q84 30 72 8M72 8Q76 30 50 39l5-5","low-arc-return":"M50 24Q16 30 28 49M28 49Q24 30 50 28l-5-4","sway-return":"M50 43Q16 43 16 30Q50 8 84 30Q84 43 50 43l5-4m-5 4 5 3",halo:"M50 43C96 43 91 5 50 5C9 5 4 43 50 43l-5-4m5 4-5 3","halo-left":"M50 43C4 43 9 5 50 5C91 5 96 43 50 43l5-4m-5 4 5 3","arc-left":"M50 43Q16 44 16 30Q18 20 33 19","low-angle":"M50 20Q85 20 78 48l-5-4m5 4 3-5"};return(0,J.jsxs)("svg",{className:"fz-path",viewBox:"0 0 100 56","aria-hidden":"true",children:[(0,J.jsx)("ellipse",{cx:"50",cy:"30",rx:"34",ry:"13",className:"fz-path-guide"}),(0,J.jsx)("path",{d:"M50 13v25M43 33l7 5 7-5",className:"fz-path-axis"}),(0,J.jsx)("circle",{cx:"50",cy:"29",r:"4",className:"fz-path-subject"}),(0,J.jsx)("path",{className:"fz-path-motion",d:t[e]??t.orbit}),(0,J.jsx)("circle",{cx:"50",cy:"43",r:"3",className:"fz-path-camera"})]})}function b3(e){let[t,n]=(0,rt.useState)(e.initial.sourceAssetId?"camera":"source"),[i,s]=(0,rt.useState)(e.initial.sourceUrl),[a,r]=(0,rt.useState)(e.initial.sourceAssetId),[o,c]=(0,rt.useState)(e.initial.renders),[l,h]=(0,rt.useState)(e.initial.activeJob),[p,u]=(0,rt.useState)(e.initial.latest),[d,m]=(0,rt.useState)(!1),[S,g]=(0,rt.useState)(null),[f,_]=(0,rt.useState)(!1),[x,v]=(0,rt.useState)(!1),[T,A]=(0,rt.useState)(!1),[w,y]=(0,rt.useState)(null),[M,C]=(0,rt.useState)([L0,{time:.5,azimuth:65,elevation:8,distance:1},h3]),[D,L]=(0,rt.useState)(0),[P,W]=(0,rt.useState)(null),[B,q]=(0,rt.useState)("draw"),[X,tt]=(0,rt.useState)(!1),ot=(0,rt.useRef)(null),[ut,dt]=(0,rt.useState)(null),[xt,Zt]=(0,rt.useState)(5),[se,$t]=(0,rt.useState)("768P"),[Q]=(0,rt.useState)(()=>Math.floor(Math.random()*1e6)),it=(0,rt.useRef)(null),[,st]=(0,rt.useState)(0),Rt=(0,rt.useRef)(null),Lt=(0,rt.useRef)(null),Ct=(0,rt.useRef)(0),Wt=(0,rt.useRef)(e.initial.sourceAssetId),Nt=(0,rt.useRef)(null),Ft=(0,rt.useCallback)(I=>{let $=Nt.current;$&&$!==I&&(URL.revokeObjectURL($),Nt.current=null),I.startsWith("blob:")&&(Nt.current=I),s(I)},[]),qt=(0,rt.useCallback)(()=>{Nt.current&&(URL.revokeObjectURL(Nt.current),Nt.current=null),s(null)},[]);(0,rt.useEffect)(()=>()=>{Nt.current&&URL.revokeObjectURL(Nt.current)},[]);let Bt=(0,rt.useCallback)((I,$=!1)=>{if(typeof I.latest=="number"&&u(I.latest),h(I.activeJob??null),I.line&&g(I.line),I.sourceUrl&&($||I.sourceAssetId!==Wt.current)&&Ft(I.sourceUrl),I.sourceAssetId&&(Wt.current=I.sourceAssetId,r(I.sourceAssetId)),I.renders&&c(I.renders),w&&!I.activeJob){let j=(w.kind==="render"?I.renders:I.sketches)?.find(V=>V.jobId===w.id);j&&(j.state==="delivered"||j.state==="failed")&&(y(null),j.state==="delivered"?w.kind==="render"?(g(null),n("result")):(_(!1),g("still delivered \u2014 set the camera move"),n("camera")):g(j.error??"that didn't come out \u2014 try again?"))}},[w,Ft]),ye=(0,rt.useRef)(0),ce=(0,rt.useCallback)(async()=>{let I=++ye.current,$=await Ao({action:"status",after:String(p)});if(!(!$||I!==ye.current))return Bt($),$},[p,Bt]),He=(0,rt.useCallback)(async I=>{for(let $=0;$<10;$++){if(Wt.current!==I)return;let N=await ce();if(Wt.current!==I)return;if(N&&N.sourceAssetId===I&&(Bt(N,!0),N.sourceUrl)){g(null);return}await new Promise(j=>setTimeout(j,1200))}Wt.current===I&&g("still converting \u2014 back out and re-upload if it stalls")},[ce,Bt]),Pe=(0,rt.useCallback)(()=>{let I=Date.now();I-Ct.current<3e4||(Ct.current=I,ce().then($=>{$&&Bt($,!0)}))},[ce,Bt]),xe=(0,rt.useRef)(0);(0,rt.useEffect)(()=>{let I=++xe.current;if(!i){it.current=null,st(N=>N+1);return}let $=new Image;$.crossOrigin="anonymous",$.onload=()=>{I===xe.current&&(it.current=$,st(N=>N+1))},$.onerror=()=>{I===xe.current&&Pe()},$.src=i},[i,Pe]),(0,rt.useEffect)(()=>{if(!l)return;let I=!1,$=window.setInterval(()=>{I||(I=!0,ce().finally(()=>{I=!1}))},2500);return()=>window.clearInterval($)},[l,ce]);let Te=(I,$)=>g(I?.line??$),O=(0,rt.useCallback)(async I=>{if(!I||d)return;m(!0),g("reading the photo\u2026");let N=I.type.startsWith("image/")&&!/hei[cf]/i.test(I.type)?URL.createObjectURL(I):null,j=new FormData;j.set("action","source"),j.set("file",I);let V=await Ao(j);if(m(!1),!V||V.error||V.sourceAssetId===void 0){N&&URL.revokeObjectURL(N),Te(V,"that photo didn't come through \u2014 try another.");return}g(null),r(V.sourceAssetId),_(!1),v(!1),Wt.current=V.sourceAssetId,V.sourceUrl?(N&&URL.revokeObjectURL(N),Ft(V.sourceUrl)):N?Ft(N):(qt(),g("converting the photo\u2026")),n("camera"),ce(),!V.sourceUrl&&!N&&V.sourceAssetId&&He(V.sourceAssetId)},[d,ce,Ft,qt,He]),pn=(0,rt.useCallback)(async(I,$,N)=>{if(d)return;m(!0),g("generating the still \u2014 about a minute");let j=new FormData;j.set("action","source"),j.set("kind","sketch"),j.set("prompt",$),j.set("mode",N),I&&j.set("canvas",I,"sketch.png");let V=await Ao(j);if(m(!1),!V||V.error||!V.jobId){Te(V,"that didn't work \u2014 try again?");return}y({id:V.jobId,kind:"sketch"}),Bt(V),g("generating the still \u2014 about a minute")},[d,Bt]),re=(0,rt.useCallback)(I=>{dt(I.id),Zt(I.duration===6?6:5),C(I.trajectory.map($=>({...$}))),W(null),L(0)},[]),R=(0,rt.useCallback)(()=>{let I=wn(D,.02,.98);if(M.length>=gd||M.some(j=>Math.abs(j.time-I)<.01))return;let $=Mc(M,I),N=[...M,{...$,time:I}].sort((j,V)=>j.time-V.time).map(j=>({...j}));C(N),W(null),dt(null)},[M,D]),b=(0,rt.useCallback)(()=>{C(I=>{if(P===null||I.length<=2)return I;let $=I[P];return!$||$.time===0||$.time===1?I:I.filter((N,j)=>j!==P)}),W(null),dt(null)},[P]),F=(0,rt.useCallback)((I,$,N)=>{A(!0),dt(null),C(j=>{let V=N??P;if(V===null){let nt=1/0;j.forEach((Et,Mt)=>{let Ae=Math.abs(Et.time-D);Ae<nt&&(nt=Ae,V=Mt)})}if(V===null)return j;let lt=j[V];if(!lt||lt.time===0||lt.time===1)return j;let mt=j.map((nt,Et)=>Et===V?{...nt,azimuth:wn(nt.azimuth+I,-360,360),elevation:wn(nt.elevation+$,-90,90)}:nt);return W(V),mt})},[P,D]),k=(0,rt.useCallback)(I=>{if(I.length===0)return;let $=Math.min(I.length,gd-1),N=[{...L0}];for(let lt=0;lt<$-1;lt++){let mt=Math.floor(lt*(I.length-1)/Math.max(1,$-1)),nt=I[Math.min(mt,I.length-1)];N.push({time:Number(((lt+1)/$).toFixed(4)),azimuth:Math.round(nt.azimuth*10)/10,elevation:Math.round(nt.elevation*10)/10,distance:1})}let j=I[I.length-1];N.push({time:1,azimuth:Math.round(j.azimuth*10)/10,elevation:Math.round(j.elevation*10)/10,distance:1});let V=[];for(let lt of N){let mt=V[V.length-1];mt&&Math.abs(lt.azimuth-mt.azimuth)<.05&&Math.abs(lt.elevation-mt.elevation)<.05?V[V.length-1]={...mt,time:V.length===1?mt.time:lt.time}:V.push(lt)}V.length<2||(A(!0),dt(null),W(null),C(V),L(1))},[]),Z=(0,rt.useCallback)(I=>{C(I.map($=>({...$}))),W(null)},[]),ct=(0,rt.useCallback)((I,$)=>{dt(null),A(!0),C(N=>N.map((j,V)=>V!==I||j.time===0||j.time===1?j:{...j,...$.azimuth!==void 0?{azimuth:wn($.azimuth,-360,360)}:{},...$.elevation!==void 0?{elevation:wn($.elevation,-90,90)}:{}}))},[]),gt=(0,rt.useCallback)(async()=>{if(d||!a||!i)return;m(!0),g("rendering the freeze \u2014 a few minutes");let I={action:"render",duration:String(xt),resolution:se,seed:String(Q)};ut?I.preset=ut:I.trajectory=JSON.stringify(M);let $=await Ao(I);if(m(!1),!$||$.error||!$.jobId){Te($,"that render didn't start \u2014 try again?");return}y({id:$.jobId,kind:"render"}),Bt($),g("freezing \u2014 a few minutes")},[d,a,i,ut,se,Q,M,xt,Bt]),K=(0,rt.useCallback)(async I=>{if(d)return;m(!0),g("sending to iMessage\u2026");let $=await Ao({action:"save",job:I});if(m(!1),!$||$.error){Te($,"couldn't send it \u2014 try again");return}$.downloadUrl?(window.open($.downloadUrl,"_blank","noopener"),g("sent the link \u2014 it's only good for a little while")):g("sent to iMessage")},[d]),et=(0,rt.useCallback)(async()=>{await Ao({action:"cancel"}),y(null),g(null),await ce()},[ce]),pt=(0,rt.useMemo)(()=>o.filter(I=>I.state==="delivered"&&I.outputUrl),[o]),Tt=pt[pt.length-1],ft=P!==null&&P<M.length?P:null;if(ft===null){let I=1/0;M.forEach(($,N)=>{if($.time===0||$.time===1)return;let j=Math.abs($.time-D);j<I&&(I=j,ft=N)})}let ht=ft!==null?M[ft]:void 0,At=!!ht&&ht.time!==0&&ht.time!==1;return(0,J.jsxs)("div",{className:"fz",children:[(0,J.jsx)("div",{className:"fz-tabs",children:["source","camera","result"].map(I=>(0,J.jsx)("button",{type:"button",className:t===I?"active":"",disabled:I==="camera"&&!a||I==="result"&&pt.length===0,onClick:()=>n(I),children:I==="source"?"1 \xB7 photo":I==="camera"?"2 \xB7 camera":"3 \xB7 freeze"},I))}),l&&(0,J.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void et(),children:"cancel the running job"}),t==="source"&&(0,J.jsx)("div",{className:"fz-stage",children:!f&&!x?(0,J.jsxs)(J.Fragment,{children:[(0,J.jsxs)("div",{className:"fz-hero",children:[(0,J.jsx)("p",{className:"fz-title",children:"freeze the scene"}),(0,J.jsx)("p",{className:"fz-sub",children:"pick the still \u2014 the camera moves, the moment doesn\u2019t"})]}),(0,J.jsxs)("div",{className:"fz-source-grid",children:[(0,J.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>Lt.current?.click(),children:[(0,J.jsx)("span",{className:"fz-card-icon",children:"\u25C9"}),"take a photo"]}),(0,J.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>Rt.current?.click(),children:[(0,J.jsx)("span",{className:"fz-card-icon",children:"\u25A4"}),"upload a photo"]}),(0,J.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>_(!0),children:[(0,J.jsx)("span",{className:"fz-card-icon",children:"\u270E"}),"sketch + generate"]}),(0,J.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>v(!0),children:[(0,J.jsx)("span",{className:"fz-card-icon",children:"\u25B6"}),"video \u2192 freeze a frame"]})]}),(0,J.jsx)("input",{ref:Lt,type:"file",accept:"image/*,.heic,.heif",capture:"environment",hidden:!0,onChange:I=>void O(I.target.files?.[0]??null)}),(0,J.jsx)("input",{ref:Rt,type:"file",accept:"image/*,.heic,.heif",hidden:!0,onChange:I=>void O(I.target.files?.[0]??null)}),pt.length>0&&(0,J.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("result"),children:"see your freezes \u2192"})]}):f?(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>_(!1),children:"\u2190 back"}),(0,J.jsx)(d3,{busy:d||w?.kind==="sketch",onGenerate:pn})]}):(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>v(!1),children:"\u2190 back"}),(0,J.jsx)(g3,{busy:d,onFrame:I=>void O(I)})]})}),t==="camera"&&(0,J.jsxs)("div",{className:"fz-stage fz-cam",children:[(0,J.jsxs)("div",{className:"fz-stage-wrap",children:[(0,J.jsx)(v3,{image:it.current,keyframes:M,scrubT:D,selected:P,lite:e.initial.lite,mode:B,onViewChange:tt,viewCtl:ot,onDragPose:F,onDrawPath:k,onDrawRevert:Z,onPick:W}),X&&(0,J.jsx)("button",{type:"button",className:"fz-viewreset",onClick:()=>ot.current?.reset(),children:"reset view"}),!T&&(0,J.jsxs)("div",{className:"fz-stage-hint",children:[(0,J.jsx)("span",{className:"fz-stage-dot"}),B==="draw"?"drag to draw the camera path":B==="look"?"drag to look \u2014 pinch to zoom":"drag a dot to move it"]})]}),(0,J.jsxs)("div",{className:"fz-modebar",role:"group","aria-label":"stage gesture",children:[(0,J.jsx)("span",{className:"fz-ctl-label",children:"stage"}),(0,J.jsxs)("div",{className:"fz-seg",children:[(0,J.jsx)("button",{type:"button",className:B==="draw"?"active":"","aria-pressed":B==="draw",onClick:()=>q("draw"),children:"draw path"}),(0,J.jsx)("button",{type:"button",className:B==="edit"?"active":"","aria-pressed":B==="edit",onClick:()=>q("edit"),children:"move dot"}),(0,J.jsx)("button",{type:"button",className:B==="look"?"active":"","aria-pressed":B==="look",onClick:()=>q("look"),children:"look"})]})]}),(0,J.jsx)("div",{className:"fz-ctl-label",children:"camera move"}),(0,J.jsx)("div",{className:"fz-prail",children:e.initial.presets.map(I=>(0,J.jsxs)("button",{type:"button",className:`fz-preset${ut===I.id?" active":""}`,title:I.description,"aria-pressed":ut===I.id,onClick:()=>re(I),children:[(0,J.jsx)(x3,{kind:I.id}),(0,J.jsx)("span",{className:"fz-preset-name",children:I.name}),(0,J.jsx)("span",{className:"fz-preset-return",children:I.returnsToStart?"returns to start":"new angle"})]},I.id))}),(0,J.jsxs)("div",{className:"fz-timeline",children:[(0,J.jsxs)("div",{className:"fz-timeline-meta",children:[(0,J.jsxs)("span",{children:[(D*xt).toFixed(2),"s / ",xt,"s"]}),(0,J.jsxs)("span",{children:[M.length," keyframes",ut?` \xB7 ${e.initial.presets.find(I=>I.id===ut)?.name??ut}`:" \xB7 drawn",P!==null&&(M[P].time===0||M[P].time===1?" \xB7 endpoint":` \xB7 kf ${P+1}`)]})]}),(0,J.jsxs)("div",{className:"fz-track",onPointerDown:I=>{let $=I.currentTarget.getBoundingClientRect(),N=I.clientX-$.left,j=null,V=23;M.forEach((lt,mt)=>{let nt=Math.abs(lt.time*$.width-N);nt<V&&(V=nt,j=mt)}),j!==null?(W(j),L(M[j].time)):L(wn(N/$.width,0,1)),I.currentTarget.setPointerCapture(I.pointerId)},onPointerMove:I=>{if(I.buttons!==1)return;let $=I.currentTarget.getBoundingClientRect();L(wn((I.clientX-$.left)/$.width,0,1))},children:[(0,J.jsx)("div",{className:"fz-track-ticks"}),M.map((I,$)=>(0,J.jsx)("button",{type:"button",className:`fz-kf${P===$?" selected":""}`,style:{left:`${I.time*100}%`},onClick:()=>{W($),L(I.time)},"aria-label":`keyframe ${$+1} at ${Math.round(I.time*100)}%`},$)),(0,J.jsx)("div",{className:"fz-head",style:{left:`${D*100}%`},children:(0,J.jsx)("i",{})})]}),(0,J.jsxs)("div",{className:"fz-timeline-row",children:[(0,J.jsx)("span",{className:"fz-meta",children:P!==null?M[P].time===0||M[P].time===1?"endpoints hold the framing":"move this dot with the sliders or the scene":B==="draw"?"drag the scene to sketch the path":B==="look"?"drag to look around \u2014 pinch to zoom":"drag a dot to move it"}),(0,J.jsxs)("div",{className:"fz-timeline-actions",children:[(0,J.jsx)("button",{type:"button",className:"fz-ghost",disabled:M.length>=gd,onClick:R,children:"+ keyframe"}),(0,J.jsx)("button",{type:"button",className:"fz-ghost",disabled:P===null||M[P]?.time===0||M[P]?.time===1,onClick:b,children:"\u2212 remove"})]})]})]}),(0,J.jsxs)("div",{className:"fz-aim",children:[(0,J.jsx)("div",{className:"fz-ctl-label",children:At?`aim \u2014 keyframe ${(ft??0)+1}`:"aim \u2014 tap a middle dot on the timeline"}),(0,J.jsxs)("div",{className:"fz-aim-row",children:[(0,J.jsx)("span",{className:"fz-aim-label",children:"orbit"}),(0,J.jsx)("input",{type:"range",min:-360,max:360,step:1,value:ht?.azimuth??0,disabled:!At,"aria-label":"orbit angle in degrees",onChange:I=>{ft!==null&&ct(ft,{azimuth:Number(I.target.value)})}}),(0,J.jsx)("span",{className:"fz-aim-val",children:At&&ht?`${Math.round(ht.azimuth)}\xB0`:"\u2014"})]}),(0,J.jsxs)("div",{className:"fz-aim-row",children:[(0,J.jsx)("span",{className:"fz-aim-label",children:"height"}),(0,J.jsx)("input",{type:"range",min:-90,max:90,step:1,value:ht?.elevation??0,disabled:!At,"aria-label":"camera height in degrees",onChange:I=>{ft!==null&&ct(ft,{elevation:Number(I.target.value)})}}),(0,J.jsx)("span",{className:"fz-aim-val",children:At&&ht?`${Math.round(ht.elevation)}\xB0`:"\u2014"})]})]}),(0,J.jsxs)("div",{className:"fz-render-row",children:[(0,J.jsx)("div",{className:"fz-seg",children:[5,6].map(I=>(0,J.jsxs)("button",{type:"button",className:xt===I?"active":"",onClick:()=>Zt(I),children:[I,"s"]},I))}),(0,J.jsx)("div",{className:"fz-seg",children:["480P","768P","1080P"].map(I=>(0,J.jsx)("button",{type:"button",className:se===I?"active":"",onClick:()=>$t(I),children:I==="480P"?"480":I==="768P"?"720":"1080"},I))}),(0,J.jsx)("button",{type:"button",className:"fz-primary",disabled:d||!a||!i||w!==null,onClick:()=>void gt(),children:w?.kind==="render"||d?"freezing\u2026":"freeze it"})]})]}),t==="result"&&(0,J.jsxs)("div",{className:"fz-stage",children:[Tt?(0,J.jsxs)("div",{className:"fz-result",children:[(0,J.jsx)("video",{className:"fz-video",src:Tt.outputUrl??void 0,controls:!0,playsInline:!0,loop:!0,autoPlay:!0,muted:!0,onError:Pe}),(0,J.jsxs)("div",{className:"fz-actions",children:[(0,J.jsx)("button",{type:"button",className:"fz-primary",disabled:d,onClick:()=>void K(Tt.jobId),children:"send to iMessage"}),(0,J.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("camera"),children:"new camera move"})]})]}):l?(0,J.jsx)("p",{className:"fz-sub",children:"rendering \u2014 this takes a few minutes"}):(0,J.jsx)("p",{className:"fz-sub",children:"nothing rendered yet"}),pt.length>1&&(0,J.jsx)("div",{className:"fz-history",children:pt.slice(0,-1).reverse().map(I=>(0,J.jsxs)("div",{className:"fz-history-row",children:[(0,J.jsx)("video",{className:"fz-thumb",src:I.outputUrl??void 0,muted:!0,playsInline:!0,preload:"metadata",onError:Pe}),(0,J.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void K(I.jobId),children:"send"})]},I.jobId))})]}),(0,J.jsx)("p",{className:"fz-line",children:S??""})]})}var S3=`
...
`,U0=document.getElementById("freeze-studio");if(U0){let e=null;try{e=JSON.parse(U0.dataset.payload??"")}catch{e=null}if(e){let t=document.createElement("style");t.textContent=S3,document.head.appendChild(t),(0,CM.createRoot)(U0).render((0,J.jsx)(rt.StrictMode,{children:(0,J.jsx)(b3,{initial:e})}))}}})();
