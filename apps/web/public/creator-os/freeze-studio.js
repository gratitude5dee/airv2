...
`,N0=document.getElementById("freeze-studio");if(N0){let e=null;try{e=JSON.parse(N0.dataset.payload??"")}catch{e=null}if(e){let t=document.createElement("style");t.textContent=b2,document.head.appendChild(t),(0,AM.createRoot)(N0).render((0,Q.jsx)(at.StrictMode,{children:(0,Q.jsx)(x2,{initial:e})}))}}})();
