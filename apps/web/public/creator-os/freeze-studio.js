...
`)+`
`+f);let S=_+m+r,v=_+f+o,E=Qb(s,s.VERTEX_SHADER,S),w=Qb(s,s.FRAGMENT_SHADER,v);s.attachShader(b,E),s.attachShader(b,w),n.index0AttributeName!==void 0?s.bindAttribLocation(b,0,n.index0AttributeName):n.hasPositionAttribute===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function C(D){if(e.debug.checkShaderErrors){let O=s.getProgramInfoLog(b)||"",W=s.getShaderInfoLog(E)||"",q=s.getShaderInfoLog(w)||"",P=O.trim(),G=W.trim(),k=q.trim(),Q=!0,et=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(Q=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(s,b,E,w);else{let at=tM(s,E,"vertex"),rt=tM(s,w,"fragment");It("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
Program Info Log: `+P+`
`+at+`
`+rt)}else P!==""?Nt("WebGLProgram: Program Info Log:",P):(G===""||k==="")&&(et=!1);et&&(D.diagnostics={runnable:Q,programLog:P,vertexShader:{log:G,prefix:m},fragmentShader:{log:k,prefix:f}})}s.deleteShader(E),s.deleteShader(w),x=new So(s,b),A=d2(s,b)}let x;this.getUniforms=function(){return x===void 0&&C(this),x};let A;this.getAttributes=function(){return A===void 0&&C(this),A};let R=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=s.getProgramParameter(b,i2)),R},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(b),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=s2++,this.cacheKey=t,this.usedTimes=1,this.program=b,this.vertexShader=E,this.fragmentShader=w,this}var R2=0,E0=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,n,i){let s=this._getShaderCacheForMaterial(t);return s.has(n)===!1&&(s.add(n),n.usedTimes++),s.has(i)===!1&&(s.add(i),i.usedTimes++),this}remove(t){let n=this.materialCache.get(t);for(let i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let n=this.materialCache,i=n.get(t);return i===void 0&&(i=new Set,n.set(t,i)),i}_getShaderStage(t){let n=this.shaderCache,i=n.get(t);return i===void 0&&(i=new T0(t),n.set(t,i)),i}},T0=class{constructor(t){this.id=R2++,this.code=t,this.usedTimes=0}};function D2(e){return e===xa||e===uc||e===hc}function U2(e,t,n,i,s,a){let r=new Fl,o=new E0,l=new Set,c=[],h=new Map,p=i.logarithmicDepthBuffer,u=i.precision,d={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return l.add(x),x===0?"uv":`uv${x}`}function b(x,A,R,D,O,W){let q=D.fog,P=O.geometry,G=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?D.environment:null,k=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,Q=t.get(x.envMap||G,k),et=Q&&Q.mapping===sc?Q.image.height:null,at=d[x.type];x.precision!==null&&(u=i.getMaxPrecision(x.precision),u!==x.precision&&Nt("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let rt=P.morphAttributes.position||P.morphAttributes.normal||P.morphAttributes.color,yt=rt!==void 0?rt.length:0,Bt=0;P.morphAttributes.position!==void 0&&(Bt=1),P.morphAttributes.normal!==void 0&&(Bt=2),P.morphAttributes.color!==void 0&&(Bt=3);let ne,Xt,K,st;if(at){let bt=Zi[at];ne=bt.vertexShader,Xt=bt.fragmentShader}else{ne=x.vertexShader,Xt=x.fragmentShader;let bt=o.getVertexShaderStage(x),Ie=o.getFragmentShaderStage(x);o.update(x,bt,Ie),K=bt.id,st=Ie.id}let nt=e.getRenderTarget(),Tt=e.state.buffers.depth.getReversed(),Pt=O.isInstancedMesh===!0,Rt=O.isBatchedMesh===!0,Se=!!x.map,kt=!!x.matcap,oe=!!Q,ie=!!x.aoMap,te=!!x.lightMap,Ne=!!x.bumpMap&&x.wireframe===!1,Be=!!x.normalMap,ke=!!x.displacementMap,Je=!!x.emissiveMap,be=!!x.metalnessMap,Le=!!x.roughnessMap,L=x.anisotropy>0,en=x.clearcoat>0,H=x.dispersion>0,T=x.iridescence>0,y=x.sheen>0,N=x.transmission>0,z=L&&!!x.anisotropyMap,Y=en&&!!x.clearcoatMap,it=en&&!!x.clearcoatNormalMap,ot=en&&!!x.clearcoatRoughnessMap,Z=T&&!!x.iridescenceMap,J=T&&!!x.iridescenceThicknessMap,ct=y&&!!x.sheenColorMap,At=y&&!!x.sheenRoughnessMap,pt=!!x.specularMap,ut=!!x.specularColorMap,Dt=!!x.specularIntensityMap,Lt=N&&!!x.transmissionMap,Vt=N&&!!x.thicknessMap,I=!!x.gradientMap,lt=!!x.alphaMap,j=x.alphaTest>0,ht=!!x.alphaHash,vt=!!x.extensions,tt=Mi;x.toneMapped&&(nt===null||nt.isXRRenderTarget===!0)&&(tt=e.toneMapping);let Et={shaderID:at,shaderType:x.type,shaderName:x.name,vertexShader:ne,fragmentShader:Xt,defines:x.defines,customVertexShaderID:K,customFragmentShaderID:st,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:Rt,batchingColor:Rt&&O._colorsTexture!==null,instancing:Pt,instancingColor:Pt&&O.instanceColor!==null,instancingMorph:Pt&&O.morphTexture!==null,outputColorSpace:nt===null?e.outputColorSpace:nt.isXRRenderTarget===!0?nt.texture.colorSpace:jt.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:Se,matcap:kt,envMap:oe,envMapMode:oe&&Q.mapping,envMapCubeUVHeight:et,aoMap:ie,lightMap:te,bumpMap:Ne,normalMap:Be,displacementMap:ke,emissiveMap:Je,normalMapObjectSpace:Be&&x.normalMapType===wb,normalMapTangentSpace:Be&&x.normalMapType===a0,packedNormalMap:Be&&x.normalMapType===a0&&D2(x.normalMap.format),metalnessMap:be,roughnessMap:Le,anisotropy:L,anisotropyMap:z,clearcoat:en,clearcoatMap:Y,clearcoatNormalMap:it,clearcoatRoughnessMap:ot,dispersion:H,iridescence:T,iridescenceMap:Z,iridescenceThicknessMap:J,sheen:y,sheenColorMap:ct,sheenRoughnessMap:At,specularMap:pt,specularColorMap:ut,specularIntensityMap:Dt,transmission:N,transmissionMap:Lt,thicknessMap:Vt,gradientMap:I,opaque:x.transparent===!1&&x.blending===Ja&&x.alphaToCoverage===!1,alphaMap:lt,alphaTest:j,alphaHash:ht,combine:x.combine,mapUv:Se&&g(x.map.channel),aoMapUv:ie&&g(x.aoMap.channel),lightMapUv:te&&g(x.lightMap.channel),bumpMapUv:Ne&&g(x.bumpMap.channel),normalMapUv:Be&&g(x.normalMap.channel),displacementMapUv:ke&&g(x.displacementMap.channel),emissiveMapUv:Je&&g(x.emissiveMap.channel),metalnessMapUv:be&&g(x.metalnessMap.channel),roughnessMapUv:Le&&g(x.roughnessMap.channel),anisotropyMapUv:z&&g(x.anisotropyMap.channel),clearcoatMapUv:Y&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:it&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ot&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Z&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:J&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:ct&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:At&&g(x.sheenRoughnessMap.channel),specularMapUv:pt&&g(x.specularMap.channel),specularColorMapUv:ut&&g(x.specularColorMap.channel),specularIntensityMapUv:Dt&&g(x.specularIntensityMap.channel),transmissionMapUv:Lt&&g(x.transmissionMap.channel),thicknessMapUv:Vt&&g(x.thicknessMap.channel),alphaMapUv:lt&&g(x.alphaMap.channel),vertexTangents:!!P.attributes.tangent&&(Be||L),vertexNormals:!!P.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!P.attributes.color&&P.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!P.attributes.uv&&(Se||lt),fog:!!q,useFog:x.fog===!0,fogExp2:!!q&&q.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||P.attributes.normal===void 0&&Be===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:p,reversedDepthBuffer:Tt,skinning:O.isSkinnedMesh===!0,hasPositionAttribute:P.attributes.position!==void 0,morphTargets:P.morphAttributes.position!==void 0,morphNormals:P.morphAttributes.normal!==void 0,morphColors:P.morphAttributes.color!==void 0,morphTargetsCount:yt,morphTextureStride:Bt,numDirLights:A.directional.length,numPointLights:A.point.length,numSpotLights:A.spot.length,numSpotLightMaps:A.spotLightMap.length,numRectAreaLights:A.rectArea.length,numHemiLights:A.hemi.length,numDirLightShadows:A.directionalShadowMap.length,numPointLightShadows:A.pointShadowMap.length,numSpotLightShadows:A.spotShadowMap.length,numSpotLightShadowsWithMaps:A.numSpotLightShadowsWithMaps,numLightProbes:A.numLightProbes,numLightProbeGrids:W.length,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:x.dithering,shadowMapEnabled:e.shadowMap.enabled&&R.length>0,shadowMapType:e.shadowMap.type,toneMapping:tt,decodeVideoTexture:Se&&x.map.isVideoTexture===!0&&jt.getTransfer(x.map.colorSpace)===le,decodeVideoTextureEmissive:Je&&x.emissiveMap.isVideoTexture===!0&&jt.getTransfer(x.emissiveMap.colorSpace)===le,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Xi,flipSided:x.side===An,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:vt&&x.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(vt&&x.extensions.multiDraw===!0||Rt)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Et.vertexUv1s=l.has(1),Et.vertexUv2s=l.has(2),Et.vertexUv3s=l.has(3),l.clear(),Et}function m(x){let A=[];if(x.shaderID?A.push(x.shaderID):(A.push(x.customVertexShaderID),A.push(x.customFragmentShaderID)),x.defines!==void 0)for(let R in x.defines)A.push(R),A.push(x.defines[R]);return x.isRawShaderMaterial===!1&&(f(A,x),_(A,x),A.push(e.outputColorSpace)),A.push(x.customProgramCacheKey),A.join()}function f(x,A){x.push(A.precision),x.push(A.outputColorSpace),x.push(A.envMapMode),x.push(A.envMapCubeUVHeight),x.push(A.mapUv),x.push(A.alphaMapUv),x.push(A.lightMapUv),x.push(A.aoMapUv),x.push(A.bumpMapUv),x.push(A.normalMapUv),x.push(A.displacementMapUv),x.push(A.emissiveMapUv),x.push(A.metalnessMapUv),x.push(A.roughnessMapUv),x.push(A.anisotropyMapUv),x.push(A.clearcoatMapUv),x.push(A.clearcoatNormalMapUv),x.push(A.clearcoatRoughnessMapUv),x.push(A.iridescenceMapUv),x.push(A.iridescenceThicknessMapUv),x.push(A.sheenColorMapUv),x.push(A.sheenRoughnessMapUv),x.push(A.specularMapUv),x.push(A.specularColorMapUv),x.push(A.specularIntensityMapUv),x.push(A.transmissionMapUv),x.push(A.thicknessMapUv),x.push(A.combine),x.push(A.fogExp2),x.push(A.sizeAttenuation),x.push(A.morphTargetsCount),x.push(A.morphAttributeCount),x.push(A.numDirLights),x.push(A.numPointLights),x.push(A.numSpotLights),x.push(A.numSpotLightMaps),x.push(A.numHemiLights),x.push(A.numRectAreaLights),x.push(A.numDirLightShadows),x.push(A.numPointLightShadows),x.push(A.numSpotLightShadows),x.push(A.numSpotLightShadowsWithMaps),x.push(A.numLightProbes),x.push(A.shadowMapType),x.push(A.toneMapping),x.push(A.numClippingPlanes),x.push(A.numClipIntersection),x.push(A.depthPacking)}function _(x,A){r.disableAll(),A.instancing&&r.enable(0),A.instancingColor&&r.enable(1),A.instancingMorph&&r.enable(2),A.matcap&&r.enable(3),A.envMap&&r.enable(4),A.normalMapObjectSpace&&r.enable(5),A.normalMapTangentSpace&&r.enable(6),A.clearcoat&&r.enable(7),A.iridescence&&r.enable(8),A.alphaTest&&r.enable(9),A.vertexColors&&r.enable(10),A.vertexAlphas&&r.enable(11),A.vertexUv1s&&r.enable(12),A.vertexUv2s&&r.enable(13),A.vertexUv3s&&r.enable(14),A.vertexTangents&&r.enable(15),A.anisotropy&&r.enable(16),A.alphaHash&&r.enable(17),A.batching&&r.enable(18),A.dispersion&&r.enable(19),A.batchingColor&&r.enable(20),A.gradientMap&&r.enable(21),A.packedNormalMap&&r.enable(22),A.vertexNormals&&r.enable(23),x.push(r.mask),r.disableAll(),A.fog&&r.enable(0),A.useFog&&r.enable(1),A.flatShading&&r.enable(2),A.logarithmicDepthBuffer&&r.enable(3),A.reversedDepthBuffer&&r.enable(4),A.skinning&&r.enable(5),A.morphTargets&&r.enable(6),A.morphNormals&&r.enable(7),A.morphColors&&r.enable(8),A.premultipliedAlpha&&r.enable(9),A.shadowMapEnabled&&r.enable(10),A.doubleSided&&r.enable(11),A.flipSided&&r.enable(12),A.useDepthPacking&&r.enable(13),A.dithering&&r.enable(14),A.transmission&&r.enable(15),A.sheen&&r.enable(16),A.opaque&&r.enable(17),A.pointsUvs&&r.enable(18),A.decodeVideoTexture&&r.enable(19),A.decodeVideoTextureEmissive&&r.enable(20),A.alphaToCoverage&&r.enable(21),A.numLightProbeGrids>0&&r.enable(22),A.hasPositionAttribute&&r.enable(23),x.push(r.mask)}function S(x){let A=d[x.type],R;if(A){let D=Zi[A];R=Fb.clone(D.uniforms)}else R=x.uniforms;return R}function v(x,A){let R=h.get(A);return R!==void 0?++R.usedTimes:(R=new C2(e,A,x,s),c.push(R),h.set(A,R)),R}function E(x){if(--x.usedTimes===0){let A=c.indexOf(x);c[A]=c[c.length-1],c.pop(),h.delete(x.cacheKey),x.destroy()}}function w(x){o.remove(x)}function C(){o.dispose()}return{getParameters:b,getProgramCacheKey:m,getUniforms:S,acquireProgram:v,releaseProgram:E,releaseShaderCache:w,programs:c,dispose:C}}function N2(){let e=new WeakMap;function t(r){return e.has(r)}function n(r){let o=e.get(r);return o===void 0&&(o={},e.set(r,o)),o}function i(r){e.delete(r)}function s(r,o,l){e.get(r)[o]=l}function a(){e=new WeakMap}return{has:t,get:n,remove:i,update:s,dispose:a}}function L2(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.material.id!==t.material.id?e.material.id-t.material.id:e.materialVariant!==t.materialVariant?e.materialVariant-t.materialVariant:e.z!==t.z?e.z-t.z:e.id-t.id}function aM(e,t){return e.groupOrder!==t.groupOrder?e.groupOrder-t.groupOrder:e.renderOrder!==t.renderOrder?e.renderOrder-t.renderOrder:e.z!==t.z?t.z-e.z:e.id-t.id}function rM(){let e=[],t=0,n=[],i=[],s=[];function a(){t=0,n.length=0,i.length=0,s.length=0}function r(u){let d=0;return u.isInstancedMesh&&(d+=2),u.isSkinnedMesh&&(d+=1),d}function o(u,d,g,b,m,f){let _=e[t];return _===void 0?(_={id:u.id,object:u,geometry:d,material:g,materialVariant:r(u),groupOrder:b,renderOrder:u.renderOrder,z:m,group:f},e[t]=_):(_.id=u.id,_.object=u,_.geometry=d,_.material=g,_.materialVariant=r(u),_.groupOrder=b,_.renderOrder=u.renderOrder,_.z=m,_.group=f),t++,_}function l(u,d,g,b,m,f){let _=o(u,d,g,b,m,f);g.transmission>0?i.push(_):g.transparent===!0?s.push(_):n.push(_)}function c(u,d,g,b,m,f){let _=o(u,d,g,b,m,f);g.transmission>0?i.unshift(_):g.transparent===!0?s.unshift(_):n.unshift(_)}function h(u,d,g){n.length>1&&n.sort(u||L2),i.length>1&&i.sort(d||aM),s.length>1&&s.sort(d||aM),g&&(n.reverse(),i.reverse(),s.reverse())}function p(){for(let u=t,d=e.length;u<d;u++){let g=e[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:n,transmissive:i,transparent:s,init:a,push:l,unshift:c,finish:p,sort:h}}function I2(){let e=new WeakMap;function t(i,s){let a=e.get(i),r;return a===void 0?(r=new rM,e.set(i,[r])):s>=a.length?(r=new rM,a.push(r)):r=a[s],r}function n(){e=new WeakMap}return{get:t,dispose:n}}function O2(){let e={};return{get:function(t){if(e[t.id]!==void 0)return e[t.id];let n;switch(t.type){case"DirectionalLight":n={direction:new U,color:new Qt};break;case"SpotLight":n={position:new U,direction:new U,color:new Qt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new U,color:new Qt,distance:0,decay:0};break;case"HemisphereLight":n={direction:new U,skyColor:new Qt,groundColor:new Qt};break;case"RectAreaLight":n={color:new Qt,position:new U,halfWidth:new U,halfHeight:new U};break}return e[t.id]=n,n}}}function P2(){let e={};return{get:function(t){if(e[t.id]!==void 0)return e[t.id];let n;switch(t.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ut};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ut};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ut,shadowCameraNear:1,shadowCameraFar:1e3};break}return e[t.id]=n,n}}}var z2=0;function B2(e,t){return(t.castShadow?2:0)-(e.castShadow?2:0)+(t.map?1:0)-(e.map?1:0)}function F2(e){let t=new O2,n=P2(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new U);let s=new U,a=new De,r=new De;function o(c){let h=0,p=0,u=0;for(let A=0;A<9;A++)i.probe[A].set(0,0,0);let d=0,g=0,b=0,m=0,f=0,_=0,S=0,v=0,E=0,w=0,C=0;c.sort(B2);for(let A=0,R=c.length;A<R;A++){let D=c[A],O=D.color,W=D.intensity,q=D.distance,P=null;if(D.shadow&&D.shadow.map&&(D.shadow.map.texture.format===xa?P=D.shadow.map.texture:P=D.shadow.map.depthTexture||D.shadow.map.texture),D.isAmbientLight)h+=O.r*W,p+=O.g*W,u+=O.b*W;else if(D.isLightProbe){for(let G=0;G<9;G++)i.probe[G].addScaledVector(D.sh.coefficients[G],W);C++}else if(D.isDirectionalLight){let G=t.get(D);if(G.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){let k=D.shadow,Q=n.get(D);Q.shadowIntensity=k.intensity,Q.shadowBias=k.bias,Q.shadowNormalBias=k.normalBias,Q.shadowRadius=k.radius,Q.shadowMapSize=k.mapSize,i.directionalShadow[d]=Q,i.directionalShadowMap[d]=P,i.directionalShadowMatrix[d]=D.shadow.matrix,_++}i.directional[d]=G,d++}else if(D.isSpotLight){let G=t.get(D);G.position.setFromMatrixPosition(D.matrixWorld),G.color.copy(O).multiplyScalar(W),G.distance=q,G.coneCos=Math.cos(D.angle),G.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),G.decay=D.decay,i.spot[b]=G;let k=D.shadow;if(D.map&&(i.spotLightMap[E]=D.map,E++,k.updateMatrices(D),D.castShadow&&w++),i.spotLightMatrix[b]=k.matrix,D.castShadow){let Q=n.get(D);Q.shadowIntensity=k.intensity,Q.shadowBias=k.bias,Q.shadowNormalBias=k.normalBias,Q.shadowRadius=k.radius,Q.shadowMapSize=k.mapSize,i.spotShadow[b]=Q,i.spotShadowMap[b]=P,v++}b++}else if(D.isRectAreaLight){let G=t.get(D);G.color.copy(O).multiplyScalar(W),G.halfWidth.set(D.width*.5,0,0),G.halfHeight.set(0,D.height*.5,0),i.rectArea[m]=G,m++}else if(D.isPointLight){let G=t.get(D);if(G.color.copy(D.color).multiplyScalar(D.intensity),G.distance=D.distance,G.decay=D.decay,D.castShadow){let k=D.shadow,Q=n.get(D);Q.shadowIntensity=k.intensity,Q.shadowBias=k.bias,Q.shadowNormalBias=k.normalBias,Q.shadowRadius=k.radius,Q.shadowMapSize=k.mapSize,Q.shadowCameraNear=k.camera.near,Q.shadowCameraFar=k.camera.far,i.pointShadow[g]=Q,i.pointShadowMap[g]=P,i.pointShadowMatrix[g]=D.shadow.matrix,S++}i.point[g]=G,g++}else if(D.isHemisphereLight){let G=t.get(D);G.skyColor.copy(D.color).multiplyScalar(W),G.groundColor.copy(D.groundColor).multiplyScalar(W),i.hemi[f]=G,f++}}m>0&&(e.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=mt.LTC_FLOAT_1,i.rectAreaLTC2=mt.LTC_FLOAT_2):(i.rectAreaLTC1=mt.LTC_HALF_1,i.rectAreaLTC2=mt.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=p,i.ambient[2]=u;let x=i.hash;(x.directionalLength!==d||x.pointLength!==g||x.spotLength!==b||x.rectAreaLength!==m||x.hemiLength!==f||x.numDirectionalShadows!==_||x.numPointShadows!==S||x.numSpotShadows!==v||x.numSpotMaps!==E||x.numLightProbes!==C)&&(i.directional.length=d,i.spot.length=b,i.rectArea.length=m,i.point.length=g,i.hemi.length=f,i.directionalShadow.length=_,i.directionalShadowMap.length=_,i.pointShadow.length=S,i.pointShadowMap.length=S,i.spotShadow.length=v,i.spotShadowMap.length=v,i.directionalShadowMatrix.length=_,i.pointShadowMatrix.length=S,i.spotLightMatrix.length=v+E-w,i.spotLightMap.length=E,i.numSpotLightShadowsWithMaps=w,i.numLightProbes=C,x.directionalLength=d,x.pointLength=g,x.spotLength=b,x.rectAreaLength=m,x.hemiLength=f,x.numDirectionalShadows=_,x.numPointShadows=S,x.numSpotShadows=v,x.numSpotMaps=E,x.numLightProbes=C,i.version=z2++)}function l(c,h){let p=0,u=0,d=0,g=0,b=0,m=h.matrixWorldInverse;for(let f=0,_=c.length;f<_;f++){let S=c[f];if(S.isDirectionalLight){let v=i.directional[p];v.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),v.direction.sub(s),v.direction.transformDirection(m),p++}else if(S.isSpotLight){let v=i.spot[d];v.position.setFromMatrixPosition(S.matrixWorld),v.position.applyMatrix4(m),v.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),v.direction.sub(s),v.direction.transformDirection(m),d++}else if(S.isRectAreaLight){let v=i.rectArea[g];v.position.setFromMatrixPosition(S.matrixWorld),v.position.applyMatrix4(m),r.identity(),a.copy(S.matrixWorld),a.premultiply(m),r.extractRotation(a),v.halfWidth.set(S.width*.5,0,0),v.halfHeight.set(0,S.height*.5,0),v.halfWidth.applyMatrix4(r),v.halfHeight.applyMatrix4(r),g++}else if(S.isPointLight){let v=i.point[u];v.position.setFromMatrixPosition(S.matrixWorld),v.position.applyMatrix4(m),u++}else if(S.isHemisphereLight){let v=i.hemi[b];v.direction.setFromMatrixPosition(S.matrixWorld),v.direction.transformDirection(m),b++}}}return{setup:o,setupView:l,state:i}}function oM(e){let t=new F2(e),n=[],i=[],s=[];function a(u){p.camera=u,n.length=0,i.length=0,s.length=0}function r(u){n.push(u)}function o(u){i.push(u)}function l(u){s.push(u)}function c(){t.setup(n)}function h(u){t.setupView(n,u)}let p={lightsArray:n,shadowsArray:i,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:a,state:p,setupLights:c,setupLightsView:h,pushLight:r,pushShadow:o,pushLightProbeGrid:l}}function V2(e){let t=new WeakMap;function n(s,a=0){let r=t.get(s),o;return r===void 0?(o=new oM(e),t.set(s,[o])):a>=r.length?(o=new oM(e),r.push(o)):o=r[a],o}function i(){t=new WeakMap}return{get:n,dispose:i}}var H2=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,k2=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],X2=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],lM=new De,pc=new U,v0=new U;function W2(e,t,n){let i=new Xl,s=new Ut,a=new Ut,r=new Ue,o=new rf,l=new of,c={},h=n.maxTextureSize,p={[bs]:An,[An]:bs,[Xi]:Xi},u=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ut},radius:{value:4}},vertexShader:H2,fragmentShader:G2}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let g=new ln;g.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let b=new Qe(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ic;let f=this.type;this.render=function(w,C,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;this.type===sb&&(Nt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ic);let A=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),O=e.state;O.setBlending(Wi),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);let W=f!==this.type;W&&C.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(P=>P.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,P=w.length;q<P;q++){let G=w[q],k=G.shadow;if(k===void 0){Nt("WebGLShadowMap:",G,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;s.copy(k.mapSize);let Q=k.getFrameExtents();s.multiply(Q),a.copy(k.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/Q.x),s.x=a.x*Q.x,k.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/Q.y),s.y=a.y*Q.y,k.mapSize.y=a.y));let et=e.state.buffers.depth.getReversed();if(k.camera._reversedDepth=et,k.map===null||W===!0){if(k.map!==null&&(k.map.depthTexture!==null&&(k.map.depthTexture.dispose(),k.map.depthTexture=null),k.map.dispose()),this.type===_o){if(G.isPointLight){Nt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}k.map=new Jn(s.x,s.y,{format:xa,type:qi,minFilter:pn,magFilter:pn,generateMipmaps:!1}),k.map.texture.name=G.name+".shadowMap",k.map.depthTexture=new Ms(s.x,s.y,Ti),k.map.depthTexture.name=G.name+".shadowMapDepth",k.map.depthTexture.format=Hi,k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=on,k.map.depthTexture.magFilter=on}else G.isPointLight?(k.map=new hd(s.x),k.map.depthTexture=new Jh(s.x,Ei)):(k.map=new Jn(s.x,s.y),k.map.depthTexture=new Ms(s.x,s.y,Ei)),k.map.depthTexture.name=G.name+".shadowMap",k.map.depthTexture.format=Hi,this.type===ic?(k.map.depthTexture.compareFunction=et?od:rd,k.map.depthTexture.minFilter=pn,k.map.depthTexture.magFilter=pn):(k.map.depthTexture.compareFunction=null,k.map.depthTexture.minFilter=on,k.map.depthTexture.magFilter=on);k.camera.updateProjectionMatrix()}let at=k.map.isWebGLCubeRenderTarget?6:1;for(let rt=0;rt<at;rt++){if(k.map.isWebGLCubeRenderTarget)e.setRenderTarget(k.map,rt),e.clear();else{rt===0&&(e.setRenderTarget(k.map),e.clear());let yt=k.getViewport(rt);r.set(a.x*yt.x,a.y*yt.y,a.x*yt.z,a.y*yt.w),O.viewport(r)}if(G.isPointLight){let yt=k.camera,Bt=k.matrix,ne=G.distance||yt.far;ne!==yt.far&&(yt.far=ne,yt.updateProjectionMatrix()),pc.setFromMatrixPosition(G.matrixWorld),yt.position.copy(pc),v0.copy(yt.position),v0.add(k2[rt]),yt.up.copy(X2[rt]),yt.lookAt(v0),yt.updateMatrixWorld(),Bt.makeTranslation(-pc.x,-pc.y,-pc.z),lM.multiplyMatrices(yt.projectionMatrix,yt.matrixWorldInverse),k._frustum.setFromProjectionMatrix(lM,yt.coordinateSystem,yt.reversedDepth)}else k.updateMatrices(G);i=k.getFrustum(),v(C,x,k.camera,G,this.type)}k.isPointLightShadow!==!0&&this.type===_o&&_(k,x),k.needsUpdate=!1}f=this.type,m.needsUpdate=!1,e.setRenderTarget(A,R,D)};function _(w,C){let x=t.update(b);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,d.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Jn(s.x,s.y,{format:xa,type:qi})),u.uniforms.shadow_pass.value=w.map.depthTexture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,e.setRenderTarget(w.mapPass),e.clear(),e.renderBufferDirect(C,null,x,u,b,null),d.uniforms.shadow_pass.value=w.mapPass.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,e.setRenderTarget(w.map),e.clear(),e.renderBufferDirect(C,null,x,d,b,null)}function S(w,C,x,A){let R=null,D=x.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(D!==void 0)R=D;else if(R=x.isPointLight===!0?l:o,e.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let O=R.uuid,W=C.uuid,q=c[O];q===void 0&&(q={},c[O]=q);let P=q[W];P===void 0&&(P=R.clone(),q[W]=P,C.addEventListener("dispose",E)),R=P}if(R.visible=C.visible,R.wireframe=C.wireframe,A===_o?R.side=C.shadowSide!==null?C.shadowSide:C.side:R.side=C.shadowSide!==null?C.shadowSide:p[C.side],R.alphaMap=C.alphaMap,R.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,R.map=C.map,R.clipShadows=C.clipShadows,R.clippingPlanes=C.clippingPlanes,R.clipIntersection=C.clipIntersection,R.displacementMap=C.displacementMap,R.displacementScale=C.displacementScale,R.displacementBias=C.displacementBias,R.wireframeLinewidth=C.wireframeLinewidth,R.linewidth=C.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let O=e.properties.get(R);O.light=x}return R}function v(w,C,x,A,R){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&R===_o)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,w.matrixWorld);let W=t.update(w),q=w.material;if(Array.isArray(q)){let P=W.groups;for(let G=0,k=P.length;G<k;G++){let Q=P[G],et=q[Q.materialIndex];if(et&&et.visible){let at=S(w,et,A,R);w.onBeforeShadow(e,w,C,x,W,at,Q),e.renderBufferDirect(x,null,W,at,w,Q),w.onAfterShadow(e,w,C,x,W,at,Q)}}}else if(q.visible){let P=S(w,q,A,R);w.onBeforeShadow(e,w,C,x,W,P,null),e.renderBufferDirect(x,null,W,P,w,null),w.onAfterShadow(e,w,C,x,W,P,null)}}let O=w.children;for(let W=0,q=O.length;W<q;W++)v(O[W],C,x,A,R)}function E(w){w.target.removeEventListener("dispose",E);for(let x in c){let A=c[x],R=w.target.uuid;R in A&&(A[R].dispose(),delete A[R])}}}function q2(e,t){function n(){let I=!1,lt=new Ue,j=null,ht=new Ue(0,0,0,0);return{setMask:function(vt){j!==vt&&!I&&(e.colorMask(vt,vt,vt,vt),j=vt)},setLocked:function(vt){I=vt},setClear:function(vt,tt,Et,bt,Ie){Ie===!0&&(vt*=bt,tt*=bt,Et*=bt),lt.set(vt,tt,Et,bt),ht.equals(lt)===!1&&(e.clearColor(vt,tt,Et,bt),ht.copy(lt))},reset:function(){I=!1,j=null,ht.set(-1,0,0,0)}}}function i(){let I=!1,lt=!1,j=null,ht=null,vt=null;return{setReversed:function(tt){if(lt!==tt){let Et=t.get("EXT_clip_control");tt?Et.clipControlEXT(Et.LOWER_LEFT_EXT,Et.ZERO_TO_ONE_EXT):Et.clipControlEXT(Et.LOWER_LEFT_EXT,Et.NEGATIVE_ONE_TO_ONE_EXT),lt=tt;let bt=vt;vt=null,this.setClear(bt)}},getReversed:function(){return lt},setTest:function(tt){tt?nt(e.DEPTH_TEST):Tt(e.DEPTH_TEST)},setMask:function(tt){j!==tt&&!I&&(e.depthMask(tt),j=tt)},setFunc:function(tt){if(lt&&(tt=zb[tt]),ht!==tt){switch(tt){case Nh:e.depthFunc(e.NEVER);break;case Lh:e.depthFunc(e.ALWAYS);break;case Ih:e.depthFunc(e.LESS);break;case Ka:e.depthFunc(e.LEQUAL);break;case Oh:e.depthFunc(e.EQUAL);break;case Ph:e.depthFunc(e.GEQUAL);break;case zh:e.depthFunc(e.GREATER);break;case Bh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}ht=tt}},setLocked:function(tt){I=tt},setClear:function(tt){vt!==tt&&(vt=tt,lt&&(tt=1-tt),e.clearDepth(tt))},reset:function(){I=!1,j=null,ht=null,vt=null,lt=!1}}}function s(){let I=!1,lt=null,j=null,ht=null,vt=null,tt=null,Et=null,bt=null,Ie=null;return{setTest:function(_e){I||(_e?nt(e.STENCIL_TEST):Tt(e.STENCIL_TEST))},setMask:function(_e){lt!==_e&&!I&&(e.stencilMask(_e),lt=_e)},setFunc:function(_e,Ai,wi){(j!==_e||ht!==Ai||vt!==wi)&&(e.stencilFunc(_e,Ai,wi),j=_e,ht=Ai,vt=wi)},setOp:function(_e,Ai,wi){(tt!==_e||Et!==Ai||bt!==wi)&&(e.stencilOp(_e,Ai,wi),tt=_e,Et=Ai,bt=wi)},setLocked:function(_e){I=_e},setClear:function(_e){Ie!==_e&&(e.clearStencil(_e),Ie=_e)},reset:function(){I=!1,lt=null,j=null,ht=null,vt=null,tt=null,Et=null,bt=null,Ie=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,h={},p={},u={},d=new WeakMap,g=[],b=null,m=!1,f=null,_=null,S=null,v=null,E=null,w=null,C=null,x=new Qt(0,0,0),A=0,R=!1,D=null,O=null,W=null,q=null,P=null,G=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),k=!1,Q=0,et=e.getParameter(e.VERSION);et.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(et)[1]),k=Q>=1):et.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(et)[1]),k=Q>=2);let at=null,rt={},yt=e.getParameter(e.SCISSOR_BOX),Bt=e.getParameter(e.VIEWPORT),ne=new Ue().fromArray(yt),Xt=new Ue().fromArray(Bt);function K(I,lt,j,ht){let vt=new Uint8Array(4),tt=e.createTexture();e.bindTexture(I,tt),e.texParameteri(I,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(I,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Et=0;Et<j;Et++)I===e.TEXTURE_3D||I===e.TEXTURE_2D_ARRAY?e.texImage3D(lt,0,e.RGBA,1,1,ht,0,e.RGBA,e.UNSIGNED_BYTE,vt):e.texImage2D(lt+Et,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,vt);return tt}let st={};st[e.TEXTURE_2D]=K(e.TEXTURE_2D,e.TEXTURE_2D,1),st[e.TEXTURE_CUBE_MAP]=K(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),st[e.TEXTURE_2D_ARRAY]=K(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),st[e.TEXTURE_3D]=K(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),nt(e.DEPTH_TEST),r.setFunc(Ka),Ne(!1),Be(Fg),nt(e.CULL_FACE),ie(Wi);function nt(I){h[I]!==!0&&(e.enable(I),h[I]=!0)}function Tt(I){h[I]!==!1&&(e.disable(I),h[I]=!1)}function Pt(I,lt){return u[I]!==lt?(e.bindFramebuffer(I,lt),u[I]=lt,I===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=lt),I===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=lt),!0):!1}function Rt(I,lt){let j=g,ht=!1;if(I){j=d.get(lt),j===void 0&&(j=[],d.set(lt,j));let vt=I.textures;if(j.length!==vt.length||j[0]!==e.COLOR_ATTACHMENT0){for(let tt=0,Et=vt.length;tt<Et;tt++)j[tt]=e.COLOR_ATTACHMENT0+tt;j.length=vt.length,ht=!0}}else j[0]!==e.BACK&&(j[0]=e.BACK,ht=!0);ht&&e.drawBuffers(j)}function Se(I){return b!==I?(e.useProgram(I),b=I,!0):!1}let kt={[la]:e.FUNC_ADD,[rb]:e.FUNC_SUBTRACT,[ob]:e.FUNC_REVERSE_SUBTRACT};kt[lb]=e.MIN,kt[cb]=e.MAX;let oe={[ub]:e.ZERO,[hb]:e.ONE,[fb]:e.SRC_COLOR,[Dh]:e.SRC_ALPHA,[vb]:e.SRC_ALPHA_SATURATE,[gb]:e.DST_COLOR,[pb]:e.DST_ALPHA,[db]:e.ONE_MINUS_SRC_COLOR,[Uh]:e.ONE_MINUS_SRC_ALPHA,[_b]:e.ONE_MINUS_DST_COLOR,[mb]:e.ONE_MINUS_DST_ALPHA,[yb]:e.CONSTANT_COLOR,[xb]:e.ONE_MINUS_CONSTANT_COLOR,[Sb]:e.CONSTANT_ALPHA,[bb]:e.ONE_MINUS_CONSTANT_ALPHA};function ie(I,lt,j,ht,vt,tt,Et,bt,Ie,_e){if(I===Wi){m===!0&&(Tt(e.BLEND),m=!1);return}if(m===!1&&(nt(e.BLEND),m=!0),I!==ab){if(I!==f||_e!==R){if((_!==la||E!==la)&&(e.blendEquation(e.FUNC_ADD),_=la,E=la),_e)switch(I){case Ja:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Vg:e.blendFunc(e.ONE,e.ONE);break;case Hg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Gg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:It("WebGLState: Invalid blending: ",I);break}else switch(I){case Ja:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Vg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Hg:It("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Gg:It("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:It("WebGLState: Invalid blending: ",I);break}S=null,v=null,w=null,C=null,x.set(0,0,0),A=0,f=I,R=_e}return}vt=vt||lt,tt=tt||j,Et=Et||ht,(lt!==_||vt!==E)&&(e.blendEquationSeparate(kt[lt],kt[vt]),_=lt,E=vt),(j!==S||ht!==v||tt!==w||Et!==C)&&(e.blendFuncSeparate(oe[j],oe[ht],oe[tt],oe[Et]),S=j,v=ht,w=tt,C=Et),(bt.equals(x)===!1||Ie!==A)&&(e.blendColor(bt.r,bt.g,bt.b,Ie),x.copy(bt),A=Ie),f=I,R=!1}function te(I,lt){I.side===Xi?Tt(e.CULL_FACE):nt(e.CULL_FACE);let j=I.side===An;lt&&(j=!j),Ne(j),I.blending===Ja&&I.transparent===!1?ie(Wi):ie(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),r.setFunc(I.depthFunc),r.setTest(I.depthTest),r.setMask(I.depthWrite),a.setMask(I.colorWrite);let ht=I.stencilWrite;o.setTest(ht),ht&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Je(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?nt(e.SAMPLE_ALPHA_TO_COVERAGE):Tt(e.SAMPLE_ALPHA_TO_COVERAGE)}function Ne(I){D!==I&&(I?e.frontFace(e.CW):e.frontFace(e.CCW),D=I)}function Be(I){I!==nb?(nt(e.CULL_FACE),I!==O&&(I===Fg?e.cullFace(e.BACK):I===ib?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Tt(e.CULL_FACE),O=I}function ke(I){I!==W&&(k&&e.lineWidth(I),W=I)}function Je(I,lt,j){I?(nt(e.POLYGON_OFFSET_FILL),(q!==lt||P!==j)&&(q=lt,P=j,r.getReversed()&&(lt=-lt),e.polygonOffset(lt,j))):Tt(e.POLYGON_OFFSET_FILL)}function be(I){I?nt(e.SCISSOR_TEST):Tt(e.SCISSOR_TEST)}function Le(I){I===void 0&&(I=e.TEXTURE0+G-1),at!==I&&(e.activeTexture(I),at=I)}function L(I,lt,j){j===void 0&&(at===null?j=e.TEXTURE0+G-1:j=at);let ht=rt[j];ht===void 0&&(ht={type:void 0,texture:void 0},rt[j]=ht),(ht.type!==I||ht.texture!==lt)&&(at!==j&&(e.activeTexture(j),at=j),e.bindTexture(I,lt||st[I]),ht.type=I,ht.texture=lt)}function en(){let I=rt[at];I!==void 0&&I.type!==void 0&&(e.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function H(){try{e.compressedTexImage2D(...arguments)}catch(I){It("WebGLState:",I)}}function T(){try{e.compressedTexImage3D(...arguments)}catch(I){It("WebGLState:",I)}}function y(){try{e.texSubImage2D(...arguments)}catch(I){It("WebGLState:",I)}}function N(){try{e.texSubImage3D(...arguments)}catch(I){It("WebGLState:",I)}}function z(){try{e.compressedTexSubImage2D(...arguments)}catch(I){It("WebGLState:",I)}}function Y(){try{e.compressedTexSubImage3D(...arguments)}catch(I){It("WebGLState:",I)}}function it(){try{e.texStorage2D(...arguments)}catch(I){It("WebGLState:",I)}}function ot(){try{e.texStorage3D(...arguments)}catch(I){It("WebGLState:",I)}}function Z(){try{e.texImage2D(...arguments)}catch(I){It("WebGLState:",I)}}function J(){try{e.texImage3D(...arguments)}catch(I){It("WebGLState:",I)}}function ct(I){return p[I]!==void 0?p[I]:e.getParameter(I)}function At(I,lt){p[I]!==lt&&(e.pixelStorei(I,lt),p[I]=lt)}function pt(I){ne.equals(I)===!1&&(e.scissor(I.x,I.y,I.z,I.w),ne.copy(I))}function ut(I){Xt.equals(I)===!1&&(e.viewport(I.x,I.y,I.z,I.w),Xt.copy(I))}function Dt(I,lt){let j=c.get(lt);j===void 0&&(j=new WeakMap,c.set(lt,j));let ht=j.get(I);ht===void 0&&(ht=e.getUniformBlockIndex(lt,I.name),j.set(I,ht))}function Lt(I,lt){let ht=c.get(lt).get(I);l.get(lt)!==ht&&(e.uniformBlockBinding(lt,ht,I.__bindingPointIndex),l.set(lt,ht))}function Vt(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},at=null,rt={},u={},d=new WeakMap,g=[],b=null,m=!1,f=null,_=null,S=null,v=null,E=null,w=null,C=null,x=new Qt(0,0,0),A=0,R=!1,D=null,O=null,W=null,q=null,P=null,ne.set(0,0,e.canvas.width,e.canvas.height),Xt.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:nt,disable:Tt,bindFramebuffer:Pt,drawBuffers:Rt,useProgram:Se,setBlending:ie,setMaterial:te,setFlipSided:Ne,setCullFace:Be,setLineWidth:ke,setPolygonOffset:Je,setScissorTest:be,activeTexture:Le,bindTexture:L,unbindTexture:en,compressedTexImage2D:H,compressedTexImage3D:T,texImage2D:Z,texImage3D:J,pixelStorei:At,getParameter:ct,updateUBOMapping:Dt,uniformBlockBinding:Lt,texStorage2D:it,texStorage3D:ot,texSubImage2D:y,texSubImage3D:N,compressedTexSubImage2D:z,compressedTexSubImage3D:Y,scissor:pt,viewport:ut,reset:Vt}}function Y2(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ut,h=new WeakMap,p=new Set,u,d=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(T,y){return g?new OffscreenCanvas(T,y):zl("canvas")}function m(T,y,N){let z=1,Y=H(T);if((Y.width>N||Y.height>N)&&(z=N/Math.max(Y.width,Y.height)),z<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let it=Math.floor(z*Y.width),ot=Math.floor(z*Y.height);u===void 0&&(u=b(it,ot));let Z=y?b(it,ot):u;return Z.width=it,Z.height=ot,Z.getContext("2d").drawImage(T,0,0,it,ot),Nt("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+it+"x"+ot+")."),Z}else return"data"in T&&Nt("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),T;return T}function f(T){return T.generateMipmaps}function _(T){e.generateMipmap(T)}function S(T){return T.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?e.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function v(T,y,N,z,Y,it=!1){if(T!==null){if(e[T]!==void 0)return e[T];Nt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let ot;z&&(ot=t.get("EXT_texture_norm16"),ot||Nt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=y;if(y===e.RED&&(N===e.FLOAT&&(Z=e.R32F),N===e.HALF_FLOAT&&(Z=e.R16F),N===e.UNSIGNED_BYTE&&(Z=e.R8),N===e.UNSIGNED_SHORT&&ot&&(Z=ot.R16_EXT),N===e.SHORT&&ot&&(Z=ot.R16_SNORM_EXT)),y===e.RED_INTEGER&&(N===e.UNSIGNED_BYTE&&(Z=e.R8UI),N===e.UNSIGNED_SHORT&&(Z=e.R16UI),N===e.UNSIGNED_INT&&(Z=e.R32UI),N===e.BYTE&&(Z=e.R8I),N===e.SHORT&&(Z=e.R16I),N===e.INT&&(Z=e.R32I)),y===e.RG&&(N===e.FLOAT&&(Z=e.RG32F),N===e.HALF_FLOAT&&(Z=e.RG16F),N===e.UNSIGNED_BYTE&&(Z=e.RG8),N===e.UNSIGNED_SHORT&&ot&&(Z=ot.RG16_EXT),N===e.SHORT&&ot&&(Z=ot.RG16_SNORM_EXT)),y===e.RG_INTEGER&&(N===e.UNSIGNED_BYTE&&(Z=e.RG8UI),N===e.UNSIGNED_SHORT&&(Z=e.RG16UI),N===e.UNSIGNED_INT&&(Z=e.RG32UI),N===e.BYTE&&(Z=e.RG8I),N===e.SHORT&&(Z=e.RG16I),N===e.INT&&(Z=e.RG32I)),y===e.RGB_INTEGER&&(N===e.UNSIGNED_BYTE&&(Z=e.RGB8UI),N===e.UNSIGNED_SHORT&&(Z=e.RGB16UI),N===e.UNSIGNED_INT&&(Z=e.RGB32UI),N===e.BYTE&&(Z=e.RGB8I),N===e.SHORT&&(Z=e.RGB16I),N===e.INT&&(Z=e.RGB32I)),y===e.RGBA_INTEGER&&(N===e.UNSIGNED_BYTE&&(Z=e.RGBA8UI),N===e.UNSIGNED_SHORT&&(Z=e.RGBA16UI),N===e.UNSIGNED_INT&&(Z=e.RGBA32UI),N===e.BYTE&&(Z=e.RGBA8I),N===e.SHORT&&(Z=e.RGBA16I),N===e.INT&&(Z=e.RGBA32I)),y===e.RGB&&(N===e.UNSIGNED_SHORT&&ot&&(Z=ot.RGB16_EXT),N===e.SHORT&&ot&&(Z=ot.RGB16_SNORM_EXT),N===e.UNSIGNED_INT_5_9_9_9_REV&&(Z=e.RGB9_E5),N===e.UNSIGNED_INT_10F_11F_11F_REV&&(Z=e.R11F_G11F_B10F)),y===e.RGBA){let J=it?Ol:jt.getTransfer(Y);N===e.FLOAT&&(Z=e.RGBA32F),N===e.HALF_FLOAT&&(Z=e.RGBA16F),N===e.UNSIGNED_BYTE&&(Z=J===le?e.SRGB8_ALPHA8:e.RGBA8),N===e.UNSIGNED_SHORT&&ot&&(Z=ot.RGBA16_EXT),N===e.SHORT&&ot&&(Z=ot.RGBA16_SNORM_EXT),N===e.UNSIGNED_SHORT_4_4_4_4&&(Z=e.RGBA4),N===e.UNSIGNED_SHORT_5_5_5_1&&(Z=e.RGB5_A1)}return(Z===e.R16F||Z===e.R32F||Z===e.RG16F||Z===e.RG32F||Z===e.RGBA16F||Z===e.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function E(T,y){let N;return T?y===null||y===Ei||y===yo?N=e.DEPTH24_STENCIL8:y===Ti?N=e.DEPTH32F_STENCIL8:y===vo&&(N=e.DEPTH24_STENCIL8,Nt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===Ei||y===yo?N=e.DEPTH_COMPONENT24:y===Ti?N=e.DEPTH_COMPONENT32F:y===vo&&(N=e.DEPTH_COMPONENT16),N}function w(T,y){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==on&&T.minFilter!==pn?Math.log2(Math.max(y.width,y.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?y.mipmaps.length:1}function C(T){let y=T.target;y.removeEventListener("dispose",C),A(y),y.isVideoTexture&&h.delete(y),y.isHTMLTexture&&p.delete(y)}function x(T){let y=T.target;y.removeEventListener("dispose",x),D(y)}function A(T){let y=i.get(T);if(y.__webglInit===void 0)return;let N=T.source,z=d.get(N);if(z){let Y=z[y.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&R(T),Object.keys(z).length===0&&d.delete(N)}i.remove(T)}function R(T){let y=i.get(T);e.deleteTexture(y.__webglTexture);let N=T.source,z=d.get(N);delete z[y.__cacheKey],r.memory.textures--}function D(T){let y=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(y.__webglFramebuffer[z]))for(let Y=0;Y<y.__webglFramebuffer[z].length;Y++)e.deleteFramebuffer(y.__webglFramebuffer[z][Y]);else e.deleteFramebuffer(y.__webglFramebuffer[z]);y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer[z])}else{if(Array.isArray(y.__webglFramebuffer))for(let z=0;z<y.__webglFramebuffer.length;z++)e.deleteFramebuffer(y.__webglFramebuffer[z]);else e.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&e.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&e.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let z=0;z<y.__webglColorRenderbuffer.length;z++)y.__webglColorRenderbuffer[z]&&e.deleteRenderbuffer(y.__webglColorRenderbuffer[z]);y.__webglDepthRenderbuffer&&e.deleteRenderbuffer(y.__webglDepthRenderbuffer)}let N=T.textures;for(let z=0,Y=N.length;z<Y;z++){let it=i.get(N[z]);it.__webglTexture&&(e.deleteTexture(it.__webglTexture),r.memory.textures--),i.remove(N[z])}i.remove(T)}let O=0;function W(){O=0}function q(){return O}function P(T){O=T}function G(){let T=O;return T>=s.maxTextures&&Nt("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),O+=1,T}function k(T){let y=[];return y.push(T.wrapS),y.push(T.wrapT),y.push(T.wrapR||0),y.push(T.magFilter),y.push(T.minFilter),y.push(T.anisotropy),y.push(T.internalFormat),y.push(T.format),y.push(T.type),y.push(T.generateMipmaps),y.push(T.premultiplyAlpha),y.push(T.flipY),y.push(T.unpackAlignment),y.push(T.colorSpace),y.join()}function Q(T,y){let N=i.get(T);if(T.isVideoTexture&&L(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&N.__version!==T.version){let z=T.image;if(z===null)Nt("WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)Nt("WebGLRenderer: Texture marked for update but image is incomplete");else{Tt(N,T,y);return}}else T.isExternalTexture&&(N.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,N.__webglTexture,e.TEXTURE0+y)}function et(T,y){let N=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&N.__version!==T.version){Tt(N,T,y);return}else T.isExternalTexture&&(N.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,N.__webglTexture,e.TEXTURE0+y)}function at(T,y){let N=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&N.__version!==T.version){Tt(N,T,y);return}n.bindTexture(e.TEXTURE_3D,N.__webglTexture,e.TEXTURE0+y)}function rt(T,y){let N=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&N.__version!==T.version){Pt(N,T,y);return}n.bindTexture(e.TEXTURE_CUBE_MAP,N.__webglTexture,e.TEXTURE0+y)}let yt={[Fh]:e.REPEAT,[Fi]:e.CLAMP_TO_EDGE,[Vh]:e.MIRRORED_REPEAT},Bt={[on]:e.NEAREST,[Tb]:e.NEAREST_MIPMAP_NEAREST,[ac]:e.NEAREST_MIPMAP_LINEAR,[pn]:e.LINEAR,[Mf]:e.LINEAR_MIPMAP_NEAREST,[va]:e.LINEAR_MIPMAP_LINEAR},ne={[Cb]:e.NEVER,[Lb]:e.ALWAYS,[Rb]:e.LESS,[rd]:e.LEQUAL,[Db]:e.EQUAL,[od]:e.GEQUAL,[Ub]:e.GREATER,[Nb]:e.NOTEQUAL};function Xt(T,y){if(y.type===Ti&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===pn||y.magFilter===Mf||y.magFilter===ac||y.magFilter===va||y.minFilter===pn||y.minFilter===Mf||y.minFilter===ac||y.minFilter===va)&&Nt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(T,e.TEXTURE_WRAP_S,yt[y.wrapS]),e.texParameteri(T,e.TEXTURE_WRAP_T,yt[y.wrapT]),(T===e.TEXTURE_3D||T===e.TEXTURE_2D_ARRAY)&&e.texParameteri(T,e.TEXTURE_WRAP_R,yt[y.wrapR]),e.texParameteri(T,e.TEXTURE_MAG_FILTER,Bt[y.magFilter]),e.texParameteri(T,e.TEXTURE_MIN_FILTER,Bt[y.minFilter]),y.compareFunction&&(e.texParameteri(T,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(T,e.TEXTURE_COMPARE_FUNC,ne[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===on||y.minFilter!==ac&&y.minFilter!==va||y.type===Ti&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){let N=t.get("EXT_texture_filter_anisotropic");e.texParameterf(T,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,s.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function K(T,y){let N=!1;T.__webglInit===void 0&&(T.__webglInit=!0,y.addEventListener("dispose",C));let z=y.source,Y=d.get(z);Y===void 0&&(Y={},d.set(z,Y));let it=k(y);if(it!==T.__cacheKey){Y[it]===void 0&&(Y[it]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,N=!0),Y[it].usedTimes++;let ot=Y[T.__cacheKey];ot!==void 0&&(Y[T.__cacheKey].usedTimes--,ot.usedTimes===0&&R(y)),T.__cacheKey=it,T.__webglTexture=Y[it].texture}return N}function st(T,y,N){return Math.floor(Math.floor(T/N)/y)}function nt(T,y,N,z){let it=T.updateRanges;if(it.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,y.width,y.height,N,z,y.data);else{it.sort((At,pt)=>At.start-pt.start);let ot=0;for(let At=1;At<it.length;At++){let pt=it[ot],ut=it[At],Dt=pt.start+pt.count,Lt=st(ut.start,y.width,4),Vt=st(pt.start,y.width,4);ut.start<=Dt+1&&Lt===Vt&&st(ut.start+ut.count-1,y.width,4)===Lt?pt.count=Math.max(pt.count,ut.start+ut.count-pt.start):(++ot,it[ot]=ut)}it.length=ot+1;let Z=n.getParameter(e.UNPACK_ROW_LENGTH),J=n.getParameter(e.UNPACK_SKIP_PIXELS),ct=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,y.width);for(let At=0,pt=it.length;At<pt;At++){let ut=it[At],Dt=Math.floor(ut.start/4),Lt=Math.ceil(ut.count/4),Vt=Dt%y.width,I=Math.floor(Dt/y.width),lt=Lt,j=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,Vt),n.pixelStorei(e.UNPACK_SKIP_ROWS,I),n.texSubImage2D(e.TEXTURE_2D,0,Vt,I,lt,j,N,z,y.data)}T.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,Z),n.pixelStorei(e.UNPACK_SKIP_PIXELS,J),n.pixelStorei(e.UNPACK_SKIP_ROWS,ct)}}function Tt(T,y,N){let z=e.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(z=e.TEXTURE_2D_ARRAY),y.isData3DTexture&&(z=e.TEXTURE_3D);let Y=K(T,y),it=y.source;n.bindTexture(z,T.__webglTexture,e.TEXTURE0+N);let ot=i.get(it);if(it.version!==ot.__version||Y===!0){if(n.activeTexture(e.TEXTURE0+N),(typeof ImageBitmap<"u"&&y.image instanceof ImageBitmap)===!1){let j=jt.getPrimaries(jt.workingColorSpace),ht=y.colorSpace===Es?null:jt.getPrimaries(y.colorSpace),vt=y.colorSpace===Es||j===ht?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt)}n.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment);let J=m(y.image,!1,s.maxTextureSize);J=en(y,J);let ct=a.convert(y.format,y.colorSpace),At=a.convert(y.type),pt=v(y.internalFormat,ct,At,y.normalized,y.colorSpace,y.isVideoTexture);Xt(z,y);let ut,Dt=y.mipmaps,Lt=y.isVideoTexture!==!0,Vt=ot.__version===void 0||Y===!0,I=it.dataReady,lt=w(y,J);if(y.isDepthTexture)pt=E(y.format===ya,y.type),Vt&&(Lt?n.texStorage2D(e.TEXTURE_2D,1,pt,J.width,J.height):n.texImage2D(e.TEXTURE_2D,0,pt,J.width,J.height,0,ct,At,null));else if(y.isDataTexture)if(Dt.length>0){Lt&&Vt&&n.texStorage2D(e.TEXTURE_2D,lt,pt,Dt[0].width,Dt[0].height);for(let j=0,ht=Dt.length;j<ht;j++)ut=Dt[j],Lt?I&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ut.width,ut.height,ct,At,ut.data):n.texImage2D(e.TEXTURE_2D,j,pt,ut.width,ut.height,0,ct,At,ut.data);y.generateMipmaps=!1}else Lt?(Vt&&n.texStorage2D(e.TEXTURE_2D,lt,pt,J.width,J.height),I&&nt(y,J,ct,At)):n.texImage2D(e.TEXTURE_2D,0,pt,J.width,J.height,0,ct,At,J.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){Lt&&Vt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,lt,pt,Dt[0].width,Dt[0].height,J.depth);for(let j=0,ht=Dt.length;j<ht;j++)if(ut=Dt[j],y.format!==mi)if(ct!==null)if(Lt){if(I)if(y.layerUpdates.size>0){let vt=f0(ut.width,ut.height,y.format,y.type);for(let tt of y.layerUpdates){let Et=ut.data.subarray(tt*vt/ut.data.BYTES_PER_ELEMENT,(tt+1)*vt/ut.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,tt,ut.width,ut.height,1,ct,Et)}y.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,0,ut.width,ut.height,J.depth,ct,ut.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,j,pt,ut.width,ut.height,J.depth,0,ut.data,0,0);else Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Lt?I&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,j,0,0,0,ut.width,ut.height,J.depth,ct,At,ut.data):n.texImage3D(e.TEXTURE_2D_ARRAY,j,pt,ut.width,ut.height,J.depth,0,ct,At,ut.data)}else{Lt&&Vt&&n.texStorage2D(e.TEXTURE_2D,lt,pt,Dt[0].width,Dt[0].height);for(let j=0,ht=Dt.length;j<ht;j++)ut=Dt[j],y.format!==mi?ct!==null?Lt?I&&n.compressedTexSubImage2D(e.TEXTURE_2D,j,0,0,ut.width,ut.height,ct,ut.data):n.compressedTexImage2D(e.TEXTURE_2D,j,pt,ut.width,ut.height,0,ut.data):Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Lt?I&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ut.width,ut.height,ct,At,ut.data):n.texImage2D(e.TEXTURE_2D,j,pt,ut.width,ut.height,0,ct,At,ut.data)}else if(y.isDataArrayTexture)if(Lt){if(Vt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,lt,pt,J.width,J.height,J.depth),I)if(y.layerUpdates.size>0){let j=f0(J.width,J.height,y.format,y.type);for(let ht of y.layerUpdates){let vt=J.data.subarray(ht*j/J.data.BYTES_PER_ELEMENT,(ht+1)*j/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,ht,J.width,J.height,1,ct,At,vt)}y.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ct,At,J.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,pt,J.width,J.height,J.depth,0,ct,At,J.data);else if(y.isData3DTexture)Lt?(Vt&&n.texStorage3D(e.TEXTURE_3D,lt,pt,J.width,J.height,J.depth),I&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ct,At,J.data)):n.texImage3D(e.TEXTURE_3D,0,pt,J.width,J.height,J.depth,0,ct,At,J.data);else if(y.isFramebufferTexture){if(Vt)if(Lt)n.texStorage2D(e.TEXTURE_2D,lt,pt,J.width,J.height);else{let j=J.width,ht=J.height;for(let vt=0;vt<lt;vt++)n.texImage2D(e.TEXTURE_2D,vt,pt,j,ht,0,ct,At,null),j>>=1,ht>>=1}}else if(y.isHTMLTexture){if("texElementImage2D"in e){let j=e.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),J.parentNode!==j){j.appendChild(J),p.add(y),j.onpaint=ht=>{let vt=ht.changedElements;for(let tt of p)vt.includes(tt.image)&&(tt.needsUpdate=!0)},j.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,J);else{let vt=e.RGBA,tt=e.RGBA,Et=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,vt,tt,Et,J)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(Dt.length>0){if(Lt&&Vt){let j=H(Dt[0]);n.texStorage2D(e.TEXTURE_2D,lt,pt,j.width,j.height)}for(let j=0,ht=Dt.length;j<ht;j++)ut=Dt[j],Lt?I&&n.texSubImage2D(e.TEXTURE_2D,j,0,0,ct,At,ut):n.texImage2D(e.TEXTURE_2D,j,pt,ct,At,ut);y.generateMipmaps=!1}else if(Lt){if(Vt){let j=H(J);n.texStorage2D(e.TEXTURE_2D,lt,pt,j.width,j.height)}I&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,ct,At,J)}else n.texImage2D(e.TEXTURE_2D,0,pt,ct,At,J);f(y)&&_(z),ot.__version=it.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function Pt(T,y,N){if(y.image.length!==6)return;let z=K(T,y),Y=y.source;n.bindTexture(e.TEXTURE_CUBE_MAP,T.__webglTexture,e.TEXTURE0+N);let it=i.get(Y);if(Y.version!==it.__version||z===!0){n.activeTexture(e.TEXTURE0+N);let ot=jt.getPrimaries(jt.workingColorSpace),Z=y.colorSpace===Es?null:jt.getPrimaries(y.colorSpace),J=y.colorSpace===Es||ot===Z?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,y.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);let ct=y.isCompressedTexture||y.image[0].isCompressedTexture,At=y.image[0]&&y.image[0].isDataTexture,pt=[];for(let tt=0;tt<6;tt++)!ct&&!At?pt[tt]=m(y.image[tt],!0,s.maxCubemapSize):pt[tt]=At?y.image[tt].image:y.image[tt],pt[tt]=en(y,pt[tt]);let ut=pt[0],Dt=a.convert(y.format,y.colorSpace),Lt=a.convert(y.type),Vt=v(y.internalFormat,Dt,Lt,y.normalized,y.colorSpace),I=y.isVideoTexture!==!0,lt=it.__version===void 0||z===!0,j=Y.dataReady,ht=w(y,ut);Xt(e.TEXTURE_CUBE_MAP,y);let vt;if(ct){I&&lt&&n.texStorage2D(e.TEXTURE_CUBE_MAP,ht,Vt,ut.width,ut.height);for(let tt=0;tt<6;tt++){vt=pt[tt].mipmaps;for(let Et=0;Et<vt.length;Et++){let bt=vt[Et];y.format!==mi?Dt!==null?I?j&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et,0,0,bt.width,bt.height,Dt,bt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et,Vt,bt.width,bt.height,0,bt.data):Nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et,0,0,bt.width,bt.height,Dt,Lt,bt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et,Vt,bt.width,bt.height,0,Dt,Lt,bt.data)}}}else{if(vt=y.mipmaps,I&&lt){vt.length>0&&ht++;let tt=H(pt[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,ht,Vt,tt.width,tt.height)}for(let tt=0;tt<6;tt++)if(At){I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,pt[tt].width,pt[tt].height,Dt,Lt,pt[tt].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Vt,pt[tt].width,pt[tt].height,0,Dt,Lt,pt[tt].data);for(let Et=0;Et<vt.length;Et++){let Ie=vt[Et].image[tt].image;I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et+1,0,0,Ie.width,Ie.height,Dt,Lt,Ie.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et+1,Vt,Ie.width,Ie.height,0,Dt,Lt,Ie.data)}}else{I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,0,0,Dt,Lt,pt[tt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0,Vt,Dt,Lt,pt[tt]);for(let Et=0;Et<vt.length;Et++){let bt=vt[Et];I?j&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et+1,0,0,Dt,Lt,bt.image[tt]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,Et+1,Vt,Dt,Lt,bt.image[tt])}}}f(y)&&_(e.TEXTURE_CUBE_MAP),it.__version=Y.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function Rt(T,y,N,z,Y,it){let ot=a.convert(N.format,N.colorSpace),Z=a.convert(N.type),J=v(N.internalFormat,ot,Z,N.normalized,N.colorSpace),ct=i.get(y),At=i.get(N);if(At.__renderTarget=y,!ct.__hasExternalTextures){let pt=Math.max(1,y.width>>it),ut=Math.max(1,y.height>>it);Y===e.TEXTURE_3D||Y===e.TEXTURE_2D_ARRAY?n.texImage3D(Y,it,J,pt,ut,y.depth,0,ot,Z,null):n.texImage2D(Y,it,J,pt,ut,0,ot,Z,null)}n.bindFramebuffer(e.FRAMEBUFFER,T),Le(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,z,Y,At.__webglTexture,0,be(y)):(Y===e.TEXTURE_2D||Y>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,z,Y,At.__webglTexture,it),n.bindFramebuffer(e.FRAMEBUFFER,null)}function Se(T,y,N){if(e.bindRenderbuffer(e.RENDERBUFFER,T),y.depthBuffer){let z=y.depthTexture,Y=z&&z.isDepthTexture?z.type:null,it=E(y.stencilBuffer,Y),ot=y.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Le(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,be(y),it,y.width,y.height):N?e.renderbufferStorageMultisample(e.RENDERBUFFER,be(y),it,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,it,y.width,y.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,ot,e.RENDERBUFFER,T)}else{let z=y.textures;for(let Y=0;Y<z.length;Y++){let it=z[Y],ot=a.convert(it.format,it.colorSpace),Z=a.convert(it.type),J=v(it.internalFormat,ot,Z,it.normalized,it.colorSpace);Le(y)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,be(y),J,y.width,y.height):N?e.renderbufferStorageMultisample(e.RENDERBUFFER,be(y),J,y.width,y.height):e.renderbufferStorage(e.RENDERBUFFER,J,y.width,y.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function kt(T,y,N){let z=y.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,T),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Y=i.get(y.depthTexture);if(Y.__renderTarget=y,(!Y.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),z){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,y.depthTexture.addEventListener("dispose",C)),Y.__webglTexture===void 0){Y.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,Y.__webglTexture),Xt(e.TEXTURE_CUBE_MAP,y.depthTexture);let ct=a.convert(y.depthTexture.format),At=a.convert(y.depthTexture.type),pt;y.depthTexture.format===Hi?pt=e.DEPTH_COMPONENT24:y.depthTexture.format===ya&&(pt=e.DEPTH24_STENCIL8);for(let ut=0;ut<6;ut++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ut,0,pt,y.width,y.height,0,ct,At,null)}}else Q(y.depthTexture,0);let it=Y.__webglTexture,ot=be(y),Z=z?e.TEXTURE_CUBE_MAP_POSITIVE_X+N:e.TEXTURE_2D,J=y.depthTexture.format===ya?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(y.depthTexture.format===Hi)Le(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,J,Z,it,0,ot):e.framebufferTexture2D(e.FRAMEBUFFER,J,Z,it,0);else if(y.depthTexture.format===ya)Le(y)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,J,Z,it,0,ot):e.framebufferTexture2D(e.FRAMEBUFFER,J,Z,it,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function oe(T){let y=i.get(T),N=T.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==T.depthTexture){let z=T.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),z){let Y=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,z.removeEventListener("dispose",Y)};z.addEventListener("dispose",Y),y.__depthDisposeCallback=Y}y.__boundDepthTexture=z}if(T.depthTexture&&!y.__autoAllocateDepthBuffer)if(N)for(let z=0;z<6;z++)kt(y.__webglFramebuffer[z],T,z);else{let z=T.texture.mipmaps;z&&z.length>0?kt(y.__webglFramebuffer[0],T,0):kt(y.__webglFramebuffer,T,0)}else if(N){y.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[z]),y.__webglDepthbuffer[z]===void 0)y.__webglDepthbuffer[z]=e.createRenderbuffer(),Se(y.__webglDepthbuffer[z],T,!1);else{let Y=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,it=y.__webglDepthbuffer[z];e.bindRenderbuffer(e.RENDERBUFFER,it),e.framebufferRenderbuffer(e.FRAMEBUFFER,Y,e.RENDERBUFFER,it)}}else{let z=T.texture.mipmaps;if(z&&z.length>0?n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=e.createRenderbuffer(),Se(y.__webglDepthbuffer,T,!1);else{let Y=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,it=y.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,it),e.framebufferRenderbuffer(e.FRAMEBUFFER,Y,e.RENDERBUFFER,it)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function ie(T,y,N){let z=i.get(T);y!==void 0&&Rt(z.__webglFramebuffer,T,T.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),N!==void 0&&oe(T)}function te(T){let y=T.texture,N=i.get(T),z=i.get(y);T.addEventListener("dispose",x);let Y=T.textures,it=T.isWebGLCubeRenderTarget===!0,ot=Y.length>1;if(ot||(z.__webglTexture===void 0&&(z.__webglTexture=e.createTexture()),z.__version=y.version,r.memory.textures++),it){N.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer[Z]=[];for(let J=0;J<y.mipmaps.length;J++)N.__webglFramebuffer[Z][J]=e.createFramebuffer()}else N.__webglFramebuffer[Z]=e.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){N.__webglFramebuffer=[];for(let Z=0;Z<y.mipmaps.length;Z++)N.__webglFramebuffer[Z]=e.createFramebuffer()}else N.__webglFramebuffer=e.createFramebuffer();if(ot)for(let Z=0,J=Y.length;Z<J;Z++){let ct=i.get(Y[Z]);ct.__webglTexture===void 0&&(ct.__webglTexture=e.createTexture(),r.memory.textures++)}if(T.samples>0&&Le(T)===!1){N.__webglMultisampledFramebuffer=e.createFramebuffer(),N.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let Z=0;Z<Y.length;Z++){let J=Y[Z];N.__webglColorRenderbuffer[Z]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,N.__webglColorRenderbuffer[Z]);let ct=a.convert(J.format,J.colorSpace),At=a.convert(J.type),pt=v(J.internalFormat,ct,At,J.normalized,J.colorSpace,T.isXRRenderTarget===!0),ut=be(T);e.renderbufferStorageMultisample(e.RENDERBUFFER,ut,pt,T.width,T.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Z,e.RENDERBUFFER,N.__webglColorRenderbuffer[Z])}e.bindRenderbuffer(e.RENDERBUFFER,null),T.depthBuffer&&(N.__webglDepthRenderbuffer=e.createRenderbuffer(),Se(N.__webglDepthRenderbuffer,T,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(it){n.bindTexture(e.TEXTURE_CUBE_MAP,z.__webglTexture),Xt(e.TEXTURE_CUBE_MAP,y);for(let Z=0;Z<6;Z++)if(y.mipmaps&&y.mipmaps.length>0)for(let J=0;J<y.mipmaps.length;J++)Rt(N.__webglFramebuffer[Z][J],T,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,J);else Rt(N.__webglFramebuffer[Z],T,y,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);f(y)&&_(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ot){for(let Z=0,J=Y.length;Z<J;Z++){let ct=Y[Z],At=i.get(ct),pt=e.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(pt=T.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(pt,At.__webglTexture),Xt(pt,ct),Rt(N.__webglFramebuffer,T,ct,e.COLOR_ATTACHMENT0+Z,pt,0),f(ct)&&_(pt)}n.unbindTexture()}else{let Z=e.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Z=T.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(Z,z.__webglTexture),Xt(Z,y),y.mipmaps&&y.mipmaps.length>0)for(let J=0;J<y.mipmaps.length;J++)Rt(N.__webglFramebuffer[J],T,y,e.COLOR_ATTACHMENT0,Z,J);else Rt(N.__webglFramebuffer,T,y,e.COLOR_ATTACHMENT0,Z,0);f(y)&&_(Z),n.unbindTexture()}T.depthBuffer&&oe(T)}function Ne(T){let y=T.textures;for(let N=0,z=y.length;N<z;N++){let Y=y[N];if(f(Y)){let it=S(T),ot=i.get(Y).__webglTexture;n.bindTexture(it,ot),_(it),n.unbindTexture()}}}let Be=[],ke=[];function Je(T){if(T.samples>0){if(Le(T)===!1){let y=T.textures,N=T.width,z=T.height,Y=e.COLOR_BUFFER_BIT,it=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ot=i.get(T),Z=y.length>1;if(Z)for(let ct=0;ct<y.length;ct++)n.bindFramebuffer(e.FRAMEBUFFER,ot.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,ot.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,ot.__webglMultisampledFramebuffer);let J=T.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,ot.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,ot.__webglFramebuffer);for(let ct=0;ct<y.length;ct++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Y|=e.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Y|=e.STENCIL_BUFFER_BIT)),Z){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,ot.__webglColorRenderbuffer[ct]);let At=i.get(y[ct]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,At,0)}e.blitFramebuffer(0,0,N,z,0,0,N,z,Y,e.NEAREST),l===!0&&(Be.length=0,ke.length=0,Be.push(e.COLOR_ATTACHMENT0+ct),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Be.push(it),ke.push(it),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,ke)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Be))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),Z)for(let ct=0;ct<y.length;ct++){n.bindFramebuffer(e.FRAMEBUFFER,ot.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.RENDERBUFFER,ot.__webglColorRenderbuffer[ct]);let At=i.get(y[ct]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,ot.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+ct,e.TEXTURE_2D,At,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,ot.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){let y=T.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[y])}}}function be(T){return Math.min(s.maxSamples,T.samples)}function Le(T){let y=i.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function L(T){let y=r.render.frame;h.get(T)!==y&&(h.set(T,y),T.update())}function en(T,y){let N=T.colorSpace,z=T.format,Y=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||N!==Il&&N!==Es&&(jt.getTransfer(N)===le?(z!==mi||Y!==$n)&&Nt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):It("WebGLTextures: Unsupported texture color space:",N)),y}function H(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=W,this.getTextureUnits=q,this.setTextureUnits=P,this.setTexture2D=Q,this.setTexture2DArray=et,this.setTexture3D=at,this.setTextureCube=rt,this.rebindTextures=ie,this.setupRenderTarget=te,this.updateRenderTargetMipmap=Ne,this.updateMultisampleRenderTarget=Je,this.setupDepthRenderbuffer=oe,this.setupFrameBufferTexture=Rt,this.useMultisampledRTT=Le,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Z2(e,t){function n(i,s=Es){let a,r=jt.getTransfer(s);if(i===$n)return e.UNSIGNED_BYTE;if(i===Tf)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Af)return e.UNSIGNED_SHORT_5_5_5_1;if(i===t0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===e0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===Qg)return e.BYTE;if(i===$g)return e.SHORT;if(i===vo)return e.UNSIGNED_SHORT;if(i===Ef)return e.INT;if(i===Ei)return e.UNSIGNED_INT;if(i===Ti)return e.FLOAT;if(i===qi)return e.HALF_FLOAT;if(i===n0)return e.ALPHA;if(i===i0)return e.RGB;if(i===mi)return e.RGBA;if(i===Hi)return e.DEPTH_COMPONENT;if(i===ya)return e.DEPTH_STENCIL;if(i===s0)return e.RED;if(i===wf)return e.RED_INTEGER;if(i===xa)return e.RG;if(i===Cf)return e.RG_INTEGER;if(i===Rf)return e.RGBA_INTEGER;if(i===rc||i===oc||i===lc||i===cc)if(r===le)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===rc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===oc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===cc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===rc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===oc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===cc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Df||i===Uf||i===Nf||i===Lf)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Df)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Nf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===If||i===Of||i===Pf||i===zf||i===Bf||i===uc||i===Ff)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===If||i===Of)return r===le?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Pf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===zf)return a.COMPRESSED_R11_EAC;if(i===Bf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===uc)return a.COMPRESSED_RG11_EAC;if(i===Ff)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Vf||i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Vf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Hf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Gf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===kf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Xf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Wf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===qf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Yf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Zf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Jf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Kf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===jf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Qf)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===$f)return r===le?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===td||i===ed||i===nd)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===td)return r===le?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ed)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===nd)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===id||i===sd||i===hc||i===ad)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===id)return a.COMPRESSED_RED_RGTC1_EXT;if(i===sd)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===hc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ad)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===yo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var J2=`
void main() {
...
}`,A0=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,n){if(this.texture===null){let i=new ql(t.texture);(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){let n=t.cameras[0].viewport,i=new jn({vertexShader:J2,fragmentShader:K2,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new Qe(new da(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},w0=class extends Gi{constructor(t,n){super();let i=this,s=null,a=1,r=null,o="local-floor",l=1,c=null,h=null,p=null,u=null,d=null,g=null,b=typeof XRWebGLBinding<"u",m=new A0,f={},_=n.getContextAttributes(),S=null,v=null,E=[],w=[],C=new Ut,x=null,A=new yn;A.viewport=new Ue;let R=new yn;R.viewport=new Ue;let D=[A,R],O=new yf,W=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let st=E[K];return st===void 0&&(st=new uo,E[K]=st),st.getTargetRaySpace()},this.getControllerGrip=function(K){let st=E[K];return st===void 0&&(st=new uo,E[K]=st),st.getGripSpace()},this.getHand=function(K){let st=E[K];return st===void 0&&(st=new uo,E[K]=st),st.getHandSpace()};function P(K){let st=w.indexOf(K.inputSource);if(st===-1)return;let nt=E[st];nt!==void 0&&(nt.update(K.inputSource,K.frame,c||r),nt.dispatchEvent({type:K.type,data:K.inputSource}))}function G(){s.removeEventListener("select",P),s.removeEventListener("selectstart",P),s.removeEventListener("selectend",P),s.removeEventListener("squeeze",P),s.removeEventListener("squeezestart",P),s.removeEventListener("squeezeend",P),s.removeEventListener("end",G),s.removeEventListener("inputsourceschange",k);for(let K=0;K<E.length;K++){let st=w[K];st!==null&&(w[K]=null,E[K].disconnect(st))}W=null,q=null,m.reset();for(let K in f)delete f[K];t.setRenderTarget(S),d=null,u=null,p=null,s=null,v=null,Xt.stop(),i.isPresenting=!1,t.setPixelRatio(x),t.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){a=K,i.isPresenting===!0&&Nt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,i.isPresenting===!0&&Nt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||r},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return u!==null?u:d},this.getBinding=function(){return p===null&&b&&(p=new XRWebGLBinding(s,n)),p},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(S=t.getRenderTarget(),s.addEventListener("select",P),s.addEventListener("selectstart",P),s.addEventListener("selectend",P),s.addEventListener("squeeze",P),s.addEventListener("squeezestart",P),s.addEventListener("squeezeend",P),s.addEventListener("end",G),s.addEventListener("inputsourceschange",k),_.xrCompatible!==!0&&await n.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(C),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let nt=null,Tt=null,Pt=null;_.depth&&(Pt=_.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,nt=_.stencil?ya:Hi,Tt=_.stencil?yo:Ei);let Rt={colorFormat:n.RGBA8,depthFormat:Pt,scaleFactor:a};p=this.getBinding(),u=p.createProjectionLayer(Rt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),v=new Jn(u.textureWidth,u.textureHeight,{format:mi,type:$n,depthTexture:new Ms(u.textureWidth,u.textureHeight,Tt,void 0,void 0,void 0,void 0,void 0,void 0,nt),stencilBuffer:_.stencil,colorSpace:t.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{let nt={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:a};d=new XRWebGLLayer(s,n,nt),s.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),v=new Jn(d.framebufferWidth,d.framebufferHeight,{format:mi,type:$n,colorSpace:t.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,r=await s.requestReferenceSpace(o),Xt.setContext(s),Xt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function k(K){for(let st=0;st<K.removed.length;st++){let nt=K.removed[st],Tt=w.indexOf(nt);Tt>=0&&(w[Tt]=null,E[Tt].disconnect(nt))}for(let st=0;st<K.added.length;st++){let nt=K.added[st],Tt=w.indexOf(nt);if(Tt===-1){for(let Rt=0;Rt<E.length;Rt++)if(Rt>=w.length){w.push(nt),Tt=Rt;break}else if(w[Rt]===null){w[Rt]=nt,Tt=Rt;break}if(Tt===-1)break}let Pt=E[Tt];Pt&&Pt.connect(nt)}}let Q=new U,et=new U;function at(K,st,nt){Q.setFromMatrixPosition(st.matrixWorld),et.setFromMatrixPosition(nt.matrixWorld);let Tt=Q.distanceTo(et),Pt=st.projectionMatrix.elements,Rt=nt.projectionMatrix.elements,Se=Pt[14]/(Pt[10]-1),kt=Pt[14]/(Pt[10]+1),oe=(Pt[9]+1)/Pt[5],ie=(Pt[9]-1)/Pt[5],te=(Pt[8]-1)/Pt[0],Ne=(Rt[8]+1)/Rt[0],Be=Se*te,ke=Se*Ne,Je=Tt/(-te+Ne),be=Je*-te;if(st.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(be),K.translateZ(Je),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Pt[10]===-1)K.projectionMatrix.copy(st.projectionMatrix),K.projectionMatrixInverse.copy(st.projectionMatrixInverse);else{let Le=Se+Je,L=kt+Je,en=Be-be,H=ke+(Tt-be),T=oe*kt/L*Le,y=ie*kt/L*Le;K.projectionMatrix.makePerspective(en,H,T,y,Le,L),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function rt(K,st){st===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(st.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let st=K.near,nt=K.far;m.texture!==null&&(m.depthNear>0&&(st=m.depthNear),m.depthFar>0&&(nt=m.depthFar)),O.near=R.near=A.near=st,O.far=R.far=A.far=nt,(W!==O.near||q!==O.far)&&(s.updateRenderState({depthNear:O.near,depthFar:O.far}),W=O.near,q=O.far),O.layers.mask=K.layers.mask|6,A.layers.mask=O.layers.mask&-5,R.layers.mask=O.layers.mask&-3;let Tt=K.parent,Pt=O.cameras;rt(O,Tt);for(let Rt=0;Rt<Pt.length;Rt++)rt(Pt[Rt],Tt);Pt.length===2?at(O,A,R):O.projectionMatrix.copy(A.projectionMatrix),yt(K,O,Tt)};function yt(K,st,nt){nt===null?K.matrix.copy(st.matrixWorld):(K.matrix.copy(nt.matrixWorld),K.matrix.invert(),K.matrix.multiply(st.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(st.projectionMatrix),K.projectionMatrixInverse.copy(st.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Gh*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(u===null&&d===null))return l},this.setFoveation=function(K){l=K,u!==null&&(u.fixedFoveation=K),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(O)},this.getCameraTexture=function(K){return f[K]};let Bt=null;function ne(K,st){if(h=st.getViewerPose(c||r),g=st,h!==null){let nt=h.views;d!==null&&(t.setRenderTargetFramebuffer(v,d.framebuffer),t.setRenderTarget(v));let Tt=!1;nt.length!==O.cameras.length&&(O.cameras.length=0,Tt=!0);for(let kt=0;kt<nt.length;kt++){let oe=nt[kt],ie=null;if(d!==null)ie=d.getViewport(oe);else{let Ne=p.getViewSubImage(u,oe);ie=Ne.viewport,kt===0&&(t.setRenderTargetTextures(v,Ne.colorTexture,Ne.depthStencilTexture),t.setRenderTarget(v))}let te=D[kt];te===void 0&&(te=new yn,te.layers.enable(kt),te.viewport=new Ue,D[kt]=te),te.matrix.fromArray(oe.transform.matrix),te.matrix.decompose(te.position,te.quaternion,te.scale),te.projectionMatrix.fromArray(oe.projectionMatrix),te.projectionMatrixInverse.copy(te.projectionMatrix).invert(),te.viewport.set(ie.x,ie.y,ie.width,ie.height),kt===0&&(O.matrix.copy(te.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),Tt===!0&&O.cameras.push(te)}let Pt=s.enabledFeatures;if(Pt&&Pt.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&b){p=i.getBinding();let kt=p.getDepthInformation(nt[0]);kt&&kt.isValid&&kt.texture&&m.init(kt,s.renderState)}if(Pt&&Pt.includes("camera-access")&&b){t.state.unbindTexture(),p=i.getBinding();for(let kt=0;kt<nt.length;kt++){let oe=nt[kt].camera;if(oe){let ie=f[oe];ie||(ie=new ql,f[oe]=ie);let te=p.getCameraImage(oe);ie.sourceTexture=te}}}}for(let nt=0;nt<E.length;nt++){let Tt=w[nt],Pt=E[nt];Tt!==null&&Pt!==void 0&&Pt.update(Tt,st,c||r)}Bt&&Bt(K,st),st.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:st}),g=null}let Xt=new cM;Xt.setAnimationLoop(ne),this.setAnimationLoop=function(K){Bt=K},this.dispose=function(){}}},j2=new De,mM=new zt;mM.set(-1,0,0,0,1,0,0,0,1);function Q2(e,t){function n(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,c0(e)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,_,S,v){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?a(m,f):f.isMeshLambertMaterial?(a(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(a(m,f),p(m,f)):f.isMeshPhongMaterial?(a(m,f),h(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(a(m,f),u(m,f),f.isMeshPhysicalMaterial&&d(m,f,v)):f.isMeshMatcapMaterial?(a(m,f),g(m,f)):f.isMeshDepthMaterial?a(m,f):f.isMeshDistanceMaterial?(a(m,f),b(m,f)):f.isMeshNormalMaterial?a(m,f):f.isLineBasicMaterial?(r(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,_,S):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function a(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,n(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===An&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,n(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===An&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,n(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,n(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,n(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);let _=t.get(f),S=_.envMap,v=_.envMapRotation;S&&(m.envMap.value=S,m.envMapRotation.value.setFromMatrix4(j2.makeRotationFromEuler(v)).transpose(),S.isCubeTexture&&S.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(mM),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,n(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,n(f.aoMap,m.aoMapTransform))}function r(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,_,S){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*_,m.scale.value=S*.5,f.map&&(m.map.value=f.map,n(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,n(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,n(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function p(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function u(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,n(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,n(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function d(m,f,_){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,n(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,n(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,n(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,n(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,n(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===An&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,n(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,n(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=_.texture,m.transmissionSamplerSize.value.set(_.width,_.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,n(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,n(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,n(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,n(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,n(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function b(m,f){let _=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(_.matrixWorld),m.nearDistance.value=_.shadow.camera.near,m.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function $2(e,t,n,i){let s={},a={},r=[],o=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,E){let w=E.program;i.uniformBlockBinding(v,w)}function c(v,E){let w=s[v.id];w===void 0&&(m(v),w=h(v),s[v.id]=w,v.addEventListener("dispose",_));let C=E.program;i.updateUBOMapping(v,C);let x=t.render.frame;a[v.id]!==x&&(u(v),a[v.id]=x)}function h(v){let E=p();v.__bindingPointIndex=E;let w=e.createBuffer(),C=v.__size,x=v.usage;return e.bindBuffer(e.UNIFORM_BUFFER,w),e.bufferData(e.UNIFORM_BUFFER,C,x),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,E,w),w}function p(){for(let v=0;v<o;v++)if(r.indexOf(v)===-1)return r.push(v),v;return It("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){let E=s[v.id],w=v.uniforms,C=v.__cache;e.bindBuffer(e.UNIFORM_BUFFER,E);for(let x=0,A=w.length;x<A;x++){let R=w[x];if(Array.isArray(R))for(let D=0,O=R.length;D<O;D++)d(R[D],x,D,C);else d(R,x,0,C)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function d(v,E,w,C){if(b(v,E,w,C)===!0){let x=v.__offset,A=v.value;if(Array.isArray(A)){let R=0;for(let D=0;D<A.length;D++){let O=A[D],W=f(O);g(O,v.__data,R),typeof O!="number"&&typeof O!="boolean"&&!O.isMatrix3&&!ArrayBuffer.isView(O)&&(R+=W.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(A,v.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,x,v.__data)}}function g(v,E,w){typeof v=="number"||typeof v=="boolean"?E[0]=v:v.isMatrix3?(E[0]=v.elements[0],E[1]=v.elements[1],E[2]=v.elements[2],E[3]=0,E[4]=v.elements[3],E[5]=v.elements[4],E[6]=v.elements[5],E[7]=0,E[8]=v.elements[6],E[9]=v.elements[7],E[10]=v.elements[8],E[11]=0):ArrayBuffer.isView(v)?E.set(new v.constructor(v.buffer,v.byteOffset,E.length)):v.toArray(E,w)}function b(v,E,w,C){let x=v.value,A=E+"_"+w;if(C[A]===void 0)return typeof x=="number"||typeof x=="boolean"?C[A]=x:ArrayBuffer.isView(x)?C[A]=x.slice():C[A]=x.clone(),!0;{let R=C[A];if(typeof x=="number"||typeof x=="boolean"){if(R!==x)return C[A]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(R.equals(x)===!1)return R.copy(x),!0}}return!1}function m(v){let E=v.uniforms,w=0,C=16;for(let A=0,R=E.length;A<R;A++){let D=Array.isArray(E[A])?E[A]:[E[A]];for(let O=0,W=D.length;O<W;O++){let q=D[O],P=Array.isArray(q.value)?q.value:[q.value];for(let G=0,k=P.length;G<k;G++){let Q=P[G],et=f(Q),at=w%C,rt=at%et.boundary,yt=at+rt;w+=rt,yt!==0&&C-yt<et.storage&&(w+=C-yt),q.__data=new Float32Array(et.storage/Float32Array.BYTES_PER_ELEMENT),q.__offset=w,w+=et.storage}}}let x=w%C;return x>0&&(w+=C-x),v.__size=w,v.__cache={},this}function f(v){let E={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(E.boundary=4,E.storage=4):v.isVector2?(E.boundary=8,E.storage=8):v.isVector3||v.isColor?(E.boundary=16,E.storage=12):v.isVector4?(E.boundary=16,E.storage=16):v.isMatrix3?(E.boundary=48,E.storage=48):v.isMatrix4?(E.boundary=64,E.storage=64):v.isTexture?Nt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(E.boundary=16,E.storage=v.byteLength):Nt("WebGLRenderer: Unsupported uniform value type.",v),E}function _(v){let E=v.target;E.removeEventListener("dispose",_);let w=r.indexOf(E.__bindingPointIndex);r.splice(w,1),e.deleteBuffer(s[E.id]),delete s[E.id],delete a[E.id]}function S(){for(let v in s)e.deleteBuffer(s[v]);r=[],s={},a={}}return{bind:l,update:c,dispose:S}}var t3=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Yi=null;function e3(){return Yi===null&&(Yi=new qh(t3,16,16,xa,qi),Yi.name="DFG_LUT",Yi.minFilter=pn,Yi.magFilter=pn,Yi.wrapS=Fi,Yi.wrapT=Fi,Yi.generateMipmaps=!1,Yi.needsUpdate=!0),Yi}var fd=class{constructor(t={}){let{canvas:n=Ib(),context:i=null,depth:s=!0,stencil:a=!1,alpha:r=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:d=$n}=t;this.isWebGLRenderer=!0;let g;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=i.getContextAttributes().alpha}else g=r;let b=d,m=new Set([Rf,Cf,wf]),f=new Set([$n,Ei,vo,yo,Tf,Af]),_=new Uint32Array(4),S=new Int32Array(4),v=new U,E=null,w=null,C=[],x=[],A=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Mi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,D=!1,O=null,W=null,q=null,P=null;this._outputColorSpace=Tn;let G=0,k=0,Q=null,et=-1,at=null,rt=new Ue,yt=new Ue,Bt=null,ne=new Qt(0),Xt=0,K=n.width,st=n.height,nt=1,Tt=null,Pt=null,Rt=new Ue(0,0,K,st),Se=new Ue(0,0,K,st),kt=!1,oe=new Xl,ie=!1,te=!1,Ne=new De,Be=new U,ke=new Ue,Je={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},be=!1;function Le(){return Q===null?nt:1}let L=i;function en(M,B){return n.getContext(M,B)}try{let M={alpha:!0,depth:s,stencil:a,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${xf}`),n.addEventListener("webglcontextlost",Ie,!1),n.addEventListener("webglcontextrestored",_e,!1),n.addEventListener("webglcontextcreationerror",Ai,!1),L===null){let B="webgl2";if(L=en(B,M),L===null)throw en(B)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(M){throw It("WebGLRenderer: "+M.message),M}let H,T,y,N,z,Y,it,ot,Z,J,ct,At,pt,ut,Dt,Lt,Vt,I,lt,j,ht,vt,tt;function Et(){H=new lR(L),H.init(),ht=new Z2(L,H),T=new tR(L,H,t,ht),y=new q2(L,H),T.reversedDepthBuffer&&u&&y.buffers.depth.setReversed(!0),W=L.createFramebuffer(),q=L.createFramebuffer(),P=L.createFramebuffer(),N=new hR(L),z=new N2,Y=new Y2(L,H,y,z,T,ht,N),it=new oR(R),ot=new mA(L),vt=new QC(L,ot),Z=new cR(L,ot,N,vt),J=new dR(L,Z,ot,vt,N),I=new fR(L,T,Y),Dt=new eR(z),ct=new U2(R,it,H,T,vt,Dt),At=new Q2(R,z),pt=new I2,ut=new V2(H),Vt=new jC(R,it,y,J,g,l),Lt=new W2(R,J,T),tt=new $2(L,N,T,y),lt=new $C(L,H,N),j=new uR(L,H,N),N.programs=ct.programs,R.capabilities=T,R.extensions=H,R.properties=z,R.renderLists=pt,R.shadowMap=Lt,R.state=y,R.info=N}Et(),b!==$n&&(A=new mR(b,n.width,n.height,o,s,a));let bt=new w0(R,L);this.xr=bt,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let M=H.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){let M=H.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return nt},this.setPixelRatio=function(M){M!==void 0&&(nt=M,this.setSize(K,st,!1))},this.getSize=function(M){return M.set(K,st)},this.setSize=function(M,B,X=!0){if(bt.isPresenting){Nt("WebGLRenderer: Can't change size while VR device is presenting.");return}K=M,st=B,n.width=Math.floor(M*nt),n.height=Math.floor(B*nt),X===!0&&(n.style.width=M+"px",n.style.height=B+"px"),A!==null&&A.setSize(n.width,n.height),this.setViewport(0,0,M,B)},this.getDrawingBufferSize=function(M){return M.set(K*nt,st*nt).floor()},this.setDrawingBufferSize=function(M,B,X){K=M,st=B,nt=X,n.width=Math.floor(M*X),n.height=Math.floor(B*X),this.setViewport(0,0,M,B)},this.setEffects=function(M){if(b===$n){It("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let B=0;B<M.length;B++)if(M[B].isOutputPass===!0){Nt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(rt)},this.getViewport=function(M){return M.copy(Rt)},this.setViewport=function(M,B,X,F){M.isVector4?Rt.set(M.x,M.y,M.z,M.w):Rt.set(M,B,X,F),y.viewport(rt.copy(Rt).multiplyScalar(nt).round())},this.getScissor=function(M){return M.copy(Se)},this.setScissor=function(M,B,X,F){M.isVector4?Se.set(M.x,M.y,M.z,M.w):Se.set(M,B,X,F),y.scissor(yt.copy(Se).multiplyScalar(nt).round())},this.getScissorTest=function(){return kt},this.setScissorTest=function(M){y.setScissorTest(kt=M)},this.setOpaqueSort=function(M){Tt=M},this.setTransparentSort=function(M){Pt=M},this.getClearColor=function(M){return M.copy(Vt.getClearColor())},this.setClearColor=function(){Vt.setClearColor(...arguments)},this.getClearAlpha=function(){return Vt.getClearAlpha()},this.setClearAlpha=function(){Vt.setClearAlpha(...arguments)},this.clear=function(M=!0,B=!0,X=!0){let F=0;if(M){let V=!1;if(Q!==null){let _t=Q.texture.format;V=m.has(_t)}if(V){let _t=Q.texture.type,St=f.has(_t),gt=Vt.getClearColor(),Mt=Vt.getClearAlpha(),wt=gt.r,Ht=gt.g,qt=gt.b;St?(_[0]=wt,_[1]=Ht,_[2]=qt,_[3]=Mt,L.clearBufferuiv(L.COLOR,0,_)):(S[0]=wt,S[1]=Ht,S[2]=qt,S[3]=Mt,L.clearBufferiv(L.COLOR,0,S))}else F|=L.COLOR_BUFFER_BIT}B&&(F|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),X&&(F|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F!==0&&L.clear(F)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(M){M.setRenderer(this),O=M},this.dispose=function(){n.removeEventListener("webglcontextlost",Ie,!1),n.removeEventListener("webglcontextrestored",_e,!1),n.removeEventListener("webglcontextcreationerror",Ai,!1),Vt.dispose(),pt.dispose(),ut.dispose(),z.dispose(),it.dispose(),J.dispose(),vt.dispose(),tt.dispose(),ct.dispose(),bt.dispose(),bt.removeEventListener("sessionstart",N0),bt.removeEventListener("sessionend",L0),ba.stop()};function Ie(M){M.preventDefault(),o0("WebGLRenderer: Context Lost."),D=!0}function _e(){o0("WebGLRenderer: Context Restored."),D=!1;let M=N.autoReset,B=Lt.enabled,X=Lt.autoUpdate,F=Lt.needsUpdate,V=Lt.type;Et(),N.autoReset=M,Lt.enabled=B,Lt.autoUpdate=X,Lt.needsUpdate=F,Lt.type=V}function Ai(M){It("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function wi(M){let B=M.target;B.removeEventListener("dispose",wi),EM(B)}function EM(M){TM(M),z.remove(M)}function TM(M){let B=z.get(M).programs;B!==void 0&&(B.forEach(function(X){ct.releaseProgram(X)}),M.isShaderMaterial&&ct.releaseShaderCache(M))}this.renderBufferDirect=function(M,B,X,F,V,_t){B===null&&(B=Je);let St=V.isMesh&&V.matrixWorld.determinantAffine()<0,gt=CM(M,B,X,F,V);y.setMaterial(F,St);let Mt=X.index,wt=1;if(F.wireframe===!0){if(Mt=Z.getWireframeAttribute(X),Mt===void 0)return;wt=2}let Ht=X.drawRange,qt=X.attributes.position,Ct=Ht.start*wt,he=(Ht.start+Ht.count)*wt;_t!==null&&(Ct=Math.max(Ct,_t.start*wt),he=Math.min(he,(_t.start+_t.count)*wt)),Mt!==null?(Ct=Math.max(Ct,0),he=Math.min(he,Mt.count)):qt!=null&&(Ct=Math.max(Ct,0),he=Math.min(he,qt.count));let Fe=he-Ct;if(Fe<0||Fe===1/0)return;vt.setup(V,F,gt,X,Mt);let Oe,pe=lt;if(Mt!==null&&(Oe=ot.get(Mt),pe=j,pe.setIndex(Oe)),V.isMesh)F.wireframe===!0?(y.setLineWidth(F.wireframeLinewidth*Le()),pe.setMode(L.LINES)):pe.setMode(L.TRIANGLES);else if(V.isLine){let mn=F.linewidth;mn===void 0&&(mn=1),y.setLineWidth(mn*Le()),V.isLineSegments?pe.setMode(L.LINES):V.isLineLoop?pe.setMode(L.LINE_LOOP):pe.setMode(L.LINE_STRIP)}else V.isPoints?pe.setMode(L.POINTS):V.isSprite&&pe.setMode(L.TRIANGLES);if(V.isBatchedMesh)if(H.get("WEBGL_multi_draw"))pe.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{let mn=V._multiDrawStarts,xt=V._multiDrawCounts,On=V._multiDrawCount,se=Mt?ot.get(Mt).bytesPerElement:1,ti=z.get(F).currentProgram.getUniforms();for(let Ci=0;Ci<On;Ci++)ti.setValue(L,"_gl_DrawID",Ci),pe.render(mn[Ci]/se,xt[Ci])}else if(V.isInstancedMesh)pe.renderInstances(Ct,Fe,V.count);else if(X.isInstancedBufferGeometry){let mn=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,xt=Math.min(X.instanceCount,mn);pe.renderInstances(Ct,Fe,xt)}else pe.render(Ct,Fe)};function U0(M,B,X){M.transparent===!0&&M.side===Xi&&M.forceSinglePass===!1?(M.side=An,M.needsUpdate=!0,Ec(M,B,X),M.side=bs,M.needsUpdate=!0,Ec(M,B,X),M.side=Xi):Ec(M,B,X)}this.compile=function(M,B,X=null){X===null&&(X=M),w=ut.get(X),w.init(B),x.push(w),X.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(w.pushLight(V),V.castShadow&&w.pushShadow(V))}),M!==X&&M.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(w.pushLight(V),V.castShadow&&w.pushShadow(V))}),w.setupLights();let F=new Set;return M.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;let _t=V.material;if(_t)if(Array.isArray(_t))for(let St=0;St<_t.length;St++){let gt=_t[St];U0(gt,X,V),F.add(gt)}else U0(_t,X,V),F.add(_t)}),w=x.pop(),F},this.compileAsync=function(M,B,X=null){let F=this.compile(M,B,X);return new Promise(V=>{function _t(){if(F.forEach(function(St){z.get(St).currentProgram.isReady()&&F.delete(St)}),F.size===0){V(M);return}setTimeout(_t,10)}H.get("KHR_parallel_shader_compile")!==null?_t():setTimeout(_t,10)})};let _d=null;function AM(M){_d&&_d(M)}function N0(){ba.stop()}function L0(){ba.start()}let ba=new cM;ba.setAnimationLoop(AM),typeof self<"u"&&ba.setContext(self),this.setAnimationLoop=function(M){_d=M,bt.setAnimationLoop(M),M===null?ba.stop():ba.start()},bt.addEventListener("sessionstart",N0),bt.addEventListener("sessionend",L0),this.render=function(M,B){if(B!==void 0&&B.isCamera!==!0){It("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;O!==null&&O.renderStart(M,B);let X=bt.enabled===!0&&bt.isPresenting===!0,F=A!==null&&(Q===null||X)&&A.begin(R,Q);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),bt.enabled===!0&&bt.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(bt.cameraAutoUpdate===!0&&bt.updateCamera(B),B=bt.getCamera()),M.isScene===!0&&M.onBeforeRender(R,M,B,Q),w=ut.get(M,x.length),w.init(B),w.state.textureUnits=Y.getTextureUnits(),x.push(w),Ne.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),oe.setFromProjectionMatrix(Ne,bi,B.reversedDepth),te=this.localClippingEnabled,ie=Dt.init(this.clippingPlanes,te),E=pt.get(M,C.length),E.init(),C.push(E),bt.enabled===!0&&bt.isPresenting===!0){let St=R.xr.getDepthSensingMesh();St!==null&&vd(St,B,-1/0,R.sortObjects)}vd(M,B,0,R.sortObjects),E.finish(),R.sortObjects===!0&&E.sort(Tt,Pt,B.reversedDepth),be=bt.enabled===!1||bt.isPresenting===!1||bt.hasDepthSensing()===!1,be&&Vt.addToRenderList(E,M),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),ie===!0&&Dt.beginShadows();let V=w.state.shadowsArray;if(Lt.render(V,M,B),ie===!0&&Dt.endShadows(),(F&&A.hasRenderPass())===!1){let St=E.opaque,gt=E.transmissive;if(w.setupLights(),B.isArrayCamera){let Mt=B.cameras;if(gt.length>0)for(let wt=0,Ht=Mt.length;wt<Ht;wt++){let qt=Mt[wt];O0(St,gt,M,qt)}be&&Vt.render(M);for(let wt=0,Ht=Mt.length;wt<Ht;wt++){let qt=Mt[wt];I0(E,M,qt,qt.viewport)}}else gt.length>0&&O0(St,gt,M,B),be&&Vt.render(M),I0(E,M,B)}Q!==null&&k===0&&(Y.updateMultisampleRenderTarget(Q),Y.updateRenderTargetMipmap(Q)),F&&A.end(R),M.isScene===!0&&M.onAfterRender(R,M,B),vt.resetDefaultState(),et=-1,at=null,x.pop(),x.length>0?(w=x[x.length-1],Y.setTextureUnits(w.state.textureUnits),ie===!0&&Dt.setGlobalState(R.clippingPlanes,w.state.camera)):w=null,C.pop(),C.length>0?E=C[C.length-1]:E=null,O!==null&&O.renderEnd()};function vd(M,B,X,F){if(M.visible===!1)return;if(M.layers.test(B.layers)){if(M.isGroup)X=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(B);else if(M.isLightProbeGrid)w.pushLightProbeGrid(M);else if(M.isLight)w.pushLight(M),M.castShadow&&w.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||oe.intersectsSprite(M)){F&&ke.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Ne);let St=J.update(M),gt=M.material;gt.visible&&E.push(M,St,gt,X,ke.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||oe.intersectsObject(M))){let St=J.update(M),gt=M.material;if(F&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),ke.copy(M.boundingSphere.center)):(St.boundingSphere===null&&St.computeBoundingSphere(),ke.copy(St.boundingSphere.center)),ke.applyMatrix4(M.matrixWorld).applyMatrix4(Ne)),Array.isArray(gt)){let Mt=St.groups;for(let wt=0,Ht=Mt.length;wt<Ht;wt++){let qt=Mt[wt],Ct=gt[qt.materialIndex];Ct&&Ct.visible&&E.push(M,St,Ct,X,ke.z,qt)}}else gt.visible&&E.push(M,St,gt,X,ke.z,null)}}let _t=M.children;for(let St=0,gt=_t.length;St<gt;St++)vd(_t[St],B,X,F)}function I0(M,B,X,F){let{opaque:V,transmissive:_t,transparent:St}=M;w.setupLightsView(X),ie===!0&&Dt.setGlobalState(R.clippingPlanes,X),F&&y.viewport(rt.copy(F)),V.length>0&&Mc(V,B,X),_t.length>0&&Mc(_t,B,X),St.length>0&&Mc(St,B,X),y.buffers.depth.setTest(!0),y.buffers.depth.setMask(!0),y.buffers.color.setMask(!0),y.setPolygonOffset(!1)}function O0(M,B,X,F){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[F.id]===void 0){let Ct=H.has("EXT_color_buffer_half_float")||H.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[F.id]=new Jn(1,1,{generateMipmaps:!0,type:Ct?qi:$n,minFilter:va,samples:Math.max(4,T.samples),stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:jt.workingColorSpace})}let _t=w.state.transmissionRenderTarget[F.id],St=F.viewport||rt;_t.setSize(St.z*R.transmissionResolutionScale,St.w*R.transmissionResolutionScale);let gt=R.getRenderTarget(),Mt=R.getActiveCubeFace(),wt=R.getActiveMipmapLevel();R.setRenderTarget(_t),R.getClearColor(ne),Xt=R.getClearAlpha(),Xt<1&&R.setClearColor(16777215,.5),R.clear(),be&&Vt.render(X);let Ht=R.toneMapping;R.toneMapping=Mi;let qt=F.viewport;if(F.viewport!==void 0&&(F.viewport=void 0),w.setupLightsView(F),ie===!0&&Dt.setGlobalState(R.clippingPlanes,F),Mc(M,X,F),Y.updateMultisampleRenderTarget(_t),Y.updateRenderTargetMipmap(_t),H.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let he=0,Fe=B.length;he<Fe;he++){let Oe=B[he],{object:pe,geometry:mn,material:xt,group:On}=Oe;if(xt.side===Xi&&pe.layers.test(F.layers)){let se=xt.side;xt.side=An,xt.needsUpdate=!0,P0(pe,X,F,mn,xt,On),xt.side=se,xt.needsUpdate=!0,Ct=!0}}Ct===!0&&(Y.updateMultisampleRenderTarget(_t),Y.updateRenderTargetMipmap(_t))}R.setRenderTarget(gt,Mt,wt),R.setClearColor(ne,Xt),qt!==void 0&&(F.viewport=qt),R.toneMapping=Ht}function Mc(M,B,X){let F=B.isScene===!0?B.overrideMaterial:null;for(let V=0,_t=M.length;V<_t;V++){let St=M[V],{object:gt,geometry:Mt,group:wt}=St,Ht=St.material;Ht.allowOverride===!0&&F!==null&&(Ht=F),gt.layers.test(X.layers)&&P0(gt,B,X,Mt,Ht,wt)}}function P0(M,B,X,F,V,_t){M.onBeforeRender(R,B,X,F,V,_t),M.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),V.onBeforeRender(R,B,X,F,M,_t),V.transparent===!0&&V.side===Xi&&V.forceSinglePass===!1?(V.side=An,V.needsUpdate=!0,R.renderBufferDirect(X,B,F,V,M,_t),V.side=bs,V.needsUpdate=!0,R.renderBufferDirect(X,B,F,V,M,_t),V.side=Xi):R.renderBufferDirect(X,B,F,V,M,_t),M.onAfterRender(R,B,X,F,V,_t)}function Ec(M,B,X){B.isScene!==!0&&(B=Je);let F=z.get(M),V=w.state.lights,_t=w.state.shadowsArray,St=V.state.version,gt=ct.getParameters(M,V.state,_t,B,X,w.state.lightProbeGridArray),Mt=ct.getProgramCacheKey(gt),wt=F.programs;F.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?B.environment:null,F.fog=B.fog;let Ht=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;F.envMap=it.get(M.envMap||F.environment,Ht),F.envMapRotation=F.environment!==null&&M.envMap===null?B.environmentRotation:M.envMapRotation,wt===void 0&&(M.addEventListener("dispose",wi),wt=new Map,F.programs=wt);let qt=wt.get(Mt);if(qt!==void 0){if(F.currentProgram===qt&&F.lightsStateVersion===St)return B0(M,gt),qt}else gt.uniforms=ct.getUniforms(M),O!==null&&M.isNodeMaterial&&O.build(M,X,gt),M.onBeforeCompile(gt,R),qt=ct.acquireProgram(gt,Mt),wt.set(Mt,qt),F.uniforms=gt.uniforms;let Ct=F.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ct.clippingPlanes=Dt.uniform),B0(M,gt),F.needsLights=DM(M),F.lightsStateVersion=St,F.needsLights&&(Ct.ambientLightColor.value=V.state.ambient,Ct.lightProbe.value=V.state.probe,Ct.directionalLights.value=V.state.directional,Ct.directionalLightShadows.value=V.state.directionalShadow,Ct.spotLights.value=V.state.spot,Ct.spotLightShadows.value=V.state.spotShadow,Ct.rectAreaLights.value=V.state.rectArea,Ct.ltc_1.value=V.state.rectAreaLTC1,Ct.ltc_2.value=V.state.rectAreaLTC2,Ct.pointLights.value=V.state.point,Ct.pointLightShadows.value=V.state.pointShadow,Ct.hemisphereLights.value=V.state.hemi,Ct.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Ct.spotLightMatrix.value=V.state.spotLightMatrix,Ct.spotLightMap.value=V.state.spotLightMap,Ct.pointShadowMatrix.value=V.state.pointShadowMatrix),F.lightProbeGrid=w.state.lightProbeGridArray.length>0,F.currentProgram=qt,F.uniformsList=null,qt}function z0(M){if(M.uniformsList===null){let B=M.currentProgram.getUniforms();M.uniformsList=So.seqWithValue(B.seq,M.uniforms)}return M.uniformsList}function B0(M,B){let X=z.get(M);X.outputColorSpace=B.outputColorSpace,X.batching=B.batching,X.batchingColor=B.batchingColor,X.instancing=B.instancing,X.instancingColor=B.instancingColor,X.instancingMorph=B.instancingMorph,X.skinning=B.skinning,X.morphTargets=B.morphTargets,X.morphNormals=B.morphNormals,X.morphColors=B.morphColors,X.morphTargetsCount=B.morphTargetsCount,X.numClippingPlanes=B.numClippingPlanes,X.numIntersection=B.numClipIntersection,X.vertexAlphas=B.vertexAlphas,X.vertexTangents=B.vertexTangents,X.toneMapping=B.toneMapping}function wM(M,B){if(M.length===0)return null;if(M.length===1)return M[0].texture!==null?M[0]:null;v.setFromMatrixPosition(B.matrixWorld);for(let X=0,F=M.length;X<F;X++){let V=M[X];if(V.texture!==null&&V.boundingBox.containsPoint(v))return V}return null}function CM(M,B,X,F,V){B.isScene!==!0&&(B=Je),Y.resetTextureUnits();let _t=B.fog,St=F.isMeshStandardMaterial||F.isMeshLambertMaterial||F.isMeshPhongMaterial?B.environment:null,gt=Q===null?R.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:jt.workingColorSpace,Mt=F.isMeshStandardMaterial||F.isMeshLambertMaterial&&!F.envMap||F.isMeshPhongMaterial&&!F.envMap,wt=it.get(F.envMap||St,Mt),Ht=F.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,qt=!!X.attributes.tangent&&(!!F.normalMap||F.anisotropy>0),Ct=!!X.morphAttributes.position,he=!!X.morphAttributes.normal,Fe=!!X.morphAttributes.color,Oe=Mi;F.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(Oe=R.toneMapping);let pe=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,mn=pe!==void 0?pe.length:0,xt=z.get(F),On=w.state.lights;if(ie===!0&&(te===!0||M!==at)){let ve=M===at&&F.id===et;Dt.setState(F,M,ve)}let se=!1;F.version===xt.__version?(xt.needsLights&&xt.lightsStateVersion!==On.state.version||xt.outputColorSpace!==gt||V.isBatchedMesh&&xt.batching===!1||!V.isBatchedMesh&&xt.batching===!0||V.isBatchedMesh&&xt.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&xt.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&xt.instancing===!1||!V.isInstancedMesh&&xt.instancing===!0||V.isSkinnedMesh&&xt.skinning===!1||!V.isSkinnedMesh&&xt.skinning===!0||V.isInstancedMesh&&xt.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&xt.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&xt.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&xt.instancingMorph===!1&&V.morphTexture!==null||xt.envMap!==wt||F.fog===!0&&xt.fog!==_t||xt.numClippingPlanes!==void 0&&(xt.numClippingPlanes!==Dt.numPlanes||xt.numIntersection!==Dt.numIntersection)||xt.vertexAlphas!==Ht||xt.vertexTangents!==qt||xt.morphTargets!==Ct||xt.morphNormals!==he||xt.morphColors!==Fe||xt.toneMapping!==Oe||xt.morphTargetsCount!==mn||!!xt.lightProbeGrid!=w.state.lightProbeGridArray.length>0)&&(se=!0):(se=!0,xt.__version=F.version);let ti=xt.currentProgram;se===!0&&(ti=Ec(F,B,V),O&&F.isNodeMaterial&&O.onUpdateProgram(F,ti,xt));let Ci=!1,Ts=!1,er=!1,me=ti.getUniforms(),Ve=xt.uniforms;if(y.useProgram(ti.program)&&(Ci=!0,Ts=!0,er=!0),F.id!==et&&(et=F.id,Ts=!0),xt.needsLights){let ve=wM(w.state.lightProbeGridArray,V);xt.lightProbeGrid!==ve&&(xt.lightProbeGrid=ve,Ts=!0)}if(Ci||at!==M){y.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),me.setValue(L,"projectionMatrix",M.projectionMatrix),me.setValue(L,"viewMatrix",M.matrixWorldInverse);let ws=me.map.cameraPosition;ws!==void 0&&ws.setValue(L,Be.setFromMatrixPosition(M.matrixWorld)),T.logarithmicDepthBuffer&&me.setValue(L,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(F.isMeshPhongMaterial||F.isMeshToonMaterial||F.isMeshLambertMaterial||F.isMeshBasicMaterial||F.isMeshStandardMaterial||F.isShaderMaterial)&&me.setValue(L,"isOrthographic",M.isOrthographicCamera===!0),at!==M&&(at=M,Ts=!0,er=!0)}if(xt.needsLights&&(On.state.directionalShadowMap.length>0&&me.setValue(L,"directionalShadowMap",On.state.directionalShadowMap,Y),On.state.spotShadowMap.length>0&&me.setValue(L,"spotShadowMap",On.state.spotShadowMap,Y),On.state.pointShadowMap.length>0&&me.setValue(L,"pointShadowMap",On.state.pointShadowMap,Y)),V.isSkinnedMesh){me.setOptional(L,V,"bindMatrix"),me.setOptional(L,V,"bindMatrixInverse");let ve=V.skeleton;ve&&(ve.boneTexture===null&&ve.computeBoneTexture(),me.setValue(L,"boneTexture",ve.boneTexture,Y))}V.isBatchedMesh&&(me.setOptional(L,V,"batchingTexture"),me.setValue(L,"batchingTexture",V._matricesTexture,Y),me.setOptional(L,V,"batchingIdTexture"),me.setValue(L,"batchingIdTexture",V._indirectTexture,Y),me.setOptional(L,V,"batchingColorTexture"),V._colorsTexture!==null&&me.setValue(L,"batchingColorTexture",V._colorsTexture,Y));let As=X.morphAttributes;if((As.position!==void 0||As.normal!==void 0||As.color!==void 0)&&I.update(V,X,ti),(Ts||xt.receiveShadow!==V.receiveShadow)&&(xt.receiveShadow=V.receiveShadow,me.setValue(L,"receiveShadow",V.receiveShadow)),(F.isMeshStandardMaterial||F.isMeshLambertMaterial||F.isMeshPhongMaterial)&&F.envMap===null&&B.environment!==null&&(Ve.envMapIntensity.value=B.environmentIntensity),Ve.dfgLUT!==void 0&&(Ve.dfgLUT.value=e3()),Ts){if(me.setValue(L,"toneMappingExposure",R.toneMappingExposure),xt.needsLights&&RM(Ve,er),_t&&F.fog===!0&&At.refreshFogUniforms(Ve,_t),At.refreshMaterialUniforms(Ve,F,nt,st,w.state.transmissionRenderTarget[M.id]),xt.needsLights&&xt.lightProbeGrid){let ve=xt.lightProbeGrid;Ve.probesSH.value=ve.texture,Ve.probesMin.value.copy(ve.boundingBox.min),Ve.probesMax.value.copy(ve.boundingBox.max),Ve.probesResolution.value.copy(ve.resolution)}So.upload(L,z0(xt),Ve,Y)}if(F.isShaderMaterial&&F.uniformsNeedUpdate===!0&&(So.upload(L,z0(xt),Ve,Y),F.uniformsNeedUpdate=!1),F.isSpriteMaterial&&me.setValue(L,"center",V.center),me.setValue(L,"modelViewMatrix",V.modelViewMatrix),me.setValue(L,"normalMatrix",V.normalMatrix),me.setValue(L,"modelMatrix",V.matrixWorld),F.uniformsGroups!==void 0){let ve=F.uniformsGroups;for(let ws=0,nr=ve.length;ws<nr;ws++){let F0=ve[ws];tt.update(F0,ti),tt.bind(F0,ti)}}return ti}function RM(M,B){M.ambientLightColor.needsUpdate=B,M.lightProbe.needsUpdate=B,M.directionalLights.needsUpdate=B,M.directionalLightShadows.needsUpdate=B,M.pointLights.needsUpdate=B,M.pointLightShadows.needsUpdate=B,M.spotLights.needsUpdate=B,M.spotLightShadows.needsUpdate=B,M.rectAreaLights.needsUpdate=B,M.hemisphereLights.needsUpdate=B}function DM(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return G},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return Q},this.setRenderTargetTextures=function(M,B,X){let F=z.get(M);F.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,F.__autoAllocateDepthBuffer===!1&&(F.__useRenderToTexture=!1),z.get(M.texture).__webglTexture=B,z.get(M.depthTexture).__webglTexture=F.__autoAllocateDepthBuffer?void 0:X,F.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,B){let X=z.get(M);X.__webglFramebuffer=B,X.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(M,B=0,X=0){Q=M,G=B,k=X;let F=null,V=!1,_t=!1;if(M){let gt=z.get(M);if(gt.__useDefaultFramebuffer!==void 0){y.bindFramebuffer(L.FRAMEBUFFER,gt.__webglFramebuffer),rt.copy(M.viewport),yt.copy(M.scissor),Bt=M.scissorTest,y.viewport(rt),y.scissor(yt),y.setScissorTest(Bt),et=-1;return}else if(gt.__webglFramebuffer===void 0)Y.setupRenderTarget(M);else if(gt.__hasExternalTextures)Y.rebindTextures(M,z.get(M.texture).__webglTexture,z.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){let Ht=M.depthTexture;if(gt.__boundDepthTexture!==Ht){if(Ht!==null&&z.has(Ht)&&(M.width!==Ht.image.width||M.height!==Ht.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");Y.setupDepthRenderbuffer(M)}}let Mt=M.texture;(Mt.isData3DTexture||Mt.isDataArrayTexture||Mt.isCompressedArrayTexture)&&(_t=!0);let wt=z.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(wt[B])?F=wt[B][X]:F=wt[B],V=!0):M.samples>0&&Y.useMultisampledRTT(M)===!1?F=z.get(M).__webglMultisampledFramebuffer:Array.isArray(wt)?F=wt[X]:F=wt,rt.copy(M.viewport),yt.copy(M.scissor),Bt=M.scissorTest}else rt.copy(Rt).multiplyScalar(nt).floor(),yt.copy(Se).multiplyScalar(nt).floor(),Bt=kt;if(X!==0&&(F=W),y.bindFramebuffer(L.FRAMEBUFFER,F)&&y.drawBuffers(M,F),y.viewport(rt),y.scissor(yt),y.setScissorTest(Bt),V){let gt=z.get(M.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+B,gt.__webglTexture,X)}else if(_t){let gt=B;for(let Mt=0;Mt<M.textures.length;Mt++){let wt=z.get(M.textures[Mt]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+Mt,wt.__webglTexture,X,gt)}}else if(M!==null&&X!==0){let gt=z.get(M.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,gt.__webglTexture,X)}et=-1},this.readRenderTargetPixels=function(M,B,X,F,V,_t,St,gt=0){if(!(M&&M.isWebGLRenderTarget)){It("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Mt=z.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&St!==void 0&&(Mt=Mt[St]),Mt){y.bindFramebuffer(L.FRAMEBUFFER,Mt);try{let wt=M.textures[gt],Ht=wt.format,qt=wt.type;if(M.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+gt),!T.textureFormatReadable(Ht)){It("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!T.textureTypeReadable(qt)){It("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=M.width-F&&X>=0&&X<=M.height-V&&L.readPixels(B,X,F,V,ht.convert(Ht),ht.convert(qt),_t)}finally{let wt=Q!==null?z.get(Q).__webglFramebuffer:null;y.bindFramebuffer(L.FRAMEBUFFER,wt)}}},this.readRenderTargetPixelsAsync=async function(M,B,X,F,V,_t,St,gt=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Mt=z.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&St!==void 0&&(Mt=Mt[St]),Mt)if(B>=0&&B<=M.width-F&&X>=0&&X<=M.height-V){y.bindFramebuffer(L.FRAMEBUFFER,Mt);let wt=M.textures[gt],Ht=wt.format,qt=wt.type;if(M.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+gt),!T.textureFormatReadable(Ht))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!T.textureTypeReadable(qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ct=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Ct),L.bufferData(L.PIXEL_PACK_BUFFER,_t.byteLength,L.STREAM_READ),L.readPixels(B,X,F,V,ht.convert(Ht),ht.convert(qt),0);let he=Q!==null?z.get(Q).__webglFramebuffer:null;y.bindFramebuffer(L.FRAMEBUFFER,he);let Fe=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Pb(L,Fe,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,Ct),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,_t),L.deleteBuffer(Ct),L.deleteSync(Fe),_t}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,B=null,X=0){let F=Math.pow(2,-X),V=Math.floor(M.image.width*F),_t=Math.floor(M.image.height*F),St=B!==null?B.x:0,gt=B!==null?B.y:0;Y.setTexture2D(M,0),L.copyTexSubImage2D(L.TEXTURE_2D,X,0,0,St,gt,V,_t),y.unbindTexture()},this.copyTextureToTexture=function(M,B,X=null,F=null,V=0,_t=0){let St,gt,Mt,wt,Ht,qt,Ct,he,Fe,Oe=M.isCompressedTexture?M.mipmaps[_t]:M.image;if(X!==null)St=X.max.x-X.min.x,gt=X.max.y-X.min.y,Mt=X.isBox3?X.max.z-X.min.z:1,wt=X.min.x,Ht=X.min.y,qt=X.isBox3?X.min.z:0;else{let Ve=Math.pow(2,-V);St=Math.floor(Oe.width*Ve),gt=Math.floor(Oe.height*Ve),M.isDataArrayTexture?Mt=Oe.depth:M.isData3DTexture?Mt=Math.floor(Oe.depth*Ve):Mt=1,wt=0,Ht=0,qt=0}F!==null?(Ct=F.x,he=F.y,Fe=F.z):(Ct=0,he=0,Fe=0);let pe=ht.convert(B.format),mn=ht.convert(B.type),xt;B.isData3DTexture?(Y.setTexture3D(B,0),xt=L.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(Y.setTexture2DArray(B,0),xt=L.TEXTURE_2D_ARRAY):(Y.setTexture2D(B,0),xt=L.TEXTURE_2D),y.activeTexture(L.TEXTURE0),y.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,B.flipY),y.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),y.pixelStorei(L.UNPACK_ALIGNMENT,B.unpackAlignment);let On=y.getParameter(L.UNPACK_ROW_LENGTH),se=y.getParameter(L.UNPACK_IMAGE_HEIGHT),ti=y.getParameter(L.UNPACK_SKIP_PIXELS),Ci=y.getParameter(L.UNPACK_SKIP_ROWS),Ts=y.getParameter(L.UNPACK_SKIP_IMAGES);y.pixelStorei(L.UNPACK_ROW_LENGTH,Oe.width),y.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Oe.height),y.pixelStorei(L.UNPACK_SKIP_PIXELS,wt),y.pixelStorei(L.UNPACK_SKIP_ROWS,Ht),y.pixelStorei(L.UNPACK_SKIP_IMAGES,qt);let er=M.isDataArrayTexture||M.isData3DTexture,me=B.isDataArrayTexture||B.isData3DTexture;if(M.isDepthTexture){let Ve=z.get(M),As=z.get(B),ve=z.get(Ve.__renderTarget),ws=z.get(As.__renderTarget);y.bindFramebuffer(L.READ_FRAMEBUFFER,ve.__webglFramebuffer),y.bindFramebuffer(L.DRAW_FRAMEBUFFER,ws.__webglFramebuffer);for(let nr=0;nr<Mt;nr++)er&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(M).__webglTexture,V,qt+nr),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(B).__webglTexture,_t,Fe+nr)),L.blitFramebuffer(wt,Ht,St,gt,Ct,he,St,gt,L.DEPTH_BUFFER_BIT,L.NEAREST);y.bindFramebuffer(L.READ_FRAMEBUFFER,null),y.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(V!==0||M.isRenderTargetTexture||z.has(M)){let Ve=z.get(M),As=z.get(B);y.bindFramebuffer(L.READ_FRAMEBUFFER,q),y.bindFramebuffer(L.DRAW_FRAMEBUFFER,P);for(let ve=0;ve<Mt;ve++)er?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Ve.__webglTexture,V,qt+ve):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Ve.__webglTexture,V),me?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,As.__webglTexture,_t,Fe+ve):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,As.__webglTexture,_t),V!==0?L.blitFramebuffer(wt,Ht,St,gt,Ct,he,St,gt,L.COLOR_BUFFER_BIT,L.NEAREST):me?L.copyTexSubImage3D(xt,_t,Ct,he,Fe+ve,wt,Ht,St,gt):L.copyTexSubImage2D(xt,_t,Ct,he,wt,Ht,St,gt);y.bindFramebuffer(L.READ_FRAMEBUFFER,null),y.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else me?M.isDataTexture||M.isData3DTexture?L.texSubImage3D(xt,_t,Ct,he,Fe,St,gt,Mt,pe,mn,Oe.data):B.isCompressedArrayTexture?L.compressedTexSubImage3D(xt,_t,Ct,he,Fe,St,gt,Mt,pe,Oe.data):L.texSubImage3D(xt,_t,Ct,he,Fe,St,gt,Mt,pe,mn,Oe):M.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,_t,Ct,he,St,gt,pe,mn,Oe.data):M.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,_t,Ct,he,Oe.width,Oe.height,pe,Oe.data):L.texSubImage2D(L.TEXTURE_2D,_t,Ct,he,St,gt,pe,mn,Oe);y.pixelStorei(L.UNPACK_ROW_LENGTH,On),y.pixelStorei(L.UNPACK_IMAGE_HEIGHT,se),y.pixelStorei(L.UNPACK_SKIP_PIXELS,ti),y.pixelStorei(L.UNPACK_SKIP_ROWS,Ci),y.pixelStorei(L.UNPACK_SKIP_IMAGES,Ts),_t===0&&B.generateMipmaps&&L.generateMipmap(xt),y.unbindTexture()},this.initRenderTarget=function(M){z.get(M).__webglFramebuffer===void 0&&Y.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?Y.setTextureCube(M,0):M.isData3DTexture?Y.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Y.setTexture2DArray(M,0):Y.setTexture2D(M,0),y.unbindTexture()},this.resetState=function(){G=0,k=0,Q=null,y.reset(),vt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return bi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let n=this.getContext();n.drawingBufferColorSpace=jt._getDrawingBufferColorSpace(t),n.unpackColorSpace=jt._getUnpackColorSpace()}};var C0=12;var $t=(e,t,n=0)=>({time:e,azimuth:t||0,elevation:n,distance:1}),gM=e=>[...Array.from({length:9},(t,n)=>$t(Number((n*5/48).toFixed(6)),e*n*45)),$t(1,e*360)],gc=(e,t=0)=>[$t(0,0),$t(.2,e/2,t/2),$t(.4,e,t),$t(.6,e/2,t/2),$t(.8,0),$t(1,0)],_M=e=>[...Array.from({length:9},(t,n)=>$t(Number((n*5/48).toFixed(6)),e*n*45,n===8?0:Number((25*Math.sin(Math.PI*n/8)).toFixed(3)))),$t(1,e*360)],XN=[{id:"swing",name:"Side Arc",description:"A 65-degree arc around the frame.",duration:5,returnsToStart:!1,trajectory:[$t(0,0),$t(1,65,8)]},{id:"rise",name:"Hero Rise",description:"A new angle on the action.",duration:5,returnsToStart:!1,trajectory:[$t(0,0),$t(1,35,30)]},{id:"orbit",name:"Full Orbit",description:"A full right orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:gM(1)},{id:"arc-return",name:"Arc Return",description:"Sweep 45 degrees to the side, then retrace to the starting pose.",duration:5,returnsToStart:!0,trajectory:[$t(0,0),$t(.2,22.5),$t(.45,45),$t(.7,22.5),$t(.9,0),$t(1,0)]},{id:"rise-return",name:"Rise Return",description:"Rise 25 degrees, then descend to the starting pose.",duration:5,returnsToStart:!0,trajectory:[$t(0,0),$t(.2,0,12.5),$t(.45,0,25),$t(.7,0,12.5),$t(.9,0),$t(1,0)]},{id:"orbit-left",name:"Orbit Left",description:"A full left orbit back to the starting pose.",duration:6,returnsToStart:!0,trajectory:gM(-1)},{id:"arc-left-return",name:"Left Return",description:"Sweep 45 degrees left, then retrace to the opening view.",duration:5,returnsToStart:!0,trajectory:gc(-45)},{id:"wide-return",name:"Wide Return",description:"Reach a 90-degree side view, then return to the opening pose.",duration:5,returnsToStart:!0,trajectory:gc(90)},{id:"dip-return",name:"Dip Return",description:"Dip 20 degrees below the subject, then rise back to the opening view.",duration:5,returnsToStart:!0,trajectory:gc(0,-20)},{id:"high-arc-return",name:"High Return",description:"Arc 45 degrees right and 25 degrees up, then retrace home.",duration:5,returnsToStart:!0,trajectory:gc(45,25)},{id:"low-arc-return",name:"Low Return",description:"Arc 45 degrees left and 20 degrees down, then retrace home.",duration:5,returnsToStart:!0,trajectory:gc(-45,-20)},{id:"sway-return",name:"Side to Side",description:"Sway left, cross through the opening view to the right, then return.",duration:5,returnsToStart:!0,trajectory:[$t(0,0),$t(.2,-30),$t(.4,0),$t(.6,30),$t(.8,0),$t(1,0)]},{id:"halo",name:"High Orbit",description:"Orbit right through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:_M(1)},{id:"halo-left",name:"High Orbit Left",description:"Orbit left through a raised viewpoint, descending to the exact opening pose.",duration:6,returnsToStart:!0,trajectory:_M(-1)},{id:"arc-left",name:"Left Arc",description:"A 65-degree left arc that finishes at a new angle.",duration:5,returnsToStart:!1,trajectory:[$t(0,0),$t(1,-65,8)]},{id:"low-angle",name:"Low Reveal",description:"Sweep 40 degrees right and descend 20 degrees for a low-angle finish.",duration:5,returnsToStart:!1,trajectory:[$t(0,0),$t(1,40,-20)]}];var ft=Tc(R0());async function Mo(e){let t=e instanceof FormData?e:new FormData;if(!(e instanceof FormData))for(let[n,i]of Object.entries(e))t.set(n,i);t.set("format","json");try{return await(await fetch(window.location.pathname,{method:"POST",body:t,credentials:"same-origin"})).json()}catch{return null}}var Sc=Math.PI/180;function _c(e,t,n){return Math.max(t,Math.min(n,e))}function bc(e,t){if(t<=e[0].time)return e[0];let n=e[e.length-1];if(t>=n.time)return n;let i=1;for(;e[i].time<t;)i++;let s=e[i-1],a=e[i],r=Math.max(1e-6,a.time-s.time),o=(t-s.time)/r,l=o*o*(3-2*o),c=a.azimuth-s.azimuth;return c=((c%360+540)%360+360)%360-180,{time:t,azimuth:s.azimuth+c*l,elevation:s.elevation+(a.elevation-s.elevation)*l,distance:s.distance+(a.distance-s.distance)*l}}var MM={time:0,azimuth:0,elevation:0,distance:1},a3={...MM,time:1},vc=1024,SM=["#f8fbff","#ffd166","#ff5d8f","#4db0ff","#39d98a"],r3=[{id:"fast",label:"Flare Fast"},{id:"detailed",label:"Flare Detailed"},{id:"turbo",label:"Turbo"},{id:"hq",label:"Sunburst HQ"}];function o3(e){let t=(0,dt.useRef)(null),n=(0,dt.useRef)([]),i=(0,dt.useRef)(!1),[s,a]=(0,dt.useState)(SM[0]),[r,o]=(0,dt.useState)(14),[l,c]=(0,dt.useState)(!1),[h,p]=(0,dt.useState)(""),[u,d]=(0,dt.useState)("fast"),[,g]=(0,dt.useState)(0),b=(0,dt.useCallback)(()=>{let _=t.current,S=_?.getContext("2d");if(!(!_||!S)){S.fillStyle="#0a1120",S.fillRect(0,0,vc,vc);for(let v of n.current){S.save(),S.globalCompositeOperation=v.erase?"destination-out":"source-over",S.strokeStyle=v.color,S.fillStyle=v.color,S.lineWidth=v.width,S.lineCap="round",S.lineJoin="round";let[E,...w]=v.points;if(!E){S.restore();continue}S.beginPath(),S.arc(E.x,E.y,v.width/2,0,Math.PI*2),S.fill(),S.beginPath(),S.moveTo(E.x,E.y);for(let C of w)S.lineTo(C.x,C.y);S.stroke(),S.restore()}}},[]);(0,dt.useEffect)(()=>b(),[b]);let m=_=>{let S=_.currentTarget.getBoundingClientRect(),v=vc/Math.max(1,Math.min(S.width,S.height));return{x:(_.clientX-S.left)*v,y:(_.clientY-S.top)*v}},f=n.current.length===0;return(0,ft.jsxs)("div",{className:"fz-sketch",children:[(0,ft.jsx)("canvas",{ref:t,className:"fz-sketch-canvas",width:vc,height:vc,onPointerDown:_=>{_.currentTarget.setPointerCapture(_.pointerId),i.current=!0,n.current.push({points:[m(_)],color:s,width:r,erase:l}),b()},onPointerMove:_=>{i.current&&(n.current[n.current.length-1]?.points.push(m(_)),b())},onPointerUp:()=>{i.current=!1,g(_=>_+1)}}),(0,ft.jsxs)("div",{className:"fz-tools",children:[SM.map(_=>(0,ft.jsx)("button",{type:"button",className:`fz-swatch${!l&&s===_?" selected":""}`,style:{background:_},"aria-label":`paint ${_}`,onClick:()=>{a(_),c(!1)}},_)),(0,ft.jsx)("button",{type:"button",className:`fz-ghost${l?" selected":""}`,onClick:()=>c(_=>!_),children:"erase"}),(0,ft.jsx)("input",{className:"fz-size",type:"range",min:4,max:60,value:r,onChange:_=>o(Number(_.target.value)),"aria-label":"brush size"}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",disabled:f,onClick:()=>{n.current=[],b(),g(_=>_+1)},children:"clear"})]}),(0,ft.jsx)("textarea",{className:"fz-prompt",placeholder:"describe the scene \u2014 'two friends at a diner, neon light'",value:h,maxLength:2e3,onChange:_=>p(_.target.value)}),(0,ft.jsx)("div",{className:"fz-modes",children:r3.map(_=>(0,ft.jsx)("button",{type:"button",className:u===_.id?"active":"",onClick:()=>d(_.id),children:_.label},_.id))}),(0,ft.jsx)("button",{type:"button",className:"fz-primary",disabled:e.busy||!h.trim(),onClick:()=>{let _=t.current;n.current.length>0&&_?_.toBlob(v=>e.onGenerate(v,h.trim(),u),"image/png"):e.onGenerate(null,h.trim(),u)},children:e.busy?"generating\u2026":"generate the still"})]})}function yc(e,t,n){let i=t/2,s=n*.46,a=t*.36*e.distance,r=n*.11*e.distance,o=e.azimuth*Sc;return{x:i+Math.sin(o)*a,y:s+n*.16+Math.cos(o)*r-Math.sin(e.elevation*Sc)*n*.3,depth:Math.cos(o)}}var xc=.95,l3=2.3;function gd(e,t){let n=e.azimuth*Sc,i=e.elevation*Sc,s=l3*e.distance;return t.set(Math.sin(n)*Math.cos(i)*s,xc+Math.sin(i)*s,Math.cos(n)*Math.cos(i)*s),t}function c3(e){let t=new fd({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),e.appendChild(t.domElement),t.domElement.style.position="absolute",t.domElement.style.inset="0";let n=[],i=P=>(n.push(P),P),s=new Vl,a=new yn(42,1,.05,80);a.position.set(3.15,2.05,3.55),a.lookAt(0,.85,0);let r=i(new nc(14,28,2902638,1451582));s.add(r);let o=1.7,l=o*.72,c=new Qe(i(new da(o*1.07,l*1.1)),i(new di({color:924208})));c.position.set(0,xc,0);let h=i(new di({color:4479370})),p=i(new da(o,l)),u=new Qe(p,h);u.position.set(0,xc,.001);let d=new fo(i(new Zl(p)),i(new fa({color:8240895})));d.position.copy(u.position),s.add(c,u,d);let g=i(new di({color:6348031})),b=null,m=new Vi;s.add(m);let f=i(new go(.05,16,12)),_=i(new di({color:6348031})),S=i(new di({color:16777215})),v=i(new di({color:16765286,transparent:!0})),E=new Vi;E.add(new Qe(i(new go(.075,18,14)),v));let w=new Qe(i(new Yl(.048,.17,12)),v);w.rotation.x=Math.PI/2,w.position.z=.14,E.add(w),s.add(E);let C=i(new ln().setFromPoints([new U,new U(0,xc,0)])),x=new ho(C,i(new Ql({color:16765286,dashSize:.09,gapSize:.09,transparent:!0,opacity:.45})));x.computeLineDistances(),s.add(x);let A=new U,R=new U(0,xc,0),D=[],O=()=>{let P=e.clientWidth,G=e.clientHeight;if(P===0||G===0)return;let k=new Ut;t.getSize(k),(k.x!==P||k.y!==G)&&(t.setSize(P,G,!1),a.aspect=P/G,a.updateProjectionMatrix()),t.render(s,a)},W=new ResizeObserver(O);W.observe(e);let q=null;return{setImage(P){if(q?.dispose(),P){let G=new xn(P);G.colorSpace=Tn,G.needsUpdate=!0,q=G,h.map=G,h.color.set(16777215)}else q=null,h.map=null,h.color.set(4479370);h.needsUpdate=!0,O()},update(P,G,k){if(D=P,P.length>=2){let et=[];for(let Bt=0;Bt<=96;Bt++)et.push(gd(bc(P,Bt/96),new U));let at=new mo(et),rt=new jl(at,120,.018,8,!1),yt=new Qe(rt,g);b&&(s.remove(b),b.geometry.dispose()),b=yt,s.add(b)}else b&&(s.remove(b),b.geometry.dispose(),b=null);m.clear(),P.forEach((et,at)=>{let rt=new Qe(f,at===k?S:_);rt.position.copy(gd(et,A)),at===k&&rt.scale.setScalar(1.3),rt.userData.index=at,m.add(rt)});let Q=bc(P,G);E.position.copy(gd(Q,A)),E.lookAt(R),v.opacity=Math.cos(Q.azimuth*Sc)<-.05?.45:1,C.setFromPoints([E.position.clone(),R.clone()]),x.computeLineDistances(),O()},pick(P,G){let k=e.clientWidth,Q=e.clientHeight,et=null,at=30;return D.forEach((rt,yt)=>{gd(rt,A).project(a);let Bt=(A.x*.5+.5)*k,ne=(-A.y*.5+.5)*Q,Xt=Math.hypot(Bt-P,ne-G);Xt<at&&(at=Xt,et=yt)}),et},dispose(){W.disconnect(),q?.dispose(),n.forEach(P=>P.dispose()),b?.geometry.dispose(),t.dispose(),t.domElement.remove()}}}function u3(e){let t=(0,dt.useRef)(null),n=(0,dt.useRef)(null),[i,s]=(0,dt.useState)(!1),a=(0,dt.useRef)(null),r=(0,dt.useRef)(e);return r.current=e,(0,dt.useEffect)(()=>{let o=t.current;if(!o||r.current.lite)return;let l=null;try{l=c3(o)}catch{return}return n.current=l,s(!0),()=>{n.current=null,l.dispose()}},[]),(0,dt.useEffect)(()=>{n.current?.setImage(e.image)},[i,e.image]),(0,dt.useEffect)(()=>{n.current?.update(e.keyframes,e.scrubT,e.selected)}),(0,ft.jsx)("div",{ref:t,className:"fz-stage-canvas",onPointerDown:o=>{if(!i)return;o.currentTarget.setPointerCapture(o.pointerId);let l=o.currentTarget.getBoundingClientRect(),c=n.current?.pick(o.clientX-l.left,o.clientY-l.top)??null;c!==null&&r.current.onPick(c),a.current={moved:!1,picked:c}},onPointerMove:o=>{let l=a.current;if(!l||!i)return;let c=o.movementX,h=o.movementY;Math.abs(c)+Math.abs(h)<.5||(l.moved=!0,r.current.onDragPose(c*.6,-h*.4))},onPointerUp:()=>{let o=a.current;a.current=null,!(!o||o.moved||!i)&&r.current.onPick(o.picked)},children:!i&&(0,ft.jsx)(h3,{...e})})}function h3(e){let t=(0,dt.useRef)(null),n=(0,dt.useRef)(null),i=(0,dt.useCallback)(()=>{let s=t.current,a=s?.getContext("2d");if(!s||!a)return;let r=Math.min(2,window.devicePixelRatio||1),o=s.clientWidth,l=s.clientHeight;(s.width!==o*r||s.height!==l*r)&&(s.width=o*r,s.height=l*r),a.setTransform(r,0,0,r,0,0),a.clearRect(0,0,o,l),a.strokeStyle="rgba(120,170,255,0.10)",a.lineWidth=1;let c=l*.62;for(let v=0;v<=12;v++){let E=c+Math.pow(v/12,1.6)*(l-c);a.beginPath(),a.moveTo(0,E),a.lineTo(o,E),a.stroke()}for(let v=-8;v<=8;v++)a.beginPath(),a.moveTo(o/2+v*o*.07,c),a.lineTo(o/2+v*o*.22,l),a.stroke();let h=o/2,p=l*.46,u=o*.36,d=l*.11;a.strokeStyle="rgba(125,190,255,0.22)",a.setLineDash([4,6]),a.beginPath(),a.ellipse(h,p+l*.16,u,d,0,0,Math.PI*2),a.stroke(),a.setLineDash([]);let g=e.keyframes;if(g.length>=2){a.strokeStyle="rgba(96,220,255,0.9)",a.lineWidth=3,a.lineCap="round",a.beginPath();let v=96;for(let E=0;E<=v;E++){let w=yc(bc(g,E/v),o,l);E===0?a.moveTo(w.x,w.y):a.lineTo(w.x,w.y)}a.stroke()}let b=Math.min(o*.4,l*.4*(4/3)),m=b*.72;if(a.save(),a.shadowColor="rgba(0,0,0,0.6)",a.shadowBlur=24,a.fillStyle="#0e1a30",a.fillRect(h-b/2,p-m/2,b,m),a.restore(),e.image){let v=e.image,E=Math.min(b/v.width,m/v.height),w=v.width*E,C=v.height*E;a.drawImage(v,h-w/2,p-C/2,w,C)}else a.fillStyle="rgba(219,232,255,0.5)",a.font="13px ui-monospace, monospace",a.textAlign="center",a.fillText("no photo",h,p);a.strokeStyle="rgba(125,190,255,0.5)",a.strokeRect(h-b/2,p-m/2,b,m),g.forEach((v,E)=>{let w=yc(v,o,l);a.beginPath(),a.arc(w.x,w.y,E===e.selected?7:5,0,Math.PI*2),a.fillStyle=E===e.selected?"#ffffff":"#60dcff",a.fill(),E===e.selected&&(a.strokeStyle="rgba(96,220,255,0.6)",a.lineWidth=2,a.stroke())});let f=bc(g,e.scrubT),_=yc(f,o,l),S=_.depth<-.05;a.globalAlpha=S?.45:1,a.beginPath(),a.arc(_.x,_.y,13,0,Math.PI*2),a.fillStyle="#ffd166",a.fill(),a.beginPath(),a.arc(_.x,_.y,5,0,Math.PI*2),a.fillStyle="#0a1120",a.fill(),a.strokeStyle="rgba(255,209,102,0.35)",a.setLineDash([3,5]),a.beginPath(),a.moveTo(_.x,_.y),a.lineTo(h,p),a.stroke(),a.setLineDash([]),a.globalAlpha=1},[e.image,e.keyframes,e.scrubT,e.selected]);return(0,dt.useEffect)(()=>{i()},[i]),(0,dt.useEffect)(()=>{let s=()=>i();return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[i]),(0,ft.jsx)("canvas",{ref:t,className:"fz-stage-canvas",onPointerDown:s=>{s.currentTarget.setPointerCapture(s.pointerId);let a=s.currentTarget.getBoundingClientRect(),r=s.clientX-a.left,o=s.clientY-a.top,l=e.keyframes.findIndex(c=>{let h=yc(c,a.width,a.height);return Math.hypot(h.x-r,h.y-o)<20});l>=0&&e.onPick(l),n.current={x:r,y:o,moved:!1}},onPointerMove:s=>{let a=n.current;if(!a)return;let r=s.movementX??s.clientX-a.x,o=s.movementY??s.clientY-a.y;Math.abs(r)+Math.abs(o)<.5||(a.moved=!0,a.x=s.clientX,a.y=s.clientY,e.onDragPose(r*.6,-o*.4))},onPointerUp:s=>{let a=n.current;if(n.current=null,a&&!a.moved){let r=s.currentTarget.getBoundingClientRect(),o=e.keyframes.findIndex(l=>{let c=yc(l,r.width,r.height);return Math.hypot(c.x-(s.clientX-r.left),c.y-(s.clientY-r.top))<20});e.onPick(o>=0?o:null)}}})}function f3(e){let[t,n]=(0,dt.useState)(e.initial.sourceAssetId?"camera":"source"),[i,s]=(0,dt.useState)(e.initial.sourceUrl),[a,r]=(0,dt.useState)(e.initial.sourceAssetId),[o,l]=(0,dt.useState)(e.initial.renders),[c,h]=(0,dt.useState)(e.initial.activeJob),[p,u]=(0,dt.useState)(e.initial.latest),[d,g]=(0,dt.useState)(!1),[b,m]=(0,dt.useState)(null),[f,_]=(0,dt.useState)(!1),[S,v]=(0,dt.useState)(null),[E,w]=(0,dt.useState)([MM,{time:.5,azimuth:65,elevation:8,distance:1},a3]),[C,x]=(0,dt.useState)(0),[A,R]=(0,dt.useState)(null),[D,O]=(0,dt.useState)(null),[W,q]=(0,dt.useState)(5),[P,G]=(0,dt.useState)("768P"),[k]=(0,dt.useState)(()=>Math.floor(Math.random()*1e6)),Q=(0,dt.useRef)(null),[,et]=(0,dt.useState)(0),at=(0,dt.useRef)(null),rt=(0,dt.useRef)(null),yt=(0,dt.useRef)(0),Bt=(0,dt.useRef)(e.initial.sourceAssetId),ne=(0,dt.useRef)(null),Xt=(0,dt.useCallback)(H=>{let T=ne.current;T&&T!==H&&(URL.revokeObjectURL(T),ne.current=null),H.startsWith("blob:")&&(ne.current=H),s(H)},[]),K=(0,dt.useCallback)(()=>{ne.current&&(URL.revokeObjectURL(ne.current),ne.current=null),s(null)},[]);(0,dt.useEffect)(()=>()=>{ne.current&&URL.revokeObjectURL(ne.current)},[]);let st=(0,dt.useCallback)((H,T=!1)=>{if(typeof H.latest=="number"&&u(H.latest),h(H.activeJob??null),H.line&&m(H.line),H.sourceUrl&&(T||H.sourceAssetId!==Bt.current)&&Xt(H.sourceUrl),H.sourceAssetId&&(Bt.current=H.sourceAssetId,r(H.sourceAssetId)),H.renders&&l(H.renders),S&&!H.activeJob){let N=(S.kind==="render"?H.renders:H.sketches)?.find(z=>z.jobId===S.id);N&&(N.state==="delivered"||N.state==="failed")&&(v(null),N.state==="delivered"?S.kind==="render"?(m(null),n("result")):(_(!1),m("still delivered \u2014 set the camera move"),n("camera")):m(N.error??"that didn't come out \u2014 try again?"))}},[S,Xt]),nt=(0,dt.useRef)(0),Tt=(0,dt.useCallback)(async()=>{let H=++nt.current,T=await Mo({action:"status",after:String(p)});if(!(!T||H!==nt.current))return st(T),T},[p,st]),Pt=(0,dt.useCallback)(async H=>{for(let T=0;T<10;T++){if(Bt.current!==H)return;let y=await Tt();if(Bt.current!==H)return;if(y&&y.sourceAssetId===H&&(st(y,!0),y.sourceUrl)){m(null);return}await new Promise(N=>setTimeout(N,1200))}Bt.current===H&&m("still converting \u2014 back out and re-upload if it stalls")},[Tt,st]),Rt=(0,dt.useCallback)(()=>{let H=Date.now();H-yt.current<3e4||(yt.current=H,Tt().then(T=>{T&&st(T,!0)}))},[Tt,st]),Se=(0,dt.useRef)(0);(0,dt.useEffect)(()=>{let H=++Se.current;if(!i){Q.current=null,et(y=>y+1);return}let T=new Image;T.crossOrigin="anonymous",T.onload=()=>{H===Se.current&&(Q.current=T,et(y=>y+1))},T.onerror=()=>{H===Se.current&&Rt()},T.src=i},[i,Rt]),(0,dt.useEffect)(()=>{if(!c)return;let H=!1,T=window.setInterval(()=>{H||(H=!0,Tt().finally(()=>{H=!1}))},2500);return()=>window.clearInterval(T)},[c,Tt]);let kt=(H,T)=>m(H?.line??T),oe=(0,dt.useCallback)(async H=>{if(!H||d)return;g(!0),m("reading the photo\u2026");let y=H.type.startsWith("image/")&&!/hei[cf]/i.test(H.type)?URL.createObjectURL(H):null,N=new FormData;N.set("action","source"),N.set("file",H);let z=await Mo(N);if(g(!1),!z||z.error||z.sourceAssetId===void 0){y&&URL.revokeObjectURL(y),kt(z,"that photo didn't come through \u2014 try another.");return}m(null),r(z.sourceAssetId),Bt.current=z.sourceAssetId,z.sourceUrl?(y&&URL.revokeObjectURL(y),Xt(z.sourceUrl)):y?Xt(y):(K(),m("converting the photo\u2026")),n("camera"),Tt(),!z.sourceUrl&&!y&&z.sourceAssetId&&Pt(z.sourceAssetId)},[d,Tt,Xt,K,Pt]),ie=(0,dt.useCallback)(async(H,T,y)=>{if(d)return;g(!0),m("generating the still \u2014 about a minute");let N=new FormData;N.set("action","source"),N.set("kind","sketch"),N.set("prompt",T),N.set("mode",y),H&&N.set("canvas",H,"sketch.png");let z=await Mo(N);if(g(!1),!z||z.error||!z.jobId){kt(z,"that didn't work \u2014 try again?");return}v({id:z.jobId,kind:"sketch"}),st(z),m("generating the still \u2014 about a minute")},[d,st]),te=(0,dt.useCallback)(H=>{O(H.id),q(H.duration===6?6:5),w(H.trajectory.map(T=>({...T}))),R(null),x(0)},[]),Ne=(0,dt.useCallback)(()=>{w(H=>{if(H.length>=C0)return H;let T=_c(C,.02,.98);if(H.some(z=>Math.abs(z.time-T)<.01))return H;let y=bc(H,T);return[...H,{...y,time:T}].sort((z,Y)=>z.time-Y.time).map(z=>({...z}))}),O(null)},[C]),Be=(0,dt.useCallback)(()=>{w(H=>{if(A===null||H.length<=2)return H;let T=H[A];return!T||T.time===0||T.time===1?H:H.filter((y,N)=>N!==A)}),R(null),O(null)},[A]),ke=(0,dt.useCallback)((H,T)=>{O(null),w(y=>{let N=A;if(N===null){let it=1/0;y.forEach((ot,Z)=>{let J=Math.abs(ot.time-C);J<it&&(it=J,N=Z)})}if(N===null)return y;let z=y[N];if(!z||z.time===0||z.time===1)return y;let Y=y.map((it,ot)=>ot===N?{...it,azimuth:_c(it.azimuth+H,-360,360),elevation:_c(it.elevation+T,-90,90)}:it);return R(N),Y})},[A,C]),Je=(0,dt.useCallback)(async()=>{if(d||!a||!i)return;g(!0),m("rendering the freeze \u2014 a few minutes");let H={action:"render",duration:String(W),resolution:P,seed:String(k)};D?H.preset=D:H.trajectory=JSON.stringify(E);let T=await Mo(H);if(g(!1),!T||T.error||!T.jobId){kt(T,"that render didn't start \u2014 try again?");return}v({id:T.jobId,kind:"render"}),st(T),m("freezing \u2014 a few minutes")},[d,a,i,D,P,k,E,W,st]),be=(0,dt.useCallback)(async H=>{if(d)return;g(!0),m("sending to iMessage\u2026");let T=await Mo({action:"save",job:H});if(g(!1),!T||T.error){kt(T,"couldn't send it \u2014 try again");return}T.downloadUrl?(window.open(T.downloadUrl,"_blank","noopener"),m("sent the link \u2014 it's only good for a little while")):m("sent to iMessage")},[d]),Le=(0,dt.useCallback)(async()=>{await Mo({action:"cancel"}),v(null),m(null),await Tt()},[Tt]),L=(0,dt.useMemo)(()=>o.filter(H=>H.state==="delivered"&&H.outputUrl),[o]),en=L[L.length-1];return(0,ft.jsxs)("div",{className:"fz",children:[(0,ft.jsx)("div",{className:"fz-tabs",children:["source","camera","result"].map(H=>(0,ft.jsx)("button",{type:"button",className:t===H?"active":"",disabled:H==="camera"&&!a||H==="result"&&L.length===0,onClick:()=>n(H),children:H==="source"?"1 \xB7 photo":H==="camera"?"2 \xB7 camera":"3 \xB7 freeze"},H))}),c&&(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void Le(),children:"cancel the running job"}),t==="source"&&(0,ft.jsx)("div",{className:"fz-stage",children:f?(0,ft.jsxs)(ft.Fragment,{children:[(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>_(!1),children:"\u2190 back"}),(0,ft.jsx)(o3,{busy:d||S?.kind==="sketch",onGenerate:ie})]}):(0,ft.jsxs)(ft.Fragment,{children:[(0,ft.jsxs)("div",{className:"fz-hero",children:[(0,ft.jsx)("p",{className:"fz-title",children:"freeze the scene"}),(0,ft.jsx)("p",{className:"fz-sub",children:"pick the still \u2014 the camera moves, the moment doesn\u2019t"})]}),(0,ft.jsxs)("div",{className:"fz-source-grid",children:[(0,ft.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>rt.current?.click(),children:[(0,ft.jsx)("span",{className:"fz-card-icon",children:"\u25C9"}),"take a photo"]}),(0,ft.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>at.current?.click(),children:[(0,ft.jsx)("span",{className:"fz-card-icon",children:"\u25A4"}),"upload a photo"]}),(0,ft.jsxs)("button",{type:"button",className:"fz-card",disabled:d,onClick:()=>_(!0),children:[(0,ft.jsx)("span",{className:"fz-card-icon",children:"\u270E"}),"sketch + generate"]})]}),(0,ft.jsx)("input",{ref:rt,type:"file",accept:"image/*,.heic,.heif",capture:"environment",hidden:!0,onChange:H=>void oe(H.target.files?.[0]??null)}),(0,ft.jsx)("input",{ref:at,type:"file",accept:"image/*,.heic,.heif",hidden:!0,onChange:H=>void oe(H.target.files?.[0]??null)}),L.length>0&&(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("result"),children:"see your freezes \u2192"})]})}),t==="camera"&&(0,ft.jsxs)("div",{className:"fz-stage",children:[(0,ft.jsx)("div",{className:"fz-stage-wrap",children:(0,ft.jsx)(u3,{image:Q.current,keyframes:E,scrubT:C,selected:A,lite:e.initial.lite,onDragPose:ke,onPick:R})}),(0,ft.jsx)("div",{className:"fz-presets",children:e.initial.presets.map(H=>(0,ft.jsx)("button",{type:"button",className:`fz-chip${D===H.id?" active":""}`,title:H.description,onClick:()=>te(H),children:H.name},H.id))}),(0,ft.jsxs)("div",{className:"fz-timeline",children:[(0,ft.jsxs)("div",{className:"fz-track",onPointerDown:H=>{let T=H.currentTarget.getBoundingClientRect();x(_c((H.clientX-T.left)/T.width,0,1)),H.currentTarget.setPointerCapture(H.pointerId)},onPointerMove:H=>{if(H.buttons!==1)return;let T=H.currentTarget.getBoundingClientRect();x(_c((H.clientX-T.left)/T.width,0,1))},children:[(0,ft.jsx)("div",{className:"fz-track-line"}),E.map((H,T)=>(0,ft.jsx)("button",{type:"button",className:`fz-kf${A===T?" selected":""}`,style:{left:`${H.time*100}%`},onPointerDown:y=>{y.stopPropagation(),R(T),x(H.time)},onClick:y=>y.stopPropagation(),"aria-label":`keyframe ${T+1} at ${Math.round(H.time*100)}%`},T)),(0,ft.jsx)("div",{className:"fz-head",style:{left:`${C*100}%`}})]}),(0,ft.jsxs)("div",{className:"fz-timeline-row",children:[(0,ft.jsxs)("span",{className:"fz-meta",children:[E.length," keyframes \xB7 ",W,"s",A!==null?` \xB7 keyframe ${A+1}: ${E[A].time===0||E[A].time===1?"endpoints stay":"drag the stage to change it"}`:" \xB7 tap a dot, drag the stage"]}),(0,ft.jsxs)("div",{className:"fz-timeline-actions",children:[(0,ft.jsx)("button",{type:"button",className:"fz-ghost",disabled:E.length>=C0,onClick:Ne,children:"+ keyframe"}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",disabled:A===null||E[A]?.time===0||E[A]?.time===1,onClick:Be,children:"\u2212 remove"})]})]})]}),(0,ft.jsxs)("div",{className:"fz-render-row",children:[(0,ft.jsx)("div",{className:"fz-seg",children:[5,6].map(H=>(0,ft.jsxs)("button",{type:"button",className:W===H?"active":"",onClick:()=>q(H),children:[H,"s"]},H))}),(0,ft.jsx)("div",{className:"fz-seg",children:["480P","768P","1080P"].map(H=>(0,ft.jsx)("button",{type:"button",className:P===H?"active":"",onClick:()=>G(H),children:H==="480P"?"480":H==="768P"?"720":"1080"},H))}),(0,ft.jsx)("button",{type:"button",className:"fz-primary",disabled:d||!a||!i||S!==null,onClick:()=>void Je(),children:S?.kind==="render"||d?"freezing\u2026":"freeze it"})]})]}),t==="result"&&(0,ft.jsxs)("div",{className:"fz-stage",children:[en?(0,ft.jsxs)("div",{className:"fz-result",children:[(0,ft.jsx)("video",{className:"fz-video",src:en.outputUrl??void 0,controls:!0,playsInline:!0,loop:!0,autoPlay:!0,muted:!0,onError:Rt}),(0,ft.jsxs)("div",{className:"fz-actions",children:[(0,ft.jsx)("button",{type:"button",className:"fz-primary",disabled:d,onClick:()=>void be(en.jobId),children:"send to iMessage"}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>n("camera"),children:"new camera move"})]})]}):c?(0,ft.jsx)("p",{className:"fz-sub",children:"rendering \u2014 this takes a few minutes"}):(0,ft.jsx)("p",{className:"fz-sub",children:"nothing rendered yet"}),L.length>1&&(0,ft.jsx)("div",{className:"fz-history",children:L.slice(0,-1).reverse().map(H=>(0,ft.jsxs)("div",{className:"fz-history-row",children:[(0,ft.jsx)("video",{className:"fz-thumb",src:H.outputUrl??void 0,muted:!0,playsInline:!0,preload:"metadata",onError:Rt}),(0,ft.jsx)("button",{type:"button",className:"fz-ghost",onClick:()=>void be(H.jobId),children:"send"})]},H.jobId))})]}),(0,ft.jsx)("p",{className:"fz-line",children:b??""})]})}var d3=`
...
`,D0=document.getElementById("freeze-studio");if(D0){let e=null;try{e=JSON.parse(D0.dataset.payload??"")}catch{e=null}if(e){let t=document.createElement("style");t.textContent=d3,document.head.appendChild(t),(0,bM.createRoot)(D0).render((0,ft.jsx)(dt.StrictMode,{children:(0,ft.jsx)(f3,{initial:e})}))}}})();
