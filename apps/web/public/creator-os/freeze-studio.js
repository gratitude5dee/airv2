...
}`,Y3=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],Z3=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],uM=new Le,mc=new L,x0=new L;function J3(e,t,n){let i=new Wl,s=new Ut,a=new Ut,r=new Ie,o=new af,l=new rf,c={},h=n.maxTextureSize,p={[Ms]:An,[An]:Ms,[Wi]:Wi},u=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ut},radius:{value:4}},vertexShader:W3,fragmentShader:q3}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let g=new on;g.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new Qe(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=sc;let f=this.type;this.render=function(A,w,y){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;this.type===rS&&(Lt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=sc);let M=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),I=e.state;I.setBlending(qi),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let z=f!==this.type;z&&w.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(O=>O.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,O=A.length;q<O;q++){let G=A[q],V=G.shadow;if(V===void 0){Lt("WebGLShadowMap:",G,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let K=V.getFrameExtents();s.multiply(K),a.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/K.x),s.x=a.x*K.x,V.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/K.y),s.y=a.y*K.y,V.mapSize.y=a.y));let it=e.state.buffers.depth.getReversed();if(V.camera._reversedDepth=it,V.map===null||z===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===vo){if(G.isPointLight){Lt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Jn(s.x,s.y,{format:ba,type:Yi,minFilter:dn,magFilter:dn,generateMipmaps:!1}),V.map.texture.name=G.name+".shadowMap",V.map.depthTexture=new Es(s.x,s.y,Ti),V.map.depthTexture.name=G.name+".shadowMapDepth",V.map.depthTexture.format=Gi,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=rn,V.map.depthTexture.magFilter=rn}else G.isPointLight?(V.map=new ud(s.x),V.map.depthTexture=new Zh(s.x,Ei)):(V.map=new Jn(s.x,s.y),V.map.depthTexture=new Es(s.x,s.y,Ei)),V.map.depthTexture.name=G.name+".shadowMap",V.map.depthTexture.format=Gi,this.type===sc?(V.map.depthTexture.compareFunction=it?rd:ad,V.map.depthTexture.minFilter=dn,V.map.depthTexture.magFilter=dn):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=rn,V.map.depthTexture.magFilter=rn);V.camera.updateProjectionMatrix()}let ht=V.map.isWebGLCubeRenderTarget?6:1;for(let ft=0;ft<ht;ft++){if(V.map.isWebGLCubeRenderTarget)e.setRenderTarget(V.map,ft),e.clear();else{ft===0&&(e.setRenderTarget(V.map),e.clear());let _t=V.getViewport(ft);r.set(a.x*_t.x,a.y*_t.y,a.x*_t.z,a.y*_t.w),I.viewport(r)}if(G.isPointLight){let _t=V.camera,Jt=V.matrix,ue=G.distance||_t.far;ue!==_t.far&&(_t.far=ue,_t.updateProjectionMatrix()),mc.setFromMatrixPosition(G.matrixWorld),_t.position.copy(mc),x0.copy(_t.position),x0.add(Y3[ft]),_t.up.copy(Z3[ft]),_t.lookAt(x0),_t.updateMatrixWorld(),Jt.makeTranslation(-mc.x,-mc.y,-mc.z),uM.multiplyMatrices(_t.projectionMatrix,_t.matrixWorldInverse),V._frustum.setFromProjectionMatrix(uM,_t.coordinateSystem,_t.reversedDepth)}else V.updateMatrices(G);i=V.getFrustum(),v(w,y,V.camera,G,this.type)}V.isPointLightShadow!==!0&&this.type===vo&&_(V,y),V.needsUpdate=!1}f=this.type,m.needsUpdate=!1,e.setRenderTarget(M,R,D)};function _(A,w){let y=t.update(S);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Jn(s.x,s.y,{format:ba,type:Yi})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,y,u,S,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,y,d,S,null)}function b(A,w,y,M){let R=null,D=y.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)R=D;else if(R=y.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let I=R.uuid,z=w.uuid,q=c[I];q===void 0&&(q={},c[I]=q);let O=q[z];O===void 0&&(O=R.clone(),q[z]=O,w.addEventListener("dispose",T)),R=O}if(R.visible=w.visible,R.wireframe=w.wireframe,M===vo?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:p[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,y.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let I=e.properties.get(R);I.light=y}return R}function v(A,w,y,M,R){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===vo)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,A.matrixWorld);let z=t.update(A),q=A.material;if(Array.isArray(q)){let O=z.groups;for(let G=0,V=O.length;G<V;G++){let K=O[G],it=q[K.materialIndex];if(it&&it.visible){let ht=b(A,it,M,R);A.onBeforeShadow(e,A,w,y,z,ht,K),e.renderBufferDirect(y,null,z,ht,A,K),A.onAfterShadow(e,A,w,y,z,ht,K)}}}else if(q.visible){let O=b(A,q,M,R);A.onBeforeShadow(e,A,w,y,z,O,null),e.renderBufferDirect(y,null,z,O,A,null),A.onAfterShadow(e,A,w,y,z,O,null)}}let I=A.children;for(let z=0,q=I.length;z<q;z++)v(I[z],w,y,M,R)}function T(A){A.target.removeEventListener("dispose",T);for(let y in c){let M=c[y],R=A.target.uuid;R in M&&(M[R].dispose(),delete M[R])}}}function K3(e,t){function n(){let U=!1,ct=new Ie,$=null,gt=new Ie(0,0,0,0);return{setMask:function(vt){$!==vt&&!U&&(e.colorMask(vt,vt,vt,vt),$=vt)},setLocked:function(vt){U=vt},setClear:function(vt,st,wt,Et,Pe){Pe===!0&&(vt*=Et,st*=Et,wt*=Et),ct.set(vt,st,wt,Et),gt.equals(ct)===!1&&(e.clearColor(vt,st,wt,Et),gt.copy(ct))},reset:function(){U=!1,$=null,gt.set(-1,0,0,0)}}}function i(){let U=!1,ct=!1,$=null,gt=null,vt=null;return{setReversed:function(st){if(ct!==st){let wt=t.get("EXT_clip_control");st?wt.clipControlEXT(wt.LOWER_LEFT_EXT,wt.ZERO_TO_ONE_EXT):wt.clipControlEXT(wt.LOWER_LEFT_EXT,wt.NEGATIVE_ONE_TO_ONE_EXT),ct=st;let Et=vt;vt=null,this.setClear(Et)}},getReversed:function(){return ct},setTest:function(st){st?lt(e.DEPTH_TEST):Nt(e.DEPTH_TEST)},setMask:function(st){$!==st&&!U&&(e.depthMask(st),$=st)},setFunc:function(st){if(ct&&(st=FS[st]),gt!==st){switch(st){case Nh:e.depthFunc(e.NEVER);break;case Uh:e.depthFunc(e.ALWAYS);break;case Lh:e.depthFunc(e.LESS);break;case ja:e.depthFunc(e.LEQUAL);break;case Ih:e.depthFunc(e.EQUAL);break;case Oh:e.depthFunc(e.GEQUAL);break;case Ph:e.depthFunc(e.GREATER);break;case zh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}gt=st}},setLocked:function(st){U=st},setClear:function(st){vt!==st&&(vt=st,ct&&(st=1-st),e.clearDepth(st))},reset:function(){U=!1,$=null,gt=null,vt=null,ct=!1}}}function s(){let U=!1,ct=null,$=null,gt=null,vt=null,st=null,wt=null,Et=null,Pe=null;return{setTest:function(_e){U||(_e?lt(e.STENCIL_TEST):Nt(e.STENCIL_TEST))},setMask:function(_e){ct!==_e&&!U&&(e.stencilMask(_e),ct=_e)},setFunc:function(_e,wi,Ci){($!==_e||gt!==wi||vt!==Ci)&&(e.stencilFunc(_e,wi,Ci),$=_e,gt=wi,vt=Ci)},setOp:function(_e,wi,Ci){(st!==_e||wt!==wi||Et!==Ci)&&(e.stencilOp(_e,wi,Ci),st=_e,wt=wi,Et=Ci)},setLocked:function(_e){U=_e},setClear:function(_e){Pe!==_e&&(e.clearStencil(_e),Pe=_e)},reset:function(){U=!1,ct=null,$=null,gt=null,vt=null,st=null,wt=null,Et=null,Pe=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,h={},p={},u={},d=new WeakMap,g=[],S=null,m=!1,f=null,_=null,b=null,v=null,T=null,A=null,w=null,y=new $t(0,0,0),M=0,R=!1,D=null,I=null,z=null,q=null,O=null,G=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,K=0,it=e.getParameter(e.VERSION);it.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(it)[1]),V=K>=1):it.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(it)[1]),V=K>=2);let ht=null,ft={},_t=e.getParameter(e.SCISSOR_BOX),Jt=e.getParameter(e.VIEWPORT),ue=new Ie().fromArray(_t),Wt=new Ie().fromArray(Jt);function tt(U,ct,$,gt){let vt=new Uint8Array(4),st=e.createTexture();e.bindTexture(U,st),e.texParameteri(U,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(U,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let wt=0;wt<$;wt++)U===e.TEXTURE_3D||U===e.TEXTURE_2D_ARRAY?e.texImage3D(ct,0,e.RGBA,1,1,gt,0,e.RGBA,e.UNSIGNED_BYTE,vt):e.texImage2D(ct+wt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,vt);return st}let mt={};mt[e.TEXTURE_2D]=tt(e.TEXTURE_2D,e.TEXTURE_2D,1),mt[e.TEXTURE_CUBE_MAP]=tt(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),mt[e.TEXTURE_2D_ARRAY]=tt(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),mt[e.TEXTURE_3D]=tt(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),lt(e.DEPTH_TEST),r.setFunc(ja),be(!1),Ne(Hg),lt(e.CULL_FACE),Vt(qi);function lt(U){h[U]!==!0&&(e.enable(U),h[U]=!0)}function Nt(U){h[U]!==!1&&(e.disable(U),h[U]=!1)}function It(U,ct){return u[U]!==ct?(e.bindFramebuffer(U,ct),u[U]=ct,U===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=ct),U===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=ct),!0):!1}function Rt(U,ct){let $=g,gt=!1;if(U){$=d.get(ct),$===void 0&&($=[],d.set(ct,$));let vt=U.textures;if($.length!==vt.length||$[0]!==e.COLOR_ATTACHMENT0){for(let st=0,wt=vt.length;st<wt;st++)$[st]=e.COLOR_ATTACHMENT0+st;$.length=vt.length,gt=!0}}else $[0]!==e.BACK&&($[0]=e.BACK,gt=!0);gt&&e.drawBuffers($)}function we(U){return S!==U?(e.useProgram(U),S=U,!0):!1}let zt={[ca]:e.FUNC_ADD,[lS]:e.FUNC_SUBTRACT,[cS]:e.FUNC_REVERSE_SUBTRACT};zt[uS]=e.MIN,zt[hS]=e.MAX;let re={[fS]:e.ZERO,[dS]:e.ONE,[pS]:e.SRC_COLOR,[Rh]:e.SRC_ALPHA,[xS]:e.SRC_ALPHA_SATURATE,[vS]:e.DST_COLOR,[gS]:e.DST_ALPHA,[mS]:e.ONE_MINUS_SRC_COLOR,[Dh]:e.ONE_MINUS_SRC_ALPHA,[yS]:e.ONE_MINUS_DST_COLOR,[_S]:e.ONE_MINUS_DST_ALPHA,[bS]:e.CONSTANT_COLOR,[SS]:e.ONE_MINUS_CONSTANT_COLOR,[MS]:e.CONSTANT_ALPHA,[ES]:e.ONE_MINUS_CONSTANT_ALPHA};function Vt(U,ct,$,gt,vt,st,wt,Et,Pe,_e){if(U===qi){m===!0&&(Nt(e.BLEND),m=!1);return}if(m===!1&&(lt(e.BLEND),m=!0),U!==oS){if(U!==f||_e!==R){if((_!==ca||T!==ca)&&(e.blendEquation(e.FUNC_ADD),_=ca,T=ca),_e)switch(U){case Ka:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Gg:e.blendFunc(e.ONE,e.ONE);break;case kg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Xg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Ot("WebGLState: Invalid blending: ",U);break}else switch(U){case Ka:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Gg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case kg:Ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Xg:Ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ot("WebGLState: Invalid blending: ",U);break}b=null,v=null,A=null,w=null,y.set(0,0,0),M=0,f=U,R=_e}return}vt=vt||ct,st=st||$,wt=wt||gt,(ct!==_||vt!==T)&&(e.blendEquationSeparate(zt[ct],zt[vt]),_=ct,T=vt),($!==b||gt!==v||st!==A||wt!==w)&&(e.blendFuncSeparate(re[$],re[gt],re[st],re[wt]),b=$,v=gt,A=st,w=wt),(Et.equals(y)===!1||Pe!==M)&&(e.blendColor(Et.r,Et.g,Et.b,Pe),y.copy(Et),M=Pe),f=U,R=!1}function Kt(U,ct){U.side===Wi?Nt(e.CULL_FACE):lt(e.CULL_FACE);let $=U.side===An;ct&&($=!$),be($),U.blending===Ka&&U.transparent===!1?Vt(qi):Vt(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),r.setFunc(U.depthFunc),r.setTest(U.depthTest),r.setMask(U.depthWrite),a.setMask(U.colorWrite);let gt=U.stencilWrite;o.setTest(gt),gt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),Ve(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?lt(e.SAMPLE_ALPHA_TO_COVERAGE):Nt(e.SAMPLE_ALPHA_TO_COVERAGE)}function be(U){D!==U&&(U?e.frontFace(e.CW):e.frontFace(e.CCW),D=U)}function Ne(U){U!==sS?(lt(e.CULL_FACE),U!==I&&(U===Hg?e.cullFace(e.BACK):U===aS?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Nt(e.CULL_FACE),I=U}function Ue(U){U!==z&&(V&&e.lineWidth(U),z=U)}function Ve(U,ct,$){U?(lt(e.POLYGON_OFFSET_FILL),(q!==ct||O!==$)&&(q=ct,O=$,r.getReversed()&&(ct=-ct),e.polygonOffset(ct,$))):Nt(e.POLYGON_OFFSET_FILL)}function Ce(U){U?lt(e.SCISSOR_TEST):Nt(e.SCISSOR_TEST)}function Oe(U){U===void 0&&(U=e.TEXTURE0+G-1),ht!==U&&(e.activeTexture(U),ht=U)}function P(U,ct,$){$===void 0&&(ht===null?$=e.TEXTURE0+G-1:$=ht);let gt=ft[$];gt===void 0&&(gt={type:void 0,texture:void 0},ft[$]=gt),(gt.type!==U||gt.texture!==ct)&&(ht!==$&&(e.activeTexture($),ht=$),e.bindTexture(U,ct||mt[U]),gt.type=U,gt.texture=ct)}function pn(){let U=ft[ht];U!==void 0&&U.type!==void 0&&(e.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function ie(){try{e.compressedTexImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function x(){try{e.texSubImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function F(){try{e.texSubImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function W(){try{e.compressedTexSubImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function J(){try{e.compressedTexSubImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function ut(){try{e.texStorage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function pt(){try{e.texStorage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function Z(){try{e.texImage2D(...arguments)}catch(U){Ot("WebGLState:",U)}}function Q(){try{e.texImage3D(...arguments)}catch(U){Ot("WebGLState:",U)}}function dt(U){return p[U]!==void 0?p[U]:e.getParameter(U)}function N(U,ct){p[U]!==ct&&(e.pixelStorei(U,ct),p[U]=ct)}function k(U){ue.equals(U)===!1&&(e.scissor(U.x,U.y,U.z,U.w),ue.copy(U))}function nt(U){Wt.equals(U)===!1&&(e.viewport(U.x,U.y,U.z,U.w),Wt.copy(U))}function at(U,ct){let $=c.get(ct);$===void 0&&($=new WeakMap,c.set(ct,$));let gt=$.get(U);gt===void 0&&(gt=e.getUniformBlockIndex(ct,U.name),$.set(U,gt))}function rt(U,ct){let gt=c.get(ct).get(U);l.get(ct)!==gt&&(e.uniformBlockBinding(ct,gt,U.__bindingPointIndex),l.set(ct,gt))}function Tt(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},ht=null,ft={},u={},d=new WeakMap,g=[],S=null,m=!1,f=null,_=null,b=null,v=null,T=null,A=null,w=null,y=new $t(0,0,0),M=0,R=!1,D=null,I=null,z=null,q=null,O=null,ue.set(0,0,e.canvas.width,e.canvas.height),Wt.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:lt,disable:Nt,bindFramebuffer:It,drawBuffers:Rt,useProgram:we,setBlending:Vt,setMaterial:Kt,setFlipSided:be,setCullFace:Ne,setLineWidth:Ue,setPolygonOffset:Ve,setScissorTest:Ce,activeTexture:Oe,bindTexture:P,unbindTexture:pn,compressedTexImage2D:ie,compressedTexImage3D:C,texImage2D:Z,texImage3D:Q,pixelStorei:N,getParameter:dt,updateUBOMapping:at,uniformBlockBinding:rt,texStorage2D:ut,texStorage3D:pt,texSubImage2D:x,texSubImage3D:F,compressedTexSubImage2D:W,compressedTexSubImage3D:J,scissor:k,viewport:nt,reset:Tt}}function j3(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ut,h=new WeakMap,p=new Set,u,d=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(C,x){return g?new OffscreenCanvas(C,x):Bl("canvas")}function m(C,x,F){let W=1,J=ie(C);if((J.width>F||J.height>F)&&(W=F/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){let ut=Math.floor(W*J.width),pt=Math.floor(W*J.height);u===void 0&&(u=S(ut,pt));let Z=x?S(ut,pt):u;return Z.width=ut,Z.height=pt,Z.getContext("2d").drawImage(C,0,0,ut,pt),Lt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ut+"x"+pt+")."),Z}else return"data"in C&&Lt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),C;return C}function f(C){return C.generateMipmaps}function _(C){e.generateMipmap(C)}function b(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function v(C,x,F,W,J,ut=!1){if(C!==null){if(e[C]!==void 0)return e[C];Lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let pt;W&&(pt=t.get("EXT_texture_norm16"),pt||Lt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=x;if(x===e.RED&&(F===e.FLOAT&&(Z=e.R32F),F===e.HALF_FLOAT&&(Z=e.R16F),F===e.UNSIGNED_BYTE&&(Z=e.R8),F===e.UNSIGNED_SHORT&&pt&&(Z=pt.R16_EXT),F===e.SHORT&&pt&&(Z=pt.R16_SNORM_EXT)),x===e.RED_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.R8UI),F===e.UNSIGNED_SHORT&&(Z=e.R16UI),F===e.UNSIGNED_INT&&(Z=e.R32UI),F===e.BYTE&&(Z=e.R8I),F===e.SHORT&&(Z=e.R16I),F===e.INT&&(Z=e.R32I)),x===e.RG&&(F===e.FLOAT&&(Z=e.RG32F),F===e.HALF_FLOAT&&(Z=e.RG16F),F===e.UNSIGNED_BYTE&&(Z=e.RG8),F===e.UNSIGNED_SHORT&&pt&&(Z=pt.RG16_EXT),F===e.SHORT&&pt&&(Z=pt.RG16_SNORM_EXT)),x===e.RG_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.RG8UI),F===e.UNSIGNED_SHORT&&(Z=e.RG16UI),F===e.UNSIGNED_INT&&(Z=e.RG32UI),F===e.BYTE&&(Z=e.RG8I),F===e.SHORT&&(Z=e.RG16I),F===e.INT&&(Z=e.RG32I)),x===e.RGB_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.RGB8UI),F===e.UNSIGNED_SHORT&&(Z=e.RGB16UI),F===e.UNSIGNED_INT&&(Z=e.RGB32UI),F===e.BYTE&&(Z=e.RGB8I),F===e.SHORT&&(Z=e.RGB16I),F===e.INT&&(Z=e.RGB32I)),x===e.RGBA_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.RGBA8UI),F===e.UNSIGNED_SHORT&&(Z=e.RGBA16UI),F===e.UNSIGNED_INT&&(Z=e.RGBA32UI),F===e.BYTE&&(Z=e.RGBA8I),F===e.SHORT&&(Z=e.RGBA16I),F===e.INT&&(Z=e.RGBA32I)),x===e.RGB&&(F===e.UNSIGNED_SHORT&&pt&&(Z=pt.RGB16_EXT),F===e.SHORT&&pt&&(Z=pt.RGB16_SNORM_EXT),F===e.UNSIGNED_INT_5_9_9_9_REV&&(Z=e.RGB9_E5),F===e.UNSIGNED_INT_10F_11F_11F_REV&&(Z=e.R11F_G11F_B10F)),x===e.RGBA){let Q=ut?Pl:Qt.getTransfer(J);F===e.FLOAT&&(Z=e.RGBA32F),F===e.HALF_FLOAT&&(Z=e.RGBA16F),F===e.UNSIGNED_BYTE&&(Z=Q===oe?e.SRGB8_ALPHA8:e.RGBA8),F===e.UNSIGNED_SHORT&&pt&&(Z=pt.RGBA16_EXT),F===e.SHORT&&pt&&(Z=pt.RGBA16_SNORM_EXT),F===e.UNSIGNED_SHORT_4_4_4_4&&(Z=e.RGBA4),F===e.UNSIGNED_SHORT_5_5_5_1&&(Z=e.RGB5_A1)}return(Z===e.R16F||Z===e.R32F||Z===e.RG16F||Z===e.RG32F||Z===e.RGBA16F||Z===e.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function T(C,x){let F;return C?x===null||x===Ei||x===xo?F=e.DEPTH24_STENCIL8:x===Ti?F=e.DEPTH32F_STENCIL8:x===yo&&(F=e.DEPTH24_STENCIL8,Lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Ei||x===xo?F=e.DEPTH_COMPONENT24:x===Ti?F=e.DEPTH_COMPONENT32F:x===yo&&(F=e.DEPTH_COMPONENT16),F}function A(C,x){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==rn&&C.minFilter!==dn?Math.log2(Math.max(x.width,x.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?x.mipmaps.length:1}function w(C){let x=C.target;x.removeEventListener("dispose",w),M(x),x.isVideoTexture&&h.delete(x),x.isHTMLTexture&&p.delete(x)}function y(C){let x=C.target;x.removeEventListener("dispose",y),D(x)}function M(C){let x=i.get(C);if(x.__webglInit===void 0)return;let F=C.source,W=d.get(F);if(W){let J=W[x.__cacheKey];J.usedTimes--,J.usedTimes===0&&R(C),Object.keys(W).length===0&&d.delete(F)}i.remove(C)}function R(C){let x=i.get(C);e.deleteTexture(x.__webglTexture);let F=C.source,W=d.get(F);delete W[x.__cacheKey],r.memory.textures--}function D(C){let x=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(x.__webglFramebuffer[W]))for(let J=0;J<x.__webglFramebuffer[W].length;J++)e.deleteFramebuffer(x.__webglFramebuffer[W][J]);else e.deleteFramebuffer(x.__webglFramebuffer[W]);x.__webglDepthbuffer&&e.deleteRenderbuffer(x.__webglDepthbuffer[W])}else{if(Array.isArray(x.__webglFramebuffer))for(let W=0;W<x.__webglFramebuffer.length;W++)e.deleteFramebuffer(x.__webglFramebuffer[W]);else e.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&e.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&e.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let W=0;W<x.__webglColorRenderbuffer.length;W++)x.__webglColorRenderbuffer[W]&&e.deleteRenderbuffer(x.__webglColorRenderbuffer[W]);x.__webglDepthRenderbuffer&&e.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let F=C.textures;for(let W=0,J=F.length;W<J;W++){let ut=i.get(F[W]);ut.__webglTexture&&(e.deleteTexture(ut.__webglTexture),r.memory.textures--),i.remove(F[W])}i.remove(C)}let I=0;function z(){I=0}function q(){return I}function O(C){I=C}function G(){let C=I;return C>=s.maxTextures&&Lt("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),I+=1,C}function V(C){let x=[];return x.push(C.wrapS),x.push(C.wrapT),x.push(C.wrapR||0),x.push(C.magFilter),x.push(C.minFilter),x.push(C.anisotropy),x.push(C.internalFormat),x.push(C.format),x.push(C.type),x.push(C.generateMipmaps),x.push(C.premultiplyAlpha),x.push(C.flipY),x.push(C.unpackAlignment),x.push(C.colorSpace),x.join()}function K(C,x){let F=i.get(C);if(C.isVideoTexture&&P(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&F.__version!==C.version){let W=C.image;if(W===null)Lt("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Lt("WebGLRenderer: Texture marked for update but image is incomplete");else{Nt(F,C,x);return}}else C.isExternalTexture&&(F.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,F.__webglTexture,e.TEXTURE0+x)}function it(C,x){let F=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&F.__version!==C.version){Nt(F,C,x);return}else C.isExternalTexture&&(F.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,F.__webglTexture,e.TEXTURE0+x)}function ht(C,x){let F=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&F.__version!==C.version){Nt(F,C,x);return}n.bindTexture(e.TEXTURE_3D,F.__webglTexture,e.TEXTURE0+x)}function ft(C,x){let F=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&F.__version!==C.version){It(F,C,x);return}n.bindTexture(e.TEXTURE_CUBE_MAP,F.__webglTexture,e.TEXTURE0+x)}let _t={[Bh]:e.REPEAT,[Vi]:e.CLAMP_TO_EDGE,[Fh]:e.MIRRORED_REPEAT},Jt={[rn]:e.NEAREST,[wS]:e.NEAREST_MIPMAP_NEAREST,[rc]:e.NEAREST_MIPMAP_LINEAR,[dn]:e.LINEAR,[Sf]:e.LINEAR_MIPMAP_NEAREST,[ya]:e.LINEAR_MIPMAP_LINEAR},ue={[DS]:e.NEVER,[OS]:e.ALWAYS,[NS]:e.LESS,[ad]:e.LEQUAL,[US]:e.EQUAL,[rd]:e.GEQUAL,[LS]:e.GREATER,[IS]:e.NOTEQUAL};function Wt(C,x){if(x.type===Ti&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===dn||x.magFilter===Sf||x.magFilter===rc||x.magFilter===ya||x.minFilter===dn||x.minFilter===Sf||x.minFilter===rc||x.minFilter===ya)&&Lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,_t[x.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,_t[x.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,_t[x.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,Jt[x.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,Jt[x.minFilter]),x.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,ue[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===rn||x.minFilter!==rc&&x.minFilter!==ya||x.type===Ti&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){let F=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function tt(C,x){let F=!1;C.__webglInit===void 0&&(C.__webglInit=!0,x.addEventListener("dispose",w));let W=x.source,J=d.get(W);J===void 0&&(J={},d.set(W,J));let ut=V(x);if(ut!==C.__cacheKey){J[ut]===void 0&&(J[ut]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,F=!0),J[ut].usedTimes++;let pt=J[C.__cacheKey];pt!==void 0&&(J[C.__cacheKey].usedTimes--,pt.usedTimes===0&&R(x)),C.__cacheKey=ut,C.__webglTexture=J[ut].texture}return F}function mt(C,x,F){return Math.floor(Math.floor(C/F)/x)}function lt(C,x,F,W){let ut=C.updateRanges;if(ut.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,x.width,x.height,F,W,x.data);else{ut.sort((N,k)=>N.start-k.start);let pt=0;for(let N=1;N<ut.length;N++){let k=ut[pt],nt=ut[N],at=k.start+k.count,rt=mt(nt.start,x.width,4),Tt=mt(k.start,x.width,4);nt.start<=at+1&&rt===Tt&&mt(nt.start+nt.count-1,x.width,4)===rt?k.count=Math.max(k.count,nt.start+nt.count-k.start):(++pt,ut[pt]=nt)}ut.length=pt+1;let Z=n.getParameter(e.UNPACK_ROW_LENGTH),Q=n.getParameter(e.UNPACK_SKIP_PIXELS),dt=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,x.width);for(let N=0,k=ut.length;N<k;N++){let nt=ut[N],at=Math.floor(nt.start/4),rt=Math.ceil(nt.count/4),Tt=at%x.width,U=Math.floor(at/x.width),ct=rt,$=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,Tt),n.pixelStorei(e.UNPACK_SKIP_ROWS,U),n.texSubImage2D(e.TEXTURE_2D,0,Tt,U,ct,$,F,W,x.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,Z),n.pixelStorei(e.UNPACK_SKIP_PIXELS,Q),n.pixelStorei(e.UNPACK_SKIP_ROWS,dt)}}function Nt(C,x,F){let W=e.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(W=e.TEXTURE_2D_ARRAY),x.isData3DTexture&&(W=e.TEXTURE_3D);let J=tt(C,x),ut=x.source;n.bindTexture(W,C.__webglTexture,e.TEXTURE0+F);let pt=i.get(ut);if(ut.version!==pt.__version||J===!0){if(n.activeTexture(e.TEXTURE0+F),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){let $=Qt.getPrimaries(Qt.workingColorSpace),gt=x.colorSpace===Ts?null:Qt.getPrimaries(x.colorSpace),vt=x.colorSpace===Ts||$===gt?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt)}n.pixelStorei(e.UNPACK_ALIGNMENT,x.unpackAlignment);let Q=m(x.image,!1,s.maxTextureSize);Q=pn(x,Q);let dt=a.convert(x.format,x.colorSpace),N=a.convert(x.type),k=v(x.internalFormat,dt,N,x.normalized,x.colorSpace,x.isVideoTexture);Wt(W,x);let nt,at=x.mipmaps,rt=x.isVideoTexture!==!0,Tt=pt.__version===void 0||J===!0,U=ut.dataReady,ct=A(x,Q);if(x.isDepthTexture)k=T(x.format===xa,x.type),Tt&&(rt?n.texStorage2D(e.TEXTURE_2D,1,k,Q.width,Q.height):n.texImage2D(e.TEXTURE_2D,0,k,Q.width,Q.height,0,dt,N,null));else if(x.isDataTexture)if(at.length>0){rt&&Tt&&n.texStorage2D(e.TEXTURE_2D,ct,k,at[0].width,at[0].height);for(let $=0,gt=at.length;$<gt;$++)nt=at[$],rt?U&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,nt.width,nt.height,dt,N,nt.data):n.texImage2D(e.TEXTURE_2D,$,k,nt.width,nt.height,0,dt,N,nt.data);x.generateMipmaps=!1}else rt?(Tt&&n.texStorage2D(e.TEXTURE_2D,ct,k,Q.width,Q.height),U&&lt(x,Q,dt,N)):n.texImage2D(e.TEXTURE_2D,0,k,Q.width,Q.height,0,dt,N,Q.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){rt&&Tt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ct,k,at[0].width,at[0].height,Q.depth);for(let $=0,gt=at.length;$<gt;$++)if(nt=at[$],x.format!==mi)if(dt!==null)if(rt){if(U)if(x.layerUpdates.size>0){let vt=p0(nt.width,nt.height,x.format,x.type);for(let st of x.layerUpdates){let wt=nt.data.subarray(st*vt/nt.data.BYTES_PER_ELEMENT,(st+1)*vt/nt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,st,nt.width,nt.height,1,dt,wt)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,0,nt.width,nt.height,Q.depth,dt,nt.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,$,k,nt.width,nt.height,Q.depth,0,nt.data,0,0);else Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else rt?U&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,0,nt.width,nt.height,Q.depth,dt,N,nt.data):n.texImage3D(e.TEXTURE_2D_ARRAY,$,k,nt.width,nt.height,Q.depth,0,dt,N,nt.data)}else{rt&&Tt&&n.texStorage2D(e.TEXTURE_2D,ct,k,at[0].width,at[0].height);for(let $=0,gt=at.length;$<gt;$++)nt=at[$],x.format!==mi?dt!==null?rt?U&&n.compressedTexSubImage2D(e.TEXTURE_2D,$,0,0,nt.width,nt.height,dt,nt.data):n.compressedTexImage2D(e.TEXTURE_2D,$,k,nt.width,nt.height,0,nt.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):rt?U&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,nt.width,nt.height,dt,N,nt.data):n.texImage2D(e.TEXTURE_2D,$,k,nt.width,nt.height,0,dt,N,nt.data)}else if(x.isDataArrayTexture)if(rt){if(Tt&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ct,k,Q.width,Q.height,Q.depth),U)if(x.layerUpdates.size>0){let $=p0(Q.width,Q.height,x.format,x.type);for(let gt of x.layerUpdates){let vt=Q.data.subarray(gt*$/Q.data.BYTES_PER_ELEMENT,(gt+1)*$/Q.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,gt,Q.width,Q.height,1,dt,N,vt)}x.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,dt,N,Q.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,k,Q.width,Q.height,Q.depth,0,dt,N,Q.data);else if(x.isData3DTexture)rt?(Tt&&n.texStorage3D(e.TEXTURE_3D,ct,k,Q.width,Q.height,Q.depth),U&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,dt,N,Q.data)):n.texImage3D(e.TEXTURE_3D,0,k,Q.width,Q.height,Q.depth,0,dt,N,Q.data);else if(x.isFramebufferTexture){if(Tt)if(rt)n.texStorage2D(e.TEXTURE_2D,ct,k,Q.width,Q.height);else{let $=Q.width,gt=Q.height;for(let vt=0;vt<ct;vt++)n.texImage2D(e.TEXTURE_2D,vt,k,$,gt,0,dt,N,null),$>>=1,gt>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in e){let $=e.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),Q.parentNode!==$){$.appendChild(Q),p.add(x),$.onpaint=gt=>{let vt=gt.changedElements;for(let st of p)vt.includes(st.image)&&(st.needsUpdate=!0)},$.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,Q);else{let vt=e.RGBA,st=e.RGBA,wt=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,vt,st,wt,Q)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(at.length>0){if(rt&&Tt){let $=ie(at[0]);n.texStorage2D(e.TEXTURE_2D,ct,k,$.width,$.height)}for(let $=0,gt=at.length;$<gt;$++)nt=at[$],rt?U&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,dt,N,nt):n.texImage2D(e.TEXTURE_2D,$,k,dt,N,nt);x.generateMipmaps=!1}else if(rt){if(Tt){let $=ie(Q);n.texStorage2D(e.TEXTURE_2D,ct,k,$.width,$.height)}U&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,dt,N,Q)}else n.texImage2D(e.TEXTURE_2D,0,k,dt,N,Q);f(x)&&_(W),pt.__version=ut.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function It(C,x,F){if(x.image.length!==6)return;let W=tt(C,x),J=x.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+F);let ut=i.get(J);if(J.version!==ut.__version||W===!0){n.activeTexture(e.TEXTURE0+F);let pt=Qt.getPrimaries(Qt.workingColorSpace),Z=x.colorSpace===Ts?null:Qt.getPrimaries(x.colorSpace),Q=x.colorSpace===Ts||pt===Z?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let dt=x.isCompressedTexture||x.image[0].isCompressedTexture,N=x.image[0]&&x.image[0].isDataTexture,k=[];for(let st=0;st<6;st++)!dt&&!N?k[st]=m(x.image[st],!0,s.maxCubemapSize):k[st]=N?x.image[st].image:x.image[st],k[st]=pn(x,k[st]);let nt=k[0],at=a.convert(x.format,x.colorSpace),rt=a.convert(x.type),Tt=v(x.internalFormat,at,rt,x.normalized,x.colorSpace),U=x.isVideoTexture!==!0,ct=ut.__version===void 0||W===!0,$=J.dataReady,gt=A(x,nt);Wt(e.TEXTURE_CUBE_MAP,x);let vt;if(dt){U&&ct&&n.texStorage2D(e.TEXTURE_CUBE_MAP,gt,Tt,nt.width,nt.height);for(let st=0;st<6;st++){vt=k[st].mipmaps;for(let wt=0;wt<vt.length;wt++){let Et=vt[wt];x.format!==mi?at!==null?U?$&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt,0,0,Et.width,Et.height,at,Et.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt,Tt,Et.width,Et.height,0,Et.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt,0,0,Et.width,Et.height,at,rt,Et.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt,Tt,Et.width,Et.height,0,at,rt,Et.data)}}}else{if(vt=x.mipmaps,U&&ct){vt.length>0&&gt++;let st=ie(k[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,gt,Tt,st.width,st.height)}for(let st=0;st<6;st++)if(N){U?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,k[st].width,k[st].height,at,rt,k[st].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Tt,k[st].width,k[st].height,0,at,rt,k[st].data);for(let wt=0;wt<vt.length;wt++){let Pe=vt[wt].image[st].image;U?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt+1,0,0,Pe.width,Pe.height,at,rt,Pe.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt+1,Tt,Pe.width,Pe.height,0,at,rt,Pe.data)}}else{U?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,at,rt,k[st]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Tt,at,rt,k[st]);for(let wt=0;wt<vt.length;wt++){let Et=vt[wt];U?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt+1,0,0,at,rt,Et.image[st]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,wt+1,Tt,at,rt,Et.image[st])}}}f(x)&&_(e.TEXTURE_CUBE_MAP),ut.__version=J.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function Rt(C,x,F,W,J,ut){let pt=a.convert(F.format,F.colorSpace),Z=a.convert(F.type),Q=v(F.internalFormat,pt,Z,F.normalized,F.colorSpace),dt=i.get(x),N=i.get(F);if(N.__renderTarget=x,!dt.__hasExternalTextures){let k=Math.max(1,x.width>>ut),nt=Math.max(1,x.height>>ut);J===e.TEXTURE_3D||J===e.TEXTURE_2D_ARRAY?n.texImage3D(J,ut,Q,k,nt,x.depth,0,pt,Z,null):n.texImage2D(J,ut,Q,k,nt,0,pt,Z,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),Oe(x)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,W,J,N.__webglTexture,0,Ce(x)):(J===e.TEXTURE_2D||J>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,W,J,N.__webglTexture,ut),n.bindFramebuffer(e.FRAMEBUFFER,null)}function we(C,x,F){if(e.bindRenderbuffer(e.RENDERBUFFER,C),x.depthBuffer){let W=x.depthTexture,J=W&&W.isDepthTexture?W.type:null,ut=T(x.stencilBuffer,J),pt=x.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Oe(x)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Ce(x),ut,x.width,x.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,Ce(x),ut,x.width,x.height):e.renderbufferStorage(e.RENDERBUFFER,ut,x.width,x.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,pt,e.RENDERBUFFER,C)}else{let W=x.textures;for(let J=0;J<W.length;J++){let ut=W[J],pt=a.convert(ut.format,ut.colorSpace),Z=a.convert(ut.type),Q=v(ut.internalFormat,pt,Z,ut.normalized,ut.colorSpace);Oe(x)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Ce(x),Q,x.width,x.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,Ce(x),Q,x.width,x.height):e.renderbufferStorage(e.RENDERBUFFER,Q,x.width,x.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function zt(C,x,F){let W=x.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=i.get(x.depthTexture);if(J.__renderTarget=x,(!J.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),W){if(J.__webglInit===void 0&&(J.__webglInit=!0,x.depthTexture.addEventListener("dispose",w)),J.__webglTexture===void 0){J.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,J.__webglTexture),Wt(e.TEXTURE_CUBE_MAP,x.depthTexture);let dt=a.convert(x.depthTexture.format),N=a.convert(x.depthTexture.type),k;x.depthTexture.format===Gi?k=e.DEPTH_COMPONENT24:x.depthTexture.format===xa&&(k=e.DEPTH24_STENCIL8);for(let nt=0;nt<6;nt++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,k,x.width,x.height,0,dt,N,null)}}else K(x.depthTexture,0);let ut=J.__webglTexture,pt=Ce(x),Z=W?e.TEXTURE_CUBE_MAP_POSITIVE_X+F:e.TEXTURE_2D,Q=x.depthTexture.format===xa?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(x.depthTexture.format===Gi)Oe(x)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Q,Z,ut,0,pt):e.framebufferTexture2D(e.FRAMEBUFFER,Q,Z,ut,0);else if(x.depthTexture.format===xa)Oe(x)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,Q,Z,ut,0,pt):e.framebufferTexture2D(e.FRAMEBUFFER,Q,Z,ut,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function re(C){let x=i.get(C),F=C.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==C.depthTexture){let W=C.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),W){let J=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),x.__depthDisposeCallback=J}x.__boundDepthTexture=W}if(C.depthTexture&&!x.__autoAllocateDepthBuffer)if(F)for(let W=0;W<6;W++)zt(x.__webglFramebuffer[W],C,W);else{let W=C.texture.mipmaps;W&&W.length>0?zt(x.__webglFramebuffer[0],C,0):zt(x.__webglFramebuffer,C,0)}else if(F){x.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(n.bindFramebuffer(e.FRAMEBUFFER,x.__webglFramebuffer[W]),x.__webglDepthbuffer[W]===void 0)x.__webglDepthbuffer[W]=e.createRenderbuffer(),we(x.__webglDepthbuffer[W],C,!1);else{let J=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ut=x.__webglDepthbuffer[W];e.bindRenderbuffer(e.RENDERBUFFER,ut),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,ut)}}else{let W=C.texture.mipmaps;if(W&&W.length>0?n.bindFramebuffer(e.FRAMEBUFFER,x.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=e.createRenderbuffer(),we(x.__webglDepthbuffer,C,!1);else{let J=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ut=x.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,ut),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,ut)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Vt(C,x,F){let W=i.get(C);x!==void 0&&Rt(W.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),F!==void 0&&re(C)}function Kt(C){let x=C.texture,F=i.get(C),W=i.get(x);C.addEventListener("dispose",y);let J=C.textures,ut=C.isWebGLCubeRenderTarget===!0,pt=J.length>1;if(pt||(W.__webglTexture===void 0&&(W.__webglTexture=e.createTexture()),W.__version=x.version,r.memory.textures++),ut){F.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer[Z]=[];for(let Q=0;Q<x.mipmaps.length;Q++)F.__webglFramebuffer[Z][Q]=e.createFramebuffer()}else F.__webglFramebuffer[Z]=e.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer=[];for(let Z=0;Z<x.mipmaps.length;Z++)F.__webglFramebuffer[Z]=e.createFramebuffer()}else F.__webglFramebuffer=e.createFramebuffer();if(pt)for(let Z=0,Q=J.length;Z<Q;Z++){let dt=i.get(J[Z]);dt.__webglTexture===void 0&&(dt.__webglTexture=e.createTexture(),r.memory.textures++)}if(C.samples>0&&Oe(C)===!1){F.__webglMultisampledFramebuffer=e.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let Z=0;Z<J.length;Z++){let Q=J[Z];F.__webglColorRenderbuffer[Z]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,F.__webglColorRenderbuffer[Z]);let dt=a.convert(Q.format,Q.colorSpace),N=a.convert(Q.type),k=v(Q.internalFormat,dt,N,Q.normalized,Q.colorSpace,C.isXRRenderTarget===!0),nt=Ce(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,nt,k,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Z,e.RENDERBUFFER,F.__webglColorRenderbuffer[Z])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(F.__webglDepthRenderbuffer=e.createRenderbuffer(),we(F.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(ut){n.bindTexture(e.TEXTURE_CUBE_MAP,W.__webglTexture),Wt(e.TEXTURE_CUBE_MAP,x);for(let Z=0;Z<6;Z++)if(x.mipmaps&&x.mipmaps.length>0)for(let Q=0;Q<x.mipmaps.length;Q++)Rt(F.__webglFramebuffer[Z][Q],C,x,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Q);else Rt(F.__webglFramebuffer[Z],C,x,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);f(x)&&_(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(pt){for(let Z=0,Q=J.length;Z<Q;Z++){let dt=J[Z],N=i.get(dt),k=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(k=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(k,N.__webglTexture),Wt(k,dt),Rt(F.__webglFramebuffer,C,dt,e.COLOR_ATTACHMENT0+Z,k,0),f(dt)&&_(k)}n.unbindTexture()}else{let Z=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Z=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(Z,W.__webglTexture),Wt(Z,x),x.mipmaps&&x.mipmaps.length>0)for(let Q=0;Q<x.mipmaps.length;Q++)Rt(F.__webglFramebuffer[Q],C,x,e.COLOR_ATTACHMENT0,Z,Q);else Rt(F.__webglFramebuffer,C,x,e.COLOR_ATTACHMENT0,Z,0);f(x)&&_(Z),n.unbindTexture()}C.depthBuffer&&re(C)}function be(C){let x=C.textures;for(let F=0,W=x.length;F<W;F++){let J=x[F];if(f(J)){let ut=b(C),pt=i.get(J).__webglTexture;n.bindTexture(ut,pt),_(ut),n.unbindTexture()}}}let Ne=[],Ue=[];function Ve(C){if(C.samples>0){if(Oe(C)===!1){let x=C.textures,F=C.width,W=C.height,J=e.COLOR_BUFFER_BIT,ut=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,pt=i.get(C),Z=x.length>1;if(Z)for(let dt=0;dt<x.length;dt++)n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,pt.__webglMultisampledFramebuffer);let Q=C.texture.mipmaps;Q&&Q.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,pt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,pt.__webglFramebuffer);for(let dt=0;dt<x.length;dt++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(J|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(J|=e.STENCIL_BUFFER_BIT)),Z){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,pt.__webglColorRenderbuffer[dt]);let N=i.get(x[dt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,N,0)}e.blitFramebuffer(0,0,F,W,0,0,F,W,J,e.NEAREST),l===!0&&(Ne.length=0,Ue.length=0,Ne.push(e.COLOR_ATTACHMENT0+dt),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Ne.push(ut),Ue.push(ut),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Ue)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Ne))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),Z)for(let dt=0;dt<x.length;dt++){n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.RENDERBUFFER,pt.__webglColorRenderbuffer[dt]);let N=i.get(x[dt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.TEXTURE_2D,N,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,pt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){let x=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[x])}}}function Ce(C){return Math.min(s.maxSamples,C.samples)}function Oe(C){let x=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function P(C){let x=r.render.frame;h.get(C)!==x&&(h.set(C,x),C.update())}function pn(C,x){let F=C.colorSpace,W=C.format,J=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||F!==Ol&&F!==Ts&&(Qt.getTransfer(F)===oe?(W!==mi||J!==$n)&&Lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ot("WebGLTextures: Unsupported texture color space:",F)),x}function ie(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=z,this.getTextureUnits=q,this.setTextureUnits=O,this.setTexture2D=K,this.setTexture2DArray=it,this.setTexture3D=ht,this.setTextureCube=ft,this.rebindTextures=Vt,this.setupRenderTarget=Kt,this.updateRenderTargetMipmap=be,this.updateMultisampleRenderTarget=Ve,this.setupDepthRenderbuffer=re,this.setupFrameBufferTexture=Rt,this.useMultisampledRTT=Oe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Q3(e,t){function n(i,s=Ts){let a,r=Qt.getTransfer(s);if(i===$n)return e.UNSIGNED_BYTE;if(i===Ef)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Tf)return e.UNSIGNED_SHORT_5_5_5_1;if(i===n0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===i0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===t0)return e.BYTE;if(i===e0)return e.SHORT;if(i===yo)return e.UNSIGNED_SHORT;if(i===Mf)return e.INT;if(i===Ei)return e.UNSIGNED_INT;if(i===Ti)return e.FLOAT;if(i===Yi)return e.HALF_FLOAT;if(i===s0)return e.ALPHA;if(i===a0)return e.RGB;if(i===mi)return e.RGBA;if(i===Gi)return e.DEPTH_COMPONENT;if(i===xa)return e.DEPTH_STENCIL;if(i===r0)return e.RED;if(i===Af)return e.RED_INTEGER;if(i===ba)return e.RG;if(i===wf)return e.RG_INTEGER;if(i===Cf)return e.RGBA_INTEGER;if(i===oc||i===lc||i===cc||i===uc)if(r===oe)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===oc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===cc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===uc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===oc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===cc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===uc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Rf||i===Df||i===Nf||i===Uf)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Rf)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Df)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Nf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Lf||i===If||i===Of||i===Pf||i===zf||i===hc||i===Bf)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Lf||i===If)return r===oe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Of)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Pf)return a.COMPRESSED_R11_EAC;if(i===zf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===hc)return a.COMPRESSED_RG11_EAC;if(i===Bf)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ff||i===Vf||i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Ff)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Vf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Hf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Gf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===kf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Xf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===qf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Yf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Zf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Jf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Kf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===jf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Qf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===$f||i===td||i===ed)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===$f)return r===oe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===td)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ed)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===nd||i===id||i===fc||i===sd)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===nd)return a.COMPRESSED_RED_RGTC1_EXT;if(i===id)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===fc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===sd)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===xo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var $3=`
void main() {
...
`,N0=document.getElementById("freeze-studio");if(N0){let e=null;try{e=JSON.parse(N0.dataset.payload??"")}catch{e=null}if(e){let t=document.createElement("style");t.textContent=b2,document.head.appendChild(t),(0,AM.createRoot)(N0).render((0,j.jsx)(ot.StrictMode,{children:(0,j.jsx)(x2,{initial:e})}))}}})();
