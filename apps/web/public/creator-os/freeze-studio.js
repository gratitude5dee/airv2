...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function uR(e,t,n){let i=new Float32Array(er),s=new U(0,1,0);return new jn({name:"SphericalGaussianBlur",defines:{n:er,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:fd(),fragmentShader:`
...
}`,Y3=[new U(1,0,0),new U(-1,0,0),new U(0,1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1)],Z3=[new U(0,-1,0),new U(0,-1,0),new U(0,0,1),new U(0,0,-1),new U(0,-1,0),new U(0,-1,0)],uM=new Le,mc=new U,x0=new U;function J3(e,t,n){let i=new Wl,s=new Nt,a=new Nt,r=new Ie,o=new af,l=new rf,c={},h=n.maxTextureSize,p={[Ms]:An,[An]:Ms,[Wi]:Wi},u=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Nt},radius:{value:4}},vertexShader:W3,fragmentShader:q3}),d=u.clone();d.defines.HORIZONTAL_PASS=1;let g=new on;g.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new Qe(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=sc;let f=this.type;this.render=function(A,w,y){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;this.type===rS&&(Ut("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=sc);let M=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),L=e.state;L.setBlending(qi),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);let z=f!==this.type;z&&w.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(O=>O.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,O=A.length;q<O;q++){let G=A[q],V=G.shadow;if(V===void 0){Ut("WebGLShadowMap:",G,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let Q=V.getFrameExtents();s.multiply(Q),a.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/Q.x),s.x=a.x*Q.x,V.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/Q.y),s.y=a.y*Q.y,V.mapSize.y=a.y));let it=e.state.buffers.depth.getReversed();if(V.camera._reversedDepth=it,V.map===null||z===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===vo){if(G.isPointLight){Ut("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Jn(s.x,s.y,{format:ba,type:Yi,minFilter:dn,magFilter:dn,generateMipmaps:!1}),V.map.texture.name=G.name+".shadowMap",V.map.depthTexture=new Es(s.x,s.y,Ti),V.map.depthTexture.name=G.name+".shadowMapDepth",V.map.depthTexture.format=Gi,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=rn,V.map.depthTexture.magFilter=rn}else G.isPointLight?(V.map=new ud(s.x),V.map.depthTexture=new Zh(s.x,Ei)):(V.map=new Jn(s.x,s.y),V.map.depthTexture=new Es(s.x,s.y,Ei)),V.map.depthTexture.name=G.name+".shadowMap",V.map.depthTexture.format=Gi,this.type===sc?(V.map.depthTexture.compareFunction=it?rd:ad,V.map.depthTexture.minFilter=dn,V.map.depthTexture.magFilter=dn):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=rn,V.map.depthTexture.magFilter=rn);V.camera.updateProjectionMatrix()}let ht=V.map.isWebGLCubeRenderTarget?6:1;for(let ft=0;ft<ht;ft++){if(V.map.isWebGLCubeRenderTarget)e.setRenderTarget(V.map,ft),e.clear();else{ft===0&&(e.setRenderTarget(V.map),e.clear());let bt=V.getViewport(ft);r.set(a.x*bt.x,a.y*bt.y,a.x*bt.z,a.y*bt.w),L.viewport(r)}if(G.isPointLight){let bt=V.camera,kt=V.matrix,ue=G.distance||bt.far;ue!==bt.far&&(bt.far=ue,bt.updateProjectionMatrix()),mc.setFromMatrixPosition(G.matrixWorld),bt.position.copy(mc),x0.copy(bt.position),x0.add(Y3[ft]),bt.up.copy(Z3[ft]),bt.lookAt(x0),bt.updateMatrixWorld(),kt.makeTranslation(-mc.x,-mc.y,-mc.z),uM.multiplyMatrices(bt.projectionMatrix,bt.matrixWorldInverse),V._frustum.setFromProjectionMatrix(uM,bt.coordinateSystem,bt.reversedDepth)}else V.updateMatrices(G);i=V.getFrustum(),v(w,y,V.camera,G,this.type)}V.isPointLightShadow!==!0&&this.type===vo&&_(V,y),V.needsUpdate=!1}f=this.type,m.needsUpdate=!1,e.setRenderTarget(M,R,D)};function _(A,w){let y=t.update(S);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,d.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,d.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Jn(s.x,s.y,{format:ba,type:Yi})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,y,u,S,null),d.uniforms.shadow_pass.value=A.mapPass.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,y,d,S,null)}function b(A,w,y,M){let R=null,D=y.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)R=D;else if(R=y.isPointLight===!0?l:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let L=R.uuid,z=w.uuid,q=c[L];q===void 0&&(q={},c[L]=q);let O=q[z];O===void 0&&(O=R.clone(),q[z]=O,w.addEventListener("dispose",T)),R=O}if(R.visible=w.visible,R.wireframe=w.wireframe,M===vo?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:p[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,y.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let L=e.properties.get(R);L.light=y}return R}function v(A,w,y,M,R){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===vo)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,A.matrixWorld);let z=t.update(A),q=A.material;if(Array.isArray(q)){let O=z.groups;for(let G=0,V=O.length;G<V;G++){let Q=O[G],it=q[Q.materialIndex];if(it&&it.visible){let ht=b(A,it,M,R);A.onBeforeShadow(e,A,w,y,z,ht,Q),e.renderBufferDirect(y,null,z,ht,A,Q),A.onAfterShadow(e,A,w,y,z,ht,Q)}}}else if(q.visible){let O=b(A,q,M,R);A.onBeforeShadow(e,A,w,y,z,O,null),e.renderBufferDirect(y,null,z,O,A,null),A.onAfterShadow(e,A,w,y,z,O,null)}}let L=A.children;for(let z=0,q=L.length;z<q;z++)v(L[z],w,y,M,R)}function T(A){A.target.removeEventListener("dispose",T);for(let y in c){let M=c[y],R=A.target.uuid;R in M&&(M[R].dispose(),delete M[R])}}}function K3(e,t){function n(){let I=!1,ut=new Ie,$=null,gt=new Ie(0,0,0,0);return{setMask:function(_t){$!==_t&&!I&&(e.colorMask(_t,_t,_t,_t),$=_t)},setLocked:function(_t){I=_t},setClear:function(_t,st,At,Et,Pe){Pe===!0&&(_t*=Et,st*=Et,At*=Et),ut.set(_t,st,At,Et),gt.equals(ut)===!1&&(e.clearColor(_t,st,At,Et),gt.copy(ut))},reset:function(){I=!1,$=null,gt.set(-1,0,0,0)}}}function i(){let I=!1,ut=!1,$=null,gt=null,_t=null;return{setReversed:function(st){if(ut!==st){let At=t.get("EXT_clip_control");st?At.clipControlEXT(At.LOWER_LEFT_EXT,At.ZERO_TO_ONE_EXT):At.clipControlEXT(At.LOWER_LEFT_EXT,At.NEGATIVE_ONE_TO_ONE_EXT),ut=st;let Et=_t;_t=null,this.setClear(Et)}},getReversed:function(){return ut},setTest:function(st){st?rt(e.DEPTH_TEST):Dt(e.DEPTH_TEST)},setMask:function(st){$!==st&&!I&&(e.depthMask(st),$=st)},setFunc:function(st){if(ut&&(st=FS[st]),gt!==st){switch(st){case Nh:e.depthFunc(e.NEVER);break;case Uh:e.depthFunc(e.ALWAYS);break;case Lh:e.depthFunc(e.LESS);break;case ja:e.depthFunc(e.LEQUAL);break;case Ih:e.depthFunc(e.EQUAL);break;case Oh:e.depthFunc(e.GEQUAL);break;case Ph:e.depthFunc(e.GREATER);break;case zh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}gt=st}},setLocked:function(st){I=st},setClear:function(st){_t!==st&&(_t=st,ut&&(st=1-st),e.clearDepth(st))},reset:function(){I=!1,$=null,gt=null,_t=null,ut=!1}}}function s(){let I=!1,ut=null,$=null,gt=null,_t=null,st=null,At=null,Et=null,Pe=null;return{setTest:function(_e){I||(_e?rt(e.STENCIL_TEST):Dt(e.STENCIL_TEST))},setMask:function(_e){ut!==_e&&!I&&(e.stencilMask(_e),ut=_e)},setFunc:function(_e,wi,Ci){($!==_e||gt!==wi||_t!==Ci)&&(e.stencilFunc(_e,wi,Ci),$=_e,gt=wi,_t=Ci)},setOp:function(_e,wi,Ci){(st!==_e||At!==wi||Et!==Ci)&&(e.stencilOp(_e,wi,Ci),st=_e,At=wi,Et=Ci)},setLocked:function(_e){I=_e},setClear:function(_e){Pe!==_e&&(e.clearStencil(_e),Pe=_e)},reset:function(){I=!1,ut=null,$=null,gt=null,_t=null,st=null,At=null,Et=null,Pe=null}}}let a=new n,r=new i,o=new s,l=new WeakMap,c=new WeakMap,h={},p={},u={},d=new WeakMap,g=[],S=null,m=!1,f=null,_=null,b=null,v=null,T=null,A=null,w=null,y=new $t(0,0,0),M=0,R=!1,D=null,L=null,z=null,q=null,O=null,G=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,Q=0,it=e.getParameter(e.VERSION);it.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(it)[1]),V=Q>=1):it.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(it)[1]),V=Q>=2);let ht=null,ft={},bt=e.getParameter(e.SCISSOR_BOX),kt=e.getParameter(e.VIEWPORT),ue=new Ie().fromArray(bt),qt=new Ie().fromArray(kt);function tt(I,ut,$,gt){let _t=new Uint8Array(4),st=e.createTexture();e.bindTexture(I,st),e.texParameteri(I,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(I,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let At=0;At<$;At++)I===e.TEXTURE_3D||I===e.TEXTURE_2D_ARRAY?e.texImage3D(ut,0,e.RGBA,1,1,gt,0,e.RGBA,e.UNSIGNED_BYTE,_t):e.texImage2D(ut+At,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,_t);return st}let mt={};mt[e.TEXTURE_2D]=tt(e.TEXTURE_2D,e.TEXTURE_2D,1),mt[e.TEXTURE_CUBE_MAP]=tt(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),mt[e.TEXTURE_2D_ARRAY]=tt(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),mt[e.TEXTURE_3D]=tt(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),rt(e.DEPTH_TEST),r.setFunc(ja),be(!1),Ne(Hg),rt(e.CULL_FACE),Vt(qi);function rt(I){h[I]!==!0&&(e.enable(I),h[I]=!0)}function Dt(I){h[I]!==!1&&(e.disable(I),h[I]=!1)}function Lt(I,ut){return u[I]!==ut?(e.bindFramebuffer(I,ut),u[I]=ut,I===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=ut),I===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=ut),!0):!1}function Ct(I,ut){let $=g,gt=!1;if(I){$=d.get(ut),$===void 0&&($=[],d.set(ut,$));let _t=I.textures;if($.length!==_t.length||$[0]!==e.COLOR_ATTACHMENT0){for(let st=0,At=_t.length;st<At;st++)$[st]=e.COLOR_ATTACHMENT0+st;$.length=_t.length,gt=!0}}else $[0]!==e.BACK&&($[0]=e.BACK,gt=!0);gt&&e.drawBuffers($)}function we(I){return S!==I?(e.useProgram(I),S=I,!0):!1}let zt={[ca]:e.FUNC_ADD,[lS]:e.FUNC_SUBTRACT,[cS]:e.FUNC_REVERSE_SUBTRACT};zt[uS]=e.MIN,zt[hS]=e.MAX;let re={[fS]:e.ZERO,[dS]:e.ONE,[pS]:e.SRC_COLOR,[Rh]:e.SRC_ALPHA,[xS]:e.SRC_ALPHA_SATURATE,[vS]:e.DST_COLOR,[gS]:e.DST_ALPHA,[mS]:e.ONE_MINUS_SRC_COLOR,[Dh]:e.ONE_MINUS_SRC_ALPHA,[yS]:e.ONE_MINUS_DST_COLOR,[_S]:e.ONE_MINUS_DST_ALPHA,[bS]:e.CONSTANT_COLOR,[SS]:e.ONE_MINUS_CONSTANT_COLOR,[MS]:e.CONSTANT_ALPHA,[ES]:e.ONE_MINUS_CONSTANT_ALPHA};function Vt(I,ut,$,gt,_t,st,At,Et,Pe,_e){if(I===qi){m===!0&&(Dt(e.BLEND),m=!1);return}if(m===!1&&(rt(e.BLEND),m=!0),I!==oS){if(I!==f||_e!==R){if((_!==ca||T!==ca)&&(e.blendEquation(e.FUNC_ADD),_=ca,T=ca),_e)switch(I){case Ka:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Gg:e.blendFunc(e.ONE,e.ONE);break;case kg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Xg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Ot("WebGLState: Invalid blending: ",I);break}else switch(I){case Ka:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Gg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case kg:Ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Xg:Ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ot("WebGLState: Invalid blending: ",I);break}b=null,v=null,A=null,w=null,y.set(0,0,0),M=0,f=I,R=_e}return}_t=_t||ut,st=st||$,At=At||gt,(ut!==_||_t!==T)&&(e.blendEquationSeparate(zt[ut],zt[_t]),_=ut,T=_t),($!==b||gt!==v||st!==A||At!==w)&&(e.blendFuncSeparate(re[$],re[gt],re[st],re[At]),b=$,v=gt,A=st,w=At),(Et.equals(y)===!1||Pe!==M)&&(e.blendColor(Et.r,Et.g,Et.b,Pe),y.copy(Et),M=Pe),f=I,R=!1}function Kt(I,ut){I.side===Wi?Dt(e.CULL_FACE):rt(e.CULL_FACE);let $=I.side===An;ut&&($=!$),be($),I.blending===Ka&&I.transparent===!1?Vt(qi):Vt(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),r.setFunc(I.depthFunc),r.setTest(I.depthTest),r.setMask(I.depthWrite),a.setMask(I.colorWrite);let gt=I.stencilWrite;o.setTest(gt),gt&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Ve(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?rt(e.SAMPLE_ALPHA_TO_COVERAGE):Dt(e.SAMPLE_ALPHA_TO_COVERAGE)}function be(I){D!==I&&(I?e.frontFace(e.CW):e.frontFace(e.CCW),D=I)}function Ne(I){I!==sS?(rt(e.CULL_FACE),I!==L&&(I===Hg?e.cullFace(e.BACK):I===aS?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Dt(e.CULL_FACE),L=I}function Ue(I){I!==z&&(V&&e.lineWidth(I),z=I)}function Ve(I,ut,$){I?(rt(e.POLYGON_OFFSET_FILL),(q!==ut||O!==$)&&(q=ut,O=$,r.getReversed()&&(ut=-ut),e.polygonOffset(ut,$))):Dt(e.POLYGON_OFFSET_FILL)}function Ce(I){I?rt(e.SCISSOR_TEST):Dt(e.SCISSOR_TEST)}function Oe(I){I===void 0&&(I=e.TEXTURE0+G-1),ht!==I&&(e.activeTexture(I),ht=I)}function P(I,ut,$){$===void 0&&(ht===null?$=e.TEXTURE0+G-1:$=ht);let gt=ft[$];gt===void 0&&(gt={type:void 0,texture:void 0},ft[$]=gt),(gt.type!==I||gt.texture!==ut)&&(ht!==$&&(e.activeTexture($),ht=$),e.bindTexture(I,ut||mt[I]),gt.type=I,gt.texture=ut)}function pn(){let I=ft[ht];I!==void 0&&I.type!==void 0&&(e.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function ie(){try{e.compressedTexImage2D(...arguments)}catch(I){Ot("WebGLState:",I)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(I){Ot("WebGLState:",I)}}function x(){try{e.texSubImage2D(...arguments)}catch(I){Ot("WebGLState:",I)}}function F(){try{e.texSubImage3D(...arguments)}catch(I){Ot("WebGLState:",I)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(I){Ot("WebGLState:",I)}}function J(){try{e.compressedTexSubImage3D(...arguments)}catch(I){Ot("WebGLState:",I)}}function lt(){try{e.texStorage2D(...arguments)}catch(I){Ot("WebGLState:",I)}}function pt(){try{e.texStorage3D(...arguments)}catch(I){Ot("WebGLState:",I)}}function Z(){try{e.texImage2D(...arguments)}catch(I){Ot("WebGLState:",I)}}function K(){try{e.texImage3D(...arguments)}catch(I){Ot("WebGLState:",I)}}function dt(I){return p[I]!==void 0?p[I]:e.getParameter(I)}function N(I,ut){p[I]!==ut&&(e.pixelStorei(I,ut),p[I]=ut)}function W(I){ue.equals(I)===!1&&(e.scissor(I.x,I.y,I.z,I.w),ue.copy(I))}function nt(I){qt.equals(I)===!1&&(e.viewport(I.x,I.y,I.z,I.w),qt.copy(I))}function ot(I,ut){let $=c.get(ut);$===void 0&&($=new WeakMap,c.set(ut,$));let gt=$.get(I);gt===void 0&&(gt=e.getUniformBlockIndex(ut,I.name),$.set(I,gt))}function ct(I,ut){let gt=c.get(ut).get(I);l.get(ut)!==gt&&(e.uniformBlockBinding(ut,gt,I.__bindingPointIndex),l.set(ut,gt))}function It(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},p={},ht=null,ft={},u={},d=new WeakMap,g=[],S=null,m=!1,f=null,_=null,b=null,v=null,T=null,A=null,w=null,y=new $t(0,0,0),M=0,R=!1,D=null,L=null,z=null,q=null,O=null,ue.set(0,0,e.canvas.width,e.canvas.height),qt.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:rt,disable:Dt,bindFramebuffer:Lt,drawBuffers:Ct,useProgram:we,setBlending:Vt,setMaterial:Kt,setFlipSided:be,setCullFace:Ne,setLineWidth:Ue,setPolygonOffset:Ve,setScissorTest:Ce,activeTexture:Oe,bindTexture:P,unbindTexture:pn,compressedTexImage2D:ie,compressedTexImage3D:C,texImage2D:Z,texImage3D:K,pixelStorei:N,getParameter:dt,updateUBOMapping:ot,uniformBlockBinding:ct,texStorage2D:lt,texStorage3D:pt,texSubImage2D:x,texSubImage3D:F,compressedTexSubImage2D:X,compressedTexSubImage3D:J,scissor:W,viewport:nt,reset:It}}function j3(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Nt,h=new WeakMap,p=new Set,u,d=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(C,x){return g?new OffscreenCanvas(C,x):Bl("canvas")}function m(C,x,F){let X=1,J=ie(C);if((J.width>F||J.height>F)&&(X=F/Math.max(J.width,J.height)),X<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){let lt=Math.floor(X*J.width),pt=Math.floor(X*J.height);u===void 0&&(u=S(lt,pt));let Z=x?S(lt,pt):u;return Z.width=lt,Z.height=pt,Z.getContext("2d").drawImage(C,0,0,lt,pt),Ut("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+lt+"x"+pt+")."),Z}else return"data"in C&&Ut("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),C;return C}function f(C){return C.generateMipmaps}function _(C){e.generateMipmap(C)}function b(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function v(C,x,F,X,J,lt=!1){if(C!==null){if(e[C]!==void 0)return e[C];Ut("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let pt;X&&(pt=t.get("EXT_texture_norm16"),pt||Ut("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Z=x;if(x===e.RED&&(F===e.FLOAT&&(Z=e.R32F),F===e.HALF_FLOAT&&(Z=e.R16F),F===e.UNSIGNED_BYTE&&(Z=e.R8),F===e.UNSIGNED_SHORT&&pt&&(Z=pt.R16_EXT),F===e.SHORT&&pt&&(Z=pt.R16_SNORM_EXT)),x===e.RED_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.R8UI),F===e.UNSIGNED_SHORT&&(Z=e.R16UI),F===e.UNSIGNED_INT&&(Z=e.R32UI),F===e.BYTE&&(Z=e.R8I),F===e.SHORT&&(Z=e.R16I),F===e.INT&&(Z=e.R32I)),x===e.RG&&(F===e.FLOAT&&(Z=e.RG32F),F===e.HALF_FLOAT&&(Z=e.RG16F),F===e.UNSIGNED_BYTE&&(Z=e.RG8),F===e.UNSIGNED_SHORT&&pt&&(Z=pt.RG16_EXT),F===e.SHORT&&pt&&(Z=pt.RG16_SNORM_EXT)),x===e.RG_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.RG8UI),F===e.UNSIGNED_SHORT&&(Z=e.RG16UI),F===e.UNSIGNED_INT&&(Z=e.RG32UI),F===e.BYTE&&(Z=e.RG8I),F===e.SHORT&&(Z=e.RG16I),F===e.INT&&(Z=e.RG32I)),x===e.RGB_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.RGB8UI),F===e.UNSIGNED_SHORT&&(Z=e.RGB16UI),F===e.UNSIGNED_INT&&(Z=e.RGB32UI),F===e.BYTE&&(Z=e.RGB8I),F===e.SHORT&&(Z=e.RGB16I),F===e.INT&&(Z=e.RGB32I)),x===e.RGBA_INTEGER&&(F===e.UNSIGNED_BYTE&&(Z=e.RGBA8UI),F===e.UNSIGNED_SHORT&&(Z=e.RGBA16UI),F===e.UNSIGNED_INT&&(Z=e.RGBA32UI),F===e.BYTE&&(Z=e.RGBA8I),F===e.SHORT&&(Z=e.RGBA16I),F===e.INT&&(Z=e.RGBA32I)),x===e.RGB&&(F===e.UNSIGNED_SHORT&&pt&&(Z=pt.RGB16_EXT),F===e.SHORT&&pt&&(Z=pt.RGB16_SNORM_EXT),F===e.UNSIGNED_INT_5_9_9_9_REV&&(Z=e.RGB9_E5),F===e.UNSIGNED_INT_10F_11F_11F_REV&&(Z=e.R11F_G11F_B10F)),x===e.RGBA){let K=lt?Pl:Qt.getTransfer(J);F===e.FLOAT&&(Z=e.RGBA32F),F===e.HALF_FLOAT&&(Z=e.RGBA16F),F===e.UNSIGNED_BYTE&&(Z=K===oe?e.SRGB8_ALPHA8:e.RGBA8),F===e.UNSIGNED_SHORT&&pt&&(Z=pt.RGBA16_EXT),F===e.SHORT&&pt&&(Z=pt.RGBA16_SNORM_EXT),F===e.UNSIGNED_SHORT_4_4_4_4&&(Z=e.RGBA4),F===e.UNSIGNED_SHORT_5_5_5_1&&(Z=e.RGB5_A1)}return(Z===e.R16F||Z===e.R32F||Z===e.RG16F||Z===e.RG32F||Z===e.RGBA16F||Z===e.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function T(C,x){let F;return C?x===null||x===Ei||x===xo?F=e.DEPTH24_STENCIL8:x===Ti?F=e.DEPTH32F_STENCIL8:x===yo&&(F=e.DEPTH24_STENCIL8,Ut("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Ei||x===xo?F=e.DEPTH_COMPONENT24:x===Ti?F=e.DEPTH_COMPONENT32F:x===yo&&(F=e.DEPTH_COMPONENT16),F}function A(C,x){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==rn&&C.minFilter!==dn?Math.log2(Math.max(x.width,x.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?x.mipmaps.length:1}function w(C){let x=C.target;x.removeEventListener("dispose",w),M(x),x.isVideoTexture&&h.delete(x),x.isHTMLTexture&&p.delete(x)}function y(C){let x=C.target;x.removeEventListener("dispose",y),D(x)}function M(C){let x=i.get(C);if(x.__webglInit===void 0)return;let F=C.source,X=d.get(F);if(X){let J=X[x.__cacheKey];J.usedTimes--,J.usedTimes===0&&R(C),Object.keys(X).length===0&&d.delete(F)}i.remove(C)}function R(C){let x=i.get(C);e.deleteTexture(x.__webglTexture);let F=C.source,X=d.get(F);delete X[x.__cacheKey],r.memory.textures--}function D(C){let x=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(x.__webglFramebuffer[X]))for(let J=0;J<x.__webglFramebuffer[X].length;J++)e.deleteFramebuffer(x.__webglFramebuffer[X][J]);else e.deleteFramebuffer(x.__webglFramebuffer[X]);x.__webglDepthbuffer&&e.deleteRenderbuffer(x.__webglDepthbuffer[X])}else{if(Array.isArray(x.__webglFramebuffer))for(let X=0;X<x.__webglFramebuffer.length;X++)e.deleteFramebuffer(x.__webglFramebuffer[X]);else e.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&e.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&e.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let X=0;X<x.__webglColorRenderbuffer.length;X++)x.__webglColorRenderbuffer[X]&&e.deleteRenderbuffer(x.__webglColorRenderbuffer[X]);x.__webglDepthRenderbuffer&&e.deleteRenderbuffer(x.__webglDepthRenderbuffer)}let F=C.textures;for(let X=0,J=F.length;X<J;X++){let lt=i.get(F[X]);lt.__webglTexture&&(e.deleteTexture(lt.__webglTexture),r.memory.textures--),i.remove(F[X])}i.remove(C)}let L=0;function z(){L=0}function q(){return L}function O(C){L=C}function G(){let C=L;return C>=s.maxTextures&&Ut("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),L+=1,C}function V(C){let x=[];return x.push(C.wrapS),x.push(C.wrapT),x.push(C.wrapR||0),x.push(C.magFilter),x.push(C.minFilter),x.push(C.anisotropy),x.push(C.internalFormat),x.push(C.format),x.push(C.type),x.push(C.generateMipmaps),x.push(C.premultiplyAlpha),x.push(C.flipY),x.push(C.unpackAlignment),x.push(C.colorSpace),x.join()}function Q(C,x){let F=i.get(C);if(C.isVideoTexture&&P(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&F.__version!==C.version){let X=C.image;if(X===null)Ut("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ut("WebGLRenderer: Texture marked for update but image is incomplete");else{Dt(F,C,x);return}}else C.isExternalTexture&&(F.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,F.__webglTexture,e.TEXTURE0+x)}function it(C,x){let F=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&F.__version!==C.version){Dt(F,C,x);return}else C.isExternalTexture&&(F.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,F.__webglTexture,e.TEXTURE0+x)}function ht(C,x){let F=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&F.__version!==C.version){Dt(F,C,x);return}n.bindTexture(e.TEXTURE_3D,F.__webglTexture,e.TEXTURE0+x)}function ft(C,x){let F=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&F.__version!==C.version){Lt(F,C,x);return}n.bindTexture(e.TEXTURE_CUBE_MAP,F.__webglTexture,e.TEXTURE0+x)}let bt={[Bh]:e.REPEAT,[Vi]:e.CLAMP_TO_EDGE,[Fh]:e.MIRRORED_REPEAT},kt={[rn]:e.NEAREST,[wS]:e.NEAREST_MIPMAP_NEAREST,[rc]:e.NEAREST_MIPMAP_LINEAR,[dn]:e.LINEAR,[Sf]:e.LINEAR_MIPMAP_NEAREST,[ya]:e.LINEAR_MIPMAP_LINEAR},ue={[DS]:e.NEVER,[OS]:e.ALWAYS,[NS]:e.LESS,[ad]:e.LEQUAL,[US]:e.EQUAL,[rd]:e.GEQUAL,[LS]:e.GREATER,[IS]:e.NOTEQUAL};function qt(C,x){if(x.type===Ti&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===dn||x.magFilter===Sf||x.magFilter===rc||x.magFilter===ya||x.minFilter===dn||x.minFilter===Sf||x.minFilter===rc||x.minFilter===ya)&&Ut("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,bt[x.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,bt[x.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,bt[x.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,kt[x.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,kt[x.minFilter]),x.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,ue[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===rn||x.minFilter!==rc&&x.minFilter!==ya||x.type===Ti&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){let F=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function tt(C,x){let F=!1;C.__webglInit===void 0&&(C.__webglInit=!0,x.addEventListener("dispose",w));let X=x.source,J=d.get(X);J===void 0&&(J={},d.set(X,J));let lt=V(x);if(lt!==C.__cacheKey){J[lt]===void 0&&(J[lt]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,F=!0),J[lt].usedTimes++;let pt=J[C.__cacheKey];pt!==void 0&&(J[C.__cacheKey].usedTimes--,pt.usedTimes===0&&R(x)),C.__cacheKey=lt,C.__webglTexture=J[lt].texture}return F}function mt(C,x,F){return Math.floor(Math.floor(C/F)/x)}function rt(C,x,F,X){let lt=C.updateRanges;if(lt.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,x.width,x.height,F,X,x.data);else{lt.sort((N,W)=>N.start-W.start);let pt=0;for(let N=1;N<lt.length;N++){let W=lt[pt],nt=lt[N],ot=W.start+W.count,ct=mt(nt.start,x.width,4),It=mt(W.start,x.width,4);nt.start<=ot+1&&ct===It&&mt(nt.start+nt.count-1,x.width,4)===ct?W.count=Math.max(W.count,nt.start+nt.count-W.start):(++pt,lt[pt]=nt)}lt.length=pt+1;let Z=n.getParameter(e.UNPACK_ROW_LENGTH),K=n.getParameter(e.UNPACK_SKIP_PIXELS),dt=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,x.width);for(let N=0,W=lt.length;N<W;N++){let nt=lt[N],ot=Math.floor(nt.start/4),ct=Math.ceil(nt.count/4),It=ot%x.width,I=Math.floor(ot/x.width),ut=ct,$=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,It),n.pixelStorei(e.UNPACK_SKIP_ROWS,I),n.texSubImage2D(e.TEXTURE_2D,0,It,I,ut,$,F,X,x.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,Z),n.pixelStorei(e.UNPACK_SKIP_PIXELS,K),n.pixelStorei(e.UNPACK_SKIP_ROWS,dt)}}function Dt(C,x,F){let X=e.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(X=e.TEXTURE_2D_ARRAY),x.isData3DTexture&&(X=e.TEXTURE_3D);let J=tt(C,x),lt=x.source;n.bindTexture(X,C.__webglTexture,e.TEXTURE0+F);let pt=i.get(lt);if(lt.version!==pt.__version||J===!0){if(n.activeTexture(e.TEXTURE0+F),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){let $=Qt.getPrimaries(Qt.workingColorSpace),gt=x.colorSpace===Ts?null:Qt.getPrimaries(x.colorSpace),_t=x.colorSpace===Ts||$===gt?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t)}n.pixelStorei(e.UNPACK_ALIGNMENT,x.unpackAlignment);let K=m(x.image,!1,s.maxTextureSize);K=pn(x,K);let dt=a.convert(x.format,x.colorSpace),N=a.convert(x.type),W=v(x.internalFormat,dt,N,x.normalized,x.colorSpace,x.isVideoTexture);qt(X,x);let nt,ot=x.mipmaps,ct=x.isVideoTexture!==!0,It=pt.__version===void 0||J===!0,I=lt.dataReady,ut=A(x,K);if(x.isDepthTexture)W=T(x.format===xa,x.type),It&&(ct?n.texStorage2D(e.TEXTURE_2D,1,W,K.width,K.height):n.texImage2D(e.TEXTURE_2D,0,W,K.width,K.height,0,dt,N,null));else if(x.isDataTexture)if(ot.length>0){ct&&It&&n.texStorage2D(e.TEXTURE_2D,ut,W,ot[0].width,ot[0].height);for(let $=0,gt=ot.length;$<gt;$++)nt=ot[$],ct?I&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,nt.width,nt.height,dt,N,nt.data):n.texImage2D(e.TEXTURE_2D,$,W,nt.width,nt.height,0,dt,N,nt.data);x.generateMipmaps=!1}else ct?(It&&n.texStorage2D(e.TEXTURE_2D,ut,W,K.width,K.height),I&&rt(x,K,dt,N)):n.texImage2D(e.TEXTURE_2D,0,W,K.width,K.height,0,dt,N,K.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){ct&&It&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ut,W,ot[0].width,ot[0].height,K.depth);for(let $=0,gt=ot.length;$<gt;$++)if(nt=ot[$],x.format!==mi)if(dt!==null)if(ct){if(I)if(x.layerUpdates.size>0){let _t=p0(nt.width,nt.height,x.format,x.type);for(let st of x.layerUpdates){let At=nt.data.subarray(st*_t/nt.data.BYTES_PER_ELEMENT,(st+1)*_t/nt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,st,nt.width,nt.height,1,dt,At)}x.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,0,nt.width,nt.height,K.depth,dt,nt.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,$,W,nt.width,nt.height,K.depth,0,nt.data,0,0);else Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ct?I&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,$,0,0,0,nt.width,nt.height,K.depth,dt,N,nt.data):n.texImage3D(e.TEXTURE_2D_ARRAY,$,W,nt.width,nt.height,K.depth,0,dt,N,nt.data)}else{ct&&It&&n.texStorage2D(e.TEXTURE_2D,ut,W,ot[0].width,ot[0].height);for(let $=0,gt=ot.length;$<gt;$++)nt=ot[$],x.format!==mi?dt!==null?ct?I&&n.compressedTexSubImage2D(e.TEXTURE_2D,$,0,0,nt.width,nt.height,dt,nt.data):n.compressedTexImage2D(e.TEXTURE_2D,$,W,nt.width,nt.height,0,nt.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ct?I&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,nt.width,nt.height,dt,N,nt.data):n.texImage2D(e.TEXTURE_2D,$,W,nt.width,nt.height,0,dt,N,nt.data)}else if(x.isDataArrayTexture)if(ct){if(It&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ut,W,K.width,K.height,K.depth),I)if(x.layerUpdates.size>0){let $=p0(K.width,K.height,x.format,x.type);for(let gt of x.layerUpdates){let _t=K.data.subarray(gt*$/K.data.BYTES_PER_ELEMENT,(gt+1)*$/K.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,gt,K.width,K.height,1,dt,N,_t)}x.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,dt,N,K.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,W,K.width,K.height,K.depth,0,dt,N,K.data);else if(x.isData3DTexture)ct?(It&&n.texStorage3D(e.TEXTURE_3D,ut,W,K.width,K.height,K.depth),I&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,dt,N,K.data)):n.texImage3D(e.TEXTURE_3D,0,W,K.width,K.height,K.depth,0,dt,N,K.data);else if(x.isFramebufferTexture){if(It)if(ct)n.texStorage2D(e.TEXTURE_2D,ut,W,K.width,K.height);else{let $=K.width,gt=K.height;for(let _t=0;_t<ut;_t++)n.texImage2D(e.TEXTURE_2D,_t,W,$,gt,0,dt,N,null),$>>=1,gt>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in e){let $=e.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),K.parentNode!==$){$.appendChild(K),p.add(x),$.onpaint=gt=>{let _t=gt.changedElements;for(let st of p)_t.includes(st.image)&&(st.needsUpdate=!0)},$.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,K);else{let _t=e.RGBA,st=e.RGBA,At=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,_t,st,At,K)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(ot.length>0){if(ct&&It){let $=ie(ot[0]);n.texStorage2D(e.TEXTURE_2D,ut,W,$.width,$.height)}for(let $=0,gt=ot.length;$<gt;$++)nt=ot[$],ct?I&&n.texSubImage2D(e.TEXTURE_2D,$,0,0,dt,N,nt):n.texImage2D(e.TEXTURE_2D,$,W,dt,N,nt);x.generateMipmaps=!1}else if(ct){if(It){let $=ie(K);n.texStorage2D(e.TEXTURE_2D,ut,W,$.width,$.height)}I&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,dt,N,K)}else n.texImage2D(e.TEXTURE_2D,0,W,dt,N,K);f(x)&&_(X),pt.__version=lt.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function Lt(C,x,F){if(x.image.length!==6)return;let X=tt(C,x),J=x.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+F);let lt=i.get(J);if(J.version!==lt.__version||X===!0){n.activeTexture(e.TEXTURE0+F);let pt=Qt.getPrimaries(Qt.workingColorSpace),Z=x.colorSpace===Ts?null:Qt.getPrimaries(x.colorSpace),K=x.colorSpace===Ts||pt===Z?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let dt=x.isCompressedTexture||x.image[0].isCompressedTexture,N=x.image[0]&&x.image[0].isDataTexture,W=[];for(let st=0;st<6;st++)!dt&&!N?W[st]=m(x.image[st],!0,s.maxCubemapSize):W[st]=N?x.image[st].image:x.image[st],W[st]=pn(x,W[st]);let nt=W[0],ot=a.convert(x.format,x.colorSpace),ct=a.convert(x.type),It=v(x.internalFormat,ot,ct,x.normalized,x.colorSpace),I=x.isVideoTexture!==!0,ut=lt.__version===void 0||X===!0,$=J.dataReady,gt=A(x,nt);qt(e.TEXTURE_CUBE_MAP,x);let _t;if(dt){I&&ut&&n.texStorage2D(e.TEXTURE_CUBE_MAP,gt,It,nt.width,nt.height);for(let st=0;st<6;st++){_t=W[st].mipmaps;for(let At=0;At<_t.length;At++){let Et=_t[At];x.format!==mi?ot!==null?I?$&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,0,0,Et.width,Et.height,ot,Et.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,It,Et.width,Et.height,0,Et.data):Ut("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,0,0,Et.width,Et.height,ot,ct,Et.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,It,Et.width,Et.height,0,ot,ct,Et.data)}}}else{if(_t=x.mipmaps,I&&ut){_t.length>0&&gt++;let st=ie(W[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,gt,It,st.width,st.height)}for(let st=0;st<6;st++)if(N){I?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,W[st].width,W[st].height,ot,ct,W[st].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,It,W[st].width,W[st].height,0,ot,ct,W[st].data);for(let At=0;At<_t.length;At++){let Pe=_t[At].image[st].image;I?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,0,0,Pe.width,Pe.height,ot,ct,Pe.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,It,Pe.width,Pe.height,0,ot,ct,Pe.data)}}else{I?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,ot,ct,W[st]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,It,ot,ct,W[st]);for(let At=0;At<_t.length;At++){let Et=_t[At];I?$&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,0,0,ot,ct,Et.image[st]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,It,ot,ct,Et.image[st])}}}f(x)&&_(e.TEXTURE_CUBE_MAP),lt.__version=J.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function Ct(C,x,F,X,J,lt){let pt=a.convert(F.format,F.colorSpace),Z=a.convert(F.type),K=v(F.internalFormat,pt,Z,F.normalized,F.colorSpace),dt=i.get(x),N=i.get(F);if(N.__renderTarget=x,!dt.__hasExternalTextures){let W=Math.max(1,x.width>>lt),nt=Math.max(1,x.height>>lt);J===e.TEXTURE_3D||J===e.TEXTURE_2D_ARRAY?n.texImage3D(J,lt,K,W,nt,x.depth,0,pt,Z,null):n.texImage2D(J,lt,K,W,nt,0,pt,Z,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),Oe(x)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,X,J,N.__webglTexture,0,Ce(x)):(J===e.TEXTURE_2D||J>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,X,J,N.__webglTexture,lt),n.bindFramebuffer(e.FRAMEBUFFER,null)}function we(C,x,F){if(e.bindRenderbuffer(e.RENDERBUFFER,C),x.depthBuffer){let X=x.depthTexture,J=X&&X.isDepthTexture?X.type:null,lt=T(x.stencilBuffer,J),pt=x.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Oe(x)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Ce(x),lt,x.width,x.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,Ce(x),lt,x.width,x.height):e.renderbufferStorage(e.RENDERBUFFER,lt,x.width,x.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,pt,e.RENDERBUFFER,C)}else{let X=x.textures;for(let J=0;J<X.length;J++){let lt=X[J],pt=a.convert(lt.format,lt.colorSpace),Z=a.convert(lt.type),K=v(lt.internalFormat,pt,Z,lt.normalized,lt.colorSpace);Oe(x)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Ce(x),K,x.width,x.height):F?e.renderbufferStorageMultisample(e.RENDERBUFFER,Ce(x),K,x.width,x.height):e.renderbufferStorage(e.RENDERBUFFER,K,x.width,x.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function zt(C,x,F){let X=x.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=i.get(x.depthTexture);if(J.__renderTarget=x,(!J.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),X){if(J.__webglInit===void 0&&(J.__webglInit=!0,x.depthTexture.addEventListener("dispose",w)),J.__webglTexture===void 0){J.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,J.__webglTexture),qt(e.TEXTURE_CUBE_MAP,x.depthTexture);let dt=a.convert(x.depthTexture.format),N=a.convert(x.depthTexture.type),W;x.depthTexture.format===Gi?W=e.DEPTH_COMPONENT24:x.depthTexture.format===xa&&(W=e.DEPTH24_STENCIL8);for(let nt=0;nt<6;nt++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+nt,0,W,x.width,x.height,0,dt,N,null)}}else Q(x.depthTexture,0);let lt=J.__webglTexture,pt=Ce(x),Z=X?e.TEXTURE_CUBE_MAP_POSITIVE_X+F:e.TEXTURE_2D,K=x.depthTexture.format===xa?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(x.depthTexture.format===Gi)Oe(x)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,K,Z,lt,0,pt):e.framebufferTexture2D(e.FRAMEBUFFER,K,Z,lt,0);else if(x.depthTexture.format===xa)Oe(x)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,K,Z,lt,0,pt):e.framebufferTexture2D(e.FRAMEBUFFER,K,Z,lt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function re(C){let x=i.get(C),F=C.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==C.depthTexture){let X=C.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),X){let J=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,X.removeEventListener("dispose",J)};X.addEventListener("dispose",J),x.__depthDisposeCallback=J}x.__boundDepthTexture=X}if(C.depthTexture&&!x.__autoAllocateDepthBuffer)if(F)for(let X=0;X<6;X++)zt(x.__webglFramebuffer[X],C,X);else{let X=C.texture.mipmaps;X&&X.length>0?zt(x.__webglFramebuffer[0],C,0):zt(x.__webglFramebuffer,C,0)}else if(F){x.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(n.bindFramebuffer(e.FRAMEBUFFER,x.__webglFramebuffer[X]),x.__webglDepthbuffer[X]===void 0)x.__webglDepthbuffer[X]=e.createRenderbuffer(),we(x.__webglDepthbuffer[X],C,!1);else{let J=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,lt=x.__webglDepthbuffer[X];e.bindRenderbuffer(e.RENDERBUFFER,lt),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,lt)}}else{let X=C.texture.mipmaps;if(X&&X.length>0?n.bindFramebuffer(e.FRAMEBUFFER,x.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=e.createRenderbuffer(),we(x.__webglDepthbuffer,C,!1);else{let J=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,lt=x.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,lt),e.framebufferRenderbuffer(e.FRAMEBUFFER,J,e.RENDERBUFFER,lt)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Vt(C,x,F){let X=i.get(C);x!==void 0&&Ct(X.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),F!==void 0&&re(C)}function Kt(C){let x=C.texture,F=i.get(C),X=i.get(x);C.addEventListener("dispose",y);let J=C.textures,lt=C.isWebGLCubeRenderTarget===!0,pt=J.length>1;if(pt||(X.__webglTexture===void 0&&(X.__webglTexture=e.createTexture()),X.__version=x.version,r.memory.textures++),lt){F.__webglFramebuffer=[];for(let Z=0;Z<6;Z++)if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer[Z]=[];for(let K=0;K<x.mipmaps.length;K++)F.__webglFramebuffer[Z][K]=e.createFramebuffer()}else F.__webglFramebuffer[Z]=e.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){F.__webglFramebuffer=[];for(let Z=0;Z<x.mipmaps.length;Z++)F.__webglFramebuffer[Z]=e.createFramebuffer()}else F.__webglFramebuffer=e.createFramebuffer();if(pt)for(let Z=0,K=J.length;Z<K;Z++){let dt=i.get(J[Z]);dt.__webglTexture===void 0&&(dt.__webglTexture=e.createTexture(),r.memory.textures++)}if(C.samples>0&&Oe(C)===!1){F.__webglMultisampledFramebuffer=e.createFramebuffer(),F.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let Z=0;Z<J.length;Z++){let K=J[Z];F.__webglColorRenderbuffer[Z]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,F.__webglColorRenderbuffer[Z]);let dt=a.convert(K.format,K.colorSpace),N=a.convert(K.type),W=v(K.internalFormat,dt,N,K.normalized,K.colorSpace,C.isXRRenderTarget===!0),nt=Ce(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,nt,W,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Z,e.RENDERBUFFER,F.__webglColorRenderbuffer[Z])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(F.__webglDepthRenderbuffer=e.createRenderbuffer(),we(F.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(lt){n.bindTexture(e.TEXTURE_CUBE_MAP,X.__webglTexture),qt(e.TEXTURE_CUBE_MAP,x);for(let Z=0;Z<6;Z++)if(x.mipmaps&&x.mipmaps.length>0)for(let K=0;K<x.mipmaps.length;K++)Ct(F.__webglFramebuffer[Z][K],C,x,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,K);else Ct(F.__webglFramebuffer[Z],C,x,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0);f(x)&&_(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(pt){for(let Z=0,K=J.length;Z<K;Z++){let dt=J[Z],N=i.get(dt),W=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(W=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(W,N.__webglTexture),qt(W,dt),Ct(F.__webglFramebuffer,C,dt,e.COLOR_ATTACHMENT0+Z,W,0),f(dt)&&_(W)}n.unbindTexture()}else{let Z=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Z=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(Z,X.__webglTexture),qt(Z,x),x.mipmaps&&x.mipmaps.length>0)for(let K=0;K<x.mipmaps.length;K++)Ct(F.__webglFramebuffer[K],C,x,e.COLOR_ATTACHMENT0,Z,K);else Ct(F.__webglFramebuffer,C,x,e.COLOR_ATTACHMENT0,Z,0);f(x)&&_(Z),n.unbindTexture()}C.depthBuffer&&re(C)}function be(C){let x=C.textures;for(let F=0,X=x.length;F<X;F++){let J=x[F];if(f(J)){let lt=b(C),pt=i.get(J).__webglTexture;n.bindTexture(lt,pt),_(lt),n.unbindTexture()}}}let Ne=[],Ue=[];function Ve(C){if(C.samples>0){if(Oe(C)===!1){let x=C.textures,F=C.width,X=C.height,J=e.COLOR_BUFFER_BIT,lt=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,pt=i.get(C),Z=x.length>1;if(Z)for(let dt=0;dt<x.length;dt++)n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,pt.__webglMultisampledFramebuffer);let K=C.texture.mipmaps;K&&K.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,pt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,pt.__webglFramebuffer);for(let dt=0;dt<x.length;dt++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(J|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(J|=e.STENCIL_BUFFER_BIT)),Z){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,pt.__webglColorRenderbuffer[dt]);let N=i.get(x[dt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,N,0)}e.blitFramebuffer(0,0,F,X,0,0,F,X,J,e.NEAREST),l===!0&&(Ne.length=0,Ue.length=0,Ne.push(e.COLOR_ATTACHMENT0+dt),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Ne.push(lt),Ue.push(lt),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Ue)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Ne))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),Z)for(let dt=0;dt<x.length;dt++){n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.RENDERBUFFER,pt.__webglColorRenderbuffer[dt]);let N=i.get(x[dt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,pt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+dt,e.TEXTURE_2D,N,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,pt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){let x=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[x])}}}function Ce(C){return Math.min(s.maxSamples,C.samples)}function Oe(C){let x=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function P(C){let x=r.render.frame;h.get(C)!==x&&(h.set(C,x),C.update())}function pn(C,x){let F=C.colorSpace,X=C.format,J=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||F!==Ol&&F!==Ts&&(Qt.getTransfer(F)===oe?(X!==mi||J!==$n)&&Ut("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ot("WebGLTextures: Unsupported texture color space:",F)),x}function ie(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=z,this.getTextureUnits=q,this.setTextureUnits=O,this.setTexture2D=Q,this.setTexture2DArray=it,this.setTexture3D=ht,this.setTextureCube=ft,this.rebindTextures=Vt,this.setupRenderTarget=Kt,this.updateRenderTargetMipmap=be,this.updateMultisampleRenderTarget=Ve,this.setupDepthRenderbuffer=re,this.setupFrameBufferTexture=Ct,this.useMultisampledRTT=Oe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Q3(e,t){function n(i,s=Ts){let a,r=Qt.getTransfer(s);if(i===$n)return e.UNSIGNED_BYTE;if(i===Ef)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Tf)return e.UNSIGNED_SHORT_5_5_5_1;if(i===n0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===i0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===t0)return e.BYTE;if(i===e0)return e.SHORT;if(i===yo)return e.UNSIGNED_SHORT;if(i===Mf)return e.INT;if(i===Ei)return e.UNSIGNED_INT;if(i===Ti)return e.FLOAT;if(i===Yi)return e.HALF_FLOAT;if(i===s0)return e.ALPHA;if(i===a0)return e.RGB;if(i===mi)return e.RGBA;if(i===Gi)return e.DEPTH_COMPONENT;if(i===xa)return e.DEPTH_STENCIL;if(i===r0)return e.RED;if(i===Af)return e.RED_INTEGER;if(i===ba)return e.RG;if(i===wf)return e.RG_INTEGER;if(i===Cf)return e.RGBA_INTEGER;if(i===oc||i===lc||i===cc||i===uc)if(r===oe)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===oc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===cc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===uc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===oc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===lc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===cc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===uc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Rf||i===Df||i===Nf||i===Uf)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Rf)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Df)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Nf)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Uf)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Lf||i===If||i===Of||i===Pf||i===zf||i===hc||i===Bf)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Lf||i===If)return r===oe?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Of)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Pf)return a.COMPRESSED_R11_EAC;if(i===zf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===hc)return a.COMPRESSED_RG11_EAC;if(i===Bf)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ff||i===Vf||i===Hf||i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Ff)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Vf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Hf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Gf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===kf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Xf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Wf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===qf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Yf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Zf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Jf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Kf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===jf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Qf)return r===oe?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===$f||i===td||i===ed)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===$f)return r===oe?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===td)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===ed)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===nd||i===id||i===fc||i===sd)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===nd)return a.COMPRESSED_RED_RGTC1_EXT;if(i===id)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===fc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===sd)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===xo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var $3=`
void main() {
