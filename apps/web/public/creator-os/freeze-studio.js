...
}`,Q2=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],$2=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],gM=new Oe,yc=new L,M0=new L;function t3(e,t,n){let i=new Kl,s=new Lt,a=new Lt,r=new Pe,o=new lf,c=new cf,l={},h=n.maxTextureSize,d={[Ts]:Cn,[Cn]:Ts,[ni]:ni},u=new ti({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Lt},radius:{value:4}},vertexShader:K2,fragmentShader:j2}),p=u.clone();p.defines.HORIZONTAL_PASS=1;let m=new Ve;m.setAttribute("position",new jn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let S=new je(m,u),v=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=lc;let f=this.type;this.render=function(A,w,x){if(v.enabled===!1||v.autoUpdate===!1&&v.needsUpdate===!1||A.length===0)return;this.type===fS&&(It("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=lc);let M=e.getRenderTarget(),R=e.getActiveCubeFace(),D=e.getActiveMipmapLevel(),I=e.state;I.setBlending(Zi),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let q=f!==this.type;q&&w.traverse(function(J){J.material&&(Array.isArray(J.material)?J.material.forEach(z=>z.needsUpdate=!0):J.material.needsUpdate=!0)});for(let J=0,z=A.length;J<z;J++){let B=A[J],V=B.shadow;if(V===void 0){It("WebGLShadowMap:",B,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let j=V.getFrameExtents();s.multiply(j),a.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/j.x),s.x=a.x*j.x,V.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/j.y),s.y=a.y*j.y,V.mapSize.y=a.y));let rt=e.state.buffers.depth.getReversed();if(V.camera._reversedDepth=rt,V.map===null||q===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===So){if(B.isPointLight){It("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new Qn(s.x,s.y,{format:Sa,type:Ji,minFilter:mn,magFilter:mn,generateMipmaps:!1}),V.map.texture.name=B.name+".shadowMap",V.map.depthTexture=new As(s.x,s.y,Ri),V.map.depthTexture.name=B.name+".shadowMapDepth",V.map.depthTexture.format=ki,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=cn,V.map.depthTexture.magFilter=cn}else B.isPointLight?(V.map=new dd(s.x),V.map.depthTexture=new jh(s.x,Ci)):(V.map=new Qn(s.x,s.y),V.map.depthTexture=new As(s.x,s.y,Ci)),V.map.depthTexture.name=B.name+".shadowMap",V.map.depthTexture.format=ki,this.type===lc?(V.map.depthTexture.compareFunction=rt?cd:ld,V.map.depthTexture.minFilter=mn,V.map.depthTexture.magFilter=mn):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=cn,V.map.depthTexture.magFilter=cn);V.camera.updateProjectionMatrix()}let ct=V.map.isWebGLCubeRenderTarget?6:1;for(let lt=0;lt<ct;lt++){if(V.map.isWebGLCubeRenderTarget)e.setRenderTarget(V.map,lt),e.clear();else{lt===0&&(e.setRenderTarget(V.map),e.clear());let at=V.getViewport(lt);r.set(a.x*at.x,a.y*at.y,a.x*at.z,a.y*at.w),I.viewport(r)}if(B.isPointLight){let at=V.camera,Ut=V.matrix,Jt=B.distance||at.far;Jt!==at.far&&(at.far=Jt,at.updateProjectionMatrix()),yc.setFromMatrixPosition(B.matrixWorld),at.position.copy(yc),M0.copy(at.position),M0.add(Q2[lt]),at.up.copy($2[lt]),at.lookAt(M0),at.updateMatrixWorld(),Ut.makeTranslation(-yc.x,-yc.y,-yc.z),gM.multiplyMatrices(at.projectionMatrix,at.matrixWorldInverse),V._frustum.setFromProjectionMatrix(gM,at.coordinateSystem,at.reversedDepth)}else V.updateMatrices(B);i=V.getFrustum(),_(w,x,V.camera,B,this.type)}V.isPointLightShadow!==!0&&this.type===So&&g(V,x),V.needsUpdate=!1}f=this.type,v.needsUpdate=!1,e.setRenderTarget(M,R,D)};function g(A,w){let x=t.update(S);u.defines.VSM_SAMPLES!==A.blurSamples&&(u.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Qn(s.x,s.y,{format:Sa,type:Ji})),u.uniforms.shadow_pass.value=A.map.depthTexture,u.uniforms.resolution.value=A.mapSize,u.uniforms.radius.value=A.radius,e.setRenderTarget(A.mapPass),e.clear(),e.renderBufferDirect(w,null,x,u,S,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,e.setRenderTarget(A.map),e.clear(),e.renderBufferDirect(w,null,x,p,S,null)}function y(A,w,x,M){let R=null,D=x.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)R=D;else if(R=x.isPointLight===!0?c:o,e.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let I=R.uuid,q=w.uuid,J=l[I];J===void 0&&(J={},l[I]=J);let z=J[q];z===void 0&&(z=R.clone(),J[q]=z,w.addEventListener("dispose",T)),R=z}if(R.visible=w.visible,R.wireframe=w.wireframe,M===So?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:d[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let I=e.properties.get(R);I.light=x}return R}function _(A,w,x,M,R){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&R===So)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,A.matrixWorld);let q=t.update(A),J=A.material;if(Array.isArray(J)){let z=q.groups;for(let B=0,V=z.length;B<V;B++){let j=z[B],rt=J[j.materialIndex];if(rt&&rt.visible){let ct=y(A,rt,M,R);A.onBeforeShadow(e,A,w,x,q,ct,j),e.renderBufferDirect(x,null,q,ct,A,j),A.onAfterShadow(e,A,w,x,q,ct,j)}}}else if(J.visible){let z=y(A,J,M,R);A.onBeforeShadow(e,A,w,x,q,z,null),e.renderBufferDirect(x,null,q,z,A,null),A.onAfterShadow(e,A,w,x,q,z,null)}}let I=A.children;for(let q=0,J=I.length;q<J;q++)_(I[q],w,x,M,R)}function T(A){A.target.removeEventListener("dispose",T);for(let x in l){let M=l[x],R=A.target.uuid;R in M&&(M[R].dispose(),delete M[R])}}}function e3(e,t){function n(){let O=!1,N=new Pe,U=null,st=new Pe(0,0,0,0);return{setMask:function($){U!==$&&!O&&(e.colorMask($,$,$,$),U=$)},setLocked:function($){O=$},setClear:function($,Z,ut,mt,kt){kt===!0&&($*=mt,Z*=mt,ut*=mt),N.set($,Z,ut,mt),st.equals(N)===!1&&(e.clearColor($,Z,ut,mt),st.copy(N))},reset:function(){O=!1,U=null,st.set(-1,0,0,0)}}}function i(){let O=!1,N=!1,U=null,st=null,$=null;return{setReversed:function(Z){if(N!==Z){let ut=t.get("EXT_clip_control");Z?ut.clipControlEXT(ut.LOWER_LEFT_EXT,ut.ZERO_TO_ONE_EXT):ut.clipControlEXT(ut.LOWER_LEFT_EXT,ut.NEGATIVE_ONE_TO_ONE_EXT),N=Z;let mt=$;$=null,this.setClear(mt)}},getReversed:function(){return N},setTest:function(Z){Z?ot(e.DEPTH_TEST):ft(e.DEPTH_TEST)},setMask:function(Z){U!==Z&&!O&&(e.depthMask(Z),U=Z)},setFunc:function(Z){if(N&&(Z=WS[Z]),st!==Z){switch(Z){case Ih:e.depthFunc(e.NEVER);break;case Oh:e.depthFunc(e.ALWAYS);break;case Ph:e.depthFunc(e.LESS);break;case $a:e.depthFunc(e.LEQUAL);break;case zh:e.depthFunc(e.EQUAL);break;case Bh:e.depthFunc(e.GEQUAL);break;case Fh:e.depthFunc(e.GREATER);break;case Vh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}st=Z}},setLocked:function(Z){O=Z},setClear:function(Z){$!==Z&&($=Z,N&&(Z=1-Z),e.clearDepth(Z))},reset:function(){O=!1,U=null,st=null,$=null,N=!1}}}function s(){let O=!1,N=null,U=null,st=null,$=null,Z=null,ut=null,mt=null,kt=null;return{setTest:function(se){O||(se?ot(e.STENCIL_TEST):ft(e.STENCIL_TEST))},setMask:function(se){N!==se&&!O&&(e.stencilMask(se),N=se)},setFunc:function(se,Mn,zn){(U!==se||st!==Mn||$!==zn)&&(e.stencilFunc(se,Mn,zn),U=se,st=Mn,$=zn)},setOp:function(se,Mn,zn){(Z!==se||ut!==Mn||mt!==zn)&&(e.stencilOp(se,Mn,zn),Z=se,ut=Mn,mt=zn)},setLocked:function(se){O=se},setClear:function(se){kt!==se&&(e.clearStencil(se),kt=se)},reset:function(){O=!1,N=null,U=null,st=null,$=null,Z=null,ut=null,mt=null,kt=null}}}let a=new n,r=new i,o=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},p=new WeakMap,m=[],S=null,v=!1,f=null,g=null,y=null,_=null,T=null,A=null,w=null,x=new te(0,0,0),M=0,R=!1,D=null,I=null,q=null,J=null,z=null,B=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,j=0,rt=e.getParameter(e.VERSION);rt.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(rt)[1]),V=j>=1):rt.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(rt)[1]),V=j>=2);let ct=null,lt={},at=e.getParameter(e.SCISSOR_BOX),Ut=e.getParameter(e.VIEWPORT),Jt=new Pe().fromArray(at),Xt=new Pe().fromArray(Ut);function K(O,N,U,st){let $=new Uint8Array(4),Z=e.createTexture();e.bindTexture(O,Z),e.texParameteri(O,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(O,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let ut=0;ut<U;ut++)O===e.TEXTURE_3D||O===e.TEXTURE_2D_ARRAY?e.texImage3D(N,0,e.RGBA,1,1,st,0,e.RGBA,e.UNSIGNED_BYTE,$):e.texImage2D(N+ut,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,$);return Z}let ht={};ht[e.TEXTURE_2D]=K(e.TEXTURE_2D,e.TEXTURE_2D,1),ht[e.TEXTURE_CUBE_MAP]=K(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),ht[e.TEXTURE_2D_ARRAY]=K(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),ht[e.TEXTURE_3D]=K(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ot(e.DEPTH_TEST),r.setFunc($a),ge(!1),Ne(Xg),ot(e.CULL_FACE),Ht(Zi);function ot(O){h[O]!==!0&&(e.enable(O),h[O]=!0)}function ft(O){h[O]!==!1&&(e.disable(O),h[O]=!1)}function St(O,N){return u[O]!==N?(e.bindFramebuffer(O,N),u[O]=N,O===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=N),O===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=N),!0):!1}function Tt(O,N){let U=m,st=!1;if(O){U=p.get(N),U===void 0&&(U=[],p.set(N,U));let $=O.textures;if(U.length!==$.length||U[0]!==e.COLOR_ATTACHMENT0){for(let Z=0,ut=$.length;Z<ut;Z++)U[Z]=e.COLOR_ATTACHMENT0+Z;U.length=$.length,st=!0}}else U[0]!==e.BACK&&(U[0]=e.BACK,st=!0);st&&e.drawBuffers(U)}function re(O){return S!==O?(e.useProgram(O),S=O,!0):!1}let Pt={[ha]:e.FUNC_ADD,[pS]:e.FUNC_SUBTRACT,[mS]:e.FUNC_REVERSE_SUBTRACT};Pt[gS]=e.MIN,Pt[vS]=e.MAX;let Vt={[_S]:e.ZERO,[yS]:e.ONE,[xS]:e.SRC_COLOR,[Uh]:e.SRC_ALPHA,[AS]:e.SRC_ALPHA_SATURATE,[ES]:e.DST_COLOR,[SS]:e.DST_ALPHA,[bS]:e.ONE_MINUS_SRC_COLOR,[Lh]:e.ONE_MINUS_SRC_ALPHA,[TS]:e.ONE_MINUS_DST_COLOR,[MS]:e.ONE_MINUS_DST_ALPHA,[wS]:e.CONSTANT_COLOR,[CS]:e.ONE_MINUS_CONSTANT_COLOR,[RS]:e.CONSTANT_ALPHA,[DS]:e.ONE_MINUS_CONSTANT_ALPHA};function Ht(O,N,U,st,$,Z,ut,mt,kt,se){if(O===Zi){v===!0&&(ft(e.BLEND),v=!1);return}if(v===!1&&(ot(e.BLEND),v=!0),O!==dS){if(O!==f||se!==R){if((g!==ha||T!==ha)&&(e.blendEquation(e.FUNC_ADD),g=ha,T=ha),se)switch(O){case Qa:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Wg:e.blendFunc(e.ONE,e.ONE);break;case qg:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case Yg:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:zt("WebGLState: Invalid blending: ",O);break}else switch(O){case Qa:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Wg:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case qg:zt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Yg:zt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:zt("WebGLState: Invalid blending: ",O);break}y=null,_=null,A=null,w=null,x.set(0,0,0),M=0,f=O,R=se}return}$=$||N,Z=Z||U,ut=ut||st,(N!==g||$!==T)&&(e.blendEquationSeparate(Pt[N],Pt[$]),g=N,T=$),(U!==y||st!==_||Z!==A||ut!==w)&&(e.blendFuncSeparate(Vt[U],Vt[st],Vt[Z],Vt[ut]),y=U,_=st,A=Z,w=ut),(mt.equals(x)===!1||kt!==M)&&(e.blendColor(mt.r,mt.g,mt.b,kt),x.copy(mt),M=kt),f=O,R=!1}function Ft(O,N){O.side===ni?ft(e.CULL_FACE):ot(e.CULL_FACE);let U=O.side===Cn;N&&(U=!U),ge(U),O.blending===Qa&&O.transparent===!1?Ht(Zi):Ht(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),r.setFunc(O.depthFunc),r.setTest(O.depthTest),r.setMask(O.depthWrite),a.setMask(O.colorWrite);let st=O.stencilWrite;o.setTest(st),st&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),We(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?ot(e.SAMPLE_ALPHA_TO_COVERAGE):ft(e.SAMPLE_ALPHA_TO_COVERAGE)}function ge(O){D!==O&&(O?e.frontFace(e.CW):e.frontFace(e.CCW),D=O)}function Ne(O){O!==uS?(ot(e.CULL_FACE),O!==I&&(O===Xg?e.cullFace(e.BACK):O===hS?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):ft(e.CULL_FACE),I=O}function ue(O){O!==q&&(V&&e.lineWidth(O),q=O)}function We(O,N,U){O?(ot(e.POLYGON_OFFSET_FILL),(J!==N||z!==U)&&(J=N,z=U,r.getReversed()&&(N=-N),e.polygonOffset(N,U))):ft(e.POLYGON_OFFSET_FILL)}function le(O){O?ot(e.SCISSOR_TEST):ft(e.SCISSOR_TEST)}function Ie(O){O===void 0&&(O=e.TEXTURE0+B-1),ct!==O&&(e.activeTexture(O),ct=O)}function P(O,N,U){U===void 0&&(ct===null?U=e.TEXTURE0+B-1:U=ct);let st=lt[U];st===void 0&&(st={type:void 0,texture:void 0},lt[U]=st),(st.type!==O||st.texture!==N)&&(ct!==U&&(e.activeTexture(U),ct=U),e.bindTexture(O,N||ht[O]),st.type=O,st.texture=N)}function sn(){let O=lt[ct];O!==void 0&&O.type!==void 0&&(e.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function oe(){try{e.compressedTexImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function C(){try{e.compressedTexImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function b(){try{e.texSubImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function H(){try{e.texSubImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function Q(){try{e.compressedTexSubImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function dt(){try{e.texStorage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function gt(){try{e.texStorage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function tt(){try{e.texImage2D(...arguments)}catch(O){zt("WebGLState:",O)}}function et(){try{e.texImage3D(...arguments)}catch(O){zt("WebGLState:",O)}}function vt(O){return d[O]!==void 0?d[O]:e.getParameter(O)}function At(O,N){d[O]!==N&&(e.pixelStorei(O,N),d[O]=N)}function _t(O){Jt.equals(O)===!1&&(e.scissor(O.x,O.y,O.z,O.w),Jt.copy(O))}function pt(O){Xt.equals(O)===!1&&(e.viewport(O.x,O.y,O.z,O.w),Xt.copy(O))}function Rt(O,N){let U=l.get(N);U===void 0&&(U=new WeakMap,l.set(N,U));let st=U.get(O);st===void 0&&(st=e.getUniformBlockIndex(N,O.name),U.set(O,st))}function wt(O,N){let st=l.get(N).get(O);c.get(N)!==st&&(e.uniformBlockBinding(N,st,O.__bindingPointIndex),c.set(N,st))}function Ot(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),e.pixelStorei(e.PACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_ALIGNMENT,4),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!1),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,e.BROWSER_DEFAULT_WEBGL),e.pixelStorei(e.PACK_ROW_LENGTH,0),e.pixelStorei(e.PACK_SKIP_PIXELS,0),e.pixelStorei(e.PACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_ROW_LENGTH,0),e.pixelStorei(e.UNPACK_IMAGE_HEIGHT,0),e.pixelStorei(e.UNPACK_SKIP_PIXELS,0),e.pixelStorei(e.UNPACK_SKIP_ROWS,0),e.pixelStorei(e.UNPACK_SKIP_IMAGES,0),h={},d={},ct=null,lt={},u={},p=new WeakMap,m=[],S=null,v=!1,f=null,g=null,y=null,_=null,T=null,A=null,w=null,x=new te(0,0,0),M=0,R=!1,D=null,I=null,q=null,J=null,z=null,Jt.set(0,0,e.canvas.width,e.canvas.height),Xt.set(0,0,e.canvas.width,e.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:ot,disable:ft,bindFramebuffer:St,drawBuffers:Tt,useProgram:re,setBlending:Ht,setMaterial:Ft,setFlipSided:ge,setCullFace:Ne,setLineWidth:ue,setPolygonOffset:We,setScissorTest:le,activeTexture:Ie,bindTexture:P,unbindTexture:sn,compressedTexImage2D:oe,compressedTexImage3D:C,texImage2D:tt,texImage3D:et,pixelStorei:At,getParameter:vt,updateUBOMapping:Rt,uniformBlockBinding:wt,texStorage2D:dt,texStorage3D:gt,texSubImage2D:b,texSubImage3D:H,compressedTexSubImage2D:X,compressedTexSubImage3D:Q,scissor:_t,viewport:pt,reset:Ot}}function n3(e,t,n,i,s,a,r){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Lt,h=new WeakMap,d=new Set,u,p=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(C,b){return m?new OffscreenCanvas(C,b):Gl("canvas")}function v(C,b,H){let X=1,Q=oe(C);if((Q.width>H||Q.height>H)&&(X=H/Math.max(Q.width,Q.height)),X<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){let dt=Math.floor(X*Q.width),gt=Math.floor(X*Q.height);u===void 0&&(u=S(dt,gt));let tt=b?S(dt,gt):u;return tt.width=dt,tt.height=gt,tt.getContext("2d").drawImage(C,0,0,dt,gt),It("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+dt+"x"+gt+")."),tt}else return"data"in C&&It("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),C;return C}function f(C){return C.generateMipmaps}function g(C){e.generateMipmap(C)}function y(C){return C.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?e.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function _(C,b,H,X,Q,dt=!1){if(C!==null){if(e[C]!==void 0)return e[C];It("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let gt;X&&(gt=t.get("EXT_texture_norm16"),gt||It("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let tt=b;if(b===e.RED&&(H===e.FLOAT&&(tt=e.R32F),H===e.HALF_FLOAT&&(tt=e.R16F),H===e.UNSIGNED_BYTE&&(tt=e.R8),H===e.UNSIGNED_SHORT&&gt&&(tt=gt.R16_EXT),H===e.SHORT&&gt&&(tt=gt.R16_SNORM_EXT)),b===e.RED_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.R8UI),H===e.UNSIGNED_SHORT&&(tt=e.R16UI),H===e.UNSIGNED_INT&&(tt=e.R32UI),H===e.BYTE&&(tt=e.R8I),H===e.SHORT&&(tt=e.R16I),H===e.INT&&(tt=e.R32I)),b===e.RG&&(H===e.FLOAT&&(tt=e.RG32F),H===e.HALF_FLOAT&&(tt=e.RG16F),H===e.UNSIGNED_BYTE&&(tt=e.RG8),H===e.UNSIGNED_SHORT&&gt&&(tt=gt.RG16_EXT),H===e.SHORT&&gt&&(tt=gt.RG16_SNORM_EXT)),b===e.RG_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.RG8UI),H===e.UNSIGNED_SHORT&&(tt=e.RG16UI),H===e.UNSIGNED_INT&&(tt=e.RG32UI),H===e.BYTE&&(tt=e.RG8I),H===e.SHORT&&(tt=e.RG16I),H===e.INT&&(tt=e.RG32I)),b===e.RGB_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.RGB8UI),H===e.UNSIGNED_SHORT&&(tt=e.RGB16UI),H===e.UNSIGNED_INT&&(tt=e.RGB32UI),H===e.BYTE&&(tt=e.RGB8I),H===e.SHORT&&(tt=e.RGB16I),H===e.INT&&(tt=e.RGB32I)),b===e.RGBA_INTEGER&&(H===e.UNSIGNED_BYTE&&(tt=e.RGBA8UI),H===e.UNSIGNED_SHORT&&(tt=e.RGBA16UI),H===e.UNSIGNED_INT&&(tt=e.RGBA32UI),H===e.BYTE&&(tt=e.RGBA8I),H===e.SHORT&&(tt=e.RGBA16I),H===e.INT&&(tt=e.RGBA32I)),b===e.RGB&&(H===e.UNSIGNED_SHORT&&gt&&(tt=gt.RGB16_EXT),H===e.SHORT&&gt&&(tt=gt.RGB16_SNORM_EXT),H===e.UNSIGNED_INT_5_9_9_9_REV&&(tt=e.RGB9_E5),H===e.UNSIGNED_INT_10F_11F_11F_REV&&(tt=e.R11F_G11F_B10F)),b===e.RGBA){let et=dt?Vl:ne.getTransfer(Q);H===e.FLOAT&&(tt=e.RGBA32F),H===e.HALF_FLOAT&&(tt=e.RGBA16F),H===e.UNSIGNED_BYTE&&(tt=et===de?e.SRGB8_ALPHA8:e.RGBA8),H===e.UNSIGNED_SHORT&&gt&&(tt=gt.RGBA16_EXT),H===e.SHORT&&gt&&(tt=gt.RGBA16_SNORM_EXT),H===e.UNSIGNED_SHORT_4_4_4_4&&(tt=e.RGBA4),H===e.UNSIGNED_SHORT_5_5_5_1&&(tt=e.RGB5_A1)}return(tt===e.R16F||tt===e.R32F||tt===e.RG16F||tt===e.RG32F||tt===e.RGBA16F||tt===e.RGBA32F)&&t.get("EXT_color_buffer_float"),tt}function T(C,b){let H;return C?b===null||b===Ci||b===Eo?H=e.DEPTH24_STENCIL8:b===Ri?H=e.DEPTH32F_STENCIL8:b===Mo&&(H=e.DEPTH24_STENCIL8,It("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===Ci||b===Eo?H=e.DEPTH_COMPONENT24:b===Ri?H=e.DEPTH_COMPONENT32F:b===Mo&&(H=e.DEPTH_COMPONENT16),H}function A(C,b){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==cn&&C.minFilter!==mn?Math.log2(Math.max(b.width,b.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?b.mipmaps.length:1}function w(C){let b=C.target;b.removeEventListener("dispose",w),M(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&d.delete(b)}function x(C){let b=C.target;b.removeEventListener("dispose",x),D(b)}function M(C){let b=i.get(C);if(b.__webglInit===void 0)return;let H=C.source,X=p.get(H);if(X){let Q=X[b.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&R(C),Object.keys(X).length===0&&p.delete(H)}i.remove(C)}function R(C){let b=i.get(C);e.deleteTexture(b.__webglTexture);let H=C.source,X=p.get(H);delete X[b.__cacheKey],r.memory.textures--}function D(C){let b=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(b.__webglFramebuffer[X]))for(let Q=0;Q<b.__webglFramebuffer[X].length;Q++)e.deleteFramebuffer(b.__webglFramebuffer[X][Q]);else e.deleteFramebuffer(b.__webglFramebuffer[X]);b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer[X])}else{if(Array.isArray(b.__webglFramebuffer))for(let X=0;X<b.__webglFramebuffer.length;X++)e.deleteFramebuffer(b.__webglFramebuffer[X]);else e.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&e.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&e.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let X=0;X<b.__webglColorRenderbuffer.length;X++)b.__webglColorRenderbuffer[X]&&e.deleteRenderbuffer(b.__webglColorRenderbuffer[X]);b.__webglDepthRenderbuffer&&e.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let H=C.textures;for(let X=0,Q=H.length;X<Q;X++){let dt=i.get(H[X]);dt.__webglTexture&&(e.deleteTexture(dt.__webglTexture),r.memory.textures--),i.remove(H[X])}i.remove(C)}let I=0;function q(){I=0}function J(){return I}function z(C){I=C}function B(){let C=I;return C>=s.maxTextures&&It("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),I+=1,C}function V(C){let b=[];return b.push(C.wrapS),b.push(C.wrapT),b.push(C.wrapR||0),b.push(C.magFilter),b.push(C.minFilter),b.push(C.anisotropy),b.push(C.internalFormat),b.push(C.format),b.push(C.type),b.push(C.generateMipmaps),b.push(C.premultiplyAlpha),b.push(C.flipY),b.push(C.unpackAlignment),b.push(C.colorSpace),b.join()}function j(C,b){let H=i.get(C);if(C.isVideoTexture&&P(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&H.__version!==C.version){let X=C.image;if(X===null)It("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)It("WebGLRenderer: Texture marked for update but image is incomplete");else{ft(H,C,b);return}}else C.isExternalTexture&&(H.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,H.__webglTexture,e.TEXTURE0+b)}function rt(C,b){let H=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&H.__version!==C.version){ft(H,C,b);return}else C.isExternalTexture&&(H.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,H.__webglTexture,e.TEXTURE0+b)}function ct(C,b){let H=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&H.__version!==C.version){ft(H,C,b);return}n.bindTexture(e.TEXTURE_3D,H.__webglTexture,e.TEXTURE0+b)}function lt(C,b){let H=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&H.__version!==C.version){St(H,C,b);return}n.bindTexture(e.TEXTURE_CUBE_MAP,H.__webglTexture,e.TEXTURE0+b)}let at={[Hh]:e.REPEAT,[Hi]:e.CLAMP_TO_EDGE,[Gh]:e.MIRRORED_REPEAT},Ut={[cn]:e.NEAREST,[LS]:e.NEAREST_MIPMAP_NEAREST,[uc]:e.NEAREST_MIPMAP_LINEAR,[mn]:e.LINEAR,[Tf]:e.LINEAR_MIPMAP_NEAREST,[xa]:e.LINEAR_MIPMAP_LINEAR},Jt={[PS]:e.NEVER,[HS]:e.ALWAYS,[zS]:e.LESS,[ld]:e.LEQUAL,[BS]:e.EQUAL,[cd]:e.GEQUAL,[FS]:e.GREATER,[VS]:e.NOTEQUAL};function Xt(C,b){if(b.type===Ri&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===mn||b.magFilter===Tf||b.magFilter===uc||b.magFilter===xa||b.minFilter===mn||b.minFilter===Tf||b.minFilter===uc||b.minFilter===xa)&&It("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(C,e.TEXTURE_WRAP_S,at[b.wrapS]),e.texParameteri(C,e.TEXTURE_WRAP_T,at[b.wrapT]),(C===e.TEXTURE_3D||C===e.TEXTURE_2D_ARRAY)&&e.texParameteri(C,e.TEXTURE_WRAP_R,at[b.wrapR]),e.texParameteri(C,e.TEXTURE_MAG_FILTER,Ut[b.magFilter]),e.texParameteri(C,e.TEXTURE_MIN_FILTER,Ut[b.minFilter]),b.compareFunction&&(e.texParameteri(C,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(C,e.TEXTURE_COMPARE_FUNC,Jt[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===cn||b.minFilter!==uc&&b.minFilter!==xa||b.type===Ri&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let H=t.get("EXT_texture_filter_anisotropic");e.texParameterf(C,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function K(C,b){let H=!1;C.__webglInit===void 0&&(C.__webglInit=!0,b.addEventListener("dispose",w));let X=b.source,Q=p.get(X);Q===void 0&&(Q={},p.set(X,Q));let dt=V(b);if(dt!==C.__cacheKey){Q[dt]===void 0&&(Q[dt]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,H=!0),Q[dt].usedTimes++;let gt=Q[C.__cacheKey];gt!==void 0&&(Q[C.__cacheKey].usedTimes--,gt.usedTimes===0&&R(b)),C.__cacheKey=dt,C.__webglTexture=Q[dt].texture}return H}function ht(C,b,H){return Math.floor(Math.floor(C/H)/b)}function ot(C,b,H,X){let dt=C.updateRanges;if(dt.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,b.width,b.height,H,X,b.data);else{dt.sort((At,_t)=>At.start-_t.start);let gt=0;for(let At=1;At<dt.length;At++){let _t=dt[gt],pt=dt[At],Rt=_t.start+_t.count,wt=ht(pt.start,b.width,4),Ot=ht(_t.start,b.width,4);pt.start<=Rt+1&&wt===Ot&&ht(pt.start+pt.count-1,b.width,4)===wt?_t.count=Math.max(_t.count,pt.start+pt.count-_t.start):(++gt,dt[gt]=pt)}dt.length=gt+1;let tt=n.getParameter(e.UNPACK_ROW_LENGTH),et=n.getParameter(e.UNPACK_SKIP_PIXELS),vt=n.getParameter(e.UNPACK_SKIP_ROWS);n.pixelStorei(e.UNPACK_ROW_LENGTH,b.width);for(let At=0,_t=dt.length;At<_t;At++){let pt=dt[At],Rt=Math.floor(pt.start/4),wt=Math.ceil(pt.count/4),Ot=Rt%b.width,O=Math.floor(Rt/b.width),N=wt,U=1;n.pixelStorei(e.UNPACK_SKIP_PIXELS,Ot),n.pixelStorei(e.UNPACK_SKIP_ROWS,O),n.texSubImage2D(e.TEXTURE_2D,0,Ot,O,N,U,H,X,b.data)}C.clearUpdateRanges(),n.pixelStorei(e.UNPACK_ROW_LENGTH,tt),n.pixelStorei(e.UNPACK_SKIP_PIXELS,et),n.pixelStorei(e.UNPACK_SKIP_ROWS,vt)}}function ft(C,b,H){let X=e.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(X=e.TEXTURE_2D_ARRAY),b.isData3DTexture&&(X=e.TEXTURE_3D);let Q=K(C,b),dt=b.source;n.bindTexture(X,C.__webglTexture,e.TEXTURE0+H);let gt=i.get(dt);if(dt.version!==gt.__version||Q===!0){if(n.activeTexture(e.TEXTURE0+H),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){let U=ne.getPrimaries(ne.workingColorSpace),st=b.colorSpace===ws?null:ne.getPrimaries(b.colorSpace),$=b.colorSpace===ws||U===st?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,$)}n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment);let et=v(b.image,!1,s.maxTextureSize);et=sn(b,et);let vt=a.convert(b.format,b.colorSpace),At=a.convert(b.type),_t=_(b.internalFormat,vt,At,b.normalized,b.colorSpace,b.isVideoTexture);Xt(X,b);let pt,Rt=b.mipmaps,wt=b.isVideoTexture!==!0,Ot=gt.__version===void 0||Q===!0,O=dt.dataReady,N=A(b,et);if(b.isDepthTexture)_t=T(b.format===ba,b.type),Ot&&(wt?n.texStorage2D(e.TEXTURE_2D,1,_t,et.width,et.height):n.texImage2D(e.TEXTURE_2D,0,_t,et.width,et.height,0,vt,At,null));else if(b.isDataTexture)if(Rt.length>0){wt&&Ot&&n.texStorage2D(e.TEXTURE_2D,N,_t,Rt[0].width,Rt[0].height);for(let U=0,st=Rt.length;U<st;U++)pt=Rt[U],wt?O&&n.texSubImage2D(e.TEXTURE_2D,U,0,0,pt.width,pt.height,vt,At,pt.data):n.texImage2D(e.TEXTURE_2D,U,_t,pt.width,pt.height,0,vt,At,pt.data);b.generateMipmaps=!1}else wt?(Ot&&n.texStorage2D(e.TEXTURE_2D,N,_t,et.width,et.height),O&&ot(b,et,vt,At)):n.texImage2D(e.TEXTURE_2D,0,_t,et.width,et.height,0,vt,At,et.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){wt&&Ot&&n.texStorage3D(e.TEXTURE_2D_ARRAY,N,_t,Rt[0].width,Rt[0].height,et.depth);for(let U=0,st=Rt.length;U<st;U++)if(pt=Rt[U],b.format!==yi)if(vt!==null)if(wt){if(O)if(b.layerUpdates.size>0){let $=v0(pt.width,pt.height,b.format,b.type);for(let Z of b.layerUpdates){let ut=pt.data.subarray(Z*$/pt.data.BYTES_PER_ELEMENT,(Z+1)*$/pt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,U,0,0,Z,pt.width,pt.height,1,vt,ut)}b.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,U,0,0,0,pt.width,pt.height,et.depth,vt,pt.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,U,_t,pt.width,pt.height,et.depth,0,pt.data,0,0);else It("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else wt?O&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,U,0,0,0,pt.width,pt.height,et.depth,vt,At,pt.data):n.texImage3D(e.TEXTURE_2D_ARRAY,U,_t,pt.width,pt.height,et.depth,0,vt,At,pt.data)}else{wt&&Ot&&n.texStorage2D(e.TEXTURE_2D,N,_t,Rt[0].width,Rt[0].height);for(let U=0,st=Rt.length;U<st;U++)pt=Rt[U],b.format!==yi?vt!==null?wt?O&&n.compressedTexSubImage2D(e.TEXTURE_2D,U,0,0,pt.width,pt.height,vt,pt.data):n.compressedTexImage2D(e.TEXTURE_2D,U,_t,pt.width,pt.height,0,pt.data):It("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):wt?O&&n.texSubImage2D(e.TEXTURE_2D,U,0,0,pt.width,pt.height,vt,At,pt.data):n.texImage2D(e.TEXTURE_2D,U,_t,pt.width,pt.height,0,vt,At,pt.data)}else if(b.isDataArrayTexture)if(wt){if(Ot&&n.texStorage3D(e.TEXTURE_2D_ARRAY,N,_t,et.width,et.height,et.depth),O)if(b.layerUpdates.size>0){let U=v0(et.width,et.height,b.format,b.type);for(let st of b.layerUpdates){let $=et.data.subarray(st*U/et.data.BYTES_PER_ELEMENT,(st+1)*U/et.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,st,et.width,et.height,1,vt,At,$)}b.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,vt,At,et.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,_t,et.width,et.height,et.depth,0,vt,At,et.data);else if(b.isData3DTexture)wt?(Ot&&n.texStorage3D(e.TEXTURE_3D,N,_t,et.width,et.height,et.depth),O&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,vt,At,et.data)):n.texImage3D(e.TEXTURE_3D,0,_t,et.width,et.height,et.depth,0,vt,At,et.data);else if(b.isFramebufferTexture){if(Ot)if(wt)n.texStorage2D(e.TEXTURE_2D,N,_t,et.width,et.height);else{let U=et.width,st=et.height;for(let $=0;$<N;$++)n.texImage2D(e.TEXTURE_2D,$,_t,U,st,0,vt,At,null),U>>=1,st>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in e){let U=e.canvas;if(U.hasAttribute("layoutsubtree")||U.setAttribute("layoutsubtree","true"),et.parentNode!==U){U.appendChild(et),d.add(b),U.onpaint=st=>{let $=st.changedElements;for(let Z of d)$.includes(Z.image)&&(Z.needsUpdate=!0)},U.requestPaint();return}if(e.texElementImage2D.length===3)e.texElementImage2D(e.TEXTURE_2D,e.RGBA8,et);else{let $=e.RGBA,Z=e.RGBA,ut=e.UNSIGNED_BYTE;e.texElementImage2D(e.TEXTURE_2D,0,$,Z,ut,et)}e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE)}}else if(Rt.length>0){if(wt&&Ot){let U=oe(Rt[0]);n.texStorage2D(e.TEXTURE_2D,N,_t,U.width,U.height)}for(let U=0,st=Rt.length;U<st;U++)pt=Rt[U],wt?O&&n.texSubImage2D(e.TEXTURE_2D,U,0,0,vt,At,pt):n.texImage2D(e.TEXTURE_2D,U,_t,vt,At,pt);b.generateMipmaps=!1}else if(wt){if(Ot){let U=oe(et);n.texStorage2D(e.TEXTURE_2D,N,_t,U.width,U.height)}O&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,vt,At,et)}else n.texImage2D(e.TEXTURE_2D,0,_t,vt,At,et);f(b)&&g(X),gt.__version=dt.version,b.onUpdate&&b.onUpdate(b)}C.__version=b.version}function St(C,b,H){if(b.image.length!==6)return;let X=K(C,b),Q=b.source;n.bindTexture(e.TEXTURE_CUBE_MAP,C.__webglTexture,e.TEXTURE0+H);let dt=i.get(Q);if(Q.version!==dt.__version||X===!0){n.activeTexture(e.TEXTURE0+H);let gt=ne.getPrimaries(ne.workingColorSpace),tt=b.colorSpace===ws?null:ne.getPrimaries(b.colorSpace),et=b.colorSpace===ws||gt===tt?e.NONE:e.BROWSER_DEFAULT_WEBGL;n.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,b.flipY),n.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),n.pixelStorei(e.UNPACK_ALIGNMENT,b.unpackAlignment),n.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);let vt=b.isCompressedTexture||b.image[0].isCompressedTexture,At=b.image[0]&&b.image[0].isDataTexture,_t=[];for(let Z=0;Z<6;Z++)!vt&&!At?_t[Z]=v(b.image[Z],!0,s.maxCubemapSize):_t[Z]=At?b.image[Z].image:b.image[Z],_t[Z]=sn(b,_t[Z]);let pt=_t[0],Rt=a.convert(b.format,b.colorSpace),wt=a.convert(b.type),Ot=_(b.internalFormat,Rt,wt,b.normalized,b.colorSpace),O=b.isVideoTexture!==!0,N=dt.__version===void 0||X===!0,U=Q.dataReady,st=A(b,pt);Xt(e.TEXTURE_CUBE_MAP,b);let $;if(vt){O&&N&&n.texStorage2D(e.TEXTURE_CUBE_MAP,st,Ot,pt.width,pt.height);for(let Z=0;Z<6;Z++){$=_t[Z].mipmaps;for(let ut=0;ut<$.length;ut++){let mt=$[ut];b.format!==yi?Rt!==null?O?U&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut,0,0,mt.width,mt.height,Rt,mt.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut,Ot,mt.width,mt.height,0,mt.data):It("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut,0,0,mt.width,mt.height,Rt,wt,mt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut,Ot,mt.width,mt.height,0,Rt,wt,mt.data)}}}else{if($=b.mipmaps,O&&N){$.length>0&&st++;let Z=oe(_t[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,st,Ot,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(At){O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,_t[Z].width,_t[Z].height,Rt,wt,_t[Z].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ot,_t[Z].width,_t[Z].height,0,Rt,wt,_t[Z].data);for(let ut=0;ut<$.length;ut++){let kt=$[ut].image[Z].image;O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut+1,0,0,kt.width,kt.height,Rt,wt,kt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut+1,Ot,kt.width,kt.height,0,Rt,wt,kt.data)}}else{O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Rt,wt,_t[Z]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ot,Rt,wt,_t[Z]);for(let ut=0;ut<$.length;ut++){let mt=$[ut];O?U&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut+1,0,0,Rt,wt,mt.image[Z]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+Z,ut+1,Ot,Rt,wt,mt.image[Z])}}}f(b)&&g(e.TEXTURE_CUBE_MAP),dt.__version=Q.version,b.onUpdate&&b.onUpdate(b)}C.__version=b.version}function Tt(C,b,H,X,Q,dt){let gt=a.convert(H.format,H.colorSpace),tt=a.convert(H.type),et=_(H.internalFormat,gt,tt,H.normalized,H.colorSpace),vt=i.get(b),At=i.get(H);if(At.__renderTarget=b,!vt.__hasExternalTextures){let _t=Math.max(1,b.width>>dt),pt=Math.max(1,b.height>>dt);Q===e.TEXTURE_3D||Q===e.TEXTURE_2D_ARRAY?n.texImage3D(Q,dt,et,_t,pt,b.depth,0,gt,tt,null):n.texImage2D(Q,dt,et,_t,pt,0,gt,tt,null)}n.bindFramebuffer(e.FRAMEBUFFER,C),Ie(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,X,Q,At.__webglTexture,0,le(b)):(Q===e.TEXTURE_2D||Q>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,X,Q,At.__webglTexture,dt),n.bindFramebuffer(e.FRAMEBUFFER,null)}function re(C,b,H){if(e.bindRenderbuffer(e.RENDERBUFFER,C),b.depthBuffer){let X=b.depthTexture,Q=X&&X.isDepthTexture?X.type:null,dt=T(b.stencilBuffer,Q),gt=b.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;Ie(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,le(b),dt,b.width,b.height):H?e.renderbufferStorageMultisample(e.RENDERBUFFER,le(b),dt,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,dt,b.width,b.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,gt,e.RENDERBUFFER,C)}else{let X=b.textures;for(let Q=0;Q<X.length;Q++){let dt=X[Q],gt=a.convert(dt.format,dt.colorSpace),tt=a.convert(dt.type),et=_(dt.internalFormat,gt,tt,dt.normalized,dt.colorSpace);Ie(b)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,le(b),et,b.width,b.height):H?e.renderbufferStorageMultisample(e.RENDERBUFFER,le(b),et,b.width,b.height):e.renderbufferStorage(e.RENDERBUFFER,et,b.width,b.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Pt(C,b,H){let X=b.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(e.FRAMEBUFFER,C),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let Q=i.get(b.depthTexture);if(Q.__renderTarget=b,(!Q.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),X){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),Q.__webglTexture===void 0){Q.__webglTexture=e.createTexture(),n.bindTexture(e.TEXTURE_CUBE_MAP,Q.__webglTexture),Xt(e.TEXTURE_CUBE_MAP,b.depthTexture);let vt=a.convert(b.depthTexture.format),At=a.convert(b.depthTexture.type),_t;b.depthTexture.format===ki?_t=e.DEPTH_COMPONENT24:b.depthTexture.format===ba&&(_t=e.DEPTH24_STENCIL8);for(let pt=0;pt<6;pt++)e.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+pt,0,_t,b.width,b.height,0,vt,At,null)}}else j(b.depthTexture,0);let dt=Q.__webglTexture,gt=le(b),tt=X?e.TEXTURE_CUBE_MAP_POSITIVE_X+H:e.TEXTURE_2D,et=b.depthTexture.format===ba?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;if(b.depthTexture.format===ki)Ie(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,tt,dt,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,tt,dt,0);else if(b.depthTexture.format===ba)Ie(b)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,et,tt,dt,0,gt):e.framebufferTexture2D(e.FRAMEBUFFER,et,tt,dt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Vt(C){let b=i.get(C),H=C.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==C.depthTexture){let X=C.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),X){let Q=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,X.removeEventListener("dispose",Q)};X.addEventListener("dispose",Q),b.__depthDisposeCallback=Q}b.__boundDepthTexture=X}if(C.depthTexture&&!b.__autoAllocateDepthBuffer)if(H)for(let X=0;X<6;X++)Pt(b.__webglFramebuffer[X],C,X);else{let X=C.texture.mipmaps;X&&X.length>0?Pt(b.__webglFramebuffer[0],C,0):Pt(b.__webglFramebuffer,C,0)}else if(H){b.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[X]),b.__webglDepthbuffer[X]===void 0)b.__webglDepthbuffer[X]=e.createRenderbuffer(),re(b.__webglDepthbuffer[X],C,!1);else{let Q=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,dt=b.__webglDepthbuffer[X];e.bindRenderbuffer(e.RENDERBUFFER,dt),e.framebufferRenderbuffer(e.FRAMEBUFFER,Q,e.RENDERBUFFER,dt)}}else{let X=C.texture.mipmaps;if(X&&X.length>0?n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=e.createRenderbuffer(),re(b.__webglDepthbuffer,C,!1);else{let Q=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,dt=b.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,dt),e.framebufferRenderbuffer(e.FRAMEBUFFER,Q,e.RENDERBUFFER,dt)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Ht(C,b,H){let X=i.get(C);b!==void 0&&Tt(X.__webglFramebuffer,C,C.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),H!==void 0&&Vt(C)}function Ft(C){let b=C.texture,H=i.get(C),X=i.get(b);C.addEventListener("dispose",x);let Q=C.textures,dt=C.isWebGLCubeRenderTarget===!0,gt=Q.length>1;if(gt||(X.__webglTexture===void 0&&(X.__webglTexture=e.createTexture()),X.__version=b.version,r.memory.textures++),dt){H.__webglFramebuffer=[];for(let tt=0;tt<6;tt++)if(b.mipmaps&&b.mipmaps.length>0){H.__webglFramebuffer[tt]=[];for(let et=0;et<b.mipmaps.length;et++)H.__webglFramebuffer[tt][et]=e.createFramebuffer()}else H.__webglFramebuffer[tt]=e.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){H.__webglFramebuffer=[];for(let tt=0;tt<b.mipmaps.length;tt++)H.__webglFramebuffer[tt]=e.createFramebuffer()}else H.__webglFramebuffer=e.createFramebuffer();if(gt)for(let tt=0,et=Q.length;tt<et;tt++){let vt=i.get(Q[tt]);vt.__webglTexture===void 0&&(vt.__webglTexture=e.createTexture(),r.memory.textures++)}if(C.samples>0&&Ie(C)===!1){H.__webglMultisampledFramebuffer=e.createFramebuffer(),H.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let tt=0;tt<Q.length;tt++){let et=Q[tt];H.__webglColorRenderbuffer[tt]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,H.__webglColorRenderbuffer[tt]);let vt=a.convert(et.format,et.colorSpace),At=a.convert(et.type),_t=_(et.internalFormat,vt,At,et.normalized,et.colorSpace,C.isXRRenderTarget===!0),pt=le(C);e.renderbufferStorageMultisample(e.RENDERBUFFER,pt,_t,C.width,C.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+tt,e.RENDERBUFFER,H.__webglColorRenderbuffer[tt])}e.bindRenderbuffer(e.RENDERBUFFER,null),C.depthBuffer&&(H.__webglDepthRenderbuffer=e.createRenderbuffer(),re(H.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(dt){n.bindTexture(e.TEXTURE_CUBE_MAP,X.__webglTexture),Xt(e.TEXTURE_CUBE_MAP,b);for(let tt=0;tt<6;tt++)if(b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)Tt(H.__webglFramebuffer[tt][et],C,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,et);else Tt(H.__webglFramebuffer[tt],C,b,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+tt,0);f(b)&&g(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(gt){for(let tt=0,et=Q.length;tt<et;tt++){let vt=Q[tt],At=i.get(vt),_t=e.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(_t=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(_t,At.__webglTexture),Xt(_t,vt),Tt(H.__webglFramebuffer,C,vt,e.COLOR_ATTACHMENT0+tt,_t,0),f(vt)&&g(_t)}n.unbindTexture()}else{let tt=e.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(tt=C.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(tt,X.__webglTexture),Xt(tt,b),b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)Tt(H.__webglFramebuffer[et],C,b,e.COLOR_ATTACHMENT0,tt,et);else Tt(H.__webglFramebuffer,C,b,e.COLOR_ATTACHMENT0,tt,0);f(b)&&g(tt),n.unbindTexture()}C.depthBuffer&&Vt(C)}function ge(C){let b=C.textures;for(let H=0,X=b.length;H<X;H++){let Q=b[H];if(f(Q)){let dt=y(C),gt=i.get(Q).__webglTexture;n.bindTexture(dt,gt),g(dt),n.unbindTexture()}}}let Ne=[],ue=[];function We(C){if(C.samples>0){if(Ie(C)===!1){let b=C.textures,H=C.width,X=C.height,Q=e.COLOR_BUFFER_BIT,dt=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,gt=i.get(C),tt=b.length>1;if(tt)for(let vt=0;vt<b.length;vt++)n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,gt.__webglMultisampledFramebuffer);let et=C.texture.mipmaps;et&&et.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglFramebuffer);for(let vt=0;vt<b.length;vt++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(Q|=e.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(Q|=e.STENCIL_BUFFER_BIT)),tt){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,gt.__webglColorRenderbuffer[vt]);let At=i.get(b[vt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,At,0)}e.blitFramebuffer(0,0,H,X,0,0,H,X,Q,e.NEAREST),c===!0&&(Ne.length=0,ue.length=0,Ne.push(e.COLOR_ATTACHMENT0+vt),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Ne.push(dt),ue.push(dt),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,ue)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Ne))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),tt)for(let vt=0;vt<b.length;vt++){n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.RENDERBUFFER,gt.__webglColorRenderbuffer[vt]);let At=i.get(b[vt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,gt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+vt,e.TEXTURE_2D,At,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,gt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&c){let b=C.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[b])}}}function le(C){return Math.min(s.maxSamples,C.samples)}function Ie(C){let b=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function P(C){let b=r.render.frame;h.get(C)!==b&&(h.set(C,b),C.update())}function sn(C,b){let H=C.colorSpace,X=C.format,Q=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||H!==Fl&&H!==ws&&(ne.getTransfer(H)===de?(X!==yi||Q!==ii)&&It("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):zt("WebGLTextures: Unsupported texture color space:",H)),b}function oe(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(l.width=C.naturalWidth||C.width,l.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(l.width=C.displayWidth,l.height=C.displayHeight):(l.width=C.width,l.height=C.height),l}this.allocateTextureUnit=B,this.resetTextureUnits=q,this.getTextureUnits=J,this.setTextureUnits=z,this.setTexture2D=j,this.setTexture2DArray=rt,this.setTexture3D=ct,this.setTextureCube=lt,this.rebindTextures=Ht,this.setupRenderTarget=Ft,this.updateRenderTargetMipmap=ge,this.updateMultisampleRenderTarget=We,this.setupDepthRenderbuffer=Vt,this.setupFrameBufferTexture=Tt,this.useMultisampledRTT=Ie,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function i3(e,t){function n(i,s=ws){let a,r=ne.getTransfer(s);if(i===ii)return e.UNSIGNED_BYTE;if(i===wf)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Cf)return e.UNSIGNED_SHORT_5_5_5_1;if(i===a0)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===r0)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===i0)return e.BYTE;if(i===s0)return e.SHORT;if(i===Mo)return e.UNSIGNED_SHORT;if(i===Af)return e.INT;if(i===Ci)return e.UNSIGNED_INT;if(i===Ri)return e.FLOAT;if(i===Ji)return e.HALF_FLOAT;if(i===o0)return e.ALPHA;if(i===l0)return e.RGB;if(i===yi)return e.RGBA;if(i===ki)return e.DEPTH_COMPONENT;if(i===ba)return e.DEPTH_STENCIL;if(i===c0)return e.RED;if(i===Rf)return e.RED_INTEGER;if(i===Sa)return e.RG;if(i===Df)return e.RG_INTEGER;if(i===Nf)return e.RGBA_INTEGER;if(i===hc||i===fc||i===dc||i===pc)if(r===de)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===hc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===dc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===pc)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===hc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===fc)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===dc)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===pc)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Uf||i===Lf||i===If||i===Of)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===Uf)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Lf)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===If)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Of)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Pf||i===zf||i===Bf||i===Ff||i===Vf||i===mc||i===Hf)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===Pf||i===zf)return r===de?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===Bf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ff)return a.COMPRESSED_R11_EAC;if(i===Vf)return a.COMPRESSED_SIGNED_R11_EAC;if(i===mc)return a.COMPRESSED_RG11_EAC;if(i===Hf)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Gf||i===kf||i===Xf||i===Wf||i===qf||i===Yf||i===Zf||i===Jf||i===Kf||i===jf||i===Qf||i===$f||i===td||i===ed)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===Gf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===kf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Xf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Wf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Yf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Jf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Kf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===jf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Qf)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===$f)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===td)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ed)return r===de?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===nd||i===id||i===sd)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===nd)return r===de?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===id)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===sd)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ad||i===rd||i===gc||i===od)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===ad)return a.COMPRESSED_RED_RGTC1_EXT;if(i===rd)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===gc)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===od)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Eo?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}var s3=`
void main() {
